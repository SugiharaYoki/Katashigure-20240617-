...
execute positioned 90208 14 114 if entity @a[tag=SEAPT,distance=0..10] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_spectral],Invisible:0b,Fixed:0b,Facing:1b,Item:{id:"minecraft:flow_armor_trim_smithing_template",components:{custom_name:{text:"二型光棱魔板",italic:1b,color:"light_purple",italic:0b},custom_data:{sea_t_spectral2:true}}}}
execute positioned 90135 85 42 if entity @a[tag=SEAPT,distance=0..10] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_spectral],Invisible:0b,Fixed:0b,Facing:1b,Item:{id:"minecraft:flow_armor_trim_smithing_template",components:{custom_name:{text:"趋蕴魔板",italic:1b,color:"light_purple",italic:0b},custom_data:{sea_t_pounce1:true}}}}
