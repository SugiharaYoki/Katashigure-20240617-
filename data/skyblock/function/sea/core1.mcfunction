...
execute if block 90102 124 125 iron_block positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.18 with trial_key[custom_name='{text:"器械室钥匙",italic:true,color:"yellow",italic:0b}']
execute if block 90102 124 125 iron_block positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.12 with trial_key[custom_name='{text:"文件柜A钥匙",italic:true,color:"yellow",italic:0b}']
execute if block 90102 124 125 iron_block positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.1 with trial_key[custom_name='{text:"西南驳口招待室钥匙",italic:true,color:"yellow",italic:0b}']
execute positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.16 with trial_key[custom_name='{text:"工具维护室钥匙",italic:true,color:"yellow",italic:0b}',custom_data={"sea_key01":true}]
execute if block 90102 124 125 iron_block positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.4 with trial_key[custom_name='{text:"文件柜B钥匙",italic:true,color:"yellow",italic:0b}']
execute if block 90102 124 125 iron_block positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.22 with trial_key[custom_name='{text:"文件柜C钥匙",italic:true,color:"yellow",italic:0b}']
execute positioned 90091 122 130 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.3 with trial_key[custom_name='{text:"扫除用具间钥匙",italic:true,color:"yellow",italic:0b}',custom_data={"sea_key02":true}]
execute positioned 90118 128 120 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.13 with trial_key[custom_name='{text:"空气循环控制室钥匙",italic:true,color:"yellow",italic:0b}',custom_data={"sea_key10":true}]
execute positioned 90122 137 120 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.13 with trial_key[custom_name='{text:"器械资源室2F 燃料架 - B",italic:true,color:"yellow",italic:0b}',custom_data={"sea_key09":true}]
execute positioned 90114 123 125 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.14 with trial_key[custom_name='{text:"器械资源室2F 燃料架 - A 内有慰问品",italic:true,color:"yellow",italic:0b}',custom_data={"sea_key08":true}]
execute positioned 90142 134 138 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.14 with trial_key[custom_name='{text:"宿舍楼3楼某处的钥匙",italic:true,color:"yellow",italic:0b}',custom_data={"sea_key07":true}]
execute positioned 90122 122 128 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.13 with trial_key[custom_name='{text:"折断的饮用水房钥匙",italic:true,color:"yellow",italic:0b}',lore=['{text:"010?1",color:"white",italic:0b}']]
execute positioned 90104 155 151 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.13 with trial_key[custom_name='{text:"副宿舍楼2F - 个人储藏柜2B的钥匙",italic:true,color:"yellow",italic:0b}',lore=['{text:"没错，就是最中间那个，别多想了！",color:"white",italic:0b}'],custom_data={"sea_key06":true}]
execute positioned 90104 140 029 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.12 with trial_key[custom_name='{text:"停机坪仓库的钥匙",italic:true,color:"yellow",italic:0b}',lore=['{text:"他们绝对想不到我在里头藏了多少弹药",color:"white",italic:0b}'],custom_data={"sea_key05":true}]
execute positioned 90173 006 104 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.13 with trial_key[custom_name='{text:"冷凝系统 - 休息区2F钥匙",italic:true,color:"yellow",italic:0b}',custom_data={"sea_key03":true}]
execute positioned 90145 140 120 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.13 with trial_key[custom_name='{text:"行政区3F - 吊车控制室钥匙",italic:true,color:"yellow",italic:0b}',custom_data={"sea_key11":true}]

execute positioned 90140 104 023 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.13 with ominous_trial_key[custom_name='{text:"厄珀娅之钥",italic:true,color:"dark_red",italic:0b}',custom_data={"sea_key04":true}]

item replace block 90152 129 30 container.13 with snout_armor_trim_smithing_template[custom_name='{text:"透光吸附 B",italic:true,color:"light_purple",italic:0b}',lore=['{text:"光谱 I 光棱箭的转换速度加快",color:"white",italic:0b}'],custom_data={sea_t_spectral_load2:true}]
...
item replace block 90089 128 114 container.13 with flow_banner_pattern[custom_data={sea_doc28:true},custom_name='{text:"物资层入口的笔记 - 戴德里克",italic:true,color:"dark_purple",italic:0b}',lore=['{text:"我选择加入诺玛的反抗队伍。",color:"white",italic:0b}','{text:"自从邪教徒宣布地底的古代遗物是圣水晶，感染者就接二连三地出现。",color:"white",italic:0b}','{text:"虽然邪教徒他们自己也搞不清楚究竟发生了什么，可但凡有个脑子都能知道背后的原因。",color:"white",italic:0b}','{text:"不能再让邪教徒胡作非为下去了，诺玛会带我们夺回忒尔克西的控制权。",color:"white",italic:0b}']]

item replace block 90116 128 107 container.13 with flow_banner_pattern[custom_data={sea_doc29:true},custom_name='{text:"北冷冻库的笔记 - 戴德里克",italic:true,color:"dark_purple",italic:0b}',lore=['{text:"诺玛的反抗队伍宁可错杀也不放过一人，甚至殃及了许多中立立场的钻井工人。",color:"white",italic:0b}','{text:"现存有一大堆人因为不想被波及而逃回了物资层。",color:"white",italic:0b}','{text:"我的任务则是尽可能保护他们不受攻击，现在整个平台的局势已经陷入混沌了。",color:"white",italic:0b}','{text:"但北冷冻库的升降门紧闭，晚来的人最多只能逃到这里。",color:"white",italic:0b}','{text:"我们打开了北部的通风系统，不然空气中的细菌浓度就太高了。",color:"white",italic:0b}','{text:"我得上去和诺玛的人谈判，不能再这样下去了。",color:"white",italic:0b}']]
item replace block 90116 128 107 container.26 with flow_banner_pattern[custom_data={sea_doc30:true},custom_name='{text:"北冷冻库的笔记 - 戴德里克？",italic:true,color:"dark_purple",italic:0b}',lore=['{text:"诺玛，你这个骗子。",color:"white",italic:0b}','{text:"你不得好死。",color:"white",italic:0b}']]

item replace block 90028 52 -1846 container.13 with flow_banner_pattern[custom_data={sea_doc31:true},custom_name='{text:"终点前站的笔记 - 作者不明",italic:true,color:"dark_purple",italic:0b}',lore=['{text:"因为你的命运，早已被吾钦定。世界的走向因此无法产生变动。",color:"white",italic:0b}','{text:"你早已被正确之路祝福。",color:"white",italic:0b}','{text:"无数次的尝试、无数次的死亡、无数次的时间倒流……",color:"white",italic:0b}','{text:"全部的苦难，最终都会化为光辉的结局。",color:"white",italic:0b}','{text:"你会见证一切。",color:"white",italic:0b}','{text:"以雷米尔之名。",color:"white",italic:0b}']]


item replace block 90086 143 116 container.13 with flow_banner_pattern[custom_data={sea_doc01b:true},custom_name='{text:"燃料架B内的便签纸",italic:true,color:"dark_purple",italic:0b}',lore=['{text:"上面写着歪歪扭扭的字：",color:"white",italic:0b}','{text:"“从右到左仔细观察北水箱西面的蜡烛”",color:"white",italic:0b}']]
...
#红白蓝紫红紫蓝
#1001110
item replace block 90101 137 147 container.13 with flow_banner_pattern[custom_data={sea_doc03b:true},custom_name='{text:"支撑结构底部的便签纸",italic:true,color:"dark_purple",italic:0b}',lore=['{text:"喷火器能够迅速除掉变异的虫子，我得确保后来者能顺利找到它们。",color:"white",italic:0b}','{text:"站在主平台甲板的多功能工作站与通讯室门口之间，往正西方的上面看，会有一盏蓝色的灯笼。",color:"white",italic:0b}','{text:"储藏喷火器的仓库的钥匙就在灯笼旁边。",color:"white",italic:0b}']]

item replace block 90074 128 150 container.14 with flow_banner_pattern[custom_data={sea_doc04b:true},custom_name='{text:"主平台西南升降梯旁的便签纸",italic:true,color:"dark_purple",italic:0b}',lore=['{text:"我发现这些陶罐里面被藏了很多好东西，可是我手太短够不着。",color:"white",italic:0b}','{text:"以这些陶罐的材质而言，蹲下来冲它们射一箭估计就能破开罐壁。",color:"white",italic:0b}']]

item replace block 90147 153 108 container.13 with flow_banner_pattern[custom_data={sea_doc06b:true},custom_name='{text:"船舶控制室的便签纸",italic:true,color:"dark_purple",italic:0b}',lore=['{text:"我重接了这套控制系统的排线。",color:"white",italic:0b}','{text:"必须不惜一切代价保护通风系统和消防系统，谁会要船舶停靠到我们这里来？",color:"white",italic:0b}']]
...
'{text:"支架悬崖顶端的笔记 - 麦迪逊",italic:true,color:"dark_purple",italic:0b}',\
...
'{text:"工程区液压机室的笔记 - 麦迪逊",italic:true,color:"dark_purple",italic:0b}',\
...
'{text:"行政区吊车控制室的笔记 - 麦迪逊",italic:true,color:"dark_purple",italic:0b}',\
...
'{text:"物资层排水通道的笔记 - 玛瑞莲",italic:true,color:"dark_purple",italic:0b}',\
...
'{text:"行政区二楼仓库的笔记 - 诺玛",italic:true,color:"dark_purple",italic:0b}',\
...
'{text:"矿物处理中心的笔记 - 史丹尼舵长",italic:true,color:"dark_purple",italic:0b}',\
...
'{text:"物资层大仓库维修室的笔记 - 越涵",italic:true,color:"dark_purple",italic:0b}',\
...
'{text:"通讯平台西南支柱的笔记 - 琼斯",italic:true,color:"dark_purple",italic:0b}',\
...
'{text:"菲尔娜的随笔",italic:true,color:"dark_purple",italic:0b}',\
...
'{text:"通讯平台东北支柱的笔记 - 艾德雯娜",italic:true,color:"dark_purple",italic:0b}',\
...
'{text:"通讯中心三楼的笔记 - 琼斯",italic:true,color:"dark_purple",italic:0b}',\
...
'{text:"行政区一楼仓库的笔记 - 艾德雯娜",italic:true,color:"dark_purple",italic:0b}',\
...
execute positioned 90178 39 184 if entity @a[tag=SEAPT,distance=..8] run item replace block 90178 39 184 container.10 with detector_rail[custom_name='{text:"1号操作按钮",italic:true,color:"yellow",italic:0b}',custom_data={"sea_railbox_1_1":true}]
execute positioned 90178 39 184 if entity @a[tag=SEAPT,distance=..8] run item replace block 90178 39 184 container.12 with detector_rail[custom_name='{text:"2号操作按钮",italic:true,color:"yellow",italic:0b}',custom_data={"sea_railbox_1_2":true}]
execute positioned 90178 39 184 if entity @a[tag=SEAPT,distance=..8] run item replace block 90178 39 184 container.14 with detector_rail[custom_name='{text:"3号操作按钮",italic:true,color:"yellow",italic:0b}',custom_data={"sea_railbox_1_3":true}]
execute positioned 90178 39 184 if entity @a[tag=SEAPT,distance=..8] run item replace block 90178 39 184 container.16 with detector_rail[custom_name='{text:"4号操作按钮",italic:true,color:"yellow",italic:0b}',custom_data={"sea_railbox_1_4":true}]
