...
execute if block 90074 103 136 lectern if block 90081 101 137 minecraft:dark_oak_hanging_sign positioned 90128 136 20 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_spectral],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:5b,Item:{id:"minecraft:silence_armor_trim_smithing_template",components:{custom_name:{text:"超频声荡 I",italic:0b,color:"red"},custom_data:{sea_t_ripper1:true},lore:[{text:"音爆 I 发射磁锯会制造超音波",color:"white",italic:0b},{text:"可用于破坏绿色藤蔓",color:"white",italic:0b}]}}}

execute positioned 90078 123 136 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_crowbar],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:3b,Item:{id:"minecraft:copper_hoe",components:{custom_name:{text:"撬棍",italic:0b,color:"red"},custom_data:{sea_crowbar:true},attribute_modifiers:[{type:"attack_damage",slot:"mainhand",id:"sea_weapon:001_01",amount:1.5,operation:"add_value"},{type:"attack_speed",slot:"mainhand",id:"sea_weapon:001_02",amount:-1.5,operation:"add_value"}],unbreakable:{}}}}
execute positioned 90106 129 141 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_crowbar],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:3b,Item:{id:"minecraft:copper_hoe",components:{custom_name:{text:"撬棍",italic:0b,color:"red"},custom_data:{sea_crowbar:true},attribute_modifiers:[{type:"attack_damage",slot:"mainhand",id:"sea_weapon:001_01",amount:1.5,operation:"add_value"},{type:"attack_speed",slot:"mainhand",id:"sea_weapon:001_02",amount:-1.5,operation:"add_value"}],unbreakable:{}}}}
execute positioned 90088 129 120 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_leg],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:3b,Item:{id:"minecraft:leather_leggings",components:{custom_name:{text:"基础防护裤",italic:0b,color:"red"},custom_data:{sea_leg:true},attribute_modifiers:[{type:"armor",id:"sea_armor:001_01",amount:1.0,operation:"add_value"},{type:"armor_toughness",id:"sea_armor:001_02",amount:0.5,operation:"add_value"}],unbreakable:{}}}}
execute positioned 90074 129 133 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_feet],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:2b,Item:{id:"minecraft:leather_boots",components:{custom_name:{text:"基础防护靴",italic:0b,color:"red"},custom_data:{sea_feet:true},attribute_modifiers:[{type:"armor",id:"sea_armor:008_01",amount:1.0,operation:"add_value"},{type:"armor_toughness",id:"sea_armor:008_02",amount:0.5,operation:"add_value"}],unbreakable:{}}}}

execute positioned 90121 123 140 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_safehat],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:5b,Item:{id:"minecraft:copper_helmet",components:{custom_name:{text:"电工安全帽",italic:0b,color:"red"},custom_data:{sea_safehat:true},attribute_modifiers:[{type:"armor",id:"sea_armor:003_01",amount:1.0,operation:"add_value"},{type:"knockback_resistance",id:"sea_armor:003_02",amount:0.1,operation:"add_value"}],unbreakable:{}}}}
execute positioned 90123 123 100 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_safeaxe],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:4b,Item:{id:"minecraft:iron_axe",components:{custom_name:{text:"消防斧",italic:0b,color:"red"},custom_data:{sea_safeaxe:true},attribute_modifiers:[{type:"attack_damage",slot:"mainhand",id:"sea_weapon:004_01",amount:6.5,operation:"add_value"},{type:"attack_speed",slot:"mainhand",id:"sea_weapon:004_02",amount:-3.0,operation:"add_value"}],unbreakable:{}}}}
execute positioned 90137 129 137 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_crossbow],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:5b,Item:{id:"minecraft:crossbow",components:{custom_name:{text:"工程弩",italic:0b,color:"red"},custom_data:{sea_crossbow:true},unbreakable:{}}}}
execute positioned 90137 138 126 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_flamethrower],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:4b,Item:{id:"minecraft:shears",components:{custom_name:{text:"喷火器",italic:0b,color:"red"},custom_data:{sea_flamethrower:true},unbreakable:{}}}}
execute positioned 90120 156 143 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_crossbow],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:5b,Item:{id:"minecraft:crossbow",components:{custom_name:{text:"工程弩",italic:0b,color:"red"},custom_data:{sea_crossbow:true},unbreakable:{}}}}


item replace block 90071 128 113 container.13 with music_disc_5[custom_name={text:"磁锯发射装置",italic:0b,color:"red"},custom_data={sea_flamethrower:true},unbreakable={}]
...
execute positioned 90075 129 120 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_spectral],Invisible:1b,Fixed:0b,Facing:1b,Item:{id:"minecraft:flow_armor_trim_smithing_template",components:{custom_name:{text:"光棱魔板",color:"light_purple",italic:0b},custom_data:{sea_t_spectral1:true}}}}
execute positioned 90129 144 141 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_spectral],Invisible:1b,Fixed:0b,Facing:1b,Item:{id:"minecraft:flow_armor_trim_smithing_template",components:{custom_name:{text:"残影魔板",color:"light_purple",italic:0b},custom_data:{sea_t_sprint:true}}}}
execute positioned 90208 14 114 if entity @a[tag=SEAPT,distance=0..10] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_spectral],Invisible:1b,Fixed:0b,Facing:1b,Item:{id:"minecraft:flow_armor_trim_smithing_template",components:{custom_name:{text:"二型光棱魔板",color:"light_purple",italic:0b},custom_data:{sea_t_spectral2:true}}}}
execute positioned 90135 85 42 if entity @a[tag=SEAPT,distance=0..10] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_spectral],Invisible:1b,Fixed:0b,Facing:1b,Item:{id:"minecraft:flow_armor_trim_smithing_template",components:{custom_name:{text:"趋蕴魔板",color:"light_purple",italic:0b},custom_data:{sea_t_pounce1:true}}}}

execute if block 90074 103 136 lectern unless items entity @a[tag=SEAPT,tag=!SEAPF] container.* disc_fragment_5 positioned 90157 138 156 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_spectral],Invisible:1b,Fixed:0b,Invulnerable:0b,Facing:1b,Item:{id:"minecraft:pitcher_pod"}}



execute positioned 90117 137 121 run item replace block ~ ~ ~ container.10 with copper_helmet[custom_name={text:"电工安全帽",italic:0b,color:"red"},custom_data={sea_safehat:true},attribute_modifiers=[{type:"armor",id:"sea_armor:003_01",amount:1.0,operation:"add_value"},{type:"knockback_resistance",id:"sea_armor:003_02",amount:0.1,operation:"add_value"}],unbreakable={}]
execute positioned 90117 137 121 run item replace block ~ ~ ~ container.12 with leather_chestplate[custom_name={text:"基础防护服",italic:0b,color:"red"},custom_data={sea_chest:true},attribute_modifiers=[{type:"armor",id:"sea_armor:002_01",amount:1.0,operation:"add_value"},{type:"armor_toughness",id:"sea_armor:002_02",amount:0.5,operation:"add_value"}],unbreakable={}]
execute positioned 90117 137 121 run item replace block ~ ~ ~ container.14 with leather_leggings[custom_name={text:"基础防护裤",italic:0b,color:"red"},custom_data={sea_leg:true},attribute_modifiers=[{type:"armor",id:"sea_armor:001_01",amount:1.0,operation:"add_value"},{type:"armor_toughness",id:"sea_armor:001_02",amount:0.5,operation:"add_value"}],unbreakable={}]
execute positioned 90117 137 121 run item replace block ~ ~ ~ container.16 with leather_boots[custom_name={text:"基础防护靴",italic:0b,color:"red"},custom_data={sea_feet:true},attribute_modifiers=[{type:"armor",id:"sea_armor:008_01",amount:1.0,operation:"add_value"},{type:"armor_toughness",id:"sea_armor:008_02",amount:0.5,operation:"add_value"}],unbreakable={}]

execute positioned 90193 31 158 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_shotgun],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:4b,Item:{id:"minecraft:snout_armor_trim_smithing_template",components:{custom_name:{text:"爆燃膛针",italic:0b,color:"red"},custom_data:{sea_t_shotgun1:true},lore:[{text:"急霰 I 解锁喷火器右键攻击",color:"white",italic:0b},{text:"对面前近距离造成大量伤害",color:"white",italic:0b},{text:"消耗一份燃爆剂",color:"red",italic:0b}]}}}

#地图
execute positioned 90102 123 121 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_map_01],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:5b,Item:{id:"minecraft:filled_map",components:{custom_name:{text:"维修层地图",italic:0b,color:"dark_purple"},map_id:4}}}
execute positioned 90081 129 123 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_map_02],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:4b,Item:{id:"minecraft:filled_map",components:{custom_name:{text:"物资层地图",italic:0b,color:"dark_purple"},map_id:5}}}
execute positioned 90172 22 100 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_map_04],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:3b,Item:{id:"minecraft:filled_map",components:{custom_name:{text:"冷凝系统地图",italic:0b,color:"dark_purple"},map_id:20}}}

execute if block 90062 103 135 grindstone positioned 90080 105 143 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_map_01],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:2b,Item:{id:"minecraft:filled_map",components:{custom_name:{text:"维修层地图",italic:0b,color:"dark_purple"},map_id:4}}}
execute if block 90075 103 141 minecraft:cauldron positioned 90079 105 143 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_map_02],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:2b,Item:{id:"minecraft:filled_map",components:{custom_name:{text:"物资层地图",italic:0b,color:"dark_purple"},map_id:5}}}
execute if block 90075 103 141 minecraft:cauldron positioned 90080 104 143 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_map_01],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:2b,Item:{id:"minecraft:filled_map",components:{custom_name:{text:"主平台地图：甲板部分",italic:0b,color:"dark_purple"},map_id:18}}}
execute if block 90074 103 137 scaffolding positioned 90079 104 143 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_map_04],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:2b,Item:{id:"minecraft:filled_map",components:{custom_name:{text:"冷凝系统地图",italic:0b,color:"dark_purple"},map_id:20}}}
...
#船
execute positioned 90062 104 -165 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_safehat],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:4b,Item:{id:"minecraft:spyglass",components:{lore:[{text:"我随身携带的望远镜。",color:"white",italic:0b},{text:"在前途未知的时刻，紧握住它可以让我不再迷惘。",color:"white",italic:0b},{text:"手持时：显示任务目标 & 跳过已阅读的剧情对话",color:"green",italic:0b}]}}}

execute positioned 90058 104 -166 positioned ~ ~ ~300 if entity @a[tag=SEAPT,distance=0..5] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_safehat],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:1b,Item:{id:"minecraft:flow_banner_pattern",components:{custom_name:{text:"调查记录 6月29日 17:42",color:"dark_purple",italic:0b},custom_data:{sea_doc01:true},lore:[{text:"记录者为忒尔克西钻井平台调查小组成员，也是我本人。",color:"white",italic:0b},{text:"钻井平台距离失联已经超过36小时，我们在黄昏之时赶到了平台的西南驳口。",color:"white",italic:0b},{text:"整座海上设施此时一片死寂，至少上百名的工作人员皆数不见踪影。",color:"white",italic:0b}]}}}
execute positioned 90062 104 -165 positioned ~ ~ ~300 if entity @a[tag=SEAPT,distance=0..5] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_safehat],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:4b,Item:{id:"minecraft:spyglass",components:{lore:[{text:"我随身携带的望远镜。",color:"white",italic:0b},{text:"在前途未知的时刻，紧握住它可以让我不再迷惘。",color:"white",italic:0b},{text:"手持时：显示任务目标 & 跳过已阅读的剧情对话",color:"green",italic:0b}]}}}
...
execute if block 90102 124 125 iron_block positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.18 with trial_key[custom_name={text:"器械室钥匙",color:"yellow",italic:0b}]
execute if block 90102 124 125 iron_block positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.12 with trial_key[custom_name={text:"文件柜A钥匙",color:"yellow",italic:0b}]
execute if block 90102 124 125 iron_block positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.1 with trial_key[custom_name={text:"西南驳口招待室钥匙",color:"yellow",italic:0b}]
execute positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.16 with trial_key[custom_name={text:"工具维护室钥匙",color:"yellow",italic:0b},custom_data={"sea_key01":true}]
execute if block 90102 124 125 iron_block positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.4 with trial_key[custom_name={text:"文件柜B钥匙",color:"yellow",italic:0b}]
execute if block 90102 124 125 iron_block positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.22 with trial_key[custom_name={text:"文件柜C钥匙",color:"yellow",italic:0b}]
execute positioned 90091 122 130 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.3 with trial_key[custom_name={text:"扫除用具间钥匙",color:"yellow",italic:0b},custom_data={"sea_key02":true}]
execute positioned 90118 128 120 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.13 with trial_key[custom_name={text:"空气循环控制室钥匙",color:"yellow",italic:0b},custom_data={"sea_key10":true}]
execute positioned 90122 137 120 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.13 with trial_key[custom_name={text:"器械资源室2F 燃料架 - B",color:"yellow",italic:0b},custom_data={"sea_key09":true}]
execute positioned 90114 123 125 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.14 with trial_key[custom_name={text:"器械资源室2F 燃料架 - A 内有慰问品",color:"yellow",italic:0b},custom_data={"sea_key08":true}]
execute positioned 90142 134 138 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.14 with trial_key[custom_name={text:"宿舍楼3楼某处的钥匙",color:"yellow",italic:0b},custom_data={"sea_key07":true}]
execute positioned 90122 122 128 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.13 with trial_key[custom_name={text:"折断的饮用水房钥匙",color:"yellow",italic:0b},lore=[{text:"010?1",color:"white",italic:0b}]]
execute positioned 90104 155 151 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.13 with trial_key[custom_name={text:"副宿舍楼2F - 个人储藏柜2B的钥匙",color:"yellow",italic:0b},lore=[{text:"没错，就是最中间那个，别多想了！",color:"white",italic:0b}],custom_data={"sea_key06":true}]
execute positioned 90104 140 029 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.12 with trial_key[custom_name={text:"停机坪仓库的钥匙",color:"yellow",italic:0b},lore=[{text:"他们绝对想不到我在里头藏了多少弹药",color:"white",italic:0b}],custom_data={"sea_key05":true}]
execute positioned 90173 006 104 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.13 with trial_key[custom_name={text:"冷凝系统 - 休息区2F钥匙",color:"yellow",italic:0b},custom_data={"sea_key03":true}]
execute positioned 90145 140 120 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.13 with trial_key[custom_name={text:"行政区3F - 吊车控制室钥匙",color:"yellow",italic:0b},custom_data={"sea_key11":true}]
...
item replace block 90095 122 128 container.3 with flow_banner_pattern[custom_data={sea_doc02:true},custom_name={text:"何日的新闻",color:"dark_purple",italic:0b},lore=[{text:"这座忒尔克西作为2130年往后的唯一一座新建钻井平台，其背负的不仅是开采石油的使命。",color:"white",italic:0b},{text:"于2128年在大洋洲火圈地带接连发生的火山喷发，将这一批埋藏于地层深处的石油送入了太平洋。",color:"white",italic:0b},{text:"这些石油在地理位置的分布再一次提醒了现代的人们过去有关“姆大陆”的学术猜想。",color:"white",italic:0b},{text:"忒尔克西海上钻井平台在开采这批石油的同时，也将探索位于各处石油分布区域汇聚……",color:"white",italic:0b}]]
item replace block 90095 122 128 container.15 with flow_banner_pattern[custom_data={sea_doc03:true},custom_name=\
{text:"文件室的笔记 - 丹尼尔",color:"dark_purple",italic:0b},\
...
{text:"钥匙箱内的笔记 - 丹尼尔",color:"dark_purple",italic:0b},\
...
{text:"机械暗室的笔记 - 玛瑞莲",color:"dark_purple",italic:0b},\
...
{text:"医疗报告1 - 法莫洛斯",color:"dark_purple",italic:0b},\
...
{text:"医疗报告2 - 法莫洛斯",color:"dark_purple",italic:0b},\
...
{text:"医疗报告3 - 法莫洛斯",color:"dark_purple",italic:0b},\
...
{text:"医疗报告4 - 法莫洛斯",color:"dark_purple",italic:0b},\
...
{text:"医疗报告5 - 法莫洛斯",color:"dark_purple",italic:0b},\
...
{text:"医疗报告6 - 法莫洛斯",color:"dark_purple",italic:0b},\
...
{text:"医疗报告7 - 法莫洛斯",color:"dark_purple",italic:0b},\
...
{text:"医疗报告8 - 法莫洛斯",color:"dark_purple",italic:0b},\
...
{text:"不明来历的纸条",color:"dark_purple",italic:0b},\
...
item replace block 90089 128 114 container.13 with flow_banner_pattern[custom_data={sea_doc28:true},custom_name={text:"物资层入口的笔记 - 戴德里克",color:"dark_purple",italic:0b},lore=[{text:"我选择加入诺玛的反抗队伍。",color:"white",italic:0b},{text:"自从邪教徒宣布地底的古代遗物是圣水晶，感染者就接二连三地出现。",color:"white",italic:0b},{text:"虽然邪教徒他们自己也搞不清楚究竟发生了什么，可但凡有个脑子都能知道背后的原因。",color:"white",italic:0b},{text:"不能再让邪教徒胡作非为下去了，诺玛会带我们夺回忒尔克西的控制权。",color:"white",italic:0b}]]

item replace block 90116 128 107 container.13 with flow_banner_pattern[custom_data={sea_doc29:true},custom_name={text:"北冷冻库的笔记 - 戴德里克",color:"dark_purple",italic:0b},lore=[{text:"诺玛的反抗队伍宁可错杀也不放过一人，甚至殃及了许多中立立场的钻井工人。",color:"white",italic:0b},{text:"现存有一大堆人因为不想被波及而逃回了物资层。",color:"white",italic:0b},{text:"我的任务则是尽可能保护他们不受攻击，现在整个平台的局势已经陷入混沌了。",color:"white",italic:0b},{text:"但北冷冻库的升降门紧闭，晚来的人最多只能逃到这里。",color:"white",italic:0b},{text:"我们打开了北部的通风系统，不然空气中的细菌浓度就太高了。",color:"white",italic:0b},{text:"我得上去和诺玛的人谈判，不能再这样下去了。",color:"white",italic:0b}]]
item replace block 90116 128 107 container.26 with flow_banner_pattern[custom_data={sea_doc30:true},custom_name={text:"北冷冻库的笔记 - 戴德里克？",color:"dark_purple",italic:0b},lore=[{text:"诺玛，你这个骗子。",color:"white",italic:0b},{text:"你不得好死。",color:"white",italic:0b}]]

item replace block 90028 52 -1846 container.13 with flow_banner_pattern[custom_data={sea_doc31:true},custom_name={text:"终点前站的笔记 - 作者不明",color:"dark_purple",italic:0b},lore=[{text:"因为你的命运，早已被吾钦定。世界的走向因此无法产生变动。",color:"white",italic:0b},{text:"你早已被正确之路祝福。",color:"white",italic:0b},{text:"无数次的尝试、无数次的死亡、无数次的时间倒流……",color:"white",italic:0b},{text:"全部的苦难，最终都会化为光辉的结局。",color:"white",italic:0b},{text:"你会见证一切。",color:"white",italic:0b},{text:"以雷米尔之名。",color:"white",italic:0b}]]


item replace block 90086 143 116 container.13 with flow_banner_pattern[custom_data={sea_doc01b:true},custom_name={text:"燃料架B内的便签纸",color:"dark_purple",italic:0b},lore=[{text:"上面写着歪歪扭扭的字：",color:"white",italic:0b},{text:"“从右到左仔细观察北水箱西面的蜡烛”",color:"white",italic:0b}]]

item replace block 90107 156 135 container.13 with flow_banner_pattern[custom_data={sea_doc02b:true},custom_name={text:"副宿舍楼个人储藏柜内的便签纸",color:"dark_purple",italic:0b},lore=[{text:"上面写着歪歪扭扭的字：",color:"white",italic:0b},{text:"“正方形左上”",color:"white",italic:0b},{text:"“左上的斜对角”",color:"white",italic:0b},{text:"“右上”",color:"white",italic:0b},{text:"“剩下的那个角”",color:"white",italic:0b},{text:"“第一个角”",color:"white",italic:0b},{text:"“左下”",color:"white",italic:0b},{text:"“第四个角的斜对面”",color:"white",italic:0b}]]
#红白蓝紫红紫蓝
#1001110
item replace block 90101 137 147 container.13 with flow_banner_pattern[custom_data={sea_doc03b:true},custom_name={text:"支撑结构底部的便签纸",color:"dark_purple",italic:0b},lore=[{text:"喷火器能够迅速除掉变异的虫子，我得确保后来者能顺利找到它们。",color:"white",italic:0b},{text:"站在主平台甲板的多功能工作站与通讯室门口之间，往正西方的上面看，会有一盏蓝色的灯笼。",color:"white",italic:0b},{text:"储藏喷火器的仓库的钥匙就在灯笼旁边。",color:"white",italic:0b}]]

item replace block 90074 128 150 container.14 with flow_banner_pattern[custom_data={sea_doc04b:true},custom_name={text:"主平台西南升降梯旁的便签纸",color:"dark_purple",italic:0b},lore=[{text:"我发现这些陶罐里面被藏了很多好东西，可是我手太短够不着。",color:"white",italic:0b},{text:"以这些陶罐的材质而言，蹲下来冲它们射一箭估计就能破开罐壁。",color:"white",italic:0b}]]

item replace block 90147 153 108 container.13 with flow_banner_pattern[custom_data={sea_doc06b:true},custom_name={text:"船舶控制室的便签纸",color:"dark_purple",italic:0b},lore=[{text:"我重接了这套控制系统的排线。",color:"white",italic:0b},{text:"必须不惜一切代价保护通风系统和消防系统，谁会要船舶停靠到我们这里来？",color:"white",italic:0b}]]




item replace block 90114 123 125 container.12 with flow_banner_pattern[custom_data={sea_doc10b:true},custom_name=\
{text:"维修仓库的笔记 - 麦迪逊",color:"dark_purple",italic:0b},\
...
{text:"主平台甲板通讯室储藏间的笔记A - 麦迪逊",color:"dark_purple",italic:0b},\
...
{text:"主平台甲板通讯室储藏间的笔记B - 麦迪逊",color:"dark_purple",italic:0b},\
...
{text:"物资层休息室的笔记 - 麦迪逊",color:"dark_purple",italic:0b},\
...
{text:"泄水通道秘密实验室的笔记 - 麦迪逊",color:"dark_purple",italic:0b},\
...
{text:"支架悬崖顶端的笔记 - 麦迪逊",color:"dark_purple",italic:0b},\
...
{text:"工程区液压机室的笔记 - 麦迪逊",color:"dark_purple",italic:0b},\
...
{text:"行政区吊车控制室的笔记 - 麦迪逊",color:"dark_purple",italic:0b},\
...
{text:"物资层排水通道的笔记 - 玛瑞莲",color:"dark_purple",italic:0b},\
...
{text:"建材资源平台的笔记 - 史丹尼舵长",color:"dark_purple",italic:0b},\
...
{text:"医务中心的笔记 - 丹尼尔",color:"dark_purple",italic:0b},\
...
{text:"行政区二楼仓库的笔记 - 诺玛",color:"dark_purple",italic:0b},\
...
{text:"矿物处理中心的笔记 - 史丹尼舵长",color:"dark_purple",italic:0b},\
...
{text:"工程处后厨的笔记 - 瑞佛特",color:"dark_purple",italic:0b},\
...
{text:"南冷冻室门口的笔记 - 德怀特",color:"dark_purple",italic:0b},\
...
{text:"南冷冻室内部的笔记 - 潘",color:"dark_purple",italic:0b},\
...
{text:"北部通风管道的笔记 - 瑞佛特",color:"dark_purple",italic:0b},\
...
{text:"物资层大仓库维修室的笔记 - 越涵",color:"dark_purple",italic:0b},\
...
{text:"宿舍楼图书馆的笔记 - 斯顿",color:"dark_purple",italic:0b},\
...
{text:"宿舍楼二楼的笔记 - 马绍尔",color:"dark_purple",italic:0b},\
...
{text:"副宿舍楼二楼的笔记 - 肯",color:"dark_purple",italic:0b},\
...
{text:"通讯平台西南支柱的笔记 - 琼斯",color:"dark_purple",italic:0b},\
...
{text:"菲尔娜的随笔",color:"dark_purple",italic:0b},\
...
{text:"通讯平台东北支柱的笔记 - 艾德雯娜",color:"dark_purple",italic:0b},\
...
{text:"通讯中心三楼的笔记 - 琼斯",color:"dark_purple",italic:0b},\
...
{text:"行政区一楼仓库的笔记 - 艾德雯娜",color:"dark_purple",italic:0b},\
...
execute positioned 90178 39 184 if entity @a[tag=SEAPT,distance=..8] run item replace block 90178 39 184 container.10 with detector_rail[custom_name={text:"1号操作按钮",color:"yellow",italic:0b},custom_data={"sea_railbox_1_1":true}]
execute positioned 90178 39 184 if entity @a[tag=SEAPT,distance=..8] run item replace block 90178 39 184 container.12 with detector_rail[custom_name={text:"2号操作按钮",color:"yellow",italic:0b},custom_data={"sea_railbox_1_2":true}]
execute positioned 90178 39 184 if entity @a[tag=SEAPT,distance=..8] run item replace block 90178 39 184 container.14 with detector_rail[custom_name={text:"3号操作按钮",color:"yellow",italic:0b},custom_data={"sea_railbox_1_3":true}]
execute positioned 90178 39 184 if entity @a[tag=SEAPT,distance=..8] run item replace block 90178 39 184 container.16 with detector_rail[custom_name={text:"4号操作按钮",color:"yellow",italic:0b},custom_data={"sea_railbox_1_4":true}]
