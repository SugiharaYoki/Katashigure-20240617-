...
item replace block 90116 128 107 container.13 with flow_banner_pattern[custom_data={sea_doc29:true},custom_name='{"text":"北冷冻库的笔记 - 戴德里克","italic":true,"color":"dark_purple","italic":false}',lore=['{"text":"诺玛的反抗队伍宁可错杀也不放过一人，甚至殃及了许多中立立场的钻井工人。","color":"white","italic":false}','{"text":"现存有一大堆人因为不想被波及而逃下了物资层。","color":"white","italic":false}','{"text":"但北冷冻库的升降门紧闭，晚来的人最多只能逃到这里。","color":"white","italic":false}','{"text":"我们打开了北部的通风系统，不然空气中的细菌浓度就太高了。","color":"white","italic":false}']]
