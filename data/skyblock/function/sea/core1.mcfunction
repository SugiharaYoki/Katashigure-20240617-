...
execute positioned 90121 123 140 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_safehat],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:5b,Item:{id:"minecraft:chainmail_helmet",components:{custom_name:{text:"电工安全帽",italic:0b,color:"red"},custom_data:{sea_safehat:true},attribute_modifiers:[{type:"armor",slot:"head",id:"sea_armor:003_01",amount:1.0,operation:"add_value"},{type:"knockback_resistance",slot:"head",id:"sea_armor:003_02",amount:0.1,operation:"add_value"}],unbreakable:{}}}}
...
execute positioned 90075 129 120 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_spectral],Invisible:0b,Fixed:0b,Facing:1b,Item:{id:"minecraft:flow_armor_trim_smithing_template",components:{custom_name:{text:"光棱魔板",color:"light_purple",italic:0b},custom_data:{sea_t_spectral1:true}}}}
execute positioned 90129 144 141 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_spectral],Invisible:0b,Fixed:0b,Facing:1b,Item:{id:"minecraft:flow_armor_trim_smithing_template",components:{custom_name:{text:"残影魔板",color:"light_purple",italic:0b},custom_data:{sea_t_sprint:true}}}}
execute positioned 90208 14 114 if entity @a[tag=SEAPT,distance=0..10] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_spectral],Invisible:0b,Fixed:0b,Facing:1b,Item:{id:"minecraft:flow_armor_trim_smithing_template",components:{custom_name:{text:"二型光棱魔板",color:"light_purple",italic:0b},custom_data:{sea_t_spectral2:true}}}}
execute positioned 90135 85 42 if entity @a[tag=SEAPT,distance=0..10] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_spectral],Invisible:0b,Fixed:0b,Facing:1b,Item:{id:"minecraft:flow_armor_trim_smithing_template",components:{custom_name:{text:"趋蕴魔板",color:"light_purple",italic:0b},custom_data:{sea_t_pounce1:true}}}}
