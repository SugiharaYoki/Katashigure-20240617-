...
execute positioned 90074 129 133 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:2b}
