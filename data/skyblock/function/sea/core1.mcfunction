...
execute positioned 90121 123 140 if entity @a[tag=SEAPT,distance=0..20,limit=1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_safehat],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:5b,Item:{id:"minecraft:iron_chainmail_helmet",components:{custom_name:{text:"电工安全帽",italic:0b,color:"red"},custom_data:{sea_safehat:true},attribute_modifiers:[{type:"armor",slot:"head",id:"sea_armor:003_01",amount:1.0,operation:"add_value"},{type:"knockback_resistance",slot:"head",id:"sea_armor:003_02",amount:0.1,operation:"add_value"}],unbreakable:{}}}}
...
execute positioned 90120 138 121 if entity @a[tag=SEAPT,distance=0..20,limit=1] run summon minecraft:item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_safehat],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:2b,Item:{id:"minecraft:iron_chainmail_helmet",components:{custom_name:{text:"电工安全帽",italic:0b,color:"red"},custom_data:{sea_safehat:true},attribute_modifiers:[{type:"armor",slot:"head",id:"sea_armor:003_01",amount:1.0,operation:"add_value"},{type:"knockback_resistance",slot:"head",id:"sea_armor:003_02",amount:0.1,operation:"add_value"}],unbreakable:{}}}}
