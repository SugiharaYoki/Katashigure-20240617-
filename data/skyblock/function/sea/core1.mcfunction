...
#地图
execute positioned 90102 123 121 if entity @a[tag=SEAPT,distance=0..20,limit=1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_map_01],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:5b,Item:{id:"minecraft:filled_map",components:{custom_name:'{text:"维修层地图",italic:false,color:"dark_purple"}',map_id:4}}}
execute positioned 90081 129 123 if entity @a[tag=SEAPT,distance=0..20,limit=1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_map_02],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:4b,Item:{id:"minecraft:filled_map",components:{custom_name:'{text:"物资层地图",italic:false,color:"dark_purple"}',map_id:5}}}
...
execute if block 90102 124 125 iron_block positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.18 with trial_key[custom_name='{text:"器械室钥匙",italic:true,color:"yellow",italic:false}']
execute if block 90102 124 125 iron_block positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.12 with trial_key[custom_name='{text:"文件柜A钥匙",italic:true,color:"yellow",italic:false}']
execute if block 90102 124 125 iron_block positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.1 with trial_key[custom_name='{text:"西南驳口招待室钥匙",italic:true,color:"yellow",italic:false}']
execute positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.16 with trial_key[custom_name='{text:"工具维护室钥匙",italic:true,color:"yellow",italic:false}',custom_data={"sea_key01":true}]
execute if block 90102 124 125 iron_block positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.4 with trial_key[custom_name='{text:"文件柜B钥匙",italic:true,color:"yellow",italic:false}']
execute if block 90102 124 125 iron_block positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.22 with trial_key[custom_name='{text:"文件柜C钥匙",italic:true,color:"yellow",italic:false}']
execute positioned 90091 122 130 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.3 with trial_key[custom_name='{text:"扫除用具间钥匙",italic:true,color:"yellow",italic:false}',custom_data={"sea_key02":true}]
execute positioned 90118 128 120 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.13 with trial_key[custom_name='{text:"空气循环控制室钥匙",italic:true,color:"yellow",italic:false}',custom_data={"sea_key10":true}]
execute positioned 90122 137 120 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.13 with trial_key[custom_name='{text:"器械资源室2F 燃料架 - B",italic:true,color:"yellow",italic:false}',custom_data={"sea_key09":true}]
execute positioned 90114 123 125 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.14 with trial_key[custom_name='{text:"器械资源室2F 燃料架 - A 内有慰问品",italic:true,color:"yellow",italic:false}',custom_data={"sea_key08":true}]
execute positioned 90142 134 138 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.14 with trial_key[custom_name='{text:"宿舍楼3楼某处的钥匙",italic:true,color:"yellow",italic:false}',custom_data={"sea_key07":true}]
execute positioned 90122 122 128 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.13 with trial_key[custom_name='{text:"折断的饮用水房钥匙",italic:true,color:"yellow",italic:false}',lore=['{text:"010?1",color:"white",italic:false}']]
...
lore=['{text:"绝对不能让它落入那群教徒的手中。",color:"white",italic:false}','{text:"我不知道诺曼博士是如何说服了史丹尼舵长去听信那种鬼话。",color:"white",italic:false}','{text:"居住区已经被游行的钻井队占领了，但偏偏是这种时候？",color:"white",italic:false}','{text:"愚蠢至极，我无法忍受。",color:"white",italic:false}','{text:"细菌感染爆发，安保杀了许多无辜的人，事态已经无法控制。",color:"white",italic:false}']]
...
item replace block 90116 128 107 container.13 with flow_banner_pattern[custom_data={sea_doc29:true},custom_name='{text:"北冷冻库的笔记 - 戴德里克",italic:true,color:"dark_purple",italic:false}',lore=['{text:"诺玛的反抗队伍宁可错杀也不放过一人，甚至殃及了许多中立立场的钻井工人。",color:"white",italic:false}','{text:"现存有一大堆人因为不想被波及而逃回了物资层。",color:"white",italic:false}','{text:"我的任务则是尽可能保护他们不受攻击，现在整个平台的局势已经陷入混沌了。",color:"white",italic:false}','{text:"但北冷冻库的升降门紧闭，晚来的人最多只能逃到这里。",color:"white",italic:false}','{text:"我们打开了北部的通风系统，不然空气中的细菌浓度就太高了。",color:"white",italic:false}','{text:"我得上去和诺玛的人谈判，不能再这样下去了。",color:"white",italic:false}']]
item replace block 90116 128 107 container.26 with flow_banner_pattern[custom_data={sea_doc30:true},custom_name='{text:"北冷冻库的笔记 - 戴德里克？",italic:true,color:"dark_purple",italic:false}',lore=['{text:"诺玛，你这个骗子。",color:"white",italic:false}','{text:"你不得好死。",color:"white",italic:false}']]

item replace block 90028 52 -1846 container.13 with flow_banner_pattern[custom_data={sea_doc31:true},custom_name='{text:"终点前站的笔记 - 作者不明",italic:true,color:"dark_purple",italic:false}',lore=['{text:"因为你的命运，早已被吾钦定。世界的走向因此无法产生变动。",color:"white",italic:false}','{text:"你早已被正确之路祝福。",color:"white",italic:false}','{text:"无数次的尝试、无数次的死亡、无数次的时间倒流……",color:"white",italic:false}','{text:"全部的苦难，最终都会化为光辉的结局。",color:"white",italic:false}','{text:"你会见证一切。",color:"white",italic:false}','{text:"以雷米尔之名。",color:"white",italic:false}']]
...
'{text:"行政区吊车控制室的笔记 - 麦迪逊",italic:true,color:"dark_purple",italic:false}',\
lore=['{text:"我突然意识到，这些藤蔓归根究底是在模仿神庭的生命之树啊。",color:"white",italic:false}','{text:"但它们却只是粗糙而卑劣的伪造产物。",color:"white",italic:false}','{text:"我现在需要弄明白的，是为何受到细菌感染的植物会显现出一部分本该属于天使长的权能。",color:"white",italic:false}','{text:"这些古代细菌真的是被神镇压在地底峡谷之中的邪恶之物吗？",color:"white",italic:false}','{text:"说到底，它们也早就超脱了“细菌”的范畴。它们的扩散本身就存在着目的性。",color:"white",italic:false}','{text:"“道路的天使”，您究竟在尝试给我传达什么消息？",color:"white",italic:false}','{text:"……等等，等等！我全部明白了，我终于知道这一切背后的联系了！！",color:"white",italic:false}','{text:"圣水晶与细菌并非象征神明与某种不明势力的敌对。",color:"white",italic:false}','{text:"它们本身就是二位一体、互辅相成的存在！",color:"white",italic:false}','{text:"细菌为的就是带来死亡，而圣水晶则吸引了尽可能多的生命，这一切都是为了……",color:"white",italic:false}','{text:"原来如此，天使长雷米尔大人，我终于明白您的旨意了！！",color:"white",italic:false}']]
...
'{text:"通讯中心三楼的笔记 - 琼斯",italic:true,color:"dark_purple",italic:false}',\
lore=['{text:"诺曼博士的女儿，也就是诺玛……她向我们发动的攻势极为突然。",color:"white",italic:false}','{text:"我们很多人根本没做好武装冲突的打算。",color:"white",italic:false}','{text:"若不是圣水晶将绝大多数的热兵器都无效化了，我们的下场会十分凄惨。",color:"white",italic:false}','{text:"诺玛根本不清楚她在做什么，流血冲突只会使感染速度加快。",color:"white",italic:false}','{text:"她将短时间内对我们近乎无害的细菌感染转换为了钻井平台上所有人类的噩梦。",color:"white",italic:false}']]
