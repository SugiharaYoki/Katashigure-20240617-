...
#execute if block 90074 103 136 lectern if block 90081 101 137 minecraft:dark_oak_hanging_sign positioned 90128 136 20 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_spectral],Invisible:0b,Fixed:0b,Facing:5b,Item:{id:"minecraft:silence_armor_trim_smithing_template",components:{custom_name:{text:"超频声荡 I",italic:0b,color:"red"},custom_data:{sea_t_ripper1:true},lore:[{text:"音爆 I 发射磁锯会制造超音波",color:"white",italic:0b},{text:"可用于破坏绿色藤蔓",color:"white",italic:0b}]}}}

execute positioned 90078 123 136 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_crowbar],Invisible:0b,Fixed:0b,Facing:3b,Item:{id:"minecraft:copper_hoe",components:{custom_name:{text:"撬棍",italic:0b,color:"red"},custom_data:{sea_crowbar:true},attribute_modifiers:[{type:"attack_damage",slot:"mainhand",id:"sea_weapon:001_01",amount:1.5,operation:"add_value"},{type:"attack_speed",slot:"mainhand",id:"sea_weapon:001_02",amount:-1.5,operation:"add_value"}],unbreakable:{}}}}
execute positioned 90106 129 141 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_crowbar],Invisible:0b,Fixed:0b,Facing:3b,Item:{id:"minecraft:copper_hoe",components:{custom_name:{text:"撬棍",italic:0b,color:"red"},custom_data:{sea_crowbar:true},attribute_modifiers:[{type:"attack_damage",slot:"mainhand",id:"sea_weapon:001_01",amount:1.5,operation:"add_value"},{type:"attack_speed",slot:"mainhand",id:"sea_weapon:001_02",amount:-1.5,operation:"add_value"}],unbreakable:{}}}}
execute positioned 90088 129 120 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_leg],Invisible:0b,Fixed:0b,Facing:3b,Item:{id:"minecraft:leather_leggings",components:{custom_name:{text:"基础防护裤",italic:0b,color:"red"},custom_data:{sea_leg:true},attribute_modifiers:[{type:"armor",slot:"legs",id:"sea_armor:001_01",amount:1.0,operation:"add_value"},{type:"armor_toughness",slot:"legs",id:"sea_armor:001_02",amount:0.5,operation:"add_value"}],unbreakable:{}}}}
execute positioned 90074 129 133 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_feet],Invisible:0b,Fixed:0b,Facing:2b,Item:{id:"minecraft:leather_boots",components:{custom_name:{text:"基础防护靴",italic:0b,color:"red"},custom_data:{sea_feet:true},attribute_modifiers:[{type:"armor",slot:"feet",id:"sea_armor:008_01",amount:1.0,operation:"add_value"},{type:"armor_toughness",slot:"feet",id:"sea_armor:008_02",amount:0.5,operation:"add_value"}],unbreakable:{}}}}

execute positioned 90121 123 140 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_safehat],Invisible:0b,Fixed:0b,Facing:5b,Item:{id:"minecraft:copper_helmet",components:{custom_name:{text:"电工安全帽",italic:0b,color:"red"},custom_data:{sea_safehat:true},attribute_modifiers:[{type:"armor",slot:"head",id:"sea_armor:003_01",amount:1.0,operation:"add_value"},{type:"knockback_resistance",slot:"head",id:"sea_armor:003_02",amount:0.1,operation:"add_value"}],unbreakable:{}}}}
execute positioned 90123 123 100 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_safeaxe],Invisible:0b,Fixed:0b,Facing:4b,Item:{id:"minecraft:iron_axe",components:{custom_name:{text:"消防斧",italic:0b,color:"red"},custom_data:{sea_safeaxe:true},attribute_modifiers:[{type:"attack_damage",slot:"mainhand",id:"sea_weapon:004_01",amount:6.5,operation:"add_value"},{type:"attack_speed",slot:"mainhand",id:"sea_weapon:004_02",amount:-3.0,operation:"add_value"}],unbreakable:{}}}}
execute positioned 90137 129 137 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_crossbow],Invisible:0b,Fixed:0b,Facing:5b,Item:{id:"minecraft:crossbow",components:{custom_name:{text:"工程弩",italic:0b,color:"red"},custom_data:{sea_crossbow:true},unbreakable:{}}}}
execute positioned 90137 138 126 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_flamethrower],Invisible:0b,Fixed:0b,Facing:4b,Item:{id:"minecraft:shears",components:{custom_name:{text:"喷火器",italic:0b,color:"red"},custom_data:{sea_flamethrower:true},unbreakable:{}}}}
execute positioned 90120 156 143 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_crossbow],Invisible:0b,Fixed:0b,Facing:5b,Item:{id:"minecraft:crossbow",components:{custom_name:{text:"工程弩",italic:0b,color:"red"},custom_data:{sea_crossbow:true},unbreakable:{}}}}
...
execute if block 90074 103 136 lectern unless items entity @a[tag=SEAPT,tag=!SEAPF] container.* disc_fragment_5 positioned 90157 138 156 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_spectral],Invisible:1b,Fixed:0b,Facing:1b,Item:{id:"minecraft:pitcher_pod"}}
...
execute positioned 90193 31 158 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_shotgun],Invisible:0b,Fixed:0b,Facing:4b,Item:{id:"minecraft:snout_armor_trim_smithing_template",components:{custom_name:{text:"爆燃膛针",italic:0b,color:"red"},custom_data:{sea_t_shotgun1:true},lore:[{text:"急霰 I 解锁喷火器右键攻击",color:"white",italic:0b},{text:"对面前近距离造成大量伤害",color:"white",italic:0b},{text:"消耗一份燃爆剂",color:"red",italic:0b}]}}}

#地图
execute positioned 90102 123 121 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_map_01],Invisible:0b,Fixed:0b,Facing:5b,Item:{id:"minecraft:filled_map",components:{custom_name:{text:"维修层地图",italic:0b,color:"dark_purple"},map_id:4}}}
execute positioned 90081 129 123 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_map_02],Invisible:0b,Fixed:0b,Facing:4b,Item:{id:"minecraft:filled_map",components:{custom_name:{text:"物资层地图",italic:0b,color:"dark_purple"},map_id:5}}}
execute positioned 90172 22 100 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_map_04],Invisible:0b,Fixed:0b,Facing:3b,Item:{id:"minecraft:filled_map",components:{custom_name:{text:"冷凝系统地图",italic:0b,color:"dark_purple"},map_id:20}}}

execute if block 90062 103 135 grindstone positioned 90080 105 143 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_map_01],Invisible:0b,Fixed:0b,Facing:2b,Item:{id:"minecraft:filled_map",components:{custom_name:{text:"维修层地图",italic:0b,color:"dark_purple"},map_id:4}}}
execute if block 90075 103 141 minecraft:cauldron positioned 90079 105 143 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_map_02],Invisible:0b,Fixed:0b,Facing:2b,Item:{id:"minecraft:filled_map",components:{custom_name:{text:"物资层地图",italic:0b,color:"dark_purple"},map_id:5}}}
...
execute if block 90074 103 137 scaffolding positioned 90079 104 143 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_map_04],Invisible:0b,Fixed:0b,Facing:2b,Item:{id:"minecraft:filled_map",components:{custom_name:{text:"冷凝系统地图",italic:0b,color:"dark_purple"},map_id:20}}}
...
#船
execute positioned 90062 104 -165 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_safehat],Invisible:0b,Fixed:0b,Facing:4b,Item:{id:"minecraft:spyglass",components:{lore:[{text:"我随身携带的望远镜。",color:"white",italic:0b},{text:"在前途未知的时刻，紧握住它可以让我不再迷惘。",color:"white",italic:0b},{text:"手持时：显示任务目标 & 跳过已阅读的剧情对话",color:"green",italic:0b}]}}}

execute positioned 90058 104 -166 positioned ~ ~ ~300 if entity @a[tag=SEAPT,distance=0..5] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_safehat],Invisible:0b,Fixed:0b,Facing:1b,Item:{id:"minecraft:flow_banner_pattern",components:{custom_name:{text:"调查记录 6月29日 17:42",color:"dark_purple",italic:0b},custom_data:{sea_doc01:true},lore:[{text:"记录者为忒尔克西钻井平台调查小组成员，也是我本人。",color:"white",italic:0b},{text:"钻井平台距离失联已经超过36小时，我们在黄昏之时赶到了平台的西南驳口。",color:"white",italic:0b},{text:"整座海上设施此时一片死寂，至少上百名的工作人员皆数不见踪影。",color:"white",italic:0b}]}}}
execute positioned 90062 104 -165 positioned ~ ~ ~300 if entity @a[tag=SEAPT,distance=0..5] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_safehat],Invisible:0b,Fixed:0b,Facing:4b,Item:{id:"minecraft:spyglass",components:{lore:[{text:"我随身携带的望远镜。",color:"white",italic:0b},{text:"在前途未知的时刻，紧握住它可以让我不再迷惘。",color:"white",italic:0b},{text:"手持时：显示任务目标 & 跳过已阅读的剧情对话",color:"green",italic:0b}]}}}
