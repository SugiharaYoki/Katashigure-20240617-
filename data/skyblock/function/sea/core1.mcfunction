...
execute positioned 90129 144 141 if entity @a[tag=SEAPT,distance=0..20,limit=1] unless entity @n[type=glow_item_frame,distance=..1] unless entity @n[type=item_frame,distance=..1] run summon minecraft:glow_item_frame ~ ~ ~
