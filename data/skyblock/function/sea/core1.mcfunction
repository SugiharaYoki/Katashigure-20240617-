...
execute positioned 90128 136 20 if entity @a[tag=SEAPT,distance=0..20,limit=1] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_spectral],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:5b,Item:{id:"minecraft:silence_armor_trim_smithing_template",components:{custom_name:'{"text":"超频声荡 I","italic":false,"color":"red"}',custom_data:{sea_t_ripper1:true},lore:['{"text":"音爆 I 发射磁锯会制造超音波","color":"white","italic":false}','{"text":"可用于破坏绿色藤蔓","color":"white","italic":false}']}}}
