...
execute positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.18 with trial_key[custom_name='{"text":"器械室钥匙","italic":true,"color":"yellow","italic":false}']
execute positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.12 with trial_key[custom_name='{"text":"文件柜A钥匙","italic":true,"color":"yellow","italic":false}']
execute positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.1 with trial_key[custom_name='{"text":"西南驳口招待室钥匙","italic":true,"color":"yellow","italic":false}']
execute positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.16 with trial_key[custom_name='{"text":"工具维护室钥匙","italic":true,"color":"yellow","italic":false}']
execute positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.4 with trial_key[custom_name='{"text":"文件柜B钥匙","italic":true,"color":"yellow","italic":false}']
execute positioned 90104 122 131 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.22 with trial_key[custom_name='{"text":"文件柜C钥匙","italic":true,"color":"yellow","italic":false}']
execute positioned 90091 122 130 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.3 with trial_key[custom_name='{"text":"扫除用具间钥匙","italic":true,"color":"yellow","italic":false}']
execute positioned 90118 128 120 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.13 with trial_key[custom_name='{"text":"空气循环控制室钥匙","italic":true,"color":"yellow","italic":false}']
execute positioned 90122 137 120 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.13 with trial_key[custom_name='{"text":"器械资源室2F 燃料架 - B","italic":true,"color":"yellow","italic":false}']
execute positioned 90114 123 125 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.14 with trial_key[custom_name='{"text":"器械资源室2F 燃料架 - A 内有慰问品","italic":true,"color":"yellow","italic":false}']
execute positioned 90142 134 138 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.14 with trial_key[custom_name='{"text":"宿舍楼3楼某处的钥匙","italic":true,"color":"yellow","italic":false}']
...
execute positioned 90104 155 151 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.13 with trial_key[custom_name='{"text":"副宿舍楼2F - 个人储藏柜2B的钥匙","italic":true,"color":"yellow","italic":false}',lore=['{"text":"没错，就是最中间那个，别多想了！","color":"white","italic":false}']]
execute positioned 90104 140 029 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.12 with trial_key[custom_name='{"text":"停机坪仓库的钥匙","italic":true,"color":"yellow","italic":false}',lore=['{"text":"他们绝对想不到我在里头藏了多少弹药","color":"white","italic":false}']]
execute positioned 90173 006 104 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.13 with trial_key[custom_name='{"text":"冷凝系统 - 休息区2F钥匙","italic":true,"color":"yellow","italic":false}']
execute positioned 90140 104 023 if entity @a[distance=..6.2,limit=1] run item replace block ~ ~ ~ container.13 with ominous_trial_key[custom_name='{"text":"厄珀娅之钥","italic":true,"color":"dark_red","italic":false}']
