...
item replace block 90110 128 135 container.15 with dune_armor_trim_smithing_template[custom_name='{"text":"金砂石板","italic":true,"color":"light_purple","italic":false}'] 1
...
item replace block 90088 131 118 container.12 with wayfinder_armor_trim_smithing_template[custom_name='{"text":"醒殉徒石板","italic":true,"color":"light_purple","italic":false}'] 2
item replace block 90088 131 118 container.14 with wild_armor_trim_smithing_template[custom_name='{"text":"狂荒石板","italic":true,"color":"light_purple","italic":false}'] 2
