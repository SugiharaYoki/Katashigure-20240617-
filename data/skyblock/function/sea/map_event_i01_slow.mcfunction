...
summon drowned 90097 123 148 {CustomName:'[{text:"安全帽腐尸"}]',DeathLootTable:"skyblock:sea_drowned1",Tags:["SEAmob"],attributes:[{id:"attack_damage",base:4.0},{id:"movement_speed",base:0.17}],equipment:{feet:{},legs:{},chest:{},head:{id:iron_helmet,count:1}},drop_chances:{feet:0f,legs:0f,chest:0f,head:0f}}
