...
execute as @a[tag=SEAPT,tag=e_w_02] at @s if entity @s[nbt=!{Inventory:[{id:"minecraft:iron_axe"}]}] run give @s iron_axe[custom_name='{"text":"消防斧","italic":false,"color":"red"}',custom_data={sea_safeaxe:true},attribute_modifiers=[{type:"generic.attack_damage",slot:"hand",id:"sea_weapon:004_01",amount:8.0,operation:"add_value"},{type:"generic.attack_speed",slot:"hand",id:"sea_weapon:004_02",amount:-2.5,operation:"add_value"}],unbreakable={}]
