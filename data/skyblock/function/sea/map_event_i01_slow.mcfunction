...
execute as @n[tag=sc,scores={sea_4temp2=..3950,sea_speedrun_ch1=..2160}] if entity @a[tag=SEAPT,x=90074,y=122,z=118,distance=0..4] run scoreboard players set @n[tag=sc] sea_4temp2 6000
