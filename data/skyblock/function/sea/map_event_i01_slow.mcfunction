...
#初始之船
execute positioned 90058 104 -166 positioned ~ ~ ~300 if entity @a[tag=SEAPT,distance=0..20] run summon minecraft:item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_safehat],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:1b,Item:{id:"minecraft:flow_banner_pattern",components:{custom_name:'{"text":"调查记录 6月29日 17:42","italic":true,"color":"dark_purple","italic":false}',custom_data:{sea_doc01:true},lore:['{"text":"记录者为忒尔克西钻井平台调查小组成员，也是我本人。","color":"white","italic":false}','{"text":"钻井平台距离失联已经超过36小时，我们在黄昏之时赶到了平台的西南驳口。","color":"white","italic":false}','{"text":"整座海上设施此时一片死寂，至少上百名的工作人员皆数不见踪影。","color":"white","italic":false}']}}}
execute positioned 90058 104 -166 if entity @a[tag=SEAPT,distance=0..20] run summon minecraft:item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_safehat],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:4b,Item:{id:"minecraft:spyglass",components:{lore:['{"text":"我随身携带的望远镜。","color":"white","italic":false}','{"text":"在前途未知的时刻，紧握住它可以让我不再迷惘。","color":"white","italic":false}','{"text":"手持时：显示任务目标 & 跳过已阅读的剧情对话","color":"green","italic":false}']}}}
execute positioned 90058 104 -166 positioned ~ ~ ~300 if entity @a[tag=SEAPT,distance=0..20] run summon minecraft:item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_safehat],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:4b,Item:{id:"minecraft:spyglass",components:{lore:['{"text":"我随身携带的望远镜。","color":"white","italic":false}','{"text":"在前途未知的时刻，紧握住它可以让我不再迷惘。","color":"white","italic":false}','{"text":"手持时：显示任务目标 & 跳过已阅读的剧情对话","color":"green","italic":false}']}}}
...
execute as @n[tag=sc,scores={sea_4temp2=1144}] positioned 90074.0 129 109.0 run stopsound @a[distance=0..500] music
...
execute as @n[tag=sc,scores={sea_4temp2=6037}] at @n[tag=SEAframauros] run tellraw @a[tag=SEAPT,distance=0.1..35] [{"text":"法莫洛斯：","color":"green","bold": true},{"text":"\n“太好了……终于有人来，代替我救他们了……”","color":"white","bold": false}]
...
execute as @n[tag=sc,scores={sea_4temp2=6098}] at @n[tag=SEAframauros] run tellraw @a[tag=SEAPT,distance=0.1..35] [{"text":"法莫洛斯：","color":"green","bold": true},{"text":"\n“太晚了，我的朋友……”","color":"white","bold": false}]
execute as @n[tag=sc,scores={sea_4temp2=6119}] at @n[tag=SEAframauros] run playsound entity.villager.ambient neutral @a ~ ~ ~ 0.8 0.7
execute as @n[tag=sc,scores={sea_4temp2=6119}] at @n[tag=SEAframauros] run tellraw @a[tag=SEAPT,distance=0.1..35] [{"text":"法莫洛斯：","color":"green","bold": true},{"text":"\n“我……活不了多久了。感染……开始，就无法停下。”","color":"white","bold": false}]
...
execute as @n[tag=sc,scores={sea_4temp2=6190}] at @n[tag=SEAframauros] run tellraw @a[tag=SEAPT,distance=0.1..35] [{"text":"法莫洛斯：","color":"green","bold": true},{"text":"\n“是啊……还有多少人活着呢。\n他们才是……不幸运的那批人吧。”","color":"white","bold": false}]
...
execute as @n[tag=sc,scores={sea_4temp2=6264}] at @n[tag=SEAframauros] run tellraw @a[tag=SEAPT,distance=0.1..35] [{"text":"法莫洛斯：","color":"green","bold": true},{"text":"\n“上面一定还有活人……请代替我救他们。我已经没有……时间了。”","color":"white","bold": false}]
execute as @n[tag=sc,scores={sea_4temp2=6304}] at @n[tag=SEAframauros] run playsound entity.villager.ambient neutral @a ~ ~ ~ 0.8 0.7
execute as @n[tag=sc,scores={sea_4temp2=6304}] at @n[tag=SEAframauros] run tellraw @a[tag=SEAPT,distance=0.1..35] [{"text":"法莫洛斯：","color":"green","bold": true},{"text":"\n“以及……”","color":"white","bold": false}]
execute as @n[tag=sc,scores={sea_4temp2=6334}] at @n[tag=SEAframauros] run playsound entity.villager.ambient neutral @a ~ ~ ~ 0.8 0.7
execute as @n[tag=sc,scores={sea_4temp2=6334}] at @n[tag=SEAframauros] run tellraw @a[tag=SEAPT,distance=0.1..35] [{"text":"法莫洛斯：","color":"green","bold": true},{"text":"\n“能杀了我吗……？”","color":"white","bold": false}]
...
execute as @n[tag=sc,scores={sea_4temp2=6534}] at @n[tag=SEAframauros] run tellraw @a[tag=SEAPT,distance=0.1..35] [{"text":"法莫洛斯：","color":"green","bold": true},{"text":"\n“求求你……我没有多少时间了……”","color":"white","bold": false}]
execute as @n[tag=sc,scores={sea_4temp2=6634}] at @n[tag=SEAframauros] run playsound entity.villager.ambient neutral @a ~ ~ ~ 0.8 0.7
execute as @n[tag=sc,scores={sea_4temp2=6634}] at @n[tag=SEAframauros] run tellraw @a[tag=SEAPT,distance=0.1..35] [{"text":"法莫洛斯：","color":"green","bold": true},{"text":"\n“我需要……保持、……我该自杀，对吗？……”","color":"white","bold": false}]
execute as @n[tag=sc,scores={sea_4temp2=6734}] at @n[tag=SEAframauros] run playsound entity.villager.ambient neutral @a ~ ~ ~ 0.8 0.7
execute as @n[tag=sc,scores={sea_4temp2=6734}] at @n[tag=SEAframauros] run tellraw @a[tag=SEAPT,distance=0.1..35] [{"text":"法莫洛斯：","color":"yellow","bold": true},{"text":"\n“快要……来不及……了……”","color":"white","bold": false}]
execute as @n[tag=sc,scores={sea_4temp2=6834}] at @n[tag=SEAframauros] run playsound entity.villager.ambient neutral @a ~ ~ ~ 0.8 0.7
execute as @n[tag=sc,scores={sea_4temp2=6834}] at @n[tag=SEAframauros] run tellraw @a[tag=SEAPT,distance=0.1..35] [{"text":"法莫洛斯：","color":"yellow","bold": true},{"text":"\n“我本该……有时间……自杀的……”","color":"white","bold": false}]
