...
execute as @n[tag=sc,scores={sea_4temp2=6003..7000}] at @n[tag=SEAframauros] if entity @a[tag=SEAPT,distance=0.1..5] run function skyblock:sea/e/ch1/boss1_framauros_alive
