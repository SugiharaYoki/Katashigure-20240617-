...
execute if items entity @p container.* fire_charge as @a[tag=SEAPT,advancements={skyblock:sea/doc/g24=false}] at @s if items entity @s container.* fire_charge run advancement grant @s only skyblock:sea/doc/g24
