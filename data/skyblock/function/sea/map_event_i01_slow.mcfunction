...
execute as @n[tag=sc,scores={sea_4temp2=6000..6002}] run scoreboard players add @n[tag=sc] sea_4temp2 1
execute as @n[tag=sc,scores={sea_4temp2=6000..6003}] run function skyblock:sea/e/ch1/boss1_framauros_alive
execute as @n[tag=sc,scores={sea_4temp2=6004..7000}] at @n[tag=SEAframauros] if entity @a[tag=SEAPT,distance=0.1..5] run function skyblock:sea/e/ch1/boss1_framauros_alive
