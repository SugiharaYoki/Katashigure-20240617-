...
execute if entity @s[tag=sea_t_speed4] run data modify entity @n[tag=SEAenchant_illum3] CustomName set value '" IV "'
...
execute if entity @s[tag=!sea_t_speed4] run data modify entity @n[tag=SEAenchant_illum3] CustomName set value '"  "'
...
execute if entity @s[tag=sea_t_attackspeed4] run data modify entity @n[tag=SEAenchant_illum3] CustomName set value '" IV "'
...
execute if entity @s[tag=!sea_t_attackspeed4] run data modify entity @n[tag=SEAenchant_illum3] CustomName set value '"  "'
tellraw @s [{"text":" 烈躁之魂 ","color":"light_purple"},{"selector":"@n[tag=SEAenchant_illum1]","color":"dark_purple"},{"selector":"@n[tag=SEAenchant_illum2]","color":"dark_purple"},{"selector":"@n[tag=SEAenchant_illum3]","color":"dark_purple"}]
...
execute if entity @s[tag=SEAPT] run tellraw @s [{"text":" Lv3-4 "},{"text":"沧没辙合的华尔兹：烈躁/敏捷  ","color":"white"},{"score":{"name":"@s","objective":"sea_i_trim_zombie"},"color":"light_purple"},{"text":"/10 牧羊人石板 ","color":"light_purple"},{"text":"〈◆〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger sea_crafter set 20001"}}]
