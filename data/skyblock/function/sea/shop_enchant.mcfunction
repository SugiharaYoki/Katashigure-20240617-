...
execute if entity @s[tag=SEAPT] run tellraw @s [{"text":" Lv3-4 "},{"text":"沧没辙合的华尔兹：烈躁/敏捷  ","color":"white"},{"score":{"name":"@s","objective":"sea_i_trim_zombie"},"color":"light_purple"},{"text":"/10 牧羊人石板 ","color":"light_purple"},{"text":"〈◆〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger sea_crafter set 20022"}}]
