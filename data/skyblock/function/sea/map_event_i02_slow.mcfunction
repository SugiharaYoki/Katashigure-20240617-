...
execute if entity @a[tag=SEAPT] as @n[tag=sc,scores={sea_4temp2=5001..5005}] as @a run bossbar remove 9066601
execute if entity @a[tag=SEAPT] as @n[tag=sc,scores={sea_4temp2=5001..5005}] as @a run bossbar set 9066601 visible false
execute if entity @a[tag=SEAPT] as @n[tag=sc,scores={sea_4temp2=5001..5005}] run bossbar set minecraft:9066601 players @s
