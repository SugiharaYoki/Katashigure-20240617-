...
execute if entity @n[tag=sc,scores={sea_4temp2=2113..3999}] as @n[tag=SEAboss2,scores={rng2=3,sea_boss1_hp=36..},tag=SEAboss2bow] run item replace entity @s weapon.offhand with arrow
