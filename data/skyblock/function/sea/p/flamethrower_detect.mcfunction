...
execute if entity @s[tag=sea_w_ripper_skill_range_1] positioned ^ ^ ^4.3 run function skyblock:sea/p/flamethrower_effect
execute if entity @s[tag=sea_w_ripper_skill_range_2] positioned ^ ^ ^4.8 run function skyblock:sea/p/flamethrower_effect
