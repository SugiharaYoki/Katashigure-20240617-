...
execute as @n[type=interaction,tag=flamethrowerdetect] on target if entity @s[level=1..] anchored eyes positioned ^ ^ ^1.8 as @e[tag=SEAmob,distance=0..1.5] run damage @s 1.5 campfire
execute as @n[type=interaction,tag=flamethrowerdetect] on target if entity @s[level=1..] anchored eyes positioned ^ ^ ^2.3 as @e[tag=SEAmob,distance=0..1.5] run damage @s 1.5 campfire
