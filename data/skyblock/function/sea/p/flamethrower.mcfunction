...
execute as @n[type=interaction,tag=flamethrowerdetect] on target if items entity @s weapon.mainhand music_disc_5 if items entity @s[scores={sea_ripper=..0}] container.* minecraft:disc_fragment_5 anchored eyes run function skyblock:sea/p/ripper
