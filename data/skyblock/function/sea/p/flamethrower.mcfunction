...
execute as @n[type=interaction,tag=flamethrowerdetect] on target anchored eyes run particle flame ^ ^ ^1.3 0.1 0.1 0.1 0.01 5
execute as @n[type=interaction,tag=flamethrowerdetect] on target anchored eyes run particle flame ^ ^ ^1.8 0.1 0.1 0.1 0.01 5
execute as @n[type=interaction,tag=flamethrowerdetect] on target anchored eyes run particle flame ^ ^ ^2.3 0.1 0.1 0.1 0.01 5
execute as @n[type=interaction,tag=flamethrowerdetect] on target anchored eyes run particle flame ^ ^ ^2.8 0.1 0.1 0.1 0.01 5
execute as @n[type=interaction,tag=flamethrowerdetect] on target anchored eyes run particle flame ^ ^ ^3.3 0.1 0.1 0.1 0.01 5
execute as @n[type=interaction,tag=flamethrowerdetect] on target anchored eyes run particle flame ^ ^ ^3.8 0.1 0.1 0.1 0.01 5
execute as @n[type=interaction,tag=flamethrowerdetect] on target anchored eyes run particle flame ^ ^ ^4.3 0.1 0.1 0.1 0.01 5
