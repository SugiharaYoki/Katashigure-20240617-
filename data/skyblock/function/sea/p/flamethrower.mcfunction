...
execute unless entity @n[type=interaction,tag=flamethrowerdetect,distance=..0.3] anchored eyes run summon interaction ^ ^0 ^0 {Tags:["flamethrowerdetect"]}
execute if entity @n[type=interaction,tag=flamethrowerdetect,distance=..0.3] anchored eyes run tp @n[type=interaction,tag=flamethrowerdetect,distance=..0.3] ^ ^0 ^0
