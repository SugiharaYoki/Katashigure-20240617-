...
execute store result score @s[scores={rng2=1,rng1=..2}] rng1 run random value 3..7
...
execute as @s[scores={rng1=6}] at @s run particle electric_spark ~ ~1 ~ 0.3 0.3 0.3 0.03 5
execute as @s[scores={rng1=4}] at @s run particle electric_spark ~ ~1 ~ 0.3 0.3 0.3 0.03 5
execute as @s[scores={rng1=2}] at @s run particle electric_spark ~ ~1 ~ 0.3 0.3 0.3 0.03 5
