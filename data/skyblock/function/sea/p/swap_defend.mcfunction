execute if items entity @s weapon.offhand air unless items entity @s weapon.mainhand shield run tag @s add swapdefend_case_1
...
execute if items entity @s weapon.mainhand shield unless items entity @s weapon.mainhand air run tag @s add swapdefend_case_2
