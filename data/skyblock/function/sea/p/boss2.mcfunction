...
execute as @s[tag=!boss2hplock3,scores={rng1=1,sea_4temp8=1..40}] at @s positioned ~-2 ~ ~1 if block ~ ~ ~ air unless block ~ ~-1 ~ air run summon evoker_fangs
execute as @s[tag=!boss2hplock3,scores={rng1=2,sea_4temp8=1..40}] at @s positioned ~-2 ~ ~-1 if block ~ ~ ~ air unless block ~ ~-1 ~ air run summon evoker_fangs
execute as @s[tag=!boss2hplock3,scores={rng1=3,sea_4temp8=1..40}] at @s positioned ~-2 ~ ~ if block ~ ~ ~ air unless block ~ ~-1 ~ air run summon evoker_fangs
execute as @s[tag=!boss2hplock3,scores={rng1=4,sea_4temp8=1..40}] at @s positioned ~2 ~ ~1 if block ~ ~ ~ air unless block ~ ~-1 ~ air run summon evoker_fangs
execute as @s[tag=!boss2hplock3,scores={rng1=5,sea_4temp8=1..40}] at @s positioned ~2 ~ ~-1 if block ~ ~ ~ air unless block ~ ~-1 ~ air run summon evoker_fangs
execute as @s[tag=!boss2hplock3,scores={rng1=6,sea_4temp8=1..40}] at @s positioned ~2 ~ ~ if block ~ ~ ~ air unless block ~ ~-1 ~ air run summon evoker_fangs
