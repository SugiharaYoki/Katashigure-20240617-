...
#execute if entity @n[tag=sc,scores={sea_4temp2=2114..2117}] as @s at @s positioned ~ ~1.5 ~-0.3 run playsound minecraft:item.crossbow.shoot hostile @a ~ ~ ~ 1.0 0.7
execute if entity @n[tag=sc,scores={sea_4temp2=2124..2127}] as @s at @s positioned ~-0.6 ~1.3 ~ run playsound minecraft:item.crossbow.shoot hostile @a ~ ~ ~ 1.0 0.7
execute if entity @n[tag=sc,scores={sea_4temp2=2124..2127}] as @s at @s positioned ~ ~1.5 ~0.6 run summon arrow ~ ~ ~ {Motion:[-1.8d,0d,0d]}
execute if entity @n[tag=sc,scores={sea_4temp2=2124..2127}] as @s at @s positioned ~ ~1.5 ~-0.6 run summon arrow ~ ~ ~ {Motion:[-1.8d,0d,0d]}
execute if entity @n[tag=sc,scores={sea_4temp2=2124..2127}] as @s at @s positioned ~-0.6 ~1.3 ~ run summon arrow ~ ~ ~ {Motion:[-1.8d,0d,0d]}
execute if entity @n[tag=sc,scores={sea_4temp2=2123..2126}] as @s at @s positioned ~ ~1.5 ~0.6 run particle minecraft:sculk_soul ~ ~ ~ 0.1 0.1 0.1 0 3
execute if entity @n[tag=sc,scores={sea_4temp2=2123..2126}] as @s at @s positioned ~ ~1.5 ~-0.6 run particle minecraft:sculk_soul ~ ~ ~ 0.1 0.1 0.1 0 3
execute if entity @n[tag=sc,scores={sea_4temp2=2123..2126}] as @s at @s positioned ~-0.6 ~1.3 ~ run particle minecraft:sculk_soul ~ ~ ~ 0.1 0.1 0.1 0 3
...
execute as @s[scores={rng1=1,sea_4temp8=21..40}] at @s positioned ~-1 ~ ~1 if block ~ ~ ~ air unless block ~ ~-1 ~ air run summon evoker_fangs
execute as @s[scores={rng1=2,sea_4temp8=21..40}] at @s positioned ~-1 ~ ~-1 if block ~ ~ ~ air unless block ~ ~-1 ~ air run summon evoker_fangs
execute as @s[scores={rng1=3,sea_4temp8=21..40}] at @s positioned ~-1 ~ ~ if block ~ ~ ~ air unless block ~ ~-1 ~ air run summon evoker_fangs
execute as @s[scores={rng1=4,sea_4temp8=21..40}] at @s positioned ~1 ~ ~1 if block ~ ~ ~ air unless block ~ ~-1 ~ air run summon evoker_fangs
execute as @s[scores={rng1=5,sea_4temp8=21..40}] at @s positioned ~1 ~ ~-1 if block ~ ~ ~ air unless block ~ ~-1 ~ air run summon evoker_fangs
execute as @s[scores={rng1=6,sea_4temp8=21..40}] at @s positioned ~1 ~ ~ if block ~ ~ ~ air unless block ~ ~-1 ~ air run summon evoker_fangs
execute as @s[scores={rng1=7,sea_4temp8=21..40}] at @s positioned ~ ~ ~1 if block ~ ~ ~ air unless block ~ ~-1 ~ air run summon evoker_fangs
execute as @s[scores={rng1=8,sea_4temp8=21..40}] at @s positioned ~ ~ ~-1 if block ~ ~ ~ air unless block ~ ~-1 ~ air run summon evoker_fangs
execute as @s[scores={rng1=1,sea_4temp8=21..40}] at @s positioned ~-1 ~-1 ~1 if block ~ ~ ~ air unless block ~ ~-1 ~ air run summon evoker_fangs
execute as @s[scores={rng1=2,sea_4temp8=21..40}] at @s positioned ~-1 ~-1 ~-1 if block ~ ~ ~ air unless block ~ ~-1 ~ air run summon evoker_fangs
execute as @s[scores={rng1=3,sea_4temp8=21..40}] at @s positioned ~-1 ~-1 ~ if block ~ ~ ~ air unless block ~ ~-1 ~ air run summon evoker_fangs
execute as @s[scores={rng1=4,sea_4temp8=21..40}] at @s positioned ~1 ~-1 ~1 if block ~ ~ ~ air unless block ~ ~-1 ~ air run summon evoker_fangs
execute as @s[scores={rng1=5,sea_4temp8=21..40}] at @s positioned ~1 ~-1 ~-1 if block ~ ~ ~ air unless block ~ ~-1 ~ air run summon evoker_fangs
execute as @s[scores={rng1=6,sea_4temp8=21..40}] at @s positioned ~1 ~-1 ~ if block ~ ~ ~ air unless block ~ ~-1 ~ air run summon evoker_fangs
execute as @s[scores={rng1=7,sea_4temp8=21..40}] at @s positioned ~ ~-1 ~1 if block ~ ~ ~ air unless block ~ ~-1 ~ air run summon evoker_fangs
execute as @s[scores={rng1=8,sea_4temp8=21..40}] at @s positioned ~ ~-1 ~-1 if block ~ ~ ~ air unless block ~ ~-1 ~ air run summon evoker_fangs
