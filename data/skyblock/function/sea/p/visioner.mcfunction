...
execute as @a[tag=SEAvisioned_WARN,tag=!SEAvisioned,scores={sea_visioned=..0}] run attribute @s generic.jump_strength modifier remove sea:mob_debuff_visioned01
