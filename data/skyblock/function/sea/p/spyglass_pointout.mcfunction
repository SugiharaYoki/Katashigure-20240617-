...
execute if score @s SEA_if_spying matches 1.. at @s positioned ~ ~1 ~ as @n[tag=SEA_spyglass_pointout_marker,distance=0..0.5] if score @s SEAPT_member_eternal = @p SEAPT_member_eternal as @p at @s run tp @n[tag=SEA_spyglass_pointout_marker,distance=0..0.5] ^ ^ ^-0.05 facing entity @s
