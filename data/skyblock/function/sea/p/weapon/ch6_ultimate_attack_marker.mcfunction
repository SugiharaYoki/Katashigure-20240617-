...
execute if score @s rng1 matches 4.. rotated ~ 0 run particle soul_fire_flame ^0.4 ^2.2 ^1 0 0 0 0 1
execute if score @s rng1 matches 5.. rotated ~ 0 run particle soul_fire_flame ^0.8 ^2.2 ^1 0 0 0 0 1
execute if score @s rng1 matches 6.. rotated ~ 0 run particle soul_fire_flame ^1.2 ^2.2 ^1 0 0 0 0 1
execute if score @s rng1 matches 7.. rotated ~ 0 run particle soul_fire_flame ^1.6 ^2.2 ^1 0 0 0 0 1
execute if score @s rng1 matches 4.. rotated ~ 0 run particle soul_fire_flame ^-0.4 ^2.2 ^1 0 0 0 0 1
execute if score @s rng1 matches 5.. rotated ~ 0 run particle soul_fire_flame ^-0.8 ^2.2 ^1 0 0 0 0 1
execute if score @s rng1 matches 6.. rotated ~ 0 run particle soul_fire_flame ^-1.2 ^2.2 ^1 0 0 0 0 1
execute if score @s rng1 matches 7.. rotated ~ 0 run particle soul_fire_flame ^-1.6 ^2.2 ^1 0 0 0 0 1
