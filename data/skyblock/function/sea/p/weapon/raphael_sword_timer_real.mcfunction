...
execute as @e[tag=sea_raphael_sword,type=armor_stand,scores={sea_4temp1=1..38}] at @s run particle flame ^ ^ ^2.2 0.23 0.1 0.23 0.03 5
execute as @e[tag=sea_raphael_sword,type=armor_stand,scores={sea_4temp1=1..38}] at @s run particle flame ^ ^ ^2.5 0.23 0.1 0.23 0.03 5
execute as @e[tag=sea_raphael_sword,type=armor_stand,scores={sea_4temp1=1..38}] at @s run particle flame ^ ^ ^4.2 0.28 0.2 0.28 0.03 5
execute as @e[tag=sea_raphael_sword,type=armor_stand,scores={sea_4temp1=1..38}] at @s run particle flame ^ ^ ^4.5 0.28 0.2 0.28 0.03 5
...
execute as @e[tag=sea_raphael_sword,type=armor_stand,scores={sea_4temp1=1..4}] at @s run playsound entity.blaze.shoot player @a ^ ^ ^4.2 0.7 1.5
...
execute as @e[tag=sea_raphael_sword,type=armor_stand,scores={sea_4temp1=1..38}] at @s positioned ^ ^ ^2.2 positioned ~ ~-0.5 ~ as @e[tag=SEAmob,distance=0..2.1] run damage @s 5 on_fire
...
execute as @e[tag=sea_raphael_sword,type=armor_stand,scores={sea_4temp1=1..38}] at @s positioned ^ ^ ^4.2 positioned ~ ~-0.5 ~ as @e[tag=SEAmob,distance=0..2.1] anchored eyes run particle crit ~ ~ ~ 0 0 0 0.03 3
execute as @e[tag=sea_raphael_sword,type=armor_stand,scores={sea_4temp1=1..38}] at @s positioned ^ ^ ^4.2 positioned ~ ~-0.5 ~ as @e[tag=SEAmob,distance=0..2.1] anchored eyes run playsound entity.generic.explode player @a ~ ~ ~ 0.9 1.1
execute as @e[tag=sea_raphael_sword,type=armor_stand,scores={sea_4temp1=1..38}] at @s positioned ^ ^ ^4.2 positioned ~ ~-0.5 ~ as @e[tag=SEAmob,distance=0..2.1] run damage @s 5 on_fire
execute as @e[tag=sea_raphael_sword,type=armor_stand,scores={sea_4temp1=1..38}] at @s positioned ^ ^ ^4.2 positioned ~ ~-0.5 ~ as @e[tag=SEAmob,distance=0..2.1] run data modify entity @s Fire set value 20s
