...
execute as @e[tag=sea_raphael_sword,type=marker,scores={sea_4temp1=1..38}] at @s positioned ^ ^ ^1.2 positioned ~ ~-0.5 ~ as @e[tag=SEAmob,distance=0..1] run damage @s 3 fire
