...
execute store result score @s[scores={rng1=2..9}] rng1 run random value 1..10
execute store result score @s[scores={rng1=1}] rng1 run random value 2..9
execute if entity @a[tag=SEAPT,distance=0..14] unless entity @s[scores={rng1=-5..}] run scoreboard players set @s rng1 5
execute store result score @s[scores={rng1=10}] rng1 run random value 2..9
