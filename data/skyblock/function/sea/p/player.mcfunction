...
execute if entity @s[tag=!e_w_06] if items entity @s container.* music_disc_5[custom_data={sea_flamethrower:true}] run tellraw @s {"text": "短程武器，右键后消耗一枚锯片，在身前牵引持续对怪物造成伤害的磁锯。","color": "white"}
