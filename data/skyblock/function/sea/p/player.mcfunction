...
execute if items entity @s player.cursor *[custom_data={"SEAcrafterbox":true}] as @n[tag=SEAcrafter,type=interaction,x=90000,y=0,z=0,distance=..9] at @s positioned ~ ~-1 ~ run function skyblock:sea/shop_reader_box
