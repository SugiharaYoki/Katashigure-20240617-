...
item replace entity @s[tag=sea_t_spectral1,tag=!sea_t_spectral2] player.crafting.0 with flow_armor_trim_smithing_template[custom_name={text:"光棱魔板",italic:true,color:"light_purple",italic:0b},lore=[{text:"静滞光棱 I",color:"white",italic:0b},{text:"箭矢路径的小范围内怪物大幅减速",color:"white",italic:0b}],custom_data={sea_t_spectral1:true}]
item replace entity @s[tag=sea_t_spectral2] player.crafting.0 with flow_armor_trim_smithing_template[custom_name={text:"二型光棱魔板",italic:true,color:"light_purple",italic:0b},lore=[{text:"静滞光棱 II",color:"white",italic:0b},{text:"箭矢路径的小范围内怪物大幅减速",color:"white",italic:0b},{text:"若持有光棱箭，将自动上膛",color:"white",italic:0b}],custom_data={sea_t_spectral2:true}]
item replace entity @s player.crafting.1 with barrier
item replace entity @s[tag=sea_t_sprint,tag=!sea_t_sprint_disabled] player.crafting.1 with flow_armor_trim_smithing_template[custom_name={text:"残影魔板",italic:true,color:"light_purple",italic:0b},lore=[{text:"绿色指示灯亮起时，起跑将被替换为冲刺",color:"white",italic:0b},{text:"期间防御、移动速度、击退抗性巨幅提升",color:"white",italic:0b},{text:"点击禁用",color:"green",italic:0b,bold: true}],custom_data={sea_t_sprint:true}]
item replace entity @s[tag=sea_t_sprint,tag=sea_t_sprint_disabled] player.crafting.1 with flow_armor_trim_smithing_template[custom_name={text:"残影魔板 - 禁用中",italic:true,color:"light_purple",italic:0b},lore=[{text:"绿色指示灯亮起时，起跑将被替换为冲刺",color:"white",italic:0b},{text:"期间防御、移动速度、击退抗性巨幅提升",color:"white",italic:0b},{text:"点击启用",color:"green",italic:0b,bold: true}],custom_data={sea_t_sprint_disabled:true},enchantments={"vanishing_curse":1}]

item replace entity @s player.crafting.2 with barrier
execute unless block 90074 103 137 minecraft:scaffolding run item replace entity @s player.crafting.2 with flow_armor_trim_smithing_template[custom_name={text:"趋蕴魔板 - 无效",italic:true,color:"light_purple",italic:0b},lore=[{text:"虽然凭空出现在了我的背包内，",color:"white",italic:0b},{text:"但我从中感知不到任何深邃的魔力。",color:"white",italic:0b}],custom_data={sea_t_pounce_disabled:true},enchantments={"vanishing_curse":1}]
execute if block 90074 103 137 minecraft:scaffolding run item replace entity @s[tag=sea_t_pounce1,tag=!sea_t_pounce_disabled] player.crafting.2 with flow_armor_trim_smithing_template[custom_name={text:"趋蕴魔板",italic:true,color:"light_purple",italic:0b},lore=[{text:"蹲下正好1秒时",color:"white",italic:0b},{text:"极短时间内跳跃高度、攻击力提升",color:"white",italic:0b},{text:"如果此时主手为撬棍，将临时被视为一把重锤",color:"white",italic:0b},{text:"点击禁用",color:"green",italic:0b,bold: true}],custom_data={sea_t_pounce1:true}]
execute if block 90074 103 137 minecraft:scaffolding run item replace entity @s[tag=sea_t_pounce1,tag=sea_t_pounce_disabled] player.crafting.2 with flow_armor_trim_smithing_template[custom_name={text:"趋蕴魔板 - 禁用中",italic:true,color:"light_purple",italic:0b},lore=[{text:"蹲下正好1秒时",color:"white",italic:0b},{text:"极短时间内跳跃高度、攻击力提升",color:"white",italic:0b},{text:"如果此时主手为撬棍，将临时被视为一把重锤",color:"white",italic:0b},{text:"点击启用",color:"green",italic:0b,bold: true}],custom_data={sea_t_pounce_disabled:true},enchantments={"vanishing_curse":1}]
