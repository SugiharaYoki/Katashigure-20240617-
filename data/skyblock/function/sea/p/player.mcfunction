...
execute as @s[scores={sea_crafter=30000}] at @s if entity @n[tag=SEAcrafter,distance=0..5] unless SEA_ch6_event rng5 matches 1112.. run function skyblock:sea/shop_tp
