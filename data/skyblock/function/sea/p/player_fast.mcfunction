...
execute as @s[nbt={Inventory:[{components:{"minecraft:custom_data":{sea_chest_shadowchest:true}},Slot:6b}]},predicate=skyblock:sneaking] run effect give @s invisibility 3 0 false