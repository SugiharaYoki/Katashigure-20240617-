...
execute as @s[tag=sea_t_sprint,tag=sea_t_sprint_ended,scores={sea_t_sprint_charge=0}] unless entity @s[predicate=skyblock:forward,predicate=skyblock:sprint] run scoreboard players set @s sea_runs -40
execute as @s[tag=sea_t_sprint,tag=sea_t_sprint_ended,scores={sea_t_sprint_charge=1}] unless entity @s[predicate=skyblock:forward,predicate=skyblock:sprint] run scoreboard players set @s sea_runs -32
execute as @s[tag=sea_t_sprint,tag=sea_t_sprint_ended,scores={sea_t_sprint_charge=2}] unless entity @s[predicate=skyblock:forward,predicate=skyblock:sprint] run scoreboard players set @s sea_runs -24
execute as @s[tag=sea_t_sprint,tag=sea_t_sprint_ended,scores={sea_t_sprint_charge=3}] unless entity @s[predicate=skyblock:forward,predicate=skyblock:sprint] run scoreboard players set @s sea_runs -16
