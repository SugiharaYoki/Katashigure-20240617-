...
execute if score @s sea_ripper matches 1.. positioned ^ ^ ^ if block ~ ~ ~ #skyblock:water run playsound entity.generic.swim block @a ~ ~ ~ 0.8 1.6
...
execute if score @s sea_ripper matches 1.. positioned ^ ^ ^ if block ~ ~ ~ #skyblock:water run playsound entity.generic.splash block @a ~ ~ ~ 0.5 2
execute if score @s sea_ripper matches 1.. positioned ^ ^ ^ if block ~ ~ ~ #skyblock:water run particle splash ~ ~ ~ 0.4 0.06 0.4 0.2 15
...
execute if score @s[scores={rng3=1,rng4=1..}] sea_ripper matches 1.. positioned ^ ^-1.5 ^ as @e[tag=SEAmob,type=!husk,distance=0..1.6,type=!warden] at @s run damage @s 10 minecraft:cactus
execute if score @s[scores={rng3=1,rng4=1..}] sea_ripper matches 1.. positioned ^ ^ ^ as @e[tag=SEAmob,    type=!husk,distance=0..1.6,type=!warden] at @s run damage @s 10 minecraft:cactus
...
execute if score @s[scores={rng3=2,rng4=1..}] sea_ripper matches 1.. positioned ^ ^-1.5 ^ as @e[tag=SEAmob,type=!husk,distance=0..1.6,type=!warden] at @s run damage @s 14 minecraft:cactus
execute if score @s[scores={rng3=2,rng4=1..}] sea_ripper matches 1.. positioned ^ ^ ^ as @e[tag=SEAmob,    type=!husk,distance=0..1.6,type=!warden] at @s run damage @s 14 minecraft:cactus
execute if score @s[scores={rng5=2,rng4=1..}] sea_ripper matches 1.. positioned ^ ^-1.5 ^ as @e[tag=SEAmob,type=!husk,distance=0..1.6] at @s run effect give @s slowness 1 5 true
execute if score @s[scores={rng5=2,rng4=1..}] sea_ripper matches 1.. positioned ^ ^ ^ as @e[tag=SEAmob,    type=!husk,distance=0..1.6] at @s run effect give @s slowness 1 5 true
...
execute if score @s[scores={rng5=3,rng4=1..}] sea_ripper matches 1.. positioned ^ ^-1.5 ^ as @e[tag=SEAmob,type=!husk,distance=0..1.6] at @s run effect give @s slowness 1 9 true
execute if score @s[scores={rng5=3,rng4=1..}] sea_ripper matches 1.. positioned ^ ^ ^ as @e[tag=SEAmob,    type=!husk,distance=0..1.6] at @s run effect give @s slowness 1 9 true
...
execute if score @s[scores={rng3=1..,rng4=1..}] sea_ripper matches 1.. positioned ^ ^-1.5 ^ as @e[tag=SEAmob,type=husk,distance=0..1.7] at @s run damage @s 30 minecraft:cactus
execute if score @s[scores={rng3=1..,rng4=1..}] sea_ripper matches 1.. positioned ^ ^ ^ as @e[tag=SEAmob,    type=husk,distance=0..1.7] at @s run damage @s 30 minecraft:cactus
