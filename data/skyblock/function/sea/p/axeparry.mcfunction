...
execute at @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"sea_axe":true}}}}] anchored eyes positioned ^ ^ ^1.5 as @e[tag=SEAmob,distance=..1.3] at @s run damage @s 2 minecraft:generic
execute at @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"sea_axe2":true}}}}] anchored eyes positioned ^ ^ ^1.5 as @e[tag=SEAmob,distance=..1.4] at @s run damage @s 2.5 minecraft:generic
execute at @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"sea_axe3":true}}}}] anchored eyes positioned ^ ^ ^1.5 as @e[tag=SEAmob,distance=..1.5] at @s run damage @s 3 minecraft:generic
