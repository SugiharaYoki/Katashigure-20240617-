...
execute at @s[scores={rng9=2}] anchored eyes positioned ^ ^ ^1.5 as @e[tag=SEAmob,distance=..1.5] at @s run damage @s 3 minecraft:generic
execute at @s[scores={rng9=3}] anchored eyes positioned ^ ^ ^1.5 as @e[tag=SEAmob,distance=..1.7] at @s run damage @s 4 minecraft:generic
execute at @s[scores={rng9=5}] anchored eyes positioned ^ ^ ^1.5 as @e[tag=SEAmob,distance=..1.8] at @s run damage @s 4.5 minecraft:generic
execute at @s[scores={rng9=6}] anchored eyes positioned ^ ^ ^1.5 as @e[tag=SEAmob,distance=..1.9] at @s run damage @s 5 minecraft:generic
