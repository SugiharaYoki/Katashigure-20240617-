...
execute if score @s sea_4temp1 matches 2.. run playsound block.bamboo.place block @a ~ ~ ~ 0.7 1.5
...
execute if score @s sea_4temp1 matches 10.. run scoreboard players add @s sea_4temp2 1
execute if score @s sea_4temp1 matches 12.. run scoreboard players add @s sea_4temp2 1
execute if score @s sea_4temp1 matches 14.. run scoreboard players add @s sea_4temp2 1
execute if score @s sea_4temp1 matches 16.. run scoreboard players add @s sea_4temp2 1
execute if score @s sea_4temp1 matches 18.. run scoreboard players add @s sea_4temp2 1
execute if score @s sea_4temp1 matches 20.. run scoreboard players add @s sea_4temp2 1
execute if score @s sea_4temp1 matches 22.. run scoreboard players add @s sea_4temp2 1
execute if score @s sea_4temp1 matches 24.. run scoreboard players add @s sea_4temp2 1
execute if score @s sea_4temp1 matches 26.. run scoreboard players add @s sea_4temp2 1
execute if score @s sea_4temp1 matches 28.. run scoreboard players add @s sea_4temp2 1
execute if score @s sea_4temp1 matches 30.. run scoreboard players add @s sea_4temp2 1
