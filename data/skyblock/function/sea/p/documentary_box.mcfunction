...
,lore=['{text:"为什么会没发现这个档案……？",color:"white","italic":false}']]
...
,lore=['{text:"维修层的入口还遗留了一些笔记。",color:"white","italic":false}']]
...
,lore=['{text:"钻井平台的医务人员似乎留下了一些诊断记录。",color:"white","italic":false}']]
...
,lore=['{text:"在法莫洛斯医生待过的地方寻找吧。",color:"white","italic":false}']]
...
,lore=['{text:"物资层的厨师组似乎遭遇了不幸的事故。",color:"white","italic":false}']]
...
,lore=['{text:"宿舍楼的坚守者们在房间内留下了笔记。",color:"white","italic":false}']]
...
,lore=['{text:"试着探索一下钻井平台的各个区域吧。",color:"white","italic":false}']]
...
,lore=['{text:"在维修层的维修仓库似乎存有某位工程师的笔记。",color:"white","italic":false}']]
...
,lore=['{text:"在主平台甲板的通讯室似乎存有某位工程师的笔记。",color:"white","italic":false}']]
