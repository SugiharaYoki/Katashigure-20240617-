...
execute if entity @s[tag=sea_doc01b] run item replace block 90081 104 134 container.0 with flow_banner_pattern[custom_data={sea_doc01b:true},custom_name={text:"燃料架B内的便签纸",italic:1b,color:"dark_purple",italic:0b},lore=[{text:"上面写着歪歪扭扭的字：",color:"white",italic:0b},{text:"“从右到左仔细观察北水箱西面的蜡烛”",color:"white",italic:0b}]]
...
'{text:"维修层空气循环系统控制室的笔记 - 越涵",italic:1b,color:"dark_purple",italic:0b},\
