...
{"selector":"@n[tag=SEA_w_ripper_displaymarker3]","color":"blue","clickEvent":{"action":"run_command","value":"/trigger sea_crafter set 50603"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：2\n减速效果略微增加","color":"white"}}},\
