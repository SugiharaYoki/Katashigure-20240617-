...
{"selector":"@n[tag=SEA_w_ripper_displaymarker8]","color":"blue","click_event":{"action":"run_command","value":"/trigger sea_crafter set 50608"},"hover_event":{"action":"show_text","value":{"text":"消耗：1\n减速效果略微增加","color":"white"}}},\
{"selector":"@n[tag=SEA_w_ripper_displaymarker9]","color":"yellow","click_event":{"action":"run_command","value":"/trigger sea_crafter set 50609"},"hover_event":{"action":"show_text","value":{"text":"消耗：3\n切割范围增加0.3格","color":"white"}}},\
{"selector":"@n[tag=SEA_w_ripper_displaymarkerE]","color":"dark_gray"},\
{"selector":"@n[tag=SEA_w_ripper_displaymarkerE]","color":"dark_gray"}]

tellraw @s [{"text":" ","color":"light_purple"},\
{"selector":"@n[tag=SEA_w_ripper_displaymarker0b]","color":"dark_gray"},\
{"selector":"@n[tag=SEA_w_ripper_displaymarker5]","color":"green","click_event":{"action":"run_command","value":"/trigger sea_crafter set 50605"},"hover_event":{"action":"show_text","value":{"text":"消耗：2\n持续时间增加0.8秒","color":"white"}}},\
{"selector":"@n[tag=SEA_w_ripper_displaymarkerE]","color":"dark_gray"},\
{"selector":"@n[tag=SEA_w_ripper_displaymarker6]","color":"yellow","click_event":{"action":"run_command","value":"/trigger sea_crafter set 50606"},"hover_event":{"action":"show_text","value":{"text":"消耗：3\n切割范围增加0.3格","color":"white"}}},\
{"selector":"@n[tag=SEA_w_ripper_displaymarker7]","color":"green","click_event":{"action":"run_command","value":"/trigger sea_crafter set 50607"},"hover_event":{"action":"show_text","value":{"text":"消耗：2\n持续时间增加0.8秒","color":"white"}}}]

tellraw @s [{"text":" ","color":"light_purple"},\
{"selector":"@n[tag=SEA_w_ripper_displaymarker0]","color":"red"},\
{"selector":"@n[tag=SEA_w_ripper_displaymarker1]","color":"dark_red","click_event":{"action":"run_command","value":"/trigger sea_crafter set 50601"},"hover_event":{"action":"show_text","value":{"text":"消耗：1\n单次攻击力增加0.5","color":"white"}}},\
{"selector":"@n[tag=SEA_w_ripper_displaymarker2]","color":"dark_red","click_event":{"action":"run_command","value":"/trigger sea_crafter set 50602"},"hover_event":{"action":"show_text","value":{"text":"消耗：2\n单次攻击力增加0.5","color":"white"}}},\
{"selector":"@n[tag=SEA_w_ripper_displaymarker3]","color":"blue","click_event":{"action":"run_command","value":"/trigger sea_crafter set 50603"},"hover_event":{"action":"show_text","value":{"text":"消耗：2\n减速效果略微增加","color":"white"}}},\
{"selector":"@n[tag=SEA_w_ripper_displaymarker4]","color":"dark_red","click_event":{"action":"run_command","value":"/trigger sea_crafter set 50604"},"hover_event":{"action":"show_text","value":{"text":"消耗：3\n单次攻击力增加0.5","color":"white"}}}]

tellraw @s [{"text":" ","color":"light_purple"},\
{"selector":"@n[tag=SEA_w_ripper_displaymarker0b]","color":"dark_gray"},\
{"selector":"@n[tag=SEA_w_ripper_displaymarkerE]","color":"dark_gray"},\
{"selector":"@n[tag=SEA_w_ripper_displaymarker10]","color":"green","click_event":{"action":"run_command","value":"/trigger sea_crafter set 50610"},"hover_event":{"action":"show_text","value":{"text":"消耗：2\n持续时间增加0.8秒","color":"white"}}},\
{"selector":"@n[tag=SEA_w_ripper_displaymarkerE]","color":"dark_gray"},\
{"selector":"@n[tag=SEA_w_ripper_displaymarkerE]","color":"dark_gray"}]
