attribute @s[tag=!e_w_ahl2_e] generic.armor modifier remove sea_weapon:upg_armor01
attribute @s[tag=!e_w_ahl2_e] generic.armor_toughness modifier remove sea_weapon:upg_armor02
