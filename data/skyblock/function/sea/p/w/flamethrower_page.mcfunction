...
{"selector":"@n[tag=SEA_w_flamethrower_displaymarker1]","color":"light_purple","click_event":{"action":"run_command","value":"/trigger sea_crafter set 50201"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：1\n增加0.3格有效射程","color":"white"}}},\
{"selector":"@n[tag=SEA_w_flamethrower_displaymarker2]","color":"green","click_event":{"action":"run_command","value":"/trigger sea_crafter set 50202"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：1\n加快燃料补充速度","color":"white"}}},\
{"selector":"@n[tag=SEA_w_flamethrower_displaymarker3]","color":"green","click_event":{"action":"run_command","value":"/trigger sea_crafter set 50203"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：4\n加快燃料补充速度","color":"white"}}},\
{"selector":"@n[tag=SEA_w_flamethrower_displaymarker4]","color":"green","click_event":{"action":"run_command","value":"/trigger sea_crafter set 50204"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：3\n加快燃料补充速度","color":"white"}}},\
{"selector":"@n[tag=SEA_w_flamethrower_displaymarker5]","color":"light_purple","click_event":{"action":"run_command","value":"/trigger sea_crafter set 50205"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：1\n增加0.3格有效射程","color":"white"}}}]

tellraw @s [{"text":" ","color":"light_purple"},\
{"selector":"@n[tag=SEA_w_flamethrower_displaymarker0b]","color":"dark_gray"},\
{"selector":"@n[tag=SEA_w_flamethrower_displaymarker11]","color":"gold","click_event":{"action":"run_command","value":"/trigger sea_crafter set 50211"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：2\n增加喷火的灼烧时长\n可以强制唤醒灰烬状态的炽烈球体","color":"white"}}},\
{"selector":"@n[tag=SEA_w_flamethrower_displaymarker6]","color":"blue","click_event":{"action":"run_command","value":"/trigger sea_crafter set 50206"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：2\n减少喷火时的燃料消耗","color":"white"}}},\
{"selector":"@n[tag=SEA_w_flamethrower_displaymarkerE]","color":"dark_gray"},\
{"selector":"@n[tag=SEA_w_flamethrower_displaymarker12]","color":"gold","click_event":{"action":"run_command","value":"/trigger sea_crafter set 50212"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：10\n喷火器的普通喷射可用于破坏粘液墙","color":"white"}}},\
{"selector":"@n[tag=SEA_w_flamethrower_displaymarkerE]","color":"dark_gray"}]

tellraw @s [{"text":" ","color":"light_purple"},\
{"selector":"@n[tag=SEA_w_flamethrower_displaymarker0b]","color":"dark_gray"},\
{"selector":"@n[tag=SEA_w_flamethrower_displaymarkerE]","color":"dark_gray"},\
{"selector":"@n[tag=SEA_w_flamethrower_displaymarker7]","color":"gold","click_event":{"action":"run_command","value":"/trigger sea_crafter set 50207"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：3\n被灼烧的僵尸与溺尸将会永久丢失1.5防御力","color":"white"}}},\
{"selector":"@n[tag=SEA_w_flamethrower_displaymarker8]","color":"dark_red","click_event":{"action":"run_command","value":"/trigger sea_crafter set 50208"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：5\n单次攻击力增加0.5","color":"white"}}},\
{"selector":"@n[tag=SEA_w_flamethrower_displaymarker9]","color":"dark_red","click_event":{"action":"run_command","value":"/trigger sea_crafter set 50209"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：8\n单次攻击力增加0.5","color":"white"}}},\
{"selector":"@n[tag=SEA_w_flamethrower_displaymarkerE]","color":"dark_gray"}]

tellraw @s [{"text":" ","color":"light_purple"},\
{"selector":"@n[tag=SEA_w_flamethrower_displaymarker0b]","color":"dark_gray"},\
{"selector":"@n[tag=SEA_w_flamethrower_displaymarkerE]","color":"dark_gray"},\
{"selector":"@n[tag=SEA_w_flamethrower_displaymarker10]","color":"blue","click_event":{"action":"run_command","value":"/trigger sea_crafter set 50210"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：5\n减少喷火时的燃料消耗","color":"white"}}},\
{"selector":"@n[tag=SEA_w_flamethrower_displaymarkerE]","color":"dark_gray"},\
{"selector":"@n[tag=SEA_w_flamethrower_displaymarkerE]","color":"dark_gray"},\
{"selector":"@n[tag=SEA_w_flamethrower_displaymarkerE]","color":"dark_gray"}]
