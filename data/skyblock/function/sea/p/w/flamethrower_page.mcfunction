...
tellraw @s[scores={sea_i_iron_ingot=1..}] [{text:"剩余可分配铁锭：",bold:true,color:"green"},{bold:false,"score":{"name":"@s","objective":"sea_i_iron_ingot"},color:"green"},{text:"〈全部重置〉",bold:true,color:"red",click_event:{"action":"run_command","command":"trigger sea_crafter set 59903"}}]
tellraw @s[scores={sea_i_iron_ingot=..0}] [{text:"剩余可分配铁锭：",bold:true,color:"green"},{bold:false,"score":{"name":"@s","objective":"sea_i_iron_ingot"},color:"red"},{text:"〈全部重置〉",bold:true,color:"red",click_event:{"action":"run_command","command":"trigger sea_crafter set 59903"}}]
