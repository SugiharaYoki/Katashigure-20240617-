...
execute at @n[tag=SEAshotgun_shoot] as @e[tag=SEAmob,distance=0..0.3] run damage @s 60 explosion
...
execute at @n[tag=SEAshotgun_shoot] as @e[tag=SEAmob,distance=0..0.7] run damage @s 40 explosion
...
execute at @n[tag=SEAshotgun_shoot] as @e[tag=SEAmob,distance=0..0.7] run damage @s 30 explosion
...
execute at @n[tag=SEAshotgun_shoot] as @e[tag=SEAmob,distance=0..0.9] run damage @s 25 explosion
...
execute at @n[tag=SEAshotgun_shoot] as @e[tag=SEAmob,distance=0..1.1] run damage @s 20 explosion
...
execute at @n[tag=SEAshotgun_shoot] as @e[tag=SEAmob,distance=0..1.3] run damage @s 15 explosion
...
execute at @n[tag=SEAshotgun_shoot] as @e[tag=SEAmob,distance=0..1.5] run damage @s 10 explosion
