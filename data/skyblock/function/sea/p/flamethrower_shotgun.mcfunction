...
execute as @n[tag=SEAshotgun_shoot] rotated as @p run tp @s ~ ~1.5 ~ facing ^ ^ ^1
...
execute as @n[tag=SEAshotgun_shoot] at @s run particle smoke ~ ~ ~ 0.5 0.5 0.5 0.03 30
execute as @n[tag=SEAshotgun_shoot] at @s run particle small_flame ~ ~ ~ 0.4 0.4 0.4 0.0 30
...
execute as @n[tag=SEAshotgun_shoot] at @s run particle small_flame ~ ~ ~ 1.1 1.1 1.1 0.0 40
...
execute as @n[tag=SEAshotgun_shoot] at @s run tp @s ^ ^ ^0.45
execute as @n[tag=SEAshotgun_shoot] at @s run particle smoke ~ ~ ~ 1.5 1.5 1.5 0.03 50
execute as @n[tag=SEAshotgun_shoot] at @s run particle small_flame ~ ~ ~ 1.5 1.5 1.5 0.0 50
...
execute as @n[tag=SEAshotgun_shoot] at @s run tp @s ^ ^ ^0.45
execute as @n[tag=SEAshotgun_shoot] at @s run particle smoke ~ ~ ~ 1.9 1.9 1.9 0.03 60
execute as @n[tag=SEAshotgun_shoot] at @s run particle small_flame ~ ~ ~ 1.9 1.9 1.9 0.0 60
...
execute as @n[tag=SEAshotgun_shoot] at @s run particle small_flame ~ ~ ~ 2.3 2.3 2.3 0.0 70
...
execute as @n[tag=SEAshotgun_shoot] at @s run particle small_flame ~ ~ ~ 2.7 2.7 2.7 0.0 70
