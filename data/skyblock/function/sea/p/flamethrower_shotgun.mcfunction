...
playsound minecraft:entity.item.break player @a ~ ~ ~ 0.3 0.6

execute rotated as @s run summon marker ~ ~ ~ {Tags:["SEAshotgun_shoot"]}


execute as @n[tag=SEAshotgun_shoot] at @s run tp @s ^ ^ ^0.3
execute as @n[tag=SEAshotgun_shoot] at @s run particle smoke ~ ~ ~ 0.3 0.3 0.3 0.03 40
execute as @n[tag=SEAshotgun_shoot] at @s run particle small_flame ~ ~ ~ 0.3 0.3 0.3 0.03 40
...
execute as @n[tag=SEAshotgun_shoot] at @s run particle smoke ~ ~ ~ 0.7 0.7 0.7 0.03 40
execute as @n[tag=SEAshotgun_shoot] at @s run particle small_flame ~ ~ ~ 0.7 0.7 0.7 0.03 40
...
execute as @n[tag=SEAshotgun_shoot] at @s run tp @s ^ ^ ^0.4
execute as @n[tag=SEAshotgun_shoot] at @s run particle smoke ~ ~ ~ 1.1 1.1 1.1 0.03 40
execute as @n[tag=SEAshotgun_shoot] at @s run particle small_flame ~ ~ ~ 1.1 1.1 1.1 0.03 40
...
execute as @n[tag=SEAshotgun_shoot] at @s run tp @s ^ ^ ^0.4
execute as @n[tag=SEAshotgun_shoot] at @s run particle smoke ~ ~ ~ 1.5 1.5 1.5 0.03 40
execute as @n[tag=SEAshotgun_shoot] at @s run particle small_flame ~ ~ ~ 1.5 1.5 1.5 0.03 40
...
execute as @n[tag=SEAshotgun_shoot] at @s run tp @s ^ ^ ^0.4
execute as @n[tag=SEAshotgun_shoot] at @s run particle smoke ~ ~ ~ 1.9 1.9 1.9 0.03 40
execute as @n[tag=SEAshotgun_shoot] at @s run particle small_flame ~ ~ ~ 1.9 1.9 1.9 0.03 40
...
execute as @n[tag=SEAshotgun_shoot] at @s run tp @s ^ ^ ^0.4
execute as @n[tag=SEAshotgun_shoot] at @s run particle smoke ~ ~ ~ 2.3 2.3 2.3 0.03 40
execute as @n[tag=SEAshotgun_shoot] at @s run particle small_flame ~ ~ ~ 2.3 2.3 2.3 0.03 40
...
execute as @n[tag=SEAshotgun_shoot] at @s run tp @s ^ ^ ^0.4
execute as @n[tag=SEAshotgun_shoot] at @s run particle smoke ~ ~ ~ 2.7 2.7 2.7 0.03 40
execute as @n[tag=SEAshotgun_shoot] at @s run particle small_flame ~ ~ ~ 2.7 2.7 2.7 0.03 40
execute at @n[tag=SEAshotgun_shoot] as @e[tag=SEAmob,distance=0..2.7] run damage @s 9 campfire
execute at @n[tag=SEAshotgun_shoot] as @e[tag=SEAmob,distance=0..2.7] run data modify entity @s Fire set value 40s
