...
execute as @s[x=80000,dx=20000,z=-10000,dz=20000,y=102,dy=5] at @s if block ~ ~-1 ~ waxed_weathered_cut_copper_slab unless block ~ ~-2 ~ red_concrete if block ~ ~-0.1 ~ air run tp @s ~ 127.0 ~
...
execute as @s[x=80000,dx=20000,z=-10000,dz=20000,y=102,dy=5] at @s if block ~ ~-1.5 ~ waxed_weathered_cut_copper_slab unless block ~ ~-2.5 ~ red_concrete if block ~ ~-0.1 ~ air run tp @s ~ 127.0 ~
