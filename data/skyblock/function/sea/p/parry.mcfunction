...
execute as @s[tag=sea_shield1_checked,scores={sea_shield_switch=13}] run scoreboard players add @s sea_shielding_3 9
...
execute as @s[tag=sea_shield2_checked,scores={sea_shield_switch=12}] run scoreboard players add @s sea_shielding_3 9
...
execute as @s[tag=sea_shield3_checked,scores={sea_shield_switch=11}] run scoreboard players add @s sea_shielding_3 8
...
execute as @s[tag=sea_shield4_checked,scores={sea_shield_switch=10}] run scoreboard players add @s sea_shielding_3 8
...
execute as @s[tag=sea_shield5_checked,scores={sea_shield_switch=10}] run scoreboard players add @s sea_shielding_3 8
...
execute as @s[tag=sea_shield6_checked,scores={sea_shield_switch=10}] run scoreboard players add @s sea_shielding_3 7
...
execute as @s[tag=sea_shield7_checked,scores={sea_shield_switch=9}] run scoreboard players add @s sea_shielding_3 7
