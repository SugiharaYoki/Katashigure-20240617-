...
#待修复 execute as @e[tag=SEAmob_bloodrived] on passengers as @s[tag=SEAmob_bloodrive] run data merge entity @s {text:{score:{name:"SEA_bloodrive",objective:"health"},color:"green"},{text:"\\n"}}
