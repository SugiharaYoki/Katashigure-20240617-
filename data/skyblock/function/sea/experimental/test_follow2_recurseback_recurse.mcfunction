...
#execute if score SEA_follow_target_step rng1 matches 1.. as @n[tag=SEA_follow_target_marker,tag=!SEA_follow_target_stepped] at @s as @e[tag=SEA_follow_target_marker,distance=0.3..] if score @s rng1 = SEA_follow_target_step rng1 run tellraw @a {"text": "SEA_follow 移除无效分支","color": "dark_gray"}
...
execute if score SEA_follow_target_step rng1 matches 1.. as @n[tag=SEA_follow_target_marker,tag=!SEA_follow_target_stepped] at @s as @e[tag=SEA_follow_target_marker,distance=0.3..] if score @s rng1 = SEA_follow_target_step rng1 run kill @s
