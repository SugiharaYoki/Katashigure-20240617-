...
execute if score AZR_boss2_breakingout rng1 matches 69..92 if score AZR_boss2_breakingout rng3 matches 1 at @n[tag=AZR_boss2_breakingout_attacker] run summon arrow ^ ^0.1 ^1.2 {Motion:[0d,1.7d,0d],Rotation:[0f,90f],life:1100,damage:3.0,Fire:100s}
execute if score AZR_boss2_breakingout rng1 matches 69..92 if score AZR_boss2_breakingout rng3 matches 2 at @n[tag=AZR_boss2_breakingout_attacker] run summon arrow ^ ^0.1 ^1.2 {Motion:[0.2d,1.65d,0d],Rotation:[0f,90f],life:1100,damage:3.0,Fire:100s}
execute if score AZR_boss2_breakingout rng1 matches 69..92 if score AZR_boss2_breakingout rng3 matches 3 at @n[tag=AZR_boss2_breakingout_attacker] run summon arrow ^ ^0.1 ^1.2 {Motion:[-0.2d,1.65d,0d],Rotation:[0f,90f],life:1100,damage:3.0,Fire:100s}
execute if score AZR_boss2_breakingout rng1 matches 69..92 if score AZR_boss2_breakingout rng3 matches 4 at @n[tag=AZR_boss2_breakingout_attacker] run summon arrow ^ ^0.1 ^1.2 {Motion:[0d,1.65d,0.2d],Rotation:[0f,90f],life:1100,damage:3.0,Fire:100s}
execute if score AZR_boss2_breakingout rng1 matches 69..92 if score AZR_boss2_breakingout rng3 matches 5 at @n[tag=AZR_boss2_breakingout_attacker] run summon arrow ^ ^0.1 ^1.2 {Motion:[0d,1.65d,-0.2d],Rotation:[0f,90f],life:1100,damage:3.0,Fire:100s}
execute if score AZR_boss2_breakingout rng1 matches 69..92 if score AZR_boss2_breakingout rng3 matches 6 at @n[tag=AZR_boss2_breakingout_attacker] run summon arrow ^ ^0.1 ^1.2 {Motion:[0.2d,1.6d,0.2d],Rotation:[0f,90f],life:1100,damage:3.0,Fire:100s}
execute if score AZR_boss2_breakingout rng1 matches 69..92 if score AZR_boss2_breakingout rng3 matches 7 at @n[tag=AZR_boss2_breakingout_attacker] run summon arrow ^ ^0.1 ^1.2 {Motion:[0.2d,1.6d,-0.2d],Rotation:[0f,90f],life:1100,damage:3.0,Fire:100s}
execute if score AZR_boss2_breakingout rng1 matches 69..92 if score AZR_boss2_breakingout rng3 matches 8 at @n[tag=AZR_boss2_breakingout_attacker] run summon arrow ^ ^0.1 ^1.2 {Motion:[-0.2d,1.6d,0.2d],Rotation:[0f,90f],life:1100,damage:3.0,Fire:100s}
execute if score AZR_boss2_breakingout rng1 matches 69..92 if score AZR_boss2_breakingout rng3 matches 9 at @n[tag=AZR_boss2_breakingout_attacker] run summon arrow ^ ^0.1 ^1.2 {Motion:[-0.2d,1.6d,-0.2d],Rotation:[0f,90f],life:1100,damage:3.0,Fire:100s}
