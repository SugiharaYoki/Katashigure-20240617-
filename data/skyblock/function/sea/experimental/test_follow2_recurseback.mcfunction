...
execute as @n[tag=optimized] at @s run tellraw @a {"text": "SEA_follow 已决定最佳适配对象","color": "dark_gray"}
execute unless entity @n[tag=optimized,distance=0.1..] at @s run tellraw @a {"text": "SEA_follow 无法寻找到下一个适配对象","color": "dark_red"}
