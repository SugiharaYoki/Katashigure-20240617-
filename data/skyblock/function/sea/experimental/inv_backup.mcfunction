...
execute at @n[tag=SEAinv_backup_marker] run item replace entity @s armor.head from block ~ ~ ~-1 container.0
execute at @n[tag=SEAinv_backup_marker] run item replace entity @s armor.chest from block ~ ~ ~-1 container.1
execute at @n[tag=SEAinv_backup_marker] run item replace entity @s armor.legs from block ~ ~ ~-1 container.2
execute at @n[tag=SEAinv_backup_marker] run item replace entity @s armor.feet from block ~ ~ ~-1 container.3
