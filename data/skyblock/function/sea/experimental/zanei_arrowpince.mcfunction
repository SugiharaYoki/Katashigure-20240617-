...
execute if score AZR_boss2_arrowpince rng1 matches 30 run scoreboard players set AZR_boss2_arrowpince rng1 0
execute if score AZR_boss2_arrowpince rng1 matches 30 run tag @s remove AZR_boss2_skill_arrowpince
