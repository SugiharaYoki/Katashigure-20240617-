...
execute as @e[type=armor_stand,tag=SEA_bj_origin] if block ^ ^ ^-0.1 air run tag @s remove SEA_bj_notokay
execute as @e[type=armor_stand,tag=SEA_bj_origin] if block ^ ^ ^-0.1 #signs run tag @s remove SEA_bj_notokay
execute as @e[type=armor_stand,tag=SEA_bj_origin] if block ^ ^ ^-0.1 cobweb run tag @s remove SEA_bj_notokay
execute as @e[type=armor_stand,tag=SEA_bj_origin] if block ^ ^ ^-0.1 #flower_pots run tag @s remove SEA_bj_notokay
execute as @e[type=armor_stand,tag=SEA_bj_origin] if block ^ ^ ^-0.1 player_head run tag @s remove SEA_bj_notokay
execute as @e[type=armor_stand,tag=SEA_bj_origin] if block ^ ^ ^-0.1 player_wall_head run tag @s remove SEA_bj_notokay
