...
execute run tellraw @a[tag=SEA_follow_debug] [{"text": "SEA_follow 进行递归 ","color": "dark_gray"},{"score":{"name":"@n[tag=SEA_follow_target_origin]","objective":"rng1"},"color":"dark_gray"}]
