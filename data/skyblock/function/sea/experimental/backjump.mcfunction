...
execute if block ^ ^ ^-0.2 air run tag @s add SEA_bj_process
execute if block ^ ^ ^-0.2 #signs run tag @s add SEA_bj_process
execute if block ^ ^ ^-0.2 cobweb run tag @s add SEA_bj_process
execute if block ^ ^ ^-0.2 #flower_pots run tag @s add SEA_bj_process
execute if block ^ ^ ^-0.2 player_head run tag @s add SEA_bj_process
execute if block ^ ^ ^-0.2 player_wall_head run tag @s add SEA_bj_process
