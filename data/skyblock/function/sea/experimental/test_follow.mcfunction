...
execute at @s[tag=SEA_follow,scores={rng4=2..}] at @e[tag=SEA_follow_target_marker_previous] store result score @s rng8 if entity @n[tag=SEA_follow_target_marker,distance=0.6..]
execute at @s[tag=SEA_follow,scores={rng4=2..,rng8=1..}] at @e[tag=SEA_follow_target_marker_previous] run kill @n[tag=SEA_follow_target_marker,distance=0..0.6]
