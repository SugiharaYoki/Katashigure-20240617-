...
execute at @s[tag=SEA_follow] rotated ~ 0 run rotate @s facing entity @p[tag=SEA_follow_target]
...
execute at @s[tag=SEA_follow] if entity @n[tag=SEA_follow_target_marker] rotated ~ 0 run rotate @s facing entity @n[tag=SEA_follow_target_marker]
