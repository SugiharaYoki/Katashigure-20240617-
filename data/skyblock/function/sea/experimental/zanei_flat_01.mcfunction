execute if score zanei_flat_01_marker rng1 matches 16 run execute positioned 0.0 0 0.0 run summon marker ^ ^0.15 ^1 {Tags:["zanei_flat_01_marker"]}
...
execute if score zanei_flat_01_marker rng1 matches 19 run execute positioned 0.0 0 0.0 run summon marker ^ ^0.15 ^1 {Tags:["zanei_flat_01_marker"]}
...
execute if score zanei_flat_01_marker rng1 matches 22 run execute positioned 0.0 0 0.0 run summon marker ^ ^0.15 ^1 {Tags:["zanei_flat_01_marker"]}
...
execute if score zanei_flat_01_marker rng1 matches 16 run playsound entity.arrow.shoot hostile @a ~ ~ ~ 1 1.1
execute if score zanei_flat_01_marker rng1 matches 19 run playsound entity.arrow.shoot hostile @a ~ ~ ~ 1 1.1
execute if score zanei_flat_01_marker rng1 matches 22 run playsound entity.arrow.shoot hostile @a ~ ~ ~ 1 1.1
...
execute if score zanei_flat_01_marker rng1 matches 22 run summon arrow ~ ~1.5 ~ {Tags:["zanei_flat_01_arrow3"],life:1100,damage:2.0}
