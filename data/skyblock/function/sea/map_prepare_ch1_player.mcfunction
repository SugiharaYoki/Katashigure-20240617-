...
give @s spyglass[lore=['{"text":"我随身携带的望远镜。","color":"white","italic":false}','{"text":"在前途危险未知的时刻，紧握住它可以让我不再迷惘。","color":"white","italic":false}','{"text":"手持时：跳过已阅读的剧情对话","color":"green","italic":false}']]
give @s compass
