...
execute if entity @s[tag=sea_purchase_pass] run give @s fire_charge[custom_name={text:"定时炸弹",italic:true,color:"blue",italic:0b},lore=[{text:"它会在你丢出去3秒后爆炸！",color:"white",italic:0b},{text:"炸到自己的话，职业生涯就会结束了吧。",color:"white",italic:0b},{text:"可用于破坏凝胶壁障与瓦罐。",color:"white",italic:0b}]] 2
...
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:block.note_block.hat player @a ~ ~ ~ 0.8 0.7
execute if entity @s[tag=sea_purchase_pass] run give @s firework_star[custom_name={text:"燃爆剂",italic:true,color:"blue",italic:0b},lore=[{text:"喷火器专用燃爆剂。",color:"white",italic:0b},{text:"使用喷火器时左键，瞬间对面前近距离造成大量伤害。",color:"white",italic:0b}]] 5
...
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:block.note_block.hat player @a ~ ~ ~ 0.8 0.7
execute if entity @s[tag=sea_purchase_pass] run give @s tnt[custom_name={text:"可控地雷触发装置",italic:true,color:"blue",italic:0b},lore=[{text:"并不会在你丢出去后立刻爆炸。",color:"white",italic:0b},{text:"放心，真的不会伤到友军！",color:"white",italic:0b},{text:"请注意：丢出去之后可就没法拆卸了。",color:"white",italic:0b}]] 1
...
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:item.armor.equip_iron neutral @s ~ ~ ~ 100
execute if entity @s[tag=sea_purchase_pass] run give @s heart_of_the_sea[custom_name={text:"深海宝石",italic:true,color:"gold",italic:0b},lore=[{text:"曾是艾德雯娜的护身符",color:"white",italic:0b},{text:"用途与来源皆不明，只知能用于驱赶某种魔物",color:"white",italic:0b}],custom_data={sea_seaheart:true}]
...
execute if entity @s[tag=sea_purchase_pass,scores={rng1=1..10}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"机关铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"守护 I 强化护甲",color:"white",italic:0b}],custom_data={sea_t_armor1:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=11..15}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"精制铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"守护 II 强化护甲",color:"white",italic:0b}],custom_data={sea_t_armor2:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=16..25}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"机关铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"坚韧 I 增加护甲韧度",color:"white",italic:0b}],custom_data={sea_t_tough1:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=26..30}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"精制铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"坚韧 II 增加护甲韧度",color:"white",italic:0b}],custom_data={sea_t_tough2:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=31..33}] run give @s netherite_scrap[custom_name={text:"废物铜板",italic:true,color:"gray",italic:0b},lore=[{text:"毫无任何魔力感应",color:"gray",italic:0b}],custom_data={sea_t_empty:true}]
...
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:item.lodestone_compass.lock neutral @s ~ ~ ~ 100 0.8
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:block.enchantment_table.use neutral @s ~ ~ ~ 100 0.9
execute if entity @s[tag=sea_purchase_pass,scores={rng1=1..10}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"机关铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"敏捷 I 增加移动速度",color:"white",italic:0b}],custom_data={sea_t_speed1:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=11..15}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"精制铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"敏捷 II 增加移动速度",color:"white",italic:0b}],custom_data={sea_t_speed2:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=16..25}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"机关铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"蛮力 I 增加基础攻击",color:"white",italic:0b}],custom_data={sea_t_damage1:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=26..30}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"精制铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"蛮力 II 增加基础攻击",color:"white",italic:0b}],custom_data={sea_t_damage2:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=31..33}] run give @s netherite_scrap[custom_name={text:"废物铜板",italic:true,color:"gray",italic:0b},lore=[{text:"毫无任何魔力感应",color:"gray",italic:0b}],custom_data={sea_t_empty:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=31..33}] run give @s emerald 3
...
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:item.lodestone_compass.lock neutral @s ~ ~ ~ 100 0.8
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:block.enchantment_table.use neutral @s ~ ~ ~ 100 0.9
execute if entity @s[tag=sea_purchase_pass,scores={rng1=1..10}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"机关铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"汲苒 I 增加生命上限",color:"white",italic:0b}],custom_data={sea_t_health1:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=11..15}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"精制铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"汲苒 II 增加生命上限",color:"white",italic:0b}],custom_data={sea_t_health2:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=16..25}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"机关铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"烈躁 I 增加攻击速度",color:"white",italic:0b}],custom_data={sea_t_attackspeed1:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=26..30}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"精制铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"烈躁 II 增加攻击速度",color:"white",italic:0b}],custom_data={sea_t_attackspeed2:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=31..33}] run give @s netherite_scrap[custom_name={text:"废物铜板",italic:true,color:"gray",italic:0b},lore=[{text:"毫无任何魔力感应",color:"gray",italic:0b}],custom_data={sea_t_empty:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=31..33}] run give @s emerald 3
...
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:item.lodestone_compass.lock neutral @s ~ ~ ~ 100 0.8
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:block.enchantment_table.use neutral @s ~ ~ ~ 100 0.9
execute if entity @s[tag=sea_purchase_pass,scores={rng1=1..7}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"机关铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"敏捷 I 增加移动速度",color:"white",italic:0b}],custom_data={sea_t_speed1:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=8..15}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"精制铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"敏捷 II 增加移动速度",color:"white",italic:0b}],custom_data={sea_t_speed2:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=16..20}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"密械铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"敏捷 III 增加移动速度",color:"white",italic:0b}],custom_data={sea_t_speed3:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=21..27}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"机关铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"汲苒 I 增加生命上限",color:"white",italic:0b}],custom_data={sea_t_health1:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=28..35}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"精制铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"汲苒 II 增加生命上限",color:"white",italic:0b}],custom_data={sea_t_health2:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=36..40}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"密械铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"汲苒 III 增加生命上限",color:"white",italic:0b}],custom_data={sea_t_health3:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=41..45}] run give @s netherite_scrap[custom_name={text:"废物铜板",italic:true,color:"gray",italic:0b},lore=[{text:"毫无任何魔力感应",color:"gray",italic:0b}],custom_data={sea_t_empty:true}]
...
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:item.lodestone_compass.lock neutral @s ~ ~ ~ 100 0.8
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:block.enchantment_table.use neutral @s ~ ~ ~ 100 0.9
execute if entity @s[tag=sea_purchase_pass,scores={rng1=1..7}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"机关铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"坚韧 I 增加护甲韧度",color:"white",italic:0b}],custom_data={sea_t_tough1:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=8..15}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"精制铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"坚韧 II 增加护甲韧度",color:"white",italic:0b}],custom_data={sea_t_tough2:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=16..20}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"密械铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"坚韧 III 增加护甲韧度",color:"white",italic:0b}],custom_data={sea_t_tough3:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=21..27}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"机关铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"冲斥 I 强化击退",color:"white",italic:0b}],custom_data={sea_t_knockback1:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=28..35}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"精制铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"冲斥 II 强化击退",color:"white",italic:0b}],custom_data={sea_t_knockback2:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=36..40}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"密械铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"冲斥 III 强化击退",color:"white",italic:0b}],custom_data={sea_t_knockback3:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=41..45}] run give @s netherite_scrap[custom_name={text:"废物铜板",italic:true,color:"gray",italic:0b},lore=[{text:"毫无任何魔力感应",color:"gray",italic:0b}],custom_data={sea_t_empty:true}]
...
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:item.lodestone_compass.lock neutral @s ~ ~ ~ 100 0.8
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:block.enchantment_table.use neutral @s ~ ~ ~ 100 0.9
execute if entity @s[tag=sea_purchase_pass,scores={rng1=1..7}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"机关铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"蛮力 I 增加基础攻击",color:"white",italic:0b}],custom_data={sea_t_damage1:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=8..15}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"精制铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"蛮力 II 增加基础攻击",color:"white",italic:0b}],custom_data={sea_t_damage2:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=16..20}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"密械铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"蛮力 III 增加基础攻击",color:"white",italic:0b}],custom_data={sea_t_damage3:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=21..27}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"机关铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"烈躁 I 增加攻击速度",color:"white",italic:0b}],custom_data={sea_t_attackspeed1:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=28..35}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"精制铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"烈躁 II 增加攻击速度",color:"white",italic:0b}],custom_data={sea_t_attackspeed2:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=36..40}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"密械铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"烈躁 III 增加攻击速度",color:"white",italic:0b}],custom_data={sea_t_attackspeed3:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=41..45}] run give @s netherite_scrap[custom_name={text:"废物铜板",italic:true,color:"gray",italic:0b},lore=[{text:"毫无任何魔力感应",color:"gray",italic:0b}],custom_data={sea_t_empty:true}]
...
execute if entity @s[tag=sea_purchase_pass,scores={rng1=8..15}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"精制铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"蛮力 II 增加基础攻击",color:"white",italic:0b}],custom_data={sea_t_damage2:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=16..20}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"密械铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"蛮力 III 增加基础攻击",color:"white",italic:0b}],custom_data={sea_t_damage3:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=21..27}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"机关铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"守护 I 强化护甲",color:"white",italic:0b}],custom_data={sea_t_armor1:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=28..35}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"精制铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"守护 II 强化护甲",color:"white",italic:0b}],custom_data={sea_t_armor2:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=36..40}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"密械铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"守护 III 强化护甲",color:"white",italic:0b}],custom_data={sea_t_armor3:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=41..45}] run give @s netherite_scrap[custom_name={text:"废物铜板",italic:true,color:"gray",italic:0b},lore=[{text:"毫无任何魔力感应",color:"gray",italic:0b}],custom_data={sea_t_empty:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=41..45}] run give @s emerald 8
...
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:item.lodestone_compass.lock neutral @s ~ ~ ~ 100 0.8
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:block.enchantment_table.use neutral @s ~ ~ ~ 100 0.9
execute if entity @s[tag=sea_purchase_pass,scores={rng1=1..15}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"密械铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"烈躁 III 增加攻击速度",color:"white",italic:0b}],custom_data={sea_t_attackspeed3:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=16..20}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"坍缩铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"烈躁 IV 增加攻击速度",color:"white",italic:0b}],custom_data={sea_t_attackspeed4:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=21..35}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"密械铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"敏捷 III 增加移动速度",color:"white",italic:0b}],custom_data={sea_t_speed3:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=36..40}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"坍缩铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"敏捷 IV 增加移动速度",color:"white",italic:0b}],custom_data={sea_t_speed4:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=41..45}] run give @s netherite_scrap[custom_name={text:"废物铜板",italic:true,color:"gray",italic:0b},lore=[{text:"毫无任何魔力感应",color:"gray",italic:0b}],custom_data={sea_t_empty:true}]
...
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:item.lodestone_compass.lock neutral @s ~ ~ ~ 100 0.8
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:block.enchantment_table.use neutral @s ~ ~ ~ 100 0.9
execute if entity @s[tag=sea_purchase_pass,scores={rng1=1..15}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"密械铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"守护 III 强化护甲",color:"white",italic:0b}],custom_data={sea_t_armor3:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=16..20}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"坍缩铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"守护 IV 强化护甲",color:"white",italic:0b}],custom_data={sea_t_armor4:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=21..35}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"密械铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"汲苒 III 增加生命上限",color:"white",italic:0b}],custom_data={sea_t_health3:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=36..40}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"坍缩铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"汲苒 IV 增加生命上限",color:"white",italic:0b}],custom_data={sea_t_health4:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=41..45}] run give @s netherite_scrap[custom_name={text:"废物铜板",italic:true,color:"gray",italic:0b},lore=[{text:"毫无任何魔力感应",color:"gray",italic:0b}],custom_data={sea_t_empty:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=41..45}] run give @s emerald 30
...
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:item.lodestone_compass.lock neutral @s ~ ~ ~ 100 0.8
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:block.enchantment_table.use neutral @s ~ ~ ~ 100 0.9
execute if entity @s[tag=sea_purchase_pass,scores={rng1=1..15}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"密械铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"蛮力 III 增加基础攻击",color:"white",italic:0b}],custom_data={sea_t_damage3:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=16..20}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"坍缩铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"蛮力 IV 增加基础攻击",color:"white",italic:0b}],custom_data={sea_t_damage4:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=21..35}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"密械铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"坚韧 III 增加护甲韧度",color:"white",italic:0b}],custom_data={sea_t_tough3:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=36..40}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"坍缩铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"坚韧 IV 增加护甲韧度",color:"white",italic:0b}],custom_data={sea_t_tough4:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=41..45}] run give @s netherite_scrap[custom_name={text:"废物铜板",italic:true,color:"gray",italic:0b},lore=[{text:"毫无任何魔力感应",color:"gray",italic:0b}],custom_data={sea_t_empty:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=41..45}] run give @s emerald 30
...
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:item.lodestone_compass.lock neutral @s ~ ~ ~ 100 0.8
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:block.enchantment_table.use neutral @s ~ ~ ~ 100 0.9
execute if entity @s[tag=sea_purchase_pass,scores={rng1=1..20}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"机关铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"",color:"white",italic:0b}],custom_data={sea_t_sprint1:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=21..35}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"精制铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"",color:"white",italic:0b}],custom_data={sea_t_sprint2:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=36..40}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"密械铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"",color:"white",italic:0b}],custom_data={sea_t_sprint3:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=41..45}] run give @s netherite_scrap[custom_name={text:"废物铜板",italic:true,color:"gray",italic:0b},lore=[{text:"毫无任何魔力感应",color:"gray",italic:0b}],custom_data={sea_t_empty:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=41..45}] run give @s emerald 30
...
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:item.lodestone_compass.lock neutral @s ~ ~ ~ 100 0.8
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:block.enchantment_table.use neutral @s ~ ~ ~ 100 0.9
execute if entity @s[tag=sea_purchase_pass,scores={rng1=1..20}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"机关铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"",color:"white",italic:0b}],custom_data={sea_t_sprint4:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=21..38}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"精制铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"",color:"white",italic:0b}],custom_data={sea_t_sprint5:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=39..45}] run give @s bolt_armor_trim_smithing_template[custom_name={text:"密械铜板",italic:true,color:"light_purple",italic:0b},lore=[{text:"",color:"white",italic:0b}],custom_data={sea_t_sprint6:true}]
