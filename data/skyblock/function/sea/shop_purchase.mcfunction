...
execute if score @s sea_crafter matches 90003 if block 90062 103 135 grindstone unless block 90075 103 141 minecraft:cauldron if score sea_ch2_event_enteringlevel sea_4temp2 matches 104..120 run scoreboard players set sea_ch2_event_enteringlevel sea_4temp2 121
