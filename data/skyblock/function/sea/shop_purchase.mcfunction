...
execute if score @s[tag=sea_teleport01] sea_crafter matches 30001 at @n[tag=SEAcrafter_tp1,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run rotate @s facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport02] sea_crafter matches 30002 at @n[tag=SEAcrafter_tp2,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run rotate @s facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport03] sea_crafter matches 30003 at @n[tag=SEAcrafter_tp3,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run rotate @s facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport04] sea_crafter matches 30004 at @n[tag=SEAcrafter_tp4,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run rotate @s facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport05] sea_crafter matches 30005 at @n[tag=SEAcrafter_tp5,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run rotate @s facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport06] sea_crafter matches 30006 at @n[tag=SEAcrafter_tp6,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run rotate @s facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport07] sea_crafter matches 30007 at @n[tag=SEAcrafter_tp7,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run rotate @s facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport08] sea_crafter matches 30008 at @n[tag=SEAcrafter_tp8,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run rotate @s facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport09] sea_crafter matches 30009 at @n[tag=SEAcrafter_tp9,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run rotate @s facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport10] sea_crafter matches 30010 at @n[tag=SEAcrafter_tp10,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run rotate @s facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport11] sea_crafter matches 30011 at @n[tag=SEAcrafter_tp11,type=marker] if entity @n[tag=SEAcrafter_foodless,distance=0..3] run rotate @s facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport12] sea_crafter matches 30012 at @n[tag=SEAcrafter_tp12,type=marker] if entity @n[tag=SEAcrafter_foodless,distance=0..3] run rotate @s facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport13] sea_crafter matches 30013 at @n[tag=SEAcrafter_tp13,type=marker] if entity @n[tag=SEAcrafter_foodless,distance=0..3] run rotate @s facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport14] sea_crafter matches 30014 at @n[tag=SEAcrafter_tp14,type=marker] if entity @n[tag=SEAcrafter_foodless,distance=0..3] run rotate @s facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport15] sea_crafter matches 30015 at @n[tag=SEAcrafter_tp15,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run rotate @s facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport16] sea_crafter matches 30016 at @n[tag=SEAcrafter_tp16,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run rotate @s facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport17] sea_crafter matches 30017 at @n[tag=SEAcrafter_tp17,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run rotate @s facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport18] sea_crafter matches 30018 at @n[tag=SEAcrafter_tp18,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run rotate @s facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport19] sea_crafter matches 30019 at @n[tag=SEAcrafter_tp19,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run rotate @s facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport20] sea_crafter matches 30020 at @n[tag=SEAcrafter_tp20,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run rotate @s facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport21] sea_crafter matches 30021 at @n[tag=SEAcrafter_tp21,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run rotate @s facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport22] sea_crafter matches 30022 at @n[tag=SEAcrafter_tp22,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run rotate @s facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport23] sea_crafter matches 30023 at @n[tag=SEAcrafter_tp23,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run rotate @s facing entity @n[tag=SEAcrafter]
