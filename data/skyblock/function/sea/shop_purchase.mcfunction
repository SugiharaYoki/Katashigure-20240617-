...
execute if score @s[tag=sea_teleport10] sea_crafter matches 30010 unless score SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp10,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
...
execute if score @s[tag=sea_teleport20] sea_crafter matches 30020 unless score SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp20,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport21] sea_crafter matches 30021 unless score SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp21,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport22] sea_crafter matches 30022 unless score SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp22,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport23] sea_crafter matches 30023 unless score SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp23,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
