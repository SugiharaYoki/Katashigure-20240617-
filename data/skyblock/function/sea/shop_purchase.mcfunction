...
execute if entity @s[tag=sea_purchase_pass] run tellraw @a[gamemode=spectator,distance=0..20] [{"text":"◆ 玩家操作：","bold":true,"color":"yellow"},{"text":"购买回声碎片","bold":true,"color":"white"}]
...
execute if entity @s[tag=sea_purchase_pass] run tellraw @a[gamemode=spectator,distance=0..20] [{"text":"◆ 玩家操作：","bold":true,"color":"yellow"},{"text":"购买5个回声碎片","bold":true,"color":"white"}]
...
execute if entity @s[tag=sea_purchase_pass] run tellraw @a[gamemode=spectator,distance=0..20] [{"text":"◆ 玩家操作：","bold":true,"color":"yellow"},{"text":"购买一次性打火石","bold":true,"color":"white"}]
tag @s remove sea_purchase_pass
...
execute if entity @s[tag=sea_purchase_pass] run tellraw @a[gamemode=spectator,distance=0..20] [{"text":"◆ 玩家操作：","bold":true,"color":"yellow"},{"text":"打造回响指南针","bold":true,"color":"white"}]
tag @s remove sea_purchase_pass
...
execute if entity @s[tag=sea_purchase_pass] run give @s shield[custom_name='{"text":"防护盾","italic":false,"color":"red"}',custom_data={sea_shield:true},attribute_modifiers=[{type:"movement_speed",slot:"hand",id:"sea_armor:004_01",amount:-0.03,operation:"add_value"}],lore=['{"text":"主手选至此道具的瞬间获得极短暂无敌（无需右键使用）","color":"white","italic":false}','{"text":"在这期间受到攻击并反击可以造成巨额伤害","color":"white","italic":false}']]
execute if entity @s[tag=sea_purchase_pass] run tellraw @a[gamemode=spectator,distance=0..20] [{"text":"◆ 玩家操作：","bold":true,"color":"yellow"},{"text":"制作了盾牌","bold":true,"color":"white"}]
...
execute if entity @s[tag=sea_purchase_pass] run tellraw @a[gamemode=spectator,distance=0..20] [{"text":"◆ 玩家操作：","bold":true,"color":"yellow"},{"text":"通过工作站获得复合弓","bold":true,"color":"white"}]
...
execute if entity @s[tag=sea_purchase_pass] run tellraw @a[gamemode=spectator,distance=0..20] [{"text":"◆ 玩家操作：","bold":true,"color":"yellow"},{"text":"升级复合弓","bold":true,"color":"white"}]
...
execute if entity @s[tag=sea_purchase_pass] run tellraw @a[gamemode=spectator,distance=0..20] [{"text":"◆ 玩家操作：","bold":true,"color":"yellow"},{"text":"制作箭矢","bold":true,"color":"white"}]
...
execute if entity @s[tag=sea_purchase_pass] run tellraw @a[gamemode=spectator,distance=0..20] [{"text":"◆ 玩家操作：","bold":true,"color":"yellow"},{"text":"制作锯片","bold":true,"color":"white"}]
...
execute if entity @s[tag=sea_purchase_pass] run tellraw @a[gamemode=spectator,distance=0..20] [{"text":"◆ 玩家操作：","bold":true,"color":"yellow"},{"text":"制作定时炸弹","bold":true,"color":"white"}]
...
execute if entity @s[tag=sea_purchase_pass] run tellraw @a[gamemode=spectator,distance=0..20] [{"text":"◆ 玩家操作：","bold":true,"color":"yellow"},{"text":"制作燃爆剂","bold":true,"color":"white"}]
...
execute if entity @s[tag=sea_purchase_pass] run tellraw @a[gamemode=spectator,distance=0..20] [{"text":"◆ 玩家操作：","bold":true,"color":"yellow"},{"text":"购买可控地雷","bold":true,"color":"white"}]
...
execute if entity @s[tag=sea_purchase_pass] run tellraw @a[gamemode=spectator,distance=0..20] [{"text":"◆ 玩家操作：","bold":true,"color":"yellow"},{"text":"使用金西瓜兑换命星","bold":true,"color":"white"}]
execute if entity @s[tag=sea_purchase_pass] run clear @s echo_shard 5
tag @s remove sea_purchase_pass
...
execute if entity @s[tag=sea_purchase_pass] run tellraw @a[gamemode=spectator,distance=0..20] [{"text":"◆ 玩家操作：","bold":true,"color":"yellow"},{"text":"使用金西瓜兑换3根金萝卜","bold":true,"color":"white"}]
execute if entity @s[tag=sea_purchase_pass] run clear @s glistering_melon_slice 1
tag @s remove sea_purchase_pass
...
execute if entity @s[tag=sea_purchase_pass] run tellraw @a[gamemode=spectator,distance=0..20] [{"text":"◆ 玩家操作：","bold":true,"color":"yellow"},{"text":"使用金西瓜兑换15绿宝石","bold":true,"color":"white"}]
execute if entity @s[tag=sea_purchase_pass] run clear @s glistering_melon_slice 1
tag @s remove sea_purchase_pass
...
execute if entity @s[tag=sea_purchase_pass] run tellraw @a[gamemode=spectator,distance=0..20] [{"text":" - 玩家成功打造了艾德雯娜的深海宝石！","bold":true,"color":"gold"}]
tag @s remove sea_purchase_pass
...
execute if entity @s[tag=sea_purchase_pass] run tellraw @a[gamemode=spectator,distance=0..20] [{"text":" - 玩家切碎了绿宝石块","bold":true,"color":"green"}]
...
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:item.lodestone_compass.lock neutral @s ~ ~ ~ 100 0.8
execute if entity @s[tag=sea_purchase_pass] run playsound minecraft:block.enchantment_table.use neutral @s ~ ~ ~ 100 0.9
execute if entity @s[tag=sea_purchase_pass,scores={rng1=1..15}] run give @s bolt_armor_trim_smithing_template[custom_name='{"text":"密械铜板","italic":true,"color":"light_purple","italic":false}',lore=['{"text":"守护 III 强化护甲","color":"white","italic":false}'],custom_data={sea_t_armor3:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=16..20}] run give @s bolt_armor_trim_smithing_template[custom_name='{"text":"坍缩铜板","italic":true,"color":"light_purple","italic":false}',lore=['{"text":"守护 IV 强化护甲","color":"white","italic":false}'],custom_data={sea_t_armor4:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=21..35}] run give @s bolt_armor_trim_smithing_template[custom_name='{"text":"密械铜板","italic":true,"color":"light_purple","italic":false}',lore=['{"text":"汲苒 III 增加生命上限","color":"white","italic":false}'],custom_data={sea_t_health3:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=36..40}] run give @s bolt_armor_trim_smithing_template[custom_name='{"text":"坍缩铜板","italic":true,"color":"light_purple","italic":false}',lore=['{"text":"汲苒 IV 增加生命上限","color":"white","italic":false}'],custom_data={sea_t_health4:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=41..45}] run give @s netherite_scrap[custom_name='{"text":"废物铜板","italic":true,"color":"gray","italic":false}',lore=['{"text":"毫无任何魔力感应","color":"gray","italic":false}'],custom_data={sea_t_empty:true}]
execute if entity @s[tag=sea_purchase_pass,scores={rng1=41..45}] run give @s emerald 30
...
execute if score @s[tag=sea_teleport01] sea_crafter matches 30001 unless SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp1,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport02] sea_crafter matches 30002 unless SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp2,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport03] sea_crafter matches 30003 unless SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp3,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport04] sea_crafter matches 30004 unless SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp4,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport05] sea_crafter matches 30005 unless SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp5,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport06] sea_crafter matches 30006 unless SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp6,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport07] sea_crafter matches 30007 unless SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp7,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport08] sea_crafter matches 30008 unless SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp8,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport09] sea_crafter matches 30009 unless SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp9,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport10] sea_crafter matches 30010 unless SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp10,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport11] sea_crafter matches 30011 unless SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp11,type=marker] if entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport12] sea_crafter matches 30012 unless SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp12,type=marker] if entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport13] sea_crafter matches 30013 unless SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp13,type=marker] if entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport14] sea_crafter matches 30014 unless SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp14,type=marker] if entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport15] sea_crafter matches 30015 unless SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp15,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport16] sea_crafter matches 30016 unless SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp16,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport17] sea_crafter matches 30017 unless SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp17,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport18] sea_crafter matches 30018 unless SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp18,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport19] sea_crafter matches 30019 unless SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp19,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport20] sea_crafter matches 30020 unless SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp20,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport21] sea_crafter matches 30021 unless SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp21,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport22] sea_crafter matches 30022 unless SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp22,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
execute if score @s[tag=sea_teleport23] sea_crafter matches 30023 unless SEA_ch6_event rng5 matches 1112.. at @n[tag=SEAcrafter_tp23,type=marker] unless entity @n[tag=SEAcrafter_foodless,distance=0..3] run tp @s ~ ~ ~ facing entity @n[tag=SEAcrafter]
...
execute if score @s sea_crafter matches 90002 if block 90075 103 141 minecraft:cauldron unless block 90074 103 137 scaffolding if entity @n[tag=sc,scores={sea_4temp2=227..247}] run scoreboard players set @n[tag=sc] sea_4temp2 248
execute if score @s sea_crafter matches 90003 if block 90062 103 135 grindstone unless block 90075 103 141 minecraft:cauldron if entity @n[tag=sc,scores={sea_4temp2=104..120}] run scoreboard players set @n[tag=sc] sea_4temp2 121
