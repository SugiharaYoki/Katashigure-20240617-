...
execute if score @s sea_crafter matches 90004 if block 90075 103 141 minecraft:cauldron unless block 90074 103 137 scaffolding if entity @n[tag=SEAmarshall,scores={sea_4temp1=372..464}] run scoreboard players set @n[tag=SEAmarshall] sea_4temp2 465
