...
item replace block 90158 35 95 container.13 with firework_star[custom_name={text:"燃爆剂",color:"blue",italic:0b},lore=[{text:"喷火器专用燃爆剂。",color:"white",italic:0b},{text:"使用喷火器时右键，瞬间对面前近距离造成大量伤害。",color:"white",italic:0b}]] 3
