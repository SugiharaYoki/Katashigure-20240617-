...
setblock 90086 145 116 chest[facing=north]{lock:{components:{custom_data:{"sea_key09":true}}}}
...
setblock 90086 143 116 chest[facing=north]{lock:{components:{custom_data:{"sea_key09":true}}}}

setblock 90086 145 114 air
setblock 90086 145 114 chest[facing=north]{lock:{components:{custom_data:{"sea_key08":true}}}}
...
setblock 90086 143 114 chest[facing=north]{lock:{components:{custom_data:{"sea_key08":true}}}}
...
setblock 90130 151 142 chest[facing=east]{lock:{components:{custom_data:{"sea_key07":true}}}}
...
item replace block 90124 144 116 container.13 with emerald[lore=['{"text":"随心贴：物资层外围有一面砖墙，你去找找看吧。","color":"gray","italic":false}']] 1
...
setblock 90107 156 135 barrel[facing=south]{lock:{components:{custom_data:{"sea_key06":true}}}}
