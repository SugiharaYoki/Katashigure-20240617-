...
advancement grant @s only skyblock:sea/doc/gfolder1
...
advancement grant @s[scores={sea_progress=14..}] only skyblock:sea/chapter5b
advancement grant @s[scores={sea_progress=14..}] only skyblock:sea/chapter5c

advancement grant @s[scores={sea_progress=15..}] only skyblock:sea/chapter6
advancement grant @s[scores={sea_progress=15..}] only skyblock:sea/doc/documentary6
advancement grant @s[scores={sea_progress=16..}] only skyblock:sea/chapter6b
