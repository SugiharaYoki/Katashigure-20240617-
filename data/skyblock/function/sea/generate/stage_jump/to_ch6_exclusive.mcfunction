...
execute positioned 90142 135 26 run tellraw @a[distance=0..150] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“走吧，目标是行政区。”",color:"white",bold: false}]
execute positioned 90142 135 26 run playsound entity.wandering_trader.ambient neutral @a ~ ~ ~ 1 1.3
execute as @p[tag=SEAPT] at @s as @a[distance=..200] at @s run playsound garden2.bgm.contestedterritories music @s ~ ~ ~ 0.7 1.0
