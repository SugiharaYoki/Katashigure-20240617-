...
execute if entity @s[scores={SEAPT_setting_yuehan=2}] run give @a[tag=SEAPT] snout_armor_trim_smithing_template[custom_name={text:"透光吸附 A",color:"light_purple",italic:0b},lore=[{text:"光谱 I 光棱箭的转换速度加快",color:"white",italic:0b}],custom_data={sea_t_spectral_load1:true}]
