...
#clear @a[tag=SEAPT]
item replace entity @a[tag=SEAPT] armor.feet with leather_boots[custom_name={text:"基础防护靴",italic:0b,color:"red"},custom_data={sea_feet:true},attribute_modifiers=[{type:"armor",id:"sea_armor:008_01",amount:1.0,operation:"add_value"},{type:"armor_toughness",id:"sea_armor:008_02",amount:0.5,operation:"add_value"}],unbreakable={}]
