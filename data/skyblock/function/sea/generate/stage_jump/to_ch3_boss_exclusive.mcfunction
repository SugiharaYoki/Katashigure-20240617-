...
execute positioned 90149 108 103 run tellraw @a[x=90000,y=100,z=0,distance=0..500] [{text:"越涵：",color:"green",bold:1b},{text:"\n“……们、哥们？哎哟你终于有反应了，你在这发什么呆呢？怎么叫你都不理我。着魔了？”",color:"white",bold: false}]
...
function skyblock:sea/e/ch6/yuehan/init
