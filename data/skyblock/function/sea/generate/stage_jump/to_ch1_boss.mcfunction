...
item replace entity @a[tag=SEAPT] armor.legs with leather_leggings[custom_name={text:"基础防护裤",italic:0b,color:"red"},custom_data={sea_leg:true},attribute_modifiers=[{type:"armor",id:"sea_armor:001_01",amount:1.0,operation:"add_value"},{type:"armor_toughness",id:"sea_armor:001_02",amount:0.5,operation:"add_value"}],unbreakable={}]
