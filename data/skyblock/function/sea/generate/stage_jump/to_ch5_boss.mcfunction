...
execute unless entity @s[scores={SEAPT_setting_fiona=1..}] scoreboard players add SEA_ch5_event_fiona_favor rng1 8
execute if entity @s[scores={SEAPT_setting_fiona=1}] scoreboard players add SEA_ch5_event_fiona_favor rng1 0
execute if entity @s[scores={SEAPT_setting_fiona=2}] scoreboard players add SEA_ch5_event_fiona_favor rng1 8
execute if entity @s[scores={SEAPT_setting_fiona=3}] scoreboard players add SEA_ch5_event_fiona_favor rng1 16
execute if entity @s[scores={SEAPT_setting_fiona=4}] scoreboard players add SEA_ch5_event_fiona_favor rng1 24
...
setblock 90108 107 26 chain
setblock 90111 107 26 chain
setblock 90108 107 29 chain
setblock 90111 107 29 chain
