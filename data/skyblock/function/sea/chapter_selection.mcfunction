...
execute if block 90078 91 145 red_concrete run summon minecraft:armor_stand 90074 92.3 139 {CustomName:'{"text": "第二章 物资层 BOSS关卡","color": "green"}',DisabledSlots:65793,CustomNameVisible:1b,Invisible:1b,Marker:1b,NoGravity:1b,Tags:["SEA_choose_chapter_2b","SEA_choose_chapter"]}
...
execute if block 90078 91 145 yellow_concrete run summon minecraft:armor_stand 90074 92.3 139 {CustomName:'{"text": "第三章 主平台甲板 BOSS关卡","color": "green"}',DisabledSlots:65793,CustomNameVisible:1b,Invisible:1b,Marker:1b,NoGravity:1b,Tags:["SEA_choose_chapter_3b","SEA_choose_chapter"]}
execute if block 90078 91 145 blue_concrete run summon minecraft:armor_stand 90074 92.3 139 {CustomName:'{"text": "第四章 水下研究设施 初始","color": "green"}',DisabledSlots:65793,CustomNameVisible:1b,Invisible:1b,Marker:1b,NoGravity:1b,Tags:["SEA_choose_chapter_1","SEA_choose_chapter"]}
execute if block 90078 91 145 cyan_concrete run summon minecraft:armor_stand 90074 92.3 139 {CustomName:'{"text": "第一章 初始","color": "green"}',DisabledSlots:65793,CustomNameVisible:1b,Invisible:1b,Marker:1b,NoGravity:1b,Tags:["SEA_choose_chapter_1","SEA_choose_chapter"]}
