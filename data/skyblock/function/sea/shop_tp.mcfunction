...
tellraw @s {"text":"   "}
execute if entity @s[tag=SEAPT,tag=sea_teleport05] run tellraw @s [{"text":"   - "},{"text":"支架：西南驳口  ","color":"white"},{"text":"〈◆〉","bold":true,"color":"aqua","clickEvent":{"action":"run_command","value":"/trigger sea_crafter set 30005"}}]
execute if entity @s[tag=SEAPT,tag=sea_teleport10] run tellraw @s [{"text":"   - "},{"text":"支架：东北驳口  ","color":"white"},{"text":"〈◆〉","bold":true,"color":"aqua","clickEvent":{"action":"run_command","value":"/trigger sea_crafter set 30010"}}]
...
execute if entity @s[tag=SEAPT,tag=sea_teleport08] run tellraw @s [{"text":"   - "},{"text":"主平台甲板：宿舍楼 2F  ","color":"white"},{"text":"〈◆〉","bold":true,"color":"aqua","clickEvent":{"action":"run_command","value":"/trigger sea_crafter set 30008"}}]
execute if entity @s[tag=SEAPT,tag=sea_teleport09] run tellraw @s [{"text":"   - "},{"text":"主平台甲板：宿舍楼 4F  ","color":"white"},{"text":"〈◆〉","bold":true,"color":"aqua","clickEvent":{"action":"run_command","value":"/trigger sea_crafter set 30009"}}]
