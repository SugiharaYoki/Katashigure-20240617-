...
give @a[tag=SEAPT] raiser_armor_trim_smithing_template 5
give @a[tag=SEAPT] wild_armor_trim_smithing_template 2
give @a[tag=SEAPT] wayfinder_armor_trim_smithing_template 2
give @a[tag=SEAPT] sentry_armor_trim_smithing_template 2
