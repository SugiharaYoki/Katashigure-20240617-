...
execute as @a[tag=SEAPT,x=90170,y=44,z=130,distance=0..3.2,tag=!e_i_35] at @s run title @s times 2s 4s 2s
...
execute positioned 90187 47 105 if entity @a[tag=SEAPT,distance=..8] unless entity @n[tag=SEAch4_spawn,distance=0..1] positioned 90186 46 104 run function skyblock:sea/m/silverfish
...
execute positioned 90198 46 90 if entity @a[tag=SEAPT,distance=..4.6] unless entity @n[tag=SEAch4_spawn_timer1,distance=0..3] run summon marker ~ ~ ~ {Tags:["SEAch4_spawn_timer","SEAch4_spawn_timer_largestairtoentrance"]}
