...
#越涵相遇可选路线
execute if score SEA_ch4_event_railbox rng1 matches 2000.. as @n[tag=SEAyuehan] at @s if score @s sea_4temp1 matches ..2000 unless score @n[tag=SEAch4_spawn_timer_marilyn] sea_4temp1 matches 3..327 run function skyblock:sea/e/ch4/possible_route_yuehan_meet
