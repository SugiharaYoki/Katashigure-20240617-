...
#越涵相遇可选路线
execute if score @n[tag=SEAyuehan] sea_4temp1 matches 10..5000 if entity @a[tag=SEAPT,x=90229,y=51,z=101,dx=7,dy=6,dz=7] run scoreboard players set @n[tag=SEAyuehan] sea_4temp1 5001
