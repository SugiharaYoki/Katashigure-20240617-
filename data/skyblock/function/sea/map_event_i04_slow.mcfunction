...
execute if block 90180 35 139 minecraft:magenta_glazed_terracotta[facing=west] if block 90190 34 134 minecraft:magenta_glazed_terracotta[facing=west] if block 90187 36 137 iron_bars run playsound block.iron_door.open block @a 90191.01 36.98 134.44 0.8
execute if block 90180 35 139 minecraft:magenta_glazed_terracotta[facing=west] if block 90190 34 134 minecraft:magenta_glazed_terracotta[facing=west] if block 90187 36 137 iron_bars run fill 90191 36 134 90190 34 134 air
