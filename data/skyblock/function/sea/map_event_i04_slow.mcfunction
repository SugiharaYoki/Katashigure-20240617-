...
#
execute if block 90192 34 181 stone_button[powered=true] if score sea_ch4_switch_waterstorage sea_4temp2 matches ..0 run scoreboard players set sea_ch4_switch_waterstorage sea_4temp2 31
...
execute if score sea_ch4_switch_waterstorage sea_4temp2 matches 30 run fill 90187 37 172 90193 37 171 minecraft:lime_stained_glass
...
execute positioned 90172 21 106 as @a[tag=SEAPT,distance=..5.7] unless items entity @s container.* heart_of_the_sea unless entity @n[tag=SEAch4_spawn,distance=0..3] positioned 90172 21 106 run function skyblock:sea/m/zombie_knight
execute positioned 90172 21 106 as @a[tag=SEAPT,distance=..5.7] unless items entity @s container.* heart_of_the_sea unless entity @n[tag=SEAch4_spawn,distance=0..3] run summon marker ~ ~ ~ {Tags:["SEAch4_spawn"]}

execute positioned 90192 27 130 as @a[tag=SEAPT,distance=..5.7] unless items entity @s container.* heart_of_the_sea unless entity @n[tag=SEAch4_spawn,distance=0..3] positioned ~ ~ ~ run function skyblock:sea/m/zombie_knight
execute positioned 90192 27 130 as @a[tag=SEAPT,distance=..5.7] unless items entity @s container.* heart_of_the_sea unless entity @n[tag=SEAch4_spawn,distance=0..3] run summon marker ~ ~ ~ {Tags:["SEAch4_spawn"]}

execute positioned 90170 38 172.0 as @a[tag=SEAPT,distance=..5.7] unless items entity @s container.* heart_of_the_sea unless entity @n[tag=SEAch4_spawn,distance=0..3] positioned ~ ~ ~ run function skyblock:sea/m/zombie_knight
execute positioned 90170 38 172.0 as @a[tag=SEAPT,distance=..5.7] unless items entity @s container.* heart_of_the_sea unless entity @n[tag=SEAch4_spawn,distance=0..3] run summon marker ~ ~ ~ {Tags:["SEAch4_spawn"]}
