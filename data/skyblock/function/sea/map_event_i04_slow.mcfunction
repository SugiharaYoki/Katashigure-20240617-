...
execute unless block 90241 46 134 air if score sea_ch4_aquatic_alarm rng1 matches 50.. run scoreboard players set sea_ch4_aquatic_alarm rng1 0
execute unless block 90241 46 134 air run scoreboard players add sea_ch4_aquatic_alarm rng1 1
