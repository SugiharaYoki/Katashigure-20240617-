...
execute as @n[tag=SEAboss4,scores={rng8=60},tag=SEAboss4_cannon] at @s run execute at @n[tag=SEAshotgun_shoot_boss4] as @a[distance=0..2.3] run damage @s 20 explosion
execute as @n[tag=SEAboss4,scores={rng8=60},tag=SEAboss4_cannon] at @s run execute at @n[tag=SEAshotgun_shoot_boss4] as @a[distance=0..2.3] run data modify entity @s Fire set value 160s
...
execute as @n[tag=SEAboss4,scores={rng8=60},tag=SEAboss4_cannon] at @s run execute at @n[tag=SEAshotgun_shoot_boss4] as @a[distance=0..2.3] run damage @s 16 explosion
execute as @n[tag=SEAboss4,scores={rng8=60},tag=SEAboss4_cannon] at @s run execute at @n[tag=SEAshotgun_shoot_boss4] as @a[distance=0..2.3] run data modify entity @s Fire set value 140s
...
execute as @n[tag=SEAboss4,scores={rng8=60},tag=SEAboss4_cannon] at @s run execute at @n[tag=SEAshotgun_shoot_boss4] as @a[distance=0..2.7] run damage @s 14 explosion
execute as @n[tag=SEAboss4,scores={rng8=60},tag=SEAboss4_cannon] at @s run execute at @n[tag=SEAshotgun_shoot_boss4] as @a[distance=0..2.7] run data modify entity @s Fire set value 120s
execute as @n[tag=SEAboss4,scores={rng8=60},tag=SEAboss4_cannon] at @s run execute as @n[tag=SEAshotgun_shoot_boss4] at @s run tp @s ^ ^ ^0.5
execute as @n[tag=SEAboss4,scores={rng8=60},tag=SEAboss4_cannon] at @s run execute at @n[tag=SEAshotgun_shoot_boss4] as @a[distance=0..2.7] run damage @s 12 explosion
execute as @n[tag=SEAboss4,scores={rng8=60},tag=SEAboss4_cannon] at @s run execute at @n[tag=SEAshotgun_shoot_boss4] as @a[distance=0..2.7] run data modify entity @s Fire set value 100s
execute as @n[tag=SEAboss4,scores={rng8=60},tag=SEAboss4_cannon] at @s run execute as @n[tag=SEAshotgun_shoot_boss4] at @s run tp @s ^ ^ ^0.5
execute as @n[tag=SEAboss4,scores={rng8=60},tag=SEAboss4_cannon] at @s run execute at @n[tag=SEAshotgun_shoot_boss4] as @a[distance=0..2.9] run damage @s 10 explosion
execute as @n[tag=SEAboss4,scores={rng8=60},tag=SEAboss4_cannon] at @s run execute at @n[tag=SEAshotgun_shoot_boss4] as @a[distance=0..2.9] run data modify entity @s Fire set value 80s
