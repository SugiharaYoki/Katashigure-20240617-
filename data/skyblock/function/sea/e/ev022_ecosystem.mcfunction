...
execute as @s[scores={sea_4temp1=38}] run tellraw @a[tag=SEAPT] {"text": "陌生的女声：“该不该说我很佩服你呢？居然能活着闯过整个水下研究设施。”","color": "green"}
execute as @s[scores={sea_4temp1=50}] run tellraw @a[tag=SEAPT] {"text": "陌生的女声：“我想我用言语是劝不住你了。接下来，我会用武器来阻止你。”","color": "green"}
execute as @s[scores={sea_4temp1=76}] run tellraw @a[tag=SEAPT] {"text": "陌生的女声：“劝你好自为之。没多少时间留给你慢慢思考了。”","color": "green"}
execute as @s[scores={sea_4temp1=73}] as @n[tag=SEAedwina] at @s run summon marker ~ ~ ~ {Tags:["SEAedwina_smoke"]}
execute as @s[scores={sea_4temp1=80}] as @n[tag=SEAedwina] at @s run effect give @s invisibility 10 0 true
execute as @s[scores={sea_4temp1=80}] as @n[tag=SEAedwina] at @s run tp @s ~ ~-500 ~
execute as @s[scores={sea_4temp1=81}] as @n[tag=SEAedwina] at @s run kill @s
