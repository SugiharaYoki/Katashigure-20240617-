...
execute as @s[scores={sea_4temp1=15}] if block 90236 63 85 air run tellraw @a[tag=SEAPT] {"text": "陌生的女声：“你真的不吸取教训。”","color": "green"}
execute as @s[scores={sea_4temp1=15}] if block 90236 63 85 grindstone run tellraw @a[tag=SEAPT] {"text": "艾德雯娜：“我刚刚小酣的时候做了一场梦，该说的我已经在梦里说了。”","color": "green"}
...
execute as @s[scores={sea_4temp1=70}] if block 90236 63 85 air run tellraw @a[tag=SEAPT] {"text": "陌生的女声：“劝你好自为之。没多少时间留给你慢慢思考了。”","color": "green"}
execute as @s[scores={sea_4temp1=70}] if block 90236 63 85 grindstone run tellraw @a[tag=SEAPT] {"text": "艾德雯娜：“我这人向来不喜欢把话说两遍，所以没必要废话了。”","color": "green"}
