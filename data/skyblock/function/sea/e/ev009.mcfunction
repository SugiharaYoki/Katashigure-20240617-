...
execute if entity @n[tag=SEAyuehan,tag=SEA_ch4elevator_start,scores={sea_4temp5=36..}] as @a[tag=SEAPT] at @s if entity @n[tag=sea_ch4elevator1,distance=0..4.1] run attribute @s gravity base set 0.01
...
execute as @n[tag=SEAyuehan,tag=SEA_ch4elevator_start,scores={sea_4temp5=36..}] at @s as @p[tag=SEAPT] at @s if block ~ ~-0.03 ~ barrier as @a[tag=SEAPT] run attribute @s gravity base set 0.08
