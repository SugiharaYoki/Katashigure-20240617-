...
execute as @a[tag=SEAPT,x=90125,y=103,z=100,distance=0..5] at @s unless entity @n[tag=SEAyuehan,tag=SEA_ch4elevator_start,x=90125,y=103,z=100,distance=0..5] run tp @n[tag=SEAyuehan,tag=!SEA_ch4elevator_end] 90125 103 100
...
execute if entity @n[tag=SEAyuehan,tag=SEA_ch4elevator_start] as @a[tag=SEAPT] at @s if entity @n[tag=sea_ch4elevator1,distance=0..4.1] run attribute @s generic.gravity base set 0.04
