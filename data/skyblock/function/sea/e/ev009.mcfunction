execute as @a[tag=SEAPT] at @s if block ~ ~-1 ~ barrier unless entity @a[tag=SEAPT,distance=2..] unless entity @n[tag=SEAyuehan,tag=SEA_ch4elevator_start] unless entity @n[tag=SEAyuehan,tag=SEA_ch4elevator_end] run playsound minecraft:item.armor.equip_iron block @a 90125 103 100 1 0.7
