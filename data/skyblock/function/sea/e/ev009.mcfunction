...
execute if entity @n[tag=SEAyuehan,tag=SEA_ch4elevator_start] as @n[tag=sea_ch4elevator1] at @s at @p[tag=SEAPT,distance=0..4.1] run tp @s 90125.0 ~-0.5 99.0
execute as @n[tag=SEAyuehan,tag=SEA_ch4elevator_start] at @n[tag=sea_ch4elevator1] run tp @s 90125 ~0.9 100

execute as @n[tag=SEAyuehan,tag=SEA_ch4elevator_start] at @s as @p at @s if block ~ ~-0.1 ~ barrier run playsound item.mace.smash_ground block @a 90126 36 100 1 0.5
execute as @n[tag=SEAyuehan,tag=SEA_ch4elevator_start] at @s as @p at @s if block ~ ~-0.1 ~ barrier run tag @n[tag=SEAyuehan] add SEA_ch4elevator_end
execute as @n[tag=SEAyuehan,tag=SEA_ch4elevator_start] at @s as @p at @s if block ~ ~-0.1 ~ barrier run tag @n[tag=SEAyuehan] remove SEA_ch4elevator_start
