execute as @a[tag=SEAPT] at @s if block ~ ~-1 ~ barrier unless entity @a[tag=SEAPT,distance=2..] if entity @n[tag=SEAyuehan,scores={sea_4temp5=36..}] unless entity @n[tag=SEAyuehan,tag=SEA_ch4elevator_start] unless entity @n[tag=SEAyuehan,tag=SEA_ch4elevator_end] run playsound minecraft:item.armor.equip_iron block @a 90125 103 100 1 0.7
...
execute if entity @n[tag=SEAyuehan,tag=SEA_ch4elevator_start,scores={sea_4temp5=36..}] as @a[tag=SEAPT] at @s if entity @n[tag=sea_ch4elevator1,distance=0..4.1] run effect give @s slow_falling 3 149 true
...
execute if entity @n[tag=SEAyuehan,tag=SEA_ch4elevator_start,scores={sea_4temp5=36..}] as @n[tag=sea_ch4elevator1] at @s at @p[tag=SEAPT,distance=0..4.1] run tp @s 90125.0 ~-1.1 99.0
...
execute as @n[tag=SEAyuehan,tag=SEA_ch4elevator_start,scores={sea_4temp5=36..}] at @n[tag=sea_ch4elevator1] run tp @s 90125 ~0.5 100
