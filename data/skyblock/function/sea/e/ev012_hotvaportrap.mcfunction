...
execute if score SEAch4_hotvaportrapA sea_4temp2 matches 10..30 positioned 90165.62 13.00 155.68 as @a[distance=0..0.5] run effect clear @s resistance
execute if score SEAch4_hotvaportrapA sea_4temp2 matches 10..30 positioned 90165.62 13.00 155.68 as @a[distance=0..0.5] run damage @s 4 in_fire
...
execute if score SEAch4_hotvaportrapA sea_4temp2 matches 12..32 positioned 90166.54 13.00 156.41 as @a[distance=0..0.5] run effect clear @s resistance
execute if score SEAch4_hotvaportrapA sea_4temp2 matches 12..32 positioned 90166.54 13.00 156.41 as @a[distance=0..0.5] run damage @s 4 in_fire
...
execute if score SEAch4_hotvaportrapA sea_4temp2 matches 16..36 positioned 90168.60 13.00 154.67 as @a[distance=0..0.5] run effect clear @s resistance
execute if score SEAch4_hotvaportrapA sea_4temp2 matches 16..36 positioned 90168.60 13.00 154.67 as @a[distance=0..0.5] run damage @s 4 in_fire
...
execute if score SEAch4_hotvaportrapA sea_4temp2 matches 18..38 positioned 90169.74 13.00 155.22 as @a[distance=0..0.5] run effect clear @s resistance
execute if score SEAch4_hotvaportrapA sea_4temp2 matches 18..38 positioned 90169.74 13.00 155.22 as @a[distance=0..0.5] run damage @s 4 in_fire
...
execute if score SEAch4_hotvaportrapA sea_4temp2 matches 22..42 positioned 90172.33 13.00 156.27 as @a[distance=0..0.5] run effect clear @s resistance
execute if score SEAch4_hotvaportrapA sea_4temp2 matches 22..42 positioned 90172.33 13.00 156.27 as @a[distance=0..0.5] run damage @s 4 in_fire
