...
execute as @s[scores={sea_4temp1=52}] if block 90236 63 85 air run tellraw @a[tag=SEAPT] [{"text":"艾德雯娜","color":"green","bold": true},{"text":"\n“他们没能破坏生态主控，但冷凝系统的过热使得研究设施无法再撑超过3小时。”","color":"white","bold": false}]
...
execute as @s[scores={sea_4temp1=74}] run tellraw @a[tag=SEAPT] [{"text":"艾德雯娜","color":"green","bold": true},{"text":"\n“明明再过三小时，这里的一切就会灰飞烟灭。我不会让你将你的所见所闻带出去。”","color":"white","bold": false}]
...
execute as @s[scores={rng1=105..}] as @n[tag=SEAboss4_end,x=90185.00,y=57.14,z=80.87,distance=1.5..] at @s facing 90185.00 57.14 80.87 run tp @s ~ ~ ~1 ~ 0
