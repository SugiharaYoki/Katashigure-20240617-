...
execute if score sea_ch2_angel_bless_trial sea_4temp2 matches 1023 positioned 90120 123 123 as @a[distance=0..300] at @s run playsound garden2.bgm.001 music @s ~ ~ ~ 5 1.0
