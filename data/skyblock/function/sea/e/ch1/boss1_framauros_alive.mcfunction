...
execute as @s[scores={sea_4temp2=6071}] at @n[tag=SEAframauros] as @p[tag=SEAPT] run tellraw @a[tag=SEAPT] [{"selector":"@s","color":"aqua"},{"text":"：\n“你就是……法莫洛斯医生？其他人呢、你……还好吗？”","color":"white"}]
...
execute as @s[scores={sea_4temp2=6141}] at @n[tag=SEAframauros] as @p[tag=SEAPT] run tellraw @a[tag=SEAPT] [{"selector":"@s","color":"aqua"},{"text":"：\n“法莫洛斯医生……”","color":"white"}]
execute as @s[scores={sea_4temp2=6168}] at @n[tag=SEAframauros] as @p[tag=SEAPT] run tellraw @a[tag=SEAPT] [{"selector":"@s","color":"aqua"},{"text":"：\n“其他人呢，还有多少人活着？”","color":"white"}]
