...
execute as @s[scores={sea_4temp2=216}] positioned 90120 123 123 as @p[tag=SEAPT] at @s if score sea_player_count rng1 matches 2 run tellraw @a[tag=SEAPT,distance=3..] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“我接通联络总站了！你快来我这里。”",color:"white"}]
execute as @s[scores={sea_4temp2=216}] positioned 90120 123 123 as @p[tag=SEAPT] at @s if score sea_player_count rng1 matches 3.. run tellraw @a[tag=SEAPT,distance=3..] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“我接通联络总站了！你们快来我这里。”",color:"white"}]
...
execute as @s[scores={sea_4temp2=230}] positioned 90120 123 123 if score sea_player_count rng1 matches 1.. if entity @a[scores={SEAPT_member=1}] run tellraw @a[distance=0..50] [{selector:"@p[tag=SEAPT,scores={SEAPT_member=1}]",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“喂？！听得见吗、这里到底是什么情况？！”",color:"white"}]
...
execute as @s[scores={sea_4temp2=272}] positioned 90120 123 123 if score sea_player_count rng1 matches 1 run tellraw @a[distance=0..50] [{text:"联络机台：",color:"dark_purple",bold:1b},{text:"\n“我从监控看到你附近的房间了！我劝你快从那里离开，立——\n”",color:"white",bold: false}]
execute as @s[scores={sea_4temp2=272}] positioned 90120 123 123 if score sea_player_count rng1 matches 2.. run tellraw @a[distance=0..50] [{text:"联络机台：",color:"dark_purple",bold:1b},{text:"\n“我从监控看到你们附近的房间了！我劝你快从那里离开，立——\n”",color:"white",bold: false}]
...
execute as @s[scores={sea_4temp2=290}] positioned 90120 123 123 if score sea_player_count rng1 matches 1.. if entity @a[scores={SEAPT_member=1}] run tellraw @a[distance=0..50] [{selector:"@p[tag=SEAPT,scores={SEAPT_member=1}]",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“操，她听不清我说话。”",color:"white"}]

execute as @s[scores={sea_4temp2=305}] positioned 90120 123 123 if score sea_player_count rng1 matches 1 run tellraw @a[distance=0..50] {text:"离开？把这些怪物放着不管吗？这不是我来这的目的。",color:"gray"}
execute as @s[scores={sea_4temp2=335}] positioned 90120 123 123 if score sea_player_count rng1 matches 1 run tellraw @a[distance=0..50] {text:"我得守在这里，把这些怪东西全给解决掉。",color:"gray"}
execute as @s[scores={sea_4temp2=305}] positioned 90120 123 123 if score sea_player_count rng1 matches 2.. if entity @a[scores={SEAPT_member=2}] run tellraw @a[distance=0..50] [{selector:"@p[tag=SEAPT,scores={SEAPT_member=2}]",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“该表演临阵脱逃了。”",color:"white"}]
execute as @s[scores={sea_4temp2=335}] positioned 90120 123 123 if score sea_player_count rng1 matches 2.. if entity @a[scores={SEAPT_member=1}] run tellraw @a[distance=0..50] [{selector:"@p[tag=SEAPT,scores={SEAPT_member=1}]",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“放屁，守住我后背，咱们多少也得把这些怪物给干掉。”",color:"white"}]
...
execute as @s[scores={sea_4temp2=524}] positioned 90120 123 123 if score sea_player_count rng1 matches 2.. if entity @a[scores={SEAPT_member=2}] run tellraw @a[distance=0..50] [{selector:"@p[tag=SEAPT,scores={SEAPT_member=2}]",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“到底有多少个？我说，我们为什么要做这种事情。”",color:"white"}]
execute as @s[scores={sea_4temp2=599}] positioned 90120 123 123 if score sea_player_count rng1 matches 2.. if entity @a[scores={SEAPT_member=2}] if entity @a[scores={SEAPT_member=1}] run tellraw @a[distance=0..50] [{selector:"@p[tag=SEAPT,scores={SEAPT_member=1}]",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“你是傻子吗？钻井平台发生丧尸危机——我们这么给领导汇报过去，鬼会信我们？”",color:"white"}]
execute as @s[scores={sea_4temp2=699}] positioned 90120 123 123 if score sea_player_count rng1 matches 2.. if entity @a[scores={SEAPT_member=2}] if entity @a[scores={SEAPT_member=3}] run tellraw @a[distance=0..50] [{selector:"@p[tag=SEAPT,scores={SEAPT_member=3}]",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“而且最坏情况他们已经知道会发生这种事，那我们作为知情者可活不了。”",color:"white"}]

execute if score sea_player_count rng1 matches 1 store result score @n[tag=sc,scores={sea_4temp2=200..1200}] rng1 run random value 1..18
execute if score sea_player_count rng1 matches 2 store result score @n[tag=sc,scores={sea_4temp2=200..1200}] rng1 run random value 1..17
execute if score sea_player_count rng1 matches 3.. store result score @n[tag=sc,scores={sea_4temp2=200..1200}] rng1 run random value 1..15
execute if score sea_player_count rng1 matches 5.. store result score @n[tag=sc,scores={sea_4temp2=200..1200}] rng1 run random value 1..13
...
execute if score sea_player_count rng1 matches 2.. if entity @a[tag=SEAPT,x=90125,y=123,z=118,distance=0..9.2] as @n[tag=sc,scores={sea_4temp2=930}] positioned 90127 126 122 run function skyblock:sea/m/pillager
execute if score sea_player_count rng1 matches 4.. if entity @a[tag=SEAPT,x=90125,y=123,z=118,distance=0..9.2] as @n[tag=sc,scores={sea_4temp2=950}] positioned 90127 126 122 run function skyblock:sea/m/pillager
execute if score sea_player_count rng1 matches 4.. if entity @a[tag=SEAPT,x=90125,y=123,z=118,distance=0..9.2] as @n[tag=sc,scores={sea_4temp2=980}] positioned 90127 126 122 run function skyblock:sea/m/pillager
...
execute if score sea_player_count rng1 matches 3.. if entity @a[tag=SEAPT,x=90125,y=123,z=118,distance=0..9.2] as @n[tag=sc,scores={sea_4temp2=1050}] positioned 90127 126 122 run function skyblock:sea/m/pillager
