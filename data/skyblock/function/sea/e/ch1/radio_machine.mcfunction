...
execute as @s[scores={sea_4temp2=216}] positioned 90120 123 123 as @p[tag=SEAPT] at @s if entity @n[tag=sc,scores={sea_player=2}] run tellraw @a[tag=SEAPT,distance=3..] [{"selector":"@s","color":"aqua"},{"text":"：\n“我接通联络总站了！你快来我这里。”","color":"white"}]
execute as @s[scores={sea_4temp2=216}] positioned 90120 123 123 as @p[tag=SEAPT] at @s if entity @n[tag=sc,scores={sea_player=3..}] run tellraw @a[tag=SEAPT,distance=3..] [{"selector":"@s","color":"aqua"},{"text":"：\n“我接通联络总站了！你们快来我这里。”","color":"white"}]
...
execute as @s[scores={sea_4temp2=230}] positioned 90120 123 123 if entity @n[tag=sc,scores={sea_player=1..}] if entity @a[scores={SEAPT_member=1}] run tellraw @a[distance=0..50] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=1}]","color":"aqua"},{"text":"：\n“喂？！听得见吗、这里到底是什么情况？！”","color":"white"}]
...
execute as @s[scores={sea_4temp2=290}] positioned 90120 123 123 if entity @n[tag=sc,scores={sea_player=1..}] if entity @a[scores={SEAPT_member=1}] run tellraw @a[distance=0..50] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=1}]","color":"aqua"},{"text":"：\n“操，她听不清我说话。”","color":"white"}]
...
execute as @s[scores={sea_4temp2=305}] positioned 90120 123 123 if entity @n[tag=sc,scores={sea_player=2..}] if entity @a[scores={SEAPT_member=2}] run tellraw @a[distance=0..50] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=2}]","color":"aqua"},{"text":"：\n“该表演临阵脱逃了。”","color":"white"}]
execute as @s[scores={sea_4temp2=335}] positioned 90120 123 123 if entity @n[tag=sc,scores={sea_player=2..}] if entity @a[scores={SEAPT_member=1}] run tellraw @a[distance=0..50] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=1}]","color":"aqua"},{"text":"：\n“放屁，守住我后背，咱们多少也得把这些怪物给干掉。”","color":"white"}]
...
execute as @s[scores={sea_4temp2=524}] positioned 90120 123 123 if entity @n[tag=sc,scores={sea_player=2..}] if entity @a[scores={SEAPT_member=2}] run tellraw @a[distance=0..50] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=2}]","color":"aqua"},{"text":"：\n“到底有多少个？我说，我们为什么要做这种事情。”","color":"white"}]
execute as @s[scores={sea_4temp2=599}] positioned 90120 123 123 if entity @n[tag=sc,scores={sea_player=2..}] if entity @a[scores={SEAPT_member=2}] if entity @a[scores={SEAPT_member=1}] run tellraw @a[distance=0..50] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=1}]","color":"aqua"},{"text":"：\n“你是傻子吗？钻井平台发生丧尸危机——我们这么给领导汇报过去，鬼会信我们？”","color":"white"}]
execute as @s[scores={sea_4temp2=699}] positioned 90120 123 123 if entity @n[tag=sc,scores={sea_player=2..}] if entity @a[scores={SEAPT_member=2}] if entity @a[scores={SEAPT_member=3}] run tellraw @a[distance=0..50] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=3}]","color":"aqua"},{"text":"：\n“而且最坏情况他们已经知道会发生这种事，那我们作为知情者可活不了。”","color":"white"}]
...
execute as @s[scores={sea_4temp2=1109}] positioned 90120 123 123 if entity @a[scores={SEAPT_member=1}] run tellraw @a[distance=0..50] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=1}]","color":"aqua"},{"text":"：\n“对面的人你先等下！！这里到底怎么回事？这群怪物是什么情况？！”","color":"white"}]
execute as @s[scores={sea_4temp2=1127}] positioned 90120 123 123 if entity @a[scores={SEAPT_member=2}] run tellraw @a[distance=0..50] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=2}]","color":"aqua"},{"text":"：\n“你这么喊了也没用的，信号太差。”","color":"white"}]
