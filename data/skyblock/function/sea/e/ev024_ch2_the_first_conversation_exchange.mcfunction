...
execute as @n[tag=sc,scores={sea_4temp2=230}] positioned 90122 128 131 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..50] {"text":"玛瑞莲：“我已经说了，不要过来。……除非你有把握能给我们带来一线生机。\n是啊，我当然还想活下去，我怎么可能想要死呢。”","color":"dark_purple"}
execute as @n[tag=sc,scores={sea_4temp2=230}] positioned 90122 128 131 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..50] {"text":"玛瑞莲：“我已经说了，不要过来。……除非你们有把握能给我们带来一线生机。\n是啊，我当然还想活下去，我怎么可能想要死呢。”","color":"dark_purple"}
execute as @n[tag=sc,scores={sea_4temp2=262}] positioned 90122 128 131 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"white"},{"text":"：相信我，维修层已经是人间炼狱了，可我还是一路杀了过来。\n我会前往办公区域找你。","color":"white"}]
execute as @n[tag=sc,scores={sea_4temp2=262}] positioned 90122 128 131 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"white"},{"text":"：相信我们，维修层已经是人间炼狱了，可我们还是一路杀了过来。\n我们会前往办公区域找你。","color":"white"}]
execute as @n[tag=sc,scores={sea_4temp2=295}] positioned 90122 128 131 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..50] {"text":"玛瑞莲：“您真的相当有勇有谋……可是上面的情况远超出你的想象。\n唉……我无论如何都是劝不动你的。”","color":"dark_purple"}
execute as @n[tag=sc,scores={sea_4temp2=295}] positioned 90122 128 131 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..50] {"text":"玛瑞莲：“您真的相当有勇有谋……可是上面的情况远超出你们的想象。\n唉……我无论如何都是劝不动你们的。”","color":"dark_purple"}
...
execute as @n[tag=sc,scores={sea_4temp2=388}] positioned 90122 128 131 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..50] {"text":"玛瑞莲：“我会帮你开启南东两区的冷冻库大门，接下来就只能交给你了……\n祝你好运。”","color":"dark_purple"}
execute as @n[tag=sc,scores={sea_4temp2=388}] positioned 90122 128 131 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..50] {"text":"玛瑞莲：“我会帮你们开启南东两区的冷冻库大门，接下来就只能交给你们了……\n祝你好运。”","color":"dark_purple"}
