...
execute if score sea_ch2_dwight_conversation rng5 matches 47 positioned 90128 129 106 run tellraw @a[distance=0..150] {"text":"神秘的骸骨：从来都不是圣水晶导致的。我的灵魂……已经、坚持不了太久了……","color":"dark_purple"}
