...
execute if score sea_ch2_dwight_conversation rng2 matches 32 positioned 90134 128 126 run tellraw @a[distance=0..150] {"text":"神秘的骸骨：但……我知道你来这里是为了什么。\n去做吧……保护好自己。","color":"dark_purple"}
...
execute if score sea_ch2_dwight_conversation rng4 matches 22 positioned 90074 128 147 run tellraw @a[distance=0..150] {"text":"神秘的骸骨：我相信他是被圣水晶影响的。\n他……不是我认识的瑞佛特先生。","color":"dark_purple"}
...
execute if score sea_ch2_dwight_conversation rng5 matches 22 positioned 90128 129 106 run tellraw @a[distance=0..150] {"text":"神秘的骸骨：我……我不该在这里，我……\n为什么、我会忘记那么重要的事……","color":"dark_purple"}
...
execute if score sea_ch2_dwight_conversation rng5 matches 34 positioned 90128 129 106 run tellraw @a[distance=0..150] {"text":"神秘的骸骨：不要相信那个女人、先生，……\n不对，快点离开这里……不然、我……","color":"dark_purple"}
...
execute if score sea_ch2_dwight_conversation rng5 matches 47 positioned 90128 129 106 run tellraw @a[distance=0..150] {"text":"神秘的骸骨：从来都不是圣水晶导致的。\n我的灵魂……已经、坚持不了太久了……","color":"dark_purple"}
