...
execute if score sea_ch2_dwight_conversation rng1 matches 32 positioned 90113 128 114 run tellraw @a[distance=0..150] {"text":"骷髅型态的尸变体：终于，有人……","color":"dark_purple"}
execute if score sea_ch2_dwight_conversation rng1 matches 44 positioned 90113 128 114 as @n[tag=SEAboss2npc] run effect give @s invisibility infinite 0 true
execute if score sea_ch2_dwight_conversation rng1 matches 44 positioned 90113 128 114 as @n[tag=SEAboss2npc] run tp @s ~ ~-500 ~
...
execute if score sea_ch2_dwight_conversation rng2 matches 32 positioned 90134 128 126 run tellraw @a[distance=0..150] {"text":"神秘的骸骨：但……我知道你来这里是为了什么。去做吧……保护好自己。","color":"dark_purple"}
execute if score sea_ch2_dwight_conversation rng2 matches 44 positioned 90134 128 126 as @n[tag=SEAboss2npc] run effect give @s invisibility infinite 0 true
execute if score sea_ch2_dwight_conversation rng2 matches 44 positioned 90134 128 126 as @n[tag=SEAboss2npc] run tp @s ~ ~-500 ~
...
execute if score sea_ch2_dwight_conversation rng4 matches 45 positioned 90074 128 147 as @n[tag=SEAboss2npc] run effect give @s invisibility infinite 0 true
execute if score sea_ch2_dwight_conversation rng4 matches 45 positioned 90074 128 147 as @n[tag=SEAboss2npc] run tp @s ~ ~-500 ~
...
execute if score sea_ch2_dwight_conversation rng5 matches 34 positioned 90128 129 106 run tellraw @a[distance=0..150] {"text":"神秘的骸骨：不要相信那个女人、先生，……不对，快点离开这里……不然、我……","color":"dark_purple"}
execute if score sea_ch2_dwight_conversation rng5 matches 46 positioned 90128 129 106 run playsound entity.bogged.ambient neutral @a ~ ~ ~ 1 0.8
execute if score sea_ch2_dwight_conversation rng5 matches 46 positioned 90128 129 106 run tellraw @a[distance=0..150] {"text":"神秘的骸骨：从来都不是圣水晶导致的。我的灵魂……已经、坚持不了太久了……","color":"dark_purple"}
execute if score sea_ch2_dwight_conversation rng5 matches 49 positioned 90128 129 106 as @n[tag=SEAboss2npc] run effect give @s invisibility infinite 0 true
execute if score sea_ch2_dwight_conversation rng5 matches 49 positioned 90128 129 106 as @n[tag=SEAboss2npc] run tp @s ~ ~-500 ~
