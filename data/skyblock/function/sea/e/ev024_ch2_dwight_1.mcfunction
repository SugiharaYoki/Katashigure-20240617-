...
execute if score sea_ch2_dwight_conversation rng2 matches 1..19 positioned 90134 128 126 as @n[tag=SEAboss2npc] at @s if entity @p[tag=SEAPT,tag=!SEAPF,distance=0..5] run scoreboard players set sea_ch2_dwight_conversation rng1 20
...
execute if score sea_ch2_dwight_conversation rng3 matches 1..19 positioned 90111 128 139 as @n[tag=SEAboss2npc] at @s if entity @p[tag=SEAPT,tag=!SEAPF,distance=0..5] run scoreboard players set sea_ch2_dwight_conversation rng1 20
...
execute if score sea_ch2_dwight_conversation rng4 matches 1..19 positioned 90074 128 147 as @n[tag=SEAboss2npc] at @s if entity @p[tag=SEAPT,tag=!SEAPF,distance=0..5] run scoreboard players set sea_ch2_dwight_conversation rng1 20
...
execute if score sea_ch2_dwight_conversation rng4 matches 38 positioned 90074 128 147 run effect give @s invisibility infinite 0 true
execute if score sea_ch2_dwight_conversation rng4 matches 39 positioned 90074 128 147 run tp @s ~ ~-500 ~
...
execute if score sea_ch2_dwight_conversation rng5 matches 1..19 positioned 90128 129 106 as @n[tag=SEAboss2npc] at @s if entity @p[tag=SEAPT,tag=!SEAPF,distance=0..5] run scoreboard players set sea_ch2_dwight_conversation rng1 20
