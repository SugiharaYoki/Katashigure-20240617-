...
execute as @s[scores={sea_4temp1=39}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250,tag=!e_i_28,tag=!e_i_27] {"text":"？？？：“我懂了，那个信号弹说的就是你吧……你要去水下研究设施？可是为什么……”","color":"green"}
execute as @s[scores={sea_4temp1=39}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250,tag=!e_i_28,tag=!e_i_27] {"text":"？？？：“我懂了，那个信号弹说的就是你……你们。你们要去水下研究设施？可是为什么……”","color":"green"}
execute as @s[scores={sea_4temp1=39}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250,tag=e_i_28,tag=!e_i_27] {"text":"越涵：“我靠，怎么是你啊。撞大运了。看来马绍尔足够信任你了，居然让我领你去水下研究设施。”","color":"green"}
execute as @s[scores={sea_4temp1=39}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250,tag=e_i_28,tag=!e_i_27] {"text":"越涵：“我靠，怎么是你们啊。撞大运了。看来马绍尔足够信任你们了，居然让我领你们去水下研究设施。”","color":"green"}
...
execute as @s[scores={sea_4temp1=85}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250,tag=e_i_28,tag=e_i_27] {"text":"越涵：“前面通向的便是忒尔克西的水下研究设施。走吧，我跟在后头。”","color":"green"}
execute as @s[scores={sea_4temp1=85}] at @s run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85

execute as @s[scores={sea_4temp1=113}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250,tag=!e_i_27] {"text":"越涵：“什、马绍尔说……他是宿舍楼最后一个活着的？！”","color":"green"}
execute as @s[scores={sea_4temp1=113}] at @s if entity @a[tag=!e_i_27] run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85

execute as @s[scores={sea_4temp1=145}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250,tag=!e_i_27] {"text":"越涵：“这不就意味着斯顿已经……不、不对，那家伙不可能有这么蠢的，他……他就这样死了？”","color":"green"}
...
execute as @s[scores={sea_4temp1=400}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] {"text":"越涵：“老哥，你在这里搜救多久了？”","color":"green"}
execute as @s[scores={sea_4temp1=400}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250] {"text":"越涵：“老哥，你们在这里搜救多久了？”","color":"green"}
...
execute as @s[scores={sea_4temp1=639}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] {"text":"越涵：“再不走黄花菜都凉喽。”","color":"green"}
execute as @s[scores={sea_4temp1=639}] at @s if entity @a[tag=!e_i_27] run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85

execute as @s[scores={sea_4temp1=819}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] {"text":"越涵：“你见过艾德雯娜了吗？她好像也在平台上行动，但我没有联系到她的方式。”","color":"green"}
execute as @s[scores={sea_4temp1=819}] at @s if entity @a[tag=!e_i_27] run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85

execute as @s[scores={sea_4temp1=889}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] {"text":"越涵：“对啊，艾德雯娜不知道还活没活着……她身手了得，应该不会有太大问题。”","color":"green"}
execute as @s[scores={sea_4temp1=889}] at @s if entity @a[tag=!e_i_27] run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85


execute as @s[scores={sea_4temp1=1039}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] {"text":"越涵：“吃个苹果？”","color":"green"}
...
execute as @s[scores={sea_4temp1=1239}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] {"text":"越涵：“还是快点出发吧。我们没多少时间。”","color":"green"}
