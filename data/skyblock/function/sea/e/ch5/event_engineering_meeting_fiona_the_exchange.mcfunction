...
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 10 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s as @p[tag=SEAPT] run tellraw @a[distance=0..250] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=1}]","color":"aqua"},{"text":"：\n“差不多该解释一下了吧，我们这算是怎么一种情况，菲尔娜小姐？”","color":"white"}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 42 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..250] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=2}]","color":"aqua"},{"text":"：\n“我猜是因为他看到了你的工牌。”","color":"white"}]
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 42 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s unless entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..250] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=1}]","color":"aqua"},{"text":"：\n“你胸前的工牌写得很清楚。”","color":"white"}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 87 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s as @p[tag=SEAPT] run tellraw @a[distance=0..250] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=1}]","color":"aqua"},{"text":"：\n“这……这我倒是不清楚。”","color":"white"}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 100 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..250] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=2}]","color":"aqua"},{"text":"：\n“不对啊、你说你是舵长的女儿？！那你一定比我们知道更多吧，忒尔克西到底发生什么了？”","color":"white"}]
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 100 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s unless entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..250] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=1}]","color":"aqua"},{"text":"：\n“等等、你说什么？这代表你知道的比我更多，是吗？”","color":"white"}]

execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 122 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @a[tag=SEAPT,scores={SEAPT_member=3}] run tellraw @a[distance=0..250] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=3}]","color":"aqua"},{"text":"：\n“其实也能猜到很多了吧，我们这一路上看到的已经将答案放在挺明显的位置了。”","color":"white"}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 144 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..250] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=2}]","color":"aqua"},{"text":"：\n“如果可以的话，能获得权威解答肯定是最好的。不对吗？”","color":"white"}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 184 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s run tellraw @a[distance=0..250] [{"selector":"@r[tag=SEAPT]","color":"aqua"},{"text":"：\n“没错，我去过水下了。\n除此之外我也遇见了艾德雯娜、越涵。\n以及……我还见到了法莫洛斯医生。他已经走了。”","color":"white"}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 283 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s run tellraw @a[distance=0..250] [{"selector":"@r[tag=SEAPT]","color":"aqua"},{"text":"：\n“谈判？你一直在提到的谈判到底是指什么？\n以及……诺玛？你提到的诺玛是谁？”","color":"white"}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 324 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s run tellraw @a[distance=0..250] [{"selector":"@r[tag=SEAPT]","color":"aqua"},{"text":"：\n“虽然只是推测……你提到的诺玛，是诺曼博士的女儿吗？\n还有，你是打算保护诺曼博士？”","color":"white"}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 390 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s run tellraw @a[distance=0..250] [{"selector":"@r[tag=SEAPT]","color":"aqua"},{"text":"：\n“所以……我们现在该怎么办？”","color":"white"}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 435 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s run tellraw @a[distance=0..250] [{"selector":"@r[tag=SEAPT]","color":"aqua"},{"text":"：\n“‘麻烦’……难道说我们不该呼救吗，还是说外界只会将我们全部灭口？他们到底在等什么？”","color":"white"}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 561 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..250] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=2}]","color":"aqua"},{"text":"：\n“开什么玩笑？你们在给我们讲童话故事吗？”","color":"white"}]
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 561 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s unless entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..250] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=1}]","color":"aqua"},{"text":"：\n“所以……我在听什么？邪教的洗脑演讲吗？”","color":"white"}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 734 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s run tellraw @a[distance=0..250] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=1}]","color":"aqua"},{"text":"：\n“也没有别的选择了吧。\n话说，你也知道我的名字？”","color":"white"}]
