...
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 20 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s run tellraw @a[distance=0..200] [{"text":"菲尔娜：","color":"green","bold": true},{"text":"\n“你居然还知道我的名字。”","color":"white","bold": false}]

execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 42 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..250] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=2}]","color":"white"},{"text":"：我猜是因为他看到了你的工牌。","color":"white"}]
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 42 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s unless entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..250] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=1}]","color":"white"},{"text":"：你胸前的工牌写得很清楚。","color":"white"}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 62 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s run tellraw @a[distance=0..200,tag=SEAPT] [{"text":" - "},{"text":"坦白：这件事我并不知道  ","color":"yellow"},{"text":"〈◆〉","bold":true,"color":"gold","clickEvent":{"action":"run_command","value":"/trigger sea_crafter set 90005"}}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 122 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @a[tag=SEAPT,scores={SEAPT_member=3}] run tellraw @a[distance=0..250] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=3}]","color":"white"},{"text":"：其实也能猜到很多了吧，我们这一路上看到的已经将答案放在挺明显的位置了。","color":"white"}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 144 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..250] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=2}]","color":"white"},{"text":"：如果可以的话，能获得权威解答肯定是最好的。不对吗？","color":"white"}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 200 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s run tellraw @a[distance=0..200] [{"text":"菲尔娜：","color":"green","bold": true},{"text":"\n“……唉，法莫洛斯太理想主义了。当然，他的小队挣扎了最久的时间，作为凡人他已经足够伟大了。\n但如你所见，我是激进派。既然那群暴民只是在搅浑水，那我能依靠的只有自己。”","color":"white","bold": false}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 561 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s unless entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..250] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=1}]","color":"white"},{"text":"：所以……我在听什么？邪教的洗脑演讲吗？","color":"white"}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 837.. as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200,scores={rng2=2}] at @s if entity @n[tag=SEAmob,tag=!SEAnpc,distance=..4.5,type=!magma_cube] run tag @s add SEAfiona_laser_attacking
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 837.. as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200,tag=!SEAfiona_special_sentence_1] at @s if entity @n[tag=SEAmob,tag=!SEAnpc,distance=..4.5,type=zombie] run tellraw @a[distance=0..200] [{"text":"菲尔娜：","color":"green","bold": true},{"text":"\n“哪来的这么多怪物，那群邪教徒也不清理一下场地吗？”","color":"white","bold": false}]
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 837.. as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200,tag=!SEAfiona_special_sentence_1] at @s if entity @n[tag=SEAmob,tag=!SEAnpc,distance=..4.5,type=zombie] run tag @s add SEAfiona_special_sentence_1
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 837.. as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200,tag=!SEAfiona_special_sentence_1] at @s if entity @n[tag=SEAmob,tag=!SEAnpc,distance=..4.5,type=spider] run tellraw @a[distance=0..200] [{"text":"菲尔娜：","color":"green","bold": true},{"text":"\n“哪来的这么多怪物，那群邪教徒也不清理一下场地吗？”","color":"white","bold": false}]
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 837.. as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200,tag=!SEAfiona_special_sentence_1] at @s if entity @n[tag=SEAmob,tag=!SEAnpc,distance=..4.5,type=spider] run tag @s add SEAfiona_special_sentence_1
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 837.. as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200,tag=!SEAfiona_special_sentence_2] at @s if entity @n[tag=SEAmob,tag=!SEAnpc,distance=..4.5,type=magma_cube] run tellraw @a[distance=0..200] [{"text":"菲尔娜：","color":"green","bold": true},{"text":"\n“算我求求你了，别把这些蹦来蹦去烫得要死的球给引到我这里来。”","color":"white","bold": false}]
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 837.. as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200,tag=!SEAfiona_special_sentence_2] at @s if entity @n[tag=SEAmob,tag=!SEAnpc,distance=..4.5,type=magma_cube] run tag @s add SEAfiona_special_sentence_2
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 837.. as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200,tag=!SEAfiona_special_sentence_3] at @s if entity @n[tag=SEAmob,tag=!SEAnpc,distance=..4.5,type=pillager] run tellraw @a[distance=0..200] [{"text":"菲尔娜：","color":"green","bold": true},{"text":"\n“我靠这群人有完没完？”","color":"white","bold": false}]
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 837.. as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200,tag=!SEAfiona_special_sentence_3] at @s if entity @n[tag=SEAmob,tag=!SEAnpc,distance=..4.5,type=pillager] run tag @s add SEAfiona_special_sentence_3
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 837.. as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200,tag=!SEAfiona_special_sentence_3] at @s if entity @n[tag=SEAmob,tag=!SEAnpc,distance=..4.5,type=vindicator] run tellraw @a[distance=0..200] [{"text":"菲尔娜：","color":"green","bold": true},{"text":"\n“我靠这群人有完没完？”","color":"white","bold": false}]
execute if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 837.. as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200,tag=!SEAfiona_special_sentence_3] at @s if entity @n[tag=SEAmob,tag=!SEAnpc,distance=..4.5,type=vindicator] run tag @s add SEAfiona_special_sentence_3
