...
execute as @s[scores={rng8=3}] at @s run tp @s ~ ~ ~ facing entity @n[tag=SEAmob,tag=!SEAnpc,distance=..5.6]
execute as @s[scores={rng8=4},tag=!SEAfiona_targetfound] at @s positioned ^ ^ ^0.8 unless block ~ ~ ~ air run scoreboard players set @s rng8 9
execute as @s[scores={rng8=4}] at @s positioned ^ ^ ^0.8 if entity @n[tag=SEAmob,tag=!SEAnpc,distance=0..0.8] run tag @s add SEAfiona_targetfound
...
execute as @s[scores={rng8=4}] at @s positioned ^ ^ ^1.6 if entity @n[tag=SEAmob,tag=!SEAnpc,distance=0..0.8] run tag @s add SEAfiona_targetfound
...
execute as @s[scores={rng8=4}] at @s positioned ^ ^ ^2.4 if entity @n[tag=SEAmob,tag=!SEAnpc,distance=0..0.8] run tag @s add SEAfiona_targetfound
...
execute as @s[scores={rng8=4}] at @s positioned ^ ^ ^3.2 if entity @n[tag=SEAmob,tag=!SEAnpc,distance=0..0.8] run tag @s add SEAfiona_targetfound
...
execute as @s[scores={rng8=4}] at @s positioned ^ ^ ^4.0 if entity @n[tag=SEAmob,tag=!SEAnpc,distance=0..0.8] run tag @s add SEAfiona_targetfound
...
execute as @s[scores={rng8=4}] at @s positioned ^ ^ ^4.8 if entity @n[tag=SEAmob,tag=!SEAnpc,distance=0..0.8] run tag @s add SEAfiona_targetfound
...
execute as @s[scores={rng8=4..8}] at @s run tp @s ~ ~ ~ facing entity @n[tag=SEAmob,tag=!SEAnpc]
