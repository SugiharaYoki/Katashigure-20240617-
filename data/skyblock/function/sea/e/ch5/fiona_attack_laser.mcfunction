...
execute as @s[scores={rng8=8}] at @s positioned ^ ^1 ^1 if entity @a[distance=0..1] run scoreboard players set @s rng8 9
execute as @s[scores={rng8=8}] at @s positioned ^ ^1 ^2 if entity @a[distance=0..1] run scoreboard players set @s rng8 9
execute as @s[scores={rng8=8}] at @s positioned ^ ^1 ^3 if entity @a[distance=0..1] run scoreboard players set @s rng8 9
execute as @s[scores={rng8=8}] at @s positioned ^ ^1 ^4 if entity @a[distance=0..1] run scoreboard players set @s rng8 9
execute as @s[scores={rng8=8}] at @s positioned ^ ^1 ^5 if entity @a[distance=0..1] run scoreboard players set @s rng8 9
execute as @s[scores={rng8=8}] at @s positioned ^ ^1 ^6 if entity @a[distance=0..1] run scoreboard players set @s rng8 9
execute as @s[scores={rng8=8}] at @s positioned ^ ^1 ^0.5 if entity @a[distance=0..1] run scoreboard players set @s rng8 9
execute as @s[scores={rng8=8}] at @s positioned ^ ^1 ^1.5 if entity @a[distance=0..1] run scoreboard players set @s rng8 9
execute as @s[scores={rng8=8}] at @s positioned ^ ^1 ^2.5 if entity @a[distance=0..1] run scoreboard players set @s rng8 9
execute as @s[scores={rng8=8}] at @s positioned ^ ^1 ^3.5 if entity @a[distance=0..1] run scoreboard players set @s rng8 9
execute as @s[scores={rng8=8}] at @s positioned ^ ^1 ^4.5 if entity @a[distance=0..1] run scoreboard players set @s rng8 9
execute as @s[scores={rng8=8}] at @s positioned ^ ^1 ^5.5 if entity @a[distance=0..1] run scoreboard players set @s rng8 9
execute as @s[scores={rng8=8}] at @s positioned ^ ^1 ^6.5 if entity @a[distance=0..1] run scoreboard players set @s rng8 9
