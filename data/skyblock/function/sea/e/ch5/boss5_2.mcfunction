...
execute if entity @s[scores={health=..600,sea_4temp3=..0}] run scoreboard players set @s sea_4temp3 1
execute if entity @s[scores={sea_4temp3=1..}] run function skyblock:sea/e/ch5/boss5/phase3_communication_2
