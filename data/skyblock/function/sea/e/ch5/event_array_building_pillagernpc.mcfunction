...
execute if score @s rng1 matches 3 at @s if block ~ ~-1 ~ bamboo_planks run tellraw @a[tag=SEAPT] [{"text":"邪教徒弩手：","color":"white","bold": true},{"text":"\n“嘿，兄弟！我见过你！不好意思，我刚上完厕所，让你见笑了。”","color":"green","bold": false}]
...
execute if score @s rng1 matches 83 at @s run advancement grant @a[tag=SEAPT] only skyblock:sea/doc/g27
