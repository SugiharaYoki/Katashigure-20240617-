...
execute if score SEA_ch5_event_engineering_fiona rng10 matches 60..500 if score SEA_ch5_event_engineering_fiona rng6 matches 1 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @e[tag=SEAmob,distance=0..20,type=pillager] run tellraw @a[distance=0..200] [{text:"邪教徒：",color:"yellow",bold:1b},{text:"\n“小姑娘居然有援军！小心行动！”",color:"white",bold: false}]
...
execute if score SEA_ch5_event_engineering_fiona rng10 matches 60..500 if score SEA_ch5_event_engineering_fiona rng6 matches 3 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @e[tag=SEAmob,distance=0..20,type=pillager] run tellraw @a[distance=0..200] [{text:"邪教徒：",color:"yellow",bold:1b},{text:"\n“可恶，对方比我们厉害不是一点，后方部队呢？！”",color:"white",bold: false}]
execute if score SEA_ch5_event_engineering_fiona rng10 matches 60..500 if score SEA_ch5_event_engineering_fiona rng6 matches 4 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @e[tag=SEAmob,distance=0..20,type=pillager] run tellraw @a[distance=0..200] [{text:"邪教徒：",color:"yellow",bold:1b},{text:"\n“这小姑娘挺有本事、伤员别逞强，失去战斗能力的都撤退！”",color:"white",bold: false}]
execute if score SEA_ch5_event_engineering_fiona rng10 matches 60..500 if score SEA_ch5_event_engineering_fiona rng6 matches 5 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @e[tag=SEAmob,distance=0..20,type=pillager] run tellraw @a[distance=0..200] [{text:"邪教徒：",color:"yellow",bold:1b},{text:"\n“躲开，敌人有远距离杀伤性武器！！”",color:"white",bold: false}]

execute if score SEA_ch5_event_engineering_fiona rng10 matches 160 if block 90060 101 142 red_candle[lit=true] as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @e[tag=SEAmob,distance=0..20,type=pillager] run tellraw @a[distance=0..200] [{text:"邪教徒：",color:"yellow",bold:1b},{text:"\n“前线传来报告！大小姐旁边的援手好像是之前在医疗中心放走奥斯伯特的人！”",color:"white",bold: false}]
execute if score SEA_ch5_event_engineering_fiona rng10 matches 186 if block 90060 101 142 red_candle[lit=true] as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @e[tag=SEAmob,distance=0..20,type=pillager] run tellraw @a[distance=0..200] [{text:"邪教徒：",color:"yellow",bold:1b},{text:"\n“什么？！那我们该进攻不该进攻？！先观察，战斗人员先不要下死手！”",color:"white",bold: false}]
