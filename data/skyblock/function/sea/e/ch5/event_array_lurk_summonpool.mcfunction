...
execute if score SEA_ch5_event_engineering_fiona sea_4temp8 matches 1..20 store result score SEA_ch5_event_engineering_fiona rng9 run random value 1..14
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp8 matches 321..750 store result score SEA_ch5_event_engineering_fiona rng9 if block 90060 101 142 red_candle[lit=true] run random value 1..63
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp8 matches 321..750 store result score SEA_ch5_event_engineering_fiona rng9 unless block 90060 101 142 red_candle[lit=true] run random value 1..55
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp8 matches 1..20 if score SEA_ch5_event_engineering_fiona rng8 matches 30.. store result score SEA_ch5_event_engineering_fiona rng9 run random value 10..11
execute if score SEA_ch5_event_engineering_fiona sea_4temp8 matches 21..320 if score SEA_ch5_event_engineering_fiona rng8 matches 20.. store result score SEA_ch5_event_engineering_fiona rng9 run random value 12..19
execute if score SEA_ch5_event_engineering_fiona sea_4temp8 matches 321..750 if score SEA_ch5_event_engineering_fiona rng8 matches 15.. store result score SEA_ch5_event_engineering_fiona rng9 run random value 13..35
