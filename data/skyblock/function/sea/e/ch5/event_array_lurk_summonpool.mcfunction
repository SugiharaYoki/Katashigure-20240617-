...
execute if score SEA_ch5_event_engineering_fiona rng6 matches 1 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @e[tag=SEAmob,distance=0..20,type=pillager] run tellraw @a[distance=0..200] [{text:"邪教徒：",color:"yellow",bold:1b},{text:"\n“小姑娘这援军也有本事！优先让那人失去战斗能力！”",color:"white",bold: false}]
execute if score SEA_ch5_event_engineering_fiona rng6 matches 2 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @a[tag=SEAPT,scores={SEAPT_member=2}] if entity @e[tag=SEAmob,distance=0..20,type=pillager] run tellraw @a[distance=0..200] [{text:"邪教徒：",color:"yellow",bold:1b},{text:"\n“一定要把他们几个拦在通讯中心外头！”",color:"white",bold: false}]
execute if score SEA_ch5_event_engineering_fiona rng6 matches 2 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s unless entity @a[tag=SEAPT,scores={SEAPT_member=2}] if entity @e[tag=SEAmob,distance=0..20,type=pillager] run tellraw @a[distance=0..200] [{text:"邪教徒：",color:"yellow",bold:1b},{text:"\n“一定要把他们两个拦在通讯中心外头！”",color:"white",bold: false}]
execute if score SEA_ch5_event_engineering_fiona rng6 matches 3 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @e[tag=SEAmob,distance=0..20,type=pillager] run tellraw @a[distance=0..200] [{text:"邪教徒：",color:"yellow",bold:1b},{text:"\n“可恶，对方比我们厉害不是一点，后方部队呢？！”",color:"white",bold: false}]
execute if score SEA_ch5_event_engineering_fiona rng6 matches 4 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @e[tag=SEAmob,distance=0..20,type=pillager] run tellraw @a[distance=0..200] [{text:"邪教徒：",color:"yellow",bold:1b},{text:"\n“伤员别逞强，失去战斗能力的都撤退！”",color:"white",bold: false}]
execute if score SEA_ch5_event_engineering_fiona rng6 matches 5 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @e[tag=SEAmob,distance=0..20,type=pillager] run tellraw @a[distance=0..200] [{text:"邪教徒：",color:"yellow",bold:1b},{text:"\n“躲开，敌人有远距离杀伤性武器！！”",color:"white",bold: false}]
execute if score SEA_ch5_event_engineering_fiona rng6 matches 6 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @e[tag=SEAmob,distance=0..20,type=pillager] run tellraw @a[distance=0..200] [{text:"邪教徒：",color:"yellow",bold:1b},{text:"\n“下一步指示在哪里？！我们不知道如何行动！”",color:"white",bold: false}]
