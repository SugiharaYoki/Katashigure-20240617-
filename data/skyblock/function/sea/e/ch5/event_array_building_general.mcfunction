...
execute if score SEA_ch5_event_building rng1 matches 168 positioned 90119 137 59 run tellraw @a[distance=0..200] [{text:"邪教徒的对话声C：",color:"green",bold:1b},{text:"\n“引雷针失效，查查原因。”",color:"white",bold: false}]
