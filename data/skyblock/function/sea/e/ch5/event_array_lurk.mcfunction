...
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches ..5000 at @n[tag=SEAfiona,type=villager] as @e[distance=..60,tag=SEApillager_sentry] at @s if block ^ ^ ^1 air if block ^ ^ ^2 air positioned ^ ^ ^2 if entity @a[tag=SEAPT,distance=0..3] run scoreboard players add SEA_ch5_event_engineering_fiona sea_4temp7 8
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches ..5000 at @n[tag=SEAfiona,type=villager] as @e[distance=..60,tag=SEApillager_sentry] at @s if block ^ ^ ^1 air if block ^ ^ ^2 air if block ^ ^ ^3 air if block ^ ^ ^4 air positioned ^ ^ ^4 if entity @a[tag=SEAPT,distance=0..3] run scoreboard players add SEA_ch5_event_engineering_fiona sea_4temp7 6
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches ..5000 at @n[tag=SEAfiona,type=villager] as @e[distance=..60,tag=SEApillager_sentry] at @s if block ^ ^ ^1 air if block ^ ^ ^2 air if block ^ ^ ^3 air if block ^ ^ ^4 air if block ^ ^ ^5 air if block ^ ^ ^6 air positioned ^ ^ ^6 if entity @a[tag=SEAPT,distance=0..3] run scoreboard players add SEA_ch5_event_engineering_fiona sea_4temp7 4
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches ..5000 at @n[tag=SEAfiona,type=villager] as @e[distance=..60,tag=SEApillager_sentry] at @s if block ^ ^ ^1 air if block ^ ^ ^2 air if block ^ ^ ^3 air if block ^ ^ ^4 air if block ^ ^ ^5 air if block ^ ^ ^6 air if block ^ ^ ^7 air if block ^ ^ ^8 air positioned ^ ^ ^8 if entity @a[tag=SEAPT,distance=0..3] run scoreboard players add SEA_ch5_event_engineering_fiona sea_4temp7 2
