...
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 1503 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..200] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“事先提醒一声，被发现的话后果很严重，我建议你们避开那些巡逻员的视线。”",color:"white",bold: false}]
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 1503 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s unless entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..200] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“提醒你一下，被发现的话后果很严重，我建议你避开那些巡逻员的视线。”",color:"white",bold: false}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 1500..1505 run tag @n[tag=SEAfiona] add SEAfiona_moveable
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 5001..5010 run tag @n[tag=SEAfiona] remove SEAfiona_moveable
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 5086..5088 run tag @n[tag=SEAfiona] add SEAfiona_moveable
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 1503..4950 if score SEA_ch5_event_engineering_fiona sea_4temp7 matches 30.. as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200,tag=!SEAlurkwarning1] at @s run tellraw @a[distance=0..200] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“喂、藏好点！”",color:"white",bold: false}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 1503..4950 if score SEA_ch5_event_engineering_fiona sea_4temp7 matches 50.. as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200,tag=!SEAlurkwarning2] at @s run tellraw @a[distance=0..200] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“我发誓我们已经被看到了……你就不能不莽撞行事吗？”",color:"white",bold: false}]
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 1503..4950 if score SEA_ch5_event_engineering_fiona sea_4temp7 matches 50.. as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200,tag=!SEAlurkwarning2] at @s run scoreboard players remove SEA_ch5_event_fiona_favor rng1 1
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 1503..4950 if score SEA_ch5_event_engineering_fiona sea_4temp7 matches 90.. as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200,tag=!SEAlurkwarning3] at @s run tellraw @a[distance=0..200] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“你可真要害惨我了、你这个混蛋……”",color:"white",bold: false}]
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 1503..4950 if score SEA_ch5_event_engineering_fiona sea_4temp7 matches 90.. as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200,tag=!SEAlurkwarning3] at @s run scoreboard players remove SEA_ch5_event_fiona_favor rng1 2
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp8 matches 500 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s run tellraw @a[distance=0..200] [{text:"邪教徒：",color:"yellow",bold:1b},{text:"\n“撤退，撤退！我们不是对手！！”",color:"white",bold: false}]
execute if score SEA_ch5_event_engineering_fiona sea_4temp8 matches 540 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s run tellraw @a[distance=0..200] [{text:"邪教徒：",color:"yellow",bold:1b},{text:"\n“快去通知琼斯主教，咱们惹不起他们！”",color:"white",bold: false}]
execute if score SEA_ch5_event_engineering_fiona sea_4temp8 matches 580 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s run tellraw @a[distance=0..200] [{text:"邪教徒：",color:"yellow",bold:1b},{text:"\n“不要再打了、别再打了！我们投降！！”",color:"white",bold: false}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp8 matches 583 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s as @e[tag=SEAmob,type=pillager] at @s run tag @s add SEAmob_surrended
execute if score SEA_ch5_event_engineering_fiona sea_4temp8 matches 583 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s as @e[tag=SEAmob,type=vindicator] at @s run tag @s add SEAmob_surrended
execute if score SEA_ch5_event_engineering_fiona sea_4temp8 matches 583 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s as @e[tag=SEAmob,type=vindicator] at @s run effect give @s weakness infinite 9 true
execute if score SEA_ch5_event_engineering_fiona sea_4temp8 matches 583 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s as @e[tag=SEAmob,type=vindicator] at @s run data modify entity @s attributes[{id:"minecraft:movement_speed"}].base set value 0
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 1550 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @a[tag=SEAPT,distance=0..6] run tellraw @a[distance=0..200] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“我们的目标是这座平台斜对角的那幢白色建筑，也就是通讯中心。\n不是对面的主平台那幢。当然，我也相信你不会笨到那种地步。”",color:"white",bold: false}]

execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 1572 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @a[tag=SEAPT,distance=0..6] run tellraw @a[distance=0..250] [{selector:"@r[tag=SEAPT]",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“那里面肯定只会有更多邪教徒吧。真的不会被发现吗？”",color:"white"}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 1590 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @a[tag=SEAPT,distance=0..6] run tellraw @a[distance=0..200] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“进去之后战斗也会方便很多。相信我，我对里面的结构了如指掌。”",color:"white",bold: false}]
...
execute positioned 90112 128 24 if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 1630 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @a[tag=SEAPT,distance=0..10] run tellraw @a[distance=0..200] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“看到卸货台那边那个大集装箱了吗？从中间穿过去应该会安全很多。”",color:"white",bold: false}]
...
execute if block 90121 135 16 grindstone if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 5008 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s run tellraw @a[distance=0..200] [{text:"琼斯：",color:"yellow",bold:1b},{text:"\n“闹够了没有，大小姐？”",color:"white",bold: false}]
execute unless block 90121 135 16 grindstone if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 5008 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s run tellraw @a[distance=0..200] [{text:"琼斯：",color:"yellow",bold:1b},{text:"\n“我就知道我拦不住你。我已经了解了，让我们好好谈谈吧。”",color:"white",bold: false}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 5026 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s run tellraw @a[distance=0..200] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“琼斯，你一直观察着我们的一举一动，是吗？”",color:"white",bold: false}]
...
execute if block 90121 135 16 grindstone if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 5045 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s run tellraw @a[distance=0..200] [{text:"琼斯：",color:"yellow",bold:1b},{text:"\n“我们把话留到之后吧。你可以进来了。”",color:"white",bold: false}]
execute unless block 90121 135 16 grindstone if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 5045 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s run tellraw @a[distance=0..200] [{text:"琼斯：",color:"yellow",bold:1b},{text:"\n“先进来吧，大小姐。”",color:"white",bold: false}]
...
execute unless block 90121 135 16 grindstone if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 5063 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s run tellraw @a[distance=0..200] [{text:"琼斯：",color:"yellow",bold:1b},{text:"\n“我会让他们不要攻击你们。但小心，不一定所有的教徒都听我的指示。”",color:"white",bold: false}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 5087 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..200] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“你们怎么看？他的话我可不愿意信。”",color:"white",bold: false}]
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 5087 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s unless entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..200] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“你信他的话？反正我不信。”",color:"white",bold: false}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 5106 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s run tellraw @a[distance=0..200] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“不过已经没什么能做的了。既然他能掌控我们的行踪，我们就什么都做不了。”",color:"white",bold: false}]

execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 5125 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..250] [{selector:"@p[tag=SEAPT,scores={SEAPT_member=2}]",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“当心是埋伏噢，他给我们来一个瓮中捉鳖，一网打尽。”",color:"white"}]
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 5125 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s unless entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..250] [{selector:"@p[tag=SEAPT,scores={SEAPT_member=1}]",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“那咱们这算是潜行计划大失败？”",color:"white"}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 5144 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..200] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“……是啊！把你们一网打尽！小心我是邪教徒的奸细，我说不定在养你们猪呢。”",color:"white",bold: false}]
execute unless block 90121 135 16 grindstone if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 5144 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s unless entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..200] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“你嘴真欠啊，别再说了。”",color:"white",bold: false}]
execute if block 90121 135 16 grindstone if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 5144 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s unless entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..200] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“……你是故意想气死我，对吗？”",color:"white",bold: false}]
...
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 5050 run setblock 90136 129 39 minecraft:heavy_weighted_pressure_plate
...
execute if entity @n[tag=SEAfiona,tag=!SEAfiona_actable] positioned 90126 122 23 run function skyblock:sea/e/ch6/fiona/init
