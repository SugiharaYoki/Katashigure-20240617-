...
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 1503..4950 if score SEA_ch5_event_engineering_fiona sea_4temp7 matches 0..89 as @n[tag=SEAfiona,x=90096,y=135,z=16,dx=80,dy=80,dz=80,tag=!SEAspeciallurk1] at @s unless entity @n[distance=..30,tag=SEApillager_sentry] run playsound entity.wandering_trader.ambient neutral @a ~ ~ ~ 0.7 1.3
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 1503..4950 if score SEA_ch5_event_engineering_fiona sea_4temp7 matches 0..89 as @n[tag=SEAfiona,x=90096,y=135,z=16,dx=80,dy=80,dz=80,tag=!SEAspeciallurk1] at @s unless entity @n[distance=..30,tag=SEApillager_sentry] run tellraw @a[distance=0..200] [{"text":"菲尔娜：","color":"green","bold": true},{"text":"\n“请问……您的潜入方式是谁教的？”","color":"white","bold": false}]
execute if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 1503..4950 if score SEA_ch5_event_engineering_fiona sea_4temp7 matches 0..89 as @n[tag=SEAfiona,x=90096,y=135,z=16,dx=80,dy=80,dz=80,tag=!SEAspeciallurk1] at @s unless entity @n[distance=..30,tag=SEApillager_sentry] run tag @s add SEAspeciallurk1
