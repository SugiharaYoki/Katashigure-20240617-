...
execute if score SEA_ch5_event_outerspace_fiona sea_4temp3 matches 23 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s run tellraw @a[distance=0..250] [{selector:"@p[tag=SEAPT,scores={SEAPT_member=1}]",color:"aqua"},{text:"：",color:"aqua","bold": true},{text:"\n“它在逐渐生长。不光是这座铁塔，行政楼那里也都快长满了。”",color:"white"}]
