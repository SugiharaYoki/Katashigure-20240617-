...
execute if score SEA_ch5_event_outerspace_fiona sea_4temp1 matches 23 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..250] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=2}]","color":"white"},{"text":"：","color":"aqua","bold": true},{"text":"\n“是越涵带我们来的。”","color":"white"}]
