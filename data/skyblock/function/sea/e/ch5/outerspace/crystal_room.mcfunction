...
execute if score SEA_ch5_event_outerspace_fiona sea_4temp1 matches 23 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s unless entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..250] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=1}]","color":"white"},{"text":"：当时我不小心打开了备用无线电。我就是在这里遇到了越涵。","color":"white"}]
...
execute if score SEA_ch5_event_outerspace_fiona sea_4temp1 matches 65 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..250] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=1}]","color":"white"},{"text":"：……抱歉，我们也不知道。他跌下了海中，艾德雯娜正在找他。","color":"white"}]
execute if score SEA_ch5_event_outerspace_fiona sea_4temp1 matches 65 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s unless entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..250] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=1}]","color":"white"},{"text":"：……抱歉，我也不知道。他跌下了海中，艾德雯娜正在找他。","color":"white"}]
