...
execute if score SEA_ch5_event_boss5 rng1 matches 248 as @n[tag=SEAboss5] at @s run title @a[distance=0..200] times 0 40 20
...
execute if score SEA_ch5_event_boss5 rng1 matches 248 as @n[tag=SEAboss5] at @s positioned 90142 134 26 as @e[type=#illager,distance=0..50,type=pillager] at @s run function skyblock:sea/e/ch5/boss5/npc_help_quit
