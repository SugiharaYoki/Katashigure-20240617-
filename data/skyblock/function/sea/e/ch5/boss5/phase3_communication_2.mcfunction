...
execute if score SEA_ch5_event_boss5 sea_4temp3 matches 2.. run particle small_gust ^0.4 ^1.2 ^-0.5 0.1 0.1 0.1 0 2
execute if score SEA_ch5_event_boss5 sea_4temp3 matches 2.. run particle small_gust ^-0.4 ^1.2 ^-0.5 0.1 0.1 0.1 0 2
execute if score SEA_ch5_event_boss5 sea_4temp3 matches 12.. run particle small_gust ^0.6 ^1.3 ^-0.7 0.1 0.1 0.1 0 2
execute if score SEA_ch5_event_boss5 sea_4temp3 matches 12.. run particle small_gust ^-0.6 ^1.3 ^-0.7 0.1 0.1 0.1 0 2
execute if score SEA_ch5_event_boss5 sea_4temp3 matches 22.. run particle small_gust ^0.8 ^1.45 ^-0.9 0.1 0.1 0.1 0 2
execute if score SEA_ch5_event_boss5 sea_4temp3 matches 22.. run particle small_gust ^-0.8 ^1.45 ^-0.9 0.1 0.1 0.1 0 2
