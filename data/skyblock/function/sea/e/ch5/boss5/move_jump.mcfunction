...
execute if score @s[scores={rng5=4}] rng4 matches 2 at @s positioned 0.0 0 0.0 run summon marker ^0.9 ^0.2 ^-0.9 {Tags:["SEA_boss5_marker"]}
execute if score @s[scores={rng5=5}] rng4 matches 2 at @s positioned 0.0 0 0.0 run summon marker ^-0.9 ^0.2 ^-0.9 {Tags:["SEA_boss5_marker"]}
...
execute if score @s[scores={rng5=8}] rng4 matches 2 at @s positioned 0.0 0 0.0 run summon marker ^ ^0.2 ^-1.6 {Tags:["SEA_boss5_marker"]}
