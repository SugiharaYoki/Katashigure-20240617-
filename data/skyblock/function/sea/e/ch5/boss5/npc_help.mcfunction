...
execute if entity @s[tag=!SEANPC_Friendly_hasattacktarget] if entity @n[tag=SEAmob,distance=0..6] run attribute @s follow_range base set 13
execute if entity @s[tag=!SEANPC_Friendly_hasattacktarget] if entity @n[tag=SEAmob,distance=0..6] run data modify entity @s Silent set value 1b
execute if entity @s[tag=!SEANPC_Friendly_hasattacktarget] if entity @n[tag=SEAmob,distance=0..6] run damage @s 0 out_of_world by @n[tag=SEAmob,distance=0..6]
execute if entity @s[tag=!SEANPC_Friendly_hasattacktarget] if entity @n[tag=SEAmob,distance=0..6] run data modify entity @s Silent set value 0b
execute if entity @s[tag=!SEANPC_Friendly_hasattacktarget] if entity @n[tag=SEAmob,distance=0..6] run tag @s add SEANPC_Friendly_hasattacktarget
