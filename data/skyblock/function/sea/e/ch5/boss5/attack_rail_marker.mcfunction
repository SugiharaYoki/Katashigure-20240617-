...
execute if score @s rng1 matches 90..130 as @s at @s positioned over world_surface run tp @s ^ ^ ^0.26 facing entity @p[tag=SEAPT]
execute if score @s rng1 matches 131.. as @s at @s run tp @s ~ 135.0 ~
...
execute if score @s rng1 matches 172 as @a[tag=SEAPT,distance=..1] at @s run damage @s 4 explosion
execute if score @s rng1 matches 172 as @a[tag=SEAPT,distance=..1.4] at @s run damage @s 3 explosion
execute if score @s rng1 matches 172 as @a[tag=SEAPT,distance=..1.8] at @s run damage @s 1 explosion
