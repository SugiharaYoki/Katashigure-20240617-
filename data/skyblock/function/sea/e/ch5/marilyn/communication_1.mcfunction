...
execute if block 90163 36 86 green_concrete if score SEA_ch5_event_marilyn rng1 matches 18 positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“玛瑞莲小姐，又是我。我回到海平面上方了。”","color":"white"}]
execute unless block 90163 36 86 green_concrete if score SEA_ch5_event_marilyn rng1 matches 18 positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“玛瑞莲小姐，听得到吗？”","color":"white"}]
...
execute if block 90163 36 86 green_concrete if score SEA_ch5_event_marilyn rng1 matches 47 positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“嗯……或许并不算太重要吧。只是可能失去了很珍视的人。”","color":"white"}]
execute unless block 90163 36 86 green_concrete if score SEA_ch5_event_marilyn rng1 matches 47 positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“……不好意思，在那之后真的遭遇了很多事情。我都已经去水下研究机构转了一圈，现在已经在通讯平台的支柱了。”","color":"white"}]

execute if block 90163 36 86 green_concrete if score SEA_ch5_event_marilyn rng1 matches 67 positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“很奇怪，对吧？我和他认识明明才没几个小时。”","color":"white"}]
execute unless block 90163 36 86 green_concrete if score SEA_ch5_event_marilyn rng1 matches 67 positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“能指引我下一步的路线吗？”","color":"white"}]
...
execute if block 90163 36 86 green_concrete if score SEA_ch5_event_marilyn rng1 matches 105 positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“嗯……抱歉，我总觉得现在已经不能在这些事情上多花时间了。\n那个，方便的话能帮我讲解一下我之后的目标吗？”","color":"white"}]
...
execute if score SEA_ch5_event_marilyn rng1 matches 243 positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] unless block 90168 34 93 blue_concrete run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“就是这样对吧，我会尽力的。”","color":"white"}]
execute if score SEA_ch5_event_marilyn rng1 matches 243 positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] if block 90168 34 93 blue_concrete run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“我明白了，我会尽力的。”","color":"white"}]
execute if score SEA_ch5_event_marilyn rng1 matches 263 positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“……在我赶到行政区前一定要活着啊。拜托了。”","color":"white"}]
execute if score SEA_ch5_event_marilyn rng1 matches 263 positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“……一定要活着等我们赶到行政区。拜托了。”","color":"white"}]
...
execute if score SEA_ch5_event_marilyn rng1 matches 2028 positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“奇怪……没有接通？”","color":"white"}]
...
execute if score SEA_ch5_event_marilyn rng1 matches 2068 if score SEA_ch5_event_fiona_favor rng1 matches ..16 positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“没事没事。”","color":"white"}]
execute if score SEA_ch5_event_marilyn rng1 matches 2068 if score SEA_ch5_event_fiona_favor rng1 matches 17.. positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“怎么可能会是秘密情人呢……唉、没事没事。”","color":"white"}]
...
execute if score SEA_ch5_event_marilyn rng1 matches 4025 if score SEA_ch5_event_fiona_favor rng1 matches ..16 positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“啊、是一个说是贝塔小组员工的人，她现在在行政区。”","color":"white"}]
execute if score SEA_ch5_event_marilyn rng1 matches 4025 if score SEA_ch5_event_fiona_favor rng1 matches 17.. positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“怎么可能会是秘密情人呢……是一个说是贝塔小组员工的人，她现在在行政区。”","color":"white"}]
...
execute if score SEA_ch5_event_marilyn rng1 matches 4119 if score SEA_ch5_event_fiona_favor rng1 matches ..14 positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“那……那可千万别。我就是为了救她才走了这么远的。”","color":"white"}]
execute if score SEA_ch5_event_marilyn rng1 matches 4119 if score SEA_ch5_event_fiona_favor rng1 matches 15..16 positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“怎么可能，你别瞎说了。”","color":"white"}]
execute if score SEA_ch5_event_marilyn rng1 matches 4119 if score SEA_ch5_event_fiona_favor rng1 matches 17.. positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“所以都说了不是啦……”","color":"white"}]
...
execute if score SEA_ch5_event_marilyn rng1 matches 4158 if score SEA_ch5_event_fiona_favor rng1 matches 15.. positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“那可不。……我希望是。我也没见过她本人。”","color":"white"}]
execute if score SEA_ch5_event_marilyn rng1 matches 4178 if score SEA_ch5_event_fiona_favor rng1 matches 15.. positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“我觉得我有机会带你见到她。在那之前，我们先努力活下来吧。”","color":"white"}]
