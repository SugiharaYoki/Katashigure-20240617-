...
execute if score SEA_ch5_event_marilyn rng1 matches 183 positioned 90118 90 73 unless block 90168 34 93 blue_concrete as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run scoreboard players set SEA_ch5_event_marilyn rng1 222
execute if score SEA_ch5_event_marilyn rng1 matches 183 positioned 90118 90 73 if block 90168 34 93 blue_concrete as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..50] [{"text":"玛瑞莲：","color":"dark_purple","bold": true},{"text":"\n“如果那里被合乎情理地堵住了，那你可能需要借助平台中间的钻机上去。那会需要你想办法安全去海上。”","color":"white","bold": false}]
...
execute if score SEA_ch5_event_marilyn rng1 matches 223 positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] unless block 90168 34 93 blue_concrete run tellraw @a[distance=0..50] [{"selector":"@s","color":"white"},{"text":"：就是这样对吧，我会尽力的。","color":"white"}]
execute if score SEA_ch5_event_marilyn rng1 matches 223 positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] if block 90168 34 93 blue_concrete run tellraw @a[distance=0..50] [{"selector":"@s","color":"white"},{"text":"：我明白了，我会尽力的。","color":"white"}]
execute if score SEA_ch5_event_marilyn rng1 matches 243 positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"white"},{"text":"：……在我赶到办公区域前一定要活着啊。拜托了。","color":"white"}]
execute if score SEA_ch5_event_marilyn rng1 matches 243 positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"white"},{"text":"：……一定要活着等我们赶到办公区域。拜托了。","color":"white"}]
...
execute if score SEA_ch5_event_marilyn rng1 matches 16..203 positioned 90118 90 73 if entity @n[tag=SEAfiona,distance=0..30] run scoreboard players set SEA_ch5_event_marilyn rng1 4000
...
execute if score SEA_ch5_event_marilyn rng1 matches 4003 if score SEA_ch5_event_fiona_favor rng1 matches ..14 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..200] [{"text":"菲尔娜：","color":"green","bold": true},{"text":"\n“你要和谁通话？同事？”","color":"white","bold": false}]
execute if score SEA_ch5_event_marilyn rng1 matches 4003 if score SEA_ch5_event_fiona_favor rng1 matches 15.. as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..200] [{"text":"菲尔娜：","color":"green","bold": true},{"text":"\n“你要和谁通话？同事？秘密情人？”","color":"white","bold": false}]
...
execute if score SEA_ch5_event_marilyn rng1 matches 4100 if score SEA_ch5_event_fiona_favor rng1 matches ..14 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..200] [{"text":"菲尔娜：","color":"green","bold": true},{"text":"\n“那家伙看来是不理你咯。他那里出事了？”","color":"white","bold": false}]
execute if score SEA_ch5_event_marilyn rng1 matches 4100 if score SEA_ch5_event_fiona_favor rng1 matches 15.. as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if entity @a[tag=SEAPT,scores={SEAPT_member=2}] run tellraw @a[distance=0..200] [{"text":"菲尔娜：","color":"green","bold": true},{"text":"\n“背着我偷偷和人谈情说爱呢。”","color":"white","bold": false}]
...
execute if score SEA_ch5_event_marilyn rng1 matches 4119 if score SEA_ch5_event_fiona_favor rng1 matches 15..16 positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"white"},{"text":"：怎么可能，你别瞎说了。","color":"white"}]
execute if score SEA_ch5_event_marilyn rng1 matches 4119 if score SEA_ch5_event_fiona_favor rng1 matches 17.. positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"white"},{"text":"：所以都说了不是啦……","color":"white"}]
