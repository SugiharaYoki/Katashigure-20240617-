...
execute if score SEA_ch5_event_marilyn rng1 matches 2068 if score SEA_ch5_event_fiona_favor rng1 matches ..14 positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"white"},{"text":"：没事没事。","color":"white"}]
execute if score SEA_ch5_event_marilyn rng1 matches 2068 if score SEA_ch5_event_fiona_favor rng1 matches 15.. positioned 90118 90 73 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"white"},{"text":"：没事没事。","color":"white"}]
