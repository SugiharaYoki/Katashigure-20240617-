...
execute if score @s rng1 matches 250.. if score @s rng2 matches -5..-3 store result score @s rng5 run random value 1..24
execute if score @s rng1 matches 250.. if score @s rng5 matches 1..8 run function skyblock:sea/e/ch5/boss5/move_jump
