...
execute if score @s rng1 matches 50 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s run playsound entity.wandering_trader.ambient neutral @a ~ ~ ~ 1 1.3
execute if score @s rng1 matches 50 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if score SEA_ch5_event_fiona_favor rng1 matches ..12 run tellraw @a[distance=0..200] [{"text":"菲尔娜：","color":"green","bold": true},{"text":"\n“不，是诺曼博士的尸体。这样就没什么好谈的了，你去杀了他，我掩护你。”","color":"white","bold": false}]
...
execute if score @s rng1 matches 50 run scoreboard players set @n[tag=SEAnorman] rng2 0
execute if score @s rng1 matches 50 run scoreboard players set @n[tag=SEAnorman] rng3 0
execute if score @s rng1 matches 50 run scoreboard players set @n[tag=SEAnorman] rng4 0
execute if score @s rng1 matches 50 run scoreboard players set @n[tag=SEAnorman] rng5 0
execute if score @s rng1 matches 50 run scoreboard players set @n[tag=SEAnorman] rng6 0
execute if score @s rng1 matches 50 run scoreboard players set @n[tag=SEAnorman] rng7 0
