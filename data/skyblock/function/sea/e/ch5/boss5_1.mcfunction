...
execute if score @s rng2 matches -5 run effect give @s instant_damage 1 1 true
...
execute if score @s rng9 matches 1 positioned 90142 134 26 as @e[type=#illager,distance=0..50,tag=SEAboss5_npc_helper] at @s run function skyblock:sea/e/ch5/boss5/npc_help_keep
