...
execute if score sea_ch5_instant_freeze sea_4temp4 matches 45 run fill 90122 121 42 90127 121 41 air
execute if score sea_ch5_instant_freeze sea_4temp4 matches 45 run fill 90122 120 41 90122 119 41 gravel
execute if score sea_ch5_instant_freeze sea_4temp4 matches 45 positioned 90122 120 41 run stopsound @a[distance=0..400] music
