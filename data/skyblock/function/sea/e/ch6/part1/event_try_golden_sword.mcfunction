...
execute if score SEA_ch6_event sea_4temp3 matches 2 at @s positioned ^ ^1 ^ if entity @e[tag=SEAfiona,distance=0..1.6] run scoreboard players set SEA_ch6_event sea_4temp3 200
execute if score SEA_ch6_event sea_4temp3 matches 2 at @s positioned ^ ^2 ^ if entity @e[tag=SEAfiona,distance=0..1.6] run scoreboard players set SEA_ch6_event sea_4temp3 200
execute if score SEA_ch6_event sea_4temp3 matches 2 at @s positioned ^ ^3 ^ if entity @e[tag=SEAfiona,distance=0..1.6] run scoreboard players set SEA_ch6_event sea_4temp3 200
