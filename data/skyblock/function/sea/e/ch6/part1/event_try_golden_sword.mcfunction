...
execute if score SEA_ch6_event sea_4temp3 matches 210 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if score SEA_ch5_event_fiona_favor rng1 matches 6..17 run tellraw @a[distance=0..150] [{"text":"菲尔娜：","color":"green","bold": true},{"text":"\n“","color":"white","bold": false},{"text":"我跟你讲，你再拿我来试剑，我就从你背后把你一箭射死。”","color":"white","bold": false}]
execute if score SEA_ch6_event sea_4temp3 matches 210 as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] at @s if score SEA_ch5_event_fiona_favor rng1 matches 18.. run tellraw @a[distance=0..150] [{"text":"菲尔娜：","color":"green","bold": true},{"text":"\n“","color":"white","bold": false},{"text":"……他妈的，你就非要来拿我的身体试剑吗？你是不是有什么怪异的癖好？”","color":"white","bold": false}]
