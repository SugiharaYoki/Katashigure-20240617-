...
execute if score SEA_ch6_event rng1 matches 61 positioned 90120 129 84 run playsound block.fire.extinguish block @a ~ ~ ~ 2 1.1
execute if score SEA_ch6_event rng1 matches 61 positioned 90120 129 84 run particle falling_lava ~ ~1 ~ 0.5 1 0.5 0 20
execute if score SEA_ch6_event rng1 matches 61 positioned 90120 129 84 run function skyblock:sea/m/visioner
...
execute if score SEA_ch6_event rng1 matches 61 positioned 90118 129 84 run playsound block.fire.extinguish block @a ~ ~ ~ 2 1.1
execute if score SEA_ch6_event rng1 matches 61 positioned 90118 129 84 run particle falling_lava ~ ~1 ~ 0.5 1 0.5 0 20
execute if score SEA_ch6_event rng1 matches 61 positioned 90118 129 84 run function skyblock:sea/m/visioner
