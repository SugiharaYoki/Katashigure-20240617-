...
execute unless items block 90148 145 152 container.1 blue_wool if score SEA_ch6_event rng5 matches 17 run tellraw @a[distance=0..150] [{text:"玛瑞莲：",color:"dark_purple",bold:1b},{text:"\n“你真是个很不错的家伙。你知道我最喜欢你哪一点吗？”",color:"white",bold: false}]
execute if items block 90148 145 152 container.1 blue_wool if score SEA_ch6_event rng5 matches 17 run tellraw @a[distance=0..150] [{text:"玛瑞莲：",color:"dark_purple",bold:1b},{text:"\n“我感觉自己已经喜欢上你了，先生。你知道我最喜欢你哪一点吗？”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 34 run tellraw @a[distance=0..150] [{text:"玛瑞莲：",color:"dark_purple",bold:1b},{text:"\n“那就是无论一件事会有多么危险，令你意外死亡的可能性多么高……你都一定能将它办好。”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 50 run tellraw @a[distance=0..150] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“我就知道……是你！！”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 70 run tellraw @a[distance=0..150] [{text:"玛瑞莲：",color:"dark_purple",bold:1b},{text:"\n“讶异吗？你忘记我也参与开发了静滞光棱？菲尔娜大小姐，你明知道有危险，为何还会义无反顾地往这里闯？”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 88 as @a[tag=SEAPT] run tellraw @a[distance=0..50] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“玛瑞莲？……难道说，我被你骗了？！”",color:"white"}]
...
execute unless items block 90148 145 152 container.1 blue_wool if score SEA_ch6_event rng5 matches 108 run tellraw @a[distance=0..150] [{text:"玛瑞莲：",color:"dark_purple",bold:1b},{text:"\n“被骗？那怎么能算被骗呢。",color:"white",bold: false},{selector:"@p[tag=SEAPT,scores={SEAPT_member=1}]",color:"white",bold: false},{text:"，你们原本就都要死在这里。我不一样，我会成为更加高等的生命。”",color:"white",bold: false}]
execute if items block 90148 145 152 container.1 blue_wool if score SEA_ch6_event rng5 matches 108 run tellraw @a[distance=0..150] [{text:"玛瑞莲：",color:"dark_purple",bold:1b},{text:"\n“抱歉，",color:"white",bold: false},{selector:"@p[tag=SEAPT,scores={SEAPT_member=1}]",color:"white",bold: false},{text:"先生……说实话，如果有的选，我一点都不想杀了你。但是，我的目标是成为更加高等的生命。我会将你为我的牺牲视为对我的成全。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 126 as @a[tag=SEAPT] run tellraw @a[distance=0..50] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“听上去你是要杀了我们。……有什么和谈的方法吗？”",color:"white"}]
execute if score SEA_ch6_event rng5 matches 140 as @a[tag=SEAPT] run tellraw @a[distance=0..50] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“我真的没有料到自己杀了那么多怪物，最终却是被同族给逼到如此地步。”",color:"white"}]
...
execute if score SEA_ch6_event rng5 matches 158 if score SEA_ch5_event_fiona_favor rng1 matches ..14 run tellraw @a[distance=0..150] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“放弃吧，你其实一直都不知道她是谁。我们已经完了。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 158 if score SEA_ch5_event_fiona_favor rng1 matches 15..17 run tellraw @a[distance=0..150] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“",color:"white",bold: false},{selector:"@p[tag=SEAPT,scores={SEAPT_member=1}]",color:"white",bold: false},{text:"……已经太迟了。活下去，不论如何一定都要……！！”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 158 if score SEA_ch5_event_fiona_favor rng1 matches 18.. run tellraw @a[distance=0..150] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“",color:"white",bold: false},{selector:"@p[tag=SEAPT,scores={SEAPT_member=1}]",color:"white",bold: false},{text:"……已经太迟了。听着，我……真的很爱你……！！一定要活下去，不论如何……一定都要……”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 185 if score SEA_ch5_event_fiona_favor rng1 matches ..8 as @a[tag=SEAPT] run tellraw @a[distance=0..50] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“操，你居然真的敢下死手！！”",color:"white"}]
execute if score SEA_ch6_event rng5 matches 185 if score SEA_ch5_event_fiona_favor rng1 matches 9..14 as @a[tag=SEAPT] run tellraw @a[distance=0..50] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“菲尔娜！！”",color:"white"}]
execute if score SEA_ch6_event rng5 matches 185 if score SEA_ch5_event_fiona_favor rng1 matches 15.. as @a[tag=SEAPT] run tellraw @a[distance=0..50] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“菲……菲尔娜！！不要、不要！！！”",color:"white"}]
...
execute if score SEA_ch6_event rng5 matches 220 if score SEA_ch5_event_fiona_favor rng1 matches ..14 run tellraw @a[distance=0..150] [{text:"玛瑞莲：",color:"dark_purple",bold:1b},{text:"\n“可惜呀，菲尔娜大小姐。当初，我原本还想和你成为好朋友。如果圣水晶从来没出现过……”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 220 if score SEA_ch5_event_fiona_favor rng1 matches 15.. run tellraw @a[distance=0..150] [{text:"玛瑞莲：",color:"dark_purple",bold:1b},{text:"\n“小两口真是浪漫啊，在生命的最后关头还不忘记唧唧我我。现在，我来帮你们一同上路。”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 243 run tellraw @a[distance=0..150] [{text:"玛瑞莲？：",color:"dark_purple",bold:1b},{text:"\n“先生，我问你：知道玛丽莲·梦露的原名是什么吗？”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 263 run tellraw @a[distance=0..150] [{text:"诺玛：",color:"red",bold:1b},{text:"\n“生怕你到死都没想明白。是诺玛·简·莫泰森。”",color:"white",bold: false}]

execute if score SEA_ch6_event rng5 matches 282 if score SEA_ch5_event_fiona_favor rng1 matches ..8 as @a[tag=SEAPT] run tellraw @a[distance=0..50] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“诺玛……你居然就是我一直都在听他们提起的……那个煽动暴乱的诺玛！！”",color:"white"}]
execute if score SEA_ch6_event rng5 matches 282 if score SEA_ch5_event_fiona_favor rng1 matches 9..14 as @a[tag=SEAPT] run tellraw @a[distance=0..50] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“他妈的，玛瑞莲……诺玛！为什么要对我们做这些事情？！为什么？！！”",color:"white"}]
execute if score SEA_ch6_event rng5 matches 282 if score SEA_ch5_event_fiona_favor rng1 matches 15.. as @a[tag=SEAPT] run tellraw @a[distance=0..50] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“妈的、就你他妈是诺玛！你杀了菲尔娜，我要你血债血偿！！！”",color:"white"}]
...
execute if score SEA_ch6_event rng5 matches 301 unless items block 90148 145 152 container.1 blue_wool unless items block 90148 145 152 container.4 green_wool run tellraw @a[distance=0..150] [{text:"诺玛：",color:"red",bold:1b},{text:"\n“你已经帮我清理掉了前往水晶祀堂的路上全部的尸变体，我还没来得及感谢你呢。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 301 if items block 90148 145 152 container.1 blue_wool unless items block 90148 145 152 container.4 green_wool run tellraw @a[distance=0..150] [{text:"诺玛：",color:"red",bold:1b},{text:"\n“你已经帮我清理掉了前往水晶祀堂的路上全部的尸变体，我还没来得及感谢你呢。而且，我也真的很不想你再次体验受伤的感觉。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 301 unless items block 90148 145 152 container.1 blue_wool if items block 90148 145 152 container.4 green_wool run tellraw @a[distance=0..150] [{text:"诺玛：",color:"red",bold:1b},{text:"\n“你都把圣水晶送到我手里了，我还没来得及感谢你呢。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 301 if items block 90148 145 152 container.1 blue_wool if items block 90148 145 152 container.4 green_wool run tellraw @a[distance=0..150] [{text:"诺玛：",color:"red",bold:1b},{text:"\n“你专程为我送来了圣水晶，我还没来得及感谢你呢。而且，我也真的很不想你再次体验受伤的感觉。”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 320 run tellraw @a[distance=0..150] [{text:"诺玛：",color:"red",bold:1b},{text:"\n“所以，我会让你死得很痛快的。真的，就像我杀死菲尔娜大小姐那样。”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 412 run tellraw @a[distance=0..150] [{text:"诺玛：",color:"red",bold:1b},{text:"\n“什么、？！”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 419 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“我想杀你很久了，你这孽畜真能活！！”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 432 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“快逃，她也是感染者，我的攻击只会加速她的尸变！！她能撑到现在，尸变后的危险度不容小觑！！”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 438 unless items block 90148 145 152 container.4 green_wool run tellraw @a[distance=0..150] [{text:"诺玛：",color:"red",bold:1b},{text:"\n“呵呵呵，原来如此啊，我提前炸掉水下研究设施，居然没能困住你。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 438 if items block 90148 145 152 container.4 green_wool run tellraw @a[distance=0..150] [{text:"诺玛：",color:"red",bold:1b},{text:"\n“啊啊啊、你居然……！！可恶！我提前炸掉水下研究设施，居然没能困住你！！”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 452 unless items block 90148 145 152 container.4 green_wool run tellraw @a[distance=0..150] [{text:"诺玛：",color:"red",bold:1b},{text:"\n“很遗憾……我可不止有嘴皮功夫。我不会让你们就这么离开。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 452 if items block 90148 145 152 container.4 green_wool run tellraw @a[distance=0..150] [{text:"诺玛：",color:"red",bold:1b},{text:"\n“我饶不了你啊啊啊！！”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 718 if score SEA_ch5_event_fiona_favor rng1 matches ..14 run tellraw @a[distance=0..150] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“我没有任何能和你谈的，诺玛。我知道我本就会死。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 718 if score SEA_ch5_event_fiona_favor rng1 matches 15..17 run tellraw @a[distance=0..150] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“不论如何，诺玛！在杀了他之前，你得从我的尸体上踩过去。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 718 if score SEA_ch5_event_fiona_favor rng1 matches 18.. run tellraw @a[distance=0..150] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“我不会让你伤害他，无论如何……！！”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 735 if score SEA_ch5_event_fiona_favor rng1 matches ..14 run tellraw @a[distance=0..150] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“但诺玛，你也一样。你的计谋永远不会成功，这就是你悲惨的命运。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 735 if score SEA_ch5_event_fiona_favor rng1 matches 15..17 run tellraw @a[distance=0..150] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“你这样又能解决什么问题？有本事你冲我动手啊！就算这样，你也不会得到任何你想要的！”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 735 if score SEA_ch5_event_fiona_favor rng1 matches 18.. run tellraw @a[distance=0..150] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“他的灵魂远比你的要高洁，你永远都无法胜过他，他是比你更加完美的人选！！”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 754 run tellraw @a[distance=0..150] [{text:"玛瑞莲：",color:"dark_purple",bold:1b},{text:"\n“……废话真的太多了。大小姐，我其实一直都觉得你不该这么啰嗦。”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 761 unless items block 90148 145 152 container.1 blue_wool run tellraw @a[distance=0..150] [{text:"玛瑞莲：",color:"dark_purple",bold:1b},{text:"\n“哎呀等等，先生。你这不是把我要找的东西带在身上了吗？”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 761 if items block 90148 145 152 container.1 blue_wool run tellraw @a[distance=0..150] [{text:"玛瑞莲：",color:"dark_purple",bold:1b},{text:"\n“……嗯？有点意思。太有意思了，我就知道信任你是对的。你居然把它带在身上了。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 778 as @a[tag=SEAPT] run tellraw @a[distance=0..50] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“什、……你在说什么？”",color:"white"}]
...
execute if score SEA_ch6_event rng5 matches 790 unless items block 90148 145 152 container.1 blue_wool run tellraw @a[distance=0..150] [{text:"玛瑞莲：",color:"dark_purple",bold:1b},{text:"\n“别跟我装傻，圣水晶就在你的身上吧？”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 790 if items block 90148 145 152 container.1 blue_wool run tellraw @a[distance=0..150] [{text:"玛瑞莲：",color:"dark_purple",bold:1b},{text:"\n“呵呵……我知道圣水晶就在你的身上。”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 813 if score SEA_ch5_event_fiona_favor rng1 matches ..10 if items block 90148 145 152 container.5 green_wool run tellraw @a[distance=0..150] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“",color:"white",bold: false},{selector:"@p[tag=SEAPT,scores={SEAPT_member=1}]",color:"white",bold: false},{text:"，我之前就跟你说你干了很糟糕的事情，你非要把那玩意带身上，现在怎么办？！”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 813 if score SEA_ch5_event_fiona_favor rng1 matches ..10 unless items block 90148 145 152 container.5 green_wool run tellraw @a[distance=0..150] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“",color:"white",bold: false},{selector:"@p[tag=SEAPT,scores={SEAPT_member=1}]",color:"white",bold: false},{text:"，你他妈把什么东西带身上了？！我操……”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 813 if score SEA_ch5_event_fiona_favor rng1 matches 11.. run tellraw @a[distance=0..150] [{text:"菲尔娜：",color:"green",bold:1b},{text:"\n“糟糕了，圣水晶才是诺玛的目标，她一开始就在利用你！！”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 829 as @a[tag=SEAPT] run tellraw @a[distance=0..50] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“我……我都不清楚这件事，那……我给你圣水晶，你饶我们一命？”",color:"white"}]
...
execute if score SEA_ch6_event rng5 matches 843 unless items block 90148 145 152 container.1 blue_wool run tellraw @a[distance=0..150] [{text:"玛瑞莲：",color:"dark_purple",bold:1b},{text:"\n“可笑，圣水晶本就该归我所有，你们也本就该死。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 843 if items block 90148 145 152 container.1 blue_wool run tellraw @a[distance=0..150] [{text:"玛瑞莲：",color:"dark_purple",bold:1b},{text:"\n“抱歉，我会拿走圣水晶。但……我不能让你们活。我也有自己的考量，请你理解。”",color:"white",bold: false}]
