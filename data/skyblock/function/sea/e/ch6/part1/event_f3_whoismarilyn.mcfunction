...
execute if score SEA_ch6_event rng5 matches 126 as @a[tag=SEAPT] tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：","color":"aqua","bold": true},{"text":"\n“听上去你是要杀了我们。……有什么和谈的方法吗？我真的没有料到自己杀了那么多怪物，最终却是被自己的种族给逼到如此地步。”","color":"white"}]
...
execute if score SEA_ch6_event rng5 matches 165 if score SEA_ch5_event_fiona_favor rng1 matches ..8 as @a[tag=SEAPT] tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：","color":"aqua","bold": true},{"text":"\n“操，你居然真的敢下死手！！”","color":"white"}]
execute if score SEA_ch6_event rng5 matches 165 if score SEA_ch5_event_fiona_favor rng1 matches 9..14 as @a[tag=SEAPT] tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：","color":"aqua","bold": true},{"text":"\n“菲尔娜！！”","color":"white"}]
execute if score SEA_ch6_event rng5 matches 165 if score SEA_ch5_event_fiona_favor rng1 matches 15.. as @a[tag=SEAPT] tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：","color":"aqua","bold": true},{"text":"\n“菲……菲尔娜！！不要、不要！！！”","color":"white"}]
