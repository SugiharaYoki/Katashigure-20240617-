...
execute if score SEA_ch6_event rng5 matches 1198..1900 run scoreboard players add SEA_ch6_event rng6 1

execute if score SEA_ch6_event rng5 matches 1102 run scoreboard players set @a[tag=SEAPT,scores={sea_progress=..15}] sea_progress 16
...
execute if score SEA_ch6_event rng5 matches 1122 run tellraw @a[distance=0..200] [{text:"全平台广播：",color:"green",bold:1b},{text:"\n“所有教徒与幸存者注意，忒尔克西的输油管道已经接近临界值。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 1152 run tellraw @a[distance=0..200] [{text:"全平台广播：",color:"green",bold:1b},{text:"\n“再次通知，忒尔克西的输油管道已经接近临界值。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 1182 run tellraw @a[distance=0..200] [{text:"全平台广播：",color:"green",bold:1b},{text:"\n“我们的驻足之地随时都可能爆炸崩塌，请所有人做好临终准备。”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 1138 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“这平台终于要炸了，跟着我走。就算平台不炸，美国政府也会往这里丢燃烧弹。”",color:"white",bold: false}]

execute if score SEA_ch6_event rng5 matches 1156 as @a[tag=SEAPT] run tellraw @a[distance=0..150] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“啊？！等等、所以政府已经知道了？！”",color:"white"}]
execute if score SEA_ch6_event rng5 matches 1173 as @a[tag=SEAPT] unless items block 90148 145 152 container.4 green_wool run tellraw @a[distance=0..150] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“那我们该怎么办？总不见得无处可去吧？”",color:"white"}]
execute if score SEA_ch6_event rng5 matches 1173 as @a[tag=SEAPT] if items block 90148 145 152 container.4 green_wool run tellraw @a[distance=0..150] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“不、不对！还有更重要的事情，圣水晶还搁玛瑞、还搁诺玛手里呢！！”",color:"white"}]
...
execute if score SEA_ch6_event rng5 matches 1190 as @n[tag=SEAedwina] at @s if items entity @a[tag=SEAPT] weapon.mainhand golden_sword run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“都已经把天使长拉斐尔的剑拿在手里了，还问我这种问题？跟我一起回水下研究设施。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 1190 as @n[tag=SEAedwina] at @s unless items block 90148 145 152 container.4 green_wool unless items entity @a[tag=SEAPT] weapon.mainhand golden_sword run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“最危险的地方就是最安全的地方。跟我一起回水下研究设施。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 1190 as @n[tag=SEAedwina] at @s if items block 90148 145 152 container.4 green_wool run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“那东西刚刚就被我劈碎了，我怎么可能允许那玩意留下来？”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 1200 as @n[tag=SEAedwina] at @s if items block 90148 145 152 container.4 green_wool run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“现在我们有更重要的事情做，跟紧我，我们回水下研究设施。”",color:"white",bold: false}]

execute if score SEA_ch6_event rng5 matches 1200 as @a[tag=SEAPT] if items entity @a[tag=SEAPT] weapon.mainhand golden_sword run tellraw @a[distance=0..150] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“你先等等、拉斐尔？什么天使长？你在说什么？！”",color:"white"}]
...
execute if score SEA_ch6_event rng5 matches 1215 as @n[tag=SEAedwina] at @s if items entity @a[tag=SEAPT] weapon.mainhand golden_sword run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“不知道就别问了，现在没空跟你解释这些！总之往水下去，路线很熟悉了吧？”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 1302 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“物资层东面那座电梯应该还能用，我祈祷还能用。去那里！”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 1407 run playsound minecraft:entity.generic.explode ambient @a 90153 139 138 2 0.8
...
execute if score SEA_ch6_event rng5 matches 1309 run tellraw @a[distance=0..200] [{text:"全平台广播：",color:"green",bold:1b},{text:"\n“所有幸存者注意，忒尔克西的输油管道已经接近临界值。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 1409 run tellraw @a[distance=0..200] [{text:"全平台广播：",color:"green",bold:1b},{text:"\n“警告，通讯平台濒临崩塌，请所有的幸存者前往……”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 1502 positioned 90153.0 37 127 run data modify entity @n[tag=SEAnorma_warden] Silent set value 1b
...
execute if score SEA_ch6_event rng9 matches 42 as @n[tag=SEAnorma] at @s run tellraw @a[distance=0..150] [{text:"诺玛：",color:"red",bold:1b},{text:"\n“哈啊啊……多么美妙的、……力量！！”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng9 matches 42.. as @n[tag=SEAnorma,scores={rng8=1..}] at @s run scoreboard players remove @s rng8 1
execute if score SEA_ch6_event rng9 matches 42.. as @n[tag=SEAnorma,scores={rng8=9..12}] at @s run effect give @n[tag=SEAnorma] invisibility infinite 0 true
execute if score SEA_ch6_event rng9 matches 42.. as @n[tag=SEAnorma,scores={rng8=9..12}] at @s run effect clear @n[tag=SEAnorma_warden] invisibility
execute if score SEA_ch6_event rng9 matches 42.. as @n[tag=SEAnorma,scores={rng8=9..12}] at @n[tag=SEAnorma_warden] run particle minecraft:sculk_soul ~ ~1 ~ 1.3 1.2 1.3 0 30
execute if score SEA_ch6_event rng9 matches 42.. as @n[tag=SEAnorma,scores={rng8=9..12}] at @s run data modify entity @n[tag=SEAnorma_warden] NoAI set value 0b
#execute if score SEA_ch6_event rng9 matches 42.. as @n[tag=SEAnorma,scores={rng8=9..12}] at @s run data modify entity @n[tag=SEAnorma_warden] Silent set value 0b
execute if score SEA_ch6_event rng9 matches 42.. as @n[tag=SEAnorma,scores={rng8=8}] at @s run effect give @n[tag=SEAnorma_warden] invisibility infinite 0 true
execute if score SEA_ch6_event rng9 matches 42.. as @n[tag=SEAnorma,scores={rng8=8}] at @s run effect clear @n[tag=SEAnorma] invisibility
execute if score SEA_ch6_event rng9 matches 42.. as @n[tag=SEAnorma,scores={rng8=8}] at @s run data modify entity @n[tag=SEAnorma_warden] NoAI set value 1b
...
execute if score SEA_ch6_event rng5 matches 1507 positioned 90150 140 61 run playsound minecraft:entity.generic.explode ambient @a ~ ~ ~ 10 0.8
execute if score SEA_ch6_event rng5 matches 1509 positioned 90150 140 61 run playsound minecraft:entity.firework_rocket.large_blast ambient @a ~ ~ ~ 10 0.6
execute if score SEA_ch6_event rng5 matches 1305 positioned 90150 140 61 run playsound minecraft:entity.firework_rocket.large_blast ambient @a ~ ~ ~ 10 0.6
execute if score SEA_ch6_event rng5 matches 1408 positioned 90150 140 61 run playsound minecraft:entity.generic.explode ambient @a ~ ~ ~ 10 0.8
...
execute if score SEA_ch6_event rng5 matches 1516 positioned 90130 140 61 run playsound minecraft:entity.generic.explode ambient @a ~ ~ ~ 10 0.8
...
execute if score SEA_ch6_event rng5 matches 1547 positioned 90150 120 61 run playsound minecraft:entity.generic.explode ambient @a ~ ~ ~ 10 0.8
execute if score SEA_ch6_event rng5 matches 1549 positioned 90150 120 61 run playsound minecraft:entity.firework_rocket.large_blast ambient @a ~ ~ ~ 10 0.6

execute if score SEA_ch6_event rng5 matches 1200..1800 as @a[x=90138,y=133,z=143,dx=30,dy=4,dz=30,tag=SEAPT,tag=!e_i_54] at @s run attribute @s minecraft:jump_strength modifier add sea:marilyn_01 -50 add_value
...
execute if score SEA_ch6_event rng5 matches 1200..1800 as @a[tag=SEAPT,gamemode=adventure] at @s if block ~ ~ ~ #skyblock:water if block ~ ~-1 ~ water run kill @s
...
execute if score SEA_ch6_event rng5 matches 1603 run playsound minecraft:entity.generic.explode ambient @a 90152 102 107 2 0.8
execute if score SEA_ch6_event rng5 matches 1605 run playsound minecraft:entity.generic.explode ambient @a 90152 102 109 2 0.8
...
execute if score SEA_ch6_event rng6 matches -220 as @p[tag=SEAPT] as @a[distance=..250] run title @s title [{text:"剩余 180 秒",color:"white",bold:1b}]
...
execute if score SEA_ch6_event rng6 matches -216 as @p[tag=SEAPT] as @a[distance=..250] run title @s title [{text:"剩余 179 秒",color:"white",bold:1b}]
execute if score SEA_ch6_event rng6 matches -212 as @p[tag=SEAPT] as @a[distance=..250] run title @s times 0 10 10
execute if score SEA_ch6_event rng6 matches -212 as @p[tag=SEAPT] as @a[distance=..250] run title @s title [{text:"剩余 178 秒",color:"white",bold:1b}]
...
execute if score SEA_ch6_event rng6 matches 20 as @p[tag=SEAPT] as @a[distance=..250] run title @s title [{text:"剩余 120 秒",color:"white",bold:1b}]
...
execute if score SEA_ch6_event rng6 matches 24 as @p[tag=SEAPT] as @a[distance=..250] run title @s title [{text:"剩余 119 秒",color:"white",bold:1b}]
execute if score SEA_ch6_event rng6 matches 28 as @p[tag=SEAPT] as @a[distance=..250] run title @s times 0 10 10
execute if score SEA_ch6_event rng6 matches 28 as @p[tag=SEAPT] as @a[distance=..250] run title @s title [{text:"剩余 118 秒",color:"white",bold:1b}]
...
execute if score SEA_ch6_event rng6 matches 280 as @p[tag=SEAPT] as @a[distance=..250] run title @s title [{text:"剩余 60 秒",color:"white",bold:1b}]
...
execute if score SEA_ch6_event rng6 matches 284 as @p[tag=SEAPT] as @a[distance=..250] run title @s title [{text:"剩余 59 秒",color:"white",bold:1b}]
execute if score SEA_ch6_event rng6 matches 288 as @p[tag=SEAPT] as @a[distance=..250] run title @s times 0 10 10
execute if score SEA_ch6_event rng6 matches 288 as @p[tag=SEAPT] as @a[distance=..250] run title @s title [{text:"剩余 58 秒",color:"white",bold:1b}]
...
execute if score SEA_ch6_event rng6 matches 360 as @p[tag=SEAPT] as @a[distance=..250] run title @s title [{text:"剩余 30 秒",color:"white",bold:1b}]
...
execute if score SEA_ch6_event rng6 matches 364 as @p[tag=SEAPT] as @a[distance=..250] run title @s title [{text:"剩余 29 秒",color:"white",bold:1b}]
execute if score SEA_ch6_event rng6 matches 368 as @p[tag=SEAPT] as @a[distance=..250] run title @s times 0 10 10
execute if score SEA_ch6_event rng6 matches 368 as @p[tag=SEAPT] as @a[distance=..250] run title @s title [{text:"剩余 28 秒",color:"white",bold:1b}]

execute if score SEA_ch6_event rng6 matches 440 as @p[tag=SEAPT] as @a[distance=..250] run tellraw @s[distance=0..200] [{text:"距离忒尔克西钻井平台坍塌：",color:"red",bold:1b},{text:"\n剩余 10 秒",color:"red",bold: false}]
...
execute if score SEA_ch6_event rng6 matches 200 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“快要来不及了，尽快逃离！！”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng6 matches 390 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“我们已经做了所有我们能做的。”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng6 matches 410 as @n[tag=SEAedwina] at @s unless entity @a[tag=SEAPT,scores={sea_count_dead=1..}] run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“再见了……我的战友。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng6 matches 410 as @n[tag=SEAedwina] at @s if entity @a[tag=SEAPT,scores={sea_count_dead=1..}] run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“我的战友，我早就知道你拥有倒转时空的能力。”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng6 matches 440 as @n[tag=SEAedwina] at @s unless entity @a[tag=SEAPT,scores={sea_count_dead=1..}] run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“抱歉……我本该做得更好。事态演变成这一步，我有不可推卸的责任……”",color:"white",bold: false}]
execute if score SEA_ch6_event rng6 matches 440 as @n[tag=SEAedwina] at @s if entity @a[tag=SEAPT,scores={sea_count_dead=1..}] run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“下次见面的时候……我会再次尽我所能与你并肩作战。”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng6 matches 470 as @n[tag=SEAedwina] at @s unless entity @a[tag=SEAPT,scores={sea_count_dead=1..}] run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“真的很对不起，我对不起你们所有人……”",color:"white",bold: false}]
execute if score SEA_ch6_event rng6 matches 470 as @n[tag=SEAedwina] at @s if entity @a[tag=SEAPT,scores={sea_count_dead=1..}] run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“……愿我们来世再遇。”",color:"white",bold: false}]
