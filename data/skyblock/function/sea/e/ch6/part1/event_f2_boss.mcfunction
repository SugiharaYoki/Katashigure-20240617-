...
execute if score SEA_ch6_f2 rng1 matches 2 run execute if score SEA_ch6_f2 rng3 matches 101 run fill 90139 161 142 90139 163 142 minecraft:mangrove_leaves[persistent=true]
execute if score SEA_ch6_f2 rng1 matches 2 run execute if score SEA_ch6_f2 rng3 matches 101 run fill 90139 161 143 90139 160 143 minecraft:mangrove_leaves[persistent=true]
execute if score SEA_ch6_f2 rng1 matches 2 run execute if score SEA_ch6_f2 rng3 matches 101 run fill 90138 161 143 90138 161 144 minecraft:mangrove_leaves[persistent=true]
execute if score SEA_ch6_f2 rng1 matches 2 run execute if score SEA_ch6_f2 rng3 matches 101 run setblock 90138 162 144 minecraft:mangrove_leaves[persistent=true]
