...
execute as @a[tag=SEAPT,x=90143,y=159,z=123,dx=3,dy=4,dz=3,tag=!e_i_53] run tellraw @s [{"text":" - "},{"text":"前进，并见证一切  ","color":"light_purple"},{"text":"〈◆〉","bold":true,"color":"light_purple","clickEvent":{"action":"run_command","value":"/trigger sea_crafter set 90005"}}]
