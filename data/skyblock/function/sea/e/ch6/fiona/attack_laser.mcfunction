...
execute as @s[scores={rng8=4},tag=!SEAfiona_targetfound] at @s rotated as @s positioned ^ ^ ^1.6 unless block ~ ~ ~ air unless block ~ ~ ~ fire unless block ~ ~ ~ #all_signs unless block ~ ~ ~ water unless block ~ ~ ~ cobweb unless block ~ ~ ~ #minecraft:flower_pots run scoreboard players set @s rng8 9
...
execute as @s[scores={rng8=4},tag=!SEAfiona_targetfound] at @s rotated as @s positioned ^ ^ ^2.4 unless block ~ ~ ~ air unless block ~ ~ ~ fire unless block ~ ~ ~ #all_signs unless block ~ ~ ~ water unless block ~ ~ ~ cobweb unless block ~ ~ ~ #minecraft:flower_pots run scoreboard players set @s rng8 9
...
execute as @s[scores={rng8=4},tag=!SEAfiona_targetfound] at @s rotated as @s positioned ^ ^ ^3.2 unless block ~ ~ ~ air unless block ~ ~ ~ fire unless block ~ ~ ~ #all_signs unless block ~ ~ ~ water unless block ~ ~ ~ cobweb unless block ~ ~ ~ #minecraft:flower_pots run scoreboard players set @s rng8 9
...
execute as @s[scores={rng8=4},tag=!SEAfiona_targetfound] at @s rotated as @s positioned ^ ^ ^4.0 unless block ~ ~ ~ air unless block ~ ~ ~ fire unless block ~ ~ ~ #all_signs unless block ~ ~ ~ water unless block ~ ~ ~ cobweb unless block ~ ~ ~ #minecraft:flower_pots run scoreboard players set @s rng8 9
...
execute as @s[scores={rng8=4},tag=!SEAfiona_targetfound] at @s rotated as @s positioned ^ ^ ^4.8 unless block ~ ~ ~ air unless block ~ ~ ~ fire unless block ~ ~ ~ #all_signs unless block ~ ~ ~ water unless block ~ ~ ~ cobweb unless block ~ ~ ~ #minecraft:flower_pots run scoreboard players set @s rng8 9
...
execute as @s[scores={rng8=4},tag=!SEAfiona_targetfound] at @s rotated as @s positioned ^ ^ ^5.6 unless block ~ ~ ~ air unless block ~ ~ ~ fire unless block ~ ~ ~ #all_signs unless block ~ ~ ~ water unless block ~ ~ ~ cobweb unless block ~ ~ ~ #minecraft:flower_pots run scoreboard players set @s rng8 9
