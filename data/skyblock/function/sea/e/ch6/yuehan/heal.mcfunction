...
execute as @s[scores={rng8=3,rng7=7},tag=SEAyuehan_act_heal,tag=!SEAyuehan_ch4_acting] at @s if entity @a[tag=SEAyuehan_act_heal_target] run tellraw @a[distance=0..28] [{text:"越涵：",color:"green","bold": true},{text:"\n“",color:"white","bold": false},{selector:"@p[tag=SEAyuehan_act_heal_target]",color:"white","bold": false},{text:"，你真的是从下面一路杀上来的吗？就你这水平？”",color:"white","bold": false}]
...
execute as @s[scores={rng8=3,rng7=9},tag=SEAyuehan_act_heal,tag=!SEAyuehan_ch4_acting] at @s if entity @a[tag=SEAyuehan_act_heal_target] run tellraw @a[distance=0..28] [{text:"越涵：",color:"green","bold": true},{text:"\n“说实话，",color:"white","bold": false},{selector:"@p[tag=SEAyuehan_act_heal_target]",color:"white","bold": false},{text:"，我很担心我们能不能从水下活着回来……”",color:"white","bold": false}]
