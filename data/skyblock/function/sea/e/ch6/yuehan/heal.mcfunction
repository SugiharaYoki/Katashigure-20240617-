...
execute as @s[scores={rng8=3,rng7=6},tag=SEAyuehan_act_heal] at @s if entity @a[tag=SEAyuehan_act_heal_target] run tellraw @a[distance=0..28] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“","color":"white","bold": false},{"selector":"@p[tag=SEAyuehan_act_heal_target]","color":"white","bold": false},{"text":"，我承认我治疗药水很多，但你这是故意的吗？”","color":"white","bold": false}]
execute as @s[scores={rng8=3,rng7=7},tag=SEAyuehan_act_heal] at @s if entity @a[tag=SEAyuehan_act_heal_target] run tellraw @a[distance=0..28] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“","color":"white","bold": false},{"selector":"@p[tag=SEAyuehan_act_heal_target]","color":"white","bold": false},{"text":"，你真的是从下面一路杀上来的吗？就你这水平？”","color":"white","bold": false}]
execute as @s[scores={rng8=3,rng7=8},tag=SEAyuehan_act_heal] at @s if entity @a[tag=SEAyuehan_act_heal_target] run tellraw @a[distance=0..28] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“我靠，","color":"white","bold": false},{"selector":"@p[tag=SEAyuehan_act_heal_target]","color":"white","bold": false},{"text":"，你是在浪费我的药水吗？”","color":"white","bold": false}]
execute as @s[scores={rng8=3,rng7=9},tag=SEAyuehan_act_heal] at @s if entity @a[tag=SEAyuehan_act_heal_target] run tellraw @a[distance=0..28] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“说实话，","color":"white","bold": false},{"selector":"@p[tag=SEAyuehan_act_heal_target]","color":"white","bold": false},{"text":"，我很担心我们能不能从水下活着回来……”","color":"white","bold": false}]
execute as @s[scores={rng8=3,rng7=10},tag=SEAyuehan_act_heal] at @s if entity @a[tag=SEAyuehan_act_heal_target] run tellraw @a[distance=0..28] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“我从没见过比你还莽的人，","color":"white","bold": false},{"selector":"@p[tag=SEAyuehan_act_heal_target]","color":"white","bold": false},{"text":"。”","color":"white","bold": false}]
