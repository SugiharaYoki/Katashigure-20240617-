...
execute as @s[scores={rng8=4},tag=SEAboss4_attack_dashheavy] at @s run tp @s ~ ~ ~ facing entity @n[tag=SEAmob]
...
execute as @s[scores={rng8=40..},tag=SEAboss4_attack_dashheavy,nbt={OnGround:1b}] at @s as @e[tag=SEAmob,distance=0..4.3] at @s run damage @s 8 generic
