...
execute as @s[scores={rng8=4},tag=SEAboss4_attack_dashheavy] at @s run tp @s ~ ~ ~ facing entity @n[tag=SEAmob,tag=!SEAcreak]
...
execute as @s[scores={rng8=4},tag=SEAboss4_attack_dashheavy] at @s run scoreboard players add @s rng8 20
...
execute as @s[scores={rng8=40..},tag=SEAboss4_attack_dashheavy,nbt={OnGround:1b}] at @s as @e[tag=SEAmob,distance=0..4.3,tag=!SEAcreak] at @s run damage @s 8 generic
execute as @s[scores={rng8=40..},tag=SEAboss4_attack_dashheavy,nbt={OnGround:1b}] at @s run scoreboard players set @s rng2 0
execute as @s[scores={rng8=40..},tag=SEAboss4_attack_dashheavy,nbt={OnGround:1b}] at @s run tag @s remove SEAboss4_attack_dashheavy
execute as @s[scores={rng8=40..},nbt={OnGround:1b}] at @s run scoreboard players set @s rng8 0