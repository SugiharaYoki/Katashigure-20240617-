...
execute as @s[scores={rng8=5..29},tag=SEAboss4_attack_dash] at @s if entity @n[tag=SEAmob,distance=0..1.1] run scoreboard players set @s rng8 0
...
execute as @s[scores={rng8=14},tag=SEAboss4_attack_dash] at @s run tp @s ~ ~ ~ facing entity @n[tag=SEAmob]
...
execute as @s[scores={rng8=25},tag=SEAboss4_attack_dash] at @s run tp @s ~ ~ ~ facing entity @n[tag=SEAmob]
