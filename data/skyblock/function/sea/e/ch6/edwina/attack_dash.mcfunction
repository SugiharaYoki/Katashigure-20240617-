...
execute as @s[scores={rng8=5..29},tag=SEAboss4_attack_dash] at @s positioned ^ ^ ^0.5 as @e[tag=SEAmob,tag=!SEAcreak,distance=0..1.1] at @s run damage @s 13 player_attack
