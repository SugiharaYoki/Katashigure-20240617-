...
execute as @s[tag=SEAedwina_attackable,scores={rng3=1}] at @r[tag=SEAPT] unless entity @r[tag=SEAPT,distance=..3] rotated ~ 0 positioned ^ ^ ^-2 if block ~ ~ ~ air if block ~ ~1 ~ air if block ~ ~1 ~0.3 air if block ~ ~1 ~-0.3 air if block ~0.3 ~1 ~ air if block ~-0.3 ~1 ~ air unless block ~ ~-0.7 ~ air run tp @s ~ ~ ~ facing entity @p[tag=SEAPT]
execute as @s[tag=SEAedwina_attackable,scores={rng3=1}] at @r[tag=SEAPT] unless entity @r[tag=SEAPT,distance=..3] rotated ~ 0 positioned ^1 ^ ^-2 if block ~ ~ ~ air if block ~ ~1 ~ air if block ~ ~1 ~0.3 air if block ~ ~1 ~-0.3 air if block ~0.3 ~1 ~ air if block ~-0.3 ~1 ~ air unless block ~ ~-0.7 ~ air run tp @s ~ ~ ~ facing entity @p[tag=SEAPT]
execute as @s[tag=SEAedwina_attackable,scores={rng3=1}] at @r[tag=SEAPT] unless entity @r[tag=SEAPT,distance=..3] rotated ~ 0 positioned ^-1 ^ ^-2 if block ~ ~ ~ air if block ~ ~1 ~ air if block ~ ~1 ~0.3 air if block ~ ~1 ~-0.3 air if block ~0.3 ~1 ~ air if block ~-0.3 ~1 ~ air unless block ~ ~-0.7 ~ air run tp @s ~ ~ ~ facing entity @p[tag=SEAPT]
execute as @s[tag=SEAedwina_attackable,scores={rng3=1..}] run scoreboard players set @s rng3 0

execute as @s[tag=SEAedwina_ch6_end,scores={rng3=1}] at @r[tag=SEAPT] unless entity @r[tag=SEAPT,distance=..3] rotated ~ 0 positioned ^ ^ ^-1 if block ~ ~ ~ air if block ~ ~1 ~ air if block ~ ~1 ~0.3 air if block ~ ~1 ~-0.3 air if block ~0.3 ~1 ~ air if block ~-0.3 ~1 ~ air unless block ~ ~-0.7 ~ air run tp @s ~ ~ ~ facing entity @p[tag=SEAPT]
execute as @s[tag=SEAedwina_ch6_end,scores={rng3=1}] at @r[tag=SEAPT] unless entity @r[tag=SEAPT,distance=..3] rotated ~ 0 positioned ^1 ^ ^-1 if block ~ ~ ~ air if block ~ ~1 ~ air if block ~ ~1 ~0.3 air if block ~ ~1 ~-0.3 air if block ~0.3 ~1 ~ air if block ~-0.3 ~1 ~ air unless block ~ ~-0.7 ~ air run tp @s ~ ~ ~ facing entity @p[tag=SEAPT]
execute as @s[tag=SEAedwina_ch6_end,scores={rng3=1}] at @r[tag=SEAPT] unless entity @r[tag=SEAPT,distance=..3] rotated ~ 0 positioned ^-1 ^ ^-1 if block ~ ~ ~ air if block ~ ~1 ~ air if block ~ ~1 ~0.3 air if block ~ ~1 ~-0.3 air if block ~0.3 ~1 ~ air if block ~-0.3 ~1 ~ air unless block ~ ~-0.7 ~ air run tp @s ~ ~ ~ facing entity @p[tag=SEAPT]
