...
execute as @s[tag=SEAedwina_attackable,scores={rng8=0}] if entity @n[tag=SEAmob,distance=0..4] store result score @s rng3 run random value 1..30
execute as @s[tag=SEAedwina_attackable,scores={rng8=0}] if entity @n[tag=SEAmob,distance=0..10] unless entity @n[tag=SEAmob,distance=0..4] store result score @s rng3 run random value 29..30

execute as @s[tag=SEAedwina_ch6_end] unless entity @n[tag=SEAPT,distance=0..2] store result score @s rng3 run random value 1..2
...
execute as @s[tag=SEAedwina_attackable,scores={rng3=1}] at @s unless entity @r[tag=SEAPT,distance=..3] at @r[tag=SEAPT] rotated ~ 0 positioned ^ ^ ^-2 if block ~ ~ ~ air if block ~ ~1 ~ air if block ~ ~1 ~0.3 air if block ~ ~1 ~-0.3 air if block ~0.3 ~1 ~ air if block ~-0.3 ~1 ~ air unless block ~ ~-0.7 ~ air run tp @s ~ ~ ~ facing entity @p[tag=SEAPT]
execute as @s[tag=SEAedwina_attackable,scores={rng3=1}] at @s unless entity @r[tag=SEAPT,distance=..3] at @r[tag=SEAPT] rotated ~ 0 positioned ^1 ^ ^-2 if block ~ ~ ~ air if block ~ ~1 ~ air if block ~ ~1 ~0.3 air if block ~ ~1 ~-0.3 air if block ~0.3 ~1 ~ air if block ~-0.3 ~1 ~ air unless block ~ ~-0.7 ~ air run tp @s ~ ~ ~ facing entity @p[tag=SEAPT]
execute as @s[tag=SEAedwina_attackable,scores={rng3=1}] at @s unless entity @r[tag=SEAPT,distance=..3] at @r[tag=SEAPT] rotated ~ 0 positioned ^-1 ^ ^-2 if block ~ ~ ~ air if block ~ ~1 ~ air if block ~ ~1 ~0.3 air if block ~ ~1 ~-0.3 air if block ~0.3 ~1 ~ air if block ~-0.3 ~1 ~ air unless block ~ ~-0.7 ~ air run tp @s ~ ~ ~ facing entity @p[tag=SEAPT]
execute as @s[tag=SEAedwina_attackable,scores={rng3=1..}] run scoreboard players set @s rng3 0

execute as @s[tag=SEAedwina_ch6_end,scores={rng3=1}] at @s unless entity @r[tag=SEAPT,distance=..3] at @r[tag=SEAPT] rotated ~ 0 positioned ^ ^ ^-1 if block ~ ~ ~ air if block ~ ~1 ~ air if block ~ ~1 ~0.3 air if block ~ ~1 ~-0.3 air if block ~0.3 ~1 ~ air if block ~-0.3 ~1 ~ air unless block ~ ~-0.7 ~ air run tp @s ~ ~ ~ facing entity @p[tag=SEAPT]
execute as @s[tag=SEAedwina_ch6_end,scores={rng3=1}] at @s unless entity @r[tag=SEAPT,distance=..3] at @r[tag=SEAPT] rotated ~ 0 positioned ^1 ^ ^-1 if block ~ ~ ~ air if block ~ ~1 ~ air if block ~ ~1 ~0.3 air if block ~ ~1 ~-0.3 air if block ~0.3 ~1 ~ air if block ~-0.3 ~1 ~ air unless block ~ ~-0.7 ~ air run tp @s ~ ~ ~ facing entity @p[tag=SEAPT]
execute as @s[tag=SEAedwina_ch6_end,scores={rng3=1}] at @s unless entity @r[tag=SEAPT,distance=..3] at @r[tag=SEAPT] rotated ~ 0 positioned ^-1 ^ ^-1 if block ~ ~ ~ air if block ~ ~1 ~ air if block ~ ~1 ~0.3 air if block ~ ~1 ~-0.3 air if block ~0.3 ~1 ~ air if block ~-0.3 ~1 ~ air unless block ~ ~-0.7 ~ air run tp @s ~ ~ ~ facing entity @p[tag=SEAPT]
execute as @s[tag=SEAedwina_ch6_end,scores={rng3=1..}] run scoreboard players set @s rng3 0
