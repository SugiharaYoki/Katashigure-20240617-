...
execute if score SEA_ch6_event rng5 matches 2024 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“我之前都走这条路到水下研究设施。这里相对狭窄很多，遇上怪物只能正面战斗。做好万全准备。”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 2040 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“提醒一下，这里的水被烤到了接近沸腾的温度，最好离水越远越好。”",color:"white",bold: false}]

execute if block 90172 142 -1867 lantern if score SEA_ch6_event rng5 matches 2060 as @p[tag=SEAPT] at @s run tellraw @a[distance=0..250] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“你刚刚说……你知道我有倒转时空的能力？那是什么意思？”",color:"white"}]
...
execute if block 90172 142 -1867 lantern if score SEA_ch6_event rng5 matches 2077 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“这是我梦境中的内容。抱歉……或许是在危急关头，我宁可相信它是真的吧。”",color:"white",bold: false}]
execute if block 90172 142 -1867 lantern if score SEA_ch6_event rng5 matches 2094 as @p[tag=SEAPT] at @s run tellraw @a[distance=0..250] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“我……确实做了很多场预知梦。只不过内容和现实多有差异，所以我没有放在心上。”",color:"white"}]
...
execute if score SEA_ch6_event rng5 matches 3008 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“操，这个阴魂不散的畜生……！！”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 3038 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“别作战，继续往深处跑，我根本打不死这家伙！！”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 3300 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"？？？：",color:"gray",bold:1b},{text:"\n“你根本不知道你给我们带来了多大的麻烦。”",color:"gray",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 3200 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“快跑，我尽可能拖住她！！”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 4001 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“他妈的……非得经过这段路吗？”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 4022 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“不能再往前了，从左边的裂缝上去！”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 4030 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“这里！！”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 4522 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“选择成为尸变体只会让她连爬梯子这么简单的动作都做不到。”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 4562 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“我们得想办法下到更深的地方，我不觉得她来堵我们只是为了好玩。”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 4632 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“这地方居然已经毁成这样了……氧气可能很快就会被烧完。主平台也完了，我觉得我们生存的希望很渺茫。”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 5002 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"？？？：",color:"gray",bold:1b},{text:"\n“你根本不知道你给我们带来了多大的麻烦。”",color:"gray",bold: false}]

execute if score SEA_ch6_event rng5 matches 5022 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"？？？：",color:"gray",bold:1b},{text:"\n“那是太平洋上的公海，你作为美国人去逞什么英雄？”",color:"gray",bold: false}]

execute if score SEA_ch6_event rng5 matches 5042 as @p[tag=SEAPT] at @s run tellraw @a[distance=0..250] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“……我幻听了？”",color:"white"}]
...
execute if score SEA_ch6_event rng5 matches 5059 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“你也终于开始幻听了吗？这是正常现象。”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 5077 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“我现在能幻听到我母亲跟我说话。她让我快点逃走，辞职回家。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 5099 as @p[tag=SEAPT] at @s run tellraw @a[distance=0..250] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“是因为我们两个人其实都被细菌感染了吧。”",color:"white"}]
...
execute if score SEA_ch6_event rng5 matches 5110 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“我其实为你感到很不公平。我来这里调查的时候想必就是被政府当成了弃子。这对你来说根本是场无妄之灾。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 5130 as @p[tag=SEAPT] at @s run tellraw @a[distance=0..250] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“也不完全是如此……我是有选择性地来到了此处。”",color:"white"}]
execute if score SEA_ch6_event rng5 matches 5150 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"？？？：",color:"gray",bold:1b},{text:"\n“侦破了跨国人口贩卖案件，非常好。但是你不会升职也不会获得表彰。”",color:"gray",bold: false}]
execute if score SEA_ch6_event rng5 matches 5168 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"？？？：",color:"gray",bold:1b},{text:"\n“我们必须开除你，这是对你的保护。”",color:"gray",bold: false}]
execute if score SEA_ch6_event rng5 matches 5190 as @p[tag=SEAPT] at @s run tellraw @a[distance=0..250] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“又在幻听了……”",color:"white"}]
execute if score SEA_ch6_event rng5 matches 5203 as @p[tag=SEAPT] at @s run tellraw @a[distance=0..250] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“我的父母早就双双离世了，未婚妻也死于意外。但我不觉得这些都是巧合。”",color:"white"}]
execute if score SEA_ch6_event rng5 matches 5223 as @p[tag=SEAPT] at @s run tellraw @a[distance=0..250] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“这么多天，我每天都能梦到自己来到空无一人的忒尔克西。我认为我能在这里找到一些我寻求许久的事物。”",color:"white"}]
execute if score SEA_ch6_event rng5 matches 5245 as @p[tag=SEAPT] at @s run tellraw @a[distance=0..250] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“只是……在见到了这么多后，我确实也不清楚自己究竟是在找寻何物了。”",color:"white"}]
...
execute if score SEA_ch6_event rng5 matches 5265 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“你从一开始就没打算活下去，一直自暴自弃到今天，对吗？”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 5283 as @p[tag=SEAPT] at @s run tellraw @a[distance=0..250] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“没瞒过你呢。”",color:"white"}]
...
execute if score SEA_ch6_event rng5 matches 5299 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“我阅人无数，你那不要命的行为逻辑与你在这钻井平台救援至今的事实相结合，使你在我眼中也是异类。”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 5319 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“你只是质疑自己的生命而已。你并不认为其他人的生命也是毫无价值的。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 5339 as @p[tag=SEAPT] at @s run tellraw @a[distance=0..250] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“抱歉。但我确实……我最后谁都没能救到。不论是法莫洛斯医生、越涵、菲尔娜、玛瑞莲……”",color:"white"}]
execute if score SEA_ch6_event rng5 matches 5359 as @p[tag=SEAPT] at @s run tellraw @a[distance=0..250] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“我不想再目睹任何人死在我的眼前了。我多希望这么简单的一个愿望能够成真。”",color:"white"}]
...
execute if score SEA_ch6_event rng5 matches 5379 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“有时候，目睹死亡才会令一个人获得最巨大的力量。在这种情形下，这个道理残酷、无情，却也会无比真实。”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 6004 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“欢迎回来。哎，简直是一片废墟。”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 8003 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“看来我们必须继续往下了。这里的结构随时可能坍塌，再来一场余爆就能让我们喂鱼。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 8023 as @p[tag=SEAPT] at @s run tellraw @a[distance=0..250] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“冷凝系统的下面……是什么地方？我之前在底下探索时有见到一扇巨大的金属门，但它看着坚不可摧，我就完全没管。”",color:"white"}]
...
execute if score SEA_ch6_event rng5 matches 8042 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“下面吗？猜猜看。\n没错，这下面就是他们发现圣水晶的地方。”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 8060 as @n[tag=SEAedwina] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“也就是地底峡谷。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 8077 as @p[tag=SEAPT] at @s run tellraw @a[distance=0..250] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“发现圣水晶的地底峡谷，同时也是古代细菌的来源。我们……真的要去这么危险的地方吗？”",color:"white"}]
...
execute if score SEA_ch6_event rng5 matches 8095 as @n[tag=SEAedwina] at @s if entity @a[tag=SEAPT] run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“说实话，从一开始我就想把你带到这里来。这说不定算是一步必要程序。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 8095 as @n[tag=SEAedwina] at @s unless block 90151 133 -1857 minecraft:skeleton_skull run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“诺玛不知道还会从哪里追出来。她比我们更清楚这地方的构造……而且，她的神智依然很清晰。”",color:"white",bold: false}]
...
execute if score SEA_ch6_event rng5 matches 8112 as @n[tag=SEAedwina] at @s if block 90151 133 -1857 minecraft:skeleton_skull run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“你很快就会知道我为何这么说。在那之前，我们无需回头。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 8112 as @n[tag=SEAedwina] at @s unless block 90151 133 -1857 minecraft:skeleton_skull run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“我不清楚是什么让她变成了如此强大的尸变体，但不得不承认，她已经是特例了。”",color:"white",bold: false}]
execute if score SEA_ch6_event rng5 matches 8112 as @n[tag=SEAedwina] at @s run playsound entity.villager.ambient hostile @a ~ ~ ~ 1 1.3
...
execute if score SEA_ch6_event rng5 matches 8130 as @p[tag=SEAPT] at @s if block 90151 133 -1857 minecraft:skeleton_skull run tellraw @a[distance=0..250] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“虽然我不太清楚……但我也总有种感觉。说不定我正在寻找的东西就在那下面。”",color:"white"}]
execute if score SEA_ch6_event rng5 matches 8130 as @p[tag=SEAPT] at @s unless block 90151 133 -1857 minecraft:skeleton_skull run tellraw @a[distance=0..250] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“说的也有道理……没事，反正我们俩怕是这平台上最强的两个人类吧。”",color:"white"}]
execute if score SEA_ch6_event rng5 matches 8150 as @p[tag=SEAPT] at @s if block 90151 133 -1857 minecraft:skeleton_skull run tellraw @a[distance=0..250] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“我手中这把黄金之剑也在发光。它的光愈发强烈了……就好像在昭示着我正确的方向一样。”",color:"white"}]
execute if score SEA_ch6_event rng5 matches 8150 as @p[tag=SEAPT] at @s unless block 90151 133 -1857 minecraft:skeleton_skull run tellraw @a[distance=0..250] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold:1b},{text:"\n“放心，我会看好你的背后。既然是我们二人，那就不会有问题。”",color:"white"}]
