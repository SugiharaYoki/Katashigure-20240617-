...
#execute as @a[gamemode=adventure,tag=SEAPT,scores={rng1=1..}] at @s run tellraw @a [{"text":" 章鱼熟度 = ","color":"white","italic": false},{"score":{"name":"@s","objective":"rng1"},"color": "green","italic": true}]
