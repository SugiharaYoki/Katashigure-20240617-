...
execute if score SEA_ch6_event rng5 matches 9150..9390 positioned 90142 127 -1854 run particle trial_omen ~ ~1 ~ 0.3 0.5 0.3 0.5 8
execute if score SEA_ch6_event rng5 matches 9150..9390 positioned 90142 127 -1856 run particle trial_omen ~ ~1 ~ 0.3 0.5 0.3 0.5 8
...
execute if score SEA_ch6_event rng5 matches 9250..9253 positioned 90142 127 -1854 run function skyblock:sea/m/drowned
execute if score SEA_ch6_event rng5 matches 9250..9253 positioned 90142 127 -1856 run function skyblock:sea/m/drowned
execute if score SEA_ch6_event rng5 matches 9270..9272 positioned 90142 127 -1854 run function skyblock:sea/m/drowned_small
execute if score SEA_ch6_event rng5 matches 9270..9272 positioned 90142 127 -1856 run function skyblock:sea/m/drowned_small

execute if score SEA_ch6_event rng5 matches 9302 positioned 90142 127 -1854 run function skyblock:sea/m/silverfish_big
execute if score SEA_ch6_event rng5 matches 9308 positioned 90142 127 -1854 run function skyblock:sea/m/silverfish_big
execute if score SEA_ch6_event rng5 matches 9314 positioned 90142 127 -1854 run function skyblock:sea/m/silverfish_big
execute if score SEA_ch6_event rng5 matches 9304 positioned 90142 127 -1856 run function skyblock:sea/m/spider
execute if score SEA_ch6_event rng5 matches 9312 positioned 90142 127 -1856 run function skyblock:sea/m/spider
execute if score SEA_ch6_event rng5 matches 9319 positioned 90142 127 -1854 run function skyblock:sea/m/zombie_bomb

execute if score SEA_ch6_event rng5 matches 9340 positioned 90142 127 -1856 run function skyblock:sea/m/husk
execute if score SEA_ch6_event rng5 matches 9340 positioned 90142 127 -1854 run function skyblock:sea/m/husk
execute if score SEA_ch6_event rng5 matches 9347 positioned 90142 127 -1856 run function skyblock:sea/m/husk
execute if score SEA_ch6_event rng5 matches 9347 positioned 90142 127 -1854 run function skyblock:sea/m/husk
execute if score SEA_ch6_event rng5 matches 9349 positioned 90142 127 -1856 run function skyblock:sea/m/drowned_trident
execute if score SEA_ch6_event rng5 matches 9349 positioned 90142 127 -1854 run function skyblock:sea/m/drowned_trident
execute if score SEA_ch6_event rng5 matches 9350..9351 positioned 90142 127 -1856 run function skyblock:sea/m/skeleton_melee
execute if score SEA_ch6_event rng5 matches 9350..9351 positioned 90142 127 -1854 run function skyblock:sea/m/skeleton_melee
execute if score SEA_ch6_event rng5 matches 9355 positioned 90142 127 -1856 run function skyblock:sea/m/zombie_bomb

execute if score SEA_ch6_event rng5 matches 9390 positioned 90142 127 -1856 run function skyblock:sea/m/zombie_knight
execute if score SEA_ch6_event rng5 matches 9390 positioned 90142 127 -1854 run function skyblock:sea/m/zombie_knight
...
execute if score SEA_ch6_event rng5 matches 9320 run playsound minecraft:ambient.cave ambient @a 90130.00 129.32 -1854.50 30 0.8
execute if score SEA_ch6_event rng5 matches 9330..9410 run playsound minecraft:entity.minecart.inside ambient @a 90125 129 -1855 0.5 0.8

execute if score SEA_ch6_event rng5 matches 9340 run fill 90125 119 -1853 90125 119 -1857 air
execute if score SEA_ch6_event rng5 matches 9340 run playsound minecraft:block.iron_door.open block @a 90125 129 -1855 10 0.5
...
execute if score SEA_ch6_event rng5 matches 9360 run fill 90125 120 -1853 90125 120 -1857 air
execute if score SEA_ch6_event rng5 matches 9360 run playsound minecraft:block.iron_door.open block @a 90125 129 -1855 10 0.5
...
execute if score SEA_ch6_event rng5 matches 9380 run fill 90125 121 -1853 90125 121 -1857 air
execute if score SEA_ch6_event rng5 matches 9380 run playsound minecraft:block.iron_door.open block @a 90125 129 -1855 10 0.5
...
execute if score SEA_ch6_event rng5 matches 9400 run fill 90125 121 -1853 90125 121 -1857 air
...
execute if score SEA_ch6_event rng5 matches 9420 run fill 90125 121 -1853 90125 121 -1857 air
execute if score SEA_ch6_event rng5 matches 9420 run playsound minecraft:block.iron_door.open block @a 90125 129 -1855 10 0.5
