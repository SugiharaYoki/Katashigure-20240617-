...
execute if score SEA_ch6_event rng5 matches 12563.. positioned 90013 95 -1926 run tp @a[tag=SEAPT,x=90020,y=0,z=-1917,dx=100,dy=15,dz=300,gamemode=adventure] 90046 21 -1815
