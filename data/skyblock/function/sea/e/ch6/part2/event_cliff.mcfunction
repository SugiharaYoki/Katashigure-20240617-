...
execute if score SEA_ch6_event rng5 matches 12563.. positioned 90013 95 -1926 if score SEA_ch6_event rng5 matches 20001.. run kill @n[tag=SEAmob,x=90020,y=0,z=-1917,dx=100,dy=19,dz=300]
