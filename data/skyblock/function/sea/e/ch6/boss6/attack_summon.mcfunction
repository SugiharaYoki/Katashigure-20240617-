...
execute if score @s[scores={rng5=1}] rng4 matches 20 if block 90151 133 -1857 minecraft:skeleton_skull positioned ~-1 ~ ~2 unless block ~ ~-1 ~ air run summon marker ~ ~ ~ {Tags:["SEAboss6_summoner_a"]}
execute if score @s[scores={rng5=2}] rng4 matches 20 if block 90151 133 -1857 minecraft:skeleton_skull positioned ~1 ~ ~2 unless block ~ ~-1 ~ air run summon marker ~ ~ ~ {Tags:["SEAboss6_summoner_a"]}
execute if score @s[scores={rng5=3}] rng4 matches 20 if block 90151 133 -1857 minecraft:skeleton_skull positioned ~-2 ~ ~1 unless block ~ ~-1 ~ air run summon marker ~ ~ ~ {Tags:["SEAboss6_summoner_a"]}
execute if score @s[scores={rng5=4}] rng4 matches 20 if block 90151 133 -1857 minecraft:skeleton_skull positioned ~2 ~ ~1 unless block ~ ~-1 ~ air run summon marker ~ ~ ~ {Tags:["SEAboss6_summoner_a"]}
execute if score @s[scores={rng5=5}] rng4 matches 20 if block 90151 133 -1857 minecraft:skeleton_skull positioned ~-3 ~ ~ unless block ~ ~-1 ~ air run summon marker ~ ~ ~ {Tags:["SEAboss6_summoner_a"]}
execute if score @s[scores={rng5=6}] rng4 matches 20 if block 90151 133 -1857 minecraft:skeleton_skull positioned ~3 ~ ~ unless block ~ ~-1 ~ air run summon marker ~ ~ ~ {Tags:["SEAboss6_summoner_a"]}
execute if score @s[scores={rng5=7}] rng4 matches 20 if block 90151 133 -1857 minecraft:skeleton_skull positioned ~1.5 ~ ~-2 unless block ~ ~-1 ~ air run summon marker ~ ~ ~ {Tags:["SEAboss6_summoner_a"]}
execute if score @s[scores={rng5=8}] rng4 matches 20 if block 90151 133 -1857 minecraft:skeleton_skull positioned ~-1.5 ~ ~-2 unless block ~ ~-1 ~ air run summon marker ~ ~ ~ {Tags:["SEAboss6_summoner_a"]}

execute if score @s[scores={rng5=1}] rng4 matches 40 if block 90151 133 -1857 minecraft:skeleton_skull positioned ~-1 ~ ~2 unless block ~ ~-1 ~ air run summon marker ~ ~ ~ {Tags:["SEAboss6_summoner_a"]}
execute if score @s[scores={rng5=2}] rng4 matches 40 if block 90151 133 -1857 minecraft:skeleton_skull positioned ~1 ~ ~2 unless block ~ ~-1 ~ air run summon marker ~ ~ ~ {Tags:["SEAboss6_summoner_a"]}
execute if score @s[scores={rng5=3}] rng4 matches 40 if block 90151 133 -1857 minecraft:skeleton_skull positioned ~-2 ~ ~1 unless block ~ ~-1 ~ air run summon marker ~ ~ ~ {Tags:["SEAboss6_summoner_a"]}
execute if score @s[scores={rng5=4}] rng4 matches 40 if block 90151 133 -1857 minecraft:skeleton_skull positioned ~2 ~ ~1 unless block ~ ~-1 ~ air run summon marker ~ ~ ~ {Tags:["SEAboss6_summoner_a"]}
execute if score @s[scores={rng5=5}] rng4 matches 40 if block 90151 133 -1857 minecraft:skeleton_skull positioned ~-3 ~ ~ unless block ~ ~-1 ~ air run summon marker ~ ~ ~ {Tags:["SEAboss6_summoner_a"]}
execute if score @s[scores={rng5=6}] rng4 matches 40 if block 90151 133 -1857 minecraft:skeleton_skull positioned ~3 ~ ~ unless block ~ ~-1 ~ air run summon marker ~ ~ ~ {Tags:["SEAboss6_summoner_a"]}
execute if score @s[scores={rng5=7}] rng4 matches 40 if block 90151 133 -1857 minecraft:skeleton_skull positioned ~1.5 ~ ~-2 unless block ~ ~-1 ~ air run summon marker ~ ~ ~ {Tags:["SEAboss6_summoner_a"]}
execute if score @s[scores={rng5=8}] rng4 matches 40 if block 90151 133 -1857 minecraft:skeleton_skull positioned ~-1.5 ~ ~-2 unless block ~ ~-1 ~ air run summon marker ~ ~ ~ {Tags:["SEAboss6_summoner_a"]}
