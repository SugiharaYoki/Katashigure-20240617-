...
execute if score @s[scores={rng2=1}] rng1 matches 45 at @s if entity @a[tag=SEAedwina] as @a[scores={SEAPT_member=1},distance=0..1.8] at @s run tellraw @a[distance=0..150] [{"text":"艾德雯娜：","color":"green","bold": true},{"text":"\n“离你站的地方远一点！！”","color":"white","bold": false}]
execute if score @s[scores={rng2=2}] rng1 matches 45 at @s if entity @a[tag=SEAedwina] as @a[scores={SEAPT_member=1},distance=0..1.8] at @s run tellraw @a[distance=0..150] [{"text":"艾德雯娜：","color":"green","bold": true},{"text":"\n“小心脚底下！！”","color":"white","bold": false}]
