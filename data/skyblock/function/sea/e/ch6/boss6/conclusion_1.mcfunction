...
execute if score SEA_ch6_event sea_4temp4 matches 11782 as @p[tag=SEAPT] at @s run tellraw @a[distance=0..250] [{"text":"艾德雯娜：","color":"green","bold": true},{"text":"\n“我原本想要报答你，但无论如何都找不到你了，你的亲人也都已经去世。”","color":"white","bold": false}]
...
execute if score SEA_ch6_event sea_4temp4 matches 11867 as @p[tag=SEAPT] at @s run tellraw @a[distance=0..250] [{"text":"艾德雯娜：","color":"green","bold": true},{"text":"\n“加入中情局一半是为了调查当时跨国人口贩卖案的余党，另外就是尝试找到你。”","color":"white","bold": false}]
...
execute if score SEA_ch6_event sea_4temp4 matches 15949 as @a[tag=SEAPT] at @s run give @s mojang_banner_pattern[custom_data={sea_docg36:true}]
...
execute if score SEA_ch6_event sea_4temp4 matches 15949 run tellraw @a[tag=SEAPT,scores={sea_progress=..17}] [{"text":"永久奖励：","color":"green","bold": true},{"text": "已获得可用于多功能工作站的永久升级。\n防具第3起始点的升级会始终点亮最左两格。","color": "white"}]
execute if score SEA_ch6_event sea_4temp4 matches 15949 run tellraw @a[tag=SEAPT,scores={sea_progress=..17}] [{"text":"永久奖励：","color":"green","bold": true},{"text": "撬棍类武器的基础攻击力 +0.5","color": "white"}]
execute if score SEA_ch6_event sea_4temp4 matches 15949 run tellraw @a[tag=SEAPT,scores={sea_progress=..17}] [{"text":"永久奖励：","color":"green","bold": true},{"text": "消防斧类武器的基础攻击力 +1.0","color": "white"}]
execute if score SEA_ch6_event sea_4temp4 matches 15949 run tellraw @a[tag=SEAPT,scores={sea_progress=..17}] [{"text":"永久奖励：","color":"green","bold": true},{"text": "光棱箭的最大持有数量 +2","color": "white"}]
