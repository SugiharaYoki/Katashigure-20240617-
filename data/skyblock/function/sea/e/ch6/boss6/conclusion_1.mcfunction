...
execute if score SEA_ch6_event sea_4temp4 matches 15949 run tellraw @a[tag=SEAPT,scores={sea_progress=..17}] [{"text":"通关奖励：","color":"green","bold": true},{"text": "已获得可用于多功能工作站的永久升级。\n第3起始点的升级会始终点亮最左两格。","color": "white"}]
execute if score SEA_ch6_event sea_4temp4 matches 15949 run tellraw @a[tag=SEAPT,scores={sea_progress=..17}] [{"text":"通关奖励：","color":"green","bold": true},{"text": "撬棍类武器的基础攻击力 +0.5","color": "white"}]
execute if score SEA_ch6_event sea_4temp4 matches 15949 run tellraw @a[tag=SEAPT,scores={sea_progress=..17}] [{"text":"通关奖励：","color":"green","bold": true},{"text": "消防斧类武器的基础攻击力 +1.0","color": "white"}]
execute if score SEA_ch6_event sea_4temp4 matches 15949 run tellraw @a[tag=SEAPT,scores={sea_progress=..17}] [{"text":"通关奖励：","color":"green","bold": true},{"text": "光棱箭的最大持有数量 +2","color": "white"}]
