...
execute if score @s rng4 matches 50.. at @s if score @s[scores={rng9=1..3}] rng7 matches 15.. as @n[tag=SEA_boss6_burst_master] at @s run scoreboard players add @s rng1 1
execute if score @s rng4 matches 50.. at @s if score @s[scores={rng9=1..3}] rng7 matches 15.. at @n[tag=SEA_boss6_burst_master,scores={rng1=2}] positioned ~ ~ ~-1 run summon marker ~ 21.0 ~ {Tags:["SEA_boss6_burst_anchor"]}
execute if score @s rng4 matches 50.. at @s if score @s[scores={rng9=1..3}] rng7 matches 15.. at @n[tag=SEA_boss6_burst_master,scores={rng1=2}] positioned ~ ~ ~00 run summon marker ~ 21.0 ~ {Tags:["SEA_boss6_burst_anchor"]}
execute if score @s rng4 matches 50.. at @s if score @s[scores={rng9=1..3}] rng7 matches 15.. at @n[tag=SEA_boss6_burst_master,scores={rng1=2}] positioned ~ ~ ~01 run summon marker ~ 21.0 ~ {Tags:["SEA_boss6_burst_anchor"]}

execute if score @s rng4 matches 50.. at @s if score @s[scores={rng9=1..3}] rng7 matches 15.. as @n[tag=SEA_boss6_burst_master,scores={rng1=1}] at @s run tp @s ^ ^ ^1.5 facing ^ ^ ^2

execute if score @s rng4 matches 50.. at @s if score @s[scores={rng9=1..3}] rng7 matches 15.. as @n[tag=SEA_boss6_burst_master,scores={rng1=2..}] at @s run scoreboard players set @s rng1 0
execute if score @s rng4 matches 50.. at @s if score @s[scores={rng9=1..3}] rng7 matches 40.. as @n[tag=SEA_boss6_burst_master] at @s run kill @s
execute if score @s rng4 matches 50.. at @s if score @s[scores={rng9=1..3}] rng7 matches 40.. run scoreboard players set @s rng7 0
