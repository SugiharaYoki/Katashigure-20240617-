...
execute if score @s[scores={rng5=1},tag=SEAboss6] rng4 matches 62 at @s as @a[scores={SEAPT_member=1}] at @s run tellraw @a[distance=0..150] [{text:"权之执理：",color:"red",bold:1b},{text:"\n“神之怒火，从天降下。”",color:"white",bold: false}]
execute if score @s[scores={rng5=2},tag=SEAboss6] rng4 matches 62 at @s as @a[scores={SEAPT_member=1}] at @s run tellraw @a[distance=0..150] [{text:"权之执理：",color:"red",bold:1b},{text:"\n“汝应当看准点。”",color:"white",bold: false}]
execute if score @s[scores={rng5=3},tag=SEAboss6] rng4 matches 62 at @s as @a[scores={SEAPT_member=1}] at @s run tellraw @a[distance=0..150] [{text:"权之执理：",color:"red",bold:1b},{text:"\n“卑微的人类，汝将被吾碾碎。”",color:"white",bold: false}]
execute if score @s[scores={rng5=4},tag=SEAboss6] rng4 matches 67 at @s as @a[scores={SEAPT_member=1}] at @s run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“小心，它要从上面撞下来！”",color:"white",bold: false}]
...
execute if score @s rng4 matches 330.. run scoreboard players set @s rng4 0