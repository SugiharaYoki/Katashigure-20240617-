...
execute if score @s rng4 matches 1 run say 1
execute if score @s rng4 matches 42 run say 2
execute if score @s rng4 matches 44 run say 3
execute if score @s rng4 matches 45 run say 4
