...
execute if score @s rng4 matches 10 positioned 90059 20 -1825 run tellraw @a[distance=0..150] [{text:"权之执理：",color:"red",bold:1b},{text:"\n“很好，汝有同吾对战的资格。”",color:"white",bold: false}]
...
execute if score @s rng4 matches 70 positioned 90059 20 -1825 if entity @a[tag=SEAPT,distance=0..5.5] run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“快远离那块平台！！”",color:"white",bold: false}]
execute if score @s rng4 matches 70 positioned 90059 20 -1825 unless entity @a[tag=SEAPT,distance=0..5.5] run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“祂这是要……将平台砸毁？！”",color:"white",bold: false}]
...
execute if score @s rng4 matches 60 as @a[scores={SEAPT_member=1}] at @s if block 90151 133 -1857 minecraft:skeleton_skull run tellraw @a[distance=0..150] [{text:"权之执理：",color:"red",bold:1b},{text:"\n“很好，汝现今的力量确实很强大，但到此为止了！！”",color:"white",bold: false}]
