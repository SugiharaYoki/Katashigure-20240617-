...
execute if score SEA_ch6_event sea_4temp4 matches ..2200 if entity @a[tag=SEAPT,x=90381,y=228,z=-1794,dx=30,dy=20,dz=30] run scoreboard players set SEA_ch6_event sea_4temp4 2201
...
execute if score SEA_ch6_event sea_4temp4 matches ..2400 if entity @a[tag=SEAPT,x=90381,y=228,z=-1784,dx=30,dy=20,dz=30] run scoreboard players set SEA_ch6_event sea_4temp4 2401
...
execute if score SEA_ch6_event sea_4temp4 matches ..2600 if entity @a[tag=SEAPT,x=90381,y=228,z=-1774,dx=30,dy=20,dz=30] run scoreboard players set SEA_ch6_event sea_4temp4 2601
