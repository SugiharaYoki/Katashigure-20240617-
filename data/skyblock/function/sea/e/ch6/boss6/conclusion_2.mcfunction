...
execute if score SEA_ch6_event sea_4temp4 matches 8501..9999 as @p[tag=SEAPT] at @s unless entity @n[tag=SEAboss6c] run particle white_ash ~ ~5 ~ 10 5 10 0 50
execute if score SEA_ch6_event sea_4temp4 matches 8501..9999 as @p[tag=SEAPT] at @s unless entity @n[tag=SEAboss6c] run particle cherry_leaves ~ ~5 ~ 10 5 10 0 20
