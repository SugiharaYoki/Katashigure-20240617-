...
execute if score SEA_ch6_event sea_4temp4 matches 3996 as @n[tag=SEAboss6c] at @s run tp @s 90214 131 -2182
execute if score SEA_ch6_event sea_4temp4 matches 3996 as @p[tag=SEAPT] at @s run tp @s 90216 131 -2182
execute if score SEA_ch6_event sea_4temp4 matches 3996 as @n[tag=SEAboss6c] at @s run effect give @s levitation 3 50 true
execute if score SEA_ch6_event sea_4temp4 matches 3996 as @p[tag=SEAPT] at @s run effect give @s levitation 3 50 true
