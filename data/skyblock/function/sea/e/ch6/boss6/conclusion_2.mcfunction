...
execute if score SEA_ch6_event sea_4temp4 matches 3896..3906 as @a[tag=SEAPT] at @s run playsound item.elytra.flying player @s ~ ~ ~ 1 0.7
execute if score SEA_ch6_event sea_4temp4 matches 3906..3906 as @a[tag=SEAPT] at @s run playsound item.elytra.flying player @s ~ ~ ~ 1 0.9
