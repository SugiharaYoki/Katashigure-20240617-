...
execute if score @s rng1 matches 4 run particle flash ~0 ~3 ~0 0 0 0 0 1
execute if score @s rng1 matches 5 run particle flash ~0 ~5 ~0 0 0 0 0 1
execute if score @s rng1 matches 6 run particle flash ~0 ~7 ~0 0 0 0 0 1
execute if score @s rng1 matches 7 run particle flash ~0 ~9 ~0 0 0 0 0 1
execute if score @s rng1 matches 8 run particle flash ~0 ~11 ~0 0 0 0 0 1
