...
execute if score @s rng4 matches 8.. run particle minecraft:trial_spawner_detection_ominous ~ ~ ~ 1 0 1 0 20
execute if score @s rng4 matches 12.. run particle minecraft:trial_spawner_detection_ominous ~ ~ ~ 1 0 1 0 40
execute if score @s rng4 matches 12.. run particle minecraft:trial_spawner_detection_ominous ~ ~ ~ 1 0 1 0 60
