...
execute if score @s rng4 matches 70 positioned 90059 20 -1805 if entity @a[tag=SEAPT,distance=0..5.5] run tellraw @a[distance=0..150] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“离远点，祂又要毁掉平台了！！”",color:"white",bold: false}]
