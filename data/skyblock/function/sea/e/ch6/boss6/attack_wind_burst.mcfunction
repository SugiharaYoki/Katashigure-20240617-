...
execute if score @s rng4 matches 88 run particle minecraft:gust ~ ~4.5 ~ 3 1 3 0 10
execute if score @s rng4 matches 82 run playsound entity.wind_charge.wind_burst hostile @a ~ ~ ~ 3 0.8
execute if score @s rng4 matches 84 run playsound entity.wind_charge.wind_burst hostile @a ~ ~ ~ 3 0.8
execute if score @s rng4 matches 86 run playsound entity.wind_charge.wind_burst hostile @a ~ ~ ~ 3 0.8
