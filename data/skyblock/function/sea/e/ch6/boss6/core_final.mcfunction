...
execute if score SEAmusic rng1 matches 3920.. as @p[tag=SEAPT] at @s as @a[distance=0..250] at @s if entity @n[tag=SEAboss6c,scores={health=250..}] run stopsound @s music minecraft:salvation2
execute if score SEAmusic rng1 matches 3920.. if entity @n[tag=SEAboss6c,scores={health=250..}] run scoreboard players set SEAmusic rng1 2109
execute if score SEAmusic rng1 matches 3920.. if entity @n[tag=SEAboss6c,scores={health=..249}] run scoreboard players set SEAmusic rng1 2109
