...
execute if score SEA_ch6_event rng8 matches 120 run effect give @a[tag=SEAPT] darkness 240 0 true
execute if score SEA_ch6_event rng8 matches 240 run clear @a[tag=SEAPT]
execute if score SEA_ch6_event rng8 matches 240 as @a[tag=SEAPT] run function skyblock:sea/dead
