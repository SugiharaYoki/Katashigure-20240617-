...
execute if entity @a[tag=SEAPT,distance=..6] as @s[x=90161,y=128,z=112,distance=..4,scores={sea_4temp1=69}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250,tag=e_i_28,tag=!e_i_27] {"text":"越涵：“他们还好吗？等等，这里太危险了，我们下去说。”","color":"green"}
execute if entity @a[tag=SEAPT,distance=..6] as @s[x=90161,y=128,z=112,distance=..4,scores={sea_4temp1=69}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250,tag=e_i_28,tag=e_i_27] {"text":"越涵：“电梯门已经开了，跟我来吧。”","color":"green"}
execute if entity @a[tag=SEAPT,distance=..6] as @s[x=90161,y=128,z=112,distance=4..,scores={sea_4temp1=69}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250,tag=!e_i_28,tag=!e_i_27] {"text":"越涵：“我是维修部门的越涵。上头太危险了，但既然你都跳下来了……哎老哥，以后能不能别做这种事？”","color":"green"}
execute if entity @a[tag=SEAPT,distance=..6] as @s[x=90161,y=128,z=112,distance=4..,scores={sea_4temp1=69}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250,tag=e_i_28,tag=!e_i_27] {"text":"越涵：“他们还好吗？还有……你他妈还好吗？得亏你没摔死。”","color":"green"}
execute if entity @a[tag=SEAPT,distance=..6] as @s[x=90161,y=128,z=112,distance=4..,scores={sea_4temp1=69}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250,tag=e_i_28,tag=e_i_27] {"text":"越涵：“不，我还得说一句：你是傻逼吗，还嫌自己死的不够快？”","color":"green"}
...
execute if entity @a[tag=SEAPT,distance=..6] as @s[scores={sea_4temp1=85}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250,tag=!e_i_28,tag=!e_i_27] {"text":"越涵：“哎先听我说，你是从宿舍楼那儿过来的吧？你有见到过斯顿吗？”","color":"green"}
...
execute if entity @a[tag=SEAPT,distance=..6] as @s[scores={sea_4temp1=145}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250,tag=!e_i_27] {"text":"越涵：“不、不对，他不可能有这么蠢的，一定有什么搞错了……”","color":"green"}
execute if entity @a[tag=SEAPT,distance=..6] as @s[scores={sea_4temp1=145}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250,tag=e_i_28,tag=e_i_27] {"text":"越涵：“不想走？我无所谓，但可能会错过更多的幸存者。你确定吗？”","color":"green"}
...
execute if entity @a[tag=SEAPT,distance=..6] as @s[scores={sea_4temp1=174}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250,tag=!e_i_27] {"text":"越涵：“对对、对不起……我失态了。抱歉，我需要点时间消化一下。……”","color":"green"}
...
execute if entity @a[tag=SEAPT,distance=..6] as @s[scores={sea_4temp1=199}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250,tag=!e_i_27] {"text":"越涵：“……总之、先……嗯、先走吧。我就跟在你后面。”","color":"green"}
...
execute if entity @a[tag=SEAPT,distance=..6] as @s[scores={sea_4temp1=259}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250,tag=!e_i_27] {"text":"越涵：“他、怎么会这样……”","color":"green"}
...
execute if entity @a[tag=SEAPT,distance=..6] as @s[scores={sea_4temp1=329}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] {"text":"越涵：“说真的，没人能想到咱们这里能遇到这么离谱的事情。”","color":"green"}
...
execute if entity @a[tag=SEAPT,distance=..6] as @s[scores={sea_4temp1=400}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] {"text":"越涵：“老哥，你在这里搜救多久了？”","color":"green"}
execute if entity @a[tag=SEAPT,distance=..6] as @s[scores={sea_4temp1=400}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250] {"text":"越涵：“老哥，你们在这里搜救多久了？”","color":"green"}
...
execute if entity @a[tag=SEAPT,distance=..6] as @s[scores={sea_4temp1=429}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] {"text":"越涵：“我靠，杀穿维修层和物资层，当代战神啊。”","color":"green"}
...
execute if entity @a[tag=SEAPT,distance=..6] as @s[scores={sea_4temp1=639}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] {"text":"越涵：“再不走黄花菜都凉喽。”","color":"green"}
...
execute if entity @a[tag=SEAPT,distance=..6] as @s[scores={sea_4temp1=819}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] {"text":"越涵：“你见过艾德雯娜了吗？她好像也在平台上行动，但我没有联系到她的方式。”","color":"green"}
...
execute if entity @a[tag=SEAPT,distance=..6] as @s[scores={sea_4temp1=889}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] {"text":"越涵：“对啊，艾德雯娜不知道还活没活着……她身手了得，应该不会有太大问题。”","color":"green"}
...
execute if entity @a[tag=SEAPT,distance=..6] as @s[scores={sea_4temp1=1039}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] {"text":"越涵：“吃个苹果？”","color":"green"}
...
execute if entity @a[tag=SEAPT,distance=..6] as @s[scores={sea_4temp1=1239}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] {"text":"越涵：“还是快点出发吧。我们没多少时间。”","color":"green"}
...
#修复了时间轴
execute if entity @a[tag=SEAPT,distance=..6] as @s[tag=SEA_ch4elevator_end,scores={sea_4temp1=1310}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] {"text":"越涵：“坏事了，这底下居然没有升降开关。”","color":"green"}
...
execute if entity @a[tag=SEAPT,distance=..6] as @s[tag=SEA_ch4elevator_end,scores={sea_4temp1=1340}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] {"text":"越涵：“我就说他们怎么可能会留个这么方便的水下通道。妈的，果然中计了……”","color":"green"}
...
execute if entity @a[tag=SEAPT,distance=..6] as @s[tag=SEA_ch4elevator_end,scores={sea_4temp1=1375}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] {"text":"越涵：“但他们一定想不到你就一个人也能杀穿这座平台，干脆来个将计就计。反正本来就做好死在这儿的准备了。”","color":"green"}
execute if entity @a[tag=SEAPT,distance=..6] as @s[tag=SEA_ch4elevator_end,scores={sea_4temp1=1375}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250] {"text":"越涵：“但他们一定想不到你们的实力如此强大，干脆来个将计就计。反正本来就做好死在这儿的准备了。”","color":"green"}
