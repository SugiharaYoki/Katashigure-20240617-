...
execute as @s[scores={rng5=155}] as @p[tag=SEAPT,scores={SEAPT_member=1}] at @s run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“我叫","color":"white"},{"selector":"@s","color":"white"},{"text":"，不是‘维修工’。”","color":"white"}]
execute as @s[scores={rng5=163}] as @p[tag=SEAPT,scores={SEAPT_member=2}] at @s run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“嗯，这里是","color":"white"},{"selector":"@s","color":"white"},{"text":"！现在被你打得浑身疼。”","color":"white"}]
execute as @s[scores={rng5=180}] as @p[tag=SEAPT,scores={SEAPT_member=3}] at @s run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“懒得自我介绍，让我歇一会儿。”","color":"white"}]
...
execute as @s[scores={rng5=240}] if entity @n[tag=sc,scores={sea_player=1}] as @p[tag=SEAPT,scores={SEAPT_member=1}] at @s run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“那我还真的谢谢你啊。”","color":"white"}]
execute as @s[scores={rng5=240}] if entity @n[tag=sc,scores={sea_player=2..}] as @p[tag=SEAPT,scores={SEAPT_member=1}] at @s run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“那我们还真的谢谢你啊。”","color":"white"}]
...
execute if score @s rng6 matches 1222 unless entity @p[tag=SEAPT,scores={SEAPT_member=2..}] at @s run tellraw @a[distance=0..250] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=1}]","color":"aqua"},{"text":"：\n“没什么问题。越涵的话……”","color":"white"}]
execute if score @s rng6 matches 1222 if entity @p[tag=SEAPT,scores={SEAPT_member=2..}] at @s run tellraw @a[distance=0..250] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=1}]","color":"aqua"},{"text":"：\n“还是我去吧、……”","color":"white"}]
