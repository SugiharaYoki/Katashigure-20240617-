...
execute as @s[scores={rng8=3},tag=SEAboss4_attack_dash] at @s run rotate @s facing entity @p[tag=SEAPT]
...
execute as @s[scores={rng8=14},tag=SEAboss4_attack_dash] at @s run rotate @s facing entity @p[tag=SEAPT]
...
execute as @s[scores={rng8=25},tag=SEAboss4_attack_dash] at @s run rotate @s facing entity @p[tag=SEAPT]
