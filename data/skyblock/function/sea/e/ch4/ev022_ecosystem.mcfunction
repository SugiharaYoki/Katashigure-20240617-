...
execute as @s[scores={sea_4temp1=15}] if block 90236 63 85 air as @p[tag=SEAPT] at @s run tellraw @a[distance=..150] [{"text":"陌生的女声：","color":"yellow","bold": true},{"text":"\n“你真的不吸取教训。”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=15}] if block 90236 63 85 grindstone as @p[tag=SEAPT] at @s run tellraw @a[distance=..150] [{"text":"艾德雯娜：","color":"green","bold": true},{"text":"\n“我刚刚小酣的时候做了一场梦，该说的我已经在梦里说了。”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=33}] as @p[tag=SEAPT] at @s run tellraw @a[distance=..150] [{"text":"陌生的女声：","color":"yellow","bold": true},{"text":"\n“该不该说我很佩服你呢？居然能活着闯过整个水下研究设施。”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=46}] as @p[tag=SEAPT] at @s run tellraw @a[distance=..150] [{"text":"陌生的女声：","color":"yellow","bold": true},{"text":"\n“我想我用言语是劝不住你了。接下来，我会用武器来阻止你。”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=70}] if block 90236 63 85 air as @p[tag=SEAPT] at @s run tellraw @a[distance=..150] [{"text":"陌生的女声：","color":"yellow","bold": true},{"text":"\n“劝你好自为之。没多少时间留给你慢慢思考了。”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=70}] if block 90236 63 85 grindstone as @p[tag=SEAPT] at @s run tellraw @a[distance=..150] [{"text":"艾德雯娜：","color":"green","bold": true},{"text":"\n“我这人向来不喜欢把话说两遍，所以没必要废话了。”","color":"white","bold": false}]
