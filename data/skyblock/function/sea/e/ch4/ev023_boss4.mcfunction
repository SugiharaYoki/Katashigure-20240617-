...
execute as @s[scores={rng1=5}] if score SEA_ch4_event_railbox rng9 matches ..159 if entity @n[tag=sc,scores={sea_player=1}] at @n[tag=SEAedwina] run tellraw @a[distance=0..250] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“沈越涵……？我的天，所以你是他们信得过的人。”",color:"white",bold: false}]
execute as @s[scores={rng1=5}] if score SEA_ch4_event_railbox rng9 matches ..159 if entity @n[tag=sc,scores={sea_player=2}] at @n[tag=SEAedwina] run tellraw @a[distance=0..250] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“沈越涵……？我的天，所以你俩是他们信得过的人。”",color:"white",bold: false}]
execute as @s[scores={rng1=5}] if score SEA_ch4_event_railbox rng9 matches ..159 if entity @n[tag=sc,scores={sea_player=3..}] at @n[tag=SEAedwina] run tellraw @a[distance=0..250] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“沈越涵……？我的天，所以你们几个是他们信得过的人。我还以为是暴民派下来的小队。”",color:"white",bold: false}]
execute as @s[scores={rng1=5}] if score SEA_ch4_event_railbox rng9 matches 160.. if entity @n[tag=sc,scores={sea_player=1..}] at @n[tag=SEAedwina] run tellraw @a[distance=0..250] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“沈越涵……？我的天，你刚刚是在说实话？！”",color:"white",bold: false}]
...
execute as @s[scores={rng1=100}] at @n[tag=SEAedwina] if entity @n[tag=sc,scores={sea_player=1}] unless items entity @a[tag=SEAPT] container.* bread run tellraw @a[distance=0..250] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“嗯，想必也是如此……抱歉。我们先去找越涵吧。”",color:"white",bold: false}]
execute as @s[scores={rng1=100}] at @n[tag=SEAedwina] if entity @n[tag=sc,scores={sea_player=2..}] unless items entity @a[tag=SEAPT] container.* bread run tellraw @a[distance=0..250] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“嗯，想必也是如此……抱歉。我们先去找越涵吧。”",color:"white",bold: false}]
execute as @s[scores={rng1=100}] at @n[tag=SEAedwina] if entity @n[tag=sc,scores={sea_player=1}] if items entity @a[tag=SEAPT] container.* bread run tellraw @a[distance=0..250] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“待会……分我一块吧，不过先过一会儿。来吧，我们去跟越涵解释一下。”",color:"white",bold: false}]
execute as @s[scores={rng1=100}] at @n[tag=SEAedwina] if entity @n[tag=sc,scores={sea_player=2..}] if items entity @a[tag=SEAPT] container.* bread run tellraw @a[distance=0..250] [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“也是，你没有义务给我。都来吧，我们去跟越涵解释一下。”",color:"white",bold: false}]
