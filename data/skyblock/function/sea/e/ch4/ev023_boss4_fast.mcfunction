...
execute as @n[tag=SEAboss4,scores={rng2=4},tag=!SEAboss4_phase2] as @a[tag=SEAPT] unless entity @s[tag=!e_w_02,tag=!e_w_03,tag=!e_w_04,tag=!e_w_05,tag=!e_w_06] run tellraw @s [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“真不赖，可惜偷偷告诉你，你手上的装备，我也全都有。”",color:"white",bold: false}]
execute as @n[tag=SEAboss4,scores={rng2=4},tag=!SEAboss4_phase2] as @a[tag=SEAPT] if entity @s[tag=!e_w_02,tag=!e_w_03,tag=!e_w_04,tag=!e_w_05,tag=!e_w_06] run tellraw @s [{text:"艾德雯娜：",color:"green",bold:1b},{text:"\n“真不赖，可惜你还太嫩了，甚至连一把趁手的武器都没有。”",color:"white",bold: false}]
