...
execute if block 90081 110 112 minecraft:acacia_pressure_plate[powered=true] if block 90082 111 111 air run function skyblock:sea/e/mul/the_path_from_ch1_to_ch2_p
