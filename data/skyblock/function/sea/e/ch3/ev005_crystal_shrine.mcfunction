...
execute as @s[scores={sea_4temp1=39}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] [{text:"？？？：",color:"yellow",bold:1b},{text:"\n“调查员……？他们那群傻逼居然还真的知道该派人来，但我操，就派一个人？我去他妈的，纯他妈傻逼。”",color:"white",bold: false}]
execute as @s[scores={sea_4temp1=39}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250] [{text:"？？？：",color:"yellow",bold:1b},{text:"\n“调查小组……？他们那群傻逼居然还真的知道该派人来，但不派海警派维修工？我日，脑子里进屎了吗？”",color:"white",bold: false}]
...
execute as @s[scores={sea_4temp1=238}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] [{text:"越涵：",color:"green",bold:1b},{text:"\n“你能帮我找找他吗？对、我知道我还活着，你别一脸如释重负的表情了……”",color:"white",bold: false}]
execute as @s[scores={sea_4temp1=238}] at @s if entity @n[tag=sc,scores={sea_player=2}] run tellraw @a[distance=0..250] [{text:"越涵：",color:"green",bold:1b},{text:"\n“你俩能帮我找找他吗？对、我知道我还活着，你别一脸如释重负的表情了……”",color:"white",bold: false}]
execute as @s[scores={sea_4temp1=238}] at @s if entity @n[tag=sc,scores={sea_player=3..}] run tellraw @a[distance=0..250] [{text:"越涵：",color:"green",bold:1b},{text:"\n“你们几位能帮我找找他吗？对、我知道我还活着，你别一脸如释重负的表情了……”",color:"white",bold: false}]
...
execute as @s[scores={sea_4temp1=291}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] [{text:"越涵：",color:"green",bold:1b},{text:"\n“我这儿有点绿宝石，你拿去买多功能工作站里的玩意。我塞进去的肉估计都变质了，你最好别吃。”",color:"white",bold: false}]
execute as @s[scores={sea_4temp1=291}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250] [{text:"越涵：",color:"green",bold:1b},{text:"\n“我这儿有点绿宝石，你拿去买多功能工作站里的玩意。我塞进去的肉估计都变质了，你最好叫你的同事们都别吃。”",color:"white",bold: false}]
...
execute as @s[scores={sea_4temp1=402}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] [{text:"越涵：",color:"green",bold:1b},{text:"\n“哎，你找到斯顿了吗？”",color:"white",bold: false}]
execute as @s[scores={sea_4temp1=402}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250] [{text:"越涵：",color:"green",bold:1b},{text:"\n“哎，你们找到斯顿了吗？”",color:"white",bold: false}]
execute as @s[scores={sea_4temp1=435}] at @s run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85
execute as @s[scores={sea_4temp1=435}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] [{text:"越涵：",color:"green",bold:1b},{text:"\n“什……你说他、……什么？”",color:"white",bold: false}]
execute as @s[scores={sea_4temp1=435}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250] [{text:"越涵：",color:"green",bold:1b},{text:"\n“什……你们说他、……什么？”",color:"white",bold: false}]
...
execute as @s[scores={sea_4temp1=1402}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] [{text:"越涵：",color:"green",bold:1b},{text:"\n“啊、什么，你说你已经找到斯顿了？”",color:"white",bold: false}]
execute as @s[scores={sea_4temp1=1402}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250] [{text:"越涵：",color:"green",bold:1b},{text:"\n“啊、什么，你们说已经找到斯顿了？”",color:"white",bold: false}]
execute as @s[scores={sea_4temp1=1435}] at @s run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85
execute as @s[scores={sea_4temp1=1435}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] [{text:"越涵：",color:"green",bold:1b},{text:"\n“早点告诉我呢，他还好吗？……什、你说……他已经、他……死了？”",color:"white",bold: false}]
execute as @s[scores={sea_4temp1=1435}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250] [{text:"越涵：",color:"green",bold:1b},{text:"\n“早点告诉我呢，他还好吗？……什、你们说……他已经、他……死了？”",color:"white",bold: false}]
