...
execute if entity @n[tag=SEAbossch3_core,scores={sea_4temp4=80}] unless entity @n[tag=SEAbossch3_light_keep] run tellraw @a[x=90100,y=100,z=100,distance=0..1000] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“下面怎么回事？！我听到一堆怪物的声音？”","color":"white","bold": false}]
execute if entity @n[tag=SEAbossch3_core,scores={sea_4temp4=110}] unless entity @n[tag=SEAbossch3_light_keep] run tellraw @a[x=90100,y=100,z=100,distance=0..1000] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“我操老哥你等等我，我想想办法！”","color":"white","bold": false}]
execute if entity @n[tag=SEAbossch3_core,scores={sea_4temp4=240}] unless entity @n[tag=SEAbossch3_light_keep] run tellraw @a[x=90100,y=100,z=100,distance=0..1000] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“老哥，底下应该有七盏感应灯，你试着去同时把它们都给开了！”","color":"white","bold": false}]
execute if entity @n[tag=SEAbossch3_core,scores={sea_4temp4=270}] unless entity @n[tag=SEAbossch3_light_keep] run tellraw @a[x=90100,y=100,z=100,distance=0..1000] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“这灯泡好像只能坚持十几秒，必须保证要快！”","color":"white","bold": false}]


execute if entity @n[tag=SEAbossch3_core,scores={sea_4temp4=450}] unless entity @n[tag=SEAbossch3_light_keep] if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[x=90100,y=100,z=100,distance=0..1000] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“我从墙里刨出电路了！我帮你守着一盏灯，你去搞其它的！”","color":"white","bold": false}]
execute if entity @n[tag=SEAbossch3_core,scores={sea_4temp4=450}] unless entity @n[tag=SEAbossch3_light_keep] if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[x=90100,y=100,z=100,distance=0..1000] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“我从墙里刨出电路了！我帮你们守着一盏灯，你们去搞其它的！”","color":"white","bold": false}]
...
execute if entity @n[tag=SEAbossch3_core,scores={sea_4temp4=570}] unless entity @n[tag=SEAbossch3_light_keep] if entity @n[tag=sc,scores={sea_player=1}] if entity @a[tag=e_i_27] run tellraw @a[x=90100,y=100,z=100,distance=0..1000] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“操！我已经失去了斯顿，我不要连你也失去了！！他妈的，你给我活下来！！”","color":"white","bold": false}]
execute if entity @n[tag=SEAbossch3_core,scores={sea_4temp4=570}] unless entity @n[tag=SEAbossch3_light_keep] if entity @n[tag=sc,scores={sea_player=2..}] if entity @a[tag=e_i_27] run tellraw @a[x=90100,y=100,z=100,distance=0..1000] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“操！我已经失去了斯顿，我不要连你们也失去了！！他妈的，你们给我活下来！！”","color":"white","bold": false}]
...
#execute as @n[tag=SEAbossch3_core,tag=SEAbossch3_core_lighted,scores={sea_4temp7=80}] as @a[tag=SEAPT] at @s run playsound minecraft:app1.speirapyrgos music @a[tag=SEAPT] ~ ~ ~ 1 1
