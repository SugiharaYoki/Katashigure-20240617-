...
execute as @s[tag=sc,scores={sea_4temp2=206}] positioned 90133 137 108 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=2..3}] \
 run tellraw @a[distance=0..50] [{"selector":"@s","color":"white"},{"text":"：底下的门是锁的，我们该如何到达对面？\n虽然我们人比较少，但强行突破听上去行得通吗？","color":"white"}]
execute as @s[tag=sc,scores={sea_4temp2=206}] positioned 90133 137 108 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=4..}] \
 run tellraw @a[distance=0..50] [{"selector":"@s","color":"white"},{"text":"：底下的门是锁的，我们该如何到达对面？\n我们人多，强行突破可行吗？","color":"white"}]

execute as @s[tag=sc,scores={sea_4temp2=226}] positioned 90133 137 108 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..3}] \
 run tellraw @a[distance=0..50] [{"text":"玛瑞莲：","color":"dark_purple","bold": true},{"text":"\n“宿舍楼有一支幸存的小队，我与他们失联已经超过两小时，但他们有地下通道的钥匙。\n相信我，您不会想走大路。”","color":"white","bold": false}]
execute as @s[tag=sc,scores={sea_4temp2=226}] positioned 90133 137 108 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=4..}] \
 run tellraw @a[distance=0..50] [{"text":"玛瑞莲：","color":"dark_purple","bold": true},{"text":"\n“宿舍楼有一支幸存的小队，我与他们失联已经超过两小时，但他们有地下通道的钥匙。\n相信我，您不会想走大路，人再多也只会白白送命。”","color":"white","bold": false}]


execute as @s[tag=sc,scores={sea_4temp2=227}] positioned 90133 137 108 run tellraw @a[distance=0..50,tag=SEAPT] [{"text":"   - "},{"text":"询问：找到幸存者的希望有多大？  ","color":"white"},{"text":"〈◆〉","bold":true,"color":"yellow","clickEvent":{"action":"run_command","value":"/trigger sea_crafter set 90002"}}]

execute as @s[tag=sc,scores={sea_4temp2=247}] run scoreboard players set SEA_ch5_event_engineering_fiona sea_4temp2 341

execute as @s[tag=sc,scores={sea_4temp2=249}] positioned 90133 137 108 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] \
 run tellraw @a[distance=0..50] [{"selector":"@s","color":"white"},{"text":"：真的……会有幸存者吗？","color":"white"}]

execute as @s[tag=sc,scores={sea_4temp2=266}] positioned 90133 137 108 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1}] \
 run tellraw @a[distance=0..50] [{"text":"玛瑞莲：","color":"dark_purple","bold": true},{"text":"\n“不瞒你讲，希望确实很渺茫。\n但再怎么说，虽然钻井平台上绝大多数火器都失效了，他们也还是临时制造了一些强力武器。”","color":"white","bold": false}]
execute as @s[tag=sc,scores={sea_4temp2=266}] positioned 90133 137 108 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=2..}] \
 run tellraw @a[distance=0..50] [{"text":"玛瑞莲：","color":"dark_purple","bold": true},{"text":"\n“不瞒你们讲，希望确实很渺茫。\n但再怎么说，虽然钻井平台上绝大多数火器都失效了，他们也还是临时制造了一些强力武器。”","color":"white","bold": false}]
...
execute as @s[tag=sc,scores={sea_4temp2=288}] positioned 90133 137 108 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] \
 ...
 execute as @s[tag=sc,scores={sea_4temp2=304}] positioned 90133 137 108 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=2..}] \
...
execute as @s[tag=sc,scores={sea_4temp2=364}] positioned 90133 137 108 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1}] \
 run tellraw @a[distance=0..50] [{"text":"玛瑞莲：","color":"dark_purple","bold": true},{"text":"\n“等你到达宿舍楼前，我会远程开启大门……\n一定要小心，那里的怪物已经二次变异了。”","color":"white","bold": false}]
execute as @s[tag=sc,scores={sea_4temp2=364}] positioned 90133 137 108 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=2..}] \
 run tellraw @a[distance=0..50] [{"text":"玛瑞莲：","color":"dark_purple","bold": true},{"text":"\n“等你们到达宿舍楼前，我会远程开启大门……\n一定要小心，那里的怪物已经二次变异了。”","color":"white","bold": false}]
