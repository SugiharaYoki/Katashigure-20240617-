...
execute as @s[tag=sc,scores={sea_4temp2=103}] positioned 90133 137 108 as @p[tag=SEAPT] at @s \
 run tellraw @a[tag=SEAPT,distance=3..] [{"selector":"@s","color":"white"},{"text":"：\n“我再次接通联络总站了！快来我这里。”","color":"white"}]
...
execute as @s[tag=sc,scores={sea_4temp2=118}] positioned 90133 137 108 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1}] \
 run tellraw @a[distance=0..50] [{"selector":"@s","color":"white"},{"text":"：\n“玛瑞莲小姐，这里通往行政区的所有通道都被堵住了，我该怎么上去？”","color":"white"}]
...
execute as @s[tag=sc,scores={sea_4temp2=171}] positioned 90133 137 108 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"white"},{"text":"：\n“通讯中心？是指在桥对面的附属平台吗？”","color":"white"}]
