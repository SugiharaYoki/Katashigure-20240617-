...
execute as @a[tag=SEAPT,x=90125,y=103,z=100,distance=0..8] at @s unless entity @n[tag=SEAyuehan,tag=SEA_ch4elevator_start,x=90125,y=103,z=100,distance=0..5] run tp @n[tag=SEAyuehan,tag=!SEA_ch4elevator_end,scores={sea_4temp5=..35}] 90125 103 100
...
execute if entity @n[tag=SEAyuehan,tag=SEA_ch4elevator_start,scores={sea_4temp5=36..}] as @p[tag=SEAPT] at @s if block ~ ~-0.03 ~ barrier as @a[tag=SEAPT] run attribute @s generic.gravity base set 0.08
