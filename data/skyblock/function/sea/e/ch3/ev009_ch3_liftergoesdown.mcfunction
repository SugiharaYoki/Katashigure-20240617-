...
#结束，清除除动画以外的实体
execute if entity @n[tag=SEAyuehan,tag=SEA_ch4elevator_start,scores={sea_4temp5=36..}] as @e[tag=sea_ch3elevator1,tag=!display] at @s if block ~ ~ ~ barrier run function skyblock:sea/e/ch3/ev009_ch3_lifterend
