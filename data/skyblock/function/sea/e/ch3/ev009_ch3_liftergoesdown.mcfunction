...
execute as @a[tag=SEAPT] at @s if block ~ ~-1 ~ barrier unless entity @a[tag=SEAPT,distance=2..] if entity @n[tag=SEAyuehan,scores={sea_4temp5=..35}] unless entity @n[tag=SEAyuehan,tag=SEA_ch4elevator_end] unless entity @n[tag=SEA_ch4elevator_warn2,tag=e_i_28,tag=e_i_27] run tellraw @s [{"text":"越涵：","color":"green","bold": true},{"text":"\n“站稳了，我现在启动电梯。”","color":"white","bold": false}]
execute as @a[tag=SEAPT] at @s if block ~ ~-1 ~ barrier unless entity @a[tag=SEAPT,distance=2..] if entity @n[tag=SEAyuehan,scores={sea_4temp5=..35},tag=e_i_28,tag=e_i_27] unless entity @n[tag=SEAyuehan,tag=SEA_ch4elevator_end] unless entity @n[tag=SEA_ch4elevator_warn2] run tellraw @s [{"text":"越涵：","color":"green","bold": true},{"text":"\n“我要启动电梯了。\n抓稳，别摔死。”","color":"white","bold": false}]
