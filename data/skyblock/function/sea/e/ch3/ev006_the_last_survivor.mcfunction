...
execute as @s[scores={sea_4temp1=372}] at @s run tellraw @a[distance=0..50,tag=SEAPT] [{text:" - "},{text:"坚持带他走",color:"yellow"},{text:"〈◆〉",bold:true,color:"gold",click_event:{"action":"run_command","command":"trigger sea_crafter set 90004"}}]
