...
execute as @s[scores={sea_4temp1=5}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] [{text:"？？？：",color:"yellow",bold:1b},{text:"\n“你是第一个成功上来的幸存者。”",color:"white",bold: false}]
execute as @s[scores={sea_4temp1=5}] at @s if entity @n[tag=sc,scores={sea_player=2}] run tellraw @a[distance=0..250] [{text:"？？？：",color:"yellow",bold:1b},{text:"\n“你们是唯二成功上来的幸存者。”",color:"white",bold: false}]
execute as @s[scores={sea_4temp1=5}] at @s if entity @n[tag=sc,scores={sea_player=3..}] run tellraw @a[distance=0..250] [{text:"？？？：",color:"yellow",bold:1b},{text:"\n“你们是第一批成功上来的幸存者。”",color:"white",bold: false}]
...
execute as @s[scores={sea_4temp1=32}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] [{text:"？？？：",color:"yellow",bold:1b},{text:"\n“怎么样？……你的忒尔克西之旅还顺利吗？”",color:"white",bold: false}]
execute as @s[scores={sea_4temp1=32}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250] [{text:"？？？：",color:"yellow",bold:1b},{text:"\n“怎么样？……你们的忒尔克西之旅还顺利吗？”",color:"white",bold: false}]
...
execute as @s[scores={sea_4temp1=208}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] [{text:"马绍尔：",color:"green",bold:1b},{text:"\n“他们早就试过了。现如今，没有电磁信号能顺利离开这个太平洋上的钢铁孤岛。你的船也是，你就不想想它为什么还没被人偷走？”",color:"white",bold: false}]
execute as @s[scores={sea_4temp1=208}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250] [{text:"马绍尔：",color:"green",bold:1b},{text:"\n“他们早就试过了。现如今，没有电磁信号能顺利离开这个太平洋上的钢铁孤岛。你们的船也是，你们就不想想它为什么还没被人偷走？”",color:"white",bold: false}]
...
execute as @s[scores={sea_4temp1=368}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] [{text:"马绍尔：",color:"green",bold:1b},{text:"\n“先生，您走吧。我已经给不了任何你需要的东西了。”",color:"white",bold: false}]
execute as @s[scores={sea_4temp1=368}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250] [{text:"马绍尔：",color:"green",bold:1b},{text:"\n“先生们，你们走吧。我已经给不了任何你们需要的东西了。”",color:"white",bold: false}]
...
execute as @s[scores={sea_4temp1=436}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] [{text:"马绍尔：",color:"green",bold:1b},{text:"\n“还不离开吗？……我都说了，我已是将死之人。”",color:"white",bold: false}]
...
execute as @s[scores={sea_4temp1=487}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] [{text:"马绍尔：",color:"green",bold:1b},{text:"\n“也是啊，能一路杀到这里还活着的人……\n又怎可能因这种情况就放弃呢。”",color:"white",bold: false}]
...
execute as @s[scores={sea_4temp1=506}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] [{text:"马绍尔：",color:"green",bold:1b},{text:"\n“这样吧，我为你最后指一条路。”",color:"white",bold: false}]
execute as @s[scores={sea_4temp1=506}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250] [{text:"马绍尔：",color:"green",bold:1b},{text:"\n“这样吧，我为你们最后指一条路。”",color:"white",bold: false}]
...
execute as @s[scores={sea_4temp1=538}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] [{text:"马绍尔：",color:"green",bold:1b},{text:"\n“沿着宿舍楼外的东南走道一直走，下到物资层。那里有一架电梯。”",color:"white",bold: false}]
execute as @s[scores={sea_4temp1=538}] at @s run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85

execute as @s[scores={sea_4temp1=568}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] [{text:"马绍尔：",color:"green",bold:1b},{text:"\n“从那里下去吧。不用担心门锁，我会为你打出最后一颗信号弹。会有人来帮你。”",color:"white",bold: false}]
execute as @s[scores={sea_4temp1=568}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250] [{text:"马绍尔：",color:"green",bold:1b},{text:"\n“从那里下去吧。不用担心门锁，我会为你们打出最后一颗信号弹。会有人来帮你们。”",color:"white",bold: false}]
execute as @s[scores={sea_4temp1=568}] at @s run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85

execute as @s[scores={sea_4temp1=592}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] [{text:"马绍尔：",color:"green",bold:1b},{text:"\n“那家伙没有什么战斗能力，请替我……保护好他。”",color:"white",bold: false}]
