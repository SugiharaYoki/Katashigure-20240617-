...
execute as @s[scores={sea_4temp1=140}] at @s run tellraw @a[distance=0..250] [{"text":"马绍尔：","color":"green","bold": true},{"text":"\n“哈哈，没什么晚不晚的。我们不可能活着逃出这座钻井平台。”","color":"white","bold": false}]
...
execute as @s[scores={sea_4temp1=174}] at @s run tellraw @a[distance=0..250] [{"text":"马绍尔：","color":"green","bold": true},{"text":"\n“你就没纳闷过，那些邪教徒既然控制了钻井平台，为什么不把圣水晶给带出这里？带到大陆上去？”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=174}] at @s run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85

execute as @s[scores={sea_4temp1=208}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] [{"text":"马绍尔：","color":"green","bold": true},{"text":"\n“他们早就试过了。现如今，没有电磁信号能顺利离开这个太平洋上的钢铁孤岛。你的船也是，你就不想想它为什么还没被人偷走？”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=208}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250] [{"text":"马绍尔：","color":"green","bold": true},{"text":"\n“他们早就试过了。现如今，没有电磁信号能顺利离开这个太平洋上的钢铁孤岛。你们的船也是，你们就不想想它为什么还没被人偷走？”","color":"white","bold": false}]
...
execute as @s[scores={sea_4temp1=372}] at @s run tellraw @a[distance=0..50,tag=SEAPT] [{"text":" - "},{"text":"坚持带他走","color":"yellow"},{"text":"〈◆〉","bold":true,"color":"gold","clickEvent":{"action":"run_command","value":"/trigger sea_crafter set 90004"}}]
...
execute as @s[scores={sea_4temp1=538}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] [{"text":"马绍尔：","color":"green","bold": true},{"text":"\n“沿着宿舍楼外的东南走道一直走，下到物资层。那里有一架电梯。”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=538}] at @s run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85

execute as @s[scores={sea_4temp1=568}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] [{"text":"马绍尔：","color":"green","bold": true},{"text":"\n“从那里下去吧。不用担心门锁，我会为你打出最后一颗信号弹。会有人来帮你。”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=568}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250] [{"text":"马绍尔：","color":"green","bold": true},{"text":"\n“从那里下去吧。不用担心门锁，我会为你们打出最后一颗信号弹。会有人来帮你们。”","color":"white","bold": false}]
