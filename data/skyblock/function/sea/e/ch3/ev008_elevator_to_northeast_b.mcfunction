...
execute as @s[x=90161,y=128,z=112,distance=4..,scores={sea_4temp1=9}] at @s run tellraw @a[distance=0..250,tag=!e_i_28,tag=!e_i_27] [{"text":"？？？：","color":"yellow","bold": true},{"text":"\n“你、你没被感染吧？”","color":"white","bold": false}]
...
execute as @s[scores={sea_4temp1=39}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250,tag=!e_i_28,tag=!e_i_27] [{"text":"？？？：","color":"yellow","bold": true},{"text":"\n“我懂了，那个信号弹说的就是你……你们。你们要去水下研究设施？可是为什么……”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=39}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250,tag=e_i_28,tag=!e_i_27] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“我靠，怎么是你啊。撞大运了。看来马绍尔足够信任你了，居然让我领你去水下研究设施。”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=39}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250,tag=e_i_28,tag=!e_i_27] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“我靠，怎么是你们啊。撞大运了。看来马绍尔足够信任你们了，居然让我领你们去水下研究设施。”","color":"white","bold": false}]
...
execute as @s[x=90161,y=128,z=112,distance=..4,scores={sea_4temp1=69}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250,tag=!e_i_28,tag=!e_i_27] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“我是维修部门的越涵。这里太危险了，我们下去说吧。”","color":"white","bold": false}]
...
execute as @s[scores={sea_4temp1=85}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250,tag=!e_i_28,tag=!e_i_27] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“哎先听我说，你是从宿舍楼那儿过来的吧？你有见到过斯顿吗？”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=85}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250,tag=!e_i_28,tag=!e_i_27] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“哎先听我说，你们是从宿舍楼那儿过来的吧？你们谁有见到过斯顿吗？”","color":"white","bold": false}]
...
execute as @s[scores={sea_4temp1=113}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250,tag=!e_i_27] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“什、马绍尔说……他是宿舍楼最后一个活着的？！”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=113}] at @s if entity @a[tag=!e_i_27] run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85

execute as @s[scores={sea_4temp1=145}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250,tag=!e_i_27] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“这不就意味着斯顿已经……不、不对，那家伙不可能有这么蠢的，他……他就这样死了？”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=145}] at @s if entity @a[tag=e_i_27] run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85

execute as @s[scores={sea_4temp1=174}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250,tag=!e_i_27] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“对对、对不起……我失态了。抱歉，我需要点时间消化一下。……”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=175}] at @s if entity @a[tag=!e_i_27] run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85

execute as @s[scores={sea_4temp1=199}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250,tag=!e_i_27] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“……总之、先……嗯、先走吧。我就跟在你后面。”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=199}] at @s if entity @a[tag=!e_i_27] run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85

execute as @s[scores={sea_4temp1=259}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250,tag=!e_i_27] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“他、怎么会这样……”","color":"white","bold": false}]
...
execute as @s[scores={sea_4temp1=329}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“说真的，没人能想到咱们这里能遇到这么离谱的事情。”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=329}] at @s if entity @a[tag=!e_i_27] run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85


execute as @s[scores={sea_4temp1=400}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“老哥，你在这里搜救多久了？”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=400}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“老哥，你们在这里搜救多久了？”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=400}] at @s if entity @a[tag=!e_i_27] run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85
execute as @s[scores={sea_4temp1=429}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“我靠，杀穿维修层和物资层，当代战神啊。”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=429}] at @s if entity @a[tag=!e_i_27] run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85

execute as @s[scores={sea_4temp1=639}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“再不走黄花菜都凉喽。”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=639}] at @s if entity @a[tag=!e_i_27] run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85

execute as @s[scores={sea_4temp1=819}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“你见过艾德雯娜了吗？她好像也在平台上行动，但我没有联系到她的方式。”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=819}] at @s if entity @a[tag=!e_i_27] run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85

execute as @s[scores={sea_4temp1=889}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“对啊，艾德雯娜不知道还活没活着……她身手了得，应该不会有太大问题。”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=889}] at @s if entity @a[tag=!e_i_27] run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85
...
#修复了时间轴
execute as @s[tag=SEA_ch4elevator_end,scores={sea_4temp1=1310}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“坏事了，这底下居然没有升降开关。”","color":"white","bold": false}]
execute as @s[tag=SEA_ch4elevator_end,scores={sea_4temp1=1310}] at @s run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85

execute as @s[tag=SEA_ch4elevator_end,scores={sea_4temp1=1340}] at @s if entity @n[tag=sc,scores={sea_player=1..}] run tellraw @a[distance=0..250] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“我就说他们怎么可能会留个这么方便的水下通道。妈的，果然中计了……”","color":"white","bold": false}]
execute as @s[tag=SEA_ch4elevator_end,scores={sea_4temp1=1340}] at @s run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85

execute as @s[tag=SEA_ch4elevator_end,scores={sea_4temp1=1375}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“但他们一定想不到你就一个人也能杀穿这座平台，干脆来个将计就计。反正本来就做好死在这儿的准备了。”","color":"white","bold": false}]
execute as @s[tag=SEA_ch4elevator_end,scores={sea_4temp1=1375}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“但他们一定想不到你们的实力如此强大，干脆来个将计就计。反正本来就做好死在这儿的准备了。”","color":"white","bold": false}]
