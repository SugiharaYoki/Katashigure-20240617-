...
execute if score sea_ch1_wasting_time rng2 matches 560 if entity @a[scores={SEAPT_member=2}] run tellraw @a[tag=SEAPT] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=1}]","color":"white"},{"text":"：我用用看工具维护室的钥匙吧，说不定能打开文件柜。","color":"white"}]
