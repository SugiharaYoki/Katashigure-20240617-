...
tellraw @a[tag=SEAPT,distance=0..10,tag=!seaPerm001,tag=!seaPerm002] [{"text": " - 游戏指引 -","color": "green","bold": true},{"text": " 隐藏乐谱可以解锁全新的“塞壬的指引”页面交易项目。","color": "white","bold": false},{"text": " 不同的交易项目对应的石板能够提高不同的能力种类。","color": "white","bold": false},{"text": " 解锁隐藏乐谱是永久性的。你可以在以后的游戏中随时随地使用已解锁的交易项目。","color": "white","bold": false}]
