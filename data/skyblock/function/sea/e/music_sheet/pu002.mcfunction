...
tellraw @a[tag=SEAPT,distance=0..10,tag=!seaPerm002] [{text:"永久解锁新曲谱！",color:"aqua",bold:1b}]
...
particle minecraft:flash{color:[0.500,0.500,1.000,1.00]} 90150.38 123.06 138.53 1 1 1 0.1 3
