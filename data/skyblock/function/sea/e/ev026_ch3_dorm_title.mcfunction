execute if block 90128 138 137 air as @a[tag=SEAPT,x=90127,y=136,z=139,distance=0..3.8,tag=!e_i_37] at @s run title @s times 0s 2s 1s
execute if block 90128 138 137 air as @a[tag=SEAPT,x=90127,y=136,z=139,distance=0..3.8,tag=!e_i_37] at @s run title @s title {"text": "忒尔克西 · 宿舍楼","color": "white"}
...
execute at @s run playsound garden2.bgm.005 music @s ~ ~ ~ 5 1.0
tag @s add e_i_37