...
execute as @n[tag=sc,scores={sea_4temp2=855}] if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[tag=SEAPT] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=1}]","color":"white"},{"text":"：我去……你闭嘴吧。","color":"white"}]
