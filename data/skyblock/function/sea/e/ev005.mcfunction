...
execute as @s[scores={sea_4temp1=19}] at @s run tellraw @a[distance=0..250] [{"text":"？？？：","color":"yellow","bold": true},{"text":"\n“你、你没被感染吧？”","color":"white","bold": false}]
...
execute as @s[scores={sea_4temp1=39}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] [{"text":"？？？：","color":"yellow","bold": true},{"text":"\n“调查员……？他们那群傻逼居然还真的知道该派人来，但我操，就派一个人？我去他妈的，纯他妈傻逼。”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=39}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250] [{"text":"？？？：","color":"yellow","bold": true},{"text":"\n“调查小组……？他们那群傻逼居然还真的知道该派人来，但不派海警派维修工？我日，脑子里进屎了吗？”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=39}] at @s run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85
execute as @s[scores={sea_4temp1=70}] at @s run tellraw @a[distance=0..250] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“那个……你听我讲，我是维修部门的越涵，他们没想到我会躲在他们以为我最不会来的地方。怎么样，中国人的大智慧。”","color":"white","bold": false}]
...
execute as @s[scores={sea_4temp1=402}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“哎，你找到斯顿了吗？”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=402}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“哎，你们找到斯顿了吗？”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=435}] at @s run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85
execute as @s[scores={sea_4temp1=435}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“什……你说他、……什么？”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=435}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“什……你们说他、……什么？”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=462}] at @s run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85
execute as @s[scores={sea_4temp1=462}] at @s run tellraw @a[distance=0..250] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“不、不对，他不可能有这么蠢的，一定有什么搞错了……”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=499}] at @s run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85
execute as @s[scores={sea_4temp1=499}] at @s run tellraw @a[distance=0..250] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“……抱歉，给我点时间。辛苦了，专程为了这种事替我跑一次。”","color":"white","bold": false}]
...
execute as @s[scores={sea_4temp1=699}] at @s run tellraw @a[distance=0..250] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“……算了。”","color":"white","bold": false}]
...
execute as @s[scores={sea_4temp1=1402}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“啊、什么，你说你已经找到斯顿了？”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=1402}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“啊、什么，你们说已经找到斯顿了？”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=1435}] at @s run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 0.85
execute as @s[scores={sea_4temp1=1435}] at @s if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..250] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“早点告诉我呢，他还好吗？……什、你说……他已经、他……死了？”","color":"white","bold": false}]
execute as @s[scores={sea_4temp1=1435}] at @s if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..250] [{"text":"越涵：","color":"green","bold": true},{"text":"\n“早点告诉我呢，他还好吗？……什、你们说……他已经、他……死了？”","color":"white","bold": false}]
...
execute as @s[scores={sea_4temp1=1539}] at @s run give @a[tag=SEAPT] flow_banner_pattern[custom_data={sea_docg04:true}]
