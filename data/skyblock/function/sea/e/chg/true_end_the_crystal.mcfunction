...
execute if score SEA_chg_true_end sea_4temp1 matches 68.. positioned 90119 137 108 unless entity @e[type=zombie,tag=SEAknight,distance=..15] run scoreboard players set SEA_chg_true_end sea_4temp1 68
execute if score SEA_chg_true_end sea_4temp1 matches 70 positioned 90119 137 108 as @a[tag=SEAPT] at @s run title @s times 0s 2s 2s
execute if score SEA_chg_true_end sea_4temp1 matches 70 positioned 90119 137 108 as @a[tag=SEAPT] at @s run title @s title {"text": "无 神 的 忒 尔 克 西","color": "dark_red","bold": true}
execute if score SEA_chg_true_end sea_4temp1 matches 70 positioned 90119 137 108 as @a[tag=SEAPT] at @s run playsound garden2.chapter_title master @s ~ ~ ~ 100 1.0
