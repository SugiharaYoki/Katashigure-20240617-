...
execute if score SEA_chg_true_end sea_4temp1 matches 68.. positioned 90119 137 108 if entity @e[type=zombie,tag=SEAknight,distance=..15] run scoreboard players set SEA_chg_true_end sea_4temp1 68
