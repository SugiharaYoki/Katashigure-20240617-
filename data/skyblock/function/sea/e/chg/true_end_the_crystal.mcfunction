...
execute if score SEA_chg_true_end sea_4temp1 matches 72 positioned 90119 137 108 as @a[tag=SEAPT] at @s run title @s title {"text": "无 神 的 忒 尔 克 西","color": "dark_red","bold": true}
