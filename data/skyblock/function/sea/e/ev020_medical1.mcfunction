...
execute if score SEAchg_spawn_timer_medical1 sea_4temp2 matches 1.. positioned 90082 145 139 as @n[tag=SEApillager_npc1] at @s if entity @a[tag=SEAPT,tag=!SEAPF,distance=0..5] run scoreboard players set @s sea_4temp1 11
