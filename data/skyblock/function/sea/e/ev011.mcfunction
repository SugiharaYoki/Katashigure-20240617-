...
execute if score SEAchg_spawn_timer_longbridge rng1 matches 1 as @n[tag=SEAstanley] at @s run effect give @s slowness 3 200 false
execute if score SEAchg_spawn_timer_longbridge rng1 matches 1 as @n[tag=SEAstanley] at @s run particle dripping_obsidian_tear ~ ~1 ~ 0.2 0.5 0.2 0 30
execute if score SEAchg_spawn_timer_longbridge rng1 matches 1 as @n[tag=SEAstanley] at @s run particle enchant ~ ~0.11 ~ 0.9 0 0.9 0.05 70
execute if score SEAchg_spawn_timer_longbridge rng1 matches 1 as @n[tag=SEAstanley] at @s run particle enchant ~ ~0.28 ~ 0.4 0 0.4 0.05 40
