...
execute if score sea_ch2_dwight_conversation rng6 matches 60 positioned 90122 129 132 run tellraw @a[distance=0..150] {"text":"熟悉又陌生的声音：你会见证更多。你会见证一切。\n等待你的，是一条光芒而伟大的道路。","color":"dark_purple"}
