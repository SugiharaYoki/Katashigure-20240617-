...
execute as @s[scores={sea_4temp1=24}] as @n[tag=SEA_event_ch4_mobfight1_3] run damage @s 2 arrow by @n[type=drowned,tag=SEAmob]
execute as @s[scores={sea_4temp1=24}] as @n[tag=SEA_event_ch4_mobfight1_4] run damage @s 2 arrow by @n[type=drowned,tag=SEAmob]
execute as @s[scores={sea_4temp1=34}] as @n[tag=SEA_event_ch4_mobfight1_3] run damage @s 2 arrow by @n[type=drowned,tag=SEAmob]
execute as @s[scores={sea_4temp1=34}] as @n[tag=SEA_event_ch4_mobfight1_4] run damage @s 2 arrow by @n[type=drowned,tag=SEAmob]
