...
execute as @s[scores={sea_4temp1=20}] positioned 90185 38 96 as @n[type=stray,tag=SEAmob] at @s run effect give @s speed 5 3 true
execute as @s[scores={sea_4temp1=20}] positioned 90185 38 85 as @n[type=stray,tag=SEAmob] at @s run effect give @s speed 5 3 true
execute as @s[scores={sea_4temp1=20..24}] positioned 90185 38 96 as @n[type=stray,tag=SEAmob] at @s run damage @s 2 arrow by @n[type=drowned,tag=SEAmob]
execute as @s[scores={sea_4temp1=20..24}] positioned 90185 38 85 as @n[type=stray,tag=SEAmob] at @s run damage @s 2 arrow by @n[type=drowned,tag=SEAmob]
...
execute as @s[scores={sea_4temp1=43}] positioned 90185 38 91 run function skyblock:sea/m/skeleton_shield
...
execute as @s[scores={sea_4temp1=43}] positioned 90185 38 89 run function skyblock:sea/m/skeleton_shield
execute as @s[scores={sea_4temp1=46..50}] positioned 90185 38 96 as @n[type=skeleton,tag=SEAmob] at @s run damage @s 2 arrow by @n[type=husk,tag=SEAmob]
execute as @s[scores={sea_4temp1=46..50}] positioned 90185 38 85 as @n[type=skeleton,tag=SEAmob] at @s run damage @s 2 arrow by @n[type=husk,tag=SEAmob]
execute as @s[scores={sea_4temp1=46..50}] positioned 90185 38 96 as @n[type=skeleton,tag=SEAmob] at @s run effect give @s speed 7 3 true
execute as @s[scores={sea_4temp1=46..50}] positioned 90185 38 85 as @n[type=skeleton,tag=SEAmob] at @s run effect give @s speed 7 3 true