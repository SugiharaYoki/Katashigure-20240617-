...
execute as @s[scores={sea_4temp1=18}] positioned 90185 38 91 as @n[type=stray,tag=SEAmob] at @s run damage @s 1 arrow by @n[type=husk,tag=SEAmob]
execute as @s[scores={sea_4temp1=18}] positioned 90185 38 89 as @n[type=stray,tag=SEAmob] at @s run damage @s 1 arrow by @n[type=husk,tag=SEAmob]
