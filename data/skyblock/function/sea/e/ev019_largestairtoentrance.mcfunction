...
execute as @s[scores={sea_4temp1=18..19}] positioned 90185 38 91 as @n[type=stray,tag=SEAmob] at @s run effect give @s speed 3 3 true
execute as @s[scores={sea_4temp1=18..19}] positioned 90185 38 89 as @n[type=stray,tag=SEAmob] at @s run effect give @s speed 3 3 true
execute as @s[scores={sea_4temp1=18..19}] positioned 90185 38 91 as @n[type=stray,tag=SEAmob] at @s run damage @s 2 arrow by @n[type=drowned,tag=SEAmob]
execute as @s[scores={sea_4temp1=18..19}] positioned 90185 38 89 as @n[type=stray,tag=SEAmob] at @s run damage @s 2 arrow by @n[type=drowned,tag=SEAmob]
...
execute as @s[scores={sea_4temp1=43..44}] positioned 90185 38 91 as @n[type=stray,tag=SEAmob] at @s run damage @s 2 arrow by @n[type=husk,tag=SEAmob]
execute as @s[scores={sea_4temp1=43..44}] positioned 90185 38 89 as @n[type=stray,tag=SEAmob] at @s run damage @s 2 arrow by @n[type=husk,tag=SEAmob]