...
execute as @s[scores={sea_4temp1=18..19}] positioned 90185 38 91 as @n[type=stray,tag=SEAmob] at @s run damage @s 1 arrow by @n[type=husk,tag=SEAmob]
execute as @s[scores={sea_4temp1=18..19}] positioned 90185 38 89 as @n[type=stray,tag=SEAmob] at @s run damage @s 1 arrow by @n[type=husk,tag=SEAmob]

execute as @s[scores={sea_4temp1=19}] positioned 90185 38 90 as @n[type=stray,tag=SEAmob] at @s run tellraw @a[tag=SEAPT,distance=0.1..16] {"text":"浑浊的碰撞声：“……杀、死……全部、尸变体！！”","color":"red"}
execute as @s[scores={sea_4temp1=45}] positioned 90185 38 90 as @n[type=stray,tag=SEAmob] at @s run tellraw @a[tag=SEAPT,distance=0.1..16] {"text":"浑浊的碰撞声：“守、……护、……忒尔克……西！！”","color":"red"}
...
execute as @s[scores={sea_4temp1=43..44}] positioned 90185 38 91 as @n[type=stray,tag=SEAmob] at @s run damage @s 1 arrow by @n[type=husk,tag=SEAmob]
execute as @s[scores={sea_4temp1=43..44}] positioned 90185 38 89 as @n[type=stray,tag=SEAmob] at @s run damage @s 1 arrow by @n[type=husk,tag=SEAmob]