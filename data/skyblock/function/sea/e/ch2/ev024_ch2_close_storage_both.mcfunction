...
#execute as @n[tag=sc,scores={sea_4temp2=843}] if entity @a[scores={SEAPT_member=2}] run tellraw @a[tag=SEAPT] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=2}]","color":"white"},{"text":"：\n“某人又闯大祸咯”","color":"white"}]
#execute as @n[tag=sc,scores={sea_4temp2=855}] if entity @a[scores={SEAPT_member=2}] if entity @a[scores={SEAPT_member=1}] run tellraw @a[tag=SEAPT] [{"selector":"@p[tag=SEAPT,scores={SEAPT_member=1}]","color":"white"},{"text":"：\n“我去……你闭嘴吧。”","color":"white"}]
