execute as @n[tag=sc,scores={sea_4temp2=103}] positioned 90122 128 131 if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..50] [{text:"联络机台：",color:"dark_purple",bold: true},{text:"\n“联络总站收到呼叫。啊啊，看来你活着抵达物资层了……祝贺你。”",color:"white",bold: false}]
...
execute as @s[tag=sc,scores={sea_4temp2=104}] positioned 90133 137 108 run tellraw @a[distance=0..50,tag=SEAPT] [{text:" - "},{text:"询问：你现在在哪里？这地方发生了什么？  ",color:"yellow"},{text:"〈◆〉",bold:true,color:"gold",click_event:{"action":"run_command","command":"trigger sea_crafter set 90003"}}]
...
execute as @n[tag=sc,scores={sea_4temp2=156}] positioned 90122 128 131 as @p[tag=SEAPT] run tellraw @a[distance=0..50] [{text:"联络机台：",color:"dark_purple",bold: true},{text:"\n“我是玛瑞莲，忒尔克西钻井平台机械研发贝塔小组的组长。”",color:"white",bold: false}]
execute as @n[tag=sc,scores={sea_4temp2=178}] positioned 90122 128 131 as @p[tag=SEAPT] run tellraw @a[distance=0..50] [{text:"玛瑞莲：",color:"dark_purple",bold: true},{text:"\n“如你所见，钻井平台里发生了超自然现象，我没时间过多解释。”",color:"white",bold: false}]
execute as @n[tag=sc,scores={sea_4temp2=198}] positioned 90122 128 131 as @p[tag=SEAPT] run tellraw @a[distance=0..50] [{text:"玛瑞莲：",color:"dark_purple",bold: true},{text:"\n“我劝你立刻上船返航，这里的情势并非人类所能解决。”",color:"white",bold: false}]
execute as @n[tag=sc,scores={sea_4temp2=214}] positioned 90122 128 131 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..50] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold: true},{text:"\n“我就是救援队的成员。玛瑞莲小姐，你现在在行政区的通讯总站是吗？”",color:"white"}]
execute as @n[tag=sc,scores={sea_4temp2=214}] positioned 90122 128 131 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..50] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold: true},{text:"\n“我们就是救援队的成员。玛瑞莲小姐，你现在在行政区的通讯总站是吗？”",color:"white"}]
execute as @n[tag=sc,scores={sea_4temp2=230}] positioned 90122 128 131 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..50] [{text:"玛瑞莲：",color:"dark_purple",bold: true},{text:"\n“我已经说了，不要过来。……除非你有把握能给我们带来一线生机。\n是啊，我当然还想活下去，我怎么可能想要死呢。”",color:"white",bold: false}]
execute as @n[tag=sc,scores={sea_4temp2=230}] positioned 90122 128 131 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..50] [{text:"玛瑞莲：",color:"dark_purple",bold: true},{text:"\n“我已经说了，不要过来。……除非你们有把握能给我们带来一线生机。\n是啊，我当然还想活下去，我怎么可能想要死呢。”",color:"white",bold: false}]
execute as @n[tag=sc,scores={sea_4temp2=262}] positioned 90122 128 131 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..50] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold: true},{text:"\n“相信我，维修层已经是人间炼狱了，可我还是一路杀了过来。\n我会前往行政区找你。”",color:"white"}]
execute as @n[tag=sc,scores={sea_4temp2=262}] positioned 90122 128 131 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..50] [{selector:"@s",color:"aqua"},{text:"：",color:"aqua",bold: true},{text:"\n“相信我们，维修层已经是人间炼狱了，可我们还是一路杀了过来。\n我们会前往行政区找你。”",color:"white"}]
execute as @n[tag=sc,scores={sea_4temp2=295}] positioned 90122 128 131 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..50] [{text:"玛瑞莲：",color:"dark_purple",bold: true},{text:"\n“您真的相当有勇有谋……可是上面的情况远超出你的想象。\n唉……我无论如何都是劝不动你的。”",color:"white",bold: false}]
execute as @n[tag=sc,scores={sea_4temp2=295}] positioned 90122 128 131 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..50] [{text:"玛瑞莲：",color:"dark_purple",bold: true},{text:"\n“您真的相当有勇有谋……可是上面的情况远超出你们的想象。\n唉……我无论如何都是劝不动你们的。”",color:"white",bold: false}]
execute as @n[tag=sc,scores={sea_4temp2=312}] positioned 90122 128 131 as @p[tag=SEAPT] run tellraw @a[distance=0..50] [{text:"玛瑞莲：",color:"dark_purple",bold: true},{text:"\n“物资层北区的冷冻系统被我们的小队成员开到了最大，为的就是防止那些畏惧严寒环境的怪物进一步祸害下方区域。”",color:"white",bold: false}]
execute as @n[tag=sc,scores={sea_4temp2=339}] positioned 90122 128 131 as @p[tag=SEAPT] run tellraw @a[distance=0..50] [{text:"玛瑞莲：",color:"dark_purple",bold: true},{text:"\n“虽然这一尝试失败了……但若想要前往更上层就必须先把北区的冷冻系统给关停。”",color:"white",bold: false}]
execute as @n[tag=sc,scores={sea_4temp2=365}] positioned 90122 128 131 as @p[tag=SEAPT] run tellraw @a[distance=0..50] [{text:"玛瑞莲：",color:"dark_purple",bold: true},{text:"\n“关闭系统的总控已经被我们的人破坏，但如果同时开启南区与东区的冷冻系统，就有办法将北区的系统过载掉。”",color:"white",bold: false}]
execute as @n[tag=sc,scores={sea_4temp2=388}] positioned 90122 128 131 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..50] [{text:"玛瑞莲：",color:"dark_purple",bold: true},{text:"\n“我会帮你开启南东两区的冷冻库大门，接下来就只能交给你了……\n祝你好运。”",color:"white",bold: false}]
execute as @n[tag=sc,scores={sea_4temp2=388}] positioned 90122 128 131 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..50] [{text:"玛瑞莲：",color:"dark_purple",bold: true},{text:"\n“我会帮你们开启南东两区的冷冻库大门，接下来就只能交给你们了……\n祝你好运。”",color:"white",bold: false}]
