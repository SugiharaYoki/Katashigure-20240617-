...
execute as @n[tag=sc,scores={sea_4temp2=103}] positioned 90122 128 131 as @p[tag=SEAPT] at @s run tellraw @a[tag=SEAPT,distance=3..] [{"selector":"@s","color":"aqua"},{"text":"：\n“我再次接通联络总站了！快来我这里。”","color":"white"}]
...
execute as @n[tag=sc,scores={sea_4temp2=122}] positioned 90122 128 131 as @p[tag=SEAPT] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“你现在在哪里？这地方到底发生了什么？”","color":"white"}]
...
execute as @n[tag=sc,scores={sea_4temp2=214}] positioned 90122 128 131 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“我就是救援队的成员。玛瑞莲小姐，你现在在行政区的通讯总站是吗？”","color":"white"}]
execute as @n[tag=sc,scores={sea_4temp2=214}] positioned 90122 128 131 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“我们就是救援队的成员。玛瑞莲小姐，你现在在行政区的通讯总站是吗？”","color":"white"}]
...
execute as @n[tag=sc,scores={sea_4temp2=262}] positioned 90122 128 131 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=1}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“相信我，维修层已经是人间炼狱了，可我还是一路杀了过来。\n我会前往行政区找你。”","color":"white"}]
execute as @n[tag=sc,scores={sea_4temp2=262}] positioned 90122 128 131 as @p[tag=SEAPT] if entity @n[tag=sc,scores={sea_player=2..}] run tellraw @a[distance=0..50] [{"selector":"@s","color":"aqua"},{"text":"：\n“相信我们，维修层已经是人间炼狱了，可我们还是一路杀了过来。\n我们会前往行政区找你。”","color":"white"}]
