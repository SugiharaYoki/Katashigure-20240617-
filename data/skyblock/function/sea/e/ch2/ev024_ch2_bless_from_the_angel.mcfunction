...
execute if score sea_ch2_angel_bless_trial sea_4temp2 matches 1198..1299 if block 90133 129 121 air unless entity @e[tag=SEAmob,x=90137,y=129,z=117,distance=..7] run scoreboard players set sea_ch2_event_enteringlevel sea_4temp1 1300
