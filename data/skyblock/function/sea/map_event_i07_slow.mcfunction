...
execute if score SEA_ch6_event sea_4temp4 matches 10541 as @n[tag=SEAexusiai] at @s run tellraw @a[distance=..200] [{"text":"诡谲之人：","color":"yellow","bold": true},{"text":"\n“以及……矿物处理区前的那第三道防水门，你认为在控制链条完全断裂的前提下，它是如何开启的？”","color":"white","bold": false}]
...
execute if score SEA_ch6_event sea_4temp4 matches 10732 as @n[tag=SEAexusiai] at @s run tellraw @a[distance=..200] [{"text":"诡谲之人：","color":"yellow","bold": true},{"text":"\n“麦迪逊？那个人类发现了圣水晶背后的真相，意识到只要藏到最后，第二代雷米尔就一定会解决一切，现在都还躲在平台的某个角落苟全性命呢。”","color":"white","bold": false}]
...
execute if score SEA_ch6_event sea_4temp4 matches 10912 as @n[tag=SEAexusiai] at @s run tellraw @a[distance=..200] [{"text":"诡谲之人：","color":"yellow","bold": true},{"text":"\n“我是谁，一点都不重要。但是，我希望你会帮我一个忙。”","color":"white","bold": false}]
...
execute if score SEA_ch6_event sea_4temp4 matches 11002 as @n[tag=SEAexusiai] at @s run tellraw @a[distance=..200] [{"text":"诡谲之人：","color":"yellow","bold": true},{"text":"\n“7年后，我将不得不令一位灵魂坠入永世不得脱离的黑渊。但那都是为了一场戏，一场演给所有人的戏。”","color":"white","bold": false}]
...
execute if score SEA_ch6_event sea_4temp4 matches 11102 as @n[tag=SEAexusiai] at @s run tellraw @a[distance=..200] [{"text":"诡谲之人：","color":"yellow","bold": true},{"text":"\n“你拥有逆转时间与引导灵魂的权能。请你帮我守住那位人类的灵魂，莫让其消散于地底的深渊。”","color":"white","bold": false}]
...
execute if score SEA_ch6_event sea_4temp4 matches 11402 as @n[tag=SEAexusiai] at @s run tellraw @a[distance=..200] [{"text":"诡谲之人：","color":"yellow","bold": true},{"text":"\n“那就要交给你自己来寻找答案了。”","color":"white","bold": false}]
