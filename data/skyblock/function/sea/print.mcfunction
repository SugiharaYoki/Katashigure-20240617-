...
execute if entity @n[tag=sc] run tellraw @s [{"text":" SC存活？","color":"yellow","italic": false},{"text":"T","color": "green","italic": true}]
execute unless entity @n[tag=sc] run tellraw @s [{"text":" SC存活？","color":"yellow","italic": false},{"text":"F","color": "dark_red","italic": true}]
...
tellraw @s [{"text":" 临时值.07 = ","color":"white","italic": false},{"score":{"name":"@n[tag=sc]","objective":"sea_4temp7"},"color": "green","italic": true},{"text":" | 临时值.08 = ","color":"white","italic": false},{"score":{"name":"@n[tag=sc]","objective":"sea_4temp8"},"color": "green","italic": true},{"text":" | 临时值.09 = ","color":"white","italic": false},{"score":{"name":"@n[tag=sc]","objective":"sea_4temp9"},"color": "green","italic": true}]
...
tellraw @s [{"text":" 速通计时.1 = ","color":"white","italic": false},{"score":{"name":"@n[tag=sc]","objective":"sea_speedrun_ch1"},"color": "green","italic": true},{"text":" | 速通计时.2 = ","color":"white","italic": false},{"score":{"name":"@n[tag=sc]","objective":"sea_speedrun_ch2"},"color": "green","italic": true},{"text":" | 速通计时.3 = ","color":"white","italic": false},{"score":{"name":"@n[tag=sc]","objective":"sea_speedrun_ch3"},"color": "green","italic": true}]
tellraw @s [{"text":" 速通计时.4 = ","color":"white","italic": false},{"score":{"name":"@n[tag=sc]","objective":"sea_speedrun_ch4"},"color": "green","italic": true},{"text":" | 速通计时.5 = ","color":"white","italic": false},{"score":{"name":"@n[tag=sc]","objective":"sea_speedrun_ch5"},"color": "green","italic": true},{"text":" | 速通计时.6 = ","color":"white","italic": false},{"score":{"name":"@n[tag=sc]","objective":"sea_speedrun_ch6"},"color": "green","italic": true}]
