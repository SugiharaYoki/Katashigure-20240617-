...
execute unless block 90058 103 141 grindstone if entity @a[tag=SEAPT] if entity @n[tag=sc,tag=SeGa_sea_ch2] run function skyblock:sea/map_event_i02_slow
...
execute as @a[tag=SEAPT,nbt={Inventory:[{id:"minecraft:bolt_armor_trim_smithing_template",components:{"minecraft:custom_data":{sea_t_armor3:true}}}]}] run attribute @s minecraft:generic.armor modifier add sea_t_armor3 1 add_value
execute as @a[tag=SEAPT,nbt=!{Inventory:[{id:"minecraft:bolt_armor_trim_smithing_template",components:{"minecraft:custom_data":{sea_t_armor3:true}}}]}] run attribute @s minecraft:generic.armor modifier remove sea_t_armor3
...
execute as @a[tag=SEAPT,nbt={Inventory:[{id:"minecraft:bolt_armor_trim_smithing_template",components:{"minecraft:custom_data":{sea_t_tough2:true}}}]}] run attribute @s minecraft:generic.armor_toughness modifier add sea_t_tough2 1.5 add_value
...
execute as @a[tag=SEAPT,nbt={Inventory:[{id:"minecraft:bolt_armor_trim_smithing_template",components:{"minecraft:custom_data":{sea_t_tough3:true}}}]}] run attribute @s minecraft:generic.armor_toughness modifier add sea_t_tough3 1.5 add_value
execute as @a[tag=SEAPT,nbt=!{Inventory:[{id:"minecraft:bolt_armor_trim_smithing_template",components:{"minecraft:custom_data":{sea_t_tough3:true}}}]}] run attribute @s minecraft:generic.armor_toughness modifier remove sea_t_tough3
...
execute as @a[tag=SEAPT,nbt={Inventory:[{id:"minecraft:bolt_armor_trim_smithing_template",components:{"minecraft:custom_data":{sea_t_damage3:true}}}]}] run attribute @s minecraft:generic.attack_damage modifier add sea_t_damage3 1 add_value
execute as @a[tag=SEAPT,nbt=!{Inventory:[{id:"minecraft:bolt_armor_trim_smithing_template",components:{"minecraft:custom_data":{sea_t_damage3:true}}}]}] run attribute @s minecraft:generic.attack_damage modifier remove sea_t_damage3

execute as @a[tag=SEAPT,nbt={Inventory:[{id:"minecraft:bolt_armor_trim_smithing_template",components:{"minecraft:custom_data":{sea_t_speed1:true}}}]}] run attribute @s minecraft:generic.movement_speed modifier add sea_t_speed1 0.02 add_value
...
execute as @a[tag=SEAPT,nbt={Inventory:[{id:"minecraft:bolt_armor_trim_smithing_template",components:{"minecraft:custom_data":{sea_t_speed2:true}}}]}] run attribute @s minecraft:generic.movement_speed modifier add sea_t_speed2 0.04 add_value
...
execute as @a[tag=SEAPT,nbt={Inventory:[{id:"minecraft:bolt_armor_trim_smithing_template",components:{"minecraft:custom_data":{sea_t_speed3:true}}}]}] run attribute @s minecraft:generic.movement_speed modifier add sea_t_speed3 0.04 add_value
execute as @a[tag=SEAPT,nbt=!{Inventory:[{id:"minecraft:bolt_armor_trim_smithing_template",components:{"minecraft:custom_data":{sea_t_speed3:true}}}]}] run attribute @s minecraft:generic.movement_speed modifier remove sea_t_speed3
...
execute as @a[tag=SEAPT,nbt={Inventory:[{id:"minecraft:bolt_armor_trim_smithing_template",components:{"minecraft:custom_data":{sea_t_attackspeed2:true}}}]}] run attribute @s minecraft:generic.attack_speed modifier add sea_t_attackspeed2 0.1 add_value
execute as @a[tag=SEAPT,nbt=!{Inventory:[{id:"minecraft:bolt_armor_trim_smithing_template",components:{"minecraft:custom_data":{sea_t_attackspeed2:true}}}]}] run attribute @s minecraft:generic.attack_speed modifier remove sea_t_attackspeed2
execute as @a[tag=SEAPT,nbt={Inventory:[{id:"minecraft:bolt_armor_trim_smithing_template",components:{"minecraft:custom_data":{sea_t_attackspeed3:true}}}]}] run attribute @s minecraft:generic.attack_speed modifier add sea_t_attackspeed3 0.1 add_value
execute as @a[tag=SEAPT,nbt=!{Inventory:[{id:"minecraft:bolt_armor_trim_smithing_template",components:{"minecraft:custom_data":{sea_t_attackspeed3:true}}}]}] run attribute @s minecraft:generic.attack_speed modifier remove sea_t_attackspeed3
...
execute as @a[tag=SEAPT,nbt={Inventory:[{id:"minecraft:bolt_armor_trim_smithing_template",components:{"minecraft:custom_data":{sea_t_health3:true}}}]}] run attribute @s minecraft:generic.max_health modifier add sea_t_health3 4 add_value
execute as @a[tag=SEAPT,nbt=!{Inventory:[{id:"minecraft:bolt_armor_trim_smithing_template",components:{"minecraft:custom_data":{sea_t_health3:true}}}]}] run attribute @s minecraft:generic.max_health modifier remove sea_t_health3