...
item replace entity @s armor.head with chainmail_helmet[custom_name='{"text":"电工不安全帽","italic":false,"color":"red"}',custom_data={sea_safehat2a:true},attribute_modifiers=[{type:"armor",slot:"head",id:"sea_armor:003_01not",amount:4.0,operation:"add_value"},{type:"knockback_resistance",slot:"head",id:"sea_armor:003_02not",amount:0.3,operation:"add_value"}],unbreakable={}]
item replace entity @s armor.chest with leather_chestplate[custom_name='{"text":"不基础防护服","italic":false,"color":"red"}',custom_data={sea_chest3b:true},attribute_modifiers=[{type:"armor",slot:"chest",id:"sea_armor:002_01not",amount:4.0,operation:"add_value"},{type:"armor_toughness",slot:"chest",id:"sea_armor:002_02not",amount:2,operation:"add_value"}],unbreakable={},dyed_color={rgb:3800882}]
item replace entity @s armor.legs with leather_leggings[custom_name='{"text":"不基础防护裤","italic":false,"color":"red"}',custom_data={sea_leg3b:true},attribute_modifiers=[{type:"armor",slot:"legs",id:"sea_armor:001_01not",amount:4.0,operation:"add_value"},{type:"armor_toughness",slot:"legs",id:"sea_armor:001_02not",amount:2,operation:"add_value"}],unbreakable={},dyed_color={rgb:3800882}]
item replace entity @s armor.feet with leather_boots[custom_name='{"text":"不基础防护靴","italic":false,"color":"red"}',custom_data={sea_feet3b:true},attribute_modifiers=[{type:"armor",slot:"feet",id:"sea_armor:008_01not",amount:4.0,operation:"add_value"},{type:"armor_toughness",slot:"feet",id:"sea_armor:008_02not",amount:2,operation:"add_value"}],unbreakable={},dyed_color={rgb:3800882}]
give @s iron_hoe[custom_name='{"text":"撬棍","italic":false,"color":"red"}',custom_data={sea_crowbar:true},attribute_modifiers=[{type:"attack_damage",slot:"mainhand",id:"sea_weapon:001_01",amount:1.5,operation:"add_value"},{type:"attack_speed",slot:"mainhand",id:"sea_weapon:001_02",amount:-1.5,operation:"add_value"}],unbreakable={}]
give @s iron_axe[custom_name='{"text":"消防斧","italic":false,"color":"red"}',custom_data={sea_safeaxe:true},attribute_modifiers=[{type:"attack_damage",slot:"mainhand",id:"sea_weapon:004_01",amount:6.5,operation:"add_value"},{type:"attack_speed",slot:"mainhand",id:"sea_weapon:004_02",amount:-3.0,operation:"add_value"}],unbreakable={}]
give @s crossbow[custom_name='{"text":"工程弩","italic":false,"color":"red"}',custom_data={sea_crossbow:true},unbreakable={}]
give @s bow[custom_name='{"text":"战略复合弓·改","italic":false,"color":"red"}',custom_data={sea_bow4:true},enchantments={punch:3,power:4},unbreakable={},attribute_modifiers=[{type:"movement_speed",slot:"hand",id:"sea_weapon:bow3_01",amount:0.03,operation:"add_value"}]]
...
give @s shield[custom_name='{"text":"防护盾","italic":false,"color":"red"}',custom_data={sea_shield:true},attribute_modifiers=[{type:"movement_speed",slot:"hand",id:"sea_armor:004_01",amount:-0.03,operation:"add_value"}],lore=['{"text":"主手选至此道具的瞬间获得极短暂无敌（无需右键使用）","color":"white","italic":false}','{"text":"在这期间受到攻击并反击可以造成巨额伤害","color":"white","italic":false}']]
