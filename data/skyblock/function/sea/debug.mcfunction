...
item replace entity @s armor.head with copper_helmet[custom_name={text:"电工不安全帽",italic:0b,color:"red"},custom_data={sea_safehat2a:true},attribute_modifiers=[{type:"armor",id:"sea_armor:003_01not",amount:4.0,operation:"add_value"},{type:"knockback_resistance",id:"sea_armor:003_02not",amount:0.3,operation:"add_value"}],unbreakable={}]
item replace entity @s armor.chest with leather_chestplate[custom_name={text:"不基础防护服",italic:0b,color:"red"},custom_data={sea_chest3b:true},attribute_modifiers=[{type:"armor",id:"sea_armor:002_01not",amount:4.0,operation:"add_value"},{type:"armor_toughness",id:"sea_armor:002_02not",amount:2,operation:"add_value"}],unbreakable={},dyed_color=3800882]
item replace entity @s armor.legs with leather_leggings[custom_name={text:"不基础防护裤",italic:0b,color:"red"},custom_data={sea_leg3b:true},attribute_modifiers=[{type:"armor",id:"sea_armor:001_01not",amount:4.0,operation:"add_value"},{type:"armor_toughness",id:"sea_armor:001_02not",amount:2,operation:"add_value"}],unbreakable={},dyed_color=3800882]
item replace entity @s armor.feet with leather_boots[custom_name={text:"不基础防护靴",italic:0b,color:"red"},custom_data={sea_feet3b:true},attribute_modifiers=[{type:"armor",id:"sea_armor:008_01not",amount:4.0,operation:"add_value"},{type:"armor_toughness",id:"sea_armor:008_02not",amount:2,operation:"add_value"}],unbreakable={},dyed_color=3800882]
give @s copper_hoe[custom_name={text:"撬棍",italic:0b,color:"red"},custom_data={sea_crowbar:true},attribute_modifiers=[{type:"attack_damage",slot:"mainhand",id:"sea_weapon:001_01",amount:1.5,operation:"add_value"},{type:"attack_speed",slot:"mainhand",id:"sea_weapon:001_02",amount:-1.5,operation:"add_value"}],unbreakable={}]
