...
execute as @e[type=husk,tag=SEAmob,scores={rng2=3}] at @s positioned ^1 ^ ^ align y run tp @s ~ ~ ~
execute as @e[type=husk,tag=SEAmob,scores={rng2=2}] at @s positioned ^-1 ^ ^ align y run tp @s ~ ~ ~
...
execute as @e[type=husk,tag=SEAmob,scores={rng3=3}] at @s positioned ^-1 ^ ^ align y run tp @s ~ ~ ~
execute as @e[type=husk,tag=SEAmob,scores={rng3=2}] at @s positioned ^1 ^ ^ align y run tp @s ~ ~ ~
...
execute as @e[type=husk,tag=SEAmob,scores={rng4=3}] at @s positioned ^ ^ ^2 align y run tp @s ~ ~ ~
execute as @e[type=husk,tag=SEAmob,scores={rng4=2}] at @s positioned ^ ^ ^-1 align y run tp @s ~ ~ ~