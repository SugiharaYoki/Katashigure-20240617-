...
execute as @e[type=husk,tag=SEAmob,scores={rng2=3}] at @s rotated ~ 0 positioned ^0.5 ^ ^ run tp @s ~ ~ ~
execute as @e[type=husk,tag=SEAmob,scores={rng2=4}] at @s run data modify entity @s NoAI set value 1b
execute as @e[type=husk,tag=SEAmob,scores={rng2=2}] at @s positioned ^-0.5 ^ ^ run tp @s ~ ~ ~
...
execute as @e[type=husk,tag=SEAmob,scores={rng3=3}] at @s rotated ~ 0 positioned ^-0.5 ^ ^ run tp @s ~ ~ ~
execute as @e[type=husk,tag=SEAmob,scores={rng3=4}] at @s run data modify entity @s NoAI set value 1b
execute as @e[type=husk,tag=SEAmob,scores={rng3=2}] at @s positioned ^0.5 ^ ^ run tp @s ~ ~ ~
...
execute as @e[type=husk,tag=SEAmob,scores={rng4=3}] at @s rotated ~ 0 positioned ^ ^ ^0.5 run tp @s ~ ~ ~
execute as @e[type=husk,tag=SEAmob,scores={rng4=4}] at @s run data modify entity @s NoAI set value 1b
execute as @e[type=husk,tag=SEAmob,scores={rng4=2}] at @s positioned ^ ^ ^-0.3 run tp @s ~ ~ ~
