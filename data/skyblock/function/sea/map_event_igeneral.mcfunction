...
execute as @e[type=husk,tag=SEAmob,scores={rng1=1..3}] run particle sonic_boom ~ ~1 ~ 0 0 0 0.1 1
...
execute as @e[type=husk,tag=SEAmob,scores={rng1=9..11,rng3=..0,rng4=..0}] run scoreboard players set @s rng2 4
execute as @e[type=husk,tag=SEAmob,scores={rng1=12..13,rng2=..0,rng4=..0}] run scoreboard players set @s rng3 4
execute as @e[type=husk,tag=SEAmob,scores={rng1=14..15,rng2=..0,rng3=..0}] run scoreboard players set @s rng4 4
...
execute as @e[type=husk,tag=SEAmob,scores={rng2=3}] at @s rotated ~ 0 positioned ^15 ^ ^ align y run tp @s ~ ~ ~
execute as @e[type=husk,tag=SEAmob,scores={rng2=3}] at @s run data modify entity @s NoAI set value 1b
execute as @e[type=husk,tag=SEAmob,scores={rng2=2}] at @s positioned ^-15 ^ ^ align y run tp @s ~ ~ ~
...
execute as @e[type=husk,tag=SEAmob,scores={rng3=3}] at @s rotated ~ 0 positioned ^-15 ^ ^ align y run tp @s ~ ~ ~
execute as @e[type=husk,tag=SEAmob,scores={rng3=3}] at @s run data modify entity @s NoAI set value 1b
execute as @e[type=husk,tag=SEAmob,scores={rng3=2}] at @s positioned ^15 ^ ^ align y run tp @s ~ ~ ~
...
execute as @e[type=husk,tag=SEAmob,scores={rng4=2}] at @s positioned ^ ^ ^-4.6 align y run tp @s ~ ~ ~
