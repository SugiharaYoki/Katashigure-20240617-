...
execute if score seact rng2 matches 20 as @s[tag=iframe_sea,type=item_frame] at @s unless items entity @s contents * run kill @s
execute if score seact rng2 matches 20 as @s[tag=iframe_sea,type=glow_item_frame] at @s unless items entity @s contents * run kill @s
