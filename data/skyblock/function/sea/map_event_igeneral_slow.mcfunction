...
execute if block 90075 103 141 minecraft:cauldron positioned 90079 129 123 if entity @a[tag=SEAPT,distance=0..20] unless entity @e[type=glow_item_frame,distance=0..0.5] run summon minecraft:glow_item_frame ~ ~ ~ {Tags:[iframe_sea,iframe_sea_map_02],Invisible:0b,Fixed:0b,Invulnerable:0b,Facing:2b,Item:{id:"minecraft:filled_map",components:{custom_name:'{"text":"物资层地图","italic":false,"color":"dark_purple"}',map_id:5}}}
...
item replace block 90148 122 144 container.6 with flow_banner_pattern[custom_name=\
...
item replace block 90099 130 148 container.14 with flow_banner_pattern[custom_name=\
...
item replace block 90126 128 124 container.2 with flow_banner_pattern[custom_name=\
