...
execute if block 90058 103 142 minecraft:grindstone if block 90075 103 141 air if block 90131 128 129 air if block 90141 128 134 air if block 90132 130 136 redstone_lamp[lit=true] run title @a[tag=SEAPT,tag=!e_i_24] actionbar {"text":"目标：前往北冷冻库","color":"dark_green"}
