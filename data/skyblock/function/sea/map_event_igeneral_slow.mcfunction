...
execute if block 90148 130 132 air run item replace block 90075 128 144 container.15 with lever[minecraft:can_place_on={blocks:"stripped_birch_log"},custom_data={sea_lever3:true}] 1
