...
execute as @a[tag=SEAPT] at @s run clear @s iron_axe[!custom_data={sea_safeaxe_t:true}]
...
item replace block 90117 137 142 container.16 with flow_banner_pattern[custom_name='{"text":"宿舍楼图书馆的笔记 - 斯顿","italic":true,"color":"dark_purple","italic":false}',lore=['{"text":"邪教徒已经占领了通讯中心。","color":"white","italic":false}','{"text":"但这并不是世界末日，我们也守住了宿舍楼的所有入口。","color":"white","italic":false}','{"text":"关键点是在大门的防守被冲破前找到其他的逃生路线。","color":"white","italic":false}','{"text":"他们捣毁了全部的救生艇，但若是想办法抵达维修层的话……","color":"white","italic":false}','{"text":"现在的希望在维修部门那群人身上，他们要带领大家从维修路线逃跑。","color":"white","italic":false}']]
