...
,lore=['{"text":"在维修仓库似乎存有某位工程师的笔记。","color":"white","italic":false}']]
...
,lore=['{"text":"在主平台甲板通讯室储藏间似乎存有某位工程师的笔记。","color":"white","italic":false}']]
...
,lore=['{"text":"在物资层休息室似乎存有某位工程师的笔记。","color":"white","italic":false}']]
