...
#回响指南针
execute if entity @a[tag=SEAPT,nbt={SelectedItem:{id:"minecraft:recovery_compass"}}] run effect give @s darkness 1 0 true
...
execute as @a[tag=SEAPT,nbt={SelectedItem:{id:"minecraft:recovery_compass"}}] at @e[tag=SEAmob,distance=8..16,scores={sea_4temp9=4}] run playsound minecraft:entity.warden.heartbeat hostile @a ~ ~ ~ 0.2 0.9
execute as @a[tag=SEAPT,nbt={SelectedItem:{id:"minecraft:recovery_compass"}}] at @e[tag=SEAmob,distance=..8,scores={sea_4temp9=4}] run playsound minecraft:entity.warden.heartbeat hostile @a ~ ~ ~ 0.2 1.2
execute as @a[tag=SEAPT,nbt={SelectedItem:{id:"minecraft:recovery_compass"}}] at @e[tag=SEAmob,distance=..8,scores={sea_4temp9=2}] run playsound minecraft:entity.warden.heartbeat hostile @a ~ ~ ~ 0.2 1.2
