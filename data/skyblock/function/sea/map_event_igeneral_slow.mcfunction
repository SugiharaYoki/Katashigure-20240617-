...
#任务目标列表
execute unless block 90058 103 142 minecraft:grindstone unless block 90084 122 139 air run title @a[tag=SEAPT,tag=!e_i_04] actionbar {"text":"目标：进入忒尔克西的维修层","color":"dark_green"}
execute unless block 90058 103 142 minecraft:grindstone unless block 90084 122 139 air run title @a[tag=SEAPT,tag=e_i_04] actionbar {"text":"目标：想办法打开消毒间的门 & 寻找可用的联络装置","color":"dark_green"}
execute unless block 90058 103 142 minecraft:grindstone if block 90084 122 139 air if block 90102 122 125 iron_block run title @a[tag=SEAPT,tag=!e_i_07] actionbar {"text":"目标：在有限的空间内搜索一番 & 寻找可用的联络装置","color":"dark_green"}
execute unless block 90058 103 142 minecraft:grindstone if block 90102 122 125 iron_block unless block 90129 123 120 air run title @a[tag=SEAPT,tag=e_i_07] actionbar {"text":"目标：找到文件室上锁箱子的钥匙","color":"dark_green"}
execute unless block 90058 103 142 minecraft:grindstone if block 90102 122 125 air as @n[tag=sc,scores={sea_4temp2=..216}] unless block 90129 123 120 air run title @a[tag=SEAPT] actionbar {"text":"目标：寻找可用的联络装置","color":"dark_green"}
execute unless block 90058 103 142 minecraft:grindstone if block 90102 122 125 air as @n[tag=sc,scores={sea_4temp2=296..}] unless block 90129 123 120 air run title @a[tag=SEAPT] actionbar {"text":"目标：迎战大群的腐尸","color":"dark_green"}
execute unless block 90058 103 142 minecraft:grindstone if block 90129 123 120 air run title @a[tag=SEAPT] actionbar {"text":"目标：探索维修层 & 寻找通往物资层的上行楼梯","color":"dark_green"}
execute unless block 90058 103 142 minecraft:grindstone if block 90129 123 120 air as @n[tag=sc,scores={sea_4temp2=4001..5000}] run title @a[tag=SEAPT] actionbar {"text":"目标：击败法莫洛斯","color":"dark_green"}
execute if block 90058 103 142 minecraft:grindstone if block 90075 103 141 air run title @a[tag=SEAPT,tag=!e_i_13] actionbar {"text":"目标：寻找通往物资层的上行楼梯","color":"dark_green"}
execute if block 90058 103 142 minecraft:grindstone if block 90075 103 141 air as @n[tag=sc,scores={sea_4temp2=..88}] run title @a[tag=SEAPT,tag=e_i_13] actionbar {"text":"目标：寻找可用的联络装置","color":"dark_green"}
execute if block 90058 103 142 minecraft:grindstone if block 90075 103 141 air if block 90131 128 129 air unless block 90141 128 134 air if block 90132 130 136 redstone_lamp[lit=false] run title @a[tag=SEAPT,tag=!e_i_17] actionbar {"text":"目标：调高东冷冻库的功率 & 调高南冷冻库的功率","color":"dark_green"}
execute if block 90058 103 142 minecraft:grindstone if block 90075 103 141 air if block 90131 128 129 air if block 90141 128 134 air if block 90132 130 136 redstone_lamp[lit=false] run title @a[tag=SEAPT,tag=!e_i_17] actionbar {"text":"目标：调高南冷冻库的功率","color":"dark_green"}
execute if block 90058 103 142 minecraft:grindstone if block 90075 103 141 air if block 90131 128 129 air unless block 90141 128 134 air if block 90132 130 136 redstone_lamp[lit=false] run title @a[tag=SEAPT,tag=e_i_17] actionbar {"text":"目标：调高东冷冻库的功率 & 关闭南冷冻库的空气循环系统","color":"dark_green"}
execute if block 90058 103 142 minecraft:grindstone if block 90075 103 141 air if block 90131 128 129 air if block 90141 128 134 air if block 90132 130 136 redstone_lamp[lit=false] run title @a[tag=SEAPT,tag=e_i_17] actionbar {"text":"目标：关闭南冷冻库的空气循环系统","color":"dark_green"}
execute if block 90058 103 142 minecraft:grindstone if block 90075 103 141 air if block 90131 128 129 air unless block 90141 128 134 air if block 90132 130 136 redstone_lamp[lit=false] run title @a[tag=SEAPT,tag=e_i_18] actionbar {"text":"目标：调高东冷冻库的功率 & 调高南冷冻库的功率","color":"dark_green"}
execute if block 90058 103 142 minecraft:grindstone if block 90075 103 141 air if block 90131 128 129 air if block 90141 128 134 air if block 90132 130 136 redstone_lamp[lit=false] run title @a[tag=SEAPT,tag=e_i_18] actionbar {"text":"目标：调高南冷冻库的功率","color":"dark_green"}
execute if block 90058 103 142 minecraft:grindstone if block 90075 103 141 air if block 90131 128 129 air unless block 90141 128 134 air if block 90132 130 136 redstone_lamp[lit=true] run title @a[tag=SEAPT] actionbar {"text":"目标：调高东冷冻库的功率","color":"dark_green"}
execute if block 90058 103 142 minecraft:grindstone if block 90075 103 141 air if block 90131 128 129 air if block 90141 128 134 air if block 90132 130 136 redstone_lamp[lit=true] as @n[tag=sc,scores={sea_4temp2=..828}] run title @a[tag=SEAPT,tag=!e_i_24] actionbar {"text":"","color":"dark_green"}
execute if block 90058 103 142 minecraft:grindstone if block 90075 103 141 air if block 90131 128 129 air if block 90141 128 134 air if block 90132 130 136 redstone_lamp[lit=true] as @n[tag=sc,scores={sea_4temp2=829..}] run title @a[tag=SEAPT,tag=!e_i_24] actionbar {"text":"目标：前往北冷冻库","color":"dark_green"}
execute if block 90058 103 142 minecraft:grindstone if block 90075 103 141 air if block 90131 128 129 air if entity @n[tag=sc,scores={sea_4temp2=..2000}] run title @a[tag=SEAPT,tag=e_i_24] actionbar {"text":"目标：寻找通往主平台甲板的上行楼梯","color":"dark_green"}
execute if block 90058 103 142 minecraft:grindstone if block 90075 103 141 air if block 90131 128 129 air if entity @n[tag=sc,scores={sea_4temp2=2001..}] run title @a[tag=SEAPT] actionbar {"text":"目标：调查前方","color":"dark_green"}
execute if block 90058 103 142 minecraft:grindstone if block 90075 103 141 air if block 90131 128 129 air if entity @n[tag=sc,scores={sea_4temp2=2120..}] run title @a[tag=SEAPT] actionbar {"text":"目标：后撤，寻找方法击败德怀特","color":"dark_green"}
execute if block 90058 103 142 minecraft:grindstone if block 90075 103 141 air if block 90131 128 129 air if entity @n[tag=sc,scores={sea_4temp2=5001..}] run title @a[tag=SEAPT] actionbar {"text":"目标：寻找通往主平台甲板的上行楼梯","color":"dark_green"}
execute if block 90075 103 141 cauldron run title @a[tag=SEAPT,tag=!e_i_30] actionbar {"text":"目标：寻找通往主平台甲板的上行楼梯","color":"green"}
execute if block 90075 103 141 cauldron as @n[tag=sc,scores={sea_4temp2=..88}] run title @a[tag=SEAPT,tag=e_i_30] actionbar {"text":"目标：寻找可用的联络装置 & 前往办公区域","color":"green"}
execute if block 90075 103 141 cauldron as @n[tag=sc,scores={sea_4temp2=366..}] run title @a[tag=SEAPT,tag=e_i_30] actionbar {"text":"目标：前往宿舍楼","color":"green"}
...
item replace block 90104 122 131 container.6 with flow_banner_pattern[custom_name=\
'{"text":"钥匙箱内的笔记 - 德怀特","italic":true,"color":"dark_purple","italic":false}',\
...
lore=['{"text":"患者弥尔顿表现出明显的四肢发热、皮肤溃烂症状，但并未感受到明显的疼痛。","color":"white","italic":false}','{"text":"我暂时无法确切诊断出他的病，但他是个有趣的病人。","color":"white","italic":false}','{"text":"我劝他留在医疗室接受观察，石油开采作业缺他一人也无大碍。","color":"white","italic":false}','{"text":"这显然也是为了所有人的安全考虑。我不确定他会在何时开始感到疼痛。","color":"white","italic":false}','{"text":"退十步说，这种病症的传染性也值得考究。","color":"white","italic":false}']]
item replace block 90142 122 143 container.6 with flow_banner_pattern[custom_name=\
...
item replace block 90128 128 150 container.12 with flow_banner_pattern[custom_name=\
...
item replace block 90096 122 117 container.22 with flow_banner_pattern[custom_name=\
...
item replace block 90118 128 120 container.10 with flow_banner_pattern[custom_name=\
...
item replace block 90075 122 143 container.14 with flow_banner_pattern[custom_name=\
...
item replace block 90075 122 143 container.15 with flow_banner_pattern[custom_name=\
...
item replace block 90084 122 106 container.13 with flow_banner_pattern[custom_name=\
...
item replace block 90114 123 125 container.12 with flow_banner_pattern[custom_name=\
...
item replace block 90138 137 108 container.12 with flow_banner_pattern[custom_name=\
...
item replace block 90141 137 117 container.12 with flow_banner_pattern[custom_name=\
...
item replace block 90125 128 124 container.2 with flow_banner_pattern[custom_name=\
...
item replace block 90110 128 135 container.13 with flow_banner_pattern[custom_name=\
...
item replace block 90126 129 143 container.13 with flow_banner_pattern[custom_name=\
'{"text":"南冷冻室内部的笔记 - 潘","italic":true,"color":"dark_purple","italic":false}',\
lore=['{"text":"那个婊子养的，居然把德怀特的遗骨这样随意丢进冷冻库？！","color":"white","italic":false}']]
item replace block 90148 129 113 container.3 with flow_banner_pattern[custom_name=\
...
item replace block 90081 122 145 container.13 with flow_banner_pattern[custom_name=\
