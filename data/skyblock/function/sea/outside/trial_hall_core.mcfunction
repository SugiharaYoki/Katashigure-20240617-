...
item replace block 89843 13 -163 container.8 with golden_sword[custom_name='{text:"烈风圣剑",italic:false,color:"gold"}',custom_data={sea_goldensword_1:true},attribute_modifiers=[{type:"attack_damage",slot:"mainhand",id:"sea_weapon:raphael_sword_1_01",amount:9.0,operation:"add_value"},{type:"attack_speed",slot:"mainhand",id:"sea_weapon:raphael_sword_1_02",amount:-1.0,operation:"add_value"},{type:"movement_speed",slot:"mainhand",id:"sea_weapon:raphael_sword_1_03",amount:0.02,operation:"add_value"},{type:"entity_interaction_range",slot:"mainhand",id:"sea_weapon:raphael_sword_1_04",amount:1,operation:"add_value"}],unbreakable={},enchantment_glint_override=true]

item replace block 89843 13 -163 container.5 with shears[custom_name='{text:"喷火器",italic:false,color:"red"}',custom_data={sea_flamethrower:true},enchantments={punch:1,power:1},unbreakable={}]
item replace block 89843 13 -163 container.6 with bow[custom_name='{text:"复合弓",italic:false,color:"red"}',custom_data={sea_bow1:true},enchantments={punch:1,power:1},unbreakable={}]
item replace block 89843 13 -163 container.14 with snout_armor_trim_smithing_template[custom_name='{text:"爆燃膛针",italic:false,color:"red"}',custom_data={sea_t_shotgun1:true},lore=['{text:"急霰 I 解锁喷火器右键攻击",color:"white",italic:false}','{text:"对面前近距离造成大量伤害",color:"white",italic:false}','{text:"消耗一份燃爆剂",color:"red",italic:false}']]
...
item replace block 89843 13 -163 container.23 with firework_star[custom_name='{text:"燃爆剂",italic:true,color:"blue",italic:false}',lore=['{text:"喷火器专用燃爆剂。",color:"white",italic:false}','{text:"使用喷火器时左键，瞬间对面前近距离造成大量伤害。",color:"white",italic:false}']] 5
