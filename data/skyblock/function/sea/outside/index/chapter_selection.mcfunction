...
item replace entity @s[scores={sea_progress=9..}] container.12 with waxed_copper_block[custom_data={"sea_setting_box":true},custom_name='{text:"『第四章：水下研究设施』",italic:false,color:"aqua"}',lore=['{text:"“不听劝阻的人可不是好孩子。”",color:"white",italic:true}']]
...
item replace entity @s[scores={sea_progress=17..}] container.23 with amethyst_shard[custom_data={"sea_setting_box":true},custom_name='{text:"『BOSS：权之执理』",italic:false,color:"red"}',lore=['{text:"“尔后，你终将走上命中注定的道路。”",color:"white",italic:true}'],enchantments={vanishing_curse:1}]

item replace entity @s[scores={SEAPT_setting_recall=1}] container.28 with ender_eye[custom_data={"sea_setting_box":true},custom_name='{text:"时间回溯：记忆",italic:false,color:"red"}',lore=['{text:"设定跳关后是否解锁全部的先前工作站",color:"white",italic:false}','{text:"当前：否",color:"red",italic:true}']]
item replace entity @s[scores={SEAPT_setting_recall=2}] container.28 with ender_eye[custom_data={"sea_setting_box":true},custom_name='{text:"时间回溯：记忆",italic:false,color:"red"}',lore=['{text:"设定跳关后是否解锁全部的先前工作站",color:"white",italic:false}','{text:"当前：是",color:"green",italic:true}']]
...
item replace entity @s[scores={sea_progress=6..},advancements={skyblock:sea/doc/g4=false}] container.29 with barrier[custom_data={"sea_setting_box":true},custom_name='{text:"未知的支线任务",italic:false,color:"dark_gray"}',lore=['{text:"试着在与马绍尔相遇前探索主平台甲板吧。",color:"gray",italic:true}']]

item replace entity @s[scores={sea_progress=6..,SEAPT_setting_marilyn=1},advancements={skyblock:sea/doc/g4=true}] container.30 with spyglass[custom_data={"sea_setting_box":true},custom_name='{text:"玛瑞莲：通讯交流",italic:false,color:"red"}',lore=['{text:"设定是否触发过先前所有的可选通讯机台事件",color:"white",italic:false}','{text:"（对选择章节的全部先前关卡都有效）",color:"white",italic:false}','{text:"",color:"green",italic:false}','{text:"当前：否",color:"red",italic:true}','{text:"玛瑞莲能提供的远不止指导。什么，你说你并不需要情绪价值？",color:"gray",italic:true}']]
item replace entity @s[scores={sea_progress=6..,SEAPT_setting_marilyn=2},advancements={skyblock:sea/doc/g4=true}] container.30 with spyglass[custom_data={"sea_setting_box":true},custom_name='{text:"玛瑞莲：通讯交流",italic:false,color:"red"}',lore=['{text:"设定是否触发过先前所有的可选通讯机台事件",color:"white",italic:false}','{text:"（对选择章节的全部先前关卡都有效）",color:"white",italic:false}','{text:"",color:"green",italic:false}','{text:"当前：是",color:"green",italic:true}','{text:"玛瑞莲能提供的远不止指导。什么，你说你并不需要情绪价值？",color:"gray",italic:true}']]
item replace entity @s[scores={sea_progress=6..},advancements={skyblock:sea/doc/g9=false}] container.30 with barrier[custom_data={"sea_setting_box":true},custom_name='{text:"未知的触发事件",italic:false,color:"dark_gray"}',lore=['{text:"在探索宿舍楼后，也不要忘了向某人汇报情况……",color:"gray",italic:true}']]
