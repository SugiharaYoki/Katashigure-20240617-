...
item replace entity @s[scores={sea_progress=17..}] container.23 with amethyst_shard[custom_data={"sea_setting_box":true},custom_name='{"text":"『BOSS：权之执理』","italic":false,"color":"red"}',lore=['{"text":"“最后，你将成为命中必将成为之人。”","color":"white","italic":true}'],enchantments={vanishing_curse:1}]
