...
item replace entity @s[scores={sea_progress=15..}] container.14 with sculk[custom_data={"sea_setting_box":true},custom_name='{"text":"『第六章：生命边缘』","italic":false,"color":"aqua"}',lore=['{"text":"“我不会让你就这样离开。”","color":"white","italic":true}']]
...
item replace entity @s[scores={sea_progress=14..}] container.22 with wind_charge[custom_data={"sea_setting_box":true},custom_name='{"text":"『BOSS：诺曼 & 权之执理』","italic":false,"color":"red"}',lore=['{"text":"“我听明白了，圣晶教徒信仰的东西跟细菌无关。”","color":"white","italic":true}'],enchantments={vanishing_curse:1}]
