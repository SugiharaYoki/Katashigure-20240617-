...
item replace entity @s[scores={sea_progress=14..,SEAPT_setting_fiona=1}] container.31 with tropical_fish[custom_data={"sea_setting_box":true},custom_name='{"text":"菲尔娜：好感度","italic":false,"color":"red"}',lore=['{"text":"更改角色“菲尔娜”的初始好感度","color":"white","italic":false}','{"text":"（只对第五章BOSS与后续关卡有效）","color":"white","italic":false}','{"text":"","color":"green","italic":false}','{"text":"当前：0","color":"green","italic":true}','{"text":"更高的好感度会使得她更加愿意向你敞开心扉，","color":"gray","italic":true}','{"text":"在战斗时也会所向披靡。","color":"gray","italic":true}']]
item replace entity @s[scores={sea_progress=14..,SEAPT_setting_fiona=2}] container.31 with tropical_fish[custom_data={"sea_setting_box":true},custom_name='{"text":"菲尔娜：好感度","italic":false,"color":"red"}',lore=['{"text":"更改角色“菲尔娜”的初始好感度","color":"white","italic":false}','{"text":"（只对第五章BOSS与后续关卡有效）","color":"white","italic":false}','{"text":"","color":"green","italic":false}','{"text":"当前：8","color":"green","italic":true}','{"text":"更高的好感度会使得她更加愿意向你敞开心扉，","color":"gray","italic":true}','{"text":"在战斗时也会所向披靡。","color":"gray","italic":true}']]
