...
execute if items entity @s player.cursor potion[custom_data={"sea_setting_box":true}] positioned 89843 16 -151 run function skyblock:sea/m/drowned
execute if items entity @s player.cursor iron_helmet[custom_data={"sea_setting_box":true}] positioned 89843 16 -151 run function skyblock:sea/m/drowned_hat
execute if items entity @s player.cursor iron_hoe[custom_data={"sea_setting_box":true}] positioned 89843 16 -151 run function skyblock:sea/m/drowned_maintenance
execute if items entity @s player.cursor shield[custom_data={"sea_setting_box":true}] positioned 89843 16 -151 run function skyblock:sea/m/drowned_shield
...
execute if items entity @s player.cursor fire_charge[custom_data={"sea_setting_box":true}] positioned 89843 16 -151 run function skyblock:sea/m/zombie_bomb
