...
execute if entity @s[tag=sea_dead] unless entity @a[tag=SEAPT] run function skyblock:multimenu829_teleport_m04
execute unless entity @s[tag=sea_dead] run function skyblock:multimenu829_teleport_m04