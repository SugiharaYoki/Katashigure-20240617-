execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign positioned 90140 104 56 as @a[tag=SEAPT,distance=0..3.8,tag=!e_i_38] at @s run function skyblock:sea/e/ch5/title_1
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign as @a[tag=SEAPT,tag=!e_i_42,x=90121,y=122,z=40,dx=25,dy=4,dz=25] at @s run function skyblock:sea/e/ch5/title_2
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign as @a[tag=SEAPT,tag=!e_i_44,x=90114,y=128,z=14,dx=8,dy=4,dz=8] at @s run function skyblock:sea/e/ch5/title_3
...
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign as @a[tag=SEAPT,tag=!e_i_40] at @s if block ~ ~-0.5 ~ packed_ice run function skyblock:sea/e/ch5/instant_freeze_on_thin_ice
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign if score sea_ch5_instant_freeze sea_4temp4 matches 1..55 run function skyblock:sea/e/ch5/instant_freeze_magma_boss

execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign if block 90105 102 33 bamboo_button[powered=true] run fill 90105 103 34 90106 101 34 air


execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign if score SEA_ch5_event_EnteringPillar2 rng1 matches 0 positioned 90110 88 58 if entity @a[tag=SEAPT,tag=!SEAPF,distance=0..6] run scoreboard players set SEA_ch5_event_EnteringPillar2 rng1 1

execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign if score SEA_ch5_event_EnteringPillar2 rng1 matches 1..99 run function skyblock:sea/e/ch5/event_the_first_visioner


#第三支柱
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign if score SEA_ch5_event_EnteringPillar2 rng2 matches 0 positioned 90110 114 41 if entity @a[tag=SEAPT,tag=!SEAPF,distance=0..7] run scoreboard players set SEA_ch5_event_EnteringPillar2 rng2 1
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign if score SEA_ch5_event_EnteringPillar2 rng2 matches 1..30 run function skyblock:sea/e/ch5/event_pillar_3


execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign positioned 90114 79 61 if entity @a[tag=SEAPT,tag=!SEAPF,distance=0..6] if block 90117 79 56 flower_pot positioned 90123 78 65 run function skyblock:sea/m/drowned_shield
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign positioned 90114 79 61 if entity @a[tag=SEAPT,tag=!SEAPF,distance=0..6] if block 90117 79 56 flower_pot positioned 90123 78 65 run function skyblock:sea/m/drowned_shield
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign positioned 90114 79 61 if entity @a[tag=SEAPT,tag=!SEAPF,distance=0..6] if block 90117 79 56 flower_pot positioned 90123 78 65 run function skyblock:sea/m/skeleton_melee
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign positioned 90114 79 61 if entity @a[tag=SEAPT,tag=!SEAPF,distance=0..6] if block 90117 79 56 flower_pot positioned 90123 78 65 run function skyblock:sea/m/skeleton_melee
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign positioned 90114 79 61 if entity @a[tag=SEAPT,tag=!SEAPF,distance=0..6] if block 90117 79 56 flower_pot run setblock 90117 79 56 air
...
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign if score sea_ch5_instant_freeze sea_4temp2 matches 0 if block 90130 96 31 lever[powered=true] if block 90128 96 31 lever[powered=true] run scoreboard players set sea_ch5_instant_freeze sea_4temp2 1
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign if score sea_ch5_instant_freeze sea_4temp2 matches 1..140 run function skyblock:sea/e/ch5/instant_freeze




execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign store result score sea_ch5_mood sea_4temp1 run random value 1..25
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign positioned 90112 149 103 if score sea_ch5_mood sea_4temp1 matches 1 as @r[tag=SEAPT,distance=0..400] run function skyblock:sea/e/ch5/mood_1
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign positioned 90112 149 103 if score sea_ch5_mood sea_4temp1 matches 3..14 as @r[tag=SEAPT,distance=0..400] at @s positioned over world_surface if entity @s[distance=0..1.5] unless entity @n[tag=SEAboss5] unless entity @n[tag=SEAboss5b] run function skyblock:sea/e/ch5/mood_1_surface
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign positioned 90112 149 103 if score sea_ch5_mood sea_4temp1 matches 1..20 as @r[tag=SEAPT,distance=0..400] at @s positioned over world_surface if entity @s[distance=0..1.5] run particle minecraft:ash ~ ~8 ~ 6 5 6 0 20
...
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 1..840 run function skyblock:sea/e/ch5/event_engineering_meeting_fiona_the_exchange
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign if score SEA_ch5_event_engineering_fiona sea_4temp2 matches 837.. run function skyblock:sea/e/ch5/event_engineering_meeting_fiona_the_wait
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign if score SEA_ch5_event_engineering_fiona sea_4temp6 matches 1500.. run function skyblock:sea/e/ch5/event_array_lurk

#菲尔娜技能组
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign as @n[tag=SEAfiona_laser_attacking,x=90000,y=100,z=0,distance=0..1200] at @s run function skyblock:sea/e/ch5/fiona_attack_laser
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign as @n[tag=SEAfiona_laser_attacking_hostile,x=90000,y=100,z=0,distance=0..1200] at @s run function skyblock:sea/e/ch5/fiona_attack_laser_hostile
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] run effect give @s regeneration 5 5 true
...
#通讯总站 2F 第一波敌人
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign if entity @a[tag=SEAPT,tag=!SEAPF,x=90136,y=136,z=49,dx=10,dy=10,dz=10] unless entity @a[tag=e_i_45] run function skyblock:sea/e/ch5/event_building_2f_enemy_1

execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign if entity @a[tag=SEAPT,tag=!SEAPF,x=90138,y=137,z=60,dx=6,dy=10,dz=9] positioned 90134 130 58 run function skyblock:sea/e/ch5/event_building_2f_ruins
...
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign if score SEA_ch5_event_building rng1 matches 1.. positioned 90142 137 42 run function skyblock:sea/e/ch5/event_array_building_general

execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign unless score @n[tag=SEAjones] rng1 matches 355.. as @n[type=villager,tag=SEAjones,x=90144,y=144,z=51,distance=..15] at @s if entity @a[tag=SEAPT,x=90144,y=144,z=51,dx=7,dy=5,dz=7] run function skyblock:sea/e/ch5/event_array_building_jones
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign if score @n[tag=SEAjones] rng1 matches 355.. as @n[type=villager,tag=SEAjones,x=90144,y=144,z=51,distance=..15] run function skyblock:sea/e/ch5/event_array_building_jones
...
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign positioned 90142 134 26 as @n[tag=SEAnorman,type=zombie_villager,distance=0..250] at @s unless score @s rng1 matches 1.. if entity @a[tag=SEAPT,tag=!SEAPF,distance=0..6.3] run scoreboard players set @s rng1 1


execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign positioned 90142 134 26 as @n[type=breeze_wind_charge,distance=13..50] at @s run kill @s
...
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign if entity @a[tag=SEAPT,scores={SEA_ch5_event_illager_killed=1..}] run scoreboard players remove SEA_ch5_event_illager_count rng1 1
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign if entity @a[tag=SEAPT,scores={SEA_ch5_event_illager_killed=1..}] run scoreboard players reset @a SEA_ch5_event_illager_killed


execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign if block 90118 90 73 warped_button[powered=true] if score SEA_ch5_event_marilyn rng1 matches ..0 run scoreboard players set SEA_ch5_event_marilyn rng1 1
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign if score SEA_ch5_event_marilyn rng1 matches 1.. run function skyblock:sea/e/ch5/marilyn/communication_1
...
execute unless block 90077 105 141 minecraft:dark_oak_hanging_sign if score SEA_ch5_event_boss5 rng9 matches 100.. run function skyblock:sea/e/ch5/boss5/conclusion
