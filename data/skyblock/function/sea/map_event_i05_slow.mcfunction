...
#菲尔娜技能组
execute unless block 90081 101 137 minecraft:dark_oak_hanging_sign as @n[tag=SEAfiona_laser_attacking,x=90000,y=100,z=0,distance=0..1200] at @s run function skyblock:sea/e/ch5/fiona_attack_laser
execute unless block 90081 101 137 minecraft:dark_oak_hanging_sign as @n[tag=SEAfiona_laser_attacking_hostile,x=90000,y=100,z=0,distance=0..1200] at @s run function skyblock:sea/e/ch5/fiona_attack_laser_hostile
execute unless block 90081 101 137 minecraft:dark_oak_hanging_sign as @n[tag=SEAfiona,x=90000,y=100,z=0,distance=0..1200] run effect give @s regeneration 5 5 true
...
execute if score SEA_ch5_event_fiona_favor rng1 matches 26.. as @a[tag=SEAPT,advancements={skyblock:sea/doc/g28=false}] at @s run tellraw @s [{"text":"永久奖励：","color":"green","bold": true},{"text": "静滞光棱的影响范围略微增加","color": "white"}]
