...
execute as @a[tag=SEAPT,x=90086,y=122,z=143,distance=0..2.4,tag=!e_i_05,tag=!SEAPF] at @s as @a[distance=0..600,tag=SEAPT,scores={sea_progress=..1}] at @s run tellraw @s [{"text": " - 游戏指引 -","color": "green","bold": true},{"text": " 你的面前出现了怪物！","color": "white","bold": false},{"text": " 但无需慌张，举起手中的武器，尝试击杀它。","color": "white","bold": false},{"text": " 击败怪物将有概率得到对应的奖励。","color": "white","bold": false}]
execute as @a[tag=SEAPT,x=90086,y=122,z=143,distance=0..2.4,tag=!e_i_05,tag=!SEAPF] at @s run summon drowned 90090 122 144 {CustomName:'[{"text":"行走的腐尸"}]',DeathLootTable:"skyblock:sea_drowned1",Tags:["SEAmob"],attributes:[{id:"generic.attack_damage",base:2.0},{id:"movement_speed",base:0.08}]}
...
execute as @a[tag=SEAPT,x=90101,y=122,z=142,distance=0..1.4,tag=!e_i_06,tag=!SEAPF] at @s run summon drowned 90103 125 142 {CustomName:'[{"text":"行走的腐尸"}]',DeathLootTable:"skyblock:sea_drowned1",Tags:["SEAmob"],attributes:[{id:"generic.attack_damage",base:2.0},{id:"movement_speed",base:0.08}]}
