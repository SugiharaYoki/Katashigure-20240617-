...
execute as @a[tag=SEAPT,x=90086,y=122,z=143,distance=0..2.4,tag=!e_i_05,tag=!SEAPF] at @s run tellraw @a[tag=SEAPT,distance=0.1..] [{"selector":"@s","color":"aqua"},{"text":"：","color":"aqua","bold": true},{"text":"\n“转角后面有其他人，你们先别过去！”","color":"white"}]
