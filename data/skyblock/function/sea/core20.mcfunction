...
execute as @n[type=zombie,tag=SEAmob,x=80000,dx=20000,z=-10000,dz=20000,y=-1000,dy=2000,tag=SEAknight] at @s if block ~ ~1.3 ~ water run give @a[tag=SEAPT] mojang_banner_pattern[custom_data={sea_docg26:true}]
