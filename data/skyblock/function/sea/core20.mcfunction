...
execute as @n[type=zombie,tag=SEAmob,x=80000,dx=20000,z=-10000,dz=20000,y=-1000,dy=2000,tag=SEAknight] at @s if block ~ ~-1.1 ~ water run give @a[tag=SEAPT,advancements={skyblock:sea/doc/g26=false}] mojang_banner_pattern[custom_data={sea_docg26:true}]
execute as @n[type=zombie,tag=SEAmob,x=80000,dx=20000,z=-10000,dz=20000,y=-1000,dy=2000] at @s if block ~ ~-1.1 ~ water run kill @s
execute as @n[type=husk,tag=SEAmob,x=80000,dx=20000,z=-10000,dz=20000,y=-1000,dy=2000] at @s if block ~ ~-1.1 ~ water run kill @s
