...
execute as @a[tag=SEAPT,scores={sea_is_running=1..,sea_runs=..0}] at @s run attribute @s generic.movement_speed modifier add sea_running_1a 0.2 add_value
...
execute as @a[tag=SEAPT,scores={sea_is_running=..0,sea_runs=50..}] at @s run scoreboard players remove @s sea_runs 21
