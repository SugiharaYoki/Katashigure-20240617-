...
execute as @a[tag=SEAPT,scores={sea_runs=1}] at @s run attribute @s generic.movement_speed modifier add sea_running_1a 0.09 add_value
execute as @a[tag=SEAPT,scores={sea_runs=5..9}] at @s run attribute @s generic.movement_speed modifier remove sea_running_1a
