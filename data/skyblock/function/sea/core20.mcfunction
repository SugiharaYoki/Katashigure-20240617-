...
execute as @a[tag=SEAPT,scores={sea_is_running=..0,sea_runs=20..}] at @s run scoreboard players set @s sea_runs 0
execute as @a[tag=SEAPT,scores={sea_runs=2}] at @s run attribute @s generic.movement_speed modifier add sea_running_1a 0.09 add_value
execute as @a[tag=SEAPT,scores={sea_runs=6..9}] at @s run attribute @s generic.movement_speed modifier remove sea_running_1a
