...
execute if block 90074 103 136 lectern if entity @a[tag=SEAPT] positioned 90142 134 26 as @n[tag=SEAboss5b,distance=0..250,scores={rng1=1..}] unless entity @n[tag=SEAnorman,type=zombie_villager] at @s run function skyblock:sea/e/ch5/boss5_2
