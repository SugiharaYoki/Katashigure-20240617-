...
execute positioned 90113 149 147 if entity @a[tag=SEAPT,distance=..2.3] unless entity @n[tag=SEAch3_spawn,distance=0..3] positioned 90103 155 138 run function skyblock:sea/m/skeleton_melee
execute positioned 90113 149 147 if entity @a[tag=SEAPT,distance=..2.3] unless entity @n[tag=SEAch3_spawn,distance=0..3] positioned 90102 149 139 run function skyblock:sea/m/drowned
execute positioned 90113 149 147 if entity @a[tag=SEAPT,distance=..2.3] unless entity @n[tag=SEAch3_spawn,distance=0..3] positioned 90102 149 139 run function skyblock:sea/m/drowned
execute positioned 90113 149 147 if entity @a[tag=SEAPT,distance=..2.3] unless entity @n[tag=SEAch3_spawn,distance=0..3] positioned 90102 149 139 run function skyblock:sea/m/drowned
execute positioned 90113 149 147 if entity @a[tag=SEAPT,distance=..2.3] unless entity @n[tag=SEAch3_spawn,distance=0..3] positioned 90102 149 139 run function skyblock:sea/m/drowned
...
execute positioned 90102 149 131 if entity @a[tag=SEAPT,distance=..2.3] unless block 90102 150 130 air as @n[tag=SEAeventch3_m_ston] at @s run data modify entity @s NoAI set value false
execute positioned 90102 149 131 if entity @a[tag=SEAPT,distance=..2.3] unless block 90102 150 130 air run playsound block.candle.extinguish block @a 90101 149 131 1 0.8
execute positioned 90102 149 131 if entity @a[tag=SEAPT,distance=..2.3] unless block 90102 150 130 air run playsound block.candle.extinguish block @a 90103 149 131 1 0.8
execute positioned 90102 149 131 if entity @a[tag=SEAPT,distance=..2.3] unless block 90102 150 130 air run setblock 90101 149 131 minecraft:red_candle[candles=3,lit=false]
execute positioned 90102 149 131 if entity @a[tag=SEAPT,distance=..2.3] unless block 90102 150 130 air run setblock 90103 149 131 minecraft:red_candle[candles=3,lit=false]
execute positioned 90102 149 131 if entity @a[tag=SEAPT,distance=..2.3] unless block 90102 150 130 air run kill @e[type=item,x=90102,y=150,z=130,distance=0..3]
execute positioned 90102 149 131 if entity @a[tag=SEAPT,distance=..2.3] unless block 90102 150 130 air run setblock 90102 150 130 air destroy
