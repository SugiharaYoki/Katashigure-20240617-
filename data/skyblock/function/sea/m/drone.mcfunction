...
execute if score @n[tag=sc] rng2 matches 1 run data modify entity @n[tag=sea_drone] Rotation[0] set value 45
execute if score @n[tag=sc] rng2 matches 2 run data modify entity @n[tag=sea_drone] Rotation[0] set value 135
execute if score @n[tag=sc] rng2 matches 3 run data modify entity @n[tag=sea_drone] Rotation[0] set value 225
execute if score @n[tag=sc] rng2 matches 4 run data modify entity @n[tag=sea_drone] Rotation[0] set value 315
