...
scoreboard players set @n[tag=SEAnorma] rng1 0
scoreboard players set @n[tag=SEAnorma] rng2 0
scoreboard players set @n[tag=SEAnorma] rng3 0
scoreboard players set @n[tag=SEAnorma] rng4 0
scoreboard players set @n[tag=SEAnorma] rng5 0
scoreboard players set @n[tag=SEAnorma] rng6 0
scoreboard players set @n[tag=SEAnorma] rng7 0
scoreboard players set @n[tag=SEAnorma] rng8 0
scoreboard players set @n[tag=SEAnorma] rng9 0
