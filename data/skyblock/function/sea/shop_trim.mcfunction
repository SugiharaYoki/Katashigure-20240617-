...
$tellraw @a[tag=SEAPT,scores={sea_progress=..18}] [{"selector":"@s","color":"dark_purple","italic":true},{"text":"拾取了$(trim_name)石板。","color":"dark_purple","italic":true}]
$tellraw @a[tag=SEAPT,scores={sea_progress=19..}] [{"selector":"@s","color":"dark_purple","italic":true},{"text":"拾取了$(trim_name)石板，你获得双倍。","color":"dark_purple","italic":true}]
