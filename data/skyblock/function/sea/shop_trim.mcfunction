...
$tellraw @a[tag=SEAPT] [{selector:"@s",color:"dark_purple",italic:1b},{text:"拾取了$(trim_name)石板。",color:"dark_purple",italic:1b}]
#$tellraw @a[tag=SEAPT,scores={sea_progress=19..}] [{selector:"@s",color:"dark_purple",italic:1b},{text:"拾取了$(trim_name)石板。",color:"dark_purple",italic:1b}]
