...
execute if entity @s[scores={ishtar_bless_2=20}] run tellraw @s {"text":"    天威「跃空战技」","color":"gold","hoverEvent":{"action":"show_text","contents":{"text":"跃空战技核心×1 给予自己一把重锤 留在背包内时可以在粘液块上一跃而起","color":"white"}}}
