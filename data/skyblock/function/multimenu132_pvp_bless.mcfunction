...
execute unless entity @s[scores={ishtar_bless_2=19}] run tellraw @s {"text":"    搬运「输载归巢」","color":"gray","clickEvent":{"action":"run_command","value":"/trigger MultiMenu set 132019"},"hoverEvent":{"action":"show_text","contents":{"text":"点击装备该礼装","color":"green"}}}
