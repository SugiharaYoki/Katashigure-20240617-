...
execute if entity @s[scores={ishtar_bless_2=9}] run tellraw @s {"text":"    困笼「殆命角斗」","color":"gold","hoverEvent":{"action":"show_text","contents":{"text":"高速堡垒核心×2 搭建落脚堡垒","color":"white"}}}
...
execute if entity @s[scores={ishtar_bless_2=10}] run tellraw @s {"text":"    救赎「顷刻天国」","color":"gold","hoverEvent":{"action":"show_text","contents":{"text":"顷刻天国核心×2 范围内敌我飘升并发光6秒","color":"white"}}}
...
execute unless entity @s[scores={ishtar_bless_2=17}] run tellraw @s {"text":"    归尘「扬烟剧爆」","color":"gray","clickEvent":{"action":"run_command","value":"/trigger MultiMenu set 132017"},"hoverEvent":{"action":"show_text","contents":{"text":"点击装备该礼装","color":"green"}}}
execute if entity @s[scores={ishtar_bless_2=17}] run tellraw @s {"text":"    归尘「扬烟剧爆」","color":"gold","hoverEvent":{"action":"show_text","contents":{"text":"扬烟剧爆核心×2 在身边召唤引燃的TNT","color":"white"}}}
