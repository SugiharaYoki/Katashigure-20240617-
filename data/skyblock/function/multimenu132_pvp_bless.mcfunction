...
execute if entity @s[scores={ishtar_bless_2=4}] run tellraw @s {"text":"    湖灯「雷厄渡水」","color":"gold","hoverEvent":{"action":"show_text","contents":{"text":"忠诚引雷三叉戟×1","color":"white"}}}
execute unless entity @s[scores={ishtar_bless_2=4}] run tellraw @s {"text":"    湖灯「雷厄渡水」","color":"gray","clickEvent":{"action":"run_command","value":"/trigger MultiMenu set 132004"},"hoverEvent":{"action":"show_text","contents":{"text":"点击装备该礼装","color":"green"}}}
