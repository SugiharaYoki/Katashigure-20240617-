...
execute as @s at @s[tag=purchasesuccess] run give @s potion{CustomPotionEffects:[{Id:10,Amplifier:7,Duration:36000},{Id:11,Amplifier:7,Duration:36000},{Id:14,Amplifier:0,Duration:36000}],display:{Name:"{\"text\":\"抹茶拿铁\",\"color\":\"white\",\"italic\":false}",Lore:["{\"text\":\"积木书房饮料吧台的特色饮品。\",\"color\":\"blue\",\"italic\":false}"]},CustomPotionColor:8191829} 1
