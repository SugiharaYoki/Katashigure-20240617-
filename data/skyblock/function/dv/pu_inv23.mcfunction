...
execute if entity @n[tag=sc,scores={SeGa_DVInv23=0}] as @s[tag=!purchasedone] at @s[tag=purchasesuccess] run scoreboard players set @n[tag=sc] SeGa_DVInv23 1
...
execute if entity @n[tag=sc,scores={SeGa_DVInv23=1}] as @s[tag=!purchasedone] at @s[tag=purchasesuccess] run scoreboard players set @n[tag=sc] SeGa_DVInv23 2
execute as @s at @s[tag=purchasesuccess] run tag @s add purchasedone
execute as @s at @s[tag=purchasesuccess] run tag @s remove purchasesuccess
