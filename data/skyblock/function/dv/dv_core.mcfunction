...
execute if entity @n[tag=sc,scores={SeGa_DVTimer=6..,rng5=1..2,rng2=1},tag=DVC1] as @e[tag=SeGaDVMob,type=piglin] at @s run data modify entity @s Brain.memories.minecraft:angry_at.value set from entity @e[type=villager,sort=nearest,limit=1,tag=SeGaDVProt] UUID
execute if entity @n[tag=sc,scores={SeGa_DVTimer=6..,rng5=1..2,rng2=1},tag=DVC1] as @e[tag=SeGaDVMob,type=piglin_brute] at @s run data modify entity @s Brain.memories.minecraft:angry_at.value set from entity @e[type=villager,sort=nearest,limit=1,tag=SeGaDVProt] UUID
execute if entity @n[tag=sc,scores={SeGa_DVTimer=6..,rng5=1..2,rng2=1},tag=DVC1] as @e[tag=SeGaDVMob,type=wolf] at @s run data modify entity @s Brain.memories.minecraft:angry_at.value set from entity @e[type=villager,sort=nearest,limit=1,tag=SeGaDVProt] UUID
