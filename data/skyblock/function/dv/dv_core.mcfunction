...
execute if entity @n[tag=sc,scores={SeGa_DVTimer=1}] run summon villager -90001 105 56 {VillagerData:{profession:clerik,level:99,type:savanna},Tags:["SeGaDVProt"],PersistenceRequired:1,Silent:0,NoAI:1,Rotation:[180f,0f],CustomName:"\"云端亭主\"",Attributes:[{Name:"generic.max_health",Base:100.0},{Name:"generic.armor",Base:10.0},{Name:"generic.armor_toughness",Base:5.0}],Health:100.0f}
...
execute if entity @n[tag=sc,scores={SeGa_DVTimer=6..,rng5=1..2,rng2=1},tag=DVC1] as @e[tag=SeGaDVMob,type=piglin] at @s run data modify entity @s Brain.memories.angry_at.value set from entity @e[type=villager,sort=nearest,limit=1,tag=SeGaDVProt] UUID
execute if entity @n[tag=sc,scores={SeGa_DVTimer=6..,rng5=1..2,rng2=1},tag=DVC1] as @e[tag=SeGaDVMob,type=piglin_brute] at @s run data modify entity @s Brain.memories.angry_at.value set from entity @e[type=villager,sort=nearest,limit=1,tag=SeGaDVProt] UUID
execute if entity @n[tag=sc,scores={SeGa_DVTimer=6..,rng5=1..2,rng2=1},tag=DVC1] as @e[tag=SeGaDVMob,type=wolf] at @s run data modify entity @s Brain.memories.angry_at.value set from entity @e[type=villager,sort=nearest,limit=1,tag=SeGaDVProt] UUID
...
execute if entity @n[tag=sc,scores={SeGa_DVTimer=41,SeGa_DVStage=6}] positioned -90001 81 56 run summon piglin_brute ~ ~ ~ {PersistenceRequired:1,Tags:["SeGaDVMob","20MAXHP"],DeathLootTable:"skyblock:defendcreeper_money_tier5",Attributes:[{Name:generic.knockback_resistance,Base:1.0},{Name:generic.armor_toughness,Base:1.0},{Name:generic.follow_range,Base:80.0},{Name:generic.armor,Base:9.5},{Name:generic.max_health,Base:20.0},{Name:generic.movement_speed,Base:0.139}],Health:20.0f,CustomName:"\"？？？\"",IsImmuneToZombification:1,IsBaby:0,HandItems:[{Count:1,id:"netherite_sword",tag:{Enchantments:[{id:"minecraft:sharpness",lvl:2}]}}],HandDropChances:[0.00f]}
execute if entity @n[tag=sc,scores={SeGa_DVTimer=41,SeGa_DVStage=6}] positioned -90001 81 56 run summon piglin_brute ~ ~ ~ {PersistenceRequired:1,Tags:["SeGaDVMob","20MAXHP"],DeathLootTable:"skyblock:defendcreeper_money_tier5",Attributes:[{Name:generic.knockback_resistance,Base:1.0},{Name:generic.armor_toughness,Base:1.0},{Name:generic.follow_range,Base:80.0},{Name:generic.armor,Base:9.5},{Name:generic.max_health,Base:20.0},{Name:generic.movement_speed,Base:0.139}],Health:20.0f,CustomName:"\"？？？\"",IsImmuneToZombification:1,IsBaby:0,HandItems:[{Count:1,id:"netherite_sword",tag:{Enchantments:[{id:"minecraft:sharpness",lvl:2}]}}],HandDropChances:[0.00f]}
execute if entity @n[tag=sc,scores={SeGa_DVTimer=41,SeGa_DVStage=6}] run tellraw @a[tag=SeGa_DVA] {"text":"警告！猪灵蛮兵即将现身！","color":"red"}

execute if entity @n[tag=sc,scores={SeGa_DVTimer=44,SeGa_DVStage=10}] positioned -90001 81 56 run summon piglin_brute ~ ~ ~ {PersistenceRequired:1,Tags:["SeGaDVMob","40MAXHP"],DeathLootTable:"skyblock:defendcreeper_money_tier5",Attributes:[{Name:generic.knockback_resistance,Base:1.0},{Name:generic.armor_toughness,Base:2.0},{Name:generic.follow_range,Base:80.0},{Name:generic.armor,Base:12.5},{Name:generic.max_health,Base:40.0},{Name:generic.movement_speed,Base:0.139}],Health:40.0f,CustomName:"\"？？？\"",IsImmuneToZombification:1,IsBaby:0,HandItems:[{Count:1,id:"netherite_sword",tag:{Enchantments:[{id:"minecraft:sharpness",lvl:3}]}}],HandDropChances:[0.00f]}
execute if entity @n[tag=sc,scores={SeGa_DVTimer=44,SeGa_DVStage=10}] positioned -90001 81 56 run summon piglin_brute ~ ~ ~ {PersistenceRequired:1,Tags:["SeGaDVMob","40MAXHP"],DeathLootTable:"skyblock:defendcreeper_money_tier5",Attributes:[{Name:generic.knockback_resistance,Base:1.0},{Name:generic.armor_toughness,Base:2.0},{Name:generic.follow_range,Base:80.0},{Name:generic.armor,Base:12.5},{Name:generic.max_health,Base:40.0},{Name:generic.movement_speed,Base:0.139}],Health:40.0f,CustomName:"\"？？？\"",IsImmuneToZombification:1,IsBaby:0,HandItems:[{Count:1,id:"netherite_sword",tag:{Enchantments:[{id:"minecraft:sharpness",lvl:3}]}}],HandDropChances:[0.00f]}
