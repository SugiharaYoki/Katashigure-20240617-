...
execute if entity @n[tag=sc,scores={SeGa_DVTimer=40,SeGa_DVStage=40}] run function skyblock:dv/dv_creeper_summon_gen
execute if entity @n[tag=sc,scores={SeGa_DVTimer=41,SeGa_DVStage=40}] run function skyblock:dv/dv_creeper_summon_gen
...
execute if entity @n[tag=sc,scores={SeGa_DVTimer=40,SeGa_DVStage=50}] run function skyblock:dv/dv_creeper_summon_gen
execute if entity @n[tag=sc,scores={SeGa_DVTimer=41,SeGa_DVStage=50}] run function skyblock:dv/dv_creeper_summon_gen
execute if entity @n[tag=sc,scores={SeGa_DVTimer=42,SeGa_DVStage=50}] run function skyblock:dv/dv_creeper_summon_gen
execute if entity @n[tag=sc,scores={SeGa_DVTimer=43,SeGa_DVStage=50}] run function skyblock:dv/dv_creeper_summon_gen
...
execute if entity @n[tag=sc,scores={SeGa_DVTimer=40,SeGa_DVStage=60}] run function skyblock:dv/dv_creeper_summon_gen
execute if entity @n[tag=sc,scores={SeGa_DVTimer=42,SeGa_DVStage=60}] run function skyblock:dv/lib_piglin_leader
execute if entity @n[tag=sc,scores={SeGa_DVTimer=44,SeGa_DVStage=60}] run function skyblock:dv/dv_creeper_summon_gen
execute if entity @n[tag=sc,scores={SeGa_DVTimer=45,SeGa_DVStage=60}] run function skyblock:dv/dv_creeper_summon_gen
execute if entity @n[tag=sc,scores={SeGa_DVTimer=46,SeGa_DVStage=60}] run function skyblock:dv/dv_creeper_summon_gen
execute if entity @n[tag=sc,scores={SeGa_DVTimer=47,SeGa_DVStage=60}] run function skyblock:dv/dv_creeper_summon_gen
execute if entity @n[tag=sc,scores={SeGa_DVTimer=48,SeGa_DVStage=60}] run function skyblock:dv/dv_creeper_summon_gen
execute if entity @n[tag=sc,scores={SeGa_DVTimer=49,SeGa_DVStage=60}] run function skyblock:dv/dv_creeper_summon_gen
execute if entity @n[tag=sc,scores={SeGa_DVTimer=50,SeGa_DVStage=60}] run function skyblock:dv/dv_creeper_summon_gen
execute if entity @n[tag=sc,scores={SeGa_DVTimer=52,SeGa_DVStage=60}] run function skyblock:dv/lib_piglin_leader


execute if entity @n[tag=sc,scores={rng4=1,rng9=1}] as @e[type=piglin_brute,tag=PiglinLeader,tag=SeGaDVMob] at @s run summon magma_cube ~ ~ ~1 {PersistenceRequired:1b,Tags:["10MAXHP"],DeathLootTable:"skyblock:defendcreeper_money_tier1",Attributes:[{Name:generic.follow_range,Base:40.0},{Name:generic.armor,Base:1.0},{Name:generic.max_health,Base:10.0}],Health:10.0f,CustomName:"\"？？？\""}
execute if entity @n[tag=sc,scores={rng4=2,rng9=1}] as @e[type=piglin_brute,tag=PiglinLeader,tag=SeGaDVMob] at @s run summon magma_cube ~ ~ ~-1 {PersistenceRequired:1b,Tags:["10MAXHP"],DeathLootTable:"skyblock:defendcreeper_money_tier1",Attributes:[{Name:generic.follow_range,Base:40.0},{Name:generic.armor,Base:1.0},{Name:generic.max_health,Base:10.0}],Health:10.0f,CustomName:"\"？？？\""}
execute if entity @n[tag=sc,scores={rng4=3,rng9=1}] as @e[type=piglin_brute,tag=PiglinLeader,tag=SeGaDVMob] at @s run summon magma_cube ~1 ~ ~ {PersistenceRequired:1b,Tags:["10MAXHP"],DeathLootTable:"skyblock:defendcreeper_money_tier1",Attributes:[{Name:generic.follow_range,Base:40.0},{Name:generic.armor,Base:1.0},{Name:generic.max_health,Base:10.0}],Health:10.0f,CustomName:"\"？？？\""}
execute if entity @n[tag=sc,scores={rng4=4,rng9=1}] as @e[type=piglin_brute,tag=PiglinLeader,tag=SeGaDVMob] at @s run summon magma_cube ~-1 ~ ~ {PersistenceRequired:1b,Tags:["10MAXHP"],DeathLootTable:"skyblock:defendcreeper_money_tier1",Attributes:[{Name:generic.follow_range,Base:40.0},{Name:generic.armor,Base:1.0},{Name:generic.max_health,Base:10.0}],Health:10.0f,CustomName:"\"？？？\""}