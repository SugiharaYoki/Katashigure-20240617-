...
execute if entity @n[tag=sc,scores={rng4=1,rng9=1}] as @e[type=piglin_brute,tag=PiglinLeader,tag=SeGaDVMob] at @s run summon magma_cube ~ ~ ~1 {PersistenceRequired:1b,Tags:["10MAXHP"],DeathLootTable:"skyblock:defendcreeper_money_tier1",attributes:[{id:"generic.follow_range",base:40.0},{id:"generic.armor",base:1.0},{Name:generic.max_health,Base:10.0}],Health:10.0f,CustomName:"\"？？？\""}
