...
summon villager -90001 105 56 {VillagerData:{profession:clerik,level:99,type:savanna},Invulnerable:1b,PersistenceRequired:1b,Silent:0b,NoAI:1,Rotation:[180f,0f],CustomName:"\"云亭攻防战 · 接待员\"",attributes:[{id:"generic.max_health",base:400.0},{id:"generic.armor",base:40.0},{Name:"generic.armor_toughness",Base:40.0}],Health:400.0f}
