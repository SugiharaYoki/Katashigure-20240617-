...
summon villager -90001 105 56 {VillagerData:{profession:clerik,level:99,type:savanna},Invulnerable:1,PersistenceRequired:1,Silent:0,NoAI:1,Rotation:[180f,0f],CustomName:"\"云亭攻防战 · 接待员\"",Attributes:[{Name:"generic.max_health",Base:400.0},{Name:"generic.armor",Base:40.0},{Name:"generic.armor_toughness",Base:40.0}],Health:400.0f}
