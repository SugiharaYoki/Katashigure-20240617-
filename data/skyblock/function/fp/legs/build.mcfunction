...
$execute as 0-0-0-0-0 if entity @s[tag=fp_sc] rotated 0 -90 run function skyblock:fp/legs/world_entity_set_target {leg_id:$(leg_id),subid:1,length:1.0d}

$data modify storage leg_data list[{leg_id:$(leg_id)}].value append value {subid:2,start:[0d,0d,0d],end:[0d,0d,0d],width:0.3d,length:0.3d,height:1.0d}
...
$execute as 0-0-0-0-0 if entity @s[tag=fp_sc] rotated 0 -90 run function skyblock:fp/legs/world_entity_set_target {leg_id:$(leg_id),subid:2,length:1.0d}
...
$execute as 0-0-0-0-0 if entity @s[tag=fp_sc] rotated 0 -90 run function skyblock:fp/legs/world_entity_set_target {leg_id:$(leg_id),subid:3,length:1.0d}
