...
$execute as 0-0-0-0-0 if entity @s[tag=fp_sc] run function skyblock:fp/legs/world_entity_set_target {leg_id:$(leg_id),subid:1,length:1.0d}
...
$execute as 0-0-0-0-0 if entity @s[tag=fp_sc] run function skyblock:fp/legs/world_entity_set_target {leg_id:$(leg_id),subid:2,length:1.0d}
...
$execute as 0-0-0-0-0 if entity @s[tag=fp_sc] run function skyblock:fp/legs/world_entity_set_target {leg_id:$(leg_id),subid:3,length:1.0d}
