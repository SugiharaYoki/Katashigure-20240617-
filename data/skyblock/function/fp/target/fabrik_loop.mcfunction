...
execute if score fabrik_id festering_leg_subid matches ..1 run scoreboard players set fabrik_delta festering_fabrik 1
$execute if score fabrik_id festering_leg_subid matches $(count).. run scoreboard players add fabrik_count festering_fabrik 1
$execute if score fabrik_id festering_leg_subid matches $(count).. run scoreboard players set fabrik_delta festering_fabrik -1
