execute if score fabrik_delta festering_fabrik matches -1 run tellraw @a[tag=DebugMode] [{"text":"backward第"},{"score": {"name": "fabrik_count","objective": "festering_fabrik"}},{"text":"次,id:"},{"score":{"name": "fabrik_id","objective": "festering_fabrik"}}]
execute if score fabrik_delta festering_fabrik matches 1 run tellraw @a[tag=DebugMode] [{"text":"forward第"},{"score": {"name": "fabrik_count","objective": "festering_fabrik"}},{"text":"次,id:"},{"score":{"name": "fabrik_id","objective": "festering_fabrik"}}]
