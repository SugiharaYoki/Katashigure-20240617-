...
execute if score fabrik_id festering_fabrik matches ..1 run scoreboard players set fabric_delta festering_fabrik 1
$execute if score fabrik_id festering_fabrik matches $(count).. run scoreboard players add fabrik_count festering_fabrik 1
$execute if score fabrik_id festering_fabrik matches $(count).. run scoreboard players set fabric_delta festering_fabrik -1
