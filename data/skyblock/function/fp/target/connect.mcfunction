...
execute store result storage temp:matrix display.half_width[3] double 0.01 run scoreboard players get temp_width festering_math
execute store result storage temp:matrix display.half_width[11] double 0.01 run scoreboard players get temp_length festering_math
#获得矩阵
