...
$execute if entity @s[tag=ishtar_lantern_success_1] at @s positioned ~ ~0.1 ~ run function skyblock:pvp/skywar/bless/skywar_ishtar_core37p {distance:$(If_Bless37),block_state:copper_block,particle1:0.2,particle2:0.2,particle3:1.0}
$execute if entity @s[tag=ishtar_lantern_success_2] at @s positioned ~ ~0.1 ~ run function skyblock:pvp/skywar/bless/skywar_ishtar_core37p {distance:$(If_Bless37),block_state:crimson_nylium,particle1:1.0,particle2:0.2,particle3:0.2}
$execute if entity @s[tag=ishtar_lantern_success_3] at @s positioned ~ ~0.1 ~ run function skyblock:pvp/skywar/bless/skywar_ishtar_core37p {distance:$(If_Bless37),block_state:warped_nylium,particle1:0.2,particle2:1.0,particle3:0.2}
...
$execute if entity @s[team=Team1_1] if items entity @a[distance=..$(If_Bless37),team=Team1_1] container.* *[custom_data={skywar_ishtar_1:1}] as @a[distance=..$(If_Bless37),team=Team1_1] run xp add @s[level=..60] 1 points
$execute if entity @s[team=Team1_2] if items entity @a[distance=..$(If_Bless37),team=Team1_2] container.* *[custom_data={skywar_ishtar_1:1}] as @a[distance=..$(If_Bless37),team=Team1_2] run xp add @s[level=..60] 1 points
$execute if entity @s[team=Team1_3] if items entity @a[distance=..$(If_Bless37),team=Team1_3] container.* *[custom_data={skywar_ishtar_1:1}] as @a[distance=..$(If_Bless37),team=Team1_3] run xp add @s[level=..60] 1 points
$execute if entity @s[team=Team1_4] if items entity @a[distance=..$(If_Bless37),team=Team1_4] container.* *[custom_data={skywar_ishtar_1:1}] as @a[distance=..$(If_Bless37),team=Team1_4] run xp add @s[level=..60] 1 points
$execute if entity @s[team=Team1_5] if items entity @a[distance=..$(If_Bless37),team=Team1_5] container.* *[custom_data={skywar_ishtar_1:1}] as @a[distance=..$(If_Bless37),team=Team1_5] run xp add @s[level=..60] 1 points
$execute if entity @s[team=Team1_6] if items entity @a[distance=..$(If_Bless37),team=Team1_6] container.* *[custom_data={skywar_ishtar_1:1}] as @a[distance=..$(If_Bless37),team=Team1_6] run xp add @s[level=..60] 1 points
$execute if entity @s[team=Team1_7] if items entity @a[distance=..$(If_Bless37),team=Team1_7] container.* *[custom_data={skywar_ishtar_1:1}] as @a[distance=..$(If_Bless37),team=Team1_7] run xp add @s[level=..60] 1 points
$execute if entity @s[team=Team1_8] if items entity @a[distance=..$(If_Bless37),team=Team1_8] container.* *[custom_data={skywar_ishtar_1:1}] as @a[distance=..$(If_Bless37),team=Team1_8] run xp add @s[level=..60] 1 points
