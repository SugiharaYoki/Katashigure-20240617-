...
execute at @s[scores={rng1=25}] if entity @s[x=50000,y=0,z=50000,distance=..1500] run summon silverfish ~ ~ ~ {Health:23.5f,Attributes:[{Name:"generic.maxHealth",Base:23.5}]}
execute at @s[scores={rng1=25}] if entity @s[x=50000,y=0,z=50000,distance=..1500] run summon silverfish ~ ~ ~ {Health:23.5f,Attributes:[{Name:"generic.maxHealth",Base:23.5}]}
