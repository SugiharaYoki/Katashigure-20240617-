execute unless score @s rng1 matches 1.. if entity @a[gamemode=!spectator,distance=0..1.8] run scoreboard players set @s rng1 1
...
execute at @s[scores={rng1=25}] if entity @s[x=50000,y=0,z=50000,distance=..1500] run summon tnt ~ ~ ~ {fuse:0,explosion_power:2}
execute at @s[scores={rng1=25}] if entity @s[x=50000,y=0,z=50000,distance=..1500] run summon silverfish ~ ~ ~ {Health:40f,attributes:[{id:"max_health",base:40}]}
execute at @s[scores={rng1=25}] if entity @s[x=50000,y=0,z=50000,distance=..1500] run summon silverfish ~ ~ ~ {Health:40f,attributes:[{id:"max_health",base:40}]}
