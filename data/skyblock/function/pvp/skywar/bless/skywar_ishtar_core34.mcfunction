...
execute as @e[tag=Bless34,type=item] at @s run summon endermite ~ ~ ~ {Tags:["Skywar_Bless34"],attributes:[{id:"generic.attack_damage",base:2.0},{id:"generic.movement_speed",base:0.32},{id:"generic.follow_range",base:64},{id:"generic.scale",base:0.3},{id:"generic.max_health",base:1}]}
