...
execute if score @s rng7 matches 600 if entity @s[tag=Skywar_Bless36_1] at @s as @a[team=Team1_1] if items entity @s container.* *[custom_data={skywar:1,skywar_ishtar_10:1}] run give @s music_disc_strad[custom_name='{text:"顷刻天国核心","italic":false,color:"green"}',custom_data={skywar:1,skywar_ishtar_10:1},max_stack_size=10] 1
execute if score @s rng7 matches 600 if entity @s[tag=Skywar_Bless36_2] at @s as @a[team=Team1_2] if items entity @s container.* *[custom_data={skywar:1,skywar_ishtar_10:1}] run give @s music_disc_strad[custom_name='{text:"顷刻天国核心","italic":false,color:"green"}',custom_data={skywar:1,skywar_ishtar_10:1},max_stack_size=10] 1
execute if score @s rng7 matches 600 if entity @s[tag=Skywar_Bless36_3] at @s as @a[team=Team1_3] if items entity @s container.* *[custom_data={skywar:1,skywar_ishtar_10:1}] run give @s music_disc_strad[custom_name='{text:"顷刻天国核心","italic":false,color:"green"}',custom_data={skywar:1,skywar_ishtar_10:1},max_stack_size=10] 1
execute if score @s rng7 matches 600 if entity @s[tag=Skywar_Bless36_4] at @s as @a[team=Team1_4] if items entity @s container.* *[custom_data={skywar:1,skywar_ishtar_10:1}] run give @s music_disc_strad[custom_name='{text:"顷刻天国核心","italic":false,color:"green"}',custom_data={skywar:1,skywar_ishtar_10:1},max_stack_size=10] 1
execute if score @s rng7 matches 600 if entity @s[tag=Skywar_Bless36_5] at @s as @a[team=Team1_5] if items entity @s container.* *[custom_data={skywar:1,skywar_ishtar_10:1}] run give @s music_disc_strad[custom_name='{text:"顷刻天国核心","italic":false,color:"green"}',custom_data={skywar:1,skywar_ishtar_10:1},max_stack_size=10] 1
execute if score @s rng7 matches 600 if entity @s[tag=Skywar_Bless36_6] at @s as @a[team=Team1_6] if items entity @s container.* *[custom_data={skywar:1,skywar_ishtar_10:1}] run give @s music_disc_strad[custom_name='{text:"顷刻天国核心","italic":false,color:"green"}',custom_data={skywar:1,skywar_ishtar_10:1},max_stack_size=10] 1
execute if score @s rng7 matches 600 if entity @s[tag=Skywar_Bless36_7] at @s as @a[team=Team1_7] if items entity @s container.* *[custom_data={skywar:1,skywar_ishtar_10:1}] run give @s music_disc_strad[custom_name='{text:"顷刻天国核心","italic":false,color:"green"}',custom_data={skywar:1,skywar_ishtar_10:1},max_stack_size=10] 1
execute if score @s rng7 matches 600 if entity @s[tag=Skywar_Bless36_8] at @s as @a[team=Team1_8] if items entity @s container.* *[custom_data={skywar:1,skywar_ishtar_10:1}] run give @s music_disc_strad[custom_name='{text:"顷刻天国核心","italic":false,color:"green"}',custom_data={skywar:1,skywar_ishtar_10:1},max_stack_size=10] 1
