...
execute if entity @s[scores={If_Bless21b=22..}] as @s at @s rotated as @s run rotate @s ~10 0

execute if entity @s[scores={If_Bless21b=21..}] run execute positioned 0.0 0 0.0 run summon marker ^ ^0.05 ^3 {Tags:["bless21b_arrow_spot_1","bless21b_arrow_spot"]}
...
execute if entity @s[scores={If_Bless21b=21..}] run execute positioned 0.0 0 0.0 run summon marker ^ ^0.05 ^-3 {Tags:["bless21b_arrow_spot_2","bless21b_arrow_spot"]}
...
execute if entity @s[scores={If_Bless21b=21..}] run execute positioned 0.0 0 0.0 run summon marker ^3 ^0.05 ^ {Tags:["bless21b_arrow_spot_3","bless21b_arrow_spot"]}
...
execute if entity @s[scores={If_Bless21b=21..}] run execute positioned 0.0 0 0.0 run summon marker ^-3 ^0.05 ^ {Tags:["bless21b_arrow_spot_4","bless21b_arrow_spot"]}
