...
execute if entity @s[level=8..,predicate=!skyblock:sneak] at @s rotated as @s anchored eyes run function skyblock:pvp/skywar/bless/skywar_ishtar_core18_position_reach
