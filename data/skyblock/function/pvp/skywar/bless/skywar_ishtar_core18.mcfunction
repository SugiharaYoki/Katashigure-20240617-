...
execute if entity @s[level=8..,predicate=!skyblock:sneak] at @s as @n[type=marker,tag=Skywar_ishtar_18_position_reach] at @s rotated as @s positioned ~ ~1.5 ~ run function skyblock:pvp/skywar/bless/skywar_ishtar_core18_position_reach
