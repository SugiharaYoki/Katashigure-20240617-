...
execute if entity @s[level=8..,predicate=!skyblock:sneak] at @s rotated as @s anchored eyes at @s as @n[type=marker,tag=Skywar_ishtar_18_position_reach] run tp @s ~ ~1.5 ~
