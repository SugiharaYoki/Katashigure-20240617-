...
execute if entity @s[team=Team1_1] at @n[tag=Skywar_Bless36_1,type=marker] run setblock ~ ~ ~ air
execute if entity @s[team=Team1_2] at @n[tag=Skywar_Bless36_2,type=marker] run setblock ~ ~ ~ air
execute if entity @s[team=Team1_3] at @n[tag=Skywar_Bless36_3,type=marker] run setblock ~ ~ ~ air
execute if entity @s[team=Team1_4] at @n[tag=Skywar_Bless36_4,type=marker] run setblock ~ ~ ~ air
execute if entity @s[team=Team1_5] at @n[tag=Skywar_Bless36_5,type=marker] run setblock ~ ~ ~ air
execute if entity @s[team=Team1_6] at @n[tag=Skywar_Bless36_6,type=marker] run setblock ~ ~ ~ air
execute if entity @s[team=Team1_7] at @n[tag=Skywar_Bless36_7,type=marker] run setblock ~ ~ ~ air
execute if entity @s[team=Team1_8] at @n[tag=Skywar_Bless36_8,type=marker] run setblock ~ ~ ~ air
