...
execute if entity @s[team=Team1_1] at @n[tag=Skywar_Bless36_1,type=marker] unless block ~ ~-1 ~ bedrock run setblock ~ ~-1 ~ air
execute if entity @s[team=Team1_2] at @n[tag=Skywar_Bless36_2,type=marker] unless block ~ ~-1 ~ bedrock run setblock ~ ~-1 ~ air
execute if entity @s[team=Team1_3] at @n[tag=Skywar_Bless36_3,type=marker] unless block ~ ~-1 ~ bedrock run setblock ~ ~-1 ~ air
execute if entity @s[team=Team1_4] at @n[tag=Skywar_Bless36_4,type=marker] unless block ~ ~-1 ~ bedrock run setblock ~ ~-1 ~ air
execute if entity @s[team=Team1_5] at @n[tag=Skywar_Bless36_5,type=marker] unless block ~ ~-1 ~ bedrock run setblock ~ ~-1 ~ air
execute if entity @s[team=Team1_6] at @n[tag=Skywar_Bless36_6,type=marker] unless block ~ ~-1 ~ bedrock run setblock ~ ~-1 ~ air
execute if entity @s[team=Team1_7] at @n[tag=Skywar_Bless36_7,type=marker] unless block ~ ~-1 ~ bedrock run setblock ~ ~-1 ~ air
execute if entity @s[team=Team1_8] at @n[tag=Skywar_Bless36_8,type=marker] unless block ~ ~-1 ~ bedrock run setblock ~ ~-1 ~ air
...
tag @s remove Skywar_Bless36_InVoid