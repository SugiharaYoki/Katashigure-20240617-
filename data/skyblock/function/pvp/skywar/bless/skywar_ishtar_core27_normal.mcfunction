...
execute if entity @s[tag=ishtar_27_direction1] unless block ~ ~1 ~-1 bedrock unless block ~ ~1 ~-2 bedrock unless block ~ ~1 ~-3 bedrock unless block ~ ~1 ~-2 bedrock run fill ~ ~ ~ ~ ~1 ~-2 air destroy
execute if entity @s[tag=ishtar_27_direction2] unless block ~1 ~1 ~ bedrock unless block ~2 ~1 ~ bedrock unless block ~3 ~1 ~ bedrock unless block ~2 ~1 ~ bedrock run fill ~ ~ ~ ~2 ~1 ~ air destroy
execute if entity @s[tag=ishtar_27_direction3] unless block ~ ~1 ~1 bedrock unless block ~ ~1 ~2 bedrock unless block ~ ~1 ~3 bedrock unless block ~ ~1 ~2 bedrock run fill ~ ~ ~ ~ ~1 ~2 air destroy
execute if entity @s[tag=ishtar_27_direction4] unless block ~-1 ~1 ~ bedrock unless block ~-2 ~1 ~ bedrock unless block ~-3 ~1 ~ bedrock unless block ~-2 ~1 ~ bedrock run fill ~ ~ ~ ~-2 ~1 ~ air destroy
