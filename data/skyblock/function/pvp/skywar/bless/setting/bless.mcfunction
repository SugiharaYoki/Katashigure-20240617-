...
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"建筑师"', title:'"困笼「殆命角斗」"', description:'"高速堡垒核心×2 Q丢出时，搭建落脚堡垒\\\\n使用后还会获得5秒的跳跃提升\\\\n留在背包内时增加挖掘速度（无法叠加）\\\\n\\\\n注意：如果错过了跳跃提升，这个困笼无法在通常状态下跳出"', id: 9, idsh: 9, pos: 0, idloop: 9}
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"建筑师"', title:'"搬运「输载归初」"', description:'"输载归初核心×4 Q丢出时，将周围3格内的宝箱全部刷新成蛋糕盒\\\\n下蹲可以直接破坏脚下的潜影盒，并创造一个减速圆环，消耗一枚核心\\\\n经过减速圆环的敌方玩家将获得减速效果\\\\n\\\\n小提示：可用于快速抢夺箱子"', id: 19, idsh: 19, pos: 0, idloop: 19}
...
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"圣女"', title:'"救赎「顷刻天国」"', description:'"顷刻天国核心×2 Q丢出时，范围内敌我飘升并发光6秒\\\\n留在背包内时不会陷入中毒状态"', id: 10, idsh: 10, pos: 0, idloop: 10}
...
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"圣骑士"', title:'"神威「陨落压制」"', description:'"陨落压制核心×3 Q丢出时，范围内其他玩家（包括友军）速度完全压制但接近无敌\\\\n\\\\n注意：虽然能够预防跳跃，但是这一效果的持续时长要远短于减速的时长"', id: 11, idsh: 11, pos: 0, idloop: 11}
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"圣骑士"', title:'"天威「跃空战技」"', description:'"粘液块×3、跃空战技核心×2 Q丢出时，给予自己一把重锤\\\\n留在背包内时，可以在粘液块/蛋糕上一跃而起\\\\n留在背包内时，蹲下后跳跃能力短暂增强\\\\n\\\\n小提示：推荐自己寻找重锤"', id: 20, idsh: 20, pos: 0, idloop: 20}
...
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"尘埃法师"', title:'"归尘「扬焱剧爆」"', description:'"扬焱剧爆核心×2 Q丢出时，在身边召唤引燃的TNT，该TNT引爆速度比普通TNT快30%\\\\n使用后会立刻获得4个TNT"', id: 17, idsh: 17, pos: 0, idloop: 17}
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"尘埃法师"', title:'"唤尘「漆幕虚垒」"', description:'"漆幕虚垒核心×4 Q丢出时，在面前4格处召唤持续十数秒的烟幕"', id: 18, idsh: 18, pos: 0, idloop: 18}
