...
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"影猎手"', title:'"猎夜「彻锋戮影」"', description:'"高速移动靴×1 略微减少生命值\\\\n穿戴后，当有敌人在自己的1格内时，使对方失明3秒"', id: 5, idsh: 5, pos: 0, idloop: 5}
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"影猎手"', title:'"袖剑「初绽轮月」"', description:'"慢速高攻击剑×1 增加移动速度但减少自身防御力\\\\n自带火焰附加I\\\\n对敌人一次性造成一定量的伤害后可以让自己隐身3秒\\\\n\\\\n注意：只在主手使用时有效"', id: 6, idsh: 6, pos: 0, idloop: 6}
...
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"影猎手"', title:'"夜城「刺客尊荣」"', description:'"特殊模板 放置于背包时5格内隐身玩家显形\\\\n\\\\n12格内有玩家时发出警报\\\\n并加速自身充能"', id: 16, idsh: 16, pos: 0, idloop: 16}
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"影猎手"', title:'"泯没「丛禾蓦至」"', description:'"特殊模板 放置于背包时，可以通过下蹲加速自身充能\\\\n在草丛中蹲下可以隐身"', id: 28, idsh: 28, pos: 1, idloop: 2}
...
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"驯兽师"', title:'"命唤「尸亡重兽」"', description:'"特殊模板 放置于背包时每隔20秒获得刷怪蛋×1\\\\n\\\\n可能获得的刷怪蛋：蠹虫、岩浆怪、僵尸疣猪兽\\\\n\\\\n连携效果：若自身拥有「暗行豸螨」，则还有概率获得龙息"', id: 7, idsh: 7, pos: 0, idloop: 7}
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"驯兽师"', title:'"割荒「暗行豸螨」"', description:'"龙息×2 特殊模板 手持时将周围15格的龙息掉落物转换为炸弹螨\\\\n炸弹螨在有玩家接近时会剧烈爆炸，并生成2只特殊的蠹虫"', id: 34, idsh: 34, pos: 1, idloop: 8}
...
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"建筑师"', title:'"困笼「殆命角斗」"', description:'"高速堡垒核心 消耗10 Q丢出时，搭建落脚堡垒\\\\n - 通常时掷出：角斗困笼\\\\n - 下蹲时掷出：高速哨塔\\\\n\\\\n使用后还会获得5秒的跳跃提升\\\\n留在背包内时增加挖掘速度（无法叠加）\\\\n\\\\n注意：如果错过了跳跃提升，这个困笼无法在通常状态下跳出"', id: 9, idsh: 9, pos: 0, idloop: 9}
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"建筑师"', title:'"搬运「输载归初」"', description:'"输载归初核心 消耗8 Q丢出时，将周围3格内的宝箱全部刷新成蛋糕盒\\\\n下蹲可以直接破坏脚下的潜影盒，并创造一个减速圆环，消耗4\\\\n经过减速圆环的敌方玩家将获得减速效果\\\\n\\\\n小提示：可用于快速抢夺箱子"', id: 19, idsh: 19, pos: 0, idloop: 19}
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"建筑师"', title:'"筑道「高速隧梯」"', description:'"铁轨×10、特殊模板 拥有普通铁轨时\\\\n同时按左+右键 朝距离最近的横向正十字坐标打开一道通路\\\\n加按SHIFT 则会向上两格作为楼梯延伸\\\\n若不再有铁轨，则改为消耗2级充能\\\\n\\\\n路径上的方块会成为掉落物"', id: 27, idsh: 27, pos: 1, idloop: 1}
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"建筑师"', title:'"錾艺「资源集成」"', description:'"特殊模板 不置于副手时，获得某些方块后将自动转换为另一种方块\\\\n土壤类将会成为普通的土、石类将会成为普通的石头\\\\n受影响方块：完整的花岗岩、安山岩、闪长岩、圆石、苔圆石、黑石、深板岩、凝灰岩、方解石、草方块、灰化土、砂土、缠根土、菌丝、绯红岩、诡异岩、红沙等\\\\n\\\\n产生转换时将会增加自身一定的充能（无上限）\\\\n\\\\n连携效果：若存在友方「理性混淆」持有者，\\\\n受影响的石类方块将转变为风弹并给予友方的全部「理性混淆」持有者"', id: 33, idsh: 33, pos: 1, idloop: 7}
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"圣女"', title:'"救赎「顷刻天国」"', description:'"顷刻天国核心 消耗15 Q丢出时，范围内敌我飘升并发光6秒\\\\n留在背包内时不会陷入中毒状态"', id: 10, idsh: 10, pos: 0, idloop: 10}
...
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"圣骑士"', title:'"神威「陨落压制」"', description:'"陨落压制核心 消耗15 Q丢出时，范围内其他玩家（包括友军）速度完全压制但接近无敌\\\\n\\\\n注意：虽然能够预防跳跃，但是这一效果的持续时长要远短于减速的时长"', id: 11, idsh: 11, pos: 0, idloop: 11}
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"圣骑士"', title:'"天威「跃空战技」"', description:'"粘液块×3、跃空战技核心×2 消耗20 Q丢出时，给予自己一把重锤\\\\n留在背包内时，可以在粘液块/蛋糕上一跃而起\\\\n留在背包内时，蹲下后跳跃能力短暂增强\\\\n\\\\n小提示：推荐自己寻找重锤"', id: 20, idsh: 20, pos: 0, idloop: 20}
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"圣骑士"', title:'"血兆「焚白恶魔」"', description:'"号角与特殊模板 放置于背包时吹响号角，为自己的队伍生成一个自动旋转扫描的火焰攻击塔\\\\n攻击塔的4格内，友方挖掘与攻击速度巨幅增强\\\\n同一个队伍只能同时存在一个火焰攻击塔\\\\n\\\\n连携效果：若4格内存在友方「顷刻天国」持有者，\\\\n每30秒全队的「顷刻天国」持有者充能加速"', id: 36, idsh: 36, pos: 1, idloop: 10}
...
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"尘埃法师"', title:'"唤尘「漆幕虚垒」"', description:'"漆幕虚垒核心 消耗8 Q丢出时，召唤持续十数秒的烟幕\\\\n - 通常时掷出：视角目的地发动（最高20格远）\\\\n - SHIFT掷出：脚边发动"', id: 18, idsh: 18, pos: 0, idloop: 18}
