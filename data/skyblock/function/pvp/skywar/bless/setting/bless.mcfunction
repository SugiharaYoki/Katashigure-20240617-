...
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"旅行家"', title:'"启礼「黄金圣果」"', description:'"附魔金苹果×1"', id: 008}
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"旅行家"', title:'"统礼「末影水晶」"', description:'"末影水晶×1"', id: 001}
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"旅行家"', title:'"纵礼「不死图腾」"', description:'"不死图腾×1"', id: 002}
...
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"驯兽师"', title:'"割荒「暗行豸螨」"', description:'"龙息×1 特殊模板 手持时将周围5格的龙息掉落物转换为炸弹螨\\\\n炸弹螨在有玩家接近时会剧烈爆炸"', id: 034}
...
function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"尘埃法师"', title:'"归尘「扬焱剧爆」"', description:'"扬焱剧爆核心×2 在身边召唤引燃的TNT，该TNT引爆速度比普通TNT快3/10\\\\n使用后会立刻获得4个TNT"', id: 017}

function skyblock:pvp/skywar/bless/setting/bless_macro {job:'"尘埃法师"', title:'"唤尘「漆幕虚垒」"', description:'"漆幕虚垒核心×4 在面前4格处召唤持续十数秒的烟幕"', id: 018}
