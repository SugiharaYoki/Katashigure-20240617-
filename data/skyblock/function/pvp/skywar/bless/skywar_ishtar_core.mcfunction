...
execute if entity @s[scores={If_Bless31c=1..,If_Bless31=..0}] run say hi
execute if items entity @s[scores={If_Bless31c=1..,If_Bless31=..0}] container.* *[custom_data={skywar_ishtar_31:1}] run function skyblock:pvp/skywar/bless/skywar_ishtar_core31
