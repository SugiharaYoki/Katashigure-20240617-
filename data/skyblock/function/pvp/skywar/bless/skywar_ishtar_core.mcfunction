...
execute unless entity @s[gamemode=adventure] if items entity @s[predicate=skyblock:left,predicate=skyblock:right,predicate=!skyblock:sneak,tag=!skywar_ishtar_27] container.* *[custom_data={skywar_ishtar_27_old:1}] run function skyblock:pvp/skywar/bless/skywar_ishtar_core27_old
execute unless entity @s[gamemode=adventure] if items entity @s[predicate=skyblock:left,predicate=skyblock:right,predicate=skyblock:sneak,tag=!skywar_ishtar_27] container.* *[custom_data={skywar_ishtar_27_old:1}] run function skyblock:pvp/skywar/bless/skywar_ishtar_core27_old_up

execute unless entity @s[gamemode=adventure] if items entity @s[predicate=skyblock:left,predicate=skyblock:right,tag=!skywar_ishtar_27] container.* *[custom_data={skywar_ishtar_27:1}] run function skyblock:pvp/skywar/bless/skywar_ishtar_core27
