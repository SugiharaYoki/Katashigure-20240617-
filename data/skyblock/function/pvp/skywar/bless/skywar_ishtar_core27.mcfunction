...
execute unless items entity @s container.* rail run tag @s[level=3..] add ishtar_27_success
execute unless items entity @s container.* rail run tag @s[level=3..] add ishtar_27_success_level
...
execute if entity @s[tag=ishtar_27_success_level] run xp add @s -3 levels
