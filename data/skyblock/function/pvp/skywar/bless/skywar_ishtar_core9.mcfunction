...
execute if entity @s[tag=ishtar_core9_type2,scores={ishtar_core_1=3}] run fill ~2 ~1 ~0 ~2 ~1 ~0 air replace stone_bricks
execute if entity @s[tag=ishtar_core9_type2,scores={ishtar_core_1=3}] run fill ~-2 ~1 ~0 ~-2 ~1 ~0 air replace stone_bricks
execute if entity @s[tag=ishtar_core9_type2,scores={ishtar_core_1=3}] run fill ~0 ~1 ~2 ~0 ~1 ~2 air replace stone_bricks
execute if entity @s[tag=ishtar_core9_type2,scores={ishtar_core_1=3}] run fill ~0 ~1 ~-2 ~0 ~1 ~-2 air replace stone_bricks
...
execute if entity @s[tag=ishtar_core9_type2,scores={ishtar_core_1=8}] run fill ~00 ~6 ~00 ~-0 ~6 ~-0 air replace stone_bricks
...
execute if entity @s[tag=ishtar_core9_type2,scores={ishtar_core_1=9}] run fill ~2 ~7 ~1 ~2 ~7 ~1 stone_brick_slab[type=bottom] replace stone_bricks
execute if entity @s[tag=ishtar_core9_type2,scores={ishtar_core_1=9}] run fill ~-2 ~7 ~1 ~-2 ~7 ~1 stone_brick_slab[type=bottom] replace stone_bricks
execute if entity @s[tag=ishtar_core9_type2,scores={ishtar_core_1=9}] run fill ~1 ~7 ~2 ~1 ~7 ~2 stone_brick_slab[type=bottom] replace stone_bricks
execute if entity @s[tag=ishtar_core9_type2,scores={ishtar_core_1=9}] run fill ~1 ~7 ~-2 ~1 ~7 ~-2 stone_brick_slab[type=bottom] replace stone_bricks
execute if entity @s[tag=ishtar_core9_type2,scores={ishtar_core_1=9}] run fill ~2 ~7 ~-1 ~2 ~7 ~-1 stone_brick_slab[type=bottom] replace stone_bricks
execute if entity @s[tag=ishtar_core9_type2,scores={ishtar_core_1=9}] run fill ~-2 ~7 ~-1 ~-2 ~7 ~-1 stone_brick_slab[type=bottom] replace stone_bricks
execute if entity @s[tag=ishtar_core9_type2,scores={ishtar_core_1=9}] run fill ~-1 ~7 ~2 ~-1 ~7 ~2 stone_brick_slab[type=bottom] replace stone_bricks
