...
execute if entity @s[tag=ishtar_core9_type2,scores={ishtar_core_1=9}] run fill ~2 ~7 ~1 ~2 ~7 ~1 air replace stone_bricks
execute if entity @s[tag=ishtar_core9_type2,scores={ishtar_core_1=9}] run fill ~-2 ~7 ~1 ~-2 ~7 ~1 air replace stone_bricks
execute if entity @s[tag=ishtar_core9_type2,scores={ishtar_core_1=9}] run fill ~1 ~7 ~2 ~1 ~7 ~2 air replace stone_bricks
execute if entity @s[tag=ishtar_core9_type2,scores={ishtar_core_1=9}] run fill ~1 ~7 ~-2 ~1 ~7 ~-2 air replace stone_bricks
execute if entity @s[tag=ishtar_core9_type2,scores={ishtar_core_1=9}] run fill ~2 ~7 ~-1 ~2 ~7 ~-1 air replace stone_bricks
execute if entity @s[tag=ishtar_core9_type2,scores={ishtar_core_1=9}] run fill ~-2 ~7 ~-1 ~-2 ~7 ~-1 air replace stone_bricks
execute if entity @s[tag=ishtar_core9_type2,scores={ishtar_core_1=9}] run fill ~-1 ~7 ~2 ~-1 ~7 ~2 air replace stone_bricks
