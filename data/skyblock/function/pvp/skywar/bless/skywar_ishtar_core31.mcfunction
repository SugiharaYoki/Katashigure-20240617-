execute if entity @s[team=Team1_1] at @s as @e[gamemode=!spectator,team=!Team1_1,distance=0..5] at @s \
 run function skyblock:pvp/skywar/bless/skywar_ishtar_core31e
execute if entity @s[team=Team1_2] at @s as @e[gamemode=!spectator,team=!Team1_2,distance=0..5] at @s \
 run function skyblock:pvp/skywar/bless/skywar_ishtar_core31e
...
execute if entity @s[team=Team1_5] at @s as @e[gamemode=!spectator,team=!Team1_5,distance=0..5] at @s \
 run function skyblock:pvp/skywar/bless/skywar_ishtar_core31e
execute if entity @s[team=Team1_6] at @s as @e[gamemode=!spectator,team=!Team1_6,distance=0..5] at @s \
 run function skyblock:pvp/skywar/bless/skywar_ishtar_core31e
execute if entity @s[team=Team1_7] at @s as @e[gamemode=!spectator,team=!Team1_7,distance=0..5] at @s \
 run function skyblock:pvp/skywar/bless/skywar_ishtar_core31e
execute if entity @s[team=Team1_8] at @s as @e[gamemode=!spectator,team=!Team1_8,distance=0..5] at @s \
 run function skyblock:pvp/skywar/bless/skywar_ishtar_core31e
