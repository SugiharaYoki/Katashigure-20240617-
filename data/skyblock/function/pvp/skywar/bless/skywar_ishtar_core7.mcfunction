...
execute if score @s If_Bless7 matches 399 if score @s rng1 matches 1..6 run give @s minecraft:silverfish_spawn_egg
execute if score @s If_Bless7 matches 399 if score @s rng1 matches 7..9 run give @s minecraft:magma_cube_spawn_egg_spawn_egg
