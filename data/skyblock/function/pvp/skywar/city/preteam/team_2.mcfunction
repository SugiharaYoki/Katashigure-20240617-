...
execute positioned -141 57 -98 as @a[distance=0..5] at @s if entity @s[tag=!PVPTeamed] if block ~ ~-1 ~ red_concrete run tellraw @a[tag=!Gaming,tag=!NoSkyWar] [{text:"组队预选", bold:1b, "color": "yellow"},{text:" 新的玩家加入了B队", bold: false, "color": "white"}]
