...
execute if biome ~ ~ ~ minecraft:cherry_grove run tellraw @s [{text:"嗅探兽的收获：",bold:1b,color:"gold"},{text:"获得 6 钻石",bold:0b,color:"white"}]
execute if biome ~ ~ ~ minecraft:cherry_grove run give @s diamond 6
execute if biome ~ ~ ~ minecraft:windswept_hills run tellraw @s [{text:"嗅探兽的收获：",bold:1b,color:"gold"},{text:"生命上限 +4",bold:0b,color:"white"}]
...
execute if biome ~ ~ ~ minecraft:crimson_forest run tellraw @s [{text:"嗅探兽的收获：",bold:1b,color:"gold"},{text:"攻击力 +0.5",bold:0b,color:"white"}]
