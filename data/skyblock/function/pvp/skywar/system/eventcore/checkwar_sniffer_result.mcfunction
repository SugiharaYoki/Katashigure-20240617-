...
execute if biome ~ ~ ~ minecraft:windswept_hills run attribute @s minecraft:max_health modifier add checkwar_bless:sniffer_1 4 add_value
...
execute if biome ~ ~ ~ minecraft:crimson_forest run attribute @s minecraft:attack_damage modifier add checkwar_bless:sniffer_1 0.5 add_value
...
execute if biome ~ ~ ~ minecraft:warm_ocean run attribute @s minecraft:submerged_mining_speed modifier add checkwar_bless:sniffer_1 0.5 add_value
...
execute if biome ~ ~ ~ minecraft:bamboo_jungle run attribute @s minecraft:block_interaction_range modifier add checkwar_bless:sniffer_1 0.5 add_value
...
execute if biome ~ ~ ~ minecraft:snowy_plains run attribute @s minecraft:armor_toughness modifier add checkwar_bless:sniffer_1 2 add_value
...
execute if biome ~ ~ ~ minecraft:mushroom_fields run attribute @s minecraft:entity_interaction_range modifier add checkwar_bless:sniffer_1 0.5 add_value
...
execute if biome ~ ~ ~ minecraft:dripstone_caves run attribute @s minecraft:mining_efficiency modifier add checkwar_bless:sniffer_1 2 add_value
