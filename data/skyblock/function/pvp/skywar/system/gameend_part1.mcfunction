...
execute if entity @a[team=Team1_2] run function skyblock:pvp/skywar/bless/statistics
...
execute unless entity @a[team=Team1_2] run execute as @a[tag=PVP_win] at @s run tellraw @s {text:"获得了1浮世币的奖励",color:"gold"}
