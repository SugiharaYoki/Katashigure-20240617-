...
#map002
execute if score sc Map_Code matches 2 run title @a[tag=!Gaming] actionbar {text:"空岛战争T4 腐败的祭坛",bold:true,color:"light_purple"}
execute if score sc Map_Code matches 2 run clone 12 8 28 16 12 32 -118 56 -110
#map003
execute if score sc Map_Code matches 3 run title @a[tag=!Gaming] actionbar {text:"空岛战争T4 沉默的亚特兰蒂斯",bold:true,color:"light_purple"}
execute if score sc Map_Code matches 3 run clone 12 3 28 16 7 32 -118 56 -110
#map004
execute if score sc Map_Code matches 4 run title @a[tag=!Gaming] actionbar {text:"空岛战争T4 炙魇的黑城",bold:true,color:"light_purple"}
execute if score sc Map_Code matches 4 run clone 12 -28 28 16 -32 32 -118 56 -110
#map005
execute if score sc Map_Code matches 5 run title @a[tag=!Gaming] actionbar {text:"空岛战争T4 献堂的圣咏",bold:true,color:"light_purple"}
execute if score sc Map_Code matches 5 run clone 12 -2 28 16 2 32 -118 56 -110
#map006
execute if score sc Map_Code matches 6 run title @a[tag=!Gaming] actionbar {text:"空岛战争T3 浮游要塞伊什塔尔",bold:true,color:"light_purple"}
#execute if score sc Map_Code matches 6 run clone 0 51 78 5 53 83 31 86 70
#map007
execute if score sc Map_Code matches 7 run title @a[tag=!Gaming] actionbar {text:"空岛战争T2 亚兹列尔的钟台",bold:true,color:"light_purple"}
execute if score sc Map_Code matches 7 run clone 12 13 28 16 17 32 -118 56 -110
#map008
execute if score sc Map_Code matches 8 run title @a[tag=!Gaming] actionbar {text:"空岛战争T2 荒废之地的民谣",bold:true,color:"light_purple"}
execute if score sc Map_Code matches 8 run clone 12 -7 28 16 -3 32 -118 56 -110
#map009
execute if score sc Map_Code matches 9 run title @a[tag=!Gaming] actionbar {text:"爪巴战争 预设世界",bold:true,color:"light_purple"}
#execute if score sc Map_Code matches 9 run clone 0 51 99 5 53 104 31 86 70
#map010
execute if score sc Map_Code matches 10 run title @a[tag=!Gaming] actionbar {text:"空岛战争T4 碎晦坍殒的地灵脉",bold:true,color:"light_purple"}
execute if score sc Map_Code matches 10 run clone 12 -33 28 16 -37 32 -118 56 -110
#map011
execute if score sc Map_Code matches 11 run title @a[tag=!Gaming] actionbar {text:"星罗棋盘",bold:true,color:"light_purple"}
execute if score sc Map_Code matches 11 run clone 12 -38 28 16 -42 32 -118 56 -110
#map012
execute if score sc Map_Code matches 12 run title @a[tag=!Gaming] actionbar {text:"空岛战争 煌逝的近礁",bold:true,color:"light_purple"}
#execute if score sc Map_Code matches 12 run clone 0 51 120 5 53 125 31 86 70
#map014
execute if score sc Map_Code matches 14 run title @a[tag=!Gaming] actionbar {text:"空岛战争T3 折翼界空的夜明之塔",bold:true,color:"light_purple"}
execute if score sc Map_Code matches 14 run clone 12 -12 28 16 -8 32 -118 56 -110
#map015
execute if score sc Map_Code matches 15 run title @a[tag=!Gaming] actionbar {text:"空岛战争T3 浮岛空舰站",bold:true,color:"light_purple"}
execute if score sc Map_Code matches 15 run clone 12 -17 28 16 -13 32 -118 56 -110
#map016
execute if score sc Map_Code matches 16 run title @a[tag=!Gaming] actionbar {text:"空岛战争T3 绯染缥茫的世花源",bold:true,color:"light_purple"}
execute if score sc Map_Code matches 16 run clone 12 -22 28 16 -18 32 -118 56 -110
#map017
execute if score sc Map_Code matches 17 run title @a[tag=!Gaming] actionbar {text:"空岛战争T4 天穹巨兽古伽兰那 · 维修层",bold:true,color:"light_purple"}
