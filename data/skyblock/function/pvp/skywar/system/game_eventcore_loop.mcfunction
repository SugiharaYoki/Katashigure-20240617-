...
execute if score ishtar_bless38_loop rng1 matches 3.. if items entity @s container.* *[custom_data={skywar_ishtar_38:1}] at @s run function skyblock:pvp/skywar/bless/skywar_ishtar_core38_save_position
...
execute if score sc TimeRemainUnsee matches 279..370 if score sc Map_Code matches 11 run function skyblock:pvp/skywar/system/eventcore/checkwar_sniffer3
