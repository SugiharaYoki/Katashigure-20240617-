...
execute if score skywar_start rng1 matches 2 run tellraw @a[tag=!Gaming,tag=NoSkyWar] {"text":"   —— [参加游戏] ——","color":"green","click_event":{"action":"run_command","value":"/trigger MultiMenu set 992"},"hoverEvent":{"action":"show_text","contents":{"text":"暂时关闭“自动参加PVP战争”","color":"green"}}}
execute if score skywar_start rng1 matches 2 run tellraw @a[tag=!Gaming,tag=!NoSkyWar] {"text":"   —— [不参加游戏： 仅本局] ——","color":"green","click_event":{"action":"run_command","value":"/trigger MultiMenu set 993"},"hoverEvent":{"action":"show_text","contents":{"text":"关闭“自动参加PVP战争”","color":"green"}}}
execute if score skywar_start rng1 matches 2 run tellraw @a[tag=!Gaming,tag=!NoSkyWar] {"text":"   —— [不参加游戏： 直到自己重新打开] ——","color":"green","click_event":{"action":"run_command","value":"/trigger MultiMenu set 995"},"hoverEvent":{"action":"show_text","contents":{"text":"开启“自动参加PVP战争”","color":"green"}}}
execute if score skywar_start rng1 matches 2 run tellraw @a[tag=!Gaming,tag=!NoSkyWar] {"text":"   —— [暂停开局] ——","color":"yellow","click_event":{"action":"run_command","value":"/trigger MultiMenu set 994"},"hoverEvent":{"action":"show_text","contents":{"text":"暂停PVP战场的开局","color":"green"}}}
execute if score skywar_start rng1 matches 2 run tellraw @a[tag=!Gaming,tag=!NoSkyWar] {"text":"   —— [重置倒计时] ——","color":"yellow","click_event":{"action":"run_command","value":"/trigger MultiMenu set 996"},"hoverEvent":{"action":"show_text","contents":{"text":"重置PVP战场的开局倒计时","color":"green"}}}
