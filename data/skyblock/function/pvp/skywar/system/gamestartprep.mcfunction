...
execute if score skywar_start rng1 matches 2 if entity @n[tag=sc,scores={Map_Theme=1}] run forceload add 50000 50000 50200 50200
execute if score skywar_start rng1 matches 2 if entity @n[tag=sc,scores={Map_Theme=1}] run forceload add 50000 50200 50200 50400
execute if score skywar_start rng1 matches 2 if entity @n[tag=sc,scores={Map_Theme=1}] run forceload add 50200 50000 50400 50200
execute if score skywar_start rng1 matches 2 if entity @n[tag=sc,scores={Map_Theme=1}] run forceload add 50200 50200 50400 50400
execute if score skywar_start rng1 matches 2 if entity @n[tag=sc,scores={Map_Theme=2}] run forceload add 50400 50000 50600 50200
execute if score skywar_start rng1 matches 2 if entity @n[tag=sc,scores={Map_Theme=2}] run forceload add 50400 50200 50600 50400
execute if score skywar_start rng1 matches 2 if entity @n[tag=sc,scores={Map_Theme=2}] run forceload add 50600 50000 50800 50200
execute if score skywar_start rng1 matches 2 if entity @n[tag=sc,scores={Map_Theme=2}] run forceload add 50600 50200 50800 50400
execute if score skywar_start rng1 matches 2 if entity @n[tag=sc,scores={Map_Theme=3}] run forceload add 50000 50400 50200 50600
execute if score skywar_start rng1 matches 2 if entity @n[tag=sc,scores={Map_Theme=3}] run forceload add 50000 50600 50200 50800
execute if score skywar_start rng1 matches 2 if entity @n[tag=sc,scores={Map_Theme=3}] run forceload add 50200 50400 50400 50600
execute if score skywar_start rng1 matches 2 if entity @n[tag=sc,scores={Map_Theme=3}] run forceload add 50200 50600 50400 50800
execute if score skywar_start rng1 matches 2 if entity @n[tag=sc,scores={Map_Theme=4}] run forceload add 50390 50390 50600 50600
execute if score skywar_start rng1 matches 2 if entity @n[tag=sc,scores={Map_Theme=4}] run forceload add 50390 50600 50600 50800
execute if score skywar_start rng1 matches 2 if entity @n[tag=sc,scores={Map_Theme=4}] run forceload add 50600 50390 50800 50600
execute if score skywar_start rng1 matches 2 if entity @n[tag=sc,scores={Map_Theme=4}] run forceload add 50600 50600 50800 50800
...
execute if score skywar_start rng1 matches 2 if entity @n[tag=!MapLoaAlr,tag=sc,scores={Map_Code=14}] run forceload add -9838 -10164 -9709 -10035
execute if score skywar_start rng1 matches 2 if entity @n[tag=!MapLoaAlr,tag=sc,scores={Map_Code=2}] run function skyblock:pvp/skywar/system/init/map/map002_part1
execute if score skywar_start rng1 matches 2 if entity @n[tag=!MapLoaAlr,tag=sc,scores={Map_Code=3}] run function skyblock:pvp/skywar/system/init/map/map003_part1
execute if score skywar_start rng1 matches 2 if entity @n[tag=!MapLoaAlr,tag=sc,scores={Map_Code=4}] run function skyblock:pvp/skywar/system/init/map/map004_part1_hard
execute if score skywar_start rng1 matches 2 if entity @n[tag=!MapLoaAlr,tag=sc,scores={Map_Code=5}] run function skyblock:pvp/skywar/system/init/map/map005_part1
execute if score skywar_start rng1 matches 2 if entity @n[tag=!MapLoaAlr,tag=sc,scores={Map_Code=7}] run function skyblock:pvp/skywar/system/init/map/map007_part1
execute if score skywar_start rng1 matches 2 if entity @n[tag=!MapLoaAlr,tag=sc,scores={Map_Code=8}] run function skyblock:pvp/skywar/system/init/map/map008_part1
execute if score skywar_start rng1 matches 2 if entity @n[tag=!MapLoaAlr,tag=sc,scores={Map_Code=10}] run function skyblock:pvp/skywar/system/init/map/map010_part1_hard
execute if score skywar_start rng1 matches 2 if entity @n[tag=!MapLoaAlr,tag=sc,scores={Map_Code=11}] run function skyblock:pvp/skywar/system/init/map/map011_size1
execute if score skywar_start rng1 matches 2 if entity @n[tag=!MapLoaAlr,tag=sc,scores={Map_Code=13}] run function skyblock:pvp/skywar/system/init/map/map013_part1
execute if score skywar_start rng1 matches 2 if entity @n[tag=!MapLoaAlr,tag=sc,scores={Map_Code=14}] unless block -156 59 -114 diamond_block run function skyblock:pvp/skywar/system/init/map/map014_part1_hard
execute if score skywar_start rng1 matches 2 if entity @n[tag=!MapLoaAlr,tag=sc,scores={Map_Code=14}] if block -156 59 -114 diamond_block run function skyblock:pvp/skywar/system/init/map/map014alt_part1_hard
execute if score skywar_start rng1 matches 2 if entity @n[tag=!MapLoaAlr,tag=sc,scores={Map_Code=15}] run function skyblock:pvp/skywar/system/init/map/map015_part1_hard
execute if score skywar_start rng1 matches 2 if entity @n[tag=!MapLoaAlr,tag=sc,scores={Map_Code=16}] run function skyblock:pvp/skywar/system/init/map/map016_part1_hard
execute if score skywar_start rng1 matches 2 if entity @n[tag=!MapLoaAlr,tag=sc,scores={Map_Code=17}] run function skyblock:pvp/skywar/system/init/map/map017_part1_hard
execute if score skywar_start rng1 matches 2 if entity @n[tag=!MapLoaAlr,tag=sc,scores={Map_Code=18}] run function skyblock:pvp/skywar/system/init/map/map018_part1_hard
#[futuredevskywar]
execute if score skywar_start rng1 matches 3 if entity @n[tag=!MapLoaAlr,tag=sc,scores={Map_Code=14}] run forceload remove -9838 -10164 -9709 -10035
...
execute if score skywar_start rng1 matches 11 run execute if score @n[tag=sc] Map_Type matches 1 unless score @n[tag=sc] Map_Code matches 13 run title @a[tag=PVPing] title {"text":"欢迎来到 空岛战争","color":"white"}
execute if score skywar_start rng1 matches 11 run execute if score @n[tag=sc] Map_Type matches 1 if score @n[tag=sc] Map_Code matches 13 run title @a[tag=PVPing] title {"text":"欢迎来到 混沌魔方","color":"white"}
...
execute if score skywar_start rng1 matches 13..15 if score @n[tag=sc] Map_Code matches 2..6 run gamemode survival @a[tag=PVPing,tag=PVPTeamed]
execute if score skywar_start rng1 matches 13..15 if score @n[tag=sc] Map_Code matches 7 run gamemode adventure @a[tag=PVPing,tag=PVPTeamed]
execute if score skywar_start rng1 matches 13..15 if score @n[tag=sc] Map_Code matches 8.. run gamemode survival @a[tag=PVPing,tag=PVPTeamed]
...
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 2 run title @a[tag=PVP_see] title {"text":"腐败的祭坛","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 2 run title @a[tag=PVP_see] subtitle {"text":"针叶林深处的歪曲小道尽头 坐落着昔日的祭坛","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 3 run title @a[tag=PVP_see] title {"text":"沉默的亚特兰蒂斯","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 3 run title @a[tag=PVP_see] subtitle {"text":"结界的中心 是黑水翻腾的神秘古城","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 4 run title @a[tag=PVP_see] title {"text":"炙魇的黑城","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 4 run title @a[tag=PVP_see] subtitle {"text":"梦醒之时 周遭已是鲜红的炼狱","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 5 run title @a[tag=PVP_see] title {"text":"献堂的圣咏","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 5 run title @a[tag=PVP_see] subtitle {"text":"反叛的旗帜 被悄然掀起……","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 7 run title @a[tag=PVP_see] title {"text":"亚兹列尔的钟台","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 7 run title @a[tag=PVP_see] subtitle {"text":"穹顶钟声回荡之时 某个生命便会陨落","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 8 run title @a[tag=PVP_see] title {"text":"荒废之地的民谣","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 8 run title @a[tag=PVP_see] subtitle {"text":"残羹断瓦的下方 曾是一座巨型遗迹","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 10 run title @a[tag=PVP_see] title {"text":"碎晦坍殒的地灵脉","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 10 run title @a[tag=PVP_see] subtitle {"text":"曾经地元素最为丰茂之所 今日映入眼帘的仅有腐败","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 11 run title @a[tag=PVP_see] title {"text":"星罗棋盘","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 11 run title @a[tag=PVP_see] subtitle {"text":"北风吹人不可出 清坐且可与君棋","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 13 run title @a[tag=PVP_see] title {"text":"混沌魔方","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 13 run title @a[tag=PVP_see] subtitle {"text":"混沌未分天地乱 茫茫渺渺无人见","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 14 unless block -156 59 -114 diamond_block run title @a[tag=PVP_see] title {"text":"折翼界空的夜明之塔","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 14 if block -156 59 -114 diamond_block run title @a[tag=PVP_see] title {"text":"折羽界离的夜明之塔","color":"dark_red"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 14 unless block -156 59 -114 diamond_block run title @a[tag=PVP_see] subtitle {"text":"天灾已过 人去楼空","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 14 if block -156 59 -114 diamond_block run title @a[tag=PVP_see] subtitle {"text":"天灾已过 末日却尚未降临","color":"dark_red"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 15 run title @a[tag=PVP_see] title {"text":"浮岛空舰站","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 15 run title @a[tag=PVP_see] subtitle {"text":"伊什塔尔的边界 坐落着这古代科技的前哨","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 16 run title @a[tag=PVP_see] title {"text":"绯染缥茫的世花源","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 16 run title @a[tag=PVP_see] subtitle {"text":"樱色的梦境 将在此刻破碎","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 17 run title @a[tag=PVP_see] title {"text":"天穹巨兽古伽兰那","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 17 run title @a[tag=PVP_see] subtitle {"text":"空中军舰锈迹斑斑 刺耳的金属尖啸诠释着何类的昔日辉煌？","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 18 run title @a[tag=PVP_see] title {"text":"穷泽叢烬的水灵脉","color":"white"}
execute if score skywar_start rng1 matches 13 if score @n[tag=sc] Map_Code matches 18 run title @a[tag=PVP_see] subtitle {"text":"昔日水元素最为充沛之所 终也会被滔泊而湮覆","color":"white"}
#[futuredevskywar]
...
execute if score skywar_start rng1 matches 19 if score @n[tag=sc] Map_Code matches 11 run effect give @a[tag=PVPing,tag=PVPTeamed] invisibility 240 0 true
execute if score skywar_start rng1 matches 19 if score @n[tag=sc] Map_Code matches 11 run effect give @a[tag=PVPing,tag=PVPTeamed] strength 20 4 true
execute if score skywar_start rng1 matches 19 if score @n[tag=sc] Map_Code matches 11 run effect give @a[tag=PVPing,tag=PVPTeamed] resistance 20 2 true
execute if score skywar_start rng1 matches 19 if score @n[tag=sc] Map_Code matches 11 run give @a[tag=PVPing,tag=PVPTeamed] wooden_pickaxe
execute if score skywar_start rng1 matches 19 if score @n[tag=sc] Map_Code matches 11 run give @a[tag=PVPing,tag=PVPTeamed] bread
...
execute if score skywar_start rng1 matches 20 if score @n[tag=sc] Map_Code matches 13 if block 31 59 -94 green_concrete run give @a[tag=PVPing] netherite_upgrade_smithing_template 2
execute if score skywar_start rng1 matches 20 if score @n[tag=sc] Map_Code matches 13 if block 36 59 -94 green_concrete run give @a[tag=PVPing] netherite_upgrade_smithing_template 3
