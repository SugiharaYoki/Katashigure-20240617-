...
execute if block -131 58 -133 diamond_block as @e[type=marker,tag=If_Bless21b,x=50000,y=0,d=50000,distance=..5000] at @s run function skyblock:pvp/skywar/bless/skywar_ishtar_core21b
