...
execute if block -41 156 -57 blue_stained_glass as @a at @s unless score @s ZeroBGM matches 2.. run playsound app2.afterdark master @s ~ ~ ~ 0.7
...
execute if block -41 156 -57 blue_stained_glass as @a[scores={ZeroBGM=7}] at @s run playsound vol2.replica master @s ~ ~ ~ 0.75
