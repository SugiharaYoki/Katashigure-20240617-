...
execute if block -41 156 -57 lime_stained_glass run scoreboard players add @n[tag=sc] dailydiv 1
execute if block -41 156 -57 purple_stained_glass run scoreboard players add @n[tag=sc] dailydivc2 1
execute if block -41 156 -57 lime_stained_glass run scoreboard players operation #Server_Date Global_Age = @n[tag=sc] dailydiv
