...
execute if block -41 156 -57 blue_stained_glass as @a[scores={ZeroBGM=7}] at @s run playsound vol2.replica master @s ~ ~ ~ 0.5
...
execute if block -41 156 -57 purple_stained_glass as @a at @s run playsound vol2.nalca master @s ~ ~ ~ 0.5
