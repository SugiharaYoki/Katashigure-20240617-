...
execute as @a[scores={MultiMenu=815021,MazeLS=21..}] at @s run tellraw @s [{"text":"已抵达","color":"white"},{"text":" 代达罗斯的迷宫之塔 - 地下5层 D区域","color":"green"}]
execute as @a[scores={MultiMenu=815022,MazeLS=22..}] at @s run tp @p 142 56 -232 facing 142 56 -233
execute as @a[scores={MultiMenu=815022,MazeLS=22..}] at @s run tellraw @s [{"text":"已抵达","color":"white"},{"text":" 代达罗斯的迷宫之塔 - 地下4层 A区域","color":"green"}]
