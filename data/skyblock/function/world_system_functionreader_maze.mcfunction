...
execute as @a[scores={MultiMenu=832041,parkour_stage=41..}] at @s run tp @p -1647 57 -118 facing -1648 57 -118
...
execute as @a[scores={MultiMenu=832042,parkour_stage=42..}] at @s run tp @p -1699 57 -118 facing -1700 57 -118
