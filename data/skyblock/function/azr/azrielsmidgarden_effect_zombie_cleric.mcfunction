...
summon area_effect_cloud ~ ~0.3 ~ {ReapplicationDelay:9999,Radius:0.5f,RadiusPerTick:1.16f,RadiusOnUse:0f,Duration:3,DurationOnUse:0,WaitTime:1,Color:62431,Potion:"minecraft:water"}