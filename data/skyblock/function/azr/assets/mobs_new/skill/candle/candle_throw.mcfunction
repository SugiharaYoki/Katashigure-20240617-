...
execute if score @s[scores={Health=..59}] rng5 matches 46 rotated ~ 0 run summon marker ~ ~ ~ {Tags:["AzrielMob_candle_angel_candle_throw_marker_trace"]}
...
execute if score @s[scores={Health=..99}] rng5 matches 71 rotated ~ 0 run summon marker ~ ~ ~ {Tags:["AzrielMob_candle_angel_candle_throw_marker_trace"]}
