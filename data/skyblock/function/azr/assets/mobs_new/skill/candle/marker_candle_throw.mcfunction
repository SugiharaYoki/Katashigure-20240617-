...
execute if score @s rng1 matches 8.. run tp @s ^ ^ ^0.25
execute if score @s rng1 matches 8.. store result score @s rng2 run random value 1..5
execute if score @s[scores={rng2=2}] rng1 matches 8.. run tp @s ^0.15 ^ ^
execute if score @s[scores={rng2=2}] rng1 matches 8.. run tp @s ^-0.15 ^ ^
execute if score @s[scores={rng2=2}] rng1 matches 8.. run tp @s ^0.3 ^ ^
execute if score @s[scores={rng2=2}] rng1 matches 8.. run tp @s ^-0.3 ^ ^
