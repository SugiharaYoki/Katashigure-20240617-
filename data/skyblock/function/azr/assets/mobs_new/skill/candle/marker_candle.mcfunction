...
execute if score @s rng1 matches 28.. as @a[tag=azrPlayer,distance=..1.0] at @s run damage @s 10 in_fire
execute if score @s rng1 matches 28.. as @a[tag=azrPlayer,distance=..1.5] at @s run damage @s 6 in_fire
