...
execute if score @s rng1 matches 28.. as @a[tag=azrPlayer,distance=..1.2] at @s run damage @s 10 in_fire
execute if score @s rng1 matches 28.. as @a[tag=azrPlayer,distance=..1.8] at @s run damage @s 6 in_fire
