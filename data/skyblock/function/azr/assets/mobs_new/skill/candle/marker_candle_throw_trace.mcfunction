...
execute if score @s rng1 matches 38 run summon marker ~ 4.0 ~ {Tags:["AzrielMob_candle_angel_candle_marker"]}
execute if score @s rng1 matches 41 run summon marker ~2 4.0 ~ {Tags:["AzrielMob_candle_angel_candle_marker"]}
execute if score @s rng1 matches 41 run summon marker ~-2 4.0 ~ {Tags:["AzrielMob_candle_angel_candle_marker"]}
execute if score @s rng1 matches 41 run summon marker ~ 4.0 ~2 {Tags:["AzrielMob_candle_angel_candle_marker"]}
execute if score @s rng1 matches 41 run summon marker ~ 4.0 ~-2 {Tags:["AzrielMob_candle_angel_candle_marker"]}
execute if score @s rng1 matches 44 run summon marker ~4 4.0 ~ {Tags:["AzrielMob_candle_angel_candle_marker"]}
execute if score @s rng1 matches 44 run summon marker ~-4 4.0 ~ {Tags:["AzrielMob_candle_angel_candle_marker"]}
execute if score @s rng1 matches 44 run summon marker ~ 4.0 ~4 {Tags:["AzrielMob_candle_angel_candle_marker"]}
execute if score @s rng1 matches 44 run summon marker ~ 4.0 ~-4 {Tags:["AzrielMob_candle_angel_candle_marker"]}
