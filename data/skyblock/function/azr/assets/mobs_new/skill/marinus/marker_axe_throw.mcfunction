...
execute if score @s[tag=attack_throw_angle_left] rng1 matches 1 if score @n[type=villager,tag=AzrielNPC_marinus] Health matches ..500 run rotate @s ~-40 ~
execute if score @s[tag=attack_throw_angle_left] rng1 matches 2..4 if score @n[type=villager,tag=AzrielNPC_marinus] Health matches ..400 run rotate @s ~-40 ~
execute if score @s[tag=attack_throw_angle_left] rng1 matches 5..8 if score @n[type=villager,tag=AzrielNPC_marinus] Health matches ..300 run rotate @s ~-40 ~
execute if score @s[tag=attack_throw_angle_right] rng1 matches 1 if score @n[type=villager,tag=AzrielNPC_marinus] Health matches ..500 run rotate @s ~40 ~
execute if score @s[tag=attack_throw_angle_right] rng1 matches 2..4 if score @n[type=villager,tag=AzrielNPC_marinus] Health matches ..400 run rotate @s ~40 ~
execute if score @s[tag=attack_throw_angle_right] rng1 matches 5..8 if score @n[type=villager,tag=AzrielNPC_marinus] Health matches ..300 run rotate @s ~40 ~
