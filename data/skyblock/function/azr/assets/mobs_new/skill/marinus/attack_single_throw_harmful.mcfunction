...
execute if score @s rng1 matches 4 if score @s rng5 matches 1 rotated as @s rotated ~ 0 run summon marker ^ ^ ^-0.5 {Tags:["AzrielMob_boss_marinus_axe_throw_marker","AzrielMob_mob_marker"]}
execute if score @s rng1 matches 4 if score @s rng5 matches 2 rotated as @s rotated ~ 0 run summon marker ^ ^ ^-0.5 {Tags:["AzrielMob_boss_marinus_axe_throw_marker","AzrielMob_mob_marker","attack_throw_high"]}
