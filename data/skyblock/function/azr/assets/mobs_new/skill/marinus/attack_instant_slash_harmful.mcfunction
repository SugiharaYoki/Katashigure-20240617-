...
execute at @s rotated as @s rotated ~ 0 positioned ^ ^ ^1.3 as @e[tag=AzrielMob,distance=0..2,tag=!AzrielNPC] at @s run damage @s 12 generic by @n[tag=AzrielNPC_marinus]
...
execute at @s rotated as @s rotated ~ 0 positioned ^ ^ ^1.3 positioned ~ ~1 ~ as @e[tag=AzrielMob,distance=0..2,tag=!AzrielNPC] at @s run damage @s 12 generic by @n[tag=AzrielNPC_marinus]
