...
execute as @s[scores={rng1=1..125}] at @s run particle block{block_state:{Name:raw_gold_block}} ~ ~ ~ 0.1 0.1 0.1 0.09 2
execute as @s[scores={rng1=125}] at @s run tellraw @a[tag=MG_AZR0PT] {"text":"宝藏兔逃走了……","color": "gray","bold": false}
