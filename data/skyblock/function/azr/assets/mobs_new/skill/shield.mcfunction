...
execute if score @s rng1 matches 70..80 rotated ~ 0 run particle minecraft:wax_off ^ ^0.2 ^0.5
execute if score @s rng1 matches 70..80 rotated ~ 0 run particle minecraft:wax_off ^ ^0.2 ^1
execute if score @s rng1 matches 70..80 rotated ~ 0 run particle minecraft:wax_off ^ ^0.2 ^1.5
execute if score @s rng1 matches 70..80 rotated ~ 0 run particle minecraft:wax_off ^ ^0.2 ^2
execute if score @s rng1 matches 70..80 rotated ~ 0 run particle minecraft:wax_off ^ ^0.2 ^2.5
execute if score @s rng1 matches 70..80 rotated ~ 0 run particle minecraft:wax_off ^ ^0.2 ^3
