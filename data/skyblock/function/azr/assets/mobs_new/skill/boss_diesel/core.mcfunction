...
execute if score @s AzrEntityTimer matches 51 positioned -80011 25 200 run bossbar set azr:boss_hp_bar_diesel max 300
...
#ACTION
    ...
    execute as @n[tag=AzrielBossDiesel] at @s if score @s[scores={Health=40..90}] rng8 matches 1 unless entity @s[scores={rng2=1..}] store result score @s rng2 run random value 1..5
    execute as @n[tag=AzrielBossDiesel] at @s if score @s[scores={Health=..39}] rng8 matches 1 unless entity @s[scores={rng2=1..}] store result score @s rng2 run random value 1..4
    ...
    execute as @n[tag=AzrielBossDiesel] at @s if entity @s[scores={Health=90..}] run scoreboard players set @s rng8 -20
    execute as @n[tag=AzrielBossDiesel] at @s if score @s[scores={rng2=4..5}] rng8 matches 30.. run scoreboard players set @s rng2 0
    execute as @n[tag=AzrielBossDiesel] at @s if score @s rng8 matches 30.. run scoreboard players set @s rng8 -1
