...
execute unless entity @n[tag=AzrielMob_trap_spike,distance=..0.5,type=slime] run particle block{block_state:{Name:pointed_dripstone}} ~ ~0.2 ~ 0.2 0.2 0.2 0.05 30
...
execute as @p[tag=azrPlayer,distance=..0.8,gamemode=adventure] at @s run particle block{block_state:{Name:pointed_dripstone}} ~ ~0.2 ~ 0.2 0.2 0.2 0.05 30
