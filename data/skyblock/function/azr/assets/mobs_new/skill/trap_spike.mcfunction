...
execute unless entity @n[tag=AzrielMob_trap_spike,distance=..0.5,type=slime] run particle block{block_state:{Name:pointed_dripstone}} ~0.5 ~0.2 ~0.5 0.2 0.2 0.2 0.05 10
execute unless entity @n[tag=AzrielMob_trap_spike,distance=..0.5,type=slime] run kill @s[tag=AzrielMob_trap_spike_display]

execute as @p[tag=azrPlayer,distance=..0.8,gamemode=adventure] at @s run damage @s 4 cactus
execute as @p[tag=azrPlayer,distance=..0.8,gamemode=adventure] at @s run particle block{block_state:{Name:pointed_dripstone}} ~0.5 ~0.2 ~0.5 0.2 0.2 0.2 0.05 10
execute as @p[tag=azrPlayer,distance=..0.8,gamemode=adventure] at @s run kill @n[tag=AzrielMob_trap_spike,distance=..0.5,type=slime]
