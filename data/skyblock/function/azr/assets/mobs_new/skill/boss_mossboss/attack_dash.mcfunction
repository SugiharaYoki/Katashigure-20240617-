...
execute if score @s rng8 matches 02..20 at @s rotated as @s run rotate @s facing entity @p[tag=azrPlayer]
...
execute if score @s rng8 matches 21 facing entity @p[tag=azrPlayer] feet rotated ~ 0 positioned 0.0 0 0.0 run summon marker ^ ^0.01 ^1.4 {Tags:["AzrielMob_move_marker"]}
...
execute if score @s rng8 matches 32..50 at @s rotated as @s run rotate @s facing entity @p[tag=azrPlayer]
...
execute if score @s rng8 matches 51 facing entity @p[tag=azrPlayer] feet rotated ~ 0 positioned 0.0 0 0.0 run summon marker ^ ^0.01 ^1.4 {Tags:["AzrielMob_move_marker"]}
...
execute if score @s rng8 matches 62..83 at @s rotated as @s run rotate @s facing entity @p[tag=azrPlayer]
...
execute if score @s rng8 matches 84 facing entity @p[tag=azrPlayer] feet rotated ~ 0 positioned 0.0 0 0.0 run summon marker ^ ^0.01 ^1.4 {Tags:["AzrielMob_move_marker"]}
