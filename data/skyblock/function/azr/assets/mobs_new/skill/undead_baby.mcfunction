...
execute if score @s rng1 matches 7 if items entity @s weapon.mainhand green_bundle run summon area_effect_cloud ~ ~0.3 ~ {Particle:{type:effect},Radius:0.1,RadiusPerTick:0.01,Duration:60,potion_contents:{potion:poison,custom_color:6192150,custom_effects:[{id:poison,duration:60,amplifier:1,show_particles:1b,show_icon:1b}]}}
