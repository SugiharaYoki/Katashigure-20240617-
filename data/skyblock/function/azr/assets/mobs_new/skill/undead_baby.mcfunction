...
execute if score @s rng1 matches 40 if items entity @s weapon.mainhand green_bundle run summon area_effect_cloud ~ ~0.3 ~ {Particle:{type:composter},Radius:4,Duration:10,potion_contents:{potion:poison,custom_color:6192150,custom_effects:[{id:poison,duration:60,amplifier:1,show_particles:1b,show_icon:1b}]}}
