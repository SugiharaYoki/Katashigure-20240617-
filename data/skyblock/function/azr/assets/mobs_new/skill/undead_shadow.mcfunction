...
execute if entity @s[tag=!AzrielMob_undead_shadow_tp_success] as @r[tag=azrPlayer] at @s rotated ~ 0 positioned ^0.2 ^-1 ^-4 unless block ~ ~-1 ~ #air if block ~ ~ ~ #air if block ~ ~1 ~ #air as @n[tag=AzrielMob_undead_shadow_self] run function skyblock:azr/assets/mobs_new/skill/undead_shadow_tp
execute if entity @s[tag=!AzrielMob_undead_shadow_tp_success] as @r[tag=azrPlayer] at @s rotated ~ 0 positioned ^0.2 ^1 ^-4 unless block ~ ~-1 ~ #air if block ~ ~ ~ #air if block ~ ~1 ~ #air as @n[tag=AzrielMob_undead_shadow_self] run function skyblock:azr/assets/mobs_new/skill/undead_shadow_tp
execute if entity @s[tag=!AzrielMob_undead_shadow_tp_success] as @r[tag=azrPlayer] at @s rotated ~ 0 positioned ^0.2 ^ ^-4 unless block ~ ~-1 ~ #air if block ~ ~ ~ #air if block ~ ~1 ~ #air as @n[tag=AzrielMob_undead_shadow_self] run function skyblock:azr/assets/mobs_new/skill/undead_shadow_tp
execute if entity @s[tag=!AzrielMob_undead_shadow_tp_success] as @r[tag=azrPlayer] at @s rotated ~ 0 positioned ^-0.2 ^-1 ^-4 unless block ~ ~-1 ~ #air if block ~ ~ ~ #air if block ~ ~1 ~ #air as @n[tag=AzrielMob_undead_shadow_self] run function skyblock:azr/assets/mobs_new/skill/undead_shadow_tp
execute if entity @s[tag=!AzrielMob_undead_shadow_tp_success] as @r[tag=azrPlayer] at @s rotated ~ 0 positioned ^-0.2 ^1 ^-4 unless block ~ ~-1 ~ #air if block ~ ~ ~ #air if block ~ ~1 ~ #air as @n[tag=AzrielMob_undead_shadow_self] run function skyblock:azr/assets/mobs_new/skill/undead_shadow_tp
execute if entity @s[tag=!AzrielMob_undead_shadow_tp_success] as @r[tag=azrPlayer] at @s rotated ~ 0 positioned ^-0.2 ^ ^-4 unless block ~ ~-1 ~ #air if block ~ ~ ~ #air if block ~ ~1 ~ #air as @n[tag=AzrielMob_undead_shadow_self] run function skyblock:azr/assets/mobs_new/skill/undead_shadow_tp
