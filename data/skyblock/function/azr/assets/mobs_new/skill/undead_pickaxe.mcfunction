...
execute if score @s rng1 matches 6..19 as @s at @s as @p[tag=azrPlayer,distance=5.01..8] at @s run function skyblock:azr/assets/mobs_new/skill/undead_pickaxe_particle_place
...
execute if score @s rng1 matches 20 as @s at @s as @p[tag=azrPlayer,distance=5.01..8] at @s run summon marker ~ ~ ~ {Tags:["AzrielMob_generic_pillar_attack_small","AzrielMob_summon_delay"]}
