...
execute if score @s rng1 matches 20 as @s at @s as @p[tag=azrPlayer,distance=5.01..8] at @s rotated ~ 0 positioned ^ ^ ^0.55 run summon marker ~ ~ ~ {Tags:["AzrielMob_generic_pillar_attack_small","AzrielMob_summon_delay"]}
