...
execute if entity @s[scores={rng5=1}] at @p[tag=azrPlayer] rotated as @p[tag=azrPlayer] rotated ~ 0 positioned ^ ^ ^3.6 if block ~ ~ ~ air if block ~ ~1 ~ air run tp @s ~ ~ ~
execute if entity @s[scores={rng5=2}] at @p[tag=azrPlayer] rotated as @p[tag=azrPlayer] rotated ~ 0 positioned ^ ^ ^-3.6 if block ~ ~ ~ air if block ~ ~1 ~ air run tp @s ~ ~ ~
execute if entity @s[scores={rng5=3}] at @p[tag=azrPlayer] rotated as @p[tag=azrPlayer] rotated ~ 0 positioned ^3.6 ^ ^ if block ~ ~ ~ air if block ~ ~1 ~ air run tp @s ~ ~ ~
execute if entity @s[scores={rng5=4}] at @p[tag=azrPlayer] rotated as @p[tag=azrPlayer] rotated ~ 0 positioned ^-3.6 ^ ^ if block ~ ~ ~ air if block ~ ~1 ~ air run tp @s ~ ~ ~
