...
execute if score @s[scores={rng5=1,Health=..40}] rng8 matches 55 facing entity @p[tag=azrPlayer] feet rotated ~ 0 positioned 0.0 0 0.0 run summon marker ^0.52 ^0.01 ^0.2 {Tags:["AzrielMob_move_marker"]}
execute if score @s[scores={rng5=2,Health=..40}] rng8 matches 55 facing entity @p[tag=azrPlayer] feet rotated ~ 0 positioned 0.0 0 0.0 run summon marker ^0.6 ^0.01 ^0.3 {Tags:["AzrielMob_move_marker"]}
execute if score @s[scores={rng5=3,Health=..40}] rng8 matches 55 facing entity @p[tag=azrPlayer] feet rotated ~ 0 positioned 0.0 0 0.0 run summon marker ^-0.52 ^0.01 ^0.2 {Tags:["AzrielMob_move_marker"]}
execute if score @s[scores={rng5=4,Health=..40}] rng8 matches 55 facing entity @p[tag=azrPlayer] feet rotated ~ 0 positioned 0.0 0 0.0 run summon marker ^-0.6 ^0.01 ^0.3 {Tags:["AzrielMob_move_marker"]}
execute if score @s[scores={Health=..40}] rng8 matches 55 facing entity @p[tag=azrPlayer] feet rotated ~ 0 run data modify entity @s Motion set from entity @n[type=marker,tag=AzrielMob_move_marker] Pos
execute if score @s[scores={Health=..40}] rng8 matches 55 facing entity @p[tag=azrPlayer] feet rotated ~ 0 run kill @e[type=marker,tag=AzrielMob_move_marker]
