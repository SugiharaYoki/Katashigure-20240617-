...
execute if score @s rng8 matches 9 run particle large_smoke ~ ~1 ~ 0.2 1 0.2 0.03 10
execute if score @s rng8 matches 9 run effect give @s minecraft:invisibility 1 0 true
execute if score @s rng8 matches 9 run effect give @s minecraft:speed 2 4 true
execute if score @s rng8 matches 9..29 run particle ash ~ ~0.2 ~ 0.3 0 0.3 0.0 15

execute if score @s rng8 matches 59 run scoreboard players set @s rng2 0
execute if score @s rng8 matches 59 run scoreboard players set @s rng8 -50
