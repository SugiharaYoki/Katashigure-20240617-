...
execute if score @s[scores={rng2=1..}] rng1 matches 2.. as @s at @s run particle large_smoke ~ ~0.3 ~ 0.8 0.8 0.8 0.09 65 force
execute if score @s[scores={rng2=1..}] rng1 matches 2.. as @s at @s run particle large_smoke ~ ~0.3 ~ 0.8 0.8 0.8 0.14 20 force
...
execute if score @s[scores={rng2=1..}] rng1 matches 2.. as @s at @s run scoreboard players set @s rng2 1
