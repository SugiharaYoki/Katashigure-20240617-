...
execute if score @s[scores={Health=..180}] rng4 matches 1 run summon illusioner ~ ~ ~ {PersistenceRequired:0b,Invulnerable:0b,Tags:["AzrielMob","AzrielMob_typeLIFE"],DeathLootTable:"skyblock:null",Health:3.0f,CustomName:'"权之残影"',attributes:[{id:"max_health",base:3.0d},{id:"movement_speed",base:0.22},{id:"armor",base:4.0d}],HandItems:[{},{}],HandDropChances:[0.0f,0.0f]}
execute if score @s[scores={Health=..180}] rng4 matches 2 run summon illusioner ~ ~ ~ {PersistenceRequired:0b,Invulnerable:0b,Tags:["AzrielMob","AzrielMob_typeLIFE"],DeathLootTable:"skyblock:null",Health:3.0f,CustomName:'"权之残影"',attributes:[{id:"max_health",base:3.0d},{id:"movement_speed",base:0.22},{id:"armor",base:4.0d}],HandItems:[{id:bow},{}],HandDropChances:[0.0f,0.0f]}