...
execute if score @s rng8 matches 3 run summon marker ~ ~1 ~ {Tags:["AZR_summon_arroworb"]}

execute if score @s rng8 matches 4 run function skyblock:azr/assets/mobs_new/skill/boss1_andralune/move_back
