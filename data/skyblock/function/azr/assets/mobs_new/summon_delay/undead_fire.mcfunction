...
execute if score @s rng1 matches 1.. positioned ~ ~0.5 ~ run particle small_flame ~ ~1 ~ 0.3 0.5 0.3 0.5 1
execute if score @s rng1 matches 1.. positioned ~ ~0.5 ~ run particle sculk_soul ~ ~1 ~ 0.3 0.5 0.3 0.05 3
execute if score @s rng1 matches 39 positioned ~ ~ ~ run function skyblock:azr/assets/mobs_new/undead_fire
