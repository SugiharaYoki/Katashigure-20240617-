...
execute if score AzrielC_danger rng1 matches 1.. run summon rabbit ~ ~ ~ {CustomName:'[{"text":"宝藏兔"}]',DeathLootTable:"skyblock:azr_new/rabbit_tier1",Tags:["AzrielMob","AzrielMob_treasure_rabbit","AzrielMob_level_1"],attributes:[{id:"armor",base:5.0},{id:"movement_speed",base:0.42},{id:"max_health",base:50}],Health:50,PersistenceRequired:1b,RabbitType:4}
