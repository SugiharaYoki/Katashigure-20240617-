...
execute if score AzrielC_danger rng1 matches 1.. run summon sniffer ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_barrier_maintainer","AzrielMob_level_1"],DeathLootTable:"skyblock:azriel_cow_tier1",attributes:[{id:"max_health",base:20.0},{id:"armor",base:5.0},{base:0.2d,id:"movement_speed"}],Health:20.0f,CustomName:'"结界兽"',HandItems:[{},{}],HandDropChances:[0.1f,0.1f],ArmorItems:[{},{},{},{}]}
