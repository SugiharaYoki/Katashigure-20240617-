...
execute if score AzrielC_danger rng1 matches 2..3 run summon silverfish ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeMONSTER","AzrielMob_smoke","AzrielMob_level_2"],DeathLootTable:"skyblock:azr_new/silverfish_tier1",attributes:[{id:"attack_damage",base:0.5},{id:"max_health",base:14.0},{id:"armor",base:1.0},{base:0.2d,id:"movement_speed"}],Health:14.0f,CustomName:'"扬烟虫"'}
execute if score AzrielC_danger rng1 matches 4..5 run summon silverfish ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeMONSTER","AzrielMob_smoke","AzrielMob_level_3"],DeathLootTable:"skyblock:azr_new/silverfish_tier1",attributes:[{id:"attack_damage",base:10.0},{id:"max_health",base:22.0},{id:"armor",base:2.0},{base:0.23d,id:"movement_speed"}],Health:22.0f,CustomName:'"扬烟虫"'}
execute if score AzrielC_danger rng1 matches 6..7 run summon silverfish ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeMONSTER","AzrielMob_smoke","AzrielMob_level_4"],DeathLootTable:"skyblock:azr_new/silverfish_tier1",attributes:[{id:"attack_damage",base:1.5},{id:"max_health",base:28.0},{id:"armor",base:3.0},{base:0.25d,id:"movement_speed"}],Health:28.0f,CustomName:'"扬烟虫"'}
execute if score AzrielC_danger rng1 matches 8.. run summon silverfish ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeMONSTER","AzrielMob_smoke","AzrielMob_level_5"],DeathLootTable:"skyblock:azr_new/silverfish_tier1",attributes:[{id:"attack_damage",base:2.0},{id:"max_health",base:34.0},{id:"armor",base:4.0},{base:0.27d,id:"movement_speed"}],Health:34.0f,CustomName:'"扬烟虫"'}
