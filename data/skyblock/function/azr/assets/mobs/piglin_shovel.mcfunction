...
execute if score AzrielC_danger rng1 matches 1..15 run summon piglin ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeMONSTER","AzrielMob_piglin_shovel","AzrielMob_piglin_general","AzrielMob_level_3"],DeathLootTable:"skyblock:azr_new/piglin_tier1",attributes:[{id:"attack_damage",base:4.5},{id:"max_health",base:26.0},{id:"armor",base:2.0},{base:0.23d,id:"movement_speed"}],Health:26.0f,CustomName:'魔界工兵',equipment:{mainhand:{count:1,id:"golden_shovel"}},drop_chances:{mainhand:0.0f,offhand:0.0f,feet:0.0f,legs:0.0f,chest:0.0f,head:0.0f},IsImmuneToZombification:1b}
execute if score AzrielC_danger rng1 matches 16..26 run summon piglin ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeMONSTER","AzrielMob_piglin_shovel","AzrielMob_piglin_general","AzrielMob_level_4"],DeathLootTable:"skyblock:azr_new/piglin_tier1",attributes:[{id:"attack_damage",base:5.0},{id:"max_health",base:30.0},{id:"armor",base:3.0},{base:0.23d,id:"movement_speed"}],Health:30.0f,CustomName:'魔界工兵',equipment:{mainhand:{count:1,id:"golden_shovel"}},drop_chances:{mainhand:0.0f,offhand:0.0f,feet:0.0f,legs:0.0f,chest:0.0f,head:0.0f},IsImmuneToZombification:1b}
execute if score AzrielC_danger rng1 matches 27.. run summon piglin ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeMONSTER","AzrielMob_piglin_shovel","AzrielMob_piglin_general","AzrielMob_level_5"],DeathLootTable:"skyblock:azr_new/piglin_tier1",attributes:[{id:"attack_damage",base:5.5},{id:"max_health",base:34.0},{id:"armor",base:4.0},{base:0.24d,id:"movement_speed"}],Health:34.0f,CustomName:'魔界工兵',equipment:{mainhand:{count:1,id:"golden_shovel"}},drop_chances:{mainhand:0.0f,offhand:0.0f,feet:0.0f,legs:0.0f,chest:0.0f,head:0.0f},IsImmuneToZombification:1b}
