...
execute if score @s rng1 matches ..3 run particle witch ~0.0 ~0.2 ~0.80 0 0.2 0 0.05 1
execute if score @s rng1 matches ..3 run particle witch ~0.0 ~0.5 ~0.80 0 0.2 0 0.05 1
execute if score @s rng1 matches ..3 run particle witch ~0.0 ~0.8 ~0.80 0 0.2 0 0.05 1
execute if score @s rng1 matches ..3 run particle witch ~0.0 ~1.1 ~0.80 0 0.2 0 0.05 1
...
execute if entity @n[type=evoker_fangs,distance=..1.8] run kill @s
