...
execute if score @s AzrEntityTimer matches ..20 if block ~ ~-0.1 ~ air as @s at @s run tp @s ~ ~-0.01 ~
execute if score @s AzrEntityTimer matches -14.. if block ~ ~-0.1 ~ air as @s at @s run tp @s ~ ~-0.02 ~
execute if score @s AzrEntityTimer matches -12.. if block ~ ~-0.1 ~ air as @s at @s run tp @s ~ ~-0.03 ~
execute if score @s AzrEntityTimer matches -10.. if block ~ ~-0.1 ~ air as @s at @s run tp @s ~ ~-0.04 ~
execute if score @s AzrEntityTimer matches -8.. if block ~ ~-0.1 ~ air as @s at @s run tp @s ~ ~-0.05 ~
execute if score @s AzrEntityTimer matches -6.. if block ~ ~-0.1 ~ air as @s at @s run tp @s ~ ~-0.06 ~
execute if score @s AzrEntityTimer matches -4.. if block ~ ~-0.1 ~ air as @s at @s run tp @s ~ ~-0.07 ~
execute if score @s AzrEntityTimer matches -2.. if block ~ ~-0.1 ~ air as @s at @s run tp @s ~ ~-0.08 ~
