...
execute if score @s AzrEntityTimer matches ..20 as @s at @s if block ~ ~-0.1 ~ air run tp @s ~ ~-0.01 ~
execute if score @s AzrEntityTimer matches -14.. as @s at @s if block ~ ~-0.1 ~ air run tp @s ~ ~-0.02 ~
execute if score @s AzrEntityTimer matches -12.. as @s at @s if block ~ ~-0.1 ~ air run tp @s ~ ~-0.03 ~
execute if score @s AzrEntityTimer matches -10.. as @s at @s if block ~ ~-0.1 ~ air run tp @s ~ ~-0.04 ~
execute if score @s AzrEntityTimer matches -8.. as @s at @s if block ~ ~-0.1 ~ air run tp @s ~ ~-0.05 ~
execute if score @s AzrEntityTimer matches -6.. as @s at @s if block ~ ~-0.1 ~ air run tp @s ~ ~-0.06 ~
execute if score @s AzrEntityTimer matches -4.. as @s at @s if block ~ ~-0.1 ~ air run tp @s ~ ~-0.07 ~
execute if score @s AzrEntityTimer matches -2.. as @s at @s if block ~ ~-0.1 ~ air run tp @s ~ ~-0.08 ~
