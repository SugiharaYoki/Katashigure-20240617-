...
execute as @a[tag=azrPlayer,distance=..2.3] at @s run damage @s 6 minecraft:in_fire
execute as @e[tag=AzrielMob,distance=..2.3] at @s run damage @s 6 minecraft:in_fire
