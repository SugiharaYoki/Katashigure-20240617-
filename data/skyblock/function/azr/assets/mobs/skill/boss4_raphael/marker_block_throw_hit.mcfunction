...
execute as @a[tag=azrPlayer,distance=..4.4] at @s run damage @s 8 minecraft:explosion
execute as @e[tag=AzrielMob,distance=..5] at @s run damage @s 8 minecraft:explosion
