...
execute if score @s AzrEntityTimer matches 23 run fill -79641 -28 -590 -79639 -26 -590 air destroy
...
execute if score @s AzrEntityTimer matches 26 run fill -79641 -28 -591 -79639 -26 -591 air destroy
...
execute if score @s AzrEntityTimer matches 29 run fill -79641 -28 -592 -79639 -26 -592 air destroy
...
execute if score @s AzrEntityTimer matches 32 run fill -79641 -28 -593 -79639 -26 -593 air destroy
...
execute if score @s AzrEntityTimer matches 35 run fill -79641 -28 -594 -79639 -26 -594 air destroy
