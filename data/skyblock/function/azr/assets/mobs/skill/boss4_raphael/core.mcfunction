...
execute if score @s rng1 matches 770..790 run particle crimson_spore ~ ~ ~ 10 3 10 0 10
execute if score @s rng1 matches 770..790 run particle gust_emitter_small ~ ~ ~ 10 3 10 0 1
