...
execute if score @s rng1 matches 1..8 at @n[tag=AzrielNPC_raphael] positioned ~ ~1.3 ~ rotated as @s positioned ^ ^ ^3 run tp @s ~ ~ ~
execute if score @s rng1 matches 9..16 at @n[tag=AzrielNPC_raphael] positioned ~ ~1.3 ~ rotated as @s positioned ^ ^ ^3 positioned ~ ~0.25 ~ run tp @s ~ ~ ~
execute if score @s rng1 matches 17..24 at @n[tag=AzrielNPC_raphael] positioned ~ ~1.3 ~ rotated as @s positioned ^ ^ ^3 positioned ~ ~0.50 ~ run tp @s ~ ~ ~
execute if score @s rng1 matches 25..32 at @n[tag=AzrielNPC_raphael] positioned ~ ~1.3 ~ rotated as @s positioned ^ ^ ^3 positioned ~ ~0.25 ~ run tp @s ~ ~ ~
execute if score @s rng1 matches 33..40 at @n[tag=AzrielNPC_raphael] positioned ~ ~1.3 ~ rotated as @s positioned ^ ^ ^3 run tp @s ~ ~ ~
execute if score @s rng1 matches 41..48 at @n[tag=AzrielNPC_raphael] positioned ~ ~1.3 ~ rotated as @s positioned ^ ^ ^3 positioned ~ ~-0.25 ~ run tp @s ~ ~ ~
execute if score @s rng1 matches 49..56 at @n[tag=AzrielNPC_raphael] positioned ~ ~1.3 ~ rotated as @s positioned ^ ^ ^3 positioned ~ ~-0.50 ~ run tp @s ~ ~ ~
execute if score @s rng1 matches 57..64 at @n[tag=AzrielNPC_raphael] positioned ~ ~1.3 ~ rotated as @s positioned ^ ^ ^3 positioned ~ ~-0.25 ~ run tp @s ~ ~ ~
