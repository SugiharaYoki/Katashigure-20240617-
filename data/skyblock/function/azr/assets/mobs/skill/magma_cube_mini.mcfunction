...
execute if score @s rng1 matches 5 rotated ~ 0 as @s at @s positioned 0.0 0 0.0 run summon marker ^ ^0.064 ^0.4 {Tags:["AzrielMob_magma_cube_mini_move_marker"]}
...
execute if score @s rng1 matches 14.. run scoreboard players set @s rng1 1