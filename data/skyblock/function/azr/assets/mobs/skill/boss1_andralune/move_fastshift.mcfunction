...
execute as @s[scores={rng4=5..8},tag=AzrielMob] at @s store result score @s rng6 if entity @e[tag=AzrielMob_sword]
execute as @s[scores={rng4=5..8,rng6=..4},tag=AzrielMob] at @s run summon marker ~ ~ ~ {Tags:["AzrielMob_summon_delay_marker_sword","AzrielMob_summon_delay","AzrielMob_level_1"]}
