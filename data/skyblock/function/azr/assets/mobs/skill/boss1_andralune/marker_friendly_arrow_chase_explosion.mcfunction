...
execute if score @s rng1 matches 2.. as @s at @s run particle flash{color:[1.000,1.000,1.000,1.00]} ~ ~ ~ 0.1 0.1 0.1 0 1
execute if score @s rng1 matches 2.. as @s at @s if entity @n[distance=0..8,tag=AzrielMob_demon_amy] run particle explosion ~ ~ ~ 0.1 0.1 0.1 0 3
execute if score @s rng1 matches 2.. as @s at @s if entity @n[distance=0..8,tag=AzrielMob_demon_amy] run playsound entity.generic.explode hostile @a ~ ~ ~ 0.9 1.3
execute if score @s rng1 matches 2.. as @s at @s as @n[distance=0..5.5,tag=AzrielMob_demon_amy] run damage @s 12 arrow
