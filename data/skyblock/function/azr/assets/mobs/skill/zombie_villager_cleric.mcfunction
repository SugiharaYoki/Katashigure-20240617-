...
execute if score @s[scores={AzrielMobLevel=1..}] rng1 matches 63 store result score @s rng2 run random value 15..20
execute if score @s[scores={AzrielMobLevel=2..}] rng1 matches 63 store result score @s rng2 run random value 15..25
execute if score @s[scores={AzrielMobLevel=3..}] rng1 matches 63 store result score @s rng2 run random value 20..30
execute if score @s[scores={AzrielMobLevel=4..}] rng1 matches 63 store result score @s rng2 run random value 20..35
execute if score @s[scores={AzrielMobLevel=5..}] rng1 matches 63 store result score @s rng2 run random value 25..40

execute if score @s[scores={AzrielMobLevel=1..}] rng1 matches 63 run scoreboard players operation @s rng1 += @s rng2
