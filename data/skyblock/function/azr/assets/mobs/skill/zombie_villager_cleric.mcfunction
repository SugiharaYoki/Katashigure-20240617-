...
execute if score @s rng1 matches 2..12 positioned ^ ^2.2 ^ rotated 000 ~ run particle dripping_obsidian_tear ^ ^ ^1 0 0 0 0 1 force
execute if score @s rng1 matches 2..12 positioned ^ ^2.2 ^ rotated 030 ~ run particle dripping_obsidian_tear ^ ^ ^1 0 0 0 0 1 force
execute if score @s rng1 matches 2..12 positioned ^ ^2.2 ^ rotated 060 ~ run particle dripping_obsidian_tear ^ ^ ^1 0 0 0 0 1 force
execute if score @s rng1 matches 2..12 positioned ^ ^2.2 ^ rotated 090 ~ run particle dripping_obsidian_tear ^ ^ ^1 0 0 0 0 1 force
execute if score @s rng1 matches 2..12 positioned ^ ^2.2 ^ rotated 120 ~ run particle dripping_obsidian_tear ^ ^ ^1 0 0 0 0 1 force
execute if score @s rng1 matches 2..12 positioned ^ ^2.2 ^ rotated 150 ~ run particle dripping_obsidian_tear ^ ^ ^1 0 0 0 0 1 force
execute if score @s rng1 matches 2..12 positioned ^ ^2.2 ^ rotated 180 ~ run particle dripping_obsidian_tear ^ ^ ^1 0 0 0 0 1 force
execute if score @s rng1 matches 2..12 positioned ^ ^2.2 ^ rotated 210 ~ run particle dripping_obsidian_tear ^ ^ ^1 0 0 0 0 1 force
execute if score @s rng1 matches 2..12 positioned ^ ^2.2 ^ rotated 240 ~ run particle dripping_obsidian_tear ^ ^ ^1 0 0 0 0 1 force
execute if score @s rng1 matches 2..12 positioned ^ ^2.2 ^ rotated 270 ~ run particle dripping_obsidian_tear ^ ^ ^1 0 0 0 0 1 force
execute if score @s rng1 matches 2..12 positioned ^ ^2.2 ^ rotated 300 ~ run particle dripping_obsidian_tear ^ ^ ^1 0 0 0 0 1 force
execute if score @s rng1 matches 2..12 positioned ^ ^2.2 ^ rotated 330 ~ run particle dripping_obsidian_tear ^ ^ ^1 0 0 0 0 1 force
