...
execute if score @s[scores={AzrielMobLevel=1..}] rng1 matches 2 run item replace entity @s weapon.mainhand with stone_axe[custom_data={stone_axe_normal:1b},custom_model_data={floats:[100001.0]}]
...
execute if score @s[scores={AzrielMobLevel=3..}] rng1 matches 2 run item replace entity @s weapon.mainhand with iron_axe[custom_data={iron_axe_normal:1b},custom_model_data={floats:[100001.0]}]
