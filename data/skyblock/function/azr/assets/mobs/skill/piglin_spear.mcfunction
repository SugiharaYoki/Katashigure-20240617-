...
execute if score @s rng1 matches 20 run effect give @s speed 1 0 true
...
execute if score @s rng1 matches 20 rotated ~ 0 run particle minecraft:wax_off ^ ^0.2 ^4.5
execute if score @s rng1 matches 20 rotated ~ 0 run particle minecraft:wax_off ^ ^0.2 ^5
execute if score @s rng1 matches 20 rotated ~ 0 run particle minecraft:wax_off ^ ^0.2 ^5.5
execute if score @s rng1 matches 20 rotated ~ 0 run particle minecraft:wax_off ^ ^0.2 ^6
