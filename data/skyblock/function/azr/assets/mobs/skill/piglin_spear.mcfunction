...
execute if score @s rng1 matches 20 rotated ~ 0 run particle minecraft:wax_off ^ ^0.2 ^0.5
execute if score @s rng1 matches 20 rotated ~ 0 run particle minecraft:wax_off ^ ^0.2 ^1
