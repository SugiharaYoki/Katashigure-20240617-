...
execute if score @s rng1 matches 10000 as @a[tag=azrPlayer] at @s run effect give @s regeneration 5 19 true
...
execute if score @s rng1 matches 10006..18888 if score @s rng19 matches ..2100 run stopsound @a[tag=azrShowDialog] music minecraft:truehero
...
execute if score @s rng1 matches 2310..2330 run scoreboard players set @s rng11 160
...
execute if score @s rng1 matches 2320..2333 run scoreboard players set @s rng13 1
...
execute if score @s rng1 matches 2435 run kill @a[tag=azrPlayer]
