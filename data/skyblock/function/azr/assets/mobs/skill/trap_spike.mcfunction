...
execute as @p[tag=azrPlayer,distance=..0.8,gamemode=adventure] at @s run particle block{block_state:{Name:pointed_dripstone}} ~ ~0.2 ~ 0.2 0.2 0.2 0.05 10
execute as @p[tag=azrPlayer,distance=..0.8,gamemode=adventure] at @s run kill @n[tag=AzrielMob_trap_spike,distance=..0.65,type=slime]
