...
execute as @p[tag=azrPlayer,distance=..0.8,gamemode=adventure] at @s unless items entity @s armor.feet *[custom_data={iron_boots_lightstep:1b}] run damage @s 3.5 generic
...
execute as @p[tag=azrPlayer,distance=..0.4,gamemode=adventure] at @s run damage @s 4 generic
