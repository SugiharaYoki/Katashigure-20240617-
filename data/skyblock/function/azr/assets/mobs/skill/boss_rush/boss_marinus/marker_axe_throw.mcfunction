...
execute if score @s[tag=attack_throw_angle_left] rng1 matches 5..8 if score @n[type=villager,tag=AzrielBoss_BossRush_Marinus] Health matches ..300 rotated as @s run rotate @s ~-30 ~
execute if score @s[tag=attack_throw_angle_right] rng1 matches 1 if score @n[type=villager,tag=AzrielBoss_BossRush_Marinus] Health matches ..500 rotated as @s run rotate @s ~30 ~
execute if score @s[tag=attack_throw_angle_right] rng1 matches 2..4 if score @n[type=villager,tag=AzrielBoss_BossRush_Marinus] Health matches ..400 rotated as @s run rotate @s ~30 ~
execute if score @s[tag=attack_throw_angle_right] rng1 matches 5..8 if score @n[type=villager,tag=AzrielBoss_BossRush_Marinus] Health matches ..300 rotated as @s run rotate @s ~30 ~

execute if score @s rng1 matches 2..16 rotated as @s[tag=!attack_throw_high] positioned as @s rotated ~ 0 run function skyblock:azr/assets/mobs/skill/boss_rush/boss_marinus/marker_axe_throw_warn
execute if score @s rng1 matches 2..16 rotated as @s[tag=attack_throw_high] positioned as @s positioned ~ ~1.9 ~ rotated ~ 0 run function skyblock:azr/assets/mobs/skill/boss_rush/boss_marinus/marker_axe_throw_warn
...
execute if score @s[tag=!AzrielFriendly] rng1 matches 16.. at @s[tag=!attack_throw_high] positioned ^ ^ ^0.4 as @a[tag=azrPlayer,distance=..2.1] at @s unless block ~ ~-0.2 ~ air run damage @s 5 mob_attack by @n[type=villager,tag=AzrielBoss_BossRush_Marinus]
execute if score @s[tag=AzrielFriendly] rng1 matches 16.. at @s positioned ^ ^ ^0.4 as @e[tag=AzrielMob,distance=..3.1] at @s unless block ~ ~-0.2 ~ air run damage @s 10 mob_attack by @n[type=villager,tag=AzrielBoss_BossRush_Marinus]
...
execute if score @s[tag=!AzrielFriendly] rng1 matches 16.. at @s[tag=attack_throw_high] positioned ^ ^ ^0.4 as @a[tag=azrPlayer,distance=..2.1] at @s unless entity @s[predicate=skyblock:sneak] run damage @s 5 mob_attack by @n[type=villager,tag=AzrielBoss_BossRush_Marinus]
execute if score @s[tag=!AzrielFriendly] rng1 matches 16.. at @s[tag=attack_throw_high] positioned ^ ^ ^0.4 as @a[tag=azrPlayer,distance=..2.1] at @s if entity @s[predicate=skyblock:sneak] if block ~ ~-0.3 ~ air run damage @s 5 mob_attack by @n[type=villager,tag=AzrielBoss_BossRush_Marinus]
