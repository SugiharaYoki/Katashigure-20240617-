...
#ACTION
    ...
    execute as @n[tag=AzrielBossCenturion] at @s if score @s[scores={Health=200..299}] rng8 matches 1 if score @s rng6 matches ..1 store result score @s rng6 run random value 20..32
