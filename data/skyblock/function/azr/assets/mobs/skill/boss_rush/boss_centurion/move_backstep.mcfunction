...
execute if entity @s[scores={rng5=1}] rotated ~ 0 positioned 0.0 0 0.0 run summon marker ^ ^0.3 ^-0.2 {Tags:["AzrielMob_move_marker"]}
execute if entity @s[scores={rng5=2}] rotated ~ 0 positioned 0.0 0 0.0 run summon marker ^-0.6 ^0.3 ^-0.2 {Tags:["AzrielMob_move_marker"]}
execute if entity @s[scores={rng5=3}] rotated ~ 0 positioned 0.0 0 0.0 run summon marker ^0.6 ^0.3 ^-0.2 {Tags:["AzrielMob_move_marker"]}
