...
#ACTION
    ...
    execute as @n[tag=AzrielBossDiesel] at @s if score @s[scores={Health=150..180}] rng8 matches 1 unless entity @s[scores={rng2=1..}] store result score @s rng2 run random value 3..7
    execute as @n[tag=AzrielBossDiesel] at @s if score @s[scores={Health=100..149}] rng8 matches 1 unless entity @s[scores={rng2=1..}] store result score @s rng2 run random value 2..6
    ...
    execute as @n[tag=AzrielBossDiesel] at @s if score @s[scores={rng2=3..6}] rng8 matches 1.. run function skyblock:azr/assets/mobs/skill/boss_rush/boss_diesel/attack_fire
    execute as @n[tag=AzrielBossDiesel] at @s if score @s[scores={rng2=2}] rng8 matches 1.. run function skyblock:azr/assets/mobs/skill/boss_rush/boss_diesel/attack_call
    execute as @n[tag=AzrielBossDiesel] at @s if score @s[scores={rng2=1}] rng8 matches 1.. run function skyblock:azr/assets/mobs/skill/boss_rush/boss_diesel/attack_outround
