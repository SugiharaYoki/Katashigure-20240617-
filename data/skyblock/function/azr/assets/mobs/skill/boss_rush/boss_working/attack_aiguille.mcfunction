...
execute if score @s rng8 matches 8 run summon marker ~ ~1 ~ {Tags:["AzrielMob_mob_marker_dripstone_aiguille","AzrielMob_mob_marker","AzrielMob_dripstone_aiguille_large_range"]}
