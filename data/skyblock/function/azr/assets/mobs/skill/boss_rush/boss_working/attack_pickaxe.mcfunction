...
execute if score @s[scores={Health=..120}] rng8 matches 16 as @s at @s run function skyblock:azr/assets/mobs/skill/boss_rush/boss_working/attack_pickaxe_random
execute if score @s[scores={Health=..100}] rng8 matches 17 as @s at @s run function skyblock:azr/assets/mobs/skill/boss_rush/boss_working/attack_pickaxe_random
