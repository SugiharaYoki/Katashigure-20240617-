...
execute if score @s rng1 matches 5 if score @s rng5 matches 3 run scoreboard players set @s rng1 -140
execute if score @s rng1 matches 5 if score @s rng5 matches 4 run scoreboard players set @s rng1 -60
