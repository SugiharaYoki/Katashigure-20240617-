...
execute at @s rotated as @s rotated ~ 0 positioned ^ ^ ^1.3 as @e[tag=AzrielMob,distance=0.1..2,tag=!AzrielBoss_BossRush_Marinus] at @s run damage @s 12 mob_attack by @n[tag=AzrielBoss_BossRush_Marinus]
execute at @s rotated as @s rotated ~ 0 positioned ^ ^ ^1.3 as @a[tag=azrPlayer,distance=0..2] at @s run damage @s 8 mob_attack by @n[tag=AzrielBoss_BossRush_Marinus]
execute at @s rotated as @s rotated ~ 0 positioned ^ ^ ^1.3 positioned ~ ~1 ~ as @e[tag=AzrielMob,distance=0.1..2,tag=!AzrielBoss_BossRush_Marinus] at @s run damage @s 12 mob_attack by @n[tag=AzrielBoss_BossRush_Marinus]
execute at @s rotated as @s rotated ~ 0 positioned ^ ^ ^1.3 positioned ~ ~1 ~ as @a[tag=azrPlayer,distance=0..2] at @s run damage @s 8 mob_attack by @n[tag=AzrielBoss_BossRush_Marinus]
