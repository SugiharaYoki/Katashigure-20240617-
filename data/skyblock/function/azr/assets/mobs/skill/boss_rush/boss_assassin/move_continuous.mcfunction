...
execute if score @s[scores={rng5=1}] rng8 matches 4 facing entity @p[tag=azrPlayer] feet rotated ~ 0 positioned 0.0 0 0.0 run summon marker ^1.02 ^0.01 ^0.2 {Tags:["AzrielMob_assassin_move_marker"]}
execute if score @s[scores={rng5=2}] rng8 matches 4 facing entity @p[tag=azrPlayer] feet rotated ~ 0 positioned 0.0 0 0.0 run summon marker ^1.2 ^0.01 ^0.3 {Tags:["AzrielMob_assassin_move_marker"]}
execute if score @s[scores={rng5=3}] rng8 matches 4 facing entity @p[tag=azrPlayer] feet rotated ~ 0 positioned 0.0 0 0.0 run summon marker ^-1.02 ^0.01 ^0.2 {Tags:["AzrielMob_assassin_move_marker"]}
execute if score @s[scores={rng5=4}] rng8 matches 4 facing entity @p[tag=azrPlayer] feet rotated ~ 0 positioned 0.0 0 0.0 run summon marker ^-1.2 ^0.01 ^0.3 {Tags:["AzrielMob_assassin_move_marker"]}
execute if score @s rng8 matches 4 facing entity @p[tag=azrPlayer] feet rotated ~ 0 run data modify entity @s Motion set from entity @n[type=marker,tag=AzrielMob_assassin_move_marker] Pos
execute if score @s rng8 matches 4 facing entity @p[tag=azrPlayer] feet rotated ~ 0 run kill @e[type=marker,tag=AzrielMob_assassin_move_marker]
execute if score @s rng8 matches 13 run particle large_smoke ~ ~1 ~ 0.2 1 0.2 0.03 10
execute if score @s rng8 matches 13 run function skyblock:azr/assets/mobs/skill/boss_rush/boss_assassin/inventory_clear
...
execute if score @s[scores={rng5=3,Health=..120}] rng8 matches 22 facing entity @p[tag=azrPlayer] feet rotated ~ 0 positioned 0.0 0 0.0 run summon marker ^-0.52 ^0.01 ^0.2 {Tags:["AzrielMob_assassin_move_marker"]}
execute if score @s[scores={rng5=4,Health=..120}] rng8 matches 22 facing entity @p[tag=azrPlayer] feet rotated ~ 0 positioned 0.0 0 0.0 run summon marker ^-0.6 ^0.01 ^0.3 {Tags:["AzrielMob_assassin_move_marker"]}
execute if score @s[scores={Health=..120}] rng8 matches 22 facing entity @p[tag=azrPlayer] feet rotated ~ 0 run data modify entity @s Motion set from entity @n[type=marker,tag=AzrielMob_assassin_move_marker] Pos
execute if score @s[scores={Health=..120}] rng8 matches 22 facing entity @p[tag=azrPlayer] feet rotated ~ 0 run kill @e[type=marker,tag=AzrielMob_assassin_move_marker]


execute if score @s rng8 matches 33 run function skyblock:azr/assets/mobs/skill/boss_rush/boss_assassin/inventory_from_chest
