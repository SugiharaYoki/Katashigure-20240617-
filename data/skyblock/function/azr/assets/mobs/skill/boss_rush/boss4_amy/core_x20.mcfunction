...
execute if score @s rng8 matches 110 run summon marker ^ ^ ^-3 {Tags:["AzrielMob_boss_amy_axe_line_marker","AzrielMob_mob_marker"]}
execute if score @s rng8 matches 120 run summon marker ^ ^ ^-3 {Tags:["AzrielMob_boss_amy_axe_line_marker","AzrielMob_mob_marker"]}
