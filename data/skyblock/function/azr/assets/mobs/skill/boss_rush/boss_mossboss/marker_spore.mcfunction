...
execute if entity @s[scores={rng1=2}] store result score @s rng8 run random value 1..8

execute if score @s[scores={rng1=2}] rng8 matches 1 run rotate @s 0 0
execute if score @s[scores={rng1=2}] rng8 matches 2 run rotate @s 45 0
execute if score @s[scores={rng1=2}] rng8 matches 3 run rotate @s 90 0
execute if score @s[scores={rng1=2}] rng8 matches 4 run rotate @s 135 0
execute if score @s[scores={rng1=2}] rng8 matches 5 run rotate @s 180 0
execute if score @s[scores={rng1=2}] rng8 matches 6 run rotate @s 225 0
execute if score @s[scores={rng1=2}] rng8 matches 7 run rotate @s 270 0
execute if score @s[scores={rng1=2}] rng8 matches 8 run rotate @s 315 0
...
execute if entity @s[scores={rng1=2..}] positioned ^ ^0.2 ^ run particle composter ~ ~ ~ 0.3 0 0.3 0 3 force
execute if entity @s[scores={rng1=15..}] positioned ^ ^0.2 ^ run particle smoke ~ ~ ~ 0.5 0 0.5 0 3



execute if entity @s[scores={rng1=2..20}] run tp @s ^ ^ ^0.1
execute if entity @s[scores={rng1=2..15}] run tp @s ^ ^ ^0.1
execute if entity @s[scores={rng1=2..12}] run tp @s ^ ^ ^0.15
