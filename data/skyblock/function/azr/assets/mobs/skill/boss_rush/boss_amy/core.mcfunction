...
execute if score @s[scores={Health=..400}] rng5 matches 24 run summon marker ~ ~ ~ {Tags:["AzrielMob_candle_angel_candle_throw_marker","AzrTrace","AzrielMob_mob_marker"]}
execute if score @s[scores={Health=..400}] rng5 matches 25 run summon marker ~ ~ ~ {Tags:["AzrielMob_candle_angel_candle_throw_marker","AzrTrace","AzrielMob_mob_marker"]}
execute if score @s[scores={Health=..400}] rng5 matches 26 run summon marker ~ ~ ~ {Tags:["AzrielMob_candle_angel_candle_throw_marker","AzrTrace","AzrielMob_mob_marker"]}
execute if score @s[scores={Health=..400}] rng5 matches 27 run summon marker ~ ~ ~ {Tags:["AzrielMob_candle_angel_candle_throw_marker","AzrTrace","AzrielMob_mob_marker"]}
execute if score @s[scores={Health=..300}] rng5 matches 34 run summon marker ~ ~ ~ {Tags:["AzrielMob_candle_angel_candle_throw_marker","AzrTrace","AzrielMob_mob_marker"]}
execute if score @s[scores={Health=..300}] rng5 matches 35 run summon marker ~ ~ ~ {Tags:["AzrielMob_candle_angel_candle_throw_marker","AzrTrace","AzrielMob_mob_marker"]}
execute if score @s[scores={Health=..300}] rng5 matches 36 run summon marker ~ ~ ~ {Tags:["AzrielMob_candle_angel_candle_throw_marker","AzrTrace","AzrielMob_mob_marker"]}
execute if score @s[scores={Health=..300}] rng5 matches 37 run summon marker ~ ~ ~ {Tags:["AzrielMob_candle_angel_candle_throw_marker","AzrTrace","AzrielMob_mob_marker"]}
execute if score @s[scores={Health=..100}] rng5 matches 44 run summon marker ~ ~ ~ {Tags:["AzrielMob_candle_angel_candle_throw_marker","AzrTrace","AzrielMob_mob_marker"]}
execute if score @s[scores={Health=..100}] rng5 matches 45 run summon marker ~ ~ ~ {Tags:["AzrielMob_candle_angel_candle_throw_marker","AzrTrace","AzrielMob_mob_marker"]}
execute if score @s[scores={Health=..100}] rng5 matches 46 run summon marker ~ ~ ~ {Tags:["AzrielMob_candle_angel_candle_throw_marker","AzrTrace","AzrielMob_mob_marker"]}
execute if score @s[scores={Health=..100}] rng5 matches 47 run summon marker ~ ~ ~ {Tags:["AzrielMob_candle_angel_candle_throw_marker","AzrTrace","AzrielMob_mob_marker"]}
...
execute if entity @s[scores={Health=..250},tag=!Phase3] as @s at @s run particle crimson_spore ~ ~1 ~ 6 1 6 0 600
