...
execute if score @s[scores={rng1=2..8}] rng8 matches 1 at @s rotated as @s rotated ~ 0 run function skyblock:azr/assets/mobs/skill/boss_rush/boss_diesel/marker_fire_particle_straight




execute if score @s[scores={rng1=22}] rng8 matches 1 at @s rotated as @s rotated ~ 0 positioned ^1 ^0.2 ^0.5 run function skyblock:azr/assets/mobs/skill/boss_rush/boss_diesel/marker_fire_burst
execute if score @s[scores={rng1=22}] rng8 matches 1 at @s rotated as @s rotated ~ 0 positioned ^1 ^0.2 ^1.0 run function skyblock:azr/assets/mobs/skill/boss_rush/boss_diesel/marker_fire_burst
execute if score @s[scores={rng1=22}] rng8 matches 1 at @s rotated as @s rotated ~ 0 positioned ^1 ^0.2 ^1.5 run function skyblock:azr/assets/mobs/skill/boss_rush/boss_diesel/marker_fire_burst
execute if score @s[scores={rng1=22}] rng8 matches 1 at @s rotated as @s rotated ~ 0 positioned ^1 ^0.2 ^2.0 run function skyblock:azr/assets/mobs/skill/boss_rush/boss_diesel/marker_fire_burst
execute if score @s[scores={rng1=22}] rng8 matches 1 at @s rotated as @s rotated ~ 0 positioned ^1 ^0.2 ^2.5 run function skyblock:azr/assets/mobs/skill/boss_rush/boss_diesel/marker_fire_burst
execute if score @s[scores={rng1=22}] rng8 matches 1 at @s rotated as @s rotated ~ 0 positioned ^1 ^0.2 ^3.0 run function skyblock:azr/assets/mobs/skill/boss_rush/boss_diesel/marker_fire_burst
execute if score @s[scores={rng1=22}] rng8 matches 1 at @s rotated as @s rotated ~ 0 positioned ^1 ^0.2 ^3.5 run function skyblock:azr/assets/mobs/skill/boss_rush/boss_diesel/marker_fire_burst
execute if score @s[scores={rng1=22}] rng8 matches 1 at @s rotated as @s rotated ~ 0 positioned ^1 ^0.2 ^4.0 run function skyblock:azr/assets/mobs/skill/boss_rush/boss_diesel/marker_fire_burst
execute if score @s[scores={rng1=22}] rng8 matches 1 at @s rotated as @s rotated ~ 0 positioned ^1 ^0.2 ^4.5 run function skyblock:azr/assets/mobs/skill/boss_rush/boss_diesel/marker_fire_burst
execute if score @s[scores={rng1=22}] rng8 matches 1 at @s rotated as @s rotated ~ 0 positioned ^1 ^0.2 ^5.0 run function skyblock:azr/assets/mobs/skill/boss_rush/boss_diesel/marker_fire_burst
execute if score @s[scores={rng1=22}] rng8 matches 1 at @s rotated as @s rotated ~ 0 positioned ^1 ^0.2 ^5.5 run function skyblock:azr/assets/mobs/skill/boss_rush/boss_diesel/marker_fire_burst
execute if score @s[scores={rng1=22}] rng8 matches 1 at @s rotated as @s rotated ~ 0 positioned ^1 ^0.2 ^6.0 run function skyblock:azr/assets/mobs/skill/boss_rush/boss_diesel/marker_fire_burst
execute if score @s[scores={rng1=22}] rng8 matches 1 at @s rotated as @s rotated ~ 0 positioned ^1 ^0.2 ^6.5 run function skyblock:azr/assets/mobs/skill/boss_rush/boss_diesel/marker_fire_burst
execute if score @s[scores={rng1=22}] rng8 matches 1 at @s rotated as @s rotated ~ 0 positioned ^1 ^0.2 ^7.0 run function skyblock:azr/assets/mobs/skill/boss_rush/boss_diesel/marker_fire_burst
execute if score @s[scores={rng1=22}] rng8 matches 1 at @s rotated as @s rotated ~ 0 positioned ^1 ^0.2 ^7.5 run function skyblock:azr/assets/mobs/skill/boss_rush/boss_diesel/marker_fire_burst
execute if score @s[scores={rng1=22}] rng8 matches 1 at @s rotated as @s rotated ~ 0 positioned ^1 ^0.2 ^8.0 run function skyblock:azr/assets/mobs/skill/boss_rush/boss_diesel/marker_fire_burst
execute if score @s[scores={rng1=22}] rng8 matches 1 at @s rotated as @s rotated ~ 0 positioned ^1 ^0.2 ^8.5 run function skyblock:azr/assets/mobs/skill/boss_rush/boss_diesel/marker_fire_burst
execute if score @s[scores={rng1=22}] rng8 matches 1 at @s rotated as @s rotated ~ 0 positioned ^1 ^0.2 ^9.0 run function skyblock:azr/assets/mobs/skill/boss_rush/boss_diesel/marker_fire_burst
