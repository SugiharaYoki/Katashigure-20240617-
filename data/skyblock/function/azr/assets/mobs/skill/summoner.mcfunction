...
execute if score @s rng1 matches 50 run item replace entity @s weapon.mainhand with amethyst_shard
execute if score @s rng1 matches 50 run playsound entity.evoker.prepare_summon hostile @a ~ ~ ~ 1 1.3
...
execute if score @s[scores={AzrielMobLevel=1..2}] rng1 matches 55 as @s at @s run summon marker ~ ~ ~ {Tags:["AzrielMob_summon_delay_marker_undead3","AzrielMob_summon_delay","AzrielMob_level_1"]}
execute if score @s[scores={AzrielMobLevel=3..4}] rng1 matches 55 as @s at @s run summon marker ~ ~ ~ {Tags:["AzrielMob_summon_delay_marker_undead3","AzrielMob_summon_delay","AzrielMob_level_2"]}
execute if score @s[scores={AzrielMobLevel=5..}] rng1 matches 55 as @s at @s run summon marker ~ ~ ~ {Tags:["AzrielMob_summon_delay_marker_undead3","AzrielMob_summon_delay","AzrielMob_level_3"]}
...
execute if score @s rng1 matches 60 run item replace entity @s weapon.mainhand with crossbow[custom_data={crossbow_normal:1b},custom_model_data={floats:[100001.0]}]
