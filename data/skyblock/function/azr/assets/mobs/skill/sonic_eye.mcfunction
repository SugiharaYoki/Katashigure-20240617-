...
execute if entity @s[tag=!AzrielMob_sonic_eye_reveal] if entity @p[tag=azrPlayer,distance=..6] run particle sculk_soul ~ ~ ~ 0.2 0.2 0.2 0.1 8
...
execute if entity @s[tag=AzrielMob_sonic_eye_reveal] store result score @s rng4 if entity @n[tag=AzrielMob_trap_sonic_laser,distance=..4.3]
