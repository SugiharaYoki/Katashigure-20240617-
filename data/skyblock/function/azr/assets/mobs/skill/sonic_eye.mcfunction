...
execute if entity @a[tag=azrPlayer,distance=12..24] facing entity @p[tag=azrPlayer,distance=2..] eyes run tp ^ ^ ^0.2
...
execute if entity @s[tag=AzrielMob_sonic_eye_reveal] store result score @s rng3 if entity @n[tag=AzrielMob_trap_sonic_laser,distance=..2.3]
execute if entity @s[tag=AzrielMob_sonic_eye_reveal] if entity @p[tag=azrPlayer,distance=..7] unless score @s rng3 matches 2.. store result score @s rng2 run random value 1..20
execute if entity @s[tag=AzrielMob_sonic_eye_reveal] if entity @n[tag=AzrielNPC_Divineforce,distance=..6] unless score @s rng3 matches 3.. store result score @s rng2 run random value 1..20
