...
particle soul_fire_flame ^0.2 ^ ^3 0.05 0.05 0.05 0.00 1
particle soul_fire_flame ^-0.2 ^ ^-3 0.05 0.05 0.05 0.00 1
particle soul_fire_flame ^5 ^ ^ 0.05 0.05 0.05 0.00 1
particle soul_fire_flame ^-5 ^ ^ 0.05 0.05 0.05 0.00 1
particle soul_fire_flame ^ ^5 ^0.2 0.05 0.05 0.05 0.00 1
particle soul_fire_flame ^ ^-5 ^-0.2 0.05 0.05 0.05 0.00 1
...
execute if score @s rng1 matches 2.. run particle soul_fire_flame ~ ~0.2 ~ 0.2 0.2 0.2 0.18 3
...
execute if score @s rng1 matches 29 run playsound entity.generic.explode hostile @a ~ ~ ~ 2 1.2
