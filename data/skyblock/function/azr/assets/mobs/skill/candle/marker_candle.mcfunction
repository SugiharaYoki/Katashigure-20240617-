...
execute if score @s rng1 matches 28.. as @a[tag=azrPlayer,distance=..1.3] at @s run damage @s 8 in_fire
execute if score @s rng1 matches 28.. as @a[tag=azrPlayer,distance=..2.0] at @s run damage @s 4 in_fire
