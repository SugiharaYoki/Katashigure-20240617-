...
execute if score @s[scores={rng5=1}] rng8 matches 4 facing entity @p[tag=azrPlayer] feet rotated ~ 0 positioned 0.0 0 0.0 run summon marker ^ ^0.3 ^-0.8 {Tags:["AzrielMob_move_marker"]}
execute if score @s[scores={rng5=2}] rng8 matches 4 facing entity @p[tag=azrPlayer] feet rotated ~ 0 positioned 0.0 0 0.0 run summon marker ^-0.2 ^0.3 ^-0.8 {Tags:["AzrielMob_move_marker"]}
execute if score @s[scores={rng5=3}] rng8 matches 4 facing entity @p[tag=azrPlayer] feet rotated ~ 0 positioned 0.0 0 0.0 run summon marker ^0.2 ^0.3 ^-0.8 {Tags:["AzrielMob_move_marker"]}
