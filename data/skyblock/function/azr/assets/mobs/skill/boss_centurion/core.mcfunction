...
#ACTION
    ...
    execute as @n[tag=AzrielBossCenturion] at @s if score @s[scores={Health=100..}] rng8 matches 1 unless entity @a[tag=azrPlayer,distance=..5] unless entity @s[scores={rng2=1..}] store result score @s rng2 run random value 1..2
    execute as @n[tag=AzrielBossCenturion] at @s if score @s[scores={Health=100..}] rng8 matches 1 if entity @a[tag=azrPlayer,distance=..5] unless entity @s[scores={rng2=1..}] store result score @s rng2 run random value 2..5
    execute as @n[tag=AzrielBossCenturion] at @s if score @s[scores={Health=..99}] rng8 matches 1 unless entity @s[scores={rng2=1..}] store result score @s rng2 run random value 6..7
...
execute if score @s AzrEntityTimer matches 2005 as @n[tag=AzrielBossCenturion] at @s run tp @s ~ ~-500 ~
execute if score @s AzrEntityTimer matches 2006 as @n[tag=AzrielBossCenturion] at @s run kill @s

execute if score @s AzrEntityTimer matches 2011 run stopsound @a[tag=azrShowDialog]
execute if score @s AzrEntityTimer matches 2011 run playsound minecraft:block.beacon.deactivate block @a ~ ~ ~ 10 0.7
execute if score @s AzrEntityTimer matches 2021 run title @a[tag=azrShowDialog] actionbar {text:"Boss Annihilated",color:"green"}
execute if score @s AzrEntityTimer matches 2021 run advancement grant @a[tag=azrPlayer] only skyblock:azr/progress/sub_boss_centurion
execute if score @s AzrEntityTimer matches 2021 run bossbar remove azr:boss_hp_bar_centurion
execute if score @s AzrEntityTimer matches 2021 run fill -79768 35 -276 -79768 31 -278 minecraft:air destroy
execute if score @s AzrEntityTimer matches 2021 as @a[tag=azrPlayer] at @s run tag @s add AZS_BoSB03
execute if score @s AzrEntityTimer matches 2021 as @a[tag=azrPlayer] at @s run give @s emerald 20
execute if score @s AzrEntityTimer matches 2021 as @a[tag=azrPlayer] at @s run give @s glistering_melon_slice 1
