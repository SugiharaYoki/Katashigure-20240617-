...
execute if score @s AzrEntityTimer matches 2 positioned -79770 30 -277 run function skyblock:azr/assets/mobs/skill/boss_centurion/summon

execute if score @s AzrEntityTimer matches 61 positioned -79770 30 -277 run bossbar add azr:boss_hp_bar_centurion "施工安全保障 - 百夫长"
execute if score @s AzrEntityTimer matches 61 positioned -79770 30 -277 run bossbar set azr:boss_hp_bar_centurion color red
execute if score @s AzrEntityTimer matches 61 positioned -79770 30 -277 run bossbar set azr:boss_hp_bar_centurion max 420
execute if score @s AzrEntityTimer matches 61 positioned -79770 30 -277 run bossbar set azr:boss_hp_bar_centurion players @a[tag=azrShowDialog]
...
execute if score @s AzrEntityTimer matches ..1999 unless entity @a[tag=azrPlayer,x=-79829,dx=19,y=40,dy=10,z=124,dz=22] run bossbar remove azr:boss_hp_bar_centurion
execute if score @s AzrEntityTimer matches ..1999 unless entity @a[tag=azrPlayer,x=-79829,dx=19,y=40,dy=10,z=124,dz=22] run tp @n[tag=AzrielBossCenturion] ~ ~-200 ~
execute if score @s AzrEntityTimer matches ..1999 unless entity @a[tag=azrPlayer,x=-79829,dx=19,y=40,dy=10,z=124,dz=22] run kill @n[tag=AzrielBossCenturion]
execute if score @s AzrEntityTimer matches ..1999 unless entity @a[tag=azrPlayer,x=-79829,dx=19,y=40,dy=10,z=124,dz=22] run function skyblock:azr/lifecycle/endgame/reset_map_boss_sub_centurion
execute if score @s AzrEntityTimer matches ..1999 unless entity @a[tag=azrPlayer,x=-79829,dx=19,y=40,dy=10,z=124,dz=22] run stopsound @a[tag=azrShowDialog] music minecraft:garden1.combathigh
