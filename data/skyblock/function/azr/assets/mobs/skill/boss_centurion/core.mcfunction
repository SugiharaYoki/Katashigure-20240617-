...
execute if score @s rng9 matches 546.. run scoreboard players set @s rng9 0
...
execute if score @s AzrEntityTimer matches 2001 as @n[tag=AzrielBossCenturion] at @s run particle portal ~ ~1 ~ 0.3 1 0.3 0.06 30
execute if score @s AzrEntityTimer matches 2001 as @n[tag=AzrielBossCenturion] at @s run playsound entity.enderman.teleport hostile @a ~ ~ ~ 3 0.8
