...
execute if score @s rng1 matches 6..19 as @s at @s as @p[tag=azrPlayer,distance=5.01..8] positioned ^ ^ ^0.55 at @s run function skyblock:azr/assets/mobs/skill/undead_pickaxe_particle_place
