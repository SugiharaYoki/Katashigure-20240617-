...
execute if score @s[scores={AzrielMobLevel=1..2}] rng1 matches 260 run effect give @s speed 30 0 true
execute if score @s[scores={AzrielMobLevel=3..}] rng1 matches 260 run effect give @s speed 30 1 true
