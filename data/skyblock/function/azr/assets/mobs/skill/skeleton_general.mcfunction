...
execute if score @s[scores={rng2=..4,AzrielMobLevel=1}] rng1 matches 2.. as @s at @s run tag @s add azr_skeleton_general_heal
execute if score @s[scores={rng2=..4,AzrielMobLevel=2}] rng1 matches 2.. as @s at @s run tag @s add azr_skeleton_general_heal
...
execute if score @s rng6 matches 0.. at @s if entity @n[type=#piglin,tag=AzrielMob,distance=0..8] run damage @s 0 arrow by @n[type=#undead,tag=AzrielMob,distance=0..9]
...
execute if score @s rng6 matches ..0 at @s on target unless entity @s[type=#undead,tag=AzrielMob] run scoreboard players set @n[tag=AzrielMob_piglin_general] rng6 -20