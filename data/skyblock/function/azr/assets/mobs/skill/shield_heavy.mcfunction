...
execute if score @s[tag=!AzrielMob_shield_armorbroken_h] rng3 matches 45.. as @s at @s run scoreboard players set @s rng3 8
...
execute if score @s[tag=!AzrielMob_shield_armorbroken_c] rng3 matches 45.. as @s at @s run scoreboard players set @s rng3 10
...
execute if score @s[tag=!AzrielMob_shield_armorbroken_l] rng3 matches 35.. as @s at @s run scoreboard players set @s rng3 12
