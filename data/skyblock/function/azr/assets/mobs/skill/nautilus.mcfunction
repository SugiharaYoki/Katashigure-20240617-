...
execute at @s[tag=!AzrMob_nautilus_havetarget] facing entity @n[type=item,distance=..9.2] feet positioned ^ ^ ^0.7 if block ~ ~ ~ #skyblock:water at @n[type=item,distance=..9.2] if block ~ ~ ~ #skyblock:water run tp @s ^ ^ ^0.01
