...
execute at @s[tag=!AzrMob_nautilus_havetarget] as @n[type=item,distance=..9.2,scores={AzrEntityTimer=30..}] at @s unless block ~ ~ ~ #skyblock:water run tag @s add AzrMob_nautilus_item_cannot_reach
