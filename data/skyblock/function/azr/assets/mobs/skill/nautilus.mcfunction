...
execute at @s[tag=!AzrMob_nautilus_havetarget] at @n[type=item,distance=..9.2] if block ~ ~ ~ #skyblock:water facing entity @n[type=item,distance=..9.2] feet positioned ^ ^ ^0.7 if block ~ ~ ~ #skyblock:water at @s run tp @s ^ ^ ^0.01
