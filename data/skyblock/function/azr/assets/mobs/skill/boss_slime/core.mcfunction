...
execute as @n[type=slime,tag=AzrielBossSlime_small_slime,distance=..24,tag=!AzrielBossSlime] run function skyblock:azr/assets/mobs/skill/boss_slime/interaction_absorb_slime
