...
execute if score @s[tag=!AzrielMob_shield_armorbroken] rng2 matches 10.. run scoreboard players add @s rng3 22
execute if score @s[tag=!AzrielMob_shield_armorbroken] rng2 matches 10.. run scoreboard players set @s rng2 0
execute if score @s[tag=!AzrielMob_shield_armorbroken] rng3 matches 45.. as @s at @s run particle white_smoke ~ ~1 ~ 0.3 0.6 0.3 0.06 20
execute if score @s[tag=!AzrielMob_shield_armorbroken] rng3 matches 45.. as @s at @s run playsound minecraft:item.shield.break master @a ~ ~ ~ 1 0.7
execute if score @s[tag=!AzrielMob_shield_armorbroken] rng3 matches 45.. as @s at @s run item replace entity @s armor.head with air
execute if score @s[tag=!AzrielMob_shield_armorbroken] rng3 matches 45.. as @s at @s run item replace entity @s armor.chest with air
execute if score @s[tag=!AzrielMob_shield_armorbroken] rng3 matches 45.. as @s at @s run tag @s add AzrielMob_shield_armorbroken
