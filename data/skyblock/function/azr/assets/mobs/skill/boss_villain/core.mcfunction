...
execute if score @s AzrEntityTimer matches 10 run fill -79867 49 -130 -79867 49 -127 iron_barsr
execute if score @s AzrEntityTimer matches 11 run fill -79867 48 -130 -79867 48 -127 iron_barsr
execute if score @s AzrEntityTimer matches 8..11 run playsound minecraft:block.iron_door.open block @a -79867 51 -129.0 3 0.5

execute if score @s AzrEntityTimer matches 12 run playsound minecraft:entity.evoker.ambient neutral @s ~ ~ ~ 1 0.7
...
execute if score @s AzrEntityTimer matches 22 run playsound minecraft:entity.evoker.ambient neutral @s ~ ~ ~ 1 0.7
...
execute if score @s AzrEntityTimer matches 34 run playsound minecraft:entity.evoker.ambient neutral @s ~ ~ ~ 1 0.7
...
execute if score @s AzrEntityTimer matches 41..50 positioned -79845 48 -128 run function skyblock:azr/assets/events/effects/player_magic_release

execute if score @s AzrEntityTimer matches 51 positioned -79845 48 -128 run function skyblock:azr/assets/mobs/skill/boss_villain/summon

execute if score @s AzrEntityTimer matches 51 positioned -79845 48 -128 run bossbar add azr:boss_hp_bar_diesel "避芒藏刃的无所在无所不在之恶徒 - 晦怨贤士"
execute if score @s AzrEntityTimer matches 51 positioned -79845 48 -128 run bossbar set azr:boss_hp_bar_diesel color red
execute if score @s AzrEntityTimer matches 51 positioned -79845 48 -128 run bossbar set azr:boss_hp_bar_diesel max 200
execute if score @s AzrEntityTimer matches 51 positioned -79845 48 -128 run bossbar set azr:boss_hp_bar_diesel players @a[tag=azrShowDialog]
...
execute positioned -79845 48 -128 store result bossbar azr:boss_hp_bar_diesel value run scoreboard players get @n[tag=AzrielBossVillain] Health
...
execute if score @s AzrEntityTimer matches 2011 positioned -79845 48 -128 run kill @e[tag=AzrielMob_floating_fire,type=magma_cube,distance=..15]
...
execute if score @s AzrEntityTimer matches ..1999 unless entity @a[tag=azrPlayer,x=-80021,dx=26,y=23,dy=9,z=191,dz=20] run fill -79867 48 -130 -79867 51 -127 air
execute if score @s AzrEntityTimer matches ..1999 unless entity @a[tag=azrPlayer,x=-80021,dx=26,y=23,dy=9,z=191,dz=20] run tp @n[tag=AzrielBossVillain] ~ ~-200 ~
execute if score @s AzrEntityTimer matches ..1999 unless entity @a[tag=azrPlayer,x=-80021,dx=26,y=23,dy=9,z=191,dz=20] run kill @n[tag=AzrielBossVillain]
