...
execute if entity @p[tag=azrPlayer,distance=12..16,tag=AzrSariel_Side_Life] facing entity @p[tag=azrPlayer,distance=2..] eyes run tp ^ ^ ^0.07
execute if entity @p[tag=azrPlayer,distance=8..16,tag=AzrSariel_Side_Life] facing entity @p[tag=azrPlayer,distance=2..] eyes run tp ^ ^ ^0.06
execute if entity @p[tag=azrPlayer,distance=4..16,tag=AzrSariel_Side_Life] facing entity @p[tag=azrPlayer,distance=2..] eyes run tp ^ ^ ^0.05
execute if entity @p[tag=azrPlayer,distance=2..16,tag=AzrSariel_Side_Life] facing entity @p[tag=azrPlayer,distance=2..] eyes run tp ^ ^ ^0.04
...
execute if entity @p[tag=azrPlayer,distance=8..12,tag=AzrSariel_Side_Death] facing entity @p[tag=azrPlayer,distance=2..] eyes run tp ^ ^ ^0.06
execute if entity @p[tag=azrPlayer,distance=4..12,tag=AzrSariel_Side_Death] facing entity @p[tag=azrPlayer,distance=2..] eyes run tp ^ ^ ^0.05
execute if entity @p[tag=azrPlayer,distance=2..11,tag=AzrSariel_Side_Death] facing entity @p[tag=azrPlayer,distance=2..] eyes run tp ^ ^ ^0.04
