...
execute if score @s[scores={rng3=1}] rng1 matches 58 rotated as @s rotated ~ 0 positioned ^ ^ ^2 run function skyblock:azr/assets/mobs/trap_fang
execute if score @s[scores={rng3=1}] rng1 matches 58 rotated as @s rotated ~30 0 positioned ^ ^ ^2 run function skyblock:azr/assets/mobs/trap_fang
execute if score @s[scores={rng3=1}] rng1 matches 58 rotated as @s rotated ~60 0 positioned ^ ^ ^2 run function skyblock:azr/assets/mobs/trap_fang
execute if score @s[scores={rng3=1}] rng1 matches 58 rotated as @s rotated ~90 0 positioned ^ ^ ^2 run function skyblock:azr/assets/mobs/trap_fang
execute if score @s[scores={rng3=1}] rng1 matches 58 rotated as @s rotated ~120 0 positioned ^ ^ ^2 run function skyblock:azr/assets/mobs/trap_fang
execute if score @s[scores={rng3=1}] rng1 matches 58 rotated as @s rotated ~-30 0 positioned ^ ^ ^2 run function skyblock:azr/assets/mobs/trap_fang
execute if score @s[scores={rng3=1}] rng1 matches 58 rotated as @s rotated ~-60 0 positioned ^ ^ ^2 run function skyblock:azr/assets/mobs/trap_fang
execute if score @s[scores={rng3=1}] rng1 matches 58 rotated as @s rotated ~-90 0 positioned ^ ^ ^2 run function skyblock:azr/assets/mobs/trap_fang
execute if score @s[scores={rng3=1}] rng1 matches 58 rotated as @s rotated ~-120 0 positioned ^ ^ ^2 run function skyblock:azr/assets/mobs/trap_fang
execute if score @s[scores={rng3=1}] rng1 matches 62 rotated as @s rotated ~ 0 positioned ^ ^ ^3.5 run function skyblock:azr/assets/mobs/trap_fang
execute if score @s[scores={rng3=1}] rng1 matches 62 rotated as @s rotated ~30 0 positioned ^ ^ ^3.5 run function skyblock:azr/assets/mobs/trap_fang
execute if score @s[scores={rng3=1}] rng1 matches 62 rotated as @s rotated ~60 0 positioned ^ ^ ^3.5 run function skyblock:azr/assets/mobs/trap_fang
execute if score @s[scores={rng3=1}] rng1 matches 62 rotated as @s rotated ~90 0 positioned ^ ^ ^3.5 run function skyblock:azr/assets/mobs/trap_fang
execute if score @s[scores={rng3=1}] rng1 matches 62 rotated as @s rotated ~120 0 positioned ^ ^ ^3.5 run function skyblock:azr/assets/mobs/trap_fang
execute if score @s[scores={rng3=1}] rng1 matches 62 rotated as @s rotated ~-30 0 positioned ^ ^ ^3.5 run function skyblock:azr/assets/mobs/trap_fang
execute if score @s[scores={rng3=1}] rng1 matches 62 rotated as @s rotated ~-60 0 positioned ^ ^ ^3.5 run function skyblock:azr/assets/mobs/trap_fang
execute if score @s[scores={rng3=1}] rng1 matches 62 rotated as @s rotated ~-90 0 positioned ^ ^ ^3.5 run function skyblock:azr/assets/mobs/trap_fang
execute if score @s[scores={rng3=1}] rng1 matches 62 rotated as @s rotated ~-120 0 positioned ^ ^ ^3.5 run function skyblock:azr/assets/mobs/trap_fang
