...
execute if score @s rng4 matches 13 if score @s rng5 matches 1..15 at @s rotated as @s run summon splash_potion ^ ^1.4 ^1.0 {Tags:["AzrielMob_npc_pig_henry_bottle","AzrielMob_mob_marker"],NoGravity:1b}
