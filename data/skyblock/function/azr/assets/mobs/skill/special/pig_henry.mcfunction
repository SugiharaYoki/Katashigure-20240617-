...
execute as @n[tag=AzrielMob_npc_pig_henry_bottle,type=small_fireball,distance=..15] at @s run function skyblock:azr/assets/mobs/skill/special/pig_henry_bottle
