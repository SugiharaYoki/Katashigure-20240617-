...
execute if score @s rng4 matches 1 rotated ~ 0 as @s at @s facing entity @n[tag=AzrielMob] eyes rotated ~ 0 run summon marker ^ ^0.32 ^1.1 {Tags:["AzrielMob_move_marker_henry_bottle"]}
