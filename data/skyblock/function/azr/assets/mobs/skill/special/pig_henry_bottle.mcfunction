...
execute if score @s rng4 matches 1 rotated ~ 0 as @s at @s facing entity @n[tag=AzrielMob] eyes positioned 0 0 0 run summon marker ^ ^0.32 ^0.3 {Tags:["AzrielMob_move_marker_henry_bottle"]}
