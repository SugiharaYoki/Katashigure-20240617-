...
execute if entity @a[tag=!AzrielMob_sonic_eye_reveal,tag=azrPlayer,distance=12..32,scores={AzrSariel_Side_Result=-4..}] facing entity @p[tag=azrPlayer,distance=2..] eyes run tp ^ ^ ^0.2
execute if entity @a[tag=!AzrielMob_sonic_eye_reveal,tag=azrPlayer,distance=8..32,scores={AzrSariel_Side_Result=-4..}] facing entity @p[tag=azrPlayer,distance=2..] eyes run tp ^ ^ ^0.15
execute if entity @a[tag=!AzrielMob_sonic_eye_reveal,tag=azrPlayer,distance=6..32,scores={AzrSariel_Side_Result=-4..}] facing entity @p[tag=azrPlayer,distance=2..] eyes run tp ^ ^ ^0.12
execute if entity @a[tag=!AzrielMob_sonic_eye_reveal,tag=azrPlayer,distance=12..24,scores={AzrSariel_Side_Result=..-5}] facing entity @p[tag=azrPlayer,distance=2..] eyes run tp ^ ^ ^0.2
execute if entity @a[tag=!AzrielMob_sonic_eye_reveal,tag=azrPlayer,distance=8..24,scores={AzrSariel_Side_Result=..-5}] facing entity @p[tag=azrPlayer,distance=2..] eyes run tp ^ ^ ^0.15
...
execute if entity @s[tag=!AzrielMob_sonic_eye_reveal] if entity @p[tag=azrPlayer,distance=..7] run playsound minecraft:entity.ender_dragon.hurt hostile @a ~ ~ ~ 5 0.7
execute if entity @s[tag=!AzrielMob_sonic_eye_reveal] if entity @p[tag=azrPlayer,distance=..7] run particle explosion ~ ~ ~ 0 0 0 0 1
execute if entity @s[tag=!AzrielMob_sonic_eye_reveal] if entity @p[tag=azrPlayer,distance=..7] run particle sculk_soul ~ ~ ~ 0.2 0.2 0.2 0.13 62
execute if entity @s[tag=!AzrielMob_sonic_eye_reveal] if entity @p[tag=azrPlayer,distance=..7] run particle shriek{delay:0} ~ ~-1 ~ 0 0 0 0 1
execute if entity @s[tag=!AzrielMob_sonic_eye_reveal] if entity @p[tag=azrPlayer,distance=..7] run tag @s add AzrielMob_sonic_eye_reveal
...
execute if entity @s[tag=AzrielMob_sonic_eye_reveal] run particle sculk_charge_pop ~ ~0.3 ~ 0.7 0.7 0.7 0.02 2
execute if entity @s[tag=AzrielMob_sonic_eye_reveal] run particle soul_fire_flame ~ ~0.3 ~ 0.85 0.85 0.85 0.00 4
