...
execute at @s[scores={AzrielMobLevel=1}] facing entity @n[tag=Azriel_Piranha_target] feet if block ^ ^ ^0.5 #skyblock:water at @s run tp @s ^ ^ ^0.10 facing entity @n[tag=Azriel_Piranha_target]
execute at @s[scores={AzrielMobLevel=2}] facing entity @n[tag=Azriel_Piranha_target] feet if block ^ ^ ^0.5 #skyblock:water at @s run tp @s ^ ^ ^0.08 facing entity @n[tag=Azriel_Piranha_target]
execute at @s[scores={AzrielMobLevel=3..}] facing entity @n[tag=Azriel_Piranha_target] feet if block ^ ^ ^0.5 #skyblock:water at @s run tp @s ^ ^ ^0.06 facing entity @n[tag=Azriel_Piranha_target]
