...
execute at @s[scores={AzrielMobLevel=3..}] facing entity @n[tag=Azriel_Piranha_target] feet positioned ^ ^ ^0.13 if block ~ ~ ~ #water run tp @s ~ ~ ~ facing entity @n[tag=Azriel_Piranha_target]
