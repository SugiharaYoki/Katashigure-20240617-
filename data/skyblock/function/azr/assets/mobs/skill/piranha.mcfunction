...
execute at @s[scores={AzrielMobLevel=1}] facing entity @n[tag=Azriel_Piranha_target] feet positioned ^ ^ ^0.5 if block ~ ~ ~ #skyblock:water run tp @s ^ ^ ^0.017 facing entity @n[tag=Azriel_Piranha_target]
execute at @s[scores={AzrielMobLevel=2}] facing entity @n[tag=Azriel_Piranha_target] feet positioned ^ ^ ^0.5 if block ~ ~ ~ #skyblock:water run tp @s ^ ^ ^0.04 facing entity @n[tag=Azriel_Piranha_target]
execute at @s[scores={AzrielMobLevel=3..}] facing entity @n[tag=Azriel_Piranha_target] feet positioned ^ ^ ^0.5 if block ~ ~ ~ #skyblock:water run tp @s ^ ^ ^0.01 facing entity @n[tag=Azriel_Piranha_target]
