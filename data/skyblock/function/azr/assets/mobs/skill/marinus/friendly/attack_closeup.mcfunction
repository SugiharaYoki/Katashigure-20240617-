...
execute if score @s rng1 matches 2 as @n[tag=AzrielMob,distance=..3.1] at @s rotated as @s anchored eyes run particle minecraft:dripping_dripstone_water ^0.15 ^0.02 ^0.2 0 0 0 0 1
execute if score @s rng1 matches 2 as @n[tag=AzrielMob,distance=..3.1] at @s rotated as @s anchored eyes run particle minecraft:dripping_dripstone_water ^-0.15 ^0.02 ^0.2 0 0 0 0 1
execute if score @s rng1 matches 2 as @n[tag=AzrielMob,distance=..3.1] at @s rotated as @s anchored eyes run particle minecraft:dripping_dripstone_water ^0.12 ^0.02 ^0.3 0 0 0 0 1
execute if score @s rng1 matches 2 as @n[tag=AzrielMob,distance=..3.1] at @s rotated as @s anchored eyes run particle minecraft:dripping_dripstone_water ^-0.12 ^0.02 ^0.3 0 0 0 0 1
execute if score @s rng1 matches 2 as @n[tag=AzrielMob,distance=..2.6] run playsound minecraft:block.note_block.harp player @s ~ ~ ~ 5 0.8
...
execute if score @s rng1 matches 5 run function skyblock:azr/assets/mobs/skill/marinus/attack_instant_slash
