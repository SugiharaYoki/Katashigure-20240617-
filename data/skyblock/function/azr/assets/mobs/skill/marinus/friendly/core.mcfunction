...
#马林努斯对话
execute if score stage Azr_system matches 30.. as @s at @s if entity @a[tag=azrPlayer,distance=..15] positioned -79867 49 -128 unless entity @n[tag=AzrielMarker_encounter,distance=0..0.5] run function skyblock:azr/assets/events/stage/chapter_3/area_prison/npc_conversation_marinus