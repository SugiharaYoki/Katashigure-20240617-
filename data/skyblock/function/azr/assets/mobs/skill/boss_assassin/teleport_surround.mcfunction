...
execute if score @s rng8 matches 2 run function skyblock:azr/assets/mobs/skill/boss_assassin/teleport_surround_pos
execute if score @s rng8 matches 6 store result score @s rng5 run random value 1..8
execute if score @s rng8 matches 6 run function skyblock:azr/assets/mobs/skill/boss_assassin/teleport_surround_pos
execute if score @s rng8 matches 9 store result score @s rng5 run random value 1..8
execute if score @s rng8 matches 9 run function skyblock:azr/assets/mobs/skill/boss_assassin/teleport_surround_pos
execute if score @s rng8 matches 12 store result score @s rng5 run random value 1..8
execute if score @s rng8 matches 12 run function skyblock:azr/assets/mobs/skill/boss_assassin/teleport_surround_pos
execute if score @s rng8 matches 15 store result score @s rng5 run random value 1..8
execute if score @s rng8 matches 15 run function skyblock:azr/assets/mobs/skill/boss_assassin/teleport_surround_pos
execute if score @s rng8 matches 18 store result score @s rng5 run random value 1..8
execute if score @s rng8 matches 18 run function skyblock:azr/assets/mobs/skill/boss_assassin/teleport_surround_pos
