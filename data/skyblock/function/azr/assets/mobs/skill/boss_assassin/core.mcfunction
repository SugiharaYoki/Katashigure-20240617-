...
execute if score @s AzrEntityTimer matches 61 positioned -79828 42 136 run bossbar set azr:boss_hp_bar_assassin players @a[tag=azrShowDialog]
...
execute if score @s AzrEntityTimer matches 2011 as @a[tag=azrPlayer,tag=!AZS_BoSB01] at @s run function skyblock:azr/assets/items/amulets/back_dodge
