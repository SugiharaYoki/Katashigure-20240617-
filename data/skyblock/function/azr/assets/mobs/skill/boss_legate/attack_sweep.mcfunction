...
execute if score @s rng8 matches 2 at @s rotated ~ 0 positioned ^03.9 ^0.2 ^0.0 run summon marker ~ ~ ~ {Tags:["AzrielMob_trap_axe","AzrielMob_mob_marker"]} 
execute if score @s rng8 matches 2 at @s rotated ~ 0 positioned ^02.6 ^0.2 ^0.3 run summon marker ~ ~ ~ {Tags:["AzrielMob_trap_axe","AzrielMob_mob_marker"]} 
execute if score @s rng8 matches 2 at @s rotated ~ 0 positioned ^01.3 ^0.2 ^0.6 run summon marker ~ ~ ~ {Tags:["AzrielMob_trap_axe","AzrielMob_mob_marker"]} 
execute if score @s rng8 matches 2 at @s rotated ~ 0 positioned ^00 ^0.2 ^0.9 run summon marker ~ ~ ~ {Tags:["AzrielMob_trap_axe","AzrielMob_mob_marker"]} 
execute if score @s rng8 matches 2 at @s rotated ~ 0 positioned ^-1.3 ^0.2 ^0.6 run summon marker ~ ~ ~ {Tags:["AzrielMob_trap_axe","AzrielMob_mob_marker"]} 
