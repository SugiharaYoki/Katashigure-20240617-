...
execute at @s[tag=AzrielMob_demon_amy_flame_eye_a] rotated as @s facing entity @n[tag=AzrielMob_demon_amy_flame_eye_destination_point_a,type=marker,distance=0.5..23] eyes run tp @s ^ ^ ^0.4 facing entity @n[tag=AzrielMob_demon_amy_flame_eye_destination_point_a,type=marker,distance=..23]
execute at @s[tag=AzrielMob_demon_amy_flame_eye_b] rotated as @s facing entity @n[tag=AzrielMob_demon_amy_flame_eye_destination_point_b,type=marker,distance=0.5..23] eyes run tp @s ^ ^ ^0.4 facing entity @n[tag=AzrielMob_demon_amy_flame_eye_destination_point_b,type=marker,distance=..23]
