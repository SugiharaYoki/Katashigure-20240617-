...
execute if entity @s[scores={AzrEntityTimer=..730}] store result score @s rng1 run random value 10..12
execute if entity @s[scores={AzrEntityTimer=..730}] run scoreboard players operation @s AzrEntityTimer += @s rng1

execute if entity @s[scores={AzrEntityTimer=730..900}] run tag @s add prepare_to_fire
execute if entity @s[scores={AzrEntityTimer=730..900}] run scoreboard players set @s AzrEntityTimer 1000
...
execute if score @s AzrEntityTimer matches 1001 rotated as @s run particle wax_off ^ ^ ^9 0 0 0 0 1
execute if score @s AzrEntityTimer matches 1001 rotated as @s run particle wax_off ^ ^ ^10 0 0 0 0 1
execute if score @s AzrEntityTimer matches 1001 rotated as @s run particle wax_off ^ ^ ^11 0 0 0 0 1
execute if score @s AzrEntityTimer matches 1001 rotated as @s run particle wax_off ^ ^ ^12 0 0 0 0 1
...
execute if score @s AzrEntityTimer matches 1023 rotated as @s run particle flame ^ ^ ^9.1 0 0 0 0 1
execute if score @s AzrEntityTimer matches 1023 rotated as @s run particle flame ^ ^ ^9.6 0 0 0 0 1
execute if score @s AzrEntityTimer matches 1023 rotated as @s run particle flame ^ ^ ^10.1 0 0 0 0 1
execute if score @s AzrEntityTimer matches 1023 rotated as @s run particle flame ^ ^ ^10.6 0 0 0 0 1
execute if score @s AzrEntityTimer matches 1023 rotated as @s run particle flame ^ ^ ^11.1 0 0 0 0 1
execute if score @s AzrEntityTimer matches 1023 rotated as @s run particle flame ^ ^ ^11.6 0 0 0 0 1
execute if score @s AzrEntityTimer matches 1023 rotated as @s run particle flame ^ ^ ^12.1 0 0 0 0 1
execute if score @s AzrEntityTimer matches 1023 rotated as @s run particle flame ^ ^ ^12.6 0 0 0 0 1
...
execute if score @s AzrEntityTimer matches 1023 rotated as @s run particle falling_lava ^ ^ ^9.0 0 0 0 0 1
execute if score @s AzrEntityTimer matches 1023 rotated as @s run particle falling_lava ^ ^ ^9.5 0 0 0 0 1
execute if score @s AzrEntityTimer matches 1023 rotated as @s run particle falling_lava ^ ^ ^10.0 0 0 0 0 1
execute if score @s AzrEntityTimer matches 1023 rotated as @s run particle falling_lava ^ ^ ^10.5 0 0 0 0 1
execute if score @s AzrEntityTimer matches 1023 rotated as @s run particle falling_lava ^ ^ ^11.0 0 0 0 0 1
execute if score @s AzrEntityTimer matches 1023 rotated as @s run particle falling_lava ^ ^ ^11.5 0 0 0 0 1
execute if score @s AzrEntityTimer matches 1023 rotated as @s run particle falling_lava ^ ^ ^12.0 0 0 0 0 1
execute if score @s AzrEntityTimer matches 1023 rotated as @s run particle falling_lava ^ ^ ^12.5 0 0 0 0 1
...
execute if score @s AzrEntityTimer matches 1023 rotated as @s positioned ^ ^ ^9.0 positioned ~ ~-0.8 ~ as @a[distance=..1.5,tag=azrPlayer] at @s run damage @s 8.5 in_fire
execute if score @s AzrEntityTimer matches 1023 rotated as @s positioned ^ ^ ^9.5 positioned ~ ~-0.8 ~ as @a[distance=..1.5,tag=azrPlayer] at @s run damage @s 8.5 in_fire
execute if score @s AzrEntityTimer matches 1023 rotated as @s positioned ^ ^ ^10.0 positioned ~ ~-0.8 ~ as @a[distance=..1.5,tag=azrPlayer] at @s run damage @s 8.5 in_fire
execute if score @s AzrEntityTimer matches 1023 rotated as @s positioned ^ ^ ^10.5 positioned ~ ~-0.8 ~ as @a[distance=..1.5,tag=azrPlayer] at @s run damage @s 8.5 in_fire
execute if score @s AzrEntityTimer matches 1023 rotated as @s positioned ^ ^ ^11.0 positioned ~ ~-0.8 ~ as @a[distance=..1.5,tag=azrPlayer] at @s run damage @s 8.5 in_fire
execute if score @s AzrEntityTimer matches 1023 rotated as @s positioned ^ ^ ^11.5 positioned ~ ~-0.8 ~ as @a[distance=..1.5,tag=azrPlayer] at @s run damage @s 8.5 in_fire
execute if score @s AzrEntityTimer matches 1023 rotated as @s positioned ^ ^ ^12.0 positioned ~ ~-0.8 ~ as @a[distance=..1.5,tag=azrPlayer] at @s run damage @s 8.5 in_fire
execute if score @s AzrEntityTimer matches 1023 rotated as @s positioned ^ ^ ^12.5 positioned ~ ~-0.8 ~ as @a[distance=..1.5,tag=azrPlayer] at @s run damage @s 8.5 in_fire
...
execute unless entity @s[tag=prepare_to_fire] at @n[type=piglin_brute,tag=AzrielMob_demon_amy,distance=..20] rotated ~ 0 positioned ^3.8 ^2.5 ^-0.8 run summon marker ~ ~ ~ {Tags:["AzrielMob_demon_amy_flame_eye_destination_point_c"]}
execute unless entity @s[tag=prepare_to_fire] at @n[type=piglin_brute,tag=AzrielMob_demon_amy,distance=..20] rotated ~ 0 positioned ^-3.8 ^2.5 ^-0.8 run summon marker ~ ~ ~ {Tags:["AzrielMob_demon_amy_flame_eye_destination_point_d"]}


execute unless entity @s[tag=prepare_to_fire] at @s[tag=AzrielMob_demon_amy_flame_eye_c] rotated as @s facing entity @n[tag=AzrielMob_demon_amy_flame_eye_destination_point_c,type=marker,distance=0.9..23] eyes run tp @s ^ ^ ^0.2 facing entity @n[tag=AzrielMob_demon_amy_flame_eye_destination_point_c,type=marker,distance=..23]
execute unless entity @s[tag=prepare_to_fire] at @s[tag=AzrielMob_demon_amy_flame_eye_d] rotated as @s facing entity @n[tag=AzrielMob_demon_amy_flame_eye_destination_point_d,type=marker,distance=0.9..23] eyes run tp @s ^ ^ ^0.2 facing entity @n[tag=AzrielMob_demon_amy_flame_eye_destination_point_d,type=marker,distance=..23]
execute unless entity @s[tag=prepare_to_fire] at @s[tag=AzrielMob_demon_amy_flame_eye_c] rotated as @s facing entity @n[tag=AzrielMob_demon_amy_flame_eye_destination_point_c,type=marker,distance=5..23] eyes run tp @s ^ ^ ^0.2 facing entity @n[tag=AzrielMob_demon_amy_flame_eye_destination_point_c,type=marker,distance=..23]
execute unless entity @s[tag=prepare_to_fire] at @s[tag=AzrielMob_demon_amy_flame_eye_d] rotated as @s facing entity @n[tag=AzrielMob_demon_amy_flame_eye_destination_point_d,type=marker,distance=5..23] eyes run tp @s ^ ^ ^0.2 facing entity @n[tag=AzrielMob_demon_amy_flame_eye_destination_point_d,type=marker,distance=..23]


execute unless entity @s[tag=prepare_to_fire] at @s rotated as @s run tp @s ~ ~ ~ facing entity @p[tag=azrPlayer]


kill @n[tag=AzrielMob_demon_amy_flame_eye_destination_point_c,type=marker,distance=..23]
kill @n[tag=AzrielMob_demon_amy_flame_eye_destination_point_d,type=marker,distance=..23]