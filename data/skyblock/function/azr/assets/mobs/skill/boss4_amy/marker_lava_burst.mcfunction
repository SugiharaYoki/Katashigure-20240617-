...
execute if score @s rng1 matches 35.. run particle large_smoke ~ ~3 ~ 0.3 2 0.3 0.03 1
execute if score @s rng1 matches 35.. run particle flame ~ ~3 ~ 0.3 2 0.3 0.03 1
execute if score @s rng1 matches 50.. run particle trial_spawner_detection ~ ~3 ~ 0.3 3 0.3 0.0 1
