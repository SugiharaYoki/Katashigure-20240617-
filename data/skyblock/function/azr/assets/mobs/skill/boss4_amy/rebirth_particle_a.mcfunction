...
execute if score @s rng1 matches 1.. at @s rotated ~ 0 positioned ^ ^1 ^2 run particle flame ~ ~ ~ 0 0 0 0 1
execute if score @s rng1 matches 1.. at @s rotated ~ 0 positioned ^ ^ ^-5 run particle flame ~ ~ ~ 0 0 0 0 1
execute if score @s rng1 matches 1.. at @s rotated ~ 0 positioned ^ ^1 ^2 run particle small_flame ~ ~ ~ 0 0 0 0.12 1
