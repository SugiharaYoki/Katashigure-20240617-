...
execute if score @s rng1 matches 1..20 at @s run tp @s ~ ~0.02 ~
execute if score @s rng1 matches 1..10 at @s run tp @s ~ ~0.02 ~
execute if score @s rng1 matches 1..5 at @s run tp @s ~ ~0.02 ~
