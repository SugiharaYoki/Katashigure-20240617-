...
execute if score @s[scores={rng13=1..3}] rng14 matches 12 as @n[tag=AzrielNPC_andralune] run function skyblock:azr/assets/mobs/skill/marinus/move_fastshift
execute if score @s[scores={rng13=1..3}] rng14 matches 22 as @n[tag=AzrielNPC_andralune] run function skyblock:azr/assets/mobs/skill/marinus/move_fastshift
execute if score @s[scores={rng13=1..3}] rng14 matches 33 as @n[tag=AzrielNPC_andralune] run function skyblock:azr/assets/mobs/skill/marinus/move_fastshift
execute if score @s[scores={rng13=1..3}] rng14 matches 40 as @n[tag=AzrielNPC_andralune] run function skyblock:azr/assets/mobs/skill/marinus/move_fastshift
execute if score @s[scores={rng13=1..3}] rng14 matches 52 as @n[tag=AzrielNPC_andralune] run function skyblock:azr/assets/mobs/skill/marinus/move_fastshift
