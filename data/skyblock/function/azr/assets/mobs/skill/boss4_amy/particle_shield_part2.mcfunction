...
execute if score @s rng18 matches 120..139 as @a[distance=9.7..10.4,tag=azrPlayer] run damage @s 4 minecraft:flame
execute if score @s rng18 matches 120..139 as @n[distance=9.7..10.4,tag=AzrielNPC_andralune] run damage @s 8 minecraft:flame
