...
execute if score @s rng3 matches 27 run effect give @s instant_damage 2 0 false
execute if score @s rng3 matches 37 run effect give @s instant_damage 2 0 false
execute if score @s rng3 matches 47 run effect give @s instant_damage 2 0 false
...
execute if score @s rng3 matches 57 run particle minecraft:wax_on ~ ~1 ~ 0.1 0.5 0.1 3 50
...
execute if score @s rng3 matches 2..57 run particle minecraft:wax_on ~ ~1 ~ 0.2 0.5 0.2 0.03 1
execute if score @s rng3 matches 58 run scoreboard players set @s rng1 1
