...
execute if score @s rng1 matches ..5 unless block ~ ~ ~ air run kill @s
...
execute if score @s rng1 matches 9 run setblock ~ ~ ~ pointed_dripstone[thickness=tip,vertical_direction=down]
