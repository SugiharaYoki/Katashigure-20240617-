...
execute as @p[tag=azrPlayer,distance=..0.8,gamemode=adventure] at @s unless items entity @s armor.feet *[custom_data={iron_boots_lightstep:1b}] run damage @s 3 generic
...
execute as @p[tag=azrPlayer,distance=..0.4,gamemode=adventure] at @s if score AzrielC_danger rng1 matches ..4 run damage @s 4 generic
execute as @p[tag=azrPlayer,distance=..0.4,gamemode=adventure] at @s if score AzrielC_danger rng1 matches 5..8 run damage @s 6 generic
execute as @p[tag=azrPlayer,distance=..0.4,gamemode=adventure] at @s if score AzrielC_danger rng1 matches 9.. run damage @s 8 generic
...
execute as @n[tag=AzrielNPC_Divineforce,distance=..0.8] at @s run damage @s 4 generic
