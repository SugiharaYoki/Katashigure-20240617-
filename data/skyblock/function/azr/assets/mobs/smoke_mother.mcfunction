...
execute if score AzrielC_danger rng1 matches 1..5 run summon silverfish ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeMONSTER","AzrielMob_smoke_mother","AzrielMob_level_1"],DeathLootTable:"skyblock:azr_new/silverfish_tier1",attributes:[{id:"attack_damage",base:2.0},{id:"max_health",base:32.0},{id:"armor",base:0.0},{base:0.16d,id:"movement_speed"},{base:1.6d,id:"scale"}],Health:32.0f,CustomName:'母虫'}
execute if score AzrielC_danger rng1 matches 6..14 run summon silverfish ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeMONSTER","AzrielMob_smoke_mother","AzrielMob_level_2"],DeathLootTable:"skyblock:azr_new/silverfish_tier1",attributes:[{id:"attack_damage",base:2.0},{id:"max_health",base:36.0},{id:"armor",base:1.0},{base:0.16d,id:"movement_speed"},{base:1.6d,id:"scale"}],Health:36.0f,CustomName:'母虫'}
execute if score AzrielC_danger rng1 matches 15..19 run summon silverfish ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeMONSTER","AzrielMob_smoke_mother","AzrielMob_level_3"],DeathLootTable:"skyblock:azr_new/silverfish_tier1",attributes:[{id:"attack_damage",base:3.0},{id:"max_health",base:40.0},{id:"armor",base:2.0},{base:0.16d,id:"movement_speed"},{base:1.6d,id:"scale"}],Health:40.0f,CustomName:'母虫'}
execute if score AzrielC_danger rng1 matches 20..26 run summon silverfish ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeMONSTER","AzrielMob_smoke_mother","AzrielMob_level_4"],DeathLootTable:"skyblock:azr_new/silverfish_tier1",attributes:[{id:"attack_damage",base:3.0},{id:"max_health",base:46.0},{id:"armor",base:3.0},{base:0.17d,id:"movement_speed"},{base:1.6d,id:"scale"}],Health:46.0f,CustomName:'母虫'}
execute if score AzrielC_danger rng1 matches 27.. run summon silverfish ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeMONSTER","AzrielMob_smoke_mother","AzrielMob_level_5"],DeathLootTable:"skyblock:azr_new/silverfish_tier1",attributes:[{id:"attack_damage",base:4.0},{id:"max_health",base:56.0},{id:"armor",base:4.0},{base:0.17d,id:"movement_speed"},{base:1.6d,id:"scale"}],Health:56.0f,CustomName:'母虫'}
