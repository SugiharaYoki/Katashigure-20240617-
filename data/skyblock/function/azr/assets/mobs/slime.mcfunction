...
execute if score AzrielC_danger rng1 matches 1..5 run summon slime ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeLIFE","AzrielMob_slime","AzrielMob_level_1","AzrielMob_contactdmg_immune"],DeathLootTable:"skyblock:azr_new/slime_tier1",attributes:[{id:"max_health",base:8.0},{id:"armor",base:0.0},{base:0.24d,id:"movement_speed"},{id:"knockback_resistance",base:1.0}],Health:8.0f,CustomName:'沼泽球体'}
execute if score AzrielC_danger rng1 matches 6..7 run summon slime ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeLIFE","AzrielMob_slime","AzrielMob_level_2","AzrielMob_contactdmg_immune"],DeathLootTable:"skyblock:azr_new/slime_tier1",attributes:[{id:"max_health",base:12.0},{id:"armor",base:1.0},{base:0.25d,id:"movement_speed"},{id:"knockback_resistance",base:1.0}],Health:12.0f,CustomName:'沼泽球体'}
...
execute if score AzrielC_danger rng1 matches 10..12 run summon slime ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeLIFE","AzrielMob_slime","AzrielMob_level_4","AzrielMob_contactdmg_immune"],DeathLootTable:"skyblock:azr_new/slime_tier1",attributes:[{id:"max_health",base:20.0},{id:"armor",base:3.0},{base:0.29d,id:"movement_speed"},{id:"knockback_resistance",base:1.0}],Health:20.0f,CustomName:'沼泽球体'}
execute if score AzrielC_danger rng1 matches 13.. run summon slime ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeLIFE","AzrielMob_slime","AzrielMob_level_5","AzrielMob_contactdmg_immune"],DeathLootTable:"skyblock:azr_new/slime_tier1",attributes:[{id:"max_health",base:24.0},{id:"armor",base:4.0},{base:0.32d,id:"movement_speed"},{id:"knockback_resistance",base:1.0}],Health:24.0f,CustomName:'沼泽球体'}
