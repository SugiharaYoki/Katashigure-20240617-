...
execute if score AzrielC_danger rng1 matches 1..14 run summon piglin ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeMONSTER","AzrielMob_piglin_crossbow","AzrielMob_piglin_general","AzrielMob_level_3"],DeathLootTable:"skyblock:azr_new/piglin_tier1",attributes:[{id:"attack_damage",base:0.0},{id:"max_health",base:20.0},{id:"armor",base:1.0},{base:0.28d,id:"movement_speed"}],Health:20.0f,CustomName:'魔界弩手',equipment:{mainhand:{count:1,id:"crossbow"}},drop_chances:{mainhand:0.0f,offhand:0.0f,feet:0.0f,legs:0.0f,chest:0.0f,head:0.0f},IsImmuneToZombification:1b}
execute if score AzrielC_danger rng1 matches 15..26 run summon piglin ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeMONSTER","AzrielMob_piglin_crossbow","AzrielMob_piglin_general","AzrielMob_level_4"],DeathLootTable:"skyblock:azr_new/piglin_tier1",attributes:[{id:"attack_damage",base:0.5},{id:"max_health",base:22.0},{id:"armor",base:2.0},{base:0.30d,id:"movement_speed"}],Health:22.0f,CustomName:'魔界弩手',equipment:{mainhand:{count:1,id:"crossbow"}},drop_chances:{mainhand:0.0f,offhand:0.0f,feet:0.0f,legs:0.0f,chest:0.0f,head:0.0f},IsImmuneToZombification:1b}
execute if score AzrielC_danger rng1 matches 27.. run summon piglin ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeMONSTER","AzrielMob_piglin_crossbow","AzrielMob_piglin_general","AzrielMob_level_5"],DeathLootTable:"skyblock:azr_new/piglin_tier1",attributes:[{id:"attack_damage",base:1.0},{id:"max_health",base:24.0},{id:"armor",base:3.0},{base:0.31d,id:"movement_speed"}],Health:24.0f,CustomName:'魔界弩手',equipment:{mainhand:{count:1,id:"crossbow"}},drop_chances:{mainhand:0.0f,offhand:0.0f,feet:0.0f,legs:0.0f,chest:0.0f,head:0.0f},IsImmuneToZombification:1b}
