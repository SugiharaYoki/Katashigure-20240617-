...
execute if score AzrielC_danger rng2 matches 1..40 if score AzrielC_danger rng1 matches 1.. run summon salmon ~ ~ ~ {Tags:["AzrielMob","AzrielMob_typeLIFE","AzrielMob_piranha","AzrielMob_level_1","AzrielMob_contactdmg_immune"],attributes:[{id:"armor",base:6.0},{id:"max_health",base:8}],Health:8,PersistenceRequired:1b,type:"small"}
...
execute if score AzrielC_danger rng2 matches 49..50 if score AzrielC_danger rng1 matches 1.. run summon salmon ~ ~ ~ {Tags:["AzrielMob","AzrielMob_typeLIFE","AzrielMob_piranha","AzrielMob_level_3","AzrielMob_contactdmg_immune"],attributes:[{id:"armor",base:10.0},{id:"max_health",base:38}],Health:38,PersistenceRequired:1b,type:"large"}
particle bubble ~ ~0.4 ~ 0.25 0.4 0.25 0 10
