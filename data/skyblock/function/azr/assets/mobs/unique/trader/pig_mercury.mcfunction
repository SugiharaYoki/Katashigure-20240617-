...
execute as @n[type=piglin,tag=AzrielTrader_pig_mercury] run item replace entity @s armor.chest with golden_chestplate[enchantments={fire_protection:4},trim={pattern:rib,material:emerald}]
