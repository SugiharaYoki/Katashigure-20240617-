...
execute if score AzrielC_danger rng1 matches 1..12 run summon piglin ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeMONSTER","AzrielMob_piglin_sword","AzrielMob_piglin_general","AzrielMob_level_3"],DeathLootTable:"skyblock:azr_new/piglin_tier1",attributes:[{id:"attack_damage",base:3.5},{id:"max_health",base:24.0},{id:"armor",base:2.0},{base:0.25d,id:"movement_speed"}],Health:24.0f,CustomName:'魔界剑士',equipment:{mainhand:{count:1,id:"golden_sword"}},drop_chances:{mainhand:0.0f,offhand:0.0f,feet:0.0f,legs:0.0f,chest:0.0f,head:0.0f},IsImmuneToZombification:1b}
execute if score AzrielC_danger rng1 matches 13..22 run summon piglin ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeMONSTER","AzrielMob_piglin_sword","AzrielMob_piglin_general","AzrielMob_level_4"],DeathLootTable:"skyblock:azr_new/piglin_tier1",attributes:[{id:"attack_damage",base:4.0},{id:"max_health",base:28.0},{id:"armor",base:2.5},{base:0.25d,id:"movement_speed"}],Health:28.0f,CustomName:'魔界剑士',equipment:{mainhand:{count:1,id:"golden_sword"}},drop_chances:{mainhand:0.0f,offhand:0.0f,feet:0.0f,legs:0.0f,chest:0.0f,head:0.0f},IsImmuneToZombification:1b}
execute if score AzrielC_danger rng1 matches 23.. run summon piglin ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeMONSTER","AzrielMob_piglin_sword","AzrielMob_piglin_general","AzrielMob_level_5"],DeathLootTable:"skyblock:azr_new/piglin_tier1",attributes:[{id:"attack_damage",base:4.5},{id:"max_health",base:32.0},{id:"armor",base:3.0},{base:0.26d,id:"movement_speed"}],Health:32.0f,CustomName:'魔界剑士',equipment:{mainhand:{count:1,id:"golden_sword"}},drop_chances:{mainhand:0.0f,offhand:0.0f,feet:0.0f,legs:0.0f,chest:0.0f,head:0.0f},IsImmuneToZombification:1b}
