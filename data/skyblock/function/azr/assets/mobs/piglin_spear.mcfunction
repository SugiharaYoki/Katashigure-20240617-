...
execute as @n[type=piglin_brute,tag=AzrielMob,tag=!AzrielMob_level_ed,tag=AzrielMob_level_3] at @s store result score @s rng1 run random value 1..18
execute as @n[type=piglin_brute,tag=AzrielMob,tag=!AzrielMob_level_ed,tag=AzrielMob_level_4] at @s store result score @s rng1 run random value 3..18
execute as @n[type=piglin_brute,tag=AzrielMob,tag=!AzrielMob_level_ed,tag=AzrielMob_level_5] at @s store result score @s rng1 run random value 5..18
...
execute as @n[type=piglin_brute,tag=AzrielMob,tag=!AzrielMob_level_ed,scores={rng1=11}] run item replace entity @s armor.head with netherite_helmet[enchantments={protection:2}]

execute as @n[type=piglin_brute,tag=AzrielMob,tag=!AzrielMob_level_ed,tag=AzrielMob_level_3] at @s store result score @s rng1 run random value 1..11
execute as @n[type=piglin_brute,tag=AzrielMob,tag=!AzrielMob_level_ed,tag=AzrielMob_level_4] at @s store result score @s rng1 run random value 3..11
execute as @n[type=piglin_brute,tag=AzrielMob,tag=!AzrielMob_level_ed,tag=AzrielMob_level_5] at @s store result score @s rng1 run random value 5..11
...
execute as @n[type=piglin_brute,tag=AzrielMob,tag=!AzrielMob_level_ed,scores={rng1=11}] run item replace entity @s armor.chest with netherite_chestplate[enchantments={protection:2}]

execute as @n[type=piglin_brute,tag=AzrielMob,tag=!AzrielMob_level_ed,tag=AzrielMob_level_3] at @s store result score @s rng1 run random value 1..13
execute as @n[type=piglin_brute,tag=AzrielMob,tag=!AzrielMob_level_ed,tag=AzrielMob_level_4] at @s store result score @s rng1 run random value 3..13
execute as @n[type=piglin_brute,tag=AzrielMob,tag=!AzrielMob_level_ed,tag=AzrielMob_level_5] at @s store result score @s rng1 run random value 5..13
...
execute as @n[type=piglin_brute,tag=AzrielMob,tag=!AzrielMob_level_ed,scores={rng1=11}] run item replace entity @s armor.legs with netherite_leggings[enchantments={protection:2}]

execute as @n[type=piglin_brute,tag=AzrielMob,tag=!AzrielMob_level_ed,tag=AzrielMob_level_3] at @s store result score @s rng1 run random value 1..15
execute as @n[type=piglin_brute,tag=AzrielMob,tag=!AzrielMob_level_ed,tag=AzrielMob_level_4] at @s store result score @s rng1 run random value 3..15
execute as @n[type=piglin_brute,tag=AzrielMob,tag=!AzrielMob_level_ed,tag=AzrielMob_level_5] at @s store result score @s rng1 run random value 5..15
...
execute as @n[type=piglin_brute,tag=AzrielMob,tag=!AzrielMob_level_ed,scores={rng1=11}] run item replace entity @s armor.feet with netherite_boots[enchantments={protection:2}]
