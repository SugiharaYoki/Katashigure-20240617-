...
execute if score AzrielC_danger rng1 matches 1..8 run summon piglin_brute ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeMONSTER","AzrielMob_piglin_spear","AzrielMob_piglin_brute_general","AzrielMob_level_3"],DeathLootTable:"skyblock:azr_new/piglin_brute_tier1",attributes:[{id:"attack_damage",base:5.5},{id:"max_health",base:40.0},{id:"armor",base:2.0},{base:0.22d,id:"movement_speed"}],Health:40.0f,CustomName:'魔界骑士',equipment:{mainhand:{count:1,id:"golden_spear"}},drop_chances:{mainhand:0.0f,offhand:0.0f,feet:0.0f,legs:0.0f,chest:0.0f,head:0.0f},IsImmuneToZombification:1b}
execute if score AzrielC_danger rng1 matches 9..12 run summon piglin_brute ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeMONSTER","AzrielMob_piglin_spear","AzrielMob_piglin_brute_general","AzrielMob_level_4"],DeathLootTable:"skyblock:azr_new/piglin_brute_tier1",attributes:[{id:"attack_damage",base:6.0},{id:"max_health",base:44.0},{id:"armor",base:2.5},{base:0.23d,id:"movement_speed"}],Health:44.0f,CustomName:'魔界骑士',equipment:{mainhand:{count:1,id:"golden_spear"}},drop_chances:{mainhand:0.0f,offhand:0.0f,feet:0.0f,legs:0.0f,chest:0.0f,head:0.0f},IsImmuneToZombification:1b}
execute if score AzrielC_danger rng1 matches 13.. run summon piglin_brute ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeMONSTER","AzrielMob_piglin_spear","AzrielMob_piglin_brute_general","AzrielMob_level_5"],DeathLootTable:"skyblock:azr_new/piglin_brute_tier1",attributes:[{id:"attack_damage",base:6.5},{id:"max_health",base:48.0},{id:"armor",base:3.0},{base:0.24d,id:"movement_speed"}],Health:48.0f,CustomName:'魔界骑士',equipment:{mainhand:{count:1,id:"golden_spear"}},drop_chances:{mainhand:0.0f,offhand:0.0f,feet:0.0f,legs:0.0f,chest:0.0f,head:0.0f},IsImmuneToZombification:1b}
