...
execute if score random_enemy_type AzrTimerStack matches 1..4 run summon marker ~ ~ ~ {Tags:["AzrielMob_summon_delay_marker_slime","AzrielMob_summon_delay","AzrielMob_level_1"]}
