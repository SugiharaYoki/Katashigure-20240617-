...
execute if score @s rng1 matches 1.. positioned ~ ~0.5 ~ run particle soul ~ ~1 ~ 0.3 0.5 0.3 0.05 1
execute if score @s rng1 matches 39 positioned ~ ~ ~ run function skyblock:azr/assets/mobs/zombie_villager_cleric
