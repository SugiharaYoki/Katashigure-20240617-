...
execute if score AzrielC_danger rng1 matches 1..3 run summon zombie_villager ~ ~ ~ {PersistenceRequired:1b,Tags:["AzrielMob","AzrielMob_typeDEATH","AzrielMob_zombie_villager_armor","AzrielMob_level_1"],DeathLootTable:"skyblock:azr_new/zombie_tier1",attributes:[{id:"attack_damage",base:1.0},{id:"max_health",base:18.0},{id:"armor",base:0.0},{base:0.17d,id:"movement_speed"}],Health:18.0f,CustomName:'"亡灵盔甲匠"',VillagerData:{profession:armorer,type:savanna},equipment:{mainhand:{id:"iron_shovel"},offhand:{},feet:{},legs:{},chest:{},head:{}},drop_chances:{mainhand:0.0f,offhand:0.0f,feet:0.0f,legs:0.0f,chest:0.0f,head:0.0f}}
