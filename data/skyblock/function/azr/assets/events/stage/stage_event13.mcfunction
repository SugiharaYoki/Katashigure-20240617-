...
execute if score stage_main_thread AzrTimerStack matches 9 run item replace block -79741 39 -363 container.12 with beetroot[custom_name='{text:"爆裂菜根",italic:0b}',lore=['{text:"投掷 - 轰炸（射程较低）",color:"yellow"}'],enchantments={punch:1},custom_data={blast_root:1b},custom_model_data={floats:[100001.0]}] 3
...
execute if score stage_main_thread AzrTimerStack matches 9 run summon piglin_brute -79744 38 -370 {IsImmuneToZombification:1b,PersistenceRequired:1b,Tags:["AzrielDecMob","AzrielMob"],DeathLootTable:"skyblock:azriel_piglin_tier2",Health:23.0f,CustomName:'"猪灵斧武士"',CanPickUpLoot:0b,HandItems:[{count:1,id:"golden_axe",components:{custom_name:'{text:"金斧",italic:0b,color:"white"}'}},{}],HandDropChances:[0.001f,0.001f],ArmorItems:[{},{},{count:1,id:"golden_chestplate",components:{custom_name:'{text:"金胸甲",italic:0b,color:"white"}'}},{}],ArmorDropChances:[0.01f,0.01f,0.01f,0.01f],attributes:[{id:"max_health",base:23.0d},{id:"attack_damage",base:5.5d},{id:"movement_speed",base:0.28d},{id:"armor_toughness",base:3.0d}]}
execute if score stage_main_thread AzrTimerStack matches 9 run summon piglin_brute -79744 38 -370 {IsImmuneToZombification:1b,PersistenceRequired:1b,Tags:["AzrielDecMob","AzrielMob"],DeathLootTable:"skyblock:azriel_piglin_tier2",Health:23.0f,CustomName:'"猪灵斧武士"',CanPickUpLoot:0b,HandItems:[{count:1,id:"golden_axe",components:{custom_name:'{text:"金斧",italic:0b,color:"white"}'}},{}],HandDropChances:[0.001f,0.001f],ArmorItems:[{},{},{count:1,id:"golden_chestplate",components:{custom_name:'{text:"金胸甲",italic:0b,color:"white"}'}},{}],ArmorDropChances:[0.01f,0.01f,0.01f,0.01f],attributes:[{id:"max_health",base:23.0d},{id:"attack_damage",base:5.5d},{id:"movement_speed",base:0.28d},{id:"armor_toughness",base:3.0d}]}
...
execute if score stage_main_thread AzrTimerStack matches 11..9999 as @a[tag=azrPlayer,tag=!AzrielEvent3761S] at @s as @e[tag=AzrielEvent3761,distance=0..3.5] at @s run playsound entity.piglin.ambient master @a[tag=azrShowDialog,distance=0..3.5] ~ ~ ~ 2 0.9
...
execute if score stage_main_thread AzrTimerStack matches 10000.. as @a[tag=azrPlayer,tag=!AzrielEvent3761S] at @s as @e[tag=AzrielEvent3761,distance=0..3.5] at @s run playsound entity.piglin.ambient master @a[tag=azrShowDialog,distance=0..3.5] ~ ~ ~ 2 0.9
...
execute if score stage_main_thread AzrTimerStack matches 11.. as @a[tag=azrPlayer,tag=!AzrielEvent3762S] at @s as @e[tag=AzrielEvent3762,distance=0..3.5] at @s run playsound entity.piglin.admiring_item master @a[tag=azrShowDialog,distance=0..3.5] ~ ~ ~ 2 0.9
...
execute if score stage_main_thread AzrTimerStack matches 11.. as @a[tag=azrPlayer,tag=!AzrielEvent3763S] at @s as @e[tag=AzrielEvent3763,distance=0..3.5] at @s run playsound entity.piglin.ambient master @a[tag=azrShowDialog,distance=0..3.5] ~ ~ ~ 2 0.9
...
execute if score stage_main_thread AzrTimerStack matches 11..9999 as @a[tag=azrPlayer,tag=!AzrielEvent3764S] at @s as @e[tag=AzrielEvent3764,distance=0..3.5] at @s run playsound entity.piglin.jealous master @a[tag=azrShowDialog,distance=0..3.5] ~ ~ ~ 2 0.9
...
execute if score stage_main_thread AzrTimerStack matches 10000.. as @a[tag=azrPlayer,tag=!AzrielEvent3764S] at @s as @e[tag=AzrielEvent3764,distance=0..3.5] at @s run playsound entity.piglin.jealous master @a[tag=azrShowDialog,distance=0..3.5] ~ ~ ~ 2 0.9
...
execute if score stage_main_thread AzrTimerStack matches 11.. as @a[tag=azrPlayer,tag=!AzrielEvent3765S] at @s as @e[tag=AzrielEvent3765,distance=0..3.5] at @s run playsound entity.piglin.ambient master @a[tag=azrShowDialog,distance=0..3.5] ~ ~ ~ 2 0.9
...
execute if score stage_main_thread AzrTimerStack matches 501 run tellraw @a[tag=azrShowDialog] {text:"神界军模样的人：",color:"aqua"}
execute if score stage_main_thread AzrTimerStack matches 501 if score playerCount Azr_system matches 1 run tellraw @a[tag=azrShowDialog] [{text:"“终于找着你了。我是权之残影大人派来协助你的。”",color:"white"}]
...
#跳过剧情
execute if score stage_main_thread AzrTimerStack matches 508 unless entity @a[tag=azrPlayer,scores={Azr_skillPoints=..16}] run tellraw @a[tag=azrPlayer] {text:"〈跳过剧情〉",bold:1b,color:"blue",click_event:{"action":"run_command","command":"trigger Azr_Shop set 6"}}
...
execute if score stage_main_thread AzrTimerStack matches 10000..30000 run function skyblock:azr/system/utils/rng
...
execute if score stage_main_thread AzrTimerStack matches 10600 run tellraw @a[tag=azrShowDialog] {text:"远处士兵的喊叫：",color:"aqua"}
execute if score stage_main_thread AzrTimerStack matches 10600 run tellraw @a[tag=azrShowDialog] {text:"“我们明明是同胞，为什么要将我的军队赶尽杀绝？！”",color:"white"}

execute if score stage_main_thread AzrTimerStack matches 11200 run tellraw @a[tag=azrShowDialog] {text:"远处士兵的喊叫：",color:"aqua"}
execute if score stage_main_thread AzrTimerStack matches 11200 run tellraw @a[tag=azrShowDialog] {text:"“可恶啊啊！！该死的路西法！就算这地狱已经无法管控你的无法无天，你也绝无法在神庭获胜！！”",color:"white"}


execute if score stage_main_thread AzrTimerStack matches 11235 run tellraw @a[tag=azrShowDialog] {text:"临终的呐喊：",color:"aqua"}
execute if score stage_main_thread AzrTimerStack matches 11235 run tellraw @a[tag=azrShowDialog] {text:"“等待你的覆灭之刻吧！魔鬼！！”",color:"white"}
...
# execute if score stage_main_thread AzrTimerStack matches 10000..20000 unless score $Event18573A Azr_system matches 1 if entity @a[tag=azrPlayer,x=-79781,y=39,z=-516,distance=0..10] run schedule function skyblock:azr/assets/events/effects/event13_1 3.5s
...
execute if score stage_main_thread AzrTimerStack matches 19900.. unless score $Event18575A Azr_system matches 1 if block -79609 18 -417 air if block -79647 23 -422 air run summon blaze -79609 15 -417 {PersistenceRequired:1b,Tags:["AzrielMob","AzrielDecMob"],DeathLootTable:"skyblock:azriel_blaze_tier1_ht",CustomName:'"坍缩焰型体"',Health:15.0f,attributes:[{id:"max_health",base:15.0d},{id:"attack_damage",base:9.0d},{id:"movement_speed",base:0.24d}]}
execute if score stage_main_thread AzrTimerStack matches 19900.. unless score $Event18575A Azr_system matches 1 if block -79609 18 -417 air if block -79647 23 -422 air run summon blaze -79609 15 -417 {PersistenceRequired:1b,Tags:["AzrielMob","AzrielDecMob"],DeathLootTable:"skyblock:azriel_blaze_tier1_ht",CustomName:'"坍缩焰型体"',Health:15.0f,attributes:[{id:"max_health",base:15.0d},{id:"attack_damage",base:9.0d},{id:"movement_speed",base:0.24d}]}
execute if score stage_main_thread AzrTimerStack matches 19900.. unless score $Event18575A Azr_system matches 1 if block -79609 18 -417 air if block -79647 23 -422 air run summon blaze -79609 15 -417 {PersistenceRequired:1b,Tags:["AzrielMob","AzrielDecMob"],DeathLootTable:"skyblock:azriel_blaze_tier1_ht",CustomName:'"坍缩焰型体"',Health:15.0f,attributes:[{id:"max_health",base:15.0d},{id:"attack_damage",base:9.0d},{id:"movement_speed",base:0.24d}]}
