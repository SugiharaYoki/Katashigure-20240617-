...
#rng2：技能选择器
    ...
    execute if score @s[tag=actionable,scores={rng2=12..13},tag=!boss2_afterstory] rng8 matches 1.. run function skyblock:azr/assets/mobs/skill/boss1_andralune/skill_stockpile
