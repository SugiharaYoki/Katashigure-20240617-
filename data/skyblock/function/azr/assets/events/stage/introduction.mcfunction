...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC9,distance=..100,type=piglin,scores={rng1=64}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"矿工：","color":"yellow"},{"text":"\n“……之前的铁锭到底被我放哪了？”","color":"white"}]
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC8,distance=..100,type=piglin,scores={rng1=65..66}] at @s if entity @p[tag=azrPlayer,distance=..4.2] run scoreboard players set @s rng1 55
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC8,distance=..100,type=piglin,scores={rng1=65..66}] at @s if entity @p[tag=azrPlayer,distance=..4.2] if entity @n[type=item,nbt={Item:{id:"minecraft:iron_ingot",count:1}},distance=..5] run scoreboard players set @s rng1 67
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC8,distance=..100,type=piglin,scores={rng1=67}] at @s if entity @p[tag=azrPlayer,distance=..4.2] if entity @n[type=item,nbt={Item:{id:"minecraft:iron_ingot",count:1}},distance=..5] run playsound entity.piglin.celebrate neutral @a ~ ~ ~ 1 1
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC8,distance=..100,type=piglin,scores={rng1=67}] at @s if entity @p[tag=azrPlayer,distance=..4.2] if entity @n[type=item,nbt={Item:{id:"minecraft:iron_ingot",count:1}},distance=..5] run kill @n[type=item,nbt={Item:{id:"minecraft:iron_ingot",count:1}}]
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC8,distance=..100,type=piglin,scores={rng1=67}] at @s if entity @p[tag=azrPlayer,distance=..4.2] run tellraw @a[tag=azrShowDialog] [{"text":"矿工：","color":"yellow"},{"text":"\n“你怎么知道我需要铁锭？这可太不好意思了。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC9,distance=..100,type=piglin,scores={rng1=84}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"矿工：","color":"yellow"},{"text":"\n“作为回报，给你些绿宝石吧。就是刚刚我提到的那玩意。会派上用场的。”","color":"white"}]
