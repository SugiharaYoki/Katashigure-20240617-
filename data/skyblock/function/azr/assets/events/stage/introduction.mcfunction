...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC4,distance=..100,type=piglin_brute,scores={rng1=28}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run playsound entity.piglin.ambient neutral @a ~ ~ ~ 1 1
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC4,distance=..100,type=piglin_brute,scores={rng1=28}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"守卫：","color":"yellow"},{"text":"\n“呵呵……这算是神魔两界暗地里的交易吗？”","color":"white"}]
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC4,distance=..100,type=piglin_brute,scores={rng1=68}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run playsound entity.piglin.ambient neutral @a ~ ~ ~ 1 1
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC4,distance=..100,type=piglin_brute,scores={rng1=68}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"守卫：","color":"yellow"},{"text":"\n“你还在这里做什么？继续前进吧。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC5,distance=..100,type=piglin_brute,scores={rng1=59}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tp @s -79372 26 -372
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC5,distance=..100,type=piglin_brute,scores={rng1=62..63}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run playsound block.iron_door.open block @a -79371 27 -373 1 0.7
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC5,distance=..100,type=piglin_brute,scores={rng1=62}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run fill -79372 26 -373 -79370 26 -373 air
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC5,distance=..100,type=piglin_brute,scores={rng1=63}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run fill -79372 27 -373 -79370 27 -373 air
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC7,distance=..100,type=piglin] at @s if entity @p[tag=azrPlayer,distance=..3.8] run scoreboard players add @s rng1 1
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC7,distance=..100,type=piglin,scores={rng1=2}] at @s if entity @p[tag=azrPlayer,distance=..3.8] run playsound entity.piglin.ambient neutral @a ~ ~ ~ 1 1
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC7,distance=..100,type=piglin,scores={rng1=2}] at @s if entity @p[tag=azrPlayer,distance=..3.8] run tellraw @a[tag=azrShowDialog] [{"text":"魔界居民：","color":"yellow"},{"text":"\n“恭候多时了，亚米大人已经交代过武器的事情。这把木剑和这把木斧都交给你。”","color":"white"}]
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC7,distance=..100,type=piglin,scores={rng1=2}] at @s if entity @p[tag=azrPlayer,distance=..3.8] run item replace entity @s weapon.mainhand with air
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC7,distance=..100,type=piglin,scores={rng1=2}] at @s if entity @p[tag=azrPlayer,distance=..3.8] run item replace entity @s weapon.offhand with air
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC7,distance=..100,type=piglin,scores={rng1=2}] at @s if entity @p[tag=azrPlayer,distance=..3.8] run give @a[tag=azrPlayer] wooden_sword 1
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC7,distance=..100,type=piglin,scores={rng1=2}] at @s if entity @p[tag=azrPlayer,distance=..3.8] run give @a[tag=azrPlayer] wooden_axe 1
