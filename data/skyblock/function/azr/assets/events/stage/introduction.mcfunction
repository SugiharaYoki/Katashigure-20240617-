...
execute if score Azr_Story_Introduction rng1 matches 1025 positioned -79974 38 -13 as @a[tag=azrPlayer,tag=AZR_SEAawakened] at @s run function skyblock:azr/assets/items/others/revival_star
