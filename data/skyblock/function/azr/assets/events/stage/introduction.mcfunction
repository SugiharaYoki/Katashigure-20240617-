...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC8,distance=..100,type=piglin,scores={rng1=55..56}] at @s if entity @p[tag=azrPlayer,distance=..4.2] if entity @n[type=item,nbt={Item:{id:"minecraft:iron_ingot",count:1}},distance=..5] run scoreboard players set @s rng1 57
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC8,distance=..100,type=piglin,scores={rng1=57}] at @s if entity @p[tag=azrPlayer,distance=..4.2] if entity @n[type=item,nbt={Item:{id:"minecraft:iron_ingot",count:1}},distance=..5] run playsound entity.piglin.celebrate neutral @a ~ ~ ~ 1 1
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC8,distance=..100,type=piglin,scores={rng1=57}] at @s if entity @p[tag=azrPlayer,distance=..4.2] if entity @n[type=item,nbt={Item:{id:"minecraft:iron_ingot",count:1}},distance=..5] run kill @n[type=item,nbt={Item:{id:"minecraft:iron_ingot",count:1}}]
