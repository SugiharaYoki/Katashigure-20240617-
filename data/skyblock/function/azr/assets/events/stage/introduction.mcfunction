...
execute if score Azr_Story_Introduction rng1 matches 290 at @p[tag=azrPlayer] run tellraw @a[tag=azrShowDialog] [{"text":"温柔的声音：","color":"dark_purple","bold": true},{"bold": false,"text":"\n“承受不公命运的人类啊，你必将再度睁开双眼。”","color":"white"}]
execute if score Azr_Story_Introduction rng1 matches 310 at @p[tag=azrPlayer] run tellraw @a[tag=azrShowDialog] [{"text":"温柔的声音：","color":"dark_purple","bold": true},{"bold": false,"text":"\n“我已犯下重罪，而你将会成为我的审判者。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC1,distance=..100,type=piglin,scores={rng1=2}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"看守猪圈的魔界居民：","color":"yellow","bold": true},{"bold": false,"text":"\n“怎么，你也想和我一起研究怎么减少疣猪的肥肉占比？”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC1,distance=..100,type=piglin,scores={rng1=18}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"看守猪圈的魔界居民：","color":"yellow","bold": true},{"bold": false,"text":"\n“如果想要疣猪肉，拿些金粒来买。可别想着能白嫖。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC3,distance=..100,type=piglin,scores={rng1=2}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"仓管：","color":"yellow","bold": true},{"bold": false,"text":"\n“走远点。但如果你只是想要些战斗指导，我倒是能提供。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC3,distance=..100,type=piglin,scores={rng1=18}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"仓管：","color":"yellow","bold": true},{"bold": false,"text":"\n“一般他们会给你发一把剑和一把斧头。\n剑可以进行范围攻击，而且冷却更短。\n斧只能进行单体攻击，但充能完毕后威力巨大。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC3,distance=..100,type=piglin,scores={rng1=42}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"仓管：","color":"yellow","bold": true},{"bold": false,"text":"\n“趁早搞清楚哪一类更适合自己。当然，你应该也能在之后发现与剑斧不同的武器。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC2,distance=..100,type=piglin,scores={rng1=2}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"魔界居民：","color":"yellow","bold": true},{"bold": false,"text":"\n“彼列王就是个废物，虽然他依然是我们的王。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC2,distance=..100,type=piglin,scores={rng1=18}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"魔界居民：","color":"yellow","bold": true},{"bold": false,"text":"\n“最近反抗军已经打到城门口了，我随时准备倒戈。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC2,distance=..100,type=piglin,scores={rng1=49}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"魔界居民：","color":"yellow","bold": true},{"bold": false,"text":"\n“但你在这里干什么？人类的亡魂，内战不是你该参与的事情。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC4,distance=..100,type=piglin_brute,scores={rng1=2}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"守卫：","color":"yellow","bold": true},{"bold": false,"text":"\n“人类的亡魂，前面便是通往神庭的传送门。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC4,distance=..100,type=piglin_brute,scores={rng1=22}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"守卫：","color":"yellow","bold": true},{"bold": false,"text":"\n“前往神庭，那里有个专门面向你这种对自己的死亡抱有不满之人的挑战。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC4,distance=..100,type=piglin_brute,scores={rng1=42}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"守卫：","color":"yellow","bold": true},{"bold": false,"text":"\n“杀了那些可恶的天使守备军，听说坐守神庭生命树的天使长，叫沙利叶的，会赏赐你额外的阳寿。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC4,distance=..100,type=piglin_brute,scores={rng1=78}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"守卫：","color":"yellow","bold": true},{"bold": false,"text":"\n“呵呵……这算是神魔两界暗地里的交易吗？”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC4,distance=..100,type=piglin_brute,scores={rng1=108}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"守卫：","color":"yellow","bold": true},{"bold": false,"text":"\n“你还在这里做什么？继续前进吧。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC5,distance=..100,type=piglin_brute,scores={rng1=2}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"守卫：","color":"yellow","bold": true},{"bold": false,"text":"\n“哈……欠。亚米将军提到的人类亡魂就是你吧？”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC5,distance=..100,type=piglin_brute,scores={rng1=18}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"守卫：","color":"yellow","bold": true},{"bold": false,"text":"\n“不用看我。最近死后被传送到这里来的人类就你一个。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC5,distance=..100,type=piglin_brute,scores={rng1=36}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"守卫：","color":"yellow","bold": true},{"bold": false,"text":"\n“是的，是的。你已经死了。没救了。这些都不是关键。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC5,distance=..100,type=piglin_brute,scores={rng1=56}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"守卫：","color":"yellow","bold": true},{"bold": false,"text":"\n“我会为你开门，走到尽头——嗯，应该会有其他人指引你的。不是我的职责。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC5,distance=..100,type=piglin_brute,scores={rng1=86}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"守卫：","color":"yellow","bold": true},{"bold": false,"text":"\n“还不走……麻烦死了。从这条路走到底，有个传送门，进去就到神庭了。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC5,distance=..100,type=piglin_brute,scores={rng1=108}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"守卫：","color":"yellow","bold": true},{"bold": false,"text":"\n“神庭是什么？神界有一个试炼，你打通了他们会赐予你额外的凡间寿命。就是这样。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC5,distance=..100,type=piglin_brute,scores={rng1=148}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"守卫：","color":"yellow","bold": true},{"bold": false,"text":"\n“还不走吗？我困得要死，没法跟你解释更多了。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC5,distance=..100,type=piglin_brute,scores={rng1=188}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"守卫：","color":"yellow","bold": true},{"bold": false,"text":"\n“随你便。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC6,distance=..100,type=piglin,scores={rng1=2}] at @s if entity @p[tag=azrPlayer,distance=..3.8] run tellraw @a[tag=azrShowDialog] [{"text":"猪灵居委会成员：","color":"yellow","bold": true},{"bold": false,"text":"\n“社区粮食分发。今天有剩的，给你点，伙计。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC7,distance=..100,type=piglin,scores={rng1=2}] at @s if entity @p[tag=azrPlayer,distance=..4.2] run tellraw @a[tag=azrShowDialog] [{"text":"魔界居民：","color":"yellow","bold": true},{"bold": false,"text":"\n“恭候多时了，亚米大人已经交代过武器的事情。这把木剑和这把木斧都交给你。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC8,distance=..100,type=piglin,scores={rng1=2}] at @s if entity @p[tag=azrPlayer,distance=..4.2] run tellraw @a[tag=azrShowDialog] [{"text":"魔界居民：","color":"yellow","bold": true},{"bold": false,"text":"\n“起得太晚了……没领到南瓜派。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC8,distance=..100,type=piglin,scores={rng1=18}] at @s if entity @p[tag=azrPlayer,distance=..4.2] run tellraw @a[tag=azrShowDialog] [{"text":"魔界居民：","color":"yellow","bold": true},{"bold": false,"text":"\n“你能把南瓜派分我三块吗？作为交换，我可以给你些煤炭。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC8,distance=..100,type=piglin,scores={rng1=21}] at @s if entity @p[tag=azrPlayer,distance=..4.2] run tellraw @a[tag=azrShowDialog] [{"text":"魔界居民：","color":"yellow","bold": true},{"bold": false,"text":"\n“实在是太感谢了！这些煤炭您务必收好，希望能帮上忙！”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC8,distance=..100,type=piglin,scores={rng1=42}] at @s if entity @p[tag=azrPlayer,distance=..4.2] run tellraw @a[tag=azrShowDialog] [{"text":"魔界居民：","color":"yellow","bold": true},{"bold": false,"text":"\n“终于吃上午饭了……对了对了，人类的亡魂。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC8,distance=..100,type=piglin,scores={rng1=58}] at @s if entity @p[tag=azrPlayer,distance=..4.2] run tellraw @a[tag=azrShowDialog] [{"text":"魔界居民：","color":"yellow","bold": true},{"bold": false,"text":"\n“你上神庭之后遇到的第一个敌人恐怕会是驭灵使。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC8,distance=..100,type=piglin,scores={rng1=74}] at @s if entity @p[tag=azrPlayer,distance=..4.2] run tellraw @a[tag=azrShowDialog] [{"text":"魔界居民：","color":"yellow","bold": true},{"bold": false,"text":"\n“他们和你打照面后会先召唤3只行尸，但这会需要一点时间，所以在那之前快速夺走驭灵使的行动能力才是上策。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC8,distance=..100,type=piglin,scores={rng1=84}] at @s if entity @p[tag=azrPlayer,distance=..4.2] run tellraw @a[tag=azrShowDialog] [{"text":"魔界居民：","color":"yellow","bold": true},{"bold": false,"text":"\n“行尸本身很脆弱，你应该可以做到一刀解决一个。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC8,distance=..100,type=piglin,scores={rng1=100}] at @s if entity @p[tag=azrPlayer,distance=..4.2] run tellraw @a[tag=azrShowDialog] [{"text":"魔界居民：","color":"yellow","bold": true},{"bold": false,"text":"\n“祝你好运！！”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC9,distance=..100,type=piglin,scores={rng1=2}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"矿工：","color":"yellow","bold": true},{"bold": false,"text":"\n“这里是我们的金矿。首先我劝你不要动这些金子的主意，其次你要了它们也没用。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC9,distance=..100,type=piglin,scores={rng1=18}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"矿工：","color":"yellow","bold": true},{"bold": false,"text":"\n“如果是要去跑神庭试炼，你接下来会需要一种蕴含魔力的绿宝石。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC9,distance=..100,type=piglin,scores={rng1=34}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"矿工：","color":"yellow","bold": true},{"bold": false,"text":"\n“一般来说，你会拿到一本手册，直通我们的武器库。用那些绿宝石就可以调用手册。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC9,distance=..100,type=piglin,scores={rng1=64}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"矿工：","color":"yellow","bold": true},{"bold": false,"text":"\n“……话说回来还真奇怪，之前的铁锭到底被我放哪了？”","color":"white"}]
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC9,distance=..100,type=piglin,scores={rng1=65..66}] at @s if entity @p[tag=azrPlayer,distance=..4.2] run scoreboard players set @s rng1 65
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC9,distance=..100,type=piglin,scores={rng1=67}] at @s if entity @p[tag=azrPlayer,distance=..4.2] run tellraw @a[tag=azrShowDialog] [{"text":"矿工：","color":"yellow","bold": true},{"bold": false,"text":"\n“你怎么知道我需要铁锭？这可太不好意思了。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC9,distance=..100,type=piglin,scores={rng1=84}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"矿工：","color":"yellow","bold": true},{"bold": false,"text":"\n“作为回报，给你些绿宝石吧。就是刚刚我提到的那玩意。会派上用场的。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC10,distance=..100,type=piglin_brute,scores={rng1=2}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"守卫：","color":"yellow","bold": true},{"bold": false,"text":"\n“准备好了就踏入传送门。任何神界军你都能痛揍一顿，他们没那么容易死。”","color":"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC10,distance=..100,type=piglin_brute,scores={rng1=16}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{"text":"守卫：","color":"yellow","bold": true},{"bold": false,"text":"\n“看你这么紧张，给你一些物资。你会从那群神界军身上获得更多的。”","color":"white"}]
...
execute if score Azr_Story_Introduction rng1 matches 1025 positioned -79977 8 61 if entity @s[tag=!AZR_SEAawakened] run summon minecraft:glow_item_frame ~ ~ ~ {Invisible:1b,Fixed:0b,Invulnerable:0b,Facing:1b,Item:{id:"minecraft:nether_star",components:{custom_name:'{"text":"下界命星","color":"yellow","italic":false}',custom_data:{revival_star:true},custom_model_data:{floats:[100001.0]}}}}
