...
execute if score tick_main_thread AzrTimerStack matches 2753 if score #rng3 Azr_system matches 1 run tellraw @a[tag=!En,tag=azrPlayer] {"text":"“留意汝正上方！路西法要施放狱火弹了！”","color":"white"}
execute if score tick_main_thread AzrTimerStack matches 2753 if score #rng3 Azr_system matches 2 run tellraw @a[tag=!En,tag=azrPlayer] {"text":"“又是狱火弹！小心头顶方向！”","color":"white"}
execute if score tick_main_thread AzrTimerStack matches 2753 if score #rng3 Azr_system matches 3 run tellraw @a[tag=!En,tag=azrPlayer] {"text":"“头顶有狱火弹！注意躲避！”","color":"white"}
