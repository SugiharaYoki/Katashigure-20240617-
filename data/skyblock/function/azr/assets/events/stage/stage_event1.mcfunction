...
execute if score stage_main_thread AzrTimerStack matches 303..306 positioned -79929 38 75 run function skyblock:azr/assets/mobs/zombie_t2_shield_iron
execute if score stage_main_thread AzrTimerStack matches 303..306 positioned -79933 38 75 run function skyblock:azr/assets/mobs/zombie_t2_shield_iron
