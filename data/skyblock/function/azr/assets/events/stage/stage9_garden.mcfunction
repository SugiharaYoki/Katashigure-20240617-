...
execute positioned -79893 47 -53 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=70}] if entity @n[tag=AzrielNPC_stage9_entry_conversation6] if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run tellraw @a[tag=azrShowDialog] [{"text":"巡逻小队队长 伊安：","color":"green","bold": true},{"bold": false,"text":"\n“冷静，我们如果失败了，生命树就会受到威胁！无论如何都不能死在这里！”","color":"white"}]
...
execute positioned -79893 47 -53 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=116}] if entity @n[tag=AzrielNPC_stage9_entry_conversation6] if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run tellraw @a[tag=azrShowDialog] [{"text":"巡逻小队队长 伊安：","color":"green","bold": true},{"bold": false,"text":"\n“谢谢你，人类的亡魂。你救下了我的队员。为什么要帮助我们？”","color":"white"}]
execute positioned -79893 47 -53 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=116}] unless entity @n[tag=AzrielNPC_stage9_entry_conversation6] if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run tellraw @a[tag=azrShowDialog] [{"text":"巡逻小队队长 伊安：","color":"green","bold": true},{"bold": false,"text":"\n“谢谢你，人类的亡魂。为什么要帮助我们？”","color":"white"}]
...
execute positioned -79893 47 -53 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=148}] if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run tellraw @a[tag=azrShowDialog] [{"text":"巡逻小队队长 伊安：","color":"green","bold": true},{"bold": false,"text":"\n“那东西只是一个分身。接下来你还会见到一堆这样的怪物。”","color":"white"}]
...
execute positioned -79893 47 -53 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=163}] if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run tellraw @a[tag=azrShowDialog] [{"text":"巡逻小队队长 伊安：","color":"green","bold": true},{"bold": false,"text":"\n“如果它的本体出现了……记得找到其他的神界军，让他们和你一起战斗。”","color":"white"}]
