...
execute positioned -79931 38 -30 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=35}] positioned -79931 38 -37 run tellraw @a[tag=azrShowDialog] [{"text":"你：","color":"aqua","bold": true},{"bold": false,"text":"\n“我问一下，这个采光礼堂还有什么我值得探索的地方吗？”","color":"white"}]
...
execute positioned -79890 38 4 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=52}] as @n[tag=AzrielNPC_stage9_entry_conversation3,type=pillager] at @s run tellraw @a[tag=azrShowDialog] [{"text":"第2巡逻小队队长 温斯顿：","color":"green","bold": true},{"bold": false,"text":"\n“这里的许多地方依然会涌出怪物。但不用担心，你几乎可以在任何时候回到这儿来。”","color":"white"}]
...
execute positioned -79893 47 -53 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=116}] if entity @n[tag=AzrielNPC_stage9_entry_conversation6] if entity @n[tag=AzrielNPC_stage9_entry_conversation7] if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run tellraw @a[tag=azrShowDialog] [{"text":"第5巡逻小队队长 伊安：","color":"green","bold": true},{"bold": false,"text":"\n“谢谢你，人类的亡魂，你救下了我重要的队员。为什么要帮助我们？”","color":"white"}]
execute positioned -79893 47 -53 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=116}] unless entity @n[tag=AzrielNPC_stage9_entry_conversation6] if entity @n[tag=AzrielNPC_stage9_entry_conversation7] if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run tellraw @a[tag=azrShowDialog] [{"text":"第5巡逻小队队长 伊安：","color":"green","bold": true},{"bold": false,"text":"\n“谢谢你，人类的亡魂。为什么要帮助我们？”","color":"white"}]
execute positioned -79893 47 -53 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=116}] if entity @n[tag=AzrielNPC_stage9_entry_conversation6] unless entity @n[tag=AzrielNPC_stage9_entry_conversation7] if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run tellraw @a[tag=azrShowDialog] [{"text":"第5巡逻小队队长 伊安：","color":"green","bold": true},{"bold": false,"text":"\n“谢谢你，人类的亡魂。为什么要帮助我们？”","color":"white"}]
execute positioned -79893 47 -53 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=116}] unless entity @n[tag=AzrielNPC_stage9_entry_conversation6] unless entity @n[tag=AzrielNPC_stage9_entry_conversation7] if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run tellraw @a[tag=azrShowDialog] [{"text":"第5巡逻小队队长 伊安：","color":"green","bold": true},{"bold": false,"text":"\n“谢谢你……人类的亡魂。为什么会打算帮我们？”","color":"white"}]
execute positioned -79893 47 -53 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=132}] positioned -79931 38 -37 if entity @n[tag=AzrielNPC_stage9_entry_conversation5] if entity @n[tag=AzrielNPC_stage9_entry_conversation6] run tellraw @a[tag=azrShowDialog] [{"text":"你：","color":"aqua","bold": true},{"bold": false,"text":"\n“顺手罢了。你们要是全死了，我还得单挑那个眼睛怪。”","color":"white"}]
execute positioned -79893 47 -53 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=132}] positioned -79931 38 -37 if entity @n[tag=AzrielNPC_stage9_entry_conversation5] unless entity @n[tag=AzrielNPC_stage9_entry_conversation6] run tellraw @a[tag=azrShowDialog] [{"text":"你：","color":"aqua","bold": true},{"bold": false,"text":"\n“顺手罢了。你要是死了，我还得单挑那个眼睛怪。”","color":"white"}]
...
execute positioned -79893 47 -53 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=183}] if entity @n[tag=AzrielNPC_stage9_entry_conversation6] run tellraw @a[tag=azrShowDialog,distance=..20] [{"text":"弩手 麦克：","color":"green","bold": true},{"bold": false,"text":"\n“我们该寻找大部队了……唉。”","color":"white"}]
execute positioned -79893 47 -53 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=203}] if entity @n[tag=AzrielNPC_stage9_entry_conversation6] at @n[tag=AzrielNPC_stage9_entry_conversation7] run playsound minecraft:entity.vindicator.ambient hostile @a[tag=azrShowDialog] ~ ~ ~ 1 0.9
execute positioned -79893 47 -53 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=203}] if entity @n[tag=AzrielNPC_stage9_entry_conversation6] if entity @n[tag=AzrielNPC_stage9_entry_conversation7] run tellraw @a[tag=azrShowDialog,distance=..20] [{"text":"剑士 派恩：","color":"green","bold": true},{"bold": false,"text":"\n“多亏那个人类出手相助，否则我们损失可要很惨重。他叫什么名字？”","color":"white"}]
execute positioned -79893 47 -53 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=220}] if entity @n[tag=AzrielNPC_stage9_entry_conversation7] at @n[tag=AzrielNPC_stage9_entry_conversation6] run playsound minecraft:entity.pillager.ambient hostile @a[tag=azrShowDialog] ~ ~ ~ 1 0.9
execute positioned -79893 47 -53 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=220}] if entity @n[tag=AzrielNPC_stage9_entry_conversation7] if entity @n[tag=AzrielNPC_stage9_entry_conversation6] run tellraw @a[tag=azrShowDialog,distance=..20] [{"text":"弩手 麦克：","color":"green","bold": true},{"bold": false,"text":"\n“好像是叫……爱理莎？这么说来，倒过来读很像是沙利叶大人的名字。”","color":"white"}]
