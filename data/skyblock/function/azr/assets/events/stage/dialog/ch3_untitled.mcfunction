...
execute if score internal_clock_003 Azr_system matches 4 positioned -79866 48 -117 run function skyblock:azr/assets/mobs/silverfish_t2_brick
...
execute if score internal_clock_003 Azr_system matches 8 positioned -79866 48 -117 run function skyblock:azr/assets/mobs/silverfish_t2_brick
...
execute if score internal_clock_003 Azr_system matches 12 positioned -79866 48 -117 run function skyblock:azr/assets/mobs/silverfish_t2_brick
...
execute if score internal_clock_003 Azr_system matches 16 positioned -79866 48 -117 run function skyblock:azr/assets/mobs/silverfish_t2_brick
execute if score internal_clock_003 Azr_system matches 16 run scoreboard players reset internal_clock_003
execute if score internal_clock_003 Azr_system matches -2147483648..2147483647 run schedule function skyblock:azr/assets/events/stage/dialog/ch3_untitled 1t