...
execute if score internal_clock_002 Azr_system matches 1 positioned -79923 38 -60 run function skyblock:azr/assets/mobs/pillager_t1_friendly
execute if score internal_clock_002 Azr_system matches 1 positioned -79923 38 -60 run function skyblock:azr/assets/mobs/pillager_t1_friendly
execute if score internal_clock_002 Azr_system matches 1 positioned -79923 38 -60 run function skyblock:azr/assets/mobs/pillager_t1_friendly
...
execute if score internal_clock_002 Azr_system matches -2147483648..2147483647 run schedule function skyblock:azr/assets/events/stage/dialog/first_pass_west 1t