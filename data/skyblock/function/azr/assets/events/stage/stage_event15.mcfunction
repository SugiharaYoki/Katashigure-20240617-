...
execute if entity @a[x=-79756.5,y=29.0,z=-464.5,distance=0..3,tag=azrPlayer,tag=!Trader4ATalkA] run function skyblock:azr/system/utils/rng
...
execute as @a[x=-79756.5,y=29.0,z=-464.5,distance=0..3,tag=azrPlayer,tag=!Trader4ATalkA] run function skyblock:azr/system/shop/reader_nethershop_2
