...
execute if score internal_clock_001 Azr_system matches 176 run tellraw @a[tag=azrShowDialog] [{text:"墙对面的谈话声B：",color:"yellow",bold:1b},{bold: false,text:"\n“已经有人汇报给默尔森大人了。但……这可是权之殊能大人操控的魔物，怎么会暴走？”",color:"white"}]
...
execute if score internal_clock_001 Azr_system matches 272 run tellraw @a[tag=azrShowDialog] [{text:"墙对面的谈话声A：",color:"yellow",bold:1b},{bold: false,text:"\n“我觉得还是别多问比较好。几位大人因为生命树的事情忙得不可开交，一切都会有其深意吧。”",color:"white"}]
