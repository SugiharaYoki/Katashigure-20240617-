...
execute if score @s AzrielNPC_ConversationTimer matches 3201.. unless entity @a[distance=0..5.5,tag=azrPlayer] run scoreboard players set @s AzrielNPC_ConversationTimer 49