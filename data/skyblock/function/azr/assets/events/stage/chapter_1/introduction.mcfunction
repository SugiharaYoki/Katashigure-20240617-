...
execute if score Azr_Story_Introduction rng1 matches 290 positioned -79381 22 -385 run summon piglin ~ ~ ~ {CustomName:'魔界居民',PersistenceRequired:1b,Tags:["AzrielMob_StoryIntroduction_NPC1"],Invulnerable:1b,IsImmuneToZombification:1b,attributes:[{id:"movement_speed",base:0.0}],equipment:{}}
execute if score Azr_Story_Introduction rng1 matches 290 positioned -79387 24 -404 run summon piglin ~ ~ ~ {CustomName:'魔界居民',PersistenceRequired:1b,Tags:["AzrielMob_StoryIntroduction_NPC2"],Invulnerable:1b,IsImmuneToZombification:1b,attributes:[{id:"movement_speed",base:0.15}],equipment:{}}
...
execute if score Azr_Story_Introduction rng1 matches 290 positioned -79417 27 -390 run summon piglin ~ ~ ~ {CustomName:'魔界居民',PersistenceRequired:1b,Tags:["AzrielMob_StoryIntroduction_NPC8"],Invulnerable:1b,IsImmuneToZombification:1b,attributes:[{id:"movement_speed",base:0.0}],equipment:{}}
...
execute if score Azr_Story_Introduction rng1 matches 290 positioned -79377 24 -399 run summon piglin ~ ~ ~ {CustomName:'魔界居民',PersistenceRequired:1b,Tags:["AzrielMob_StoryIntroduction_NPC_unused"],Invulnerable:1b,IsImmuneToZombification:1b,attributes:[{id:"movement_speed",base:0.15}],equipment:{}}
...
execute if score Azr_Story_Introduction rng1 matches 290 positioned -79452 24 -393 run summon strider ~ ~ ~ {CustomName:'炽足兽',PersistenceRequired:1b,Tags:["AzrielMob_StoryIntroduction_NPC_unused"],Invulnerable:1b,attributes:[{id:"movement_speed",base:0.15}]}
execute if score Azr_Story_Introduction rng1 matches 290 positioned -79438 30 -405 run summon piglin ~ ~ ~ {CustomName:'魔界居民',PersistenceRequired:1b,Tags:["AzrielMob_StoryIntroduction_NPC_unused"],Invulnerable:1b,IsImmuneToZombification:1b,attributes:[{id:"movement_speed",base:0.15}],equipment:{}}
