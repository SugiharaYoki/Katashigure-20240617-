...
execute if score Azr_Story_Introduction rng1 matches 700 as @p[tag=azrPlayer] at @s run summon marker -79723.02 ~ -1220.00 {Tags:["azrPlayer_opening_rise_particle_1_marker","AzrielMob_mob_marker"]} 
