...
execute if score Azr_Story_Introduction rng1 matches 290 positioned -79381 22 -385 run summon piglin ~ ~ ~ {CustomName:'魔界居民',PersistenceRequired:1b,Tags:["AzrielMob_StoryIntroduction_NPC1"],Invulnerable:1b,IsImmuneToZombification:1b,attributes:[{id:"movement_speed",base:0.0}],equipment:{offhand:{}}}
execute if score Azr_Story_Introduction rng1 matches 290 positioned -79387 24 -404 run summon piglin ~ ~ ~ {CustomName:'魔界居民',PersistenceRequired:1b,Tags:["AzrielMob_StoryIntroduction_NPC2"],Invulnerable:1b,IsImmuneToZombification:1b,attributes:[{id:"movement_speed",base:0.15}],equipment:{offhand:{}}}
execute if score Azr_Story_Introduction rng1 matches 290 positioned -79394 26 -386 run summon piglin ~ ~ ~ {CustomName:'仓管',PersistenceRequired:1b,Tags:["AzrielMob_StoryIntroduction_NPC3"],Invulnerable:1b,IsImmuneToZombification:1b,attributes:[{id:"movement_speed",base:0.0},{id:"attack_damage",base:0.0}],equipment:{mainhand:{count:1,id:"golden_sword"},offhand:{count:1,id:"shield"},chest:{count:1,id:"golden_chestplate"}},drop_chances:{feet:0.0f,legs:0.0f,chest:0.0f,head:0.0f}}
execute if score Azr_Story_Introduction rng1 matches 290 positioned -79407 30 -398 run summon piglin_brute ~ ~ ~ {CustomName:'守卫',PersistenceRequired:1b,Tags:["AzrielMob_StoryIntroduction_NPC4"],Invulnerable:1b,IsImmuneToZombification:1b,attributes:[{id:"movement_speed",base:0.0},{id:"attack_damage",base:0.0}],equipment:{mainhand:{count:1,id:"golden_axe"}}}
...
execute if score Azr_Story_Introduction rng1 matches 290 positioned -79371 26 -385 run summon piglin ~ ~ ~ {CustomName:'魔界居民',PersistenceRequired:1b,Tags:["AzrielMob_StoryIntroduction_NPC6"],Invulnerable:1b,IsImmuneToZombification:1b,attributes:[{id:"movement_speed",base:0.0}],equipment:{mainhand:{count:1,id:"pumpkin_pie"}}}
execute if score Azr_Story_Introduction rng1 matches 290 positioned -79441 30 -407 run summon piglin ~ ~ ~ {CustomName:'魔界居民',PersistenceRequired:1b,Tags:["AzrielMob_StoryIntroduction_NPC7"],Invulnerable:1b,IsImmuneToZombification:1b,attributes:[{id:"movement_speed",base:0.0}],equipment:{mainhand:{count:1,id:"wooden_sword"},offhand:{count:1,id:"wooden_axe"}}}
execute if score Azr_Story_Introduction rng1 matches 290 positioned -79417 27 -390 run summon piglin ~ ~ ~ {CustomName:'魔界居民',PersistenceRequired:1b,Tags:["AzrielMob_StoryIntroduction_NPC8"],Invulnerable:1b,IsImmuneToZombification:1b,attributes:[{id:"movement_speed",base:0.0}],equipment:{offhand:{}}}

execute if score Azr_Story_Introduction rng1 matches 290 positioned -79364 24 -397 run summon piglin ~ ~ ~ {CustomName:'魔界居民',PersistenceRequired:1b,Tags:["AzrielMob_StoryIntroduction_NPC9"],Invulnerable:1b,IsImmuneToZombification:1b,attributes:[{id:"movement_speed",base:0.15}],equipment:{mainhand:{count:1,id:"golden_pickaxe"}}}
...
execute if score Azr_Story_Introduction rng1 matches 290 positioned -79377 24 -399 run summon piglin ~ ~ ~ {CustomName:'魔界居民',PersistenceRequired:1b,Tags:["AzrielMob_StoryIntroduction_NPC_unused"],Invulnerable:1b,IsImmuneToZombification:1b,attributes:[{id:"movement_speed",base:0.15}],equipment:{offhand:{}}}
...
execute if score Azr_Story_Introduction rng1 matches 290 positioned -79452 24 -393 run summon strider ~ ~ ~ {CustomName:'炽足兽',PersistenceRequired:1b,Tags:["AzrielMob_StoryIntroduction_NPC_unused"],Invulnerable:1b,attributes:[{id:"movement_speed",base:0.15}]}
execute if score Azr_Story_Introduction rng1 matches 290 positioned -79438 30 -405 run summon piglin ~ ~ ~ {CustomName:'魔界居民',PersistenceRequired:1b,Tags:["AzrielMob_StoryIntroduction_NPC_unused"],Invulnerable:1b,IsImmuneToZombification:1b,attributes:[{id:"movement_speed",base:0.15}],equipment:{offhand:{}}}
execute if score Azr_Story_Introduction rng1 matches 290 positioned -79438 30 -405 run summon piglin ~ ~ ~ {CustomName:'魔界居民',PersistenceRequired:1b,Tags:["AzrielMob_StoryIntroduction_NPC_unused"],Invulnerable:1b,IsImmuneToZombification:1b,attributes:[{id:"movement_speed",base:0.15}],equipment:{feet:{count:1,id:"golden_boots"},legs:{count:1,id:"golden_leggings"},chest:{count:1,id:"golden_chestplate"}},drop_chances:{feet:0.0f,legs:0.0f,chest:0.0f,head:0.0f}}
execute if score Azr_Story_Introduction rng1 matches 290 positioned -79488 30 -405 run summon piglin ~ ~ ~ {CustomName:'魔界居民',PersistenceRequired:1b,Tags:["AzrielMob_StoryIntroduction_NPC_unused"],Invulnerable:1b,IsImmuneToZombification:1b,attributes:[{id:"movement_speed",base:0.15}],equipment:{chest:{count:1,id:"golden_chestplate"}},drop_chances:{feet:0.0f,legs:0.0f,chest:0.0f,head:0.0f}}
execute if score Azr_Story_Introduction rng1 matches 290 positioned -79488 30 -405 run summon piglin ~ ~ ~ {CustomName:'魔界居民',PersistenceRequired:1b,Tags:["AzrielMob_StoryIntroduction_NPC_unused"],Invulnerable:1b,IsImmuneToZombification:1b,attributes:[{id:"movement_speed",base:0.15}],equipment:{mainhand:{count:1,id:"spyglass"}}}
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC2,distance=..100,type=piglin,scores={rng1=69}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run playsound entity.piglin.ambient neutral @a ~ ~ ~ 1 1
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC2,distance=..100,type=piglin,scores={rng1=69}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{text:"魔界居民：",color:"yellow",bold:1b},{bold: false,text:"\n“说到底，咱们第10辖区距离王城也很远……”",color:"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC4,distance=..100,type=piglin_brute,scores={rng1=18}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run playsound entity.piglin.ambient neutral @a ~ ~ ~ 1 1
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC4,distance=..100,type=piglin_brute,scores={rng1=18}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{text:"守卫：",color:"yellow",bold:1b},{bold: false,text:"\n“前往神庭，那里有个专门面向你这种对自己的死亡抱有不满之人的挑战。”",color:"white"}]
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC4,distance=..100,type=piglin_brute,scores={rng1=35}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run playsound entity.piglin.ambient neutral @a ~ ~ ~ 1 1
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC4,distance=..100,type=piglin_brute,scores={rng1=35}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{text:"守卫：",color:"yellow",bold:1b},{bold: false,text:"\n“杀了那些可恶的天使守备军，听说坐守神庭生命树的天使长，叫沙利叶的，会赏赐你额外的阳寿。”",color:"white"}]
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC4,distance=..100,type=piglin_brute,scores={rng1=40}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run fill -79409 30 -396 -79409 32 -398 air destroy
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC4,distance=..100,type=piglin_brute,scores={rng1=63}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run playsound entity.piglin.ambient neutral @a ~ ~ ~ 1 1
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC4,distance=..100,type=piglin_brute,scores={rng1=63}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{text:"守卫：",color:"yellow",bold:1b},{bold: false,text:"\n“呵呵……这算是神魔两界暗地里的交易吗？”",color:"white"}]
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC4,distance=..100,type=piglin_brute,scores={rng1=98}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run playsound entity.piglin.ambient neutral @a ~ ~ ~ 1 1
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC4,distance=..100,type=piglin_brute,scores={rng1=98}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{text:"守卫：",color:"yellow",bold:1b},{bold: false,text:"\n“你还在这里做什么？继续前进吧。”",color:"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC5,distance=..100,type=piglin_brute,scores={rng1=17}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run playsound entity.piglin.ambient neutral @a ~ ~ ~ 1 1
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC5,distance=..100,type=piglin_brute,scores={rng1=17}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{text:"守卫：",color:"yellow",bold:1b},{bold: false,text:"\n“不用看我。最近死后被传送到这里来的人类就你一个。”",color:"white"}]
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC5,distance=..100,type=piglin_brute,scores={rng1=34}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run playsound entity.piglin.ambient neutral @a ~ ~ ~ 1 1
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC5,distance=..100,type=piglin_brute,scores={rng1=34}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{text:"守卫：",color:"yellow",bold:1b},{bold: false,text:"\n“是的，是的。你已经死了。没救了。这些都不是关键。”",color:"white"}]
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC5,distance=..100,type=piglin_brute,scores={rng1=50}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run playsound entity.piglin.ambient neutral @a ~ ~ ~ 1 1
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC5,distance=..100,type=piglin_brute,scores={rng1=50}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{text:"守卫：",color:"yellow",bold:1b},{bold: false,text:"\n“我会为你开门，走到尽头——嗯，应该会有其他人指引你的。不是我的职责。”",color:"white"}]
...
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC5,distance=..100,type=piglin_brute,scores={rng1=81}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run playsound entity.piglin.ambient neutral @a ~ ~ ~ 1 1
execute positioned -79385 23 -394 as @n[tag=AzrielMob_StoryIntroduction_NPC5,distance=..100,type=piglin_brute,scores={rng1=81}] at @s if entity @p[tag=azrPlayer,distance=..4.4] run tellraw @a[tag=azrShowDialog] [{text:"守卫：",color:"yellow",bold:1b},{bold: false,text:"\n“还不走……麻烦死了。从这条路走到底，有个传送门，进去就到神庭了。”",color:"white"}]
...
execute if score Azr_Story_Introduction rng1 matches 524 at @p[tag=azrPlayer] run tellraw @a[tag=azrShowDialog] [{text:"温柔的声音：",color:"dark_purple",bold:1b},{bold: false,text:"\n“我们已抵达结局。我，以及你。”",color:"white"}]
execute if score Azr_Story_Introduction rng1 matches 554 at @p[tag=azrPlayer] run tellraw @a[tag=azrShowDialog] [{text:"温柔的声音：",color:"dark_purple",bold:1b},{bold: false,text:"\n“你是亡魂，却也是生灵的希冀。”",color:"white"}]
execute if score Azr_Story_Introduction rng1 matches 584 at @p[tag=azrPlayer] run tellraw @a[tag=azrShowDialog] [{text:"温柔的声音：",color:"dark_purple",bold:1b},{bold: false,text:"\n“而今，苍白的枯树终将为你而生。”",color:"white"}]
execute if score Azr_Story_Introduction rng1 matches 614 at @p[tag=azrPlayer] run tellraw @a[tag=azrShowDialog] [{text:"温柔的声音：",color:"dark_purple",bold:1b},{bold: false,text:"\n“因为，你终会使这座花园走向灰烬，也终将播下第一颗生命的种子。”",color:"white"}]
