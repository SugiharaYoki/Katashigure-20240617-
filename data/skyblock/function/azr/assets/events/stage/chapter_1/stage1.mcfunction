...
execute if score stage_main_thread AzrTimerStack matches 28 positioned -79931 38 -9 as @n[tag=AzrielMob,distance=0..1] run tag @s add AzrielMob_StageProgressTarget
...
execute if score stage_main_thread AzrTimerStack matches 32..33 positioned -79931 38 -4 if entity @n[distance=..10,tag=AzrielMob_StageProgressTarget] run scoreboard players set stage_main_thread AzrTimerStack 32
