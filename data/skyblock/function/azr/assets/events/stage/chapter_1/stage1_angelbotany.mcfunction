...
#商人
execute positioned -79977 -51 12 as @n[type=villager,distance=..5,tag=AzrielTrader_botanical_trader] at @s if entity @a[tag=azrPlayer,distance=..6] run scoreboard players add @s AzrielNPC_ConversationTimer 1
