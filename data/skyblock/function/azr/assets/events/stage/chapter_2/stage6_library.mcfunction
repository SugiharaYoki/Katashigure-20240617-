...
#随机野怪
execute positioned -79876 43 132 if score random_enemy_thread AzrTimerStack matches 2 run function skyblock:azr/assets/mobs/area_pool/calculate {distance:32}
...
execute positioned -79859 43 171 if score random_enemy_thread AzrTimerStack matches 2 run function skyblock:azr/assets/mobs/area_pool/calculate {distance:28}
...
execute positioned -79876 38 100 if score random_enemy_thread AzrTimerStack matches 2 run function skyblock:azr/assets/mobs/area_pool/calculate {distance:32}
execute if block -79873 39 92 air positioned -79876 38 100 if score random_enemy_thread AzrTimerStack matches 2 unless score random_enemy_count AzrTimerStack matches 1.. unless entity @n[tag=AzrielMob,distance=..6] unless entity @a[tag=azrPlayer,distance=..16] if entity @a[tag=azrPlayer,distance=..56] run function skyblock:azr/assets/mobs/area_pool/chapter2_library
execute positioned -79856 40 69 if score random_enemy_thread AzrTimerStack matches 2 run function skyblock:azr/assets/mobs/area_pool/calculate {distance:32}
...
execute positioned -79832 35 71 if score random_enemy_thread AzrTimerStack matches 2 run function skyblock:azr/assets/mobs/area_pool/calculate {distance:32}
