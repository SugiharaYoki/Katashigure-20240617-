...
execute as @s[scores={rng1=52}] positioned -79913 27 208 if entity @n[type=item,distance=..1.5,nbt={Item:{id:"minecraft:slime_ball"}}] store result score @s rng5 run random value 1..20
