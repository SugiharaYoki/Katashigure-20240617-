...
execute if score stage_main_thread AzrTimerStack matches 50 positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{text:"马林努斯：",color:"yellow",bold:1b},{bold: false,text:"\n“试炼将会暂停，任何僭越都将被视为对神庭的宣战。”",color:"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 70 positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{text:"马林努斯：",color:"yellow",bold:1b},{bold: false,text:"\n“请回吧，前方不会再有第八关。”",color:"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 75 positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{text:"马林努斯：",color:"yellow",bold:1b},{bold: false,text:"\n“我有一定的耐心。我劝你收手。”",color:"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 95 positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{text:"马林努斯：",color:"yellow",bold:1b},{bold: false,text:"\n“哪怕与这座神庭为敌……也无妨？我不理解你的思维方式。”",color:"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 101 positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{text:"马林努斯：",color:"yellow",bold:1b},{bold: false,text:"\n“很好，人类的亡魂。我看你并没有听别人劝的意愿。”",color:"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 121 positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{text:"马林努斯：",color:"yellow",bold:1b},{bold: false,text:"\n“准备好，回你的地狱。”",color:"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 500 run fill -79906 40 27 -79906 38 29 minecraft:air destroy
...
execute if score stage_main_thread AzrTimerStack matches 500 run tellraw @a[tag=azrPlayer,scores={AZR_chainKillUpg_pts=..3}] [{text:"索命连击",color:"light_purple",bold:1b},{bold:0b,text:"可用点数已增加，目前为：4",color:"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 500 run scoreboard players set stage Azr_system 21
