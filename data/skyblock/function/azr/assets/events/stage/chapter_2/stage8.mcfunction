...
execute if score stage_main_thread AzrTimerStack matches 500 as @a[tag=azrPlayer,scores={Azr_skillPoints=..8}] run function skyblock:azr/assets/items/amulets/axe_vortex
