...
execute as @s[scores={rng2=7,rng3=1}] positioned -79495 15 -328 run function skyblock:azr/assets/mobs/skill/boss4_amy/summon_2
execute as @s[scores={rng2=7,rng3=2}] positioned -79495 15 -328 run function skyblock:azr/assets/mobs/skill/boss4_amy/summon_3
execute as @s[scores={rng2=7,rng3=3}] positioned -79495 15 -328 run function skyblock:azr/assets/mobs/skill/boss4_amy/summon_2
execute as @s[scores={rng2=7,rng3=4}] positioned -79495 15 -328 run function skyblock:azr/assets/mobs/skill/boss4_amy/summon_3
execute as @s[scores={rng2=7,rng3=5..}] positioned -79495 15 -328 run function skyblock:azr/assets/mobs/skill/boss4_amy/summon_2
