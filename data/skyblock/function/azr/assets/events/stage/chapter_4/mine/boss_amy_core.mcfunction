...
execute as @s[scores={rng2=7,rng3=5..6}] positioned -79495 15 -328 run function skyblock:azr/assets/mobs/skill/boss4_amy/summon_3
execute as @s[scores={rng2=7,rng3=7}] positioned -79495 15 -328 run function skyblock:azr/assets/mobs/skill/boss4_amy/summon_2
execute as @s[scores={rng2=7,rng3=8..12}] positioned -79495 15 -328 run function skyblock:azr/assets/mobs/skill/boss4_amy/summon_3
...
execute if score @s rng3 matches 10..20 if score @s rng9 matches 5 as @a[tag=azrShowDialog] at @s run playsound minecraft:fuse music @s ~ ~ ~ 0.7
execute if score @s rng3 matches 10.. if score @s rng9 matches 840..880 run effect give @n[tag=AzrielMob_demon_amy] resistance 10 4 true
execute if score @s rng3 matches 10.. if score @s rng9 matches 870 run scoreboard players set @s rng3 21
...
execute as @s[scores={rng2=29,rng3=3}] run tellraw @a[tag=azrShowDialog] [{text:"默尔森的灵能传话：",color:"green",bold:1b},{bold: false,text:"\n“爱理莎小姐，我会远程向你输送灵力。但可能没有那么快生效，坚持住！援军很快就到！”",color:"white"}]
execute as @s[scores={rng2=45,rng3=3}] run tellraw @a[tag=azrShowDialog] [{text:"你：",color:"aqua",bold:1b},{bold: false,text:"\n（力量……是生命魔力，我的状态略有恢复。）",color:"white"}]
...
execute as @s[scores={rng2=9..,rng3=1}] unless entity @n[tag=AzrielMob_demon_amy,distance=..80,type=piglin_brute] run stopsound @a[tag=azrShowDialog] music minecraft:garden1.combathigh
execute as @s[scores={rng2=9..,rng3=1}] unless entity @n[tag=AzrielMob_demon_amy,distance=..80,type=piglin_brute] run scoreboard players set @s rng9 0
execute as @s[scores={rng2=9..}] unless score @s rng3 matches 21.. unless entity @n[tag=AzrielMob_demon_amy,distance=..80,type=piglin_brute] run scoreboard players add @s rng3 1
execute as @s[scores={rng2=9..,rng3=..9}] unless entity @n[tag=AzrielMob_demon_amy,distance=..80,type=piglin_brute] run scoreboard players set @s rng2 -10
execute as @s[scores={rng2=9..,rng3=10..20}] unless entity @n[tag=AzrielMob_demon_amy,distance=..80,type=piglin_brute] run kill @e[tag=azr_spin_core,distance=..100,type=marker]
execute as @s[scores={rng2=9..,rng3=10..20}] unless entity @n[tag=AzrielMob_demon_amy,distance=..80,type=piglin_brute] as @e[tag=azr_spin_plate,distance=..100,type=block_display] at @s run particle campfire_cosy_smoke ~ ~0.5 ~ 0.3 0.3 0.3 0 3
execute as @s[scores={rng2=9..,rng3=10..20}] unless entity @n[tag=AzrielMob_demon_amy,distance=..80,type=piglin_brute] run kill @e[tag=azr_spin_plate,distance=..100,type=block_display]
execute as @s[scores={rng2=9..,rng3=10..20}] unless entity @n[tag=AzrielMob_demon_amy,distance=..80,type=piglin_brute] run scoreboard players set @s rng2 0
