...
execute as @s[scores={rng1=29}] unless entity @a[tag=azrPlayer,x=-79703,y=42,z=-365,dx=15,dy=2,dz=15] run scoreboard players set @s rng1 28

execute as @s[scores={rng1=30}] positioned ~ ~ ~ run function skyblock:azr/assets/events/stage/bonus_stage/stage_hoistway_prep
