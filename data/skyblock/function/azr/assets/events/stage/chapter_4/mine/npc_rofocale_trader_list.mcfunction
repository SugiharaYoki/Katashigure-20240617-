...
$execute if score azr_rofocale_shop Azr_Shop_rng$(number) matches 3 as @a[distance=0..13,tag=azrPlayer] at @s run tellraw @s \
...
$execute if score azr_rofocale_shop Azr_Shop_rng$(number) matches 4 as @a[distance=0..13,tag=azrPlayer] at @s run tellraw @s \
...
$execute if score azr_rofocale_shop Azr_Shop_rng$(number) matches 5 as @a[distance=0..13,tag=azrPlayer] at @s run tellraw @s \
...
$execute if score azr_rofocale_shop Azr_Shop_rng$(number) matches 6 as @a[distance=0..13,tag=azrPlayer] at @s run tellraw @s \
