...
execute if score @s AzrielNPC_ConversationTimer matches 3006 unless score azr_rofocale_shop dailydiv < #Server_Date Global_Age store result score azr_rofocale_shop Azr_Shop_rng1 run random value 1..3
execute if score @s AzrielNPC_ConversationTimer matches 3006 unless score azr_rofocale_shop dailydiv < #Server_Date Global_Age store result score azr_rofocale_shop Azr_Shop_rng2 run random value 4..6
...
execute unless entity @a[distance=0..8,tag=azrPlayer] run scoreboard players set @s AzrielNPC_ConversationTimer 49