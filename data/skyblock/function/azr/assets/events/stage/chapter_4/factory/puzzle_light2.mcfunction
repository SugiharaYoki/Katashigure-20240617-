...
execute if score @s AzrEntityTimer matches 18..21 if block ~ ~ ~ warped_button[powered=true] run scoreboard players set @s AzrEntityTimer 100
...
execute positioned -79781 2 -281 if score @s AzrEntityTimer matches 06 run setblock ~ ~ ~ waxed_copper_bulb[lit=true]
execute positioned -79780 2 -281 if score @s AzrEntityTimer matches 10 run setblock ~ ~ ~ waxed_copper_bulb[lit=true]
execute positioned -79779 2 -281 if score @s AzrEntityTimer matches 14 run setblock ~ ~ ~ waxed_copper_bulb[lit=true]
execute positioned -79778 2 -281 if score @s AzrEntityTimer matches 18 run setblock ~ ~ ~ waxed_oxidized_copper_bulb[lit=true]
execute positioned -79777 2 -281 if score @s AzrEntityTimer matches 22 run setblock ~ ~ ~ waxed_copper_bulb[lit=true]
execute positioned -79776 2 -281 if score @s AzrEntityTimer matches 26 run setblock ~ ~ ~ waxed_copper_bulb[lit=true]
execute positioned -79781 2 -281 if score @s AzrEntityTimer matches 06 run playsound block.copper_bulb.turn_on block @a ~ ~ ~ 1.5 1.3
execute positioned -79780 2 -281 if score @s AzrEntityTimer matches 10 run playsound block.copper_bulb.turn_on block @a ~ ~ ~ 1.5 1.3
execute positioned -79779 2 -281 if score @s AzrEntityTimer matches 14 run playsound block.copper_bulb.turn_on block @a ~ ~ ~ 1.5 1.3
execute positioned -79778 2 -281 if score @s AzrEntityTimer matches 18 run playsound block.copper_bulb.turn_on block @a ~ ~ ~ 1.5 1.3
execute positioned -79777 2 -281 if score @s AzrEntityTimer matches 22 run playsound block.copper_bulb.turn_on block @a ~ ~ ~ 1.5 1.3
execute positioned -79776 2 -281 if score @s AzrEntityTimer matches 26 run playsound block.copper_bulb.turn_on block @a ~ ~ ~ 1.5 1.3
