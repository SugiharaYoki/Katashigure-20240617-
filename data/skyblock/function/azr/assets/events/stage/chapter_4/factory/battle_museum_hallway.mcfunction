...
execute if score @s rng1 matches 32 at @n[tag=AzrielMob_piglin_sword] run tellraw @a[tag=azrShowDialog] [{text:"彼列军军士：",color:"red",bold:1b},{bold: false,text:"\n“居然有个亡魂拦在路上！”",color:"white"}]
...
execute if score @s rng1 matches 66 at @n[tag=AzrielMob_piglin_crossbow] run tellraw @a[tag=azrShowDialog] [{text:"彼列军弩手：",color:"red",bold:1b},{bold: false,text:"\n“对面这家伙可不是普通的亡魂！快点联系奥威尔少校，确认对面身份。”",color:"white"}]
...
execute if score @s rng1 matches 3..90 positioned -79795 7 -278 unless entity @a[tag=azrPlayer,x=-79769,y=15,z=-298,dx=37,dy=14,dz=31] positioned -79793 -6 -277 if loaded ~ ~ ~ as @n[tag=AzrielTrader_pig_henry,distance=0..63] at @s run scoreboard players set @s rng2 389
execute if score @s rng1 matches 3..90 positioned -79795 7 -278 unless entity @a[tag=azrPlayer,x=-79769,y=15,z=-298,dx=37,dy=14,dz=31] run fill -79745 16 -297 -79750 22 -297 air replace minecraft:red_stained_glass
execute if score @s rng1 matches 3..90 positioned -79795 7 -278 unless entity @a[tag=azrPlayer,x=-79769,y=15,z=-298,dx=37,dy=14,dz=31] as @e[tag=AzrielMob,type=piglin,x=-79762,y=15,z=-297,dx=30,dy=12,dz=30] at @s run tp @s ~ ~-150 ~
execute if score @s rng1 matches 3..90 positioned -79795 7 -278 unless entity @a[tag=azrPlayer,x=-79769,y=15,z=-298,dx=37,dy=14,dz=31] as @e[tag=AzrielMob,type=piglin,x=-79762,y=15,z=-297,dx=30,dy=12,dz=30] at @s run kill @s
execute if score @s rng1 matches 3..90 positioned -79795 7 -278 unless entity @a[tag=azrPlayer,x=-79769,y=15,z=-298,dx=37,dy=14,dz=31] run kill @s
