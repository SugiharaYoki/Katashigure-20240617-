...
execute as @s[scores={rng1=4}] as @n[tag=AzrielTrader_pig_henry] at @s run tp @s -79740 42 -446
execute as @s[scores={rng1=44}] as @n[tag=AzrielTrader_pig_henry] at @s run tp @s -79740 42 -446
execute as @s[scores={rng1=84}] as @n[tag=AzrielTrader_pig_henry] at @s run tp @s -79740 42 -446
...
execute as @s[scores={rng1=104}] as @n[tag=AzrielTrader_pig_henry] at @s run scoreboard players add @s rng7 1
execute as @s[scores={rng1=104}] as @n[tag=AzrielTrader_pig_henry] at @s run tag @s remove AzrielMob_pig_henry_attackdisabled
execute as @s[scores={rng1=104}] at @n[tag=AzrielTrader_pig_henry] run playsound minecraft:entity.piglin.ambient hostile @a[tag=azrShowDialog] ~ ~ ~ 1 0.9
