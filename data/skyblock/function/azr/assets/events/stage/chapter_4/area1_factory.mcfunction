...
execute positioned -79793 -6 -277 if loaded ~ ~ ~ as @n[tag=AzrielTrader_pig_henry,distance=0..63] at @s unless entity @n[tag=AzrielMob,distance=..8] run function skyblock:azr/assets/events/stage/chapter_4/factory/conv_the_piglin
