...
execute if score @s rng1 matches 101 positioned ~ ~ ~ at @n[tag=AzrielTrader_pig_henry] run playsound minecraft:entity.piglin.ambient hostile @a[tag=azrShowDialog] ~ ~ ~ 1 0.9
...
execute if score @s rng1 matches 130 positioned ~ ~ ~ at @n[tag=AzrielTrader_pig_henry] run playsound minecraft:entity.piglin.ambient hostile @a[tag=azrShowDialog] ~ ~ ~ 1 0.9
...
execute if score @s rng1 matches 146 positioned ~ ~ ~ at @n[tag=AzrielTrader_pig_henry] run playsound minecraft:entity.piglin.ambient hostile @a[tag=azrShowDialog] ~ ~ ~ 1 0.9
...
execute if score @s rng1 matches 102 positioned -79767 37 -417 run function skyblock:azr/assets/mobs/magma_cube_block
execute if score @s rng1 matches 102 positioned -79783 24 -440 run function skyblock:azr/assets/mobs/magma_cube_block
execute if score @s rng1 matches 102 positioned -79798 33 -461 run function skyblock:azr/assets/mobs/magma_cube_block
execute if score @s rng1 matches 102 positioned -79806 33 -487 run function skyblock:azr/assets/mobs/magma_cube_block
...
execute if score @s rng1 matches 102 positioned -79717 22 -459 run function skyblock:azr/assets/mobs/magma_cube_block

execute if score @s rng1 matches 102 positioned -79745 39 -531 run function skyblock:azr/assets/mobs/unique/trader/pig_gavroche
