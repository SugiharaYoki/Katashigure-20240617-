...
execute positioned -79693 24 -410 as @n[tag=AzrielMarker_encounter,distance=0..0.5] at @s run function skyblock:azr/assets/events/effects/soul_fragment {id:"05",pos:"-79685 24.2 -361",area:"forest"}
...
execute positioned -79775 23 -415 if score random_enemy_thread AzrTimerStack matches 3 unless score random_enemy_count rng10 matches 50.. unless score random_enemy_count AzrTimerStack matches 2.. unless entity @a[tag=azrPlayer,distance=..12] if entity @a[tag=azrPlayer,distance=..30] if loaded ~ ~ ~ run function skyblock:azr/assets/mobs/area_pool/chapter4_forest_soldier_piglin
execute if score stage Azr_system matches ..68 positioned -79755 23 -415 if score random_enemy_thread AzrTimerStack matches 3 if loaded ~ ~ ~ run function skyblock:azr/assets/mobs/area_pool/calculate {distance:42}
execute if score stage Azr_system matches ..68 positioned -79755 23 -415 if score random_enemy_thread AzrTimerStack matches 3 unless score random_enemy_count rng10 matches 50.. unless score random_enemy_count AzrTimerStack matches 2.. unless entity @a[tag=azrPlayer,distance=..12] if entity @a[tag=azrPlayer,distance=..30] if loaded ~ ~ ~ run function skyblock:azr/assets/mobs/area_pool/chapter4_forest_soldier_piglin
...
execute positioned -79744 42 -451 if score random_enemy_thread AzrTimerStack matches 2 unless score random_enemy_count rng10 matches 50.. unless score random_enemy_count AzrTimerStack matches 4.. unless entity @a[tag=azrPlayer,distance=..12] if entity @a[tag=azrPlayer,distance=..30] if loaded ~ ~ ~ run function skyblock:azr/assets/mobs/area_pool/chapter4_forest_soldier_piglin
execute if score stage Azr_system matches ..68 positioned -79809 35 -496 if score random_enemy_thread AzrTimerStack matches 2 if loaded ~ ~ ~ run function skyblock:azr/assets/mobs/area_pool/calculate {distance:42}
execute if score stage Azr_system matches ..68 positioned -79809 35 -496 if score random_enemy_thread AzrTimerStack matches 2 unless score random_enemy_count rng10 matches 50.. unless score random_enemy_count AzrTimerStack matches 4.. unless entity @a[tag=azrPlayer,distance=..12] if entity @a[tag=azrPlayer,distance=..30] if loaded ~ ~ ~ run function skyblock:azr/assets/mobs/area_pool/chapter4_forest_soldier_piglin
execute if score stage Azr_system matches ..68 positioned -79740 36 -538 if score random_enemy_thread AzrTimerStack matches 2 if loaded ~ ~ ~ run function skyblock:azr/assets/mobs/area_pool/calculate {distance:42}
execute if score stage Azr_system matches ..68 positioned -79740 36 -538 if score random_enemy_thread AzrTimerStack matches 2 unless score random_enemy_count rng10 matches 50.. unless score random_enemy_count AzrTimerStack matches 4.. unless entity @a[tag=azrPlayer,distance=..12] if entity @a[tag=azrPlayer,distance=..30] if loaded ~ ~ ~ run function skyblock:azr/assets/mobs/area_pool/chapter4_forest_soldier_piglin
...
execute if score stage Azr_system matches ..68 positioned -79773 37 -533 if score random_enemy_thread AzrTimerStack matches 2 if loaded ~ ~ ~ run function skyblock:azr/assets/mobs/area_pool/calculate {distance:42}
execute if score stage Azr_system matches ..68 positioned -79773 37 -533 if score random_enemy_thread AzrTimerStack matches 2 unless score random_enemy_count rng10 matches 50.. unless score random_enemy_count AzrTimerStack matches 2.. unless entity @a[tag=azrPlayer,distance=..12] if entity @a[tag=azrPlayer,distance=..30] if loaded ~ ~ ~ run function skyblock:azr/assets/mobs/area_pool/chapter4_forest_soldier_undead
execute if score stage Azr_system matches ..68 positioned -79724 45 -450 if score random_enemy_thread AzrTimerStack matches 2 if loaded ~ ~ ~ run function skyblock:azr/assets/mobs/area_pool/calculate {distance:42}
execute if score stage Azr_system matches ..68 positioned -79724 45 -450 if score random_enemy_thread AzrTimerStack matches 2 unless score random_enemy_count rng10 matches 50.. unless score random_enemy_count AzrTimerStack matches 2.. unless entity @a[tag=azrPlayer,distance=..12] if entity @a[tag=azrPlayer,distance=..30] if loaded ~ ~ ~ run function skyblock:azr/assets/mobs/area_pool/chapter4_forest_soldier_undead
...
execute positioned -79767 38 -520 if score random_enemy_thread AzrTimerStack matches 2 unless score random_enemy_count rng10 matches 50.. unless score random_enemy_count AzrTimerStack matches 2.. unless entity @a[tag=azrPlayer,distance=..2] if entity @a[tag=azrPlayer,distance=..6.5] if loaded ~ ~ ~ run function skyblock:azr/assets/mobs/blaze
...
execute positioned -79780 39 -537 if score random_enemy_thread AzrTimerStack matches 2 unless score random_enemy_count rng10 matches 50.. unless score random_enemy_count AzrTimerStack matches 2.. unless entity @a[tag=azrPlayer,distance=..2] if entity @a[tag=azrPlayer,distance=..6.5] if loaded ~ ~ ~ run function skyblock:azr/assets/mobs/blaze
...
execute positioned -79750 41 -542 if score random_enemy_thread AzrTimerStack matches 2 unless score random_enemy_count rng10 matches 50.. unless score random_enemy_count AzrTimerStack matches 2.. unless entity @a[tag=azrPlayer,distance=..2] if entity @a[tag=azrPlayer,distance=..6.5] if loaded ~ ~ ~ run function skyblock:azr/assets/mobs/blaze
...
execute positioned -79799 33 -491 if score random_enemy_thread AzrTimerStack matches 2 unless score random_enemy_count rng10 matches 50.. unless score random_enemy_count AzrTimerStack matches 2.. unless entity @a[tag=azrPlayer,distance=..2] if entity @a[tag=azrPlayer,distance=..6.5] if loaded ~ ~ ~ run function skyblock:azr/assets/mobs/blaze
...
execute positioned -79757 36 -424 if score random_enemy_thread AzrTimerStack matches 2 unless score random_enemy_count rng10 matches 50.. unless score random_enemy_count AzrTimerStack matches 2.. unless entity @a[tag=azrPlayer,distance=..2] if entity @a[tag=azrPlayer,distance=..6.5] if loaded ~ ~ ~ run function skyblock:azr/assets/mobs/blaze
...
execute positioned -79676 32 -499 if score random_enemy_thread AzrTimerStack matches 2 unless score random_enemy_count rng10 matches 50.. unless score random_enemy_count AzrTimerStack matches 2.. unless entity @a[tag=azrPlayer,distance=..2] if entity @a[tag=azrPlayer,distance=..6.5] if loaded ~ ~ ~ run function skyblock:azr/assets/mobs/blaze
