...
execute if score internal_clock_004 Azr_system matches -2147483648..2147483647 run schedule function skyblock:azr/assets/events/stage/dialog/ch4_door0 1t