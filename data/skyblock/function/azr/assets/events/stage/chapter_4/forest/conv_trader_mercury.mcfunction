...
execute if score @s rng1 matches 1007 as @a[distance=0..8.5,tag=azrPlayer] run tellraw @s [{text:" - "},{text:"纯金长剑  ",color:"#ad1e78"},{"score":{"name":"@s","objective":"Azr_gold"},color:"#f4cf1a"},{text:"/250 金粒 ",color:"#f4cf1a"},{text:"〈◆〉",bold:1b,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 8431604"}}]
execute if score @s rng1 matches 1007 as @a[distance=0..8.5,tag=azrPlayer] run tellraw @s [{text:" - "},{text:"纯金板斧  ",color:"#ad1e78"},{"score":{"name":"@s","objective":"Azr_gold"},color:"#f4cf1a"},{text:"/250 金粒 ",color:"#f4cf1a"},{text:"〈◆〉",bold:1b,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 8431605"}}]
execute if score @s rng1 matches 1007 as @a[distance=0..8.5,tag=azrPlayer] run tellraw @s [{text:" - "},{text:"纯金战棍  ",color:"#ad1e78"},{"score":{"name":"@s","objective":"Azr_gold"},color:"#f4cf1a"},{text:"/250 金粒 ",color:"#f4cf1a"},{text:"〈◆〉",bold:1b,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 8431606"}}]
execute if score @s rng1 matches 1007 as @a[distance=0..8.5,tag=azrPlayer] run tellraw @s [{text:" - "},{text:"金盔甲  ",color:"#cd8107"},{"score":{"name":"@s","objective":"Azr_gold"},color:"#f4cf1a"},{text:"/180 金粒 ",color:"#f4cf1a"},{text:"〈头盔〉",bold:1b,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 8431607"}},{text:"〈盔甲〉",bold:1b,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 8431608"}},{text:"〈护腿〉",bold:1b,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 8431609"}},{text:"〈靴子〉",bold:1b,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 8431610"}}]
