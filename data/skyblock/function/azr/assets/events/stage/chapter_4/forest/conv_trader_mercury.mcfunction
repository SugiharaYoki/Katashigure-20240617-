...
execute if score @s rng1 matches 1007 as @a[distance=0..8.5,tag=azrPlayer] run tellraw @s [{text:" - "},{text:"纯金灵杖  ",color:"#ad1e78"},{"score":{"name":"@s","objective":"Azr_gold"},color:"#f4cf1a"},{text:"/250 金粒 ",color:"#f4cf1a"},{text:"〈◆〉",bold:1b,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 8431606"}}]
