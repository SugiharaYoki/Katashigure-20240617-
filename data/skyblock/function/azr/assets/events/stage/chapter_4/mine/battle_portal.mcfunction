...
execute if score @s rng9 matches 551.. run scoreboard players set @s rng9 0
...
execute as @s[scores={rng1=1117}] run setblock -79371 26 -386 waxed_copper_chest[facing=west]{Inventory:[]}
...
execute as @s[scores={rng1=..6000}] positioned -79425 25 -328 if entity @a[tag=azrPlayer,distance=..10] run scoreboard players set @s rng1 6001
