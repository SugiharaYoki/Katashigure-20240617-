...
execute as @s[scores={rng1=1}] positioned ~ ~ ~ run fill -79715 26 -514 -79715 26 -516 air
execute as @s[scores={rng1=1}] positioned ~ ~ ~ run fill -79728 26 -514 -79728 26 -516 air
