...
#废品交易商人
execute positioned -79588 9 -391 as @n[type=villager,distance=..5,tag=AzrielTrader_rofocale] at @s if entity @a[tag=azrPlayer,distance=..5] run function skyblock:azr/assets/events/stage/chapter_4/mine/npc_rofocale_trader
