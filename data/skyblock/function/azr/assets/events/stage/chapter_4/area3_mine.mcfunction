...
execute positioned -79505 45 -338 unless entity @n[tag=AzrielMarker_encounter,distance=0..0.5] positioned -79505 15 -338 if entity @n[tag=AzrielMarker_encounter,distance=0..0.5,tag=Chapter4_Boss_Ended] if loaded ~ ~ ~ positioned -79505 45 -338 run summon marker ~ ~ ~ {Tags:["AzrielMarker_encounter"]}
