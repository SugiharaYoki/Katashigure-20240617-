...
execute if score stage Azr_system matches ..68 positioned -79505 15 -338 as @n[tag=AzrielMarker_encounter,distance=0..0.5,tag=!Chapter4_Boss_Ended] at @s unless entity @n[tag=Chapter4_Boss_Ended,distance=..50] run function skyblock:azr/assets/events/stage/chapter_4/mine/boss_amy_core

execute if score stage Azr_system matches ..68 positioned -79505 45 -338 unless entity @n[tag=AzrielMarker_encounter,distance=0..0.5] positioned -79505 15 -338 if entity @n[tag=AzrielMarker_encounter,distance=0..0.5,tag=Chapter4_Boss_Ended] if loaded ~ ~ ~ positioned -79505 45 -338 run summon marker ~ ~ ~ {Tags:["AzrielMarker_encounter"]}
...
#stage jahannam
execute positioned -79663 33 -434 unless entity @n[tag=AzrielMarker_encounter,distance=0..0.5] if block ~ ~ ~ air if entity @a[tag=azrPlayer,x=-79668,y=30,z=-436,dx=10,dy=5,dz=10] if loaded ~ ~ ~ run function skyblock:azr/assets/events/stage/bonus_stage/stage_jahannam_prep
...
execute positioned -79656 22 -332 if score random_enemy_thread AzrTimerStack matches 2 if loaded ~ ~ ~ run function skyblock:azr/assets/mobs/area_pool/calculate {distance:42}
execute positioned -79656 22 -332 if score random_enemy_thread AzrTimerStack matches 2 unless score random_enemy_count rng10 matches 50.. unless score random_enemy_count AzrTimerStack matches 4.. unless entity @a[tag=azrPlayer,distance=..18] if entity @a[tag=azrPlayer,distance=..30] if loaded ~ ~ ~ run function skyblock:azr/assets/mobs/area_pool/chapter4_forest_animal
execute positioned -79676 20 -333 if score random_enemy_thread AzrTimerStack matches 2 if loaded ~ ~ ~ run function skyblock:azr/assets/mobs/area_pool/calculate {distance:42}
execute positioned -79676 20 -333 if score random_enemy_thread AzrTimerStack matches 2 unless score random_enemy_count rng10 matches 50.. unless score random_enemy_count AzrTimerStack matches 4.. unless entity @a[tag=azrPlayer,distance=..18] if entity @a[tag=azrPlayer,distance=..30] if loaded ~ ~ ~ run function skyblock:azr/assets/mobs/area_pool/chapter4_forest_animal
