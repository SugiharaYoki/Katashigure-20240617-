...
execute if score @s AzrEntityTimer matches -8 run fill -79770 2 -271 -79765 2 -271 minecraft:waxed_copper_bulb[lit=false]
execute if score @s AzrEntityTimer matches -8 run setblock -79766 2 -271 minecraft:waxed_oxidized_copper_bulb[lit=false]

execute if block -79770 2 -271 waxed_copper_bulb[lit=true] run scoreboard players add @s AzrEntityTimer 1
...
execute positioned -79766 2 -271 if score @s AzrEntityTimer matches 101 run fill -79762 1 -276 -79762 2 -275 air
