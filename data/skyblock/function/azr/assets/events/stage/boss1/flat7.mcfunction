...
execute if score zanei_flat_01_marker rng1 matches 16 as @n[type=arrow,tag=zanei_flat_01_arrow1] positioned 0. 0. 0. facing entity @n[type=marker,tag=zanei_flat_01_marker] feet run function skyblock:azr/system/utils/fix_arrow_facing
...
execute if score zanei_flat_01_marker rng1 matches 19 as @n[type=arrow,tag=zanei_flat_01_arrow2] positioned 0. 0. 0. facing entity @n[type=marker,tag=zanei_flat_01_marker] feet run function skyblock:azr/system/utils/fix_arrow_facing
...
execute if score zanei_flat_01_marker rng1 matches 22 as @n[type=arrow,tag=zanei_flat_01_arrow3] positioned 0. 0. 0. facing entity @n[type=marker,tag=zanei_flat_01_marker] feet run function skyblock:azr/system/utils/fix_arrow_facing
