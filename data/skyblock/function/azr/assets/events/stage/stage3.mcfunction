...
execute if score stage_main_thread AzrTimerStack matches 121 positioned -79930 38 38 run function skyblock:azr/assets/mobs_new/sword
execute if score stage_main_thread AzrTimerStack matches 121 positioned -79932 38 38 run function skyblock:azr/assets/mobs_new/sword
