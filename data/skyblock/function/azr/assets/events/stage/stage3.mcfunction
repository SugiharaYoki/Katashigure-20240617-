...
execute if score stage_main_thread AzrTimerStack matches 232 positioned -79923 44 28 run function skyblock:azr/assets/mobs_new/summoner
execute if score stage_main_thread AzrTimerStack matches 232 positioned -79923 44 28 run function skyblock:azr/assets/mobs_new/summoner
execute if score stage_main_thread AzrTimerStack matches 232 positioned -79923 44 28 run tag @n[type=pillager,distance=0..0.1] add AzrielMob_dialog_stage4pre_hidden_a1
