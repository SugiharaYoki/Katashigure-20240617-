...
#关卡特效
execute if score stage_main_thread AzrTimerStack matches 19 positioned -79930.5 38.0 3.5 run function skyblock:azr/assets/events/effects/basalt_open
#刷怪时序
...
execute if score stage_main_thread AzrTimerStack matches 10..12 unless entity @n[tag=AzrielMob_summoner] run scoreboard players set stage_main_thread AzrTimerStack 10

execute if score stage_main_thread AzrTimerStack matches 19 positioned -79930.5 38.0 3.5 run function skyblock:azr/assets/events/effects/basalt_open
execute if score stage_main_thread AzrTimerStack matches 19 positioned -79931 38 3 run function skyblock:azr/assets/mobs_new/summoner
execute if score stage_main_thread AzrTimerStack matches 21 run tellraw @a[tag=azrShowDialog] [{"text":"驭灵使：","color":"yellow"},{"text":"\n“把我叫来就为了这种事？这就是普通人类亡灵啊。”","color":"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 40.. run scoreboard players set wave Azr_system 1
execute if score stage_main_thread AzrTimerStack matches 40.. run scoreboard players reset tick_main_thread AzrTimerStack
execute if score stage_main_thread AzrTimerStack matches 40.. run advancement grant @a[tag=azrPlayer] only skyblock:azr/progress/stage1
