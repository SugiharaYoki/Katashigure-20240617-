...
execute if score stage_main_thread AzrTimerStack matches 31 run tellraw @a[tag=azrShowDialog] [{"text":"驭灵使：","color":"yellow"},{"text":"\n“嗯……？试炼者？这种节骨眼上？”","color":"white"}]

execute if score stage_main_thread AzrTimerStack matches 32..33 if entity @n[tag=AzrielMob_summoner] run scoreboard players set stage_main_thread AzrTimerStack 32
execute if score stage_main_thread AzrTimerStack matches 32..33 unless entity @n[tag=AzrielMob_summoner] run scoreboard players set stage_main_thread AzrTimerStack 34
...
execute if score stage_main_thread AzrTimerStack matches 39 positioned -79931 38 3 run function skyblock:azr/assets/mobs_new/summoner
execute if score stage_main_thread AzrTimerStack matches 42 run tellraw @a[tag=azrShowDialog] [{"text":"驭灵使：","color":"yellow"},{"text":"\n“把我叫来就为了这种事？这就是普通人类亡灵啊。”","color":"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 62..63 unless entity @e[tag=AzrielMob_barrier_maintainer] run scoreboard players set stage_main_thread AzrTimerStack 64
#结束
execute if score stage_main_thread AzrTimerStack matches 65 run playsound ambient.crimson_forest.loop ambient @a[tag=azrShowDialog] -78000 100 0 1000
...
execute if score stage_main_thread AzrTimerStack matches 65 positioned -79925 38 14 run function skyblock:azr/assets/mobs_new/summoner
execute if score stage_main_thread AzrTimerStack matches 65 positioned -79937 38 13 run function skyblock:azr/assets/mobs_new/undead
execute if score stage_main_thread AzrTimerStack matches 65 positioned -79937 38 15 run function skyblock:azr/assets/mobs_new/undead
...
execute if score stage_main_thread AzrTimerStack matches 72.. if score playerCount Azr_system matches 3.. run fill -79934 40 -1 -79934 38 1 air destroy
...
execute if score stage_main_thread AzrTimerStack matches 72.. run scoreboard players set wave Azr_system 1
