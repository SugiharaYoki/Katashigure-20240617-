...
execute if score stage_main_thread AzrTimerStack matches 310 positioned -79931 38 25 run summon minecraft:nether_star ~ ~ ~ {Invisible:1b,Fixed:0b,Invulnerable:0b,Facing:1b,Item:{id:"minecraft:nether_star",components:{custom_name:'{"text":"下界命星","color":"yellow","italic":false}',custom_data:{revival_star:true},custom_model_data:{floats:[100001.0]}}}}
execute if score stage_main_thread AzrTimerStack matches 310 positioned -79977 8 61 run summon minecraft:nether_star ~ ~ ~ {Invisible:1b,Fixed:0b,Invulnerable:0b,Facing:1b,Item:{id:"minecraft:nether_star",components:{custom_name:'{"text":"下界命星","color":"yellow","italic":false}',custom_data:{revival_star:true},custom_model_data:{floats:[100001.0]}}}}


#野区 代替原先stage3b与4b
execute if score stage_main_thread AzrTimerStack matches 310 positioned -79946 38 4 run function skyblock:azr/assets/mobs_new/undead
execute if score stage_main_thread AzrTimerStack matches 310 positioned -79946 38 8 run function skyblock:azr/assets/mobs_new/undead
execute if score stage_main_thread AzrTimerStack matches 310 positioned -79956 38 10 run function skyblock:azr/assets/mobs_new/undead_pickaxe
execute if score stage_main_thread AzrTimerStack matches 310 store result score #rng1 Azr_system run random value 1..10
execute if score stage_main_thread AzrTimerStack matches 310 positioned -79946 38 4 if score #rng1 Azr_system matches 1..3 run function skyblock:azr/assets/mobs_new/treasure_rabbit
execute if score stage_main_thread AzrTimerStack matches 310 positioned -79950 38 21 if score #rng1 Azr_system matches 4..6 run function skyblock:azr/assets/mobs_new/treasure_rabbit
execute if score stage_main_thread AzrTimerStack matches 310 positioned -79928 38 -9 if score #rng1 Azr_system matches 7..8 run function skyblock:azr/assets/mobs_new/treasure_rabbit
