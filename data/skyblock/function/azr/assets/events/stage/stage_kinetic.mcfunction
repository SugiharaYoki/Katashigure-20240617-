...
execute if score stage_bonus_thread AzrTimerStack matches 51 positioned -79953 29 162 run function skyblock:azr/assets/mobs_new/undead_fire
execute if score stage_bonus_thread AzrTimerStack matches 55 positioned -79953 29 162 run function skyblock:azr/assets/mobs_new/undead_pickaxe
...
execute if score stage_bonus_thread AzrTimerStack matches 110 positioned -79953 29 162 run function skyblock:azr/assets/mobs_new/skeleton_melee
execute if score stage_bonus_thread AzrTimerStack matches 120 positioned -79953 29 162 run function skyblock:azr/assets/mobs_new/skeleton_melee
execute if score stage_bonus_thread AzrTimerStack matches 130 positioned -79953 29 162 run function skyblock:azr/assets/mobs_new/skeleton_melee
execute if score stage_bonus_thread AzrTimerStack matches 140 positioned -79953 29 162 run function skyblock:azr/assets/mobs_new/skeleton_melee
execute if score stage_bonus_thread AzrTimerStack matches 115 positioned -79953 29 162 run function skyblock:azr/assets/mobs_new/undead_fire
