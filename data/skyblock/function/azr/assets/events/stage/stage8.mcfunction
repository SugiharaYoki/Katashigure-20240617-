...
execute if score stage_main_thread AzrTimerStack matches 121 as @n[tag=AzrielNPC_marinus] if entity @a[tag=azrPlayer,scores={AzrSariel_Data_CostAmount=50..99}] run attribute @s armor base set 2.0
execute if score stage_main_thread AzrTimerStack matches 121 as @n[tag=AzrielNPC_marinus] if entity @a[tag=azrPlayer,scores={AzrSariel_Data_CostAmount=100..249}] run attribute @s armor base set 3.5
execute if score stage_main_thread AzrTimerStack matches 121 as @n[tag=AzrielNPC_marinus] if entity @a[tag=azrPlayer,scores={AzrSariel_Data_CostAmount=250..349}] run attribute @s armor base set 6.0
execute if score stage_main_thread AzrTimerStack matches 121 as @n[tag=AzrielNPC_marinus] if entity @a[tag=azrPlayer,scores={AzrSariel_Data_CostAmount=350..}] run attribute @s armor base set 9.0
