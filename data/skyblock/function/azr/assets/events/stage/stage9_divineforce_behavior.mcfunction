...
execute if entity @s[tag=!AzrielNPC_Divineforce_hasattacktarget] if entity @n[tag=!AzrielNPC_Divineforce,tag=AzrielMob,distance=0..7] store result score @s rng9 run random value 1..20

execute if entity @s[tag=!AzrielNPC_Divineforce_hasattacktarget,scores={rng9=1},tag=AzrielMob_sword] if entity @n[tag=!AzrielNPC_Divineforce,tag=AzrielMob,distance=0..7] run tellraw @a[tag=azrShowDialog] [{"text":"剑士：","color":"green","bold": true},{"bold": false,"text":"\n“我来帮你一把！”","color":"white"}]
execute if entity @s[tag=!AzrielNPC_Divineforce_hasattacktarget,scores={rng9=2},tag=AzrielMob_sword] if entity @n[tag=!AzrielNPC_Divineforce,tag=AzrielMob,distance=0..7] run tellraw @a[tag=azrShowDialog] [{"text":"剑士：","color":"green","bold": true},{"bold": false,"text":"\n“敌人交给我。”","color":"white"}]
execute if entity @s[tag=!AzrielNPC_Divineforce_hasattacktarget,scores={rng9=3},tag=AzrielMob_sword] if entity @n[tag=!AzrielNPC_Divineforce,tag=AzrielMob,distance=0..7] run tellraw @a[tag=azrShowDialog] [{"text":"剑士：","color":"green","bold": true},{"bold": false,"text":"\n“我来帮忙，爱理莎女士。”","color":"white"}]
execute if entity @s[tag=!AzrielNPC_Divineforce_hasattacktarget,scores={rng9=4},tag=AzrielMob_sword] if entity @n[tag=!AzrielNPC_Divineforce,tag=AzrielMob,distance=0..7] run tellraw @a[tag=azrShowDialog] [{"text":"剑士：","color":"green","bold": true},{"bold": false,"text":"\n“就是这家伙吗？让我来。”","color":"white"}]
execute if entity @s[tag=!AzrielNPC_Divineforce_hasattacktarget,scores={rng9=5},tag=AzrielMob_sword] if entity @n[tag=!AzrielNPC_Divineforce,tag=AzrielMob,distance=0..7] run tellraw @a[tag=azrShowDialog] [{"text":"剑士：","color":"green","bold": true},{"bold": false,"text":"\n“是时候大展身手了。”","color":"white"}]
execute if entity @s[tag=!AzrielNPC_Divineforce_hasattacktarget,scores={rng9=1},tag=AzrielMob_pillager] if entity @n[tag=!AzrielNPC_Divineforce,tag=AzrielMob,distance=0..7] run tellraw @a[tag=azrShowDialog] [{"text":"弩手：","color":"green","bold": true},{"bold": false,"text":"\n“随时准备阻击敌人。”","color":"white"}]
execute if entity @s[tag=!AzrielNPC_Divineforce_hasattacktarget,scores={rng9=2},tag=AzrielMob_pillager] if entity @n[tag=!AzrielNPC_Divineforce,tag=AzrielMob,distance=0..7] run tellraw @a[tag=azrShowDialog] [{"text":"弩手：","color":"green","bold": true},{"bold": false,"text":"\n“发现目标。”","color":"white"}]
execute if entity @s[tag=!AzrielNPC_Divineforce_hasattacktarget,scores={rng9=3},tag=AzrielMob_pillager] if entity @n[tag=!AzrielNPC_Divineforce,tag=AzrielMob,distance=0..7] run tellraw @a[tag=azrShowDialog] [{"text":"弩手：","color":"green","bold": true},{"bold": false,"text":"\n“爱理莎女士，支援来了。”","color":"white"}]
execute if entity @s[tag=!AzrielNPC_Divineforce_hasattacktarget,scores={rng9=4},tag=AzrielMob_pillager] if entity @n[tag=!AzrielNPC_Divineforce,tag=AzrielMob,distance=0..7] run tellraw @a[tag=azrShowDialog] [{"text":"弩手：","color":"green","bold": true},{"bold": false,"text":"\n“小心，躲开我的箭。”","color":"white"}]
execute if entity @s[tag=!AzrielNPC_Divineforce_hasattacktarget,scores={rng9=5},tag=AzrielMob_pillager] if entity @n[tag=!AzrielNPC_Divineforce,tag=AzrielMob,distance=0..7] run tellraw @a[tag=azrShowDialog] [{"text":"弩手：","color":"green","bold": true},{"bold": false,"text":"\n“看上去是个难缠的敌人。”","color":"white"}]
