...
execute positioned -79956 38 2 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=25}] positioned -79957 38 2 run function skyblock:azr/assets/mobs_new/sword
execute positioned -79956 38 2 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=25}] positioned -79955 38 2 run function skyblock:azr/assets/mobs_new/sword
