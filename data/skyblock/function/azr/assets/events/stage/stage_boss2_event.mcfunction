...
execute if score stage_main_thread AzrTimerStack matches 2 as @n[tag=AzrielNPC_andralune] if entity @p[tag=azrPlayer,scores={AzrSariel_Data_CostAmount=..99}] run attribute @s armor base set 11.0
execute if score stage_main_thread AzrTimerStack matches 2 as @n[tag=AzrielNPC_andralune] if entity @p[tag=azrPlayer,scores={AzrSariel_Data_CostAmount=100..249}] run attribute @s armor base set 15.0
execute if score stage_main_thread AzrTimerStack matches 2 as @n[tag=AzrielNPC_andralune] if entity @p[tag=azrPlayer,scores={AzrSariel_Data_CostAmount=250..349}] run attribute @s armor base set 18.0
execute if score stage_main_thread AzrTimerStack matches 2 as @n[tag=AzrielNPC_andralune] if entity @p[tag=azrPlayer,scores={AzrSariel_Data_CostAmount=350..}] run attribute @s armor base set 21.0
execute if score stage_main_thread AzrTimerStack matches 2 as @n[tag=AzrielNPC_andralune] if entity @p[tag=azrPlayer,scores={AzrSariel_Data_CostAmount=..299}] run attribute @s movement_speed base set 0.33
execute if score stage_main_thread AzrTimerStack matches 2 as @n[tag=AzrielNPC_andralune] if entity @p[tag=azrPlayer,scores={AzrSariel_Data_CostAmount=300..}] run attribute @s movement_speed base set 0.43
