...
execute if score stage_main_thread AzrTimerStack matches 20 if entity @n[tag=AzrielNPC_andralune,tag=!BOSS_seen_2] positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{"text":"权之残影：","color":"light_purple","bold": true},{"bold": false,"text":"\n“爱理莎女士……或者，我该如此称呼你：路西法的先锋军。”","color":"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 37 if entity @n[tag=AzrielNPC_andralune,tag=BOSS_seen_2] positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{"text":"权之残影：","color":"light_purple","bold": true},{"bold": false,"text":"\n“那么，继续我们之间的战斗吧。”","color":"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 54 positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{"text":"权之残影：","color":"light_purple","bold": true},{"bold": false,"text":"\n“我相当欣赏你的勇气。但是，我多么希望你至少站对了立场。”","color":"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 71 positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{"text":"权之残影：","color":"light_purple","bold": true},{"bold": false,"text":"\n“我给了你逃走的机会。我甚至让马林努斯拦住你。如果你执意向前，我很乐意将你的灵魂击碎。”","color":"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 1125 positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{"text":"权之残影：","color":"light_purple","bold": true},{"bold": false,"text":"\n“我居然早就料到他会变卦……人类的亡魂，虽然你并不必回答我，但给予你魔界力量的，是权之殊能吗？”","color":"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 1155 positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{"text":"权之残影：","color":"light_purple","bold": true},{"bold": false,"text":"\n“……”","color":"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 1254 positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{"text":"权之残影：","color":"light_purple","bold": true},{"bold": false,"text":"\n“这并不是什么好事。……虽然我确实需要你的帮助。”","color":"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 1270 positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{"text":"默尔森：","color":"yellow","bold": true},{"bold": false,"text":"\n“残影大人，这里恐怕已经被恣眼盯上了，留在这里不是什么好主意。”","color":"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 1295 positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{"text":"权之残影：","color":"light_purple","bold": true},{"bold": false,"text":"\n“现在最安全的反而是深入敌营。人类的亡魂爱理莎，我与我的属下会前往牢房区域一探究竟。”","color":"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 1312 positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{"text":"权之残影：","color":"light_purple","bold": true},{"bold": false,"text":"\n“你可以思考一下我的提案。但如果你要去那里，请做好万全的准备。那里的危险程度现在完全无法预测。”","color":"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 1329 positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{"text":"默尔森：","color":"green","bold": true},{"bold": false,"text":"\n“权之殊能大人本尊还好说，他的手下可绝不留情。人类的亡魂，衷心祝你好运。”","color":"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 1342 positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{"text":"权之残影：","color":"light_purple","bold": true},{"bold": false,"text":"\n“我们还会见面的。”","color":"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 1360 positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{"text":"默尔森：","color":"green","bold": true},{"bold": false,"text":"\n“……人类的亡魂，我可以看看你的生命手册吗？”","color":"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 1400 positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{"text":"默尔森：","color":"green","bold": true},{"bold": false,"text":"\n“或许有什么我能帮你做的。”","color":"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 1412 positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{"text":"默尔森：","color":"green","bold": true},{"bold": false,"text":"\n“这本生命手册……果然是奇匠派蒙的手笔。你很幸运，我和他很熟。”","color":"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 1426 positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{"text":"默尔森：","color":"green","bold": true},{"bold": false,"text":"\n“稍等，我将对魔力网络的系统施行侵入……”","color":"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 1456 positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{"text":"默尔森：","color":"green","bold": true},{"bold": false,"text":"\n“……完成了。希望能帮上你的忙。”","color":"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 1469 positioned -79923 43 96 run tellraw @a[tag=azrShowDialog] [{"text":"默尔森：","color":"green","bold": true},{"bold": false,"text":"\n“衷心祝你一路顺风。之后再见。”","color":"white"}]
