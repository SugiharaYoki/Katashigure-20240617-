...
execute positioned -80003 7 68 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=5}] run tellraw @a[tag=azrShowDialog] [{"text":"深邃中传来的声音：","color":"#935dff","bold": true},{"bold": false,"text":"\n“你终于来了，我一直都在等你。”","color":"white"}]
execute positioned -80003 7 68 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=25}] run tellraw @a[tag=azrShowDialog] [{"text":"深邃中传来的声音：","color":"#935dff","bold": true},{"bold": false,"text":"\n“我感知到了你灵魂的行动。放心吧，你已经受到了我的庇护。”","color":"white"}]
execute positioned -80003 7 68 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=69}] run tellraw @a[tag=azrShowDialog] [{"text":"深邃中传来的声音：","color":"#935dff","bold": true},{"bold": false,"text":"\n“你手中的命星可以将你的‘时间’倒退回死亡前的瞬间。”","color":"white"}]
execute positioned -80003 7 68 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=89}] run tellraw @a[tag=azrShowDialog] [{"text":"深邃中传来的声音：","color":"#935dff","bold": true},{"bold": false,"text":"\n“这是堪比起死回生的力量。你不需要害怕，因为这也是我曾走过的道路。”","color":"white"}]
...
execute positioned -80003 7 68 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=101}] as @a[tag=AZR_SEAawakening] at @s run particle totem_of_undying -79931 39 25 0.4 0.8 0.4 0.7 100
execute positioned -80003 7 68 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=101}] as @a[tag=AZR_SEAawakening] at @s run particle minecraft:flash -79931 39 25 0.4 0.7 0.4 0.3 2
