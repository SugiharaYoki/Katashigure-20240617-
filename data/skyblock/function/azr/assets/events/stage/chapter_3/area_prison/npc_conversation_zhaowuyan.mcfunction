...
execute if score @s AzrielNPC_ConversationTimer matches 42..43 if items entity @p container.* *[custom_data={azr_lever:1b}] run scoreboard players set @s AzrielNPC_ConversationTimer 44
...
execute if score @s AzrielNPC_ConversationTimer matches 44 run clear @p *[custom_data={azr_lever:1b}] 1
