...
execute as @s[scores={rng1=2}] if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run tellraw @a[tag=azrShowDialog] [{text:"第5巡逻小队队长 伊安：",color:"green",bold:1b},{bold: false,text:"\n“还没有查清楚结界为什么会张开吗？”",color:"white"}]
...
execute as @s[scores={rng1=43}] if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run tellraw @a[tag=azrShowDialog] [{text:"第5巡逻小队队长 伊安：",color:"green",bold:1b},{bold: false,text:"\n“所有人做好准备，有一个相当不妙的东西从牢房方向过来了。”",color:"white"}]
...
execute as @s[scores={rng1=52}] if entity @n[tag=AzrielNPC_stage9_entry_conversation6] run tellraw @a[tag=azrShowDialog] [{text:"弩手 麦克：",color:"green",bold:1b},{bold: false,text:"\n“啊啊、怎么办才好！？我们怎么可能是恣眼的对手……！！”",color:"white"}]
...
execute as @s[scores={rng1=70}] if entity @n[tag=AzrielNPC_stage9_entry_conversation6] if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run tellraw @a[tag=azrShowDialog] [{text:"第5巡逻小队队长 伊安：",color:"green",bold:1b},{bold: false,text:"\n“冷静，我们如果失败了，生命树就会受到威胁！无论如何都不能死在这里！”",color:"white"}]
...
execute as @s[scores={rng1=116}] if entity @n[tag=AzrielNPC_stage9_entry_conversation6] if entity @n[tag=AzrielNPC_stage9_entry_conversation7] if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run tellraw @a[tag=azrShowDialog] [{text:"第5巡逻小队队长 伊安：",color:"green",bold:1b},{bold: false,text:"\n“谢谢你，人类的亡魂，你救下了我重要的队员。为什么要帮助我们？”",color:"white"}]
execute as @s[scores={rng1=116}] unless entity @n[tag=AzrielNPC_stage9_entry_conversation6] if entity @n[tag=AzrielNPC_stage9_entry_conversation7] if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run tellraw @a[tag=azrShowDialog] [{text:"第5巡逻小队队长 伊安：",color:"green",bold:1b},{bold: false,text:"\n“谢谢你，人类的亡魂。为什么要帮助我们？”",color:"white"}]
execute as @s[scores={rng1=116}] if entity @n[tag=AzrielNPC_stage9_entry_conversation6] unless entity @n[tag=AzrielNPC_stage9_entry_conversation7] if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run tellraw @a[tag=azrShowDialog] [{text:"第5巡逻小队队长 伊安：",color:"green",bold:1b},{bold: false,text:"\n“谢谢你，人类的亡魂。为什么要帮助我们？”",color:"white"}]
execute as @s[scores={rng1=116}] unless entity @n[tag=AzrielNPC_stage9_entry_conversation6] unless entity @n[tag=AzrielNPC_stage9_entry_conversation7] if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run tellraw @a[tag=azrShowDialog] [{text:"第5巡逻小队队长 伊安：",color:"green",bold:1b},{bold: false,text:"\n“谢谢你……人类的亡魂。为什么会打算帮我们？”",color:"white"}]
execute as @s[scores={rng1=132}] positioned -79931 38 -37 if entity @n[tag=AzrielNPC_stage9_entry_conversation5] if entity @n[tag=AzrielNPC_stage9_entry_conversation6] run tellraw @a[tag=azrShowDialog] [{text:"你：",color:"aqua",bold:1b},{bold: false,text:"\n“顺手罢了。你们要是全死了，我还得单挑那个眼睛怪。”",color:"white"}]
execute as @s[scores={rng1=132}] positioned -79931 38 -37 if entity @n[tag=AzrielNPC_stage9_entry_conversation5] unless entity @n[tag=AzrielNPC_stage9_entry_conversation6] run tellraw @a[tag=azrShowDialog] [{text:"你：",color:"aqua",bold:1b},{bold: false,text:"\n“顺手罢了。你要是死了，我还得单挑那个眼睛怪。”",color:"white"}]
...
execute as @s[scores={rng1=148}] if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run tellraw @a[tag=azrShowDialog] [{text:"第5巡逻小队队长 伊安：",color:"green",bold:1b},{bold: false,text:"\n“那东西只是一个分身。接下来你还会见到一堆这样的怪物。”",color:"white"}]
...
execute as @s[scores={rng1=163}] if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run tellraw @a[tag=azrShowDialog] [{text:"第5巡逻小队队长 伊安：",color:"green",bold:1b},{bold: false,text:"\n“如果它的本体出现了……记得找到其他的神界军，让他们和你一起战斗。”",color:"white"}]
...
execute as @s[scores={rng1=183}] if entity @n[tag=AzrielNPC_stage9_entry_conversation6] run tellraw @a[tag=azrShowDialog,distance=..20] [{text:"弩手 麦克：",color:"green",bold:1b},{bold: false,text:"\n“我们该寻找大部队了……唉。”",color:"white"}]
...
execute as @s[scores={rng1=203}] if entity @n[tag=AzrielNPC_stage9_entry_conversation6] if entity @n[tag=AzrielNPC_stage9_entry_conversation7] run tellraw @a[tag=azrShowDialog,distance=..20] [{text:"剑士 派恩：",color:"green",bold:1b},{bold: false,text:"\n“多亏那个人类出手相助，否则我们损失可要很惨重。他叫什么名字？”",color:"white"}]
...
execute as @s[scores={rng1=220}] if entity @n[tag=AzrielNPC_stage9_entry_conversation7] if entity @n[tag=AzrielNPC_stage9_entry_conversation6] run tellraw @a[tag=azrShowDialog,distance=..20] [{text:"弩手 麦克：",color:"green",bold:1b},{bold: false,text:"\n“好像是叫……爱理莎？这么说来，倒过来读很像是沙利叶大人的名字。”",color:"white"}]
