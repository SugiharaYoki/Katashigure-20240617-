...
execute as @s[scores={rng1=273}] positioned -79894 32 -174 unless entity @n[tag=AzrielMarker_encounter,distance=..2,type=marker] positioned -79867 49 -128 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=60..}] at @n[tag=AzrielBossVillain] run tellraw @a[tag=azrShowDialog,distance=0..20] [{text:"晦怨贤士：",color:"yellow",bold:1b},{text:"\n“啥乱七八糟的，被我打得有感而发了？”",color:"white",bold: false}]
execute as @s[scores={rng1=284}] positioned -79894 32 -174 unless entity @n[tag=AzrielMarker_encounter,distance=..2,type=marker] positioned -79867 49 -128 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=60..}] at @n[tag=AzrielBossVillain] run tellraw @a[tag=azrShowDialog,distance=0..20] [{text:"晦怨贤士：",color:"yellow",bold:1b},{text:"\n“妈的，你战斗的时候不要被情绪影响！感情这玩意根本就是留给生者的小礼物，亡者只配归于尘土。操他妈的魔界。”",color:"white",bold: false}]
