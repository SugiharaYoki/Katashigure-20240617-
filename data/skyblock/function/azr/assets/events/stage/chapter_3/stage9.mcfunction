...
execute if score stage_main_thread AzrTimerStack matches 1 run bossbar set azr:progress_bar_normal max 340
execute if score stage_main_thread AzrTimerStack matches 1..340 store result bossbar azr:progress_bar_normal value run scoreboard players get stage_main_thread AzrTimerStack
...
execute if score stage_main_thread AzrTimerStack matches 27 as @p[tag=azrPlayer] at @s run title @a[tag=azrShowDialog] subtitle [{text:"创生万灵而恃才傲物",color:"dark_red",bold:1b}]



execute if score stage_main_thread AzrTimerStack matches 31 run stopsound @a[tag=azrShowDialog] ambient
execute if score stage_main_thread AzrTimerStack matches 31 as @p[tag=azrPlayer] at @s run title @a[tag=azrShowDialog] subtitle [{text:"",color:"dark_red",bold:1b}]
execute if score stage_main_thread AzrTimerStack matches 33 as @p[tag=azrPlayer] at @s run title @a[tag=azrShowDialog] subtitle [{text:"创生万灵而恃才傲物",color:"dark_red",bold:1b}]
execute if score stage_main_thread AzrTimerStack matches 34 as @p[tag=azrPlayer] at @s run title @a[tag=azrShowDialog] subtitle [{text:"",color:"dark_red",bold:1b}]
execute if score stage_main_thread AzrTimerStack matches 40 as @p[tag=azrPlayer] at @s run title @a[tag=azrShowDialog] subtitle [{text:"嗜戮万灵而恃才傲物",color:"dark_red",bold:1b}]
execute if score stage_main_thread AzrTimerStack matches 41 as @p[tag=azrPlayer] at @s run title @a[tag=azrShowDialog] subtitle [{text:"",color:"dark_red",bold:1b}]
execute if score stage_main_thread AzrTimerStack matches 41 as @p[tag=azrPlayer] at @s run title @a[tag=azrShowDialog] title [{text:"",color:"dark_red",bold:1b}]
...
execute if score stage_main_thread AzrTimerStack matches 219 positioned -79901 41 -50 run summon marker ~ ~ ~ {Tags:["AzrielMob_summon_delay_marker_undead3","AzrielMob_summon_delay","AzrielMob_level_1"]}
