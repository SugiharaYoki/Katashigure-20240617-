...
execute as @s[scores={rng1=114}] positioned -79839 13 -65 as @n[tag=AzrielBossWorking,type=zombie,distance=..20] run tellraw @a[tag=azrShowDialog] [{text:"金属学家：",color:"yellow",bold:1b},{bold: false,text:"\n“我是这里最后的矿工。最后的……保留了‘心’的矿工。”",color:"white"}]
execute as @s[scores={rng1=123}] positioned -79839 13 -65 as @n[tag=AzrielBossWorking,type=zombie,distance=..20] run tellraw @a[tag=azrShowDialog] [{text:"金属学家：",color:"yellow",bold:1b},{bold: false,text:"\n“战斗已经不再有意义。矿石也已经……彻底变质。”",color:"white"}]
...
execute if score @s rng1 matches 151..999 as @a[distance=0..5.5,tag=azrPlayer,tag=!azrPlayer_dialogchoice_revealed_303] run tellraw @s [{text:" - "},{text:"询问：你是谁？  ",color:"#ffe69b"},{text:"〈◆〉",bold:1b,color:"#ffcf3f",click_event:{"action":"run_command","command":"trigger Azr_Shop set 30301"}}]
execute if score @s rng1 matches 151..999 as @a[distance=0..5.5,tag=azrPlayer,tag=!azrPlayer_dialogchoice_revealed_303] run tellraw @s [{text:" - "},{text:"询问：这里是什么地方？  ",color:"#ffe69b"},{text:"〈◆〉",bold:1b,color:"#ffcf3f",click_event:{"action":"run_command","command":"trigger Azr_Shop set 30302"}}]
execute if score @s rng1 matches 151..999 as @a[distance=0..5.5,tag=azrPlayer,tag=!azrPlayer_dialogchoice_revealed_303] run tellraw @s [{text:" - "},{text:"询问：可是你应该已经成为怪物了？  ",color:"#ffe69b"},{text:"〈◆〉",bold:1b,color:"#ffcf3f",click_event:{"action":"run_command","command":"trigger Azr_Shop set 30303"}}]

execute if score @s rng1 matches 151..999 as @a[distance=0..5.5,tag=azrPlayer,tag=!azrPlayer_dialogchoice_revealed_303] run tag @s add azrPlayer_dialogchoice_revealed_303
execute if score @s rng1 matches 151..999 as @a[distance=5.6..,tag=azrPlayer,tag=azrPlayer_dialogchoice_revealed_303] run tag @s remove azrPlayer_dialogchoice_revealed_303
execute if score @s rng1 matches 151 run scoreboard players set @s rng1 149
...
execute as @s[scores={rng1=1015}] positioned -79839 13 -65 as @n[tag=AzrielBossWorking,type=zombie,distance=..20] run tellraw @a[tag=azrShowDialog] [{text:"金属学家：",color:"yellow",bold:1b},{bold: false,text:"\n“我叫什么……我不清楚。究竟是不是人类……我不清楚。”",color:"white"}]
execute if score @s rng1 matches 1025 run tag @a[tag=azrPlayer] remove azrPlayer_dialogchoice_revealed_303
execute if score @s rng1 matches 1025 run scoreboard players set @s rng1 149
...
execute as @s[scores={rng1=2013}] positioned -79839 13 -65 as @n[tag=AzrielBossWorking,type=zombie,distance=..20] run tellraw @a[tag=azrShowDialog] [{text:"金属学家：",color:"yellow",bold:1b},{bold: false,text:"\n“老板会惩罚我们。……后来，我们一直在这里，更努力工作。”",color:"white"}]
execute as @s[scores={rng1=2024}] positioned -79839 13 -65 as @n[tag=AzrielBossWorking,type=zombie,distance=..20] run tellraw @a[tag=azrShowDialog] [{text:"金属学家：",color:"yellow",bold:1b},{bold: false,text:"\n“不能再让矿被偷走了……我才一直留在这里，守护矿场……”",color:"white"}]
execute as @s[scores={rng1=2035}] positioned -79839 13 -65 as @n[tag=AzrielBossWorking,type=zombie,distance=..20] run tellraw @a[tag=azrShowDialog] [{text:"金属学家：",color:"yellow",bold:1b},{bold: false,text:"\n“但现在……已经没有意义了。已经不再是那些矿了。”",color:"white"}]
execute if score @s rng1 matches 2044 run tag @a[tag=azrPlayer] remove azrPlayer_dialogchoice_revealed_303
execute if score @s rng1 matches 2044 run scoreboard players set @s rng1 149
...
execute as @s[scores={rng1=3013}] positioned -79839 13 -65 as @n[tag=AzrielBossWorking,type=zombie,distance=..20] run tellraw @a[tag=azrShowDialog] [{text:"金属学家：",color:"yellow",bold:1b},{bold: false,text:"\n“我不知道我……为什么会保留交流能力。或许……这只是这具尸体，对我生前的拙劣模仿。”",color:"white"}]
execute as @s[scores={rng1=3025}] positioned -79839 13 -65 as @n[tag=AzrielBossWorking,type=zombie,distance=..20] run tellraw @a[tag=azrShowDialog] [{text:"金属学家：",color:"yellow",bold:1b},{bold: false,text:"\n“矿洞扩展时，我曾有机会……细致观察，生命树的根系。我将它们的……特性，写在了石板上。”",color:"white"}]
...
execute if score @s rng1 matches 3049 run tag @a[tag=azrPlayer] remove azrPlayer_dialogchoice_revealed_303
execute if score @s rng1 matches 3049 run scoreboard players set @s rng1 149
