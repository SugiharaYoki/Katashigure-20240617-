...
execute if score @s rng1 matches 33 run tellraw @a[tag=azrShowDialog,distance=..20] [{text:"工匠 罗德尼：",color:"green",bold:1b},{bold: false,text:"\n“我这儿确实有货，但我现在没心情。”",color:"white"}]
execute if score @s rng1 matches 44 run playsound entity.villager.ambient neutral @a ~ ~ ~ 1 1
execute if score @s rng1 matches 44 run tellraw @a[tag=azrShowDialog,distance=..20] [{text:"工匠 罗德尼：",color:"green",bold:1b},{bold: false,text:"\n“不过如果你想聊聊天，我倒也乐意。”",color:"white"}]
...
execute if score @s rng1 matches 3040 run tag @a[tag=azrPlayer] add azrPlayer_dialogchoice_unlocked_30105
