...
execute if score stage_main_thread AzrTimerStack matches 3070 unless entity @a[tag=azrPlayer,scores={Azr_skillPoints=..12}] run tellraw @a[tag=azrPlayer] {text:"〈跳过剧情〉",bold:true,color:"blue",click_event:{"action":"run_command","command":"trigger Azr_Shop set 6"}}
