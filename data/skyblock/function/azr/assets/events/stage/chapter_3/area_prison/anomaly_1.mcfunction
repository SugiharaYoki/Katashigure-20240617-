...
execute if score @s rng1 matches 56 as @a[distance=..200,tag=azrShowDialog] at @s run tellraw @s [{text:"陌生的语调：",color:"aqua",bold:1b},{text:"\n“稍等，妈妈。让我再读完这一页。”",color:"white",bold: false}]
...
execute if score @s rng1 matches 74 as @a[distance=..200,tag=azrShowDialog] at @s run tellraw @s [{text:"陌生的语调：",color:"aqua",bold:1b},{text:"\n“我自己去拿。”",color:"white",bold: false}]
...
execute if score @s rng1 matches 90 as @a[distance=..200,tag=azrShowDialog] at @s run tellraw @s [{text:"陌生的语调：",color:"aqua",bold:1b},{text:"\n“最该害怕的不是黑暗，而是黑暗里面什么都没有。”",color:"white",bold: false}]
