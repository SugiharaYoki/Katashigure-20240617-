...
execute if score stage_main_thread AzrTimerStack matches 1 run bossbar add azr:progress_bar_normal "Stage 10"
execute if score stage_main_thread AzrTimerStack matches 1 run bossbar set azr:progress_bar_normal color yellow
...
execute if score stage_main_thread AzrTimerStack matches 1 run scoreboard players set 200 constant 200
execute if score stage_main_thread AzrTimerStack matches 1 run scoreboard players set stage_main_thread AzrielMobLevel 0
execute if score stage_main_thread AzrTimerStack matches 1..340 store result bossbar azr:progress_bar_normal value run scoreboard players operation 200 constant -= stage_main_thread AzrielMobLevel
