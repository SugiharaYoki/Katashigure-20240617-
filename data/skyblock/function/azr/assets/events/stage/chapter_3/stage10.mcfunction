...
execute if score stage_main_thread AzrTimerStack matches 125 positioned -79915 40 -111 as @n[tag=AzrielNPC_stage9_entry_conversation5,distance=..10] as @e[distance=..15,tag=AzrielNPC_Divineforce] run tp @s ~ ~ ~
