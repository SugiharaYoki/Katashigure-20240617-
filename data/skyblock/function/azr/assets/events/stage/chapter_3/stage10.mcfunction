...
execute if score stage_main_thread AzrTimerStack matches 58..59 positioned -79924 40 -110 at @n[tag=AzrielMob_summon_delay_marker_stage10_1,distance=..20,type=marker] run summon marker ~ ~ ~ {Tags:["AzrielMob_summon_delay_marker_shield","AzrielMob_summon_delay","AzrielMob_level_1"]}
...
execute if score stage_main_thread AzrTimerStack matches 120 positioned -79915 40 -111 if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run summon marker ~ ~ ~ {Tags:["AzrielMob_summon_delay_marker_empty_human","AzrielMob_summon_delay","AzrielMob_level_1"]}
execute if score stage_main_thread AzrTimerStack matches 125 positioned -79915 40 -111 if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run function skyblock:azr/assets/mobs/pillager_friendly
execute if score stage_main_thread AzrTimerStack matches 125 positioned -79915 40 -111 if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run function skyblock:azr/assets/mobs/sword_friendly
execute if score stage_main_thread AzrTimerStack matches 125 positioned -79915 40 -111 if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run function skyblock:azr/assets/mobs/healer_friendly
execute if score stage_main_thread AzrTimerStack matches 125 positioned -79915 40 -111 as @n[tag=AzrielNPC_stage9_entry_conversation5,distance=..300] as @e[distance=..15,tag=AzrielNPC_Divineforce] run tp @s ~ ~ ~
execute if score stage_main_thread AzrTimerStack matches 128 positioned -79915 40 -111 if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run tellraw @a[tag=azrShowDialog] [{text:"第5巡逻小队队长 伊安：",color:"green",bold:1b},{bold: false,text:"\n“大伙们，上！！”",color:"white"}]
execute if score stage_main_thread AzrTimerStack matches 148 positioned -79915 40 -111 if entity @n[tag=AzrielNPC_stage9_entry_conversation5] run tellraw @a[tag=azrShowDialog] [{text:"第5巡逻小队队长 伊安：",color:"green",bold:1b},{bold: false,text:"\n“爱理莎小姐，我们这里已经受命扫荡牢房一楼。我们要再次并肩作战了。”",color:"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 228 positioned -79915 40 -111 if entity @n[tag=AzrielNPC_stage9_entry_conversation6] run tellraw @a[tag=azrShowDialog] [{text:"弩手 麦克：",color:"green",bold:1b},{bold: false,text:"\n“我有点招架不住了……！我们只有这么点人吗？！”",color:"white"}]
...
execute if score stage_main_thread AzrTimerStack matches 160..161 positioned -79924 40 -110 at @n[tag=AzrielMob_summon_delay_marker_stage10_1,distance=..20,type=marker] run summon marker ~ ~ ~ {Tags:["AzrielMob_summon_delay_marker_shield","AzrielMob_summon_delay","AzrielMob_level_1"]}
...
execute if score stage_main_thread AzrTimerStack matches 200..202 positioned -79924 40 -110 at @n[tag=AzrielMob_summon_delay_marker_stage10_1,distance=..20,type=marker] run summon marker ~ ~ ~ {Tags:["AzrielMob_summon_delay_marker_shield","AzrielMob_summon_delay","AzrielMob_level_1"]}
