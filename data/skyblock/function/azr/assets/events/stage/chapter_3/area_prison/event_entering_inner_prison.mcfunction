...
execute if score @s rng1 matches 142 as @a[distance=..200,tag=azrShowDialog] at @s run playsound minecraft:entity.evoker.ambient neutral @s ~ ~ ~ 1 0.7
execute if score @s rng1 matches 142 as @a[distance=..200,tag=azrShowDialog] at @s run tellraw @s [{text:"诡谲之低语：",color:"yellow",bold:1b},{text:"\n“枯干的骸骨啊，行走的死尸啊，忠诚的仆从啊，尔等皆要听沙利叶的话。”",color:"white",bold: false}]
execute if score @s rng1 matches 155 as @a[distance=..200,tag=azrShowDialog] at @s run tellraw @s [{text:"诡谲之低语：",color:"yellow",bold:1b},{text:"\n“我必使生灵的魔力进入尔等躯体，你们即将重生。”",color:"white",bold: false}]
execute if score @s rng1 matches 169 as @a[distance=..200,tag=azrShowDialog] at @s run tellraw @s [{text:"诡谲之低语：",color:"yellow",bold:1b},{text:"\n“我必治好你们的筋，使你们长肉，又用皮遮蔽你们。”",color:"white",bold: false}]
execute if score @s rng1 matches 176 as @a[distance=..200,tag=azrShowDialog] at @s run tellraw @s [{text:"诡谲之低语：",color:"yellow",bold:1b},{text:"\n“生灵的气息啊，要从四方而来，吹在这些被杀的人身上。”",color:"white",bold: false}]
execute if score @s rng1 matches 185 as @a[distance=..200,tag=azrShowDialog] at @s run tellraw @s [{text:"诡谲之低语：",color:"yellow",bold:1b},{text:"\n“那女人已经与我们相似，能知道善恶；现在恐怕她伸手又摘生命树的果子吃，就永远活着。”",color:"white",bold: false}]
execute if score @s rng1 matches 193 as @a[distance=..200,tag=azrShowDialog] at @s run tellraw @s [{text:"诡谲之低语：",color:"yellow",bold:1b},{text:"\n“沙利叶的神使驻守神庭的东西两庭，要把守生命树的道路。”",color:"white",bold: false}]
execute if score @s rng1 matches 202 as @a[distance=..200,tag=azrShowDialog] at @s run tellraw @s [{text:"诡谲之低语：",color:"yellow",bold:1b},{text:"\n“众人侍立在沙利叶面前，路西法也来在其中。”",color:"white",bold: false}]
execute if score @s rng1 matches 217 as @a[distance=..200,tag=azrShowDialog] at @s run tellraw @s [{text:"诡谲之低语：",color:"red",bold:1b},{text:"\n“我于这神界往返而来；我见到人类亡魂的战斗。”",color:"white",bold: false}]
execute if score @s rng1 matches 224 as @a[distance=..200,tag=azrShowDialog] at @s run tellraw @s [{text:"诡谲之低语：",color:"red",bold:1b},{text:"\n“沙利叶，她在你手中，只要存留她的性命。”",color:"white",bold: false}]
execute if score @s rng1 matches 235 as @a[distance=..200,tag=azrShowDialog] at @s run tellraw @s [{text:"诡谲之低语：",color:"red",bold:1b},{text:"\n“路西法也站在你的右侧，与她作对。”",color:"white",bold: false}]
execute if score @s rng1 matches 241 as @a[distance=..200,tag=azrShowDialog] at @s run tellraw @s [{text:"诡谲之低语：",color:"red",bold:1b},{text:"\n“她愿为自己而活，但她走向了错误的路。她将一错再错。”",color:"white",bold: false}]
execute if score @s rng1 matches 253 as @a[distance=..200,tag=azrShowDialog] at @s run tellraw @s [{text:"诡谲之低语：",color:"red",bold:1b},{text:"\n“人类的王欢，尔岂非从火中抽出来的一根柴吗？”",color:"white",bold: false}]
execute if score @s rng1 matches 262 as @a[distance=..200,tag=azrShowDialog] at @s run tellraw @s [{text:"诡谲之低语：",color:"red",bold:1b},{text:"\n“照亮着黑暗却燃烧着自己的未来，希望不是从这之中诞生的。”",color:"white",bold: false}]
execute if score @s rng1 matches 275 as @a[distance=..200,tag=azrShowDialog] at @s run tellraw @s [{text:"权之殊能：",color:"red",bold:1b},{text:"\n“生者必灭，亡者何时将复活？”",color:"white",bold: false}]
execute if score @s rng1 matches 281 as @a[distance=..200,tag=azrShowDialog] at @s run tellraw @s [{text:"权之殊能：",color:"red",bold:1b},{text:"\n“亡者的复活意味着其将成为生者，它也将迎来灭亡，或早或晚，结局再度归初。”",color:"white",bold: false}]
execute if score @s rng1 matches 293 as @a[distance=..200,tag=azrShowDialog] at @s run tellraw @s [{text:"权之殊能：",color:"red",bold:1b},{text:"\n“世间万物流转循环的规律如此，我们打破了它，我们竟试图打破它，这是无可理喻、无可饶恕的。”",color:"white",bold: false}]
execute if score @s rng1 matches 302 as @a[distance=..200,tag=azrShowDialog] at @s run tellraw @s [{text:"权之殊能：",color:"red",bold:1b},{text:"\n“沙利叶啊，神的怒火终将降在我们的头上，因我等早已渎神，这一切都是我们招致的后果。”",color:"white",bold: false}]
execute if score @s rng1 matches 313 as @a[distance=..200,tag=azrShowDialog] at @s run tellraw @s [{text:"权之殊能：",color:"red",bold:1b},{text:"\n“生命树面领的不会是地狱的烈火——它本就枯竭，我等的未来是那被燃尽的柴火，所以这为的是让最后的柴不被燃尽，我需将其熄灭。”",color:"white",bold: false}]
