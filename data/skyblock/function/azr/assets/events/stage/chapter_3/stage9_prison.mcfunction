...
execute positioned -79925 40 -112 as @n[tag=AzrielMob_ch3_resting_swordman,distance=0..9.5] at @s unless score @s rng1 matches 2.. if entity @a[tag=azrPlayer,distance=0..7] run scoreboard players add @s rng1 1
