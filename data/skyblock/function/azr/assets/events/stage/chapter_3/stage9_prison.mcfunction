...
execute positioned -79886 40 -114 as @n[tag=AzrielMarker_encounter,distance=0..0.5] unless score @s rng1 matches ..19 if block -79886 41 -114 lever[powered=true] run scoreboard players set @s rng1 31
execute positioned -79886 40 -114 as @n[tag=AzrielMarker_encounter,distance=0..0.5] unless score @s rng1 matches ..19 if block -79894 41 -123 lever[powered=true] run scoreboard players set @s rng1 31
...
execute positioned -79886 40 -114 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=32}] run fill -79892 40 -119 -79889 40 -119 iron_bars
...
execute positioned -79886 40 -114 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=34}] run fill -79892 41 -119 -79889 41 -119 iron_bars
...
execute positioned -79886 40 -114 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=36}] run fill -79892 42 -119 -79889 42 -119 iron_bars
...
execute positioned -79886 40 -114 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=38}] run fill -79892 43 -119 -79889 43 -119 iron_bars
