...
execute positioned -79811 12 -48 as @n[tag=AzrielBossWorking_StartActing,distance=0..30,scores={rng12=25..}] at @s run function skyblock:azr/assets/mobs/skill/boss_working/core
