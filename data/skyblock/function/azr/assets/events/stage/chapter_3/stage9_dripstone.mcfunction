...
execute positioned -79857.99 40.00 -94.59 as @n[tag=AzrielTrader_dripstone_smith,distance=0..20.5] at @s if entity @a[tag=azrPlayer,distance=..4] run function skyblock:azr/assets/events/chapter_3/npc_dripstone_smith_rodney
