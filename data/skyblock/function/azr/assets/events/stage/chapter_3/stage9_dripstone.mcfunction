...
execute positioned -79870 28 -67 unless entity @n[tag=AzrielMob_trap_spike,distance=..0.5] if score random_enemy_thread AzrTimerStack matches 2 if entity @a[tag=azrPlayer,distance=..64] unless entity @a[tag=azrPlayer,distance=..32] store result score random_enemy_thread rng5 run random value 1..5
