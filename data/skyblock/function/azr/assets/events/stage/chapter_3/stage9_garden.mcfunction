...
execute positioned -79890 38 4 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=35}] run tellraw @a[tag=azrShowDialog] [{text:"你：",color:"aqua","bold": true},{"bold": false,text:"\n“我问一下，这个采光礼堂还有什么我值得探索的地方吗？”",color:"white"}]
...
execute positioned -79892 42 -50 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=6}] if entity @n[tag=AzrielNPC_stage9_entry_conversation4] run tellraw @a[tag=azrShowDialog] [{text:"受伤的弩手：",color:"green","bold": true},{"bold": false,text:"\n“小心激光！恣眼的影子来了！”",color:"white"}]
