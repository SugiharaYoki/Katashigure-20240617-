...
execute positioned -79892 42 -50 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=5..}] as @n[tag=AzrielNPC_stage9_entry_conversation4] at @s run rotate @s facing entity @p[tag=azrPlayer]
