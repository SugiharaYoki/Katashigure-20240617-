...
execute if score @s rng1 matches 395 as @a[x=-79850,y=-18,z=-163,dx=5,dy=5,dz=5,tag=azrPlayer] at @s run tp @s ~ ~ ~-6 facing ~1 ~ ~-6
...
execute if score @s rng1 matches 595 as @a[x=-79850,y=-18,z=-202,dx=5,dy=5,dz=5,tag=azrPlayer] at @s run tp @s ~ ~ ~-6 facing ~1 ~ ~-6
