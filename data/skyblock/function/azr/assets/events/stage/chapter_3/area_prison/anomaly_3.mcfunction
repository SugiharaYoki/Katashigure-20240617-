...
execute if score @s rng1 matches 657 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"怀念的女声：",color:"green",bold:1b},{text:"\n“我们在说话的时候不要插嘴！！”",color:"white",bold: false}]
execute if score @s rng1 matches 667 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"牵记的男声：",color:"green",bold:1b},{text:"\n“这都是为了爱理莎的未来着想，如果我们接回女儿，爱理莎又该去哪里？谁来养她？”",color:"white",bold: false}]
execute if score @s rng1 matches 679 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"怀念的女声：",color:"green",bold:1b},{text:"\n“老公，这女孩子根本就不是我们的爱理莎！！你还记得吗，当时我怀孕，你说要接我回家，娶我为妻。”",color:"white",bold: false}]
execute if score @s rng1 matches 691 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"怀念的女声：",color:"green",bold:1b},{text:"\n“我们把爱理莎视为我们爱情的象征，是有了爱理莎我们才能走到一起……结果，老天告诉我，这个女孩并不是我们亲生女儿，我们的女儿在孤儿院待了十年？！”",color:"white",bold: false}]
execute if score @s rng1 matches 706 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"怀念的女声：",color:"green",bold:1b},{text:"\n“那是我们的亲骨肉，她被抱错了，她的父母早亡，我们爱情的象征？她这么可怜地在外流离失所十年？是在开玩笑吗？！”",color:"white",bold: false}]
execute if score @s rng1 matches 718 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"牵记的男声：",color:"green",bold:1b},{text:"\n“我懂你意思……既然找到了爱理莎，那就接她回家吧。”",color:"white",bold: false}]
execute if score @s rng1 matches 730 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"牵记的男声：",color:"green",bold:1b},{text:"\n“那，这个女孩怎么办？”",color:"white",bold: false}]
execute if score @s rng1 matches 742 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"怀念的女声：",color:"green",bold:1b},{text:"\n“……”",color:"white",bold: false}]
execute if score @s rng1 matches 749 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"怀念的女声：",color:"green",bold:1b},{text:"\n“我们养到她成人。然后，让她自己打拼。”",color:"white",bold: false}]
execute if score @s rng1 matches 761 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"怀念的女声：",color:"green",bold:1b},{text:"\n“我们没有经济条件抚养两个女儿，你清楚这一点。我们全部积蓄都用来给爱理莎攒大学学费，两个？我们会家破人亡的。”",color:"white",bold: false}]
execute if score @s rng1 matches 773 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"牵记的男声：",color:"green",bold:1b},{text:"\n“……那就，照顾到成人。她的大学怎么办？”",color:"white",bold: false}]
...
execute if score @s rng1 matches 819 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"怀念的女声：",color:"green",bold:1b},{text:"\n“之前叫她莉茜，以后也这么叫。随我们姓，仅此就足够了。”",color:"white",bold: false}]
execute if score @s rng1 matches 829 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"——",color:"gray",bold:1b}]

execute if score @s rng1 matches 840 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"沉稳的嗓音：",color:"red",bold:1b},{text:"\n“估计是医院里抱错了，而且好像是找到了原先的孩子。这样下来，莉茜肯定就不被喜欢了。”",color:"white",bold: false}]
execute if score @s rng1 matches 855 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"沉稳的嗓音：",color:"red",bold:1b},{text:"\n“而且……据说他们家的经济条件本身就不好，她养父母是不顾家里的反对私奔出来的。所以他们将孩子的意义看得很特殊。”",color:"white",bold: false}]
execute if score @s rng1 matches 870 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"柔和的话语：",color:"red",bold:1b},{text:"\n“这明明都不管孩子的事情。我真的很想帮助爱理莎，但是她们家……已经断交一个月的学费了。我们实在是不该做职责之外的工作，说不定还会被爱理莎的父母告上法庭。”",color:"white",bold: false}]
...
execute if score @s rng1 matches 930 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"挑衅的语气：",color:"red",bold:1b},{text:"\n“我看你被我欺负的时候挺听话的，我都快爱上你了。莉茜，我看你未来要不要做我的老婆啊？这样你就可以一辈子都被我这样对待了。”",color:"white",bold: false}]
execute if score @s rng1 matches 945 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"挑衅的语气：",color:"red",bold:1b},{text:"\n“反正我们已经做过男女之间能做的所有事情，有什么关系？……为什么要用这种放肆的眼神看我，你活腻了吗？你今天别想完好无缺地回家。”",color:"white",bold: false}]
execute if score @s rng1 matches 955 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"——",color:"gray",bold:1b}]
execute if score @s rng1 matches 1000 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"沉稳的嗓音：",color:"red",bold:1b},{text:"\n“话虽如此，莉茜，他和你一样只有初一。不要穷追不舍了，给大家一个犯错的机会……”",color:"white",bold: false}]
execute if score @s rng1 matches 1015 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"沉稳的嗓音：",color:"red",bold:1b},{text:"\n“我知道你是想报之前他们霸凌你的仇，现在还不是时候。莉茜，你现在需要的是尽可能考上一个好大学，争取到奖学金。”",color:"white",bold: false}]
execute if score @s rng1 matches 1030 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"沉稳的嗓音：",color:"red",bold:1b},{text:"\n“你的家庭条件并不好，老师也没法一直护着你。要在必要的时候选择忍气吞声，好吗？”",color:"white",bold: false}]
execute if score @s rng1 matches 1045 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"沉稳的嗓音：",color:"red",bold:1b},{text:"\n“老师也很为难。但他们更有可能考到顶尖大学，老师为了学校升学率，不得不这么做……这都是以大局为重。”",color:"white",bold: false}]
execute if score @s rng1 matches 1060 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"——",color:"gray",bold:1b}]
execute if score @s rng1 matches 1110 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"救赎的话语：",color:"green",bold:1b},{text:"\n“所以……莉茜，你希望我叫你什么名字？”",color:"white",bold: false}]
...
execute if score @s rng1 matches 1158 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"救赎的话语：",color:"green",bold:1b},{text:"\n“我明白了，……爱理莎。”",color:"white",bold: false}]
...
execute if score @s rng1 matches 1180 as @a[distance=..2000,tag=azrShowDialog] at @s run tellraw @s [{text:"救赎的话语：",color:"green",bold:1b},{text:"\n“感到难过的话……在我面前哭出来，也是没有任何关系的，爱理莎。”",color:"white",bold: false}]
