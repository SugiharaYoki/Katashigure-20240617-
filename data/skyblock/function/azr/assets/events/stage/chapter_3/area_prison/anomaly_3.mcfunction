...
execute if score @s rng1 matches 391 as @a[tag=azrShowDialog,distance=..2000] at @s run effect give @s slowness 5 255 true
...
execute if score @s rng1 matches 591 as @a[tag=azrShowDialog,distance=..2000] at @s run effect give @s slowness 5 255 true
execute if score @s rng1 matches 591 as @a[tag=azrShowDialog,distance=..2000] at @s run effect give @s darkness 5 0 true
execute if score @s rng1 matches 595 as @a[x=-79850,y=-18,z=-202,dx=8,dy=5,dz=5,tag=azrPlayer] at @s run tp @s ~ ~ ~-6 facing ~1 ~ ~-6
