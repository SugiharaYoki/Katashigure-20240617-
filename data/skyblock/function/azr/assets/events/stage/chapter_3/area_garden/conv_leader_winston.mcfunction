...
execute if score @s rng1 matches 1014 run playsound minecraft:entity.vindicator.ambient hostile @a[tag=azrShowDialog] ~ ~ ~ 1 0.9
execute if score @s rng1 matches 1014 run tellraw @a[tag=azrShowDialog] [{text:"第2巡逻小队队长 温斯顿：",color:"green",bold:1b},{bold: false,text:"\n“1、2、3小队负责的都是关口要道的安防。通过这个大礼堂，即可前往生命树所在的中庭花园。”",color:"white"}]
execute if score @s rng1 matches 1026 run playsound minecraft:entity.vindicator.ambient hostile @a[tag=azrShowDialog] ~ ~ ~ 1 0.9
execute if score @s rng1 matches 1026 run tellraw @a[tag=azrShowDialog] [{text:"第2巡逻小队队长 温斯顿：",color:"green",bold:1b},{bold: false,text:"\n“只不过目前那里无法通行，毕竟神庭现在遇到了紧急情况。”",color:"white"}]
execute if score @s rng1 matches 1035 run tag @a[tag=azrPlayer] remove azrPlayer_dialogchoice_revealed_302
execute if score @s rng1 matches 1035 run scoreboard players set @s rng1 59
...
execute if score @s rng1 matches 2026 run playsound minecraft:entity.vindicator.ambient hostile @a[tag=azrShowDialog] ~ ~ ~ 1 0.9
execute if score @s rng1 matches 2026 run tellraw @a[tag=azrShowDialog] [{text:"第2巡逻小队队长 温斯顿：",color:"green",bold:1b},{bold: false,text:"\n“你猜的没错……但权之残影大人定有他的深意。”",color:"white"}]
execute if score @s rng1 matches 2038 run playsound minecraft:entity.vindicator.ambient hostile @a[tag=azrShowDialog] ~ ~ ~ 1 0.9
execute if score @s rng1 matches 2038 run tellraw @a[tag=azrShowDialog] [{text:"第2巡逻小队队长 温斯顿：",color:"green",bold:1b},{bold: false,text:"\n“虽然这里有我们巡逻，但如果魔界大军打过来了，恐怕也抵挡不了多久。”",color:"white"}]
execute if score @s rng1 matches 2050 run playsound minecraft:entity.vindicator.ambient hostile @a[tag=azrShowDialog] ~ ~ ~ 1 0.9
execute if score @s rng1 matches 2050 run tellraw @a[tag=azrShowDialog] [{text:"第2巡逻小队队长 温斯顿：",color:"green",bold:1b},{bold: false,text:"\n“牢房区域就在西庭入口的北面。从建筑物外重新进来，你先前右转了——这次得改成左转。”",color:"white"}]
execute if score @s rng1 matches 2060 run tag @a[tag=azrPlayer] remove azrPlayer_dialogchoice_revealed_302
execute if score @s rng1 matches 2060 run scoreboard players set @s rng1 59
...
execute if score @s rng1 matches 3014 run playsound minecraft:entity.vindicator.ambient hostile @a[tag=azrShowDialog] ~ ~ ~ 1 0.9
execute if score @s rng1 matches 3014 run tellraw @a[tag=azrShowDialog] [{text:"第2巡逻小队队长 温斯顿：",color:"green",bold:1b},{bold: false,text:"\n“我也不知道那是什么原理，但存在里面的东西似乎进入了什么‘别的地方’。”",color:"white"}]
execute if score @s rng1 matches 3026 run playsound minecraft:entity.vindicator.ambient hostile @a[tag=azrShowDialog] ~ ~ ~ 1 0.9
execute if score @s rng1 matches 3026 run tellraw @a[tag=azrShowDialog] [{text:"第2巡逻小队队长 温斯顿：",color:"green",bold:1b},{bold: false,text:"\n“不过那毕竟是米迦勒天使长的权能，我等普通天使无法理解其原理，似乎也情有可原。”",color:"white"}]
execute if score @s rng1 matches 3035 run tag @a[tag=azrPlayer] remove azrPlayer_dialogchoice_revealed_302
execute if score @s rng1 matches 3035 run scoreboard players set @s rng1 59
