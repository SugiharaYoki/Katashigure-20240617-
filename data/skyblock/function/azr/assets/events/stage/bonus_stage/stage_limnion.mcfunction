...
execute if score stage_bonus_thread AzrTimerStack matches 85 positioned -79725 170 -859 unless entity @n[tag=AzrielMob_piranha,distance=..12] run function skyblock:azr/assets/mobs/piranha3
execute if score stage_bonus_thread AzrTimerStack matches 95 positioned -79725 170 -859 unless entity @n[tag=AzrielMob_piranha,distance=..12] run function skyblock:azr/assets/mobs/piranha3
execute if score stage_bonus_thread AzrTimerStack matches 135 positioned -79725 170 -859 unless entity @n[tag=AzrielMob_piranha,distance=..12] run function skyblock:azr/assets/mobs/piranha3
execute if score stage_bonus_thread AzrTimerStack matches 145 positioned -79725 170 -859 unless entity @n[tag=AzrielMob_piranha,distance=..12] run function skyblock:azr/assets/mobs/piranha3
