...
execute if score stage_bonus_thread AzrTimerStack matches 300 as @a[tag=azrPlayer] at @s unless entity @s[tag=AZS_BoS02] run function skyblock:azr/assets/items/amulets/flower_spike
