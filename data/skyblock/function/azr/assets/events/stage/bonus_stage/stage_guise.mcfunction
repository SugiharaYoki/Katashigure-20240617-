...
execute if score stage_bonus_thread AzrTimerStack matches 203 as @a[tag=azrPlayer] at @s unless entity @s[tag=AZS_BoS07] run function skyblock:azr/assets/items/amulets/moss_grow
