...
execute if score stage_bonus_thread AzrTimerStack matches 204 as @a[tag=azrPlayer] at @s unless entity @s[tag=!AZS_BoS22] run function skyblock:azr/assets/items/amulets/down_kick
