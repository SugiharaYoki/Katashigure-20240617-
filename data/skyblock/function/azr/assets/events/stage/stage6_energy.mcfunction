...
execute positioned -79913 27 208 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=52}] positioned -79915 29 205 run scoreboard players set @s rng5 101
execute positioned -79913 27 208 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=52}] positioned -79915 29 205 if entity @n[type=item,distance=..1.5,nbt={Item:{id:"minecraft:resin_clump"}}] run scoreboard players set @s rng5 1
execute positioned -79913 27 208 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=52}] positioned -79915 29 205 if entity @n[type=item,distance=..1.5,nbt={Item:{id:"minecraft:ghast_tear"}}] run scoreboard players set @s rng5 100
execute positioned -79913 27 208 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=52}] positioned -79915 29 205 if entity @n[type=item,distance=..1.5,nbt={Item:{id:"minecraft:iron_ingot"}}] store result score @s rng5 run random value 1..100
execute positioned -79913 27 208 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=52}] positioned -79915 29 205 if entity @n[type=item,distance=..1.5,nbt={Item:{id:"minecraft:bone"}}] store result score @s rng5 run random value 1..100
...
execute positioned -79913 27 208 as @n[tag=AzrielMarker_encounter,distance=0..0.5,scores={rng1=80}] positioned -79915 29 206 if score @s rng5 matches 11..100 run particle minecraft:large_smoke ~ ~1 ~ 0.25 0.0 0.25 0.01 10
