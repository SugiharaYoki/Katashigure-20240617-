...
$execute as @s[scores={rng1=27}] positioned $(pos) as @a[tag=azrPlayer,tag=!AZS_SoulFrag$(id)] run title @s title {"text": "灵魂碎片已吸收","color": "#7321cb","bold": true}
$execute as @s[scores={rng1=36}] positioned $(pos) as @a[tag=azrPlayer,tag=!AZS_SoulFrag$(id)] run title @s times 0t 70t 12t
$execute as @s[scores={rng1=36}] positioned $(pos) as @a[tag=azrPlayer,tag=!AZS_SoulFrag$(id)] run title @s title {"text": "灵魂碎片已吸收","color": "#7321cb","bold": true}
$execute as @s[scores={rng1=36}] positioned $(pos) as @a[tag=azrPlayer,tag=!AZS_SoulFrag$(id)] run title @s subtitle [{"text": "现在的灵魂碎片总数：","color": "#7321cb","bold": true},{"score":{"name":"@s","objective":"AZS_SoulFrag"}}]
