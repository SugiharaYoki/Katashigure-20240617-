...
execute if score @s AzrEntityTimer matches 35 at @s run tp @s ~ ~ ~ ~90 ~
execute if score @s AzrEntityTimer matches 45 at @s run tp @s ~ ~ ~ ~90 ~
execute if score @s AzrEntityTimer matches 55 at @s run tp @s ~ ~ ~ ~90 ~
execute if score @s AzrEntityTimer matches 65 at @s run tp @s ~ ~ ~ ~90 ~
