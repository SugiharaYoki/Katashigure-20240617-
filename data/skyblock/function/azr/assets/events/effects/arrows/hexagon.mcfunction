...
execute rotated ~180 ~ run function skyblock:azr/assets/events/effects/arrows/summon_arrow
execute rotated ~240 ~ run function skyblock:azr/assets/events/effects/arrows/summon_arrow
execute rotated ~300 ~ run function skyblock:azr/assets/events/effects/arrows/summon_arrow