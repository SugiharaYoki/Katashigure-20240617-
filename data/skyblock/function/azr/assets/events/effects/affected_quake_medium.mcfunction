...
execute if score @s AzrEvent_affected_quake_medium matches 14 run playsound minecraft:entity.lightning_bolt.thunder ambient @s -78889 38 121 100 0.75
execute if score @s AzrEvent_affected_quake_medium matches 14 run playsound minecraft:entity.lightning_bolt.thunder ambient @s -78889 38 121 100 1
...
execute if score @s AzrEvent_affected_quake_medium matches 14 run playsound minecraft:entity.zombie_villager.cure ambient @s -78889 38 121 90 0.74
...
execute if score @s AzrEvent_affected_quake_medium matches 14 run playsound minecraft:entity.generic.explode ambient @s -78889 38 121 98 0.7
...
execute if score @s AzrEvent_affected_quake_medium matches 1 run tp @s ~ ~ ~
