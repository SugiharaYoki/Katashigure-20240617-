...
tellraw @s [{"text":"   - "},{"text":"对活物箭(Lv1) ×12","color":"white"},{"text":"  1 木棍 1 蜘蛛眼 ","color":"gold"},{"text":"〈◆〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8431513"},"hoverEvent":{"action":"show_text","contents":{"text":"相当于瞬间伤害箭矢","color":"white"}}}]
tellraw @s [{"text":"   - "},{"text":"对亡灵箭(Lv1) ×12","color":"white"},{"text":"  1 虫骸 1 硬骨 ","color":"gold"},{"text":"〈◆〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8431514"},"hoverEvent":{"action":"show_text","contents":{"text":"相当于瞬间治疗箭矢","color":"white"}}}]
tellraw @s [{"text":" - 回收作业","color":"gray"}]
tellraw @s [{"text":"   - "},{"text":"锁链","color":"white"},{"text":"  3 铁栅栏 ","color":"gold"},{"text":"〈◆〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8431515"}}]
tellraw @s[scores={Azr_Mt_0031=1..}] [{"text":"   - "},{"text":"被污染的信条","color":"white"},{"text":"  1 圣殿信条 ","color":"gold"},{"text":"〈◆〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8431516"}}]
