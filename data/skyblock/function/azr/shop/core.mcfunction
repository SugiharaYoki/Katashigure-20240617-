...
#商店入口
execute if items entity @s player.cursor *[custom_data~{LifeVitae:1b}] unless entity @s[tag=azrShopOnUse] run function skyblock:azr/shop/build
execute unless items entity @s player.cursor *[custom_data~{LifeVitae:1b}] run tag @s remove azrShopOnUse
execute if items entity @s player.cursor *[custom_data~{LifeVitae:1b}] if score @s Azr_Shop matches 20..40 run function skyblock:azr/shop/refresh
#trigger
