...
#print extra-shops
execute if score @s Azr_wave matches 1..5 if items entity @s container.* glistering_melon_slice run tellraw @s [{"text":"   "},{"text":"〈刷新商店〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 21"}},{"text":" | WAIVE： ","color":"gray"},{"score":{"name":"@s","objective":"melonCount"}},{"text":"/1 闪烁的西瓜","color":"gray"}]
execute if score @s Azr_wave matches 6..9 if items entity @s container.* glistering_melon_slice run tellraw @s [{"text":"   "},{"text":"〈刷新商店〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 21"}},{"text":" | WAIVE： ","color":"gray"},{"score":{"name":"@s","objective":"melonCount"}},{"text":"/1 闪烁的西瓜","color":"gray"}]
...
execute if score @s Azr_wave matches 1..5 unless items entity @s container.* glistering_melon_slice run tellraw @s [{"text":"   "},{"text":"〈刷新商店〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 21"}},{"text":"   花费 1 绿宝石   ","color":"gold"}]
execute if score @s Azr_wave matches 6..9 unless items entity @s container.* glistering_melon_slice run tellraw @s [{"text":"   "},{"text":"〈刷新商店〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 21"}},{"text":"   花费 3 绿宝石   ","color":"gold"}]
