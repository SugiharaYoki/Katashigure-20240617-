$execute if score @s Azr_Shop_rng$(rng) matches 0 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 0 if score @s Azr_Shop matches $(trigger)33 \
...
$execute if score @s Azr_Shop_rng$(rng) matches 1 if score @s Azr_Shop matches $(trigger) \
    if score @s Azr_emerald matches 1.. run tag @s add TEMP_purchase_success
$execute if score @s Azr_Shop_rng$(rng) matches 1 if score @s Azr_Shop matches $(trigger) \
    run give @s[tag=TEMP_purchase_success] bread 1
$execute if score @s Azr_Shop_rng$(rng) matches 1 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 1 if score @s Azr_Shop matches $(trigger)33 \
    if items entity @s container.* rotten_flesh[count={min:1}] run tag @s add TEMP_purchase_success
$execute if score @s Azr_Shop_rng$(rng) matches 1 if score @s Azr_Shop matches $(trigger)33 \
    run give @s[tag=TEMP_purchase_success] bread 2
$execute if score @s Azr_Shop_rng$(rng) matches 1 if score @s Azr_Shop matches $(trigger)33 \
...
$execute if score @s Azr_Shop_rng$(rng) matches 2 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 2 if score @s Azr_Shop matches $(trigger)33 \
...
$execute if score @s Azr_Shop_rng$(rng) matches 3 if score @s Azr_Shop matches $(trigger) \
    if score @s Azr_emerald matches 3.. run tag @s add TEMP_purchase_success
$execute if score @s Azr_Shop_rng$(rng) matches 3 if score @s Azr_Shop matches $(trigger) \
    run give @s[tag=TEMP_purchase_success] cooked_porkchop
$execute if score @s Azr_Shop_rng$(rng) matches 3 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 3 if score @s Azr_Shop matches $(trigger)33 \
    if score @s Azr_emerald matches 2.. run tag @s add TEMP_purchase_success
$execute if score @s Azr_Shop_rng$(rng) matches 3 if score @s Azr_Shop matches $(trigger)33 \
    run give @s[tag=TEMP_purchase_success] cooked_chicken
$execute if score @s Azr_Shop_rng$(rng) matches 3 if score @s Azr_Shop matches $(trigger)33 \
...
$execute if score @s Azr_Shop_rng$(rng) matches 4 if score @s Azr_Shop matches $(trigger) \
    if score @s Azr_emerald matches 2.. run tag @s add TEMP_purchase_success
$execute if score @s Azr_Shop_rng$(rng) matches 4 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 5 if score @s Azr_Shop matches $(trigger) \
    if score @s Azr_emerald matches 2.. run tag @s add TEMP_purchase_success
$execute if score @s Azr_Shop_rng$(rng) matches 5 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 6 if score @s Azr_Shop matches $(trigger) \
    if items entity @s container.* rotten_flesh[count={min:1}] run tag @s add TEMP_purchase_success
$execute if score @s Azr_Shop_rng$(rng) matches 6 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 9 if score @s Azr_Shop matches $(trigger) \
    if score @s Azr_emerald matches 3.. run tag @s add TEMP_purchase_success
$execute if score @s Azr_Shop_rng$(rng) matches 9 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 10 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 11 if score @s Azr_Shop matches $(trigger) \
    if score @s Azr_emerald matches 1.. run tag @s add TEMP_purchase_success
$execute if score @s Azr_Shop_rng$(rng) matches 11 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 12 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 13 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 14 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 15 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 16 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 17 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 18 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 19 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 20 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 21 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 22 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 23 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 24 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 25 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 26 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 27 if score @s Azr_Shop matches $(trigger) \
    if items entity @s container.* lapis_lazuli[count={min:1}] run tag @s add TEMP_purchase_success
$execute if score @s Azr_Shop_rng$(rng) matches 27 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 28 if score @s Azr_Shop matches $(trigger) \
    if items entity @s container.* lapis_lazuli[count={min:1}] run tag @s add TEMP_purchase_success
$execute if score @s Azr_Shop_rng$(rng) matches 28 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 29 if score @s Azr_Shop matches $(trigger) \
    if items entity @s container.* lapis_lazuli[count={min:1}] run tag @s add TEMP_purchase_success
$execute if score @s Azr_Shop_rng$(rng) matches 29 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 30 if score @s Azr_Shop matches $(trigger) \
    if items entity @s container.* lapis_lazuli[count={min:1}] run tag @s add TEMP_purchase_success
$execute if score @s Azr_Shop_rng$(rng) matches 30 if score @s Azr_Shop matches $(trigger) \
...
$execute if score @s Azr_Shop_rng$(rng) matches 31 if score @s Azr_Shop matches $(trigger) \
