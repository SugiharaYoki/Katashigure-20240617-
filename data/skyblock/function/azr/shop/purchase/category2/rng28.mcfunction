...
function skyblock:azr/items/crossbow_piercing

execute store success score azr_shop_alt Azr_system run clear @s crossbow[custom_data~{crossbow_normal:1b}] 1
