give @s shield[custom_data={shield_sharp_pro:1b},custom_name='{"text":"刺盾·改造","italic":false}',attribute_modifiers=[{type:"generic.attack_damage",id:"azr:shield_sharp_pro.attack_damage",amount:8.0,operation:"add_value",slot:"mainhand"},{type:"generic.attack_speed",id:"azr:shield_sharp_pro.attack_speed",amount:-3.2,operation:"add_value",slot:"mainhand"}],custom_model_data=100005]
