execute as @s[tag=!Azr_SExUp04] run function skyblock:azr/items/shield_solid
execute as @s[tag=Azr_SExUp04] run function skyblock:azr/items/shield_solid_pro
