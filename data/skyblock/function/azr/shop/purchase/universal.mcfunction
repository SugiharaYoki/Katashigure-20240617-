...
execute if score @s Azr_Shop matches 8431511 \
    ...
    run function skyblock:azr/shop/purchase/universal/arrow_weakness
...
execute if score @s Azr_Shop matches 8431512 \
    ...
    run function skyblock:azr/shop/purchase/universal/arrow_slowness
