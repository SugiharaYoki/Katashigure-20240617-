...
#第二关 4
execute unless score stopSeconds Azr_system matches 1 if score stage Azr_system matches 4 if score playerCount Azr_system matches 1..2 run function skyblock:azr/assets/events/stage/stage2
...
#第三关 6/32
execute unless score stopSeconds Azr_system matches 1 if score stage Azr_system matches 6 run function skyblock:azr/assets/events/stage/stage3
execute unless score stopSeconds Azr_system matches 1 if score stage Azr_system matches 32 run function skyblock:azr/assets/events/stage/stage3_beta
#第三关-第四关 7
execute if score stage Azr_system matches 7 run scoreboard players set stage_main_thread AzrTimerStack 0
#第四关 8/33
execute unless score stopSeconds Azr_system matches 1 if score stage Azr_system matches 8 run function skyblock:azr/assets/events/stage/stage4
execute unless score stopSeconds Azr_system matches 1 if score stage Azr_system matches 33 run function skyblock:azr/assets/events/stage/stage4_beta

#第四关-BOSS1 9
execute unless score stopSeconds Azr_system matches 1 if score stage Azr_system matches 9 run function skyblock:azr/assets/events/stage/stage_event1
#BOSS1 10
    # azr/main.mcfunction
#BOSS1-第五关 11
execute if score stage Azr_system matches 11 run scoreboard players set stage_main_thread AzrTimerStack 0
#第五关 12..13
execute unless score stopSeconds Azr_system matches 1 if score stage Azr_system matches 12..13 run function skyblock:azr/assets/events/stage/stage5
#第五关-第六关 14
execute if score stage Azr_system matches 7 run scoreboard players set stage_main_thread AzrTimerStack 0
#第六关 15
execute unless score stopSeconds Azr_system matches 1 if score stage Azr_system matches 15 run function skyblock:azr/assets/events/stage/stage6
#第六关-第七关 16
execute if score stage Azr_system matches 16 run function skyblock:azr/assets/events/stage/stage_event2
#第七关 17
execute unless score stopSeconds Azr_system matches 1 if score stage Azr_system matches 17 run function skyblock:azr/assets/events/stage/stage7
#第七关beta 18
execute unless score stopSeconds Azr_system matches 1 if score stage Azr_system matches 18 run function skyblock:azr/assets/events/stage/stage7_beta
#第七关-第八关 19
...
# execute unless score stopSeconds Azr_system matches 1 if score stage Azr_system matches 241 run function skyblock:azr/assets/events/stage/stage_event6
#第八关 20
execute unless score stopSeconds Azr_system matches 1 if score stage Azr_system matches 20 run function skyblock:azr/assets/events/stage/stage8
...
#第九关 26
execute unless score stopSeconds Azr_system matches 1 if score stage Azr_system matches 26 run function skyblock:azr/assets/events/stage/stage9
#event5 27
...
#第12关 41
execute unless score stopSeconds Azr_system matches 1 if score stage Azr_system matches 41 run function skyblock:azr/assets/events/stage/stage12
#event11 42..43
...
# 第四章，由于结构复杂采用另一种方式记录
    ...
    execute if score stage Azr_system matches 56..58 run function skyblock:azr/assets/events/stage/stage_event13
        ...
        # execute if score stage Azr_system matches 53..55 run function skyblock:azr/assets/events/stage/stage_event14
            # 第14关 55
            execute unless score stopSeconds Azr_system matches 1 if score stage Azr_system matches 55 run function skyblock:azr/assets/events/stage/stage14
        # event15 56..58
            execute if score stage Azr_system matches 56..58 run function skyblock:azr/assets/events/stage/stage_event15
            # 第15关 57
            execute unless score stopSeconds Azr_system matches 1 if score stage Azr_system matches 57 run function skyblock:azr/assets/events/stage/stage15
    # event16 59
...
# 第五章
#event19
execute unless score stopSeconds Azr_system matches 1 if score stage Azr_system matches 63 run function skyblock:azr/assets/events/stage/stage_event19
...
# 奖励关
    ...
    # Cerement 30
    execute unless score stopSeconds Azr_system matches 1 if score stage Azr_system matches 30 run function skyblock:azr/assets/events/stage/stage_cerement
    # Entertain 31
    execute unless score stopSeconds Azr_system matches 1 if score stage Azr_system matches 31 run function skyblock:azr/assets/events/stage/stage_entertain
    # Vestige 240
    execute unless score stopSeconds Azr_system matches 1 if score stage Azr_system matches 240 run function skyblock:azr/assets/events/stage/stage_vestige
    # Suspension 34
    execute unless score stopSeconds Azr_system matches 1 if score stage Azr_system matches 34 run function skyblock:azr/assets/events/stage/stage_suspension
    # Appetence 39
    execute unless score stopSeconds Azr_system matches 1 if score stage Azr_system matches 39 run function skyblock:azr/assets/events/stage/stage_appetence
    # Breakout 45
    execute unless score stopSeconds Azr_system matches 1 if score stage Azr_system matches 45 run function skyblock:azr/assets/events/stage/stage_breakout
    # Stage Object
