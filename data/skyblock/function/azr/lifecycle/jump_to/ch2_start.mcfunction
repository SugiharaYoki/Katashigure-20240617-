...
execute positioned -79923 43 96 run function skyblock:azr/assets/mobs/unique/andralune
execute positioned -79925.49 41.50 96.49 run function skyblock:azr/assets/mobs/unique/mersenne
