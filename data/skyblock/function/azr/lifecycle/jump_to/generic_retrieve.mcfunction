...
item replace entity @s armor.head from block ~1 ~1 ~ container.0
item replace entity @s armor.chest from block ~1 ~1 ~ container.1
item replace entity @s armor.legs from block ~1 ~1 ~ container.2
item replace entity @s armor.feet from block ~1 ~1 ~ container.3
item replace entity @s weapon.mainhand from block ~1 ~1 ~ container.4
item replace entity @s weapon.offhand from block ~1 ~1 ~ container.5

item replace entity @s hotbar.0 from block ~1 ~1 ~ container.9
item replace entity @s hotbar.1 from block ~1 ~1 ~ container.10
item replace entity @s hotbar.2 from block ~1 ~1 ~ container.11
item replace entity @s hotbar.3 from block ~1 ~1 ~ container.12
item replace entity @s hotbar.4 from block ~1 ~1 ~ container.13
item replace entity @s hotbar.5 from block ~1 ~1 ~ container.14
item replace entity @s hotbar.6 from block ~1 ~1 ~ container.15
item replace entity @s hotbar.7 from block ~1 ~1 ~ container.16
item replace entity @s hotbar.8 from block ~1 ~1 ~ container.17
