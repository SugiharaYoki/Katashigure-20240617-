...
execute unless score @s SeGa_StandLastBH matches 40.. run return run function skyblock:azr/lifecycle/jump_to/return
...
scoreboard players set wave Azr_system 40
scoreboard players set @s AzrJoinWave 40
