...
execute unless score @s SeGa_StandLastBH matches 23.. run return run function skyblock:azr/lifecycle/jump_to/return
...
scoreboard players set wave Azr_system 23
scoreboard players set @s AzrJoinWave 23
