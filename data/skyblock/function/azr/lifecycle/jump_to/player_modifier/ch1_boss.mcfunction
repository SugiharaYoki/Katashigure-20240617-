...
execute unless score @s SeGa_StandLastBH matches 7.. run return run function skyblock:azr/lifecycle/jump_to/return
...
scoreboard players set tick_main_thread AzrTimerStack 3
...
function skyblock:azr/assets/items/weapons/stone_axe_normal
function skyblock:azr/assets/items/armors/chainmail_helmet_normal_replace
function skyblock:azr/assets/items/armors/chainmail_chestplate_normal_replace
give @s bread 8
