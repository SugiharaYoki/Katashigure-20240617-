...
execute unless score @s SeGa_StandLastBH matches 48.. run return run function skyblock:azr/lifecycle/jump_to/return
...
clear @s
function skyblock:azr/assets/items/weapons/golden_sword_t2
function skyblock:azr/assets/items/weapons/iron_axe_chain_long_t2
function skyblock:azr/assets/items/weapons/golden_shovel_t2
function skyblock:azr/assets/items/weapons/crossbow_v71
function skyblock:azr/assets/items/armors/golden_helmet_t2_replace
function skyblock:azr/assets/items/armors/leather_chestplate_fireproof_replace
function skyblock:azr/assets/items/armors/golden_leggings_t2_replace
function skyblock:azr/assets/items/armors/leather_boots_fireproof_replace
function skyblock:azr/assets/items/weapons/shield_solid_pro
...
give @s arrow 18
function skyblock:azr/assets/items/others/soul_expel_torch
