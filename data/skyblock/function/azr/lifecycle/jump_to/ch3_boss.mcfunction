...
execute as @a[tag=azrPlayer] run function skyblock:azr/lifecycle/jump_to/player_modifier/ch3_boss
...
function skyblock:azr/lifecycle/jump_to/data_modifier/ch3_boss