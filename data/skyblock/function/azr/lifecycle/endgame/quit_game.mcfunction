...
#后续处理
execute if entity @s[x=-79900,y=40,z=0,distance=0..2200] unless entity @a[tag=azrPlayer] run spawnpoint @s -79953 38 -14 -90 0
execute if entity @s[x=-79900,y=40,z=0,distance=0..2200] unless entity @a[tag=azrPlayer] run tp @s -79953.0 38.5 -14.0 facing -79952.0 38.5 -14.0
execute if entity @s[x=-79900,y=40,z=0,distance=0..2200] if entity @a[tag=azrPlayer] run spawnpoint @s -43 55 0 -90 0
...
execute if entity @s[tag=azrRetrieved] unless items entity @s container.* *[custom_data~{revival_star:1b}] run function skyblock:azr/lifecycle/endgame/save_game_withoutstar
