...
item replace block -79948 25 22 container.12 with skull_banner_pattern[custom_name={"text": "“生与死的力量全都过剩。”", "color": "dark_purple",italic:0b}, lore=['{"text": "这些苔藓是被一种混沌力量所影响。",color:"white", italic: false},'{"text": "我在图书馆查阅过，那是被神庭控制的亡灵生物死亡时逸散的能量。",color:"white", italic: false},'{"text": "但从前这个阈值都被控制在一个安全的范畴。",color:"white", italic: false},'{"text": "为何偏偏是在最近过量出现？",color:"white", italic: false}]] 1
...
item replace block -79907 39 44 container.12 with skull_banner_pattern[custom_name={"text": "“我的东南水路正门钥匙被人偷走六回了”", "color": "dark_purple",italic:0b}, lore=['{"text": "我不知道是谁对禁地这么感兴趣。",color:"white", italic: false},'{"text": "如果只是对下水道感兴趣的话，那人完全可以选择其他三个区域。",color:"white", italic: false},'{"text": "魔神的力量……果然也在被觊觎着吧。",color:"white", italic: false}]] 1
