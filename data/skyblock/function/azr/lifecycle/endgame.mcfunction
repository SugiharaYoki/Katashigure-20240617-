...
scoreboard objectives remove AzrSariel_Amulet_Multiweapon_count
...
scoreboard objectives remove AzrSariel_Amulet_BackDodge_last
...
scoreboard objectives remove AzrSariel_Amulet_RevivalStar_Callmate
scoreboard objectives remove AzrSariel_Amulet_MagicalCurrentLevel
scoreboard objectives remove AzrSariel_Amulet_LaserDrag_timer
scoreboard objectives remove AzrSariel_Amulet_WindShear_timer
scoreboard objectives remove AzrSariel_Amulet_WaterRipple_cooldown
