...
execute as @s at @s[scores={Perm_PersonFSB=500..,Perm_PersonSHD=200..}] run tellraw @s {"text":"灵能「嗜血狂袭」升级！花费了： 500浮世币 200影之石","color":"green"}
...
execute as @s at @s[tag=purchasesuccess] run scoreboard players set @s Azr_SK2 2
