...
#投掷道具
execute as @s[type=item] run scoreboard players add @s AzrEntityTimer 1
...
execute if score playerCount Azr_system matches 1.. positioned -79177 50 -13 as @s[tag=AzrielMarker_encounter,distance=0..0.5,tag=azr_door_2] run function skyblock:azr/assets/mobs/skill/boss_rush/door_2
