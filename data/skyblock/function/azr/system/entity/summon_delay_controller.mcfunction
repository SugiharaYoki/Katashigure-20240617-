...
execute if entity @s[tag=AzrielMob_summon_delay_marker_husk] run function skyblock:azr/assets/mobs/summon_delay/husk
execute if entity @s[tag=AzrielMob_summon_delay_marker_husk_temper] run function skyblock:azr/assets/mobs/summon_delay/husk_temper
execute if entity @s[tag=AzrielMob_summon_delay_marker_sword] run function skyblock:azr/assets/mobs/summon_delay/piglin_sword
execute if entity @s[tag=AzrielMob_summon_delay_marker_shovel] run function skyblock:azr/assets/mobs/summon_delay/piglin_shovel
execute if entity @s[tag=AzrielMob_summon_delay_marker_crossbow] run function skyblock:azr/assets/mobs/summon_delay/piglin_crossbow
