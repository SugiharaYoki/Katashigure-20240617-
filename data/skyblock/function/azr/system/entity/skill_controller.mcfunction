...
execute if entity @s[type=#undead] if block ~ ~0.8 ~ #skyblock:water run scoreboard players add @s AzrielMob_undead_inwater 1
execute if entity @s[type=#undead] if block ~ ~0.8 ~ #skyblock:water if score @s AzrielMob_undead_inwater matches 5.. run tp @s ~ ~0.07 ~
execute if entity @s[type=#undead] if block ~ ~0.8 ~ #skyblock:water if score @s AzrielMob_undead_inwater matches 5.. run scoreboard players set @s AzrielMob_undead_inwater 0
...
execute if score stage Azr_system matches 25.. if entity @s[type=piglin] run function skyblock:azr/assets/events/stage/chapter_3/stage9_divineforce_behavior
