...
execute if entity @s[type=#undead] if block ~ ~1.2 ~ #skyblock:water if score @s AzrielMob_undead_inwater matches 6.. run tp @s ~ ~0.12 ~
execute if entity @s[type=#undead] if block ~ ~1.2 ~ #skyblock:water if score @s AzrielMob_undead_inwater matches 6.. run scoreboard players set @s AzrielMob_undead_inwater 0
