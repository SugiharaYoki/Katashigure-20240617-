...
#boss
execute if score stage Azr_system matches 64..68 if entity @s[type=piglin_brute,tag=AzrielMob_demon_amy] run function skyblock:azr/assets/mobs/skill/boss4_amy/core_x20
