...
execute as @s[tag=AzrielMob_demon_amy_flame_eye_part2] at @s unless entity @n[type=piglin_brute,distance=..100,tag=AZR_action_halt] run function skyblock:azr/assets/mobs/skill/boss4_amy/flame_eye_part2
