...
execute as @s[tag=AzrielMob_boss_diesel_fire_outround_marker] at @s run function skyblock:azr/assets/mobs/skill/bossrush/boss_diesel/marker_fire_outround
