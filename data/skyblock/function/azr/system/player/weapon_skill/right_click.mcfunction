...
execute if score @s AZR_chainKill_chargeup matches 10000.. if entity @s[tag=!AZR_chainKill_activated] run scoreboard players add @s azr_weapon_rightclick_chainkill_load 30
