...
execute if entity @s[tag=flowerreason_activate,tag=AzrielMob_level_2] as @e[distance=..3.8,tag=AzrielMob_typeDEATH] run damage @s 8 magic
...
execute if entity @s[tag=flowerreason_activate,tag=AzrielMob_level_2] as @e[distance=..3.8,tag=AzrielMob_typeMONSTER] run damage @s 4 magic
execute if entity @s[tag=flowerreason_activate,tag=AzrielMob_level_3] as @e[distance=..3.8,tag=AzrielMob_typeMONSTER] run damage @s 5 magic
execute if entity @s[tag=flowerreason_activate] run kill @s



execute if entity @s[scores={rng1=600..}] run kill @s