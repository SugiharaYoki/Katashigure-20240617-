...
execute if entity @a[tag=azrPlayer,distance=..1] run tag @s add flowerreason_activate

scoreboard players add @s rng1 1


particle minecraft:cherry_leaves ~ ~1 ~ 0.26 0.26 0.26 5 2

execute if entity @s[tag=flowerreason_activate] run particle minecraft:spore_blossom_air ~ ~1 ~ 0.3 0.3 0.3 2.5 20
execute if entity @s[tag=flowerreason_activate] run particle minecraft:cherry_leaves ~ ~1 ~ 0.9 0.26 0.9 5 30
...
execute if entity @s[tag=flowerreason_activate,tag=AzrielMob_level_2] as @e[distance=..3.8,tag=AzrielMob_typeDEATH] run damage @s 6 magic
execute if entity @s[tag=flowerreason_activate,tag=AzrielMob_level_3] as @e[distance=..3.8,tag=AzrielMob_typeDEATH] run damage @s 8 magic
