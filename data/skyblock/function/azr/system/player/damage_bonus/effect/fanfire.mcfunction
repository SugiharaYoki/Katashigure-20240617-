...
execute if items entity @s hotbar.* *[custom_data~{azr_amulet_fire_lit:1b}] as @s at @s positioned ~ ~0.5 ~ rotated as @s rotated ~-40 ~ run particle flame ^ ^ ^1 0 0 0 0 1
execute if items entity @s hotbar.* *[custom_data~{azr_amulet_fire_lit:1b}] as @s at @s positioned ~ ~0.5 ~ rotated as @s rotated ~-30 ~ run particle flame ^ ^ ^1 0 0 0 0 1
execute if items entity @s hotbar.* *[custom_data~{azr_amulet_fire_lit:1b}] as @s at @s positioned ~ ~0.5 ~ rotated as @s rotated ~-20 ~ run particle flame ^ ^ ^1 0 0 0 0 1
execute if items entity @s hotbar.* *[custom_data~{azr_amulet_fire_lit:1b}] as @s at @s positioned ~ ~0.5 ~ rotated as @s rotated ~-10 ~ run particle flame ^ ^ ^1 0 0 0 0 1
execute if items entity @s hotbar.* *[custom_data~{azr_amulet_fire_lit:1b}] as @s at @s positioned ~ ~0.5 ~ rotated as @s rotated ~-00 ~ run particle flame ^ ^ ^1 0 0 0 0 1
execute if items entity @s hotbar.* *[custom_data~{azr_amulet_fire_lit:1b}] as @s at @s positioned ~ ~0.5 ~ rotated as @s rotated ~010 ~ run particle flame ^ ^ ^1 0 0 0 0 1
execute if items entity @s hotbar.* *[custom_data~{azr_amulet_fire_lit:1b}] as @s at @s positioned ~ ~0.5 ~ rotated as @s rotated ~020 ~ run particle flame ^ ^ ^1 0 0 0 0 1
execute if items entity @s hotbar.* *[custom_data~{azr_amulet_fire_lit:1b}] as @s at @s positioned ~ ~0.5 ~ rotated as @s rotated ~030 ~ run particle flame ^ ^ ^1 0 0 0 0 1
execute if items entity @s hotbar.* *[custom_data~{azr_amulet_fire_lit:1b}] as @s at @s positioned ~ ~0.5 ~ rotated as @s rotated ~040 ~ run particle flame ^ ^ ^1 0 0 0 0 1
