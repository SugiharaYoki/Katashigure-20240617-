...
execute if block ~0.3 ~-2 ~0.3 lava if block ~0.3 ~1 ~0.3 lava run damage @s 50 generic
execute if block ~0.3 ~-2 ~-0.3 lava if block ~0.3 ~1 ~-0.3 lava run damage @s 50 generic
execute if block ~-0.3 ~-2 ~0.3 lava if block ~-0.3 ~1 ~0.3 lava run damage @s 50 generic
execute if block ~-0.3 ~-2 ~-0.3 lava if block ~-0.3 ~1 ~-0.3 lava run damage @s 50 generic
...
execute if items entity @s weapon.mainhand *[custom_data~{revival_star:1b}] if entity @s[predicate=skyblock:space,tag=!revival_star_task] run function skyblock:azr/system/player/skills/amulet/revival_star_task
execute if items entity @s weapon.mainhand *[custom_data~{revival_star:1b}] if entity @s[predicate=!skyblock:space,tag=revival_star_task] run tag @s remove revival_star_task
