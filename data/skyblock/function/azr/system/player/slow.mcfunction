...
execute if score stage Azr_system matches 71..76 at @n[tag=AzrielMob_utility_respawn_anchor,type=marker] run spawnpoint @s ~ ~ ~
execute if score stage Azr_system matches 77.. if score @s AzrPlayer_CurrentArea matches 9..10 at @n[tag=AzrielMob_utility_respawn_anchor,type=marker] run spawnpoint @s ~ ~ ~
