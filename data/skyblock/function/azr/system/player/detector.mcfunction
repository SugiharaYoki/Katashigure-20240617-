...
# 重置判定 - 游戏已开始但没有玩家
execute if score isStarted Azr_system matches 1 if entity @s[x=-79951,y=38,z=-15,distance=..20,gamemode=adventure] unless entity @a[tag=azrPlayer] run function skyblock:azr/lifecycle/endgame
