...
execute rotated as @s as @n[tag=skill_arrow_temp] run function skyblock:azr/system/utils/fix_arrow_facing
execute at @s positioned 0. 0. 0. as 0-0-0-0-0 run function skyblock:azr/system/utils/world_entity_get_motion_3
...
execute at @s positioned ~ ~0.1 ~ rotated ~ 0 run function skyblock:azr/assets/events/effects/player_magic_release
