...
execute if entity @s[tag=AzrAmulet_MossGrow_Activated,tag=!AzrAmulet_MossGrow_Activated_regenerating] run effect give @s regeneration infinite 0 false
execute if entity @s[tag=AzrAmulet_MossGrow_Activated,tag=!AzrAmulet_MossGrow_Activated_regenerating] run tag @s add AzrAmulet_MossGrow_Activated_regenerating
...
execute if entity @s[tag=AzrAmulet_MossGrow_Cancelling] run tag @s remove AzrAmulet_MossGrow_Activated_regenerating
execute if entity @s[tag=AzrAmulet_MossGrow_Cancelling] run effect clear @s regeneration
