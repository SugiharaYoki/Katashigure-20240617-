...
$particle minecraft:gust ~ ~ ~ $(distance) 0 $(distance) 0 20

$execute if score @s AzrSariel_Amulet_FireLit_count matches 8..15 if score @s AzrSariel_Amulet_DownKick_clock matches 11 run particle minecraft:lava ~ ~ ~ $(distance) 0 $(distance) 3 8
$execute if score @s AzrSariel_Amulet_FireLit_count matches 16.. if score @s AzrSariel_Amulet_DownKick_clock matches 11 run particle minecraft:lava ~ ~ ~ $(distance) 0 $(distance) 3 13
