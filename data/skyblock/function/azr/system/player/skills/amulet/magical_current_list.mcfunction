...
#stage 
execute positioned -79664 20 -409 if entity @s[distance=..18] run particle trail{color:6666239,duration:240,target:[-79663.49,36.06,-408.54]} ~ ~ ~ 0.5 0 0.5 0 1 force
