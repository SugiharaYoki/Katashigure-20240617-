...
execute positioned -79505 45 -338 if entity @n[tag=AzrielMarker_encounter,distance=0..0.5] if entity @s[x=-79479,y=15,z=-328,dx=0,dy=20,dz=0,predicate=!skyblock:sneak] run effect give @s levitation 1 2 true
...
execute positioned -79505 45 -338 if entity @n[tag=AzrielMarker_encounter,distance=0..0.5] if entity @s[x=-79511,y=15,z=-328,dx=0,dy=20,dz=0,predicate=!skyblock:sneak] run effect give @s levitation 1 2 true
...
execute if entity @s[x=-79730,y=23,z=-317,dx=0,dy=30,dz=0,predicate=!skyblock:sneak] run effect give @s levitation 1 2 true
...
execute if entity @s[x=-79754,y=43,z=-304,dx=0,dy=10,dz=0,predicate=!skyblock:sneak] run effect give @s levitation 1 2 true
...
execute positioned -79505 45 -338 if entity @n[tag=AzrielMarker_encounter,distance=0..0.5] if entity @s[x=-79775,y=-18,z=-177,dx=0,dy=15,dz=0,predicate=!skyblock:sneak] run effect give @s levitation 1 2 true
...
execute if score stage Azr_system matches ..75 positioned -79505 45 -338 if entity @n[tag=AzrielMarker_encounter,distance=0..0.5] if entity @s[x=-79776,y=-6,z=-200,dx=0,dy=25,dz=0,predicate=!skyblock:sneak] run effect give @s levitation 1 2 true
...
execute if entity @s[x=-79664,y=20,z=-409,dx=0,dy=15,dz=0,predicate=!skyblock:sneak] run effect give @s levitation 1 2 true
...
execute positioned -79633 116 -781 if entity @s[distance=..30] run particle trail{color:6666239,duration:240,target:[-79632.51,182.00,-780.51]} ~ ~ ~ 0.5 0 0.5 0 1 force
execute if entity @s[x=-79633,y=116,z=-781,dx=0,dy=50,dz=0,predicate=!skyblock:sneak] run effect give @s levitation 1 4 true
