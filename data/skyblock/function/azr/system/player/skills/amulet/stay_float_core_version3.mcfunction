...
execute unless score @s AzrSariel_Amulet_MagicalCurrentLevel matches 1.. if entity @s[scores={AzrSariel_Amulet_StayFloat_cooldown=..0},predicate=skyblock:jump,gamemode=adventure] unless block ~ ~-0.3 ~ water unless block ~ ~0.3 ~ water unless block ~ ~ ~ #climbable if block ~ ~-0.9 ~ air run scoreboard players set @s AzrSariel_Amulet_StayFloat_cooldown 140
...
execute if score @s AzrSariel_Amulet_StayFloat_cooldown matches 138 store result score @s AzrSariel_Amulet_StayFloat_Y run data get entity @s Pos[1] 1000000
...
execute if score @s AzrSariel_Amulet_StayFloat_cooldown matches 118..138 store result storage azr_amulet:stay_float y double 0.000001 run scoreboard players get @s AzrSariel_Amulet_StayFloat_Y
...
execute if items entity @s container.* *[custom_data~{azr_amulet_wind_shear:1b}] if score @s AzrSariel_Amulet_StayFloat_cooldown matches 136 as @s at @s positioned ~ ~-2.3 ~ run summon marker ~ ~ ~ {Tags:["AzrielMob_amulet_skill_axevortex","AzrielMob_amulet_skill","AzrielMob_level_1","toward_left"]}
execute if items entity @s container.* *[custom_data~{azr_amulet_wind_shear:1b}] if score @s AzrSariel_Amulet_StayFloat_cooldown matches 131 as @s at @s positioned ~ ~-2.3 ~ run summon marker ~ ~ ~ {Tags:["AzrielMob_amulet_skill_axevortex","AzrielMob_amulet_skill","AzrielMob_level_1","toward_right"]}
execute if items entity @s container.* *[custom_data~{azr_amulet_wind_shear:1b}] if score @s AzrSariel_Amulet_StayFloat_cooldown matches 126 as @s at @s positioned ~ ~-2.3 ~ run summon marker ~ ~ ~ {Tags:["AzrielMob_amulet_skill_axevortex","AzrielMob_amulet_skill","AzrielMob_level_1","toward_left"]}
execute if items entity @s container.* *[custom_data~{azr_amulet_wind_shear:1b}] if score @s AzrSariel_Amulet_StayFloat_cooldown matches 121 as @s at @s positioned ~ ~-2.3 ~ run summon marker ~ ~ ~ {Tags:["AzrielMob_amulet_skill_axevortex","AzrielMob_amulet_skill","AzrielMob_level_1","toward_right"]}
...
execute if score @s AzrSariel_Amulet_StayFloat_cooldown matches 138 if entity @s[predicate=skyblock:jump] run effect give @s slow_falling 1 99 true
...
execute if score @s AzrSariel_Amulet_StayFloat_cooldown matches 90..118 run scoreboard players set @s AzrSariel_Amulet_StayFloat_cooldown 3
execute if score @s AzrSariel_Amulet_StayFloat_cooldown matches 1..2 if entity @s[predicate=skyblock:jump] run scoreboard players set @s AzrSariel_Amulet_StayFloat_cooldown 2
execute if score @s AzrSariel_Amulet_StayFloat_cooldown matches 1..2 if entity @s[nbt={OnGround:0b}] run scoreboard players set @s AzrSariel_Amulet_StayFloat_cooldown 2
