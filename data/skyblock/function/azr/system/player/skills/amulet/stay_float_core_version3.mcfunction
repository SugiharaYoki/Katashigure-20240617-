...
execute if score @s AzrSariel_Amulet_StayFloat_cooldown matches 1..2 if entity @s[predicate=skyblock:jump] run scoreboard players set @s AzrSariel_Amulet_StayFloat_cooldown 11
execute if score @s AzrSariel_Amulet_StayFloat_cooldown matches 1..2 if entity @s[nbt={OnGround:0b}] run scoreboard players set @s AzrSariel_Amulet_StayFloat_cooldown 11
