...
execute at @s if score @s[scores={player_health=..3}] AzrTimerAmulet_hrm matches 14 run playsound minecraft:entity.warden.heartbeat player @s ~ ~ ~ 0.8 1.2
...
execute at @s if score @s[scores={player_health=..3}] AzrTimerAmulet_hrm matches 28 run playsound minecraft:entity.warden.heartbeat player @s ~ ~ ~ 0.8 1.2
execute at @s if score @s[scores={player_health=4..7}] AzrTimerAmulet_hrm matches 14 run playsound minecraft:entity.warden.heartbeat player @s ~ ~ ~ 0.6 0.9
execute at @s if score @s[scores={player_health=4..7}] AzrTimerAmulet_hrm matches 28 run playsound minecraft:entity.warden.heartbeat player @s ~ ~ ~ 0.6 0.9
