...
execute at @s if score @s[scores={player_health=..3}] AzrTimerAmulet_hrm matches 11 run playsound minecraft:entity.warden.heartbeat player @s ~ ~ ~ 0.8 1.2
...
execute at @s if score @s[scores={player_health=..3}] AzrTimerAmulet_hrm matches 25 run playsound minecraft:entity.warden.heartbeat player @s ~ ~ ~ 0.8 1.2
