execute store result storage azr:cache amulet_doublearrow_rain_x int 0.1 run random value -30..30
execute store result storage azr:cache amulet_doublearrow_rain_y int 0.1 run random value 25..35
execute store result storage azr:cache amulet_doublearrow_rain_z int 0.1 run random value -30..30
