...
execute if entity @s[tag=AZR_Amulet_Instant_Success] if items entity @s weapon.mainhand wooden_hoe run execute as @e[tag=AZR_Amulet_Instant_Success_Mob,distance=..15] at @s run say hi
execute if entity @s[tag=AZR_Amulet_Instant_Success] if items entity @s weapon.mainhand stone_hoe run execute as @e[tag=AZR_Amulet_Instant_Success_Mob,distance=..15] at @s run say hi
execute if entity @s[tag=AZR_Amulet_Instant_Success] if items entity @s weapon.mainhand iron_hoe run execute as @e[tag=AZR_Amulet_Instant_Success_Mob,distance=..15] at @s run say hi
execute if entity @s[tag=AZR_Amulet_Instant_Success] if items entity @s weapon.mainhand copper_hoe run execute as @e[tag=AZR_Amulet_Instant_Success_Mob,distance=..15] at @s run say hi
