...
execute if entity @s[tag=AzrInstantSuccess] if score @s rng1 matches 1 run summon marker ^00.8 ^ ^-0.3 {Tags:["AzrielMob_amulet_skill_waterripple","AzrielMob_amulet_skill","AzrielMob_level_1"]}
execute if entity @s[tag=AzrInstantSuccess] if score @s rng1 matches 2 run summon marker ^-0.8 ^ ^-0.3 {Tags:["AzrielMob_amulet_skill_waterripple","AzrielMob_amulet_skill","AzrielMob_level_1"]}
