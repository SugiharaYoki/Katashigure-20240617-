...
execute if score @s AzrSariel_Amulet_FireDrogue_cooldown matches ..0 if score @s rng1 matches ..2 run scoreboard players set @s AzrSariel_Amulet_FireDrogue_cooldown 34
execute if score @s AzrSariel_Amulet_FireDrogue_cooldown matches ..0 if score @s rng1 matches ..2 if items entity @s weapon.mainhand #hoes run scoreboard players set @s AzrSariel_Amulet_FireDrogue_cooldown 28
