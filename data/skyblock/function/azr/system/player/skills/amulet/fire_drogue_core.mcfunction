...
execute if score @s[tag=AzrSariel_Side_Life,tag=AzrSariel_Amulet_FireDrogue_PASS] rng2 matches 1 at @s positioned ^ ^1 ^-0.8 run summon marker ~ ~ ~ {Tags:["AzrielMob_amulet_skill","AzrielMob_amulet_skill_FireDrogue","AzrielMob_level_1"]}
...
execute if score @s[tag=AzrSariel_Side_Life,tag=AzrSariel_Amulet_FireDrogue_PASS] rng2 matches 2 at @s positioned ^ ^1 ^-0.8 run summon marker ~ ~ ~ {Tags:["AzrielMob_amulet_skill","AzrielMob_amulet_skill_FireDrogue","AzrielMob_level_2"]}
...
execute if score @s[tag=AzrSariel_Side_Life,tag=AzrSariel_Amulet_FireDrogue_PASS] rng2 matches 3.. at @s positioned ^ ^1 ^-0.8 run summon marker ~ ~ ~ {Tags:["AzrielMob_amulet_skill","AzrielMob_amulet_skill_FireDrogue","AzrielMob_level_3"]}
