...
execute if score @s[scores={AzrSariel_Side_Result=-4..}] AzrSariel_Amulet_FireDrogue_cooldown matches 0 if score @s rng1 matches ..2 at @s positioned ^ ^1 ^-0.8 run summon marker ~ ~ ~ {Tags:["AzrielMob_amulet_skill","AzrielMob_amulet_skill_FireDrogue","AzrielMob_level_1"]}
execute if score @s[scores={AzrSariel_Side_Result=..-5}] AzrSariel_Amulet_FireDrogue_cooldown matches 0 if score @s rng1 matches ..2 at @s positioned ^ ^1 ^-0.8 run summon marker ~ ~ ~ {Tags:["AzrielMob_amulet_skill","AzrielMob_amulet_skill_FireDrogue","AzrielMob_level_1","AzrSariel_Death"]}
