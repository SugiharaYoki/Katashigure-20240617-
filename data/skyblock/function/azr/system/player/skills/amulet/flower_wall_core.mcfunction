...
execute if entity @s[tag=!AzrAmulet_FlowerWall_Activated] if entity @s[predicate=skyblock:forward] run attribute @s armor modifier add azr_amulet:flowerwall_01 0.2 add_multiplied_total
execute if entity @s[tag=!AzrAmulet_FlowerWall_Activated] if entity @s[predicate=skyblock:forward] run tag @s add AzrAmulet_FlowerWall_Activated
