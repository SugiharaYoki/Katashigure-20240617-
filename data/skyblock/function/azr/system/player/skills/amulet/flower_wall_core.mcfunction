...
execute if entity @s[tag=!AzrAmulet_FlowerWall_Activated] if entity @s[predicate=skyblock:forward,predicate=!skyblock:backward] run attribute @s attack_damage modifier add azr_amulet:flowerwall_01 0.2 add_multiplied_total
