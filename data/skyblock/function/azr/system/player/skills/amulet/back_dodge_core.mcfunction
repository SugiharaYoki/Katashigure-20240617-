...
execute if entity @s[scores={AzrSariel_Amulet_BackDodge_clock=93..99},predicate=!skyblock:backward] run scoreboard players set @s AzrSariel_Amulet_BackDodge_clock 92

execute if entity @s[scores={AzrSariel_Amulet_BackDodge_clock=92}] run attribute @s movement_speed modifier remove azr_amulet:backdodge_01
execute if entity @s[scores={AzrSariel_Amulet_BackDodge_clock=92}] run attribute @s armor modifier remove azr_amulet:sprintdouble_01

execute if entity @s[scores={AzrSariel_Amulet_BackDodge_clock=92}] run stopsound @s player minecraft:item.elytra.flying

execute if entity @s[scores={AzrSariel_Amulet_BackDodge_clock=92}] run scoreboard players set @s AzrSariel_Amulet_BackDodge_clock 0
