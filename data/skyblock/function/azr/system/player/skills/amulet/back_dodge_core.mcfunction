...
execute if entity @s[scores={AzrSariel_Amulet_BackDodge_last=1..},predicate=skyblock:sneak] at @s rotated ~ 90 positioned ^ ^0.3 ^2 run function skyblock:azr/system/player/skills/amulet/back_dodge_core_old
