...
execute if entity @s[scores={AzrSariel_Amulet_BackDodge_clock=1..}] at @s rotated ~ 90 positioned ^ ^0.3 ^2 run function azr:system/player/skills/amulet/back_dodge_arrow_tripler_particle
