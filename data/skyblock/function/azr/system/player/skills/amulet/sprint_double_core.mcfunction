...
execute if entity @s[scores={AzrSariel_Amulet_SprintDouble_clock=93..99,AzrSariel_Amulet_generic_damage_dealt=1..}] if items entity @s hotbar.* *[custom_data~{azr_amulet_land_fracture:1b}] run function skyblock:azr/system/player/skills/amulet/sprint_double_land_fracture
