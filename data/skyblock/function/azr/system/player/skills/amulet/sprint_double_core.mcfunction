...
execute if entity @s[scores={AzrSariel_Amulet_SprintDouble_clock=49..50},predicate=!skyblock:sprint] run scoreboard players set @s AzrSariel_Amulet_SprintDouble_clock 20
