...
execute if score @s AzrSariel_Amulet_DownKick_clock matches 21..78 if entity @s[nbt={OnGround:1b},scores={AZR_chainKill_chargeup=2500..}] run scoreboard players set @s AzrSariel_Amulet_DownKick_clock 20
