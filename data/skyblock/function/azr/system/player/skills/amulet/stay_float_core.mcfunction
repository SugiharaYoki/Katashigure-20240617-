...
execute if score @s AzrSariel_Amulet_StayFloat_cooldown matches 138 at @s store result storage azr_amulet:stay_float y double 0.000001 run data get entity @s Pos[1] 1000000
...
execute if score @s AzrSariel_Amulet_StayFloat_cooldown matches 118..138 positioned as @s run playsound minecraft:block.fire.extinguish player @a ~ ~ ~ 0.4 2
execute if score @s AzrSariel_Amulet_StayFloat_cooldown matches 118..138 positioned as @s run particle white_smoke ~ ~-0.2 ~ 0.1 0 0.1 0.03 8
