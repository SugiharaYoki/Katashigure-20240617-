...
execute if score @s AzrSariel_Amulet_StayFloat_cooldown matches 136 store result storage azr_amulet:stay_float y double 0.00001 run data get entity @s Pos[1] 100000
execute if score @s AzrSariel_Amulet_StayFloat_cooldown matches 136 store result storage azr_amulet:stay_float y_10 double 0.0001 run data get entity @s Pos[1] 100000
