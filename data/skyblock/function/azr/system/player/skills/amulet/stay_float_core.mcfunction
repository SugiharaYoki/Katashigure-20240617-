...
execute if score @s AzrSariel_Amulet_StayFloat_cooldown matches 118..138 at @s run playsound minecraft:block.fire.extinguish player @a ~ ~ ~ 0.4 2
execute if score @s AzrSariel_Amulet_StayFloat_cooldown matches 118..138 at @s run particle white_smoke ~ ~-0.2 ~ 0.1 0 0.1 0.03 8
