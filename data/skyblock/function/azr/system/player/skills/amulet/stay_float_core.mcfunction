...
execute if score @s AzrSariel_Amulet_StayFloat_cooldown matches 138 store result storage azr_amulet:stay_float y_limit double 1.01 run data get entity @s Pos[1]
