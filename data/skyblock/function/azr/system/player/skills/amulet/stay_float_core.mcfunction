...
execute if score @s AzrSariel_Amulet_StayFloat_cooldown matches 138.. if entity @s[predicate=skyblock:jump] as @s at @s anchored eyes positioned ^ ^ ^0.5 unless block ~ ~ ~ air run scoreboard players set @s AzrSariel_Amulet_StayFloat_cooldown 3
