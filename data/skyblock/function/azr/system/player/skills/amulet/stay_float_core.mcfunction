...
execute if entity @s[scores={AzrSariel_Amulet_StayFloat_clock=..-10},predicate=skyblock:jump,tag=!azrAmulet_StayFloat_Jumping] run scoreboard players set @s AzrSariel_Amulet_StayFloat_clock 4
...
execute if entity @s[scores={AzrSariel_Amulet_StayFloat_clock=17..20},predicate=skyblock:jump,tag=!azrAmulet_StayFloat_Jumping] run scoreboard players set @s AzrSariel_Amulet_StayFloat_clock 100
execute if entity @s[scores={AzrSariel_Amulet_StayFloat_clock=15..16}] unless block ~ ~-0.3 ~ water unless block ~ ~0.3 ~ water unless block ~ ~ ~ #climbable run scoreboard players set @s AzrSariel_Amulet_StayFloat_cooldown 141
