...
execute if score @s AzrSariel_Amulet_StayFloat_cooldown matches 90.. if entity @s[predicate=skyblock:jump] run scoreboard players set @s AzrSariel_Amulet_StayFloat_cooldown 1
