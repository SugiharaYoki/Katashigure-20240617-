...
execute if entity @s[scores={AzrSariel_Amulet_StayFloat_clock=..0},predicate=skyblock:forward,tag=!azrAmulet_StayFloat_Jumping,gamemode=adventure] run scoreboard players set @s AzrSariel_Amulet_StayFloat_clock 10
execute if entity @s[scores={AzrSariel_Amulet_StayFloat_clock=1..10},predicate=!skyblock:forward] run scoreboard players set @s AzrSariel_Amulet_StayFloat_clock 20
execute if entity @s[scores={AzrSariel_Amulet_StayFloat_clock=15..20},predicate=skyblock:forward,tag=!azrAmulet_StayFloat_Jumping] unless block ~ ~-0.3 ~ water unless block ~ ~0.3 ~ water unless block ~ ~ ~ #climbable run scoreboard players set @s AzrSariel_Amulet_StayFloat_cooldown 141
...
execute if score @s AzrSariel_Amulet_StayFloat_cooldown matches 118..136 if entity @s[predicate=!skyblock:forward] run scoreboard players set @s AzrSariel_Amulet_StayFloat_cooldown 50
execute if score @s AzrSariel_Amulet_StayFloat_cooldown matches 137.. if entity @s[predicate=!skyblock:forward] run scoreboard players set @s AzrSariel_Amulet_StayFloat_cooldown 1
#execute if score @s AzrSariel_Amulet_StayFloat_cooldown matches 110..138 if entity @s[predicate=skyblock:jump] at @s if entity @s[nbt={OnGround:1b}] run say scoreboard players set @s AzrSariel_Amulet_StayFloat_cooldown 1
