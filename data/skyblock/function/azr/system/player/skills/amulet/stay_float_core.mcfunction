...
#execute if score @s AzrSariel_Amulet_StayFloat_cooldown matches 110..133 if entity @s[predicate=skyblock:jump] if entity @s[nbt={OnGround:1b}] run scoreboard players set @s AzrSariel_Amulet_StayFloat_cooldown 1
