...
execute if entity @s[scores={AzrSariel_Amulet_StayFloat_clock=..0},predicate=skyblock:sprint,gamemode=adventure] run scoreboard players set @s AzrSariel_Amulet_StayFloat_cooldown 141
