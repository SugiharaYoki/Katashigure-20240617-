...
execute if entity @s[tag=AZR_Amulet_Instant_Success,x_rotation=60..90] store result storage azr:cache amulet_doublearrow_rain_owner_uuid_0 int 1 run data get entity @s UUID[0]
