...
execute if entity @s[tag=AZR_Amulet_Instant_Success] as @n[type=arrow,nbt={inGround:0b,pickup:1b},distance=..2.5] at @s store result storage azr:cache amulet_doublearrow_motion_x double 0.00003 run data get entity @s Motion[0] 100000
execute if entity @s[tag=AZR_Amulet_Instant_Success] as @n[type=arrow,nbt={inGround:0b,pickup:1b},distance=..2.5] at @s store result storage azr:cache amulet_doublearrow_motion_y double 0.00003 run data get entity @s Motion[1] 100000
execute if entity @s[tag=AZR_Amulet_Instant_Success] as @n[type=arrow,nbt={inGround:0b,pickup:1b},distance=..2.5] at @s store result storage azr:cache amulet_doublearrow_motion_z double 0.00003 run data get entity @s Motion[2] 100000
