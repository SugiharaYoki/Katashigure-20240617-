...
execute if items entity @s[tag=!AzrSariel_Amulet_AxeVortex_SweepRatio] weapon.mainhand #minecraft:swords unless entity @s[predicate=!left,predicate=!right] run attribute @s sweeping_damage_ratio modifier add azr_amulet:axevortex_1 0.15 add_value 
