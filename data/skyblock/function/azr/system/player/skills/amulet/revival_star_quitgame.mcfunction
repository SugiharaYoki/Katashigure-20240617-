...
execute if score @s[gamemode=creative] AzrSariel_Amulet_RevivalStar_teleport matches 3 run scoreboard players set @s AzrSariel_Amulet_RevivalStar_teleport 60
...
execute if score @s AzrSariel_Amulet_RevivalStar_teleport matches 60 at @s run particle flash{color:[0.000,0.000,0.000,1.00]} ~ ~1 ~ 0 0 0 0 1
...
execute if score @s AzrSariel_Amulet_RevivalStar_teleport matches 60 run function skyblock:azr/lifecycle/endgame/quit_game
