...
tellraw @s [{text:" "},{text:" 次 ",bold:0b,italic:1b,color:"white"},{text:"保 ",bold:0b,italic:1b,color:"white"},{text:"增 ",bold:0b,italic:1b,color:"white"},{text:"攻 ",bold:0b,italic:1b,color:"white"}]
tellraw @s [{text:" "},{text:" 数 ",bold:0b,italic:1b,color:"white"},{text:"底 ",bold:0b,italic:1b,color:"white"},{text:"伤 ",bold:0b,italic:1b,color:"white"},{text:"击 ",bold:0b,italic:1b,color:"white"}]
tellraw @s [{text:" "},{text:" 破 ",bold:0b,italic:1b,color:"white"},{text:"次 ",bold:0b,italic:1b,color:"white"},{text:"幅 ",bold:0b,italic:1b,color:"white"},{text:"距 ",bold:0b,italic:1b,color:"white"}]
tellraw @s [{text:" "},{text:" 限 ",bold:0b,italic:1b,color:"white"},{text:"数 ",bold:0b,italic:1b,color:"white"},{text:"度 ",bold:0b,italic:1b,color:"white"},{text:"离 ",bold:0b,italic:1b,color:"white"}]
tellraw @s {text:""}
