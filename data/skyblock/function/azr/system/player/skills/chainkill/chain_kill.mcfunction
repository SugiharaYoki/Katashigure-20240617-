...
execute if entity @s[tag=AZR_chainKill_activated] if entity @n[tag=MG_AZR0MOB,distance=0..19] run title @s[tag=AZR_chainKillUpg_countvisible,scores={AZR_chainKill_count=10..}] actionbar [{text:"绿宝石 ",color:"green","bold": true},{"score":{"name":"@s","objective":"Azr0_emerald"},color:"green","bold": false},{"text": "   - 索命连击 ×Z -",color:"gold","bold": true},{text:"   钻石 ",color:"aqua","bold": true},{"score":{"name":"@s","objective":"Azr_diamond"},color:"aqua","bold": false}]
execute if entity @s[tag=AZR_chainKill_activated] if entity @n[tag=MG_AZR0MOB,distance=0..19] run title @s[tag=AZR_chainKillUpg_countvisible,scores={AZR_chainKill_count=10}] actionbar [{text:"绿宝石 ",color:"green","bold": true},{"score":{"name":"@s","objective":"Azr0_emerald"},color:"green","bold": false},{"text": "   - 索命连击 ×T -",color:"gold","bold": true},{text:"   钻石 ",color:"aqua","bold": true},{"score":{"name":"@s","objective":"Azr_diamond"},color:"aqua","bold": false}]
execute if entity @s[tag=AZR_chainKill_activated] if entity @n[tag=MG_AZR0MOB,distance=0..19] run title @s[tag=AZR_chainKillUpg_countvisible,scores={AZR_chainKill_count=9}] actionbar [{text:"绿宝石 ",color:"green","bold": true},{"score":{"name":"@s","objective":"Azr0_emerald"},color:"green","bold": false},{"text": "   - 索命连击 ×9 -",color:"gold","bold": true},{text:"   钻石 ",color:"aqua","bold": true},{"score":{"name":"@s","objective":"Azr_diamond"},color:"aqua","bold": false}]
execute if entity @s[tag=AZR_chainKill_activated] if entity @n[tag=MG_AZR0MOB,distance=0..19] run title @s[tag=AZR_chainKillUpg_countvisible,scores={AZR_chainKill_count=8}] actionbar [{text:"绿宝石 ",color:"green","bold": true},{"score":{"name":"@s","objective":"Azr0_emerald"},color:"green","bold": false},{"text": "   - 索命连击 ×8 -",color:"gold","bold": true},{text:"   钻石 ",color:"aqua","bold": true},{"score":{"name":"@s","objective":"Azr_diamond"},color:"aqua","bold": false}]
execute if entity @s[tag=AZR_chainKill_activated] if entity @n[tag=MG_AZR0MOB,distance=0..19] run title @s[tag=AZR_chainKillUpg_countvisible,scores={AZR_chainKill_count=7}] actionbar [{text:"绿宝石 ",color:"green","bold": true},{"score":{"name":"@s","objective":"Azr0_emerald"},color:"green","bold": false},{"text": "   - 索命连击 ×7 -",color:"gold","bold": true},{text:"   钻石 ",color:"aqua","bold": true},{"score":{"name":"@s","objective":"Azr_diamond"},color:"aqua","bold": false}]
execute if entity @s[tag=AZR_chainKill_activated] if entity @n[tag=MG_AZR0MOB,distance=0..19] run title @s[tag=AZR_chainKillUpg_countvisible,scores={AZR_chainKill_count=6}] actionbar [{text:"绿宝石 ",color:"green","bold": true},{"score":{"name":"@s","objective":"Azr0_emerald"},color:"green","bold": false},{"text": "   - 索命连击 ×6 -",color:"gold","bold": true},{text:"   钻石 ",color:"aqua","bold": true},{"score":{"name":"@s","objective":"Azr_diamond"},color:"aqua","bold": false}]
execute if entity @s[tag=AZR_chainKill_activated] if entity @n[tag=MG_AZR0MOB,distance=0..19] run title @s[tag=AZR_chainKillUpg_countvisible,scores={AZR_chainKill_count=5}] actionbar [{text:"绿宝石 ",color:"green","bold": true},{"score":{"name":"@s","objective":"Azr0_emerald"},color:"green","bold": false},{"text": "   - 索命连击 ×5 -",color:"gold","bold": true},{text:"   钻石 ",color:"aqua","bold": true},{"score":{"name":"@s","objective":"Azr_diamond"},color:"aqua","bold": false}]
execute if entity @s[tag=AZR_chainKill_activated] if entity @n[tag=MG_AZR0MOB,distance=0..19] run title @s[tag=AZR_chainKillUpg_countvisible,scores={AZR_chainKill_count=4}] actionbar [{text:"绿宝石 ",color:"green","bold": true},{"score":{"name":"@s","objective":"Azr0_emerald"},color:"green","bold": false},{"text": "   - 索命连击 ×4 -",color:"gold","bold": true},{text:"   钻石 ",color:"aqua","bold": true},{"score":{"name":"@s","objective":"Azr_diamond"},color:"aqua","bold": false}]
execute if entity @s[tag=AZR_chainKill_activated] if entity @n[tag=MG_AZR0MOB,distance=0..19] run title @s[tag=AZR_chainKillUpg_countvisible,scores={AZR_chainKill_count=3}] actionbar [{text:"绿宝石 ",color:"green","bold": true},{"score":{"name":"@s","objective":"Azr0_emerald"},color:"green","bold": false},{"text": "   - 索命连击 ×3 -",color:"gold","bold": true},{text:"   钻石 ",color:"aqua","bold": true},{"score":{"name":"@s","objective":"Azr_diamond"},color:"aqua","bold": false}]
execute if entity @s[tag=AZR_chainKill_activated] if entity @n[tag=MG_AZR0MOB,distance=0..19] run title @s[tag=AZR_chainKillUpg_countvisible,scores={AZR_chainKill_count=2}] actionbar [{text:"绿宝石 ",color:"green","bold": true},{"score":{"name":"@s","objective":"Azr0_emerald"},color:"green","bold": false},{"text": "   - 索命连击 ×2 -",color:"gold","bold": true},{text:"   钻石 ",color:"aqua","bold": true},{"score":{"name":"@s","objective":"Azr_diamond"},color:"aqua","bold": false}]
execute if entity @s[tag=AZR_chainKill_activated] if entity @n[tag=MG_AZR0MOB,distance=0..19] run title @s[tag=AZR_chainKillUpg_countvisible,scores={AZR_chainKill_count=1}] actionbar [{text:"绿宝石 ",color:"green","bold": true},{"score":{"name":"@s","objective":"Azr0_emerald"},color:"green","bold": false},{"text": "   - 索命连击 ×1 -",color:"gold","bold": true},{text:"   钻石 ",color:"aqua","bold": true},{"score":{"name":"@s","objective":"Azr_diamond"},color:"aqua","bold": false}]
execute if entity @s[tag=AZR_chainKill_activated] if entity @n[tag=MG_AZR0MOB,distance=0..19] run title @s[tag=!AZR_chainKillUpg_countvisible] actionbar [{text:"绿宝石 ",color:"green","bold": true},{"score":{"name":"@s","objective":"Azr0_emerald"},color:"green","bold": false},{"text": "   - 索命连击 -",color:"gold","bold": true},{text:"   钻石 ",color:"aqua","bold": true},{"score":{"name":"@s","objective":"Azr_diamond"},color:"aqua","bold": false}]
