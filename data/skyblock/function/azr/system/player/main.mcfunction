...
execute if items entity @s hotbar.* *[custom_data~{azr_amulet_assassinate:1b}] run function skyblock:azr/system/player/skills/amulet/assassinate_core
execute if items entity @s container.* *[custom_data~{azr_amulet_assassinate:1b}] run function skyblock:azr/system/player/skills/amulet/assassinate_sneak_speed
...
execute if entity @s[tag=sprint_double_pass] unless block ~ ~ ~ #skyblock:water run function skyblock:azr/system/player/skills/amulet/sprint_double_core
execute if entity @s[tag=back_dodge_pass] unless block ~ ~ ~ #skyblock:water run function skyblock:azr/system/player/skills/amulet/back_dodge_core
execute if entity @s[tag=down_kick_pass] unless block ~ ~ ~ #skyblock:water run function skyblock:azr/system/player/skills/amulet/down_kick_core
