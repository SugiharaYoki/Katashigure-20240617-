...
tellraw @s [{"text":"- 获得登录奖励 -","color": "#f3db86","bold": true},{"text":"\n每日奖励已收纳至背包","color": "white","bold": false},{"text":"\n当前连续登录天数：","color": "white","bold": false},{"bold":false,"score":{"name":"@s","objective":"Azr_Login_Day_Strike"},"color": "white"},{"text": " [?]\n","color": "#272727","bold": false,"hover_event":{"action":"show_text","contents":{"text":"连续登录的天数越长，获得稀有奖励的概率就会越高。\n中断登录会从 1 开始重新计数！","color":"white"}}}]
