...
execute if score @s rng1 matches 1..10 run give @s copper_nautilus_armor[custom_name={text:"每日奖励 · 普通",italic:0b,color:"#ebbe1a",bold:1b},lore=[{text:"每日奖励",italic:0b,color:"#f3db86",bold:1b},{text:"快点打开看看有什么吧！",italic:0b,color:"#f3db86"},{text:""},{text:"希望会获得有用的道具。",italic:1b,color:"#586371"},{text:"按F(副手)开启",italic:0b,color:"green",bold:1b}],custom_data={azr_loginbonus:1b,azr_loginbonus_level_1:1b,azr_offhand_function:1b}]
execute if score @s rng1 matches 11..20 run give @s iron_nautilus_armor[custom_name={text:"每日奖励 · 珍贵",italic:0b,color:"#ebbe1a",bold:1b},lore=[{text:"每日奖励！",italic:0b,color:"#f3db86",bold:1b},{text:"快点打开看看有什么吧！",italic:0b,color:"#f3db86"},{text:""},{text:"应该会获得很有用的道具。",italic:1b,color:"#586371"},{text:"按F(副手)开启",italic:0b,color:"green",bold:1b}],custom_data={azr_loginbonus:1b,azr_loginbonus_level_2:1b,azr_offhand_function:1b}]
execute if score @s rng1 matches 21..30 run give @s golden_nautilus_armor[custom_name={text:"每日奖励 · 华丽",italic:0b,color:"#ebbe1a",bold:1b},lore=[{text:"每日奖励！！",italic:0b,color:"#f3db86",bold:1b},{text:"快点打开看看有什么吧！",italic:0b,color:"#f3db86"},{text:""},{text:"很大概率会获得相当有用的道具。",italic:1b,color:"#586371"},{text:"按F(副手)开启",italic:0b,color:"green",bold:1b}],custom_data={azr_loginbonus:1b,azr_loginbonus_level_3:1b,azr_offhand_function:1b}]
