...
execute positioned 0. 0. 0. as 0-0-0-0-0 run function skyblock:azr/system/utils/world_entity_get_motion_0_5
...
data modify entity @n[tag=arrow_temp] Owner set from entity @s Thrower