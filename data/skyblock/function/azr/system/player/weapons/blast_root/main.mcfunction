...
execute at @s facing entity @e[tag=AzrielMob,tag=!AzrielDecMob,distance=..3] feet rotated ~ 0 run function skyblock:azr/system/player/weapons/blast_root/trigger
