...
execute if entity @s[tag=AZR_in_nether_teleportation] positioned -79338 23 -414 if entity @n[tag=AzrielMob_utility_respawn_anchor,distance=..8] run tellraw @s [{text:"   - "},{text:"血金窟",color:"#c20600"},{text:" 曾在过去到访的居民区 隐秘的黑石支柱  ",color:"white"},{text:"〈◆〉",bold:1b,color:"aqua",click_event:{"action":"run_command","command":"trigger Azr_Shop set 40027"}}]
