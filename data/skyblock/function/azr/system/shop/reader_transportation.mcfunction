...
execute if entity @s[tag=AZR_in_nether_teleportation] positioned -79765 -17 -177 if entity @n[tag=AzrielMob_utility_respawn_anchor,distance=..8] run tellraw @s [{text:"   - "},{text:"绯烟林场",color:"#ed4d47"},{text:" 无顶的深坑  ",color:"white"},{text:"〈◆〉",bold:1b,color:"aqua",click_event:{"action":"run_command","command":"trigger Azr_Shop set 40020"}}]
...
execute if entity @s[tag=AZR_in_nether_teleportation] positioned -79758 23 -463 if entity @n[tag=AzrielMob_utility_respawn_anchor,distance=..8] run tellraw @s [{text:"   - "},{text:"绯烟林场",color:"#ed4d47"},{text:" 掩埋于林场的防空洞  ",color:"white"},{text:"〈◆〉",bold:1b,color:"aqua",click_event:{"action":"run_command","command":"trigger Azr_Shop set 40023"}}]
execute if entity @s[tag=AZR_in_nether_teleportation] positioned -79712 44 -386 if entity @n[tag=AzrielMob_utility_respawn_anchor,distance=..8] run tellraw @s [{text:"   - "},{text:"绯烟林场",color:"#ed4d47"},{text:" 岐误之井  ",color:"white"},{text:"〈◆〉",bold:1b,color:"aqua",click_event:{"action":"run_command","command":"trigger Azr_Shop set 40024"}}]
execute if entity @s[tag=AZR_in_nether_teleportation] positioned -79711 30 -486 if entity @n[tag=AzrielMob_utility_respawn_anchor,distance=..8] run tellraw @s [{text:"   - "},{text:"绯烟林场",color:"#ed4d47"},{text:" 第10与11辖区矿道 入口  ",color:"white"},{text:"〈◆〉",bold:1b,color:"aqua",click_event:{"action":"run_command","command":"trigger Azr_Shop set 40025"}}]
execute if entity @s[tag=AZR_in_nether_teleportation] positioned -79572 11 -414 if entity @n[tag=AzrielMob_utility_respawn_anchor,distance=..8] run tellraw @s [{text:"   - "},{text:"血金窟",color:"#c20600"},{text:" 第10与11辖区矿道 深处  ",color:"white"},{text:"〈◆〉",bold:1b,color:"aqua",click_event:{"action":"run_command","command":"trigger Azr_Shop set 40026"}}]
execute if entity @s[tag=AZR_in_nether_teleportation] positioned -79338 23 -414 if entity @n[tag=AzrielMob_utility_respawn_anchor,distance=..8] run tellraw @s [{text:"   - "},{text:"血金窟",color:"#c20600"},{text:" 经行之镇 隐秘的黑石支柱  ",color:"white"},{text:"〈◆〉",bold:1b,color:"aqua",click_event:{"action":"run_command","command":"trigger Azr_Shop set 40027"}}]
