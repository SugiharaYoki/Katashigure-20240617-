...
execute if score @s AzrResinCount matches 1.. if score stage Azr_system matches -2..10 run tellraw @s [{text:"   "},{text:"〈刷新商店〉",bold:1b,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 20"}},{text:"消耗 ",color:"white"},{"nbt":"ingredient.resin_clump","storage":"azr:shop",color:"white"},{text:"/1 树脂 ",color:"white"}]
