...
#print extra-buttons
execute unless items entity @s container.* resin_clump if score stage Azr_system matches -2..10 run tellraw @s [{"text":"   "},{"text":"〈刷新商店〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 20"}},{"text":"消耗 ","color":"#d9ffd2"},{"score":{"name":"@s","objective":"Azr_emerald"},"color":"#d9ffd2"},{"text":"/1 绿宝石 ","color":"#d9ffd2"}]
...
execute if items entity @s container.* resin_clump if score stage Azr_system matches -2..10 run tellraw @s [{"text":"   "},{"text":"〈刷新商店〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 20"}},{"text":"消耗 ","color":"white"},{"nbt":"ingredient.resin_clump","storage":"azr:shop","color":"white"},{"text":"/1 树脂 ","color":"white"}]
