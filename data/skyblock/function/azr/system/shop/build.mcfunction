...
#print extra-buttons
execute unless items entity @s container.* resin_clump if score stage Azr_system matches -2..10 run tellraw @s [{text:"   "},{text:"〈刷新商店〉",bold:true,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 20"}},{text:"消耗 ",color:"#d9ffd2"},{"score":{"name":"@s","objective":"Azr_emerald"},color:"#d9ffd2"},{text:"/1 绿宝石 ",color:"#d9ffd2"}]
execute unless items entity @s container.* resin_clump if score stage Azr_system matches 11..24 run tellraw @s [{text:"   "},{text:"〈壹〉",bold:true,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 21"}},{text:"〈贰〉",bold:true,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 22"}},{text:"消耗 ",color:"#d9ffd2"},{"score":{"name":"@s","objective":"Azr_emerald"},color:"#d9ffd2"},{text:"/3 绿宝石 ",color:"#d9ffd2"}]
execute unless items entity @s container.* resin_clump if score stage Azr_system matches 25..35 run tellraw @s [{text:"   "},{text:"〈壹〉",bold:true,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 21"}},{text:"〈贰〉",bold:true,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 22"}},{text:"〈叁〉",bold:true,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 23"}},{text:"消耗 ",color:"#d9ffd2"},{"score":{"name":"@s","objective":"Azr_emerald"},color:"#d9ffd2"},{text:"/3 绿宝石 ",color:"#d9ffd2"}]
execute unless items entity @s container.* resin_clump if score stage Azr_system matches 36..130 run tellraw @s [{text:"   "},{text:"〈壹〉",bold:true,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 21"}},{text:"〈贰〉",bold:true,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 22"}},{text:"〈叁〉",bold:true,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 23"}},{text:"〈肆〉",bold:true,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 24"}},{text:"消耗 ",color:"#d9ffd2"},{"score":{"name":"@s","objective":"Azr_emerald"},color:"#d9ffd2"},{text:"/3 绿宝石 ",color:"#d9ffd2"}]
execute if items entity @s container.* resin_clump if score stage Azr_system matches -2..10 run tellraw @s [{text:"   "},{text:"〈刷新商店〉",bold:true,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 20"}},{text:"消耗 ",color:"white"},{"nbt":"ingredient.resin_clump","storage":"azr:shop",color:"white"},{text:"/1 树脂 ",color:"white"}]
...
execute if entity @s[tag=AZR_SEAawakened] run tellraw @s [{text:"   "},{text:"〈雷米尔的指引〉",bold:true,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 3"}}]
#print last line
tellraw @s {text:"   "}
