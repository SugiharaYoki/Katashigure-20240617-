...
execute if score @s Azr_Shop_rng7 matches -1 store result score @s Azr_Shop_rng7 run random value 51..58
execute if score @s Azr_Shop_rng8 matches -1 store result score @s Azr_Shop_rng8 run random value 51..58
execute if score @s Azr_Shop_rng9 matches -1 store result score @s Azr_Shop_rng9 run random value 51..58
