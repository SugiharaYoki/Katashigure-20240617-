...
tellraw @s [{"text":"   - "},{"text":"对活物箭(Lv1) ×12","color":"white"},{"text":"  1 木棍 4 丝线 ","color":"gold"},{"text":"〈◆〉","bold":true,"color":"green","click_event":{"action":"run_command","value":"/trigger Azr_Shop set 8431513"},"hover_event":{"action":"show_text","contents":{"text":"相当于瞬间伤害箭矢","color":"white"}}}]
tellraw @s [{"text":"   - "},{"text":"对亡灵箭(Lv1) ×12","color":"white"},{"text":"  1 虫骸 1 硬骨 ","color":"gold"},{"text":"〈◆〉","bold":true,"color":"green","click_event":{"action":"run_command","value":"/trigger Azr_Shop set 8431514"},"hover_event":{"action":"show_text","contents":{"text":"相当于瞬间治疗箭矢","color":"white"}}}]
...
execute unless entity @s[scores={AZR_arrowUpg_pts=1..}] run tellraw @s [{"text":"   - "},{"text":"主动灵能「残城箭影」","color":"white"},{"text":"  5 锁链 ","color":"gold"},{"text":"〈◆〉","bold":true,"color":"green","click_event":{"action":"run_command","value":"/trigger Azr_Shop set 8431517"},"hover_event":{"action":"show_text","contents":{"text":"射出魔法箭矢","color":"white"}}}]
