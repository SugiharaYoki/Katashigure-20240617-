...
tellraw @s [{"text":"   - "},{"text":"对活物箭(Lv1) ×12","color":"white"},{"text":"  1 木棍 4 丝线 ","color":"gold"},{"text":"〈◆〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8431513"},"hoverEvent":{"action":"show_text","contents":{"text":"相当于瞬间伤害箭矢","color":"white"}}}]
...
tellraw @s [{"text":"   - "},{"text":"圣殿信条","color":"white"},{"text":"  1 被污染的信条 ","color":"gold"},{"text":"〈◆〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8431516"}}]
