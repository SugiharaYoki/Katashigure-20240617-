...
$execute unless data storage azr:handbook_vitae doc.$(eid).zombie_villager_armor run tellraw @s [{"text":"★★？","color":"#786897"}]
$execute if data storage azr:handbook_vitae doc.$(eid).zombie_villager_armor run tellraw @s [{"text":"★★亡灵盔甲匠","color":"#8644ff","hoverEvent":{"action":"show_text","contents":[{"text":"类型：亡魂\n","color":"#9c55ff","bold": true},{"text":"攻击方式：近战 辅助\n","color":"#ffa463","bold": true},{"text":"行动缓慢，自身无法造成太大威胁。\n但它会持续给周围的其他亡魂类敌人施加高额减伤。\n不优先将它解决的话，恐怕会在面对敌群时陷入苦战。","color":"white","bold": false}]}}]
$execute unless data storage azr:handbook_vitae doc.$(eid).zombie_villager_cleric run tellraw @s [{"text":"★★？","color":"#786897"}]
$execute if data storage azr:handbook_vitae doc.$(eid).zombie_villager_cleric run tellraw @s [{"text":"★★亡灵法师","color":"#8644ff","hoverEvent":{"action":"show_text","contents":[{"text":"类型：亡魂\n","color":"#9c55ff","bold": true},{"text":"攻击方式：近战 中程陷阱\n","color":"#ffa463","bold": true},{"text":"行动缓慢，每隔一段时间会在周围释放尖刺陷阱。\n肉体刀枪不入，唯有在施法前后才可能受伤。","color":"white","bold": false}]}}]
