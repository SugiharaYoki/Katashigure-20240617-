...
{"selector":"@n[tag=AzrSariel_displaymarker1]","color":"#ffb65d","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432101"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：60\n基础防御 +1","color":"white"}}},\
{"selector":"@n[tag=AzrSariel_displaymarkerE]","color":"dark_gray"},\
{"selector":"@n[tag=AzrSariel_displaymarker1C]","color":"#ff5dd7","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432136"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：30\n生命上限 +2","color":"white"}}},\
...
{"selector":"@n[tag=AzrSariel_displaymarker1E]","color":"#576e03","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432138"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：30\n护甲韧性 +1\n击退抗性 +15%","color":"white"}}}]

tellraw @s [{"text":" ","color":"light_purple"},\
{"selector":"@n[tag=AzrSariel_displaymarker0b]","color":"dark_gray"},\
{"selector":"@n[tag=AzrSariel_displaymarker2]","color":"#ff5dd7","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432102"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：40\n生命上限 +2","color":"white"}}},\
{"selector":"@n[tag=AzrSariel_displaymarkerE]","color":"dark_gray"},\
{"selector":"@n[tag=AzrSariel_displaymarkerE]","color":"dark_gray"},\
...
{"selector":"@n[tag=AzrSariel_displaymarker3E]","color":"#576e03","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432139"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：40\n护甲韧性 +1\n击退抗性 +15%","color":"white"}}}]
...
{"selector":"@n[tag=AzrSariel_displaymarkerE]","color":"dark_gray"},\
{"selector":"@n[tag=AzrSariel_displaymarkerE]","color":"dark_gray"},\
{"selector":"@n[tag=AzrSariel_displaymarker4D]","color":"#ffb0ff","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432129"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：20\n造成点数超过6的攻击时，有8%概率在最近的敌人处制造一个理之花团\n触碰理之花团可以对3.5格内的所有亡魂与凶兽造成伤害，并恢复范围内队友生命\n伤害：3/5/7（对亡魂翻倍） 治疗：2/4/8 存在时长：60\n重复选中将升级效果","color":"white"}}}]
...
{"selector":"@n[tag=AzrSariel_displaymarker5E]","color":"#576e03","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432140"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：50\n护甲韧性 +1\n击退抗性 +15%","color":"white"}}}]
...
{"selector":"@n[tag=AzrSariel_displaymarkerE]","color":"dark_gray"},\
{"selector":"@n[tag=AzrSariel_displaymarker6C]","color":"#ffe3af","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432120"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：20\n每8秒获得一次绝对防御\n受到任何伤害都将解除绝对防御效果","color":"white"}}},\
{"selector":"@n[tag=AzrSariel_displaymarkerE]","color":"dark_gray"}]
...
{"selector":"@n[tag=AzrSariel_displaymarker7C]","color":"#ffec5d","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432126"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：40\n「能力解放」「全队共享」\n拾取绿宝石时有20%的概率获得双倍","color":"white"}}},\
{"selector":"@n[tag=AzrSariel_displaymarkerE]","color":"dark_gray"}]
...
tellraw @s [{"text":" ","color":"light_purple"},\
{"selector":"@n[tag=AzrSariel_displaymarker0b]","color":"dark_gray"},\
{"selector":"@n[tag=AzrSariel_displaymarker12]","color":"#ff5d5d","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432112"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：40\n攻击力 +0.5","color":"white"}}},\
{"selector":"@n[tag=AzrSariel_displaymarkerE]","color":"dark_gray"},\
...
tellraw @s [{"text":" ","color":"light_purple"},\
{"selector":"@n[tag=AzrSariel_displaymarker0b]","color":"dark_gray"},\
{"selector":"@n[tag=AzrSariel_displaymarker13]","color":"#7b5dff","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432113"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：40\n攻击速度 +0.1","color":"white"}}},\
...
{"selector":"@n[tag=AzrSariel_displaymarker13D]","color":"#7b5dff","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432137"},"hoverEvent":{"action":"show_text","contents":{"text":"消耗：30\n攻击速度 +0.1","color":"white"}}}]
