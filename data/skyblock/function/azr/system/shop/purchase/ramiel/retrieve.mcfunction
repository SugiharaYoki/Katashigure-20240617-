...
execute if entity @s[tag=AZS_BoS01] if score @s Azr_Shop matches 8432301 run function skyblock:azr/assets/items/amulets/assassinate
execute if entity @s[tag=AZS_BoS02] if score @s Azr_Shop matches 8432302 run function skyblock:azr/assets/items/amulets/flower_spike
...
execute if entity @s[tag=AZS_BoS08] if score @s Azr_Shop matches 8432308 run function skyblock:azr/assets/items/amulets/flower_wall_fire
...
execute if entity @s[tag=AZS_BoS10] if score @s Azr_Shop matches 8432310 run function skyblock:azr/assets/items/amulets/fire_drogue_dash
...
execute if entity @s[tag=AZS_BoS12] if score @s Azr_Shop matches 8432312 run function skyblock:azr/assets/items/amulets/water_wade
...
execute if entity @s[tag=AZS_BoS15] if score @s Azr_Shop matches 8432315 run function skyblock:azr/assets/items/amulets/arrow_tripler
execute if entity @s[tag=AZS_BoS16] if score @s Azr_Shop matches 8432316 run function skyblock:azr/assets/items/amulets/laser_drag
...
execute if entity @s[tag=AZS_BoS23] if score @s Azr_Shop matches 8432323 run function skyblock:azr/assets/items/amulets/wind_shear
...
execute if entity @s[scores={Azr_skillPoints=10..},tag=AZS_BoSShop09,tag=!AZS_BoSShop10] if score @s Azr_Shop matches 8432332 run function skyblock:azr/assets/items/amulets/light_angel_2
