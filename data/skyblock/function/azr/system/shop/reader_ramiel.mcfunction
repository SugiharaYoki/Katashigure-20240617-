...
tellraw @s [{text:" - "},{text:"心跳仪  ",color:"#306fc2"},{"score":{"name":"@s","objective":"AzrMelonCount"},color:"#fff5c2"},{text:"/1 金西瓜 ",color:"#fff5c2"},{text:"〈◆〉","bold":true,color:"green",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8431553"},hover_event:{"action":"show_text","value":{text:"背包常效装备\n在生命值过低时给予心跳声警报\n只在8格内存在敌人时有效",color:"white"}}},{text:"  起搏器  ",color:"#306fc2"},{"score":{"name":"@s","objective":"AzrMelonCount"},color:"#fff5c2"},{text:"/4 金西瓜 ",color:"#fff5c2"},{text:"〈◆〉","bold":true,color:"green",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8431554"},hover_event:{"action":"show_text","value":{text:"背包常效装备\n生命值低于4时自动恢复32生命值\n拥有40秒的冷却时间\n\n可以在背包内切换为“安全模式”，生命值低于8便会自动恢复生命值",color:"white"}}}]

tellraw @s [{text:" - "},{text:"蜂棘护甲  ",color:"#cd8107"},{"score":{"name":"@s","objective":"AzrMelonCount"},color:"#fff5c2"},{text:"/2 金西瓜 ",color:"#fff5c2"},{text:"〈盔〉","bold":true,color:"green",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8431555"},hover_event:{"action":"show_text","value":{text:"无限耐久的护甲，拥有荆棘反伤，但防御力与锁链甲持平",color:"white"}}},{text:"〈胸〉","bold":true,color:"green",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8431556"},hover_event:{"action":"show_text","value":{text:"无限耐久的护甲，拥有荆棘反伤，但防御力与锁链甲持平",color:"white"}}},{text:"〈腿〉","bold":true,color:"green",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8431557"},hover_event:{"action":"show_text","value":{text:"无限耐久的护甲，拥有荆棘反伤，但防御力与锁链护甲持平",color:"white"}}},{text:"〈靴〉","bold":true,color:"green",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8431558"},hover_event:{"action":"show_text","value":{text:"无限耐久的护甲，拥有荆棘反伤，但防御力与锁链甲持平",color:"white"}}}]
...
{selector:"@n[tag=AzrRamielExStage_displaymarkera]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432301"},hover_event:{"action":"show_text","value":{text:"Appetence",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkerb]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432302"},hover_event:{"action":"show_text","value":{text:"Breakout",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkerc]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432303"},hover_event:{"action":"show_text","value":{text:"Cerement - 贪婪石板\n增加拾取范围",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkerd]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432304"},hover_event:{"action":"show_text","value":{text:"Diffident - 花墙石板\n按前进键增加攻防",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkere]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432305"},hover_event:{"action":"show_text","value":{text:"Entertain - 冲刺石板\n按两下跑步进行冲刺",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkerf]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432306"},hover_event:{"action":"show_text","value":{text:"Flux - 燃点卷宗\n剑攻击点燃、加强节制天平扇形火",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkerg]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432307"},hover_event:{"action":"show_text","value":{text:"Guise - 滋育石板\n蹲下时移动速度减少、攻击力减少、防御力增加、缓慢恢复生命",color:"white"}}},\
{text:"\n "},\
{selector:"@n[tag=AzrRamielExStage_displaymarkerh]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432308"},hover_event:{"action":"show_text","value":{text:"???",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkeri]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432309"},hover_event:{"action":"show_text","value":{text:"Index - 斥跃石板\n蹲下跳得更高、史莱姆块助跳",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkerj]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432310"},hover_event:{"action":"show_text","value":{text:"???",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkerk]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432311"},hover_event:{"action":"show_text","value":{text:"Kinetic - 悬风石板\n按两下跳跃后长按以减缓下落",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkerl]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432312"},hover_event:{"action":"show_text","value":{text:"???",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkerm]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432313"},hover_event:{"action":"show_text","value":{text:"???",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkern]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432314"},hover_event:{"action":"show_text","value":{text:"???",color:"white"}}},\
{text:"\n "},\
{selector:"@n[tag=AzrRamielExStage_displaymarkero]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432315"},hover_event:{"action":"show_text","value":{text:"???",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkerp]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432316"},hover_event:{"action":"show_text","value":{text:"???",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkerq]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432317"},hover_event:{"action":"show_text","value":{text:"???",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkerr]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432318"},hover_event:{"action":"show_text","value":{text:"???",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkers]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432319"},hover_event:{"action":"show_text","value":{text:"???",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkert]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432320"},hover_event:{"action":"show_text","value":{text:"???",color:"white"}}},\
{text:"\n "},\
{selector:"@n[tag=AzrRamielExStage_displaymarkeru]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432321"},hover_event:{"action":"show_text","value":{text:"???",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkerv]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432322"},hover_event:{"action":"show_text","value":{text:"Vestige - 迫坠石板\n空中按shift快速下坠，25%+索命连击充能时启动下砸，下砸期间可长按启动退避石板",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkerw]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432323"},hover_event:{"action":"show_text","value":{text:"???",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkerx]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432324"},hover_event:{"action":"show_text","value":{text:"Xenia？",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkery]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432325"},hover_event:{"action":"show_text","value":{text:"???",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkerz]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432326"},hover_event:{"action":"show_text","value":{text:"???",color:"white"}}},\
{text:"\n "},\
{selector:"@n[tag=AzrRamielExStage_displaymarker1]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432327"},hover_event:{"action":"show_text","value":{text:"权之残影 - 天界怀表\n在波数暂停时手持，可以冻结计时",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarker2]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432330"},hover_event:{"action":"show_text","value":{text:"马林努斯 - 岚切卷宗\n斧攻击自动延时二次攻击、左右移动时加强剑的范围伤害",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarker3]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432332"},hover_event:{"action":"show_text","value":{text:"权之残影 - 光明天使的符文\n迫坠、退避、冲刺石板整合、施放时无敌帧",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkerBa]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432331"},hover_event:{"action":"show_text","value":{text:"阴影处刑者 - 退避石板\n连按后退键快速后撤步",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkerBd]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432329"},hover_event:{"action":"show_text","value":{text:"锅炉驱动者 - 逐焰卷宗\n持续召唤最多3个跟随火球，减少节制天平电球最低间隔时长",color:"white"}}},\
{selector:"@n[tag=AzrRamielExStage_displaymarkerBm]",color:"#70a0df",click_event:{"action":"run_command","value":"/trigger Azr_Shop set 8432328"},hover_event:{"action":"show_text","value":{text:"噬藓母虫 - 深藓石板\n造成攻击可增加“索命连击”充能、在重生锚点可获得5分钟孢子的庇护（生命值上限加成）",color:"white"}}}]
