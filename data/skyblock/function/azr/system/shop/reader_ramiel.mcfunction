...
execute if score stage Azr_system matches ..69 run tellraw @s[tag=AzrSariel_sub_stardeplete] [{text:" - "},{text:"下界命星  ",color:"#935dff"},{text:"〈◆〉",bold:1b,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 8431551"}},{text:"  人造心脏  ",color:"#5910b9"},{"score":{"name":"@s","objective":"AzrMelonCount"},color:"#fff5c2"},{text:"/1 金西瓜 ",color:"#fff5c2"},{text:"〈◆〉",bold:1b,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 8431567"},hover_event:{"action":"show_text","value":{text:"背包常效装备\n受到伤害时，获得一行额外的临时血量\n【你将无法抵达真实的结局】",color:"white"}}}]
execute if score stage Azr_system matches 70.. run tellraw @s[tag=AzrSariel_sub_stardeplete] [{text:" - "},{text:"下界命星  ",color:"#935dff"},{text:"〈◆〉",bold:1b,color:"green",click_event:{"action":"run_command","command":"trigger Azr_Shop set 8431551"}}]
...
#8431630 8431631 8431632 8431633 8431634 8431635 被罗福凯尔占用
...
execute if items entity @s container.* *[custom_data~{azr_amulet_assassinate:1b}] run data modify entity @n[tag=AzrRamielExStage_displaymarkera] CustomName set value ' √ '
...
execute if entity @s[scores={Azr_skillPoints=20..}] run data modify entity @n[tag=AzrRamielExStage_displaymarkerBc] CustomName set value ' - '
execute if entity @s[scores={Azr_skillPoints=20..}] run data modify entity @n[tag=AzrRamielExStage_displaymarkerBl] CustomName set value ' - '
...
execute if items entity @s container.* *[custom_data~{azr_amulet_light_angel_3:1b}] run data modify entity @n[tag=AzrRamielExStage_displaymarker4] CustomName set value ' - '
execute if items entity @s container.* *[custom_data~{azr_amulet_light_angel_3:1b}] run data modify entity @n[tag=AzrRamielExStage_displaymarkerl] CustomName set value ' - '
