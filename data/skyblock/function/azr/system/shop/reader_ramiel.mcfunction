...
data modify entity @n[tag=AzrRamielExStage_displaymarker1] CustomName set value ' <钟> '
data modify entity @n[tag=AzrRamielExStage_displaymarker2] CustomName set value ' <斧> '
