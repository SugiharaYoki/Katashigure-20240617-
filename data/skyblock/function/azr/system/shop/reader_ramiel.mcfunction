...
tellraw @s [{"text":" - "},{"text":"心跳仪  ","color":"#306fc2"},{"score":{"name":"@s","objective":"AzrMelonCount"},"color":"#fff5c2"},{"text":"/1 金西瓜 ","color":"#fff5c2"},{"text":"〈◆〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8431553"},"hoverEvent":{"action":"show_text","contents":{"text":"背包常效装备\n在生命值过低时给予心跳声警报\n只在8格内存在敌人时有效","color":"white"}}},{"text":"  起搏器  ","color":"#306fc2"},{"score":{"name":"@s","objective":"AzrMelonCount"},"color":"#fff5c2"},{"text":"/4 金西瓜 ","color":"#fff5c2"},{"text":"〈◆〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8431554"},"hoverEvent":{"action":"show_text","contents":{"text":"背包常效装备\n生命值低于4时自动恢复32生命值\n拥有40秒的冷却时间\n\n可以在背包内切换为“安全模式”，生命值低于8便会自动恢复生命值","color":"white"}}}]

tellraw @s [{"text":" - "},{"text":"蜂棘护甲  ","color":"#cd8107"},{"score":{"name":"@s","objective":"AzrMelonCount"},"color":"#fff5c2"},{"text":"/2 金西瓜 ","color":"#fff5c2"},{"text":"〈盔〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8431555"},"hoverEvent":{"action":"show_text","contents":{"text":"无限耐久的护甲，拥有荆棘反伤，但防御力与锁链甲持平","color":"white"}}},{"text":"〈胸〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8431556"},"hoverEvent":{"action":"show_text","contents":{"text":"无限耐久的护甲，拥有荆棘反伤，但防御力与锁链甲持平","color":"white"}}},{"text":"〈腿〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8431557"},"hoverEvent":{"action":"show_text","contents":{"text":"无限耐久的护甲，拥有荆棘反伤，但防御力与锁链护甲持平","color":"white"}}},{"text":"〈靴〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8431558"},"hoverEvent":{"action":"show_text","contents":{"text":"无限耐久的护甲，拥有荆棘反伤，但防御力与锁链甲持平","color":"white"}}}]
...
execute if entity @s[tag=AZS_BoS03] run data modify entity @n[tag=AzrRamielExStage_displaymarkerc] CustomName set value '" <C> "'
execute if entity @s[tag=AZS_BoS04] run data modify entity @n[tag=AzrRamielExStage_displaymarkerd] CustomName set value '" <D> "'
execute if entity @s[tag=AZS_BoS05] run data modify entity @n[tag=AzrRamielExStage_displaymarkere] CustomName set value '" <E> "'
execute if entity @s[tag=AZS_BoS06] run data modify entity @n[tag=AzrRamielExStage_displaymarkerf] CustomName set value '" <F> "'
execute if entity @s[tag=AZS_BoS07] run data modify entity @n[tag=AzrRamielExStage_displaymarkerg] CustomName set value '" <G> "'
execute if entity @s[tag=AZS_BoS08] run data modify entity @n[tag=AzrRamielExStage_displaymarkerh] CustomName set value '" <H> "'
execute if entity @s[tag=AZS_BoS09] run data modify entity @n[tag=AzrRamielExStage_displaymarkeri] CustomName set value '" <I> "'
execute if entity @s[tag=AZS_BoS10] run data modify entity @n[tag=AzrRamielExStage_displaymarkerj] CustomName set value '" <J> "'
execute if entity @s[tag=AZS_BoS11] run data modify entity @n[tag=AzrRamielExStage_displaymarkerk] CustomName set value '" <K> "'
execute if entity @s[tag=AZS_BoS12] run data modify entity @n[tag=AzrRamielExStage_displaymarkerl] CustomName set value '" <L> "'
execute if entity @s[tag=AZS_BoS13] run data modify entity @n[tag=AzrRamielExStage_displaymarkerm] CustomName set value '" <M> "'
execute if entity @s[tag=AZS_BoS14] run data modify entity @n[tag=AzrRamielExStage_displaymarkern] CustomName set value '" <N> "'
execute if entity @s[tag=AZS_BoS15] run data modify entity @n[tag=AzrRamielExStage_displaymarkero] CustomName set value '" <O> "'
execute if entity @s[tag=AZS_BoS16] run data modify entity @n[tag=AzrRamielExStage_displaymarkerp] CustomName set value '" <P> "'
execute if entity @s[tag=AZS_BoS17] run data modify entity @n[tag=AzrRamielExStage_displaymarkerq] CustomName set value '" <Q> "'
execute if entity @s[tag=AZS_BoS18] run data modify entity @n[tag=AzrRamielExStage_displaymarkerr] CustomName set value '" <R> "'
execute if entity @s[tag=AZS_BoS19] run data modify entity @n[tag=AzrRamielExStage_displaymarkers] CustomName set value '" <S> "'
execute if entity @s[tag=AZS_BoS20] run data modify entity @n[tag=AzrRamielExStage_displaymarkert] CustomName set value '" <T> "'
execute if entity @s[tag=AZS_BoS21] run data modify entity @n[tag=AzrRamielExStage_displaymarkeru] CustomName set value '" <U> "'
execute if entity @s[tag=AZS_BoS22] run data modify entity @n[tag=AzrRamielExStage_displaymarkerv] CustomName set value '" <V> "'
execute if entity @s[tag=AZS_BoS23] run data modify entity @n[tag=AzrRamielExStage_displaymarkerw] CustomName set value '" <W> "'
...
{"selector":"@n[tag=AzrRamielExStage_displaymarkerc]","color":"#70a0df","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432303"},"hoverEvent":{"action":"show_text","contents":{"text":"Cerement - 贪婪石板","color":"white"}}},\
{"selector":"@n[tag=AzrRamielExStage_displaymarkerd]","color":"#70a0df","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432304"},"hoverEvent":{"action":"show_text","contents":{"text":"Diffident - 花墙石板","color":"white"}}},\
{"selector":"@n[tag=AzrRamielExStage_displaymarkere]","color":"#70a0df","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432305"},"hoverEvent":{"action":"show_text","contents":{"text":"Entertain - 冲刺石板","color":"white"}}},\
{"selector":"@n[tag=AzrRamielExStage_displaymarkerf]","color":"#70a0df","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432306"},"hoverEvent":{"action":"show_text","contents":{"text":"Flux - 燃点卷宗","color":"white"}}},\
...
{"selector":"@n[tag=AzrRamielExStage_displaymarkerk]","color":"#70a0df","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432311"},"hoverEvent":{"action":"show_text","contents":{"text":"Kinetic - 悬风石板","color":"white"}}},\
...
{"selector":"@n[tag=AzrRamielExStage_displaymarkerm]","color":"#70a0df","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432313"},"hoverEvent":{"action":"show_text","contents":{"text":"???","color":"white"}}},\
{"selector":"@n[tag=AzrRamielExStage_displaymarkern]","color":"#70a0df","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432314"},"hoverEvent":{"action":"show_text","contents":{"text":"???","color":"white"}}},\
{"text":"\n "},\
{"selector":"@n[tag=AzrRamielExStage_displaymarkero]","color":"#70a0df","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432315"},"hoverEvent":{"action":"show_text","contents":{"text":"???","color":"white"}}},\
{"selector":"@n[tag=AzrRamielExStage_displaymarkerp]","color":"#70a0df","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432316"},"hoverEvent":{"action":"show_text","contents":{"text":"???","color":"white"}}},\
{"selector":"@n[tag=AzrRamielExStage_displaymarkerq]","color":"#70a0df","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432317"},"hoverEvent":{"action":"show_text","contents":{"text":"???","color":"white"}}},\
{"selector":"@n[tag=AzrRamielExStage_displaymarkerr]","color":"#70a0df","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432318"},"hoverEvent":{"action":"show_text","contents":{"text":"???","color":"white"}}},\
{"selector":"@n[tag=AzrRamielExStage_displaymarkers]","color":"#70a0df","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432319"},"hoverEvent":{"action":"show_text","contents":{"text":"???","color":"white"}}},\
{"selector":"@n[tag=AzrRamielExStage_displaymarkert]","color":"#70a0df","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432320"},"hoverEvent":{"action":"show_text","contents":{"text":"???","color":"white"}}},\
{"text":"\n "},\
...
{"selector":"@n[tag=AzrRamielExStage_displaymarkerv]","color":"#70a0df","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432322"},"hoverEvent":{"action":"show_text","contents":{"text":"Vestige - 岚切卷宗","color":"white"}}},\
...
#tellraw @s[tag=AZS_BoS01] [{"text":"   "},{"text":"蜘蛛狼护腿","color":"red"},{"text":"   1 碳钢 3 丝线 2 虫骸 ","color":"gold"},{"text":"〈◆〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8431540"}},{"text":" || 短靴","color":"red"},{"text":"   1 碳钢 3 丝线 2 蜘蛛眼 ","color":"gold"},{"text":"〈◆〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8431535"}}]
#tellraw @s[tag=AZS_BoS01] [{"text":"   "},{"text":"蜘蛛狼铠甲","color":"red"},{"text":"   1 腐烂的尸首 3 丝线 ","color":"gold"},{"text":"〈◆〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8431544"}}]
#tellraw @s[tag=AZS_BoS07,tag=!AZS_BoS08] [{"text":"   "},{"text":"试造防弹甲","color":"red"},{"text":"   3 盾牌碎片 3 硬骨 ","color":"gold"},{"text":"〈◆〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8431545"}}]
#tellraw @s[tag=AZS_BoS07,tag=AZS_BoS08] [{"text":"   "},{"text":"试造防弹甲","color":"red"},{"text":"   3 盾牌碎片 3 硬骨 ","color":"gold"},{"text":"〈◆〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8431545"}},{"text":" || ","color":"red"},{"text":"（改）","color":"dark_purple"},{"text":" +3 炽焰粉尘 ","color":"gold"},{"text":"〈◆〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8431546"}}]
#tellraw @s {"text":"   "}
#tellraw @s[tag=AZS_BoS05] [{"text":"   "},{"text":"投掷瓶·静止 LV1","color":"red"},{"text":"   6 丝线 ","color":"gold"},{"text":"〈◆〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8431542"}},{"text":" || LV2","color":"red"},{"text":"   +2 粘液球 ","color":"gold"},{"text":"◆〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8431543"}}]
#tellraw @s[tag=AZS_BoS06] [{"text":"   "},{"text":"弹簧箭盒 ×1","color":"red"},{"text":"   2 木炭 5 箭 )>( 1 甜菜种子 6 箭 ","color":"gold"},{"text":"〈◆〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8431537"}}]
##tellraw @s {"text":"   "}
