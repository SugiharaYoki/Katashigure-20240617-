...
tellraw @s [{"text":" - "},{"text":"下界命星  ","color":"#935dff"},{"text":"〈◆〉","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8431551"}}]
...
execute if items entity @s container.* *[custom_data~{azr_amulet_axe_vortex:1b}] run data modify entity @n[tag=AzrRamielExStage_displaymarkerv] CustomName set value '" √ "'
...
{"selector":"@n[tag=AzrRamielExStage_displaymarkerv]","color":"#70a0df","clickEvent":{"action":"run_command","value":"/trigger Azr_Shop set 8432322"},"hoverEvent":{"action":"show_text","contents":{"text":"Vestige - 迫坠石板\n空中按shift快速下坠，25%+索命连击充能时启动下砸，下砸期间可长按启动退避石板","color":"white"}}},\
