...
execute unless items entity @s player.crafting.0 *[!custom_data~{LifeVitae:1b}] if entity @s[tag=!azrBanLifeVitae,tag=!azrUpgrateLifeVitae] run item replace entity @s player.crafting.0 with minecraft:knowledge_book[custom_name={bold:1b,italic:0b,color:"gold",text:"生命手册"},lore=[{italic:0b,text:"选定以展开商店页面"}],custom_data={LifeVitae:1b,SlotLock:36b,Vitae:1b},custom_model_data={floats:[100001.0]}]
execute unless items entity @s player.crafting.0 *[!custom_data~{LifeVitae:1b}] if entity @s[tag=azrBanLifeVitae,tag=!azrUpgrateLifeVitae] run item replace entity @s player.crafting.0 with minecraft:book[custom_name={bold:1b,italic:0b,color:"dark_gray",text:"黯淡的生命手册"},lore=[{italic:0b,text:"选定以展开商店页面..?"}],custom_data={LifeVitae:1b,SlotLock:36b,Vitae:1b},custom_model_data={floats:[100001.0]}]
execute unless items entity @s player.crafting.0 *[!custom_data~{LifeVitae:1b}] if entity @s[tag=!azrBanLifeVitae,tag=azrUpgrateLifeVitae] run item replace entity @s player.crafting.0 with minecraft:knowledge_book[custom_name={bold:1b,italic:0b,color:"gold",text:"神圣手册"},lore=[{italic:0b,text:"选定以展开商店页面"}],custom_data={LifeVitae:1b,SlotLock:36b,Vitae:1b},custom_model_data={floats:[100001.0]}]
execute unless items entity @s player.crafting.0 *[!custom_data~{LifeVitae:1b}] if entity @s[tag=azrBanLifeVitae,tag=azrUpgrateLifeVitae] run item replace entity @s player.crafting.0 with minecraft:barrier[custom_name={bold:1b,italic:0b,color:"red",text:"生命手册出现严重错误"},lore=[{italic:0b,text:"请迅速联系管理员",color:"white"},{text:"手持该物品以显示错误信息",color:"white",italic:0b}],custom_data={LifeVitae:1b,SlotLock:36b,Error:1b,Vitae:1b},custom_model_data={floats:[100001.0]}]
#execute unless items entity @s player.crafting.1 *[!custom_data~{PsychicVitae:1b}] if entity @s[scores={AZR_chainKillUpg_pts=1..}] run item replace entity @s player.crafting.1 with minecraft:enchanted_book[custom_name={bold:1b,italic:0b,color:"gold",text:"灵能手册"},lore=[{italic:0b,text:"在物品栏选定以展开索命连击升级页面"}],custom_data={PsychicVitae:1b}]
execute unless items entity @s player.crafting.1 *[!custom_data~{PsychicVitae:1b}] if entity @s[tag=hasLifeVitae] run item replace entity @s player.crafting.1 with minecraft:enchanted_book[custom_name={bold:1b,italic:0b,color:"gold",text:"索命连击"},lore=[{italic:0b,text:"选定以展开索命连击升级页面"}],custom_data={PsychicVitae:1b,Vitae:1b},custom_model_data={floats:[100001.0]}]
execute unless items entity @s player.crafting.2 *[!custom_data~{SarielVitae:1b}] if entity @s[tag=hasLifeVitae] run item replace entity @s player.crafting.2 with minecraft:enchanted_book[custom_name={bold:1b,italic:0b,color:"gold",text:"节制天平"},lore=[{italic:0b,text:"选定以展开节制天平升级页面"}],custom_data={SarielVitae:1b,Vitae:1b}]
execute unless items entity @s player.crafting.3 *[!custom_data~{HandbookVitae:1b}] run item replace entity @s player.crafting.3 with minecraft:writable_book[custom_name={bold:1b,italic:0b,color:"gold",text:"怪物图鉴"},lore=[{italic:0b,text:"选定以浏览敌人图鉴"}],custom_data={HandbookVitae:1b,Vitae:1b}]


#绿宝石管理
execute if items entity @s[tag=hasLifeVitae] container.* gold_nugget run function skyblock:azr/system/shop/gold_conversion
