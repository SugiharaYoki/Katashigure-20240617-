...
execute if score @s Azr_Shop_rng4 matches -1 store result score @s Azr_Shop_rng4 run random value 21..27
execute if score @s Azr_Shop_rng5 matches -1 store result score @s Azr_Shop_rng5 run random value 21..27
execute if score @s Azr_Shop_rng6 matches -1 store result score @s Azr_Shop_rng6 run random value 21..27
