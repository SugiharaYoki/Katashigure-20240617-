...
execute if score @s Azr_skillPoints matches 19.. run tellraw @s [{text:"        - "},{text:"间章",color:"#4d4a46"},{text:" 邃栈  ",color:"#4d4a46"},{text:"〈◆〉",bold:1b,color:"aqua",click_event:{"action":"run_command","command":"trigger MultiMenu set 16230011"}}]
