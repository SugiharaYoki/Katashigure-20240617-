...
execute as @p at @s run tellraw @s[tag=Azr_SKun] {"text":"灵能 & 影之石","underlined":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger MultiMenu set 16220002"}}
tellraw @p [{"text":"","color":"white"}]
