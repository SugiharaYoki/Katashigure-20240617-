...
item replace block -79898 40 -109 container.13 with minecraft:iron_nugget[custom_name='{"text":"盾牌碎片","italic":false}']
...
item replace block -79875 38 64 container.13 with tripwire_hook[custom_name='{"text":"蓝宝石钥匙","color":"blue","italic":false}'] 1
...
item replace block -79902 43 109 container.12 with tripwire_hook[custom_name='{"text":"蓝宝石钥匙","color":"blue","italic":false}'] 1
...
item replace block -79863 40 -76 container.12 with stone_axe[custom_name='{"text":"苔石斧·笼怨","italic":false}',attribute_modifiers=[{type:"generic.knockback_resistance",slot:"mainhand",id:"generic.knockback_resistance",amount:0.13,operation:"add_value"},{type:"generic.attack_damage",slot:"mainhand",id:"generic.attack_damage",amount:10.5,operation:"add_value"},{type:"generic.attack_speed",slot:"mainhand",id:"generic.attack_speed",amount:-3.2,operation:"add_value"}],enchantments={"unbreaking":2}] 1
...
item replace block -79929 49 -123 container.12 with raw_iron[custom_name='{"text":"钝铁","italic":false}'] 1
