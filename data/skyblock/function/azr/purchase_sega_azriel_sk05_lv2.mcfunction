...
execute as @s at @s[scores={Perm_PersonFSB=500..,Perm_PersonSHD=500..}] run playsound minecraft:item.armor.equip_iron neutral @s ~ ~ ~ 100
execute as @s at @s[scores={Perm_PersonFSB=500..,Perm_PersonSHD=500..}] run tellraw @s {"text":"灵能「备选策略」升级！花费了： 500浮世币 500影之石","color":"green"}
...
execute as @s at @s[tag=purchasesuccess] run scoreboard players set @s Azr_SK5 2
