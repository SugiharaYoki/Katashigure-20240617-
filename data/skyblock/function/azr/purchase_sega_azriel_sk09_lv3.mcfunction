...
execute as @s at @s[scores={Perm_PersonSHD=600..}] run tellraw @s {"text":"灵能「残城箭影」升级！花费了： 600影之石","color":"green"}
...
execute as @s at @s[tag=purchasesuccess] run scoreboard players set @s Azr_SK9 3
