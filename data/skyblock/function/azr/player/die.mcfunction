...
#使用下界命星复活
execute if entity @s[tag=AZR_fakeDeath] run function skyblock:azr/player/revive
execute if items entity @s[tag=!AZR_fakeDeath] container.* *[custom_data~{revival_star:1b}] run function skyblock:azr/player/revive
#输出
...
execute if score @s Azr_forceDeath matches 1 run function skyblock:azr/endgame/quit_game
