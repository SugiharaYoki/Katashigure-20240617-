...
execute if score #rng3 Azr_system matches 3 if score #rng4 Azr_system matches 1..2 if score #rng9 Azr_system matches 6 run summon item -79908 40 126 {Item:{id:"minecraft:paper",count:1b,components:{custom_name:'{"text":"圣殿信条","italic":false,"color":"blue"}',"custom_data":{sanct_credo:1b}}}}
#
...
execute if score #rng3 Azr_system matches 3 if score #rng4 Azr_system matches 1..3 if score #rng9 Azr_system matches 6 run summon item -79908 40 126 {Item:{id:"minecraft:paper",count:1b,components:{custom_name:'{"text":"圣殿信条","italic":false,"color":"blue"}',"custom_data":{sanct_credo:1b}}}}
#
