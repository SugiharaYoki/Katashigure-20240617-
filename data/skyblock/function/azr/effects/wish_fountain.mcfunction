...
execute if score #rng3 Azr_system matches 3 if score #rng4 Azr_system matches 1..2 if score #rng9 Azr_system matches 6 run summon item ~ ~ ~ {Item:{id:"minecraft:paper",count:1b,components:{custom_name:'{"text":"圣殿信条","italic":false,"color":"blue"}',"custom_data":{sanct_credo:1b},"custom_model_data":{floats:[100001.0]}}}}
#
...
execute if score #rng3 Azr_system matches 2 if score #rng4 Azr_system matches 1..2 if score #rng9 Azr_system matches 7 run summon item ~ ~ ~ {Item:{id:"minecraft:raw_iron",count:1b,components:{custom_name:'{"text":"钝铁","italic":false,"color":"white"}',"custom_data":{raw_iron:1b},"custom_model_data":{floats:[100001.0]}}}}
...
execute if score #rng3 Azr_system matches 3 if score #rng4 Azr_system matches 1..2 if score #rng9 Azr_system matches 8 run summon item ~ ~ ~ {Item:{id:"minecraft:iron_nugget",count:1b,components:{custom_name:'{"text":"盾牌碎片","italic":false,"color":"white"}',custom_data:{shield_shard:1b},custom_model_data:{floats:[100001.0]}}}}
#/
...
execute if score #rng3 Azr_system matches 3 if score #rng4 Azr_system matches 1..3 if score #rng9 Azr_system matches 6 run summon item ~ ~ ~ {Item:{id:"minecraft:paper",count:1b,components:{custom_name:'{"text":"圣殿信条","italic":false,"color":"blue"}',"custom_data":{sanct_credo:1b},"custom_model_data":{floats:[100001.0]}}}}
#
...
execute if score #rng3 Azr_system matches 2 if score #rng4 Azr_system matches 1..3 if score #rng9 Azr_system matches 7 run summon item ~ ~ ~ {Item:{id:"minecraft:raw_iron",count:1b,components:{custom_name:'{"text":"钝铁","italic":false,"color":"white"}',"custom_data":{raw_iron:1b},"custom_model_data":{floats:[100001.0]}}}}
...
execute if score #rng3 Azr_system matches 3 if score #rng4 Azr_system matches 1..3 if score #rng9 Azr_system matches 8 run summon item ~ ~ ~ {Item:{id:"minecraft:iron_nugget",count:1b,components:{custom_name:'{"text":"盾牌碎片","italic":false,"color":"white"}',custom_data:{shield_shard:1b},custom_model_data:{floats:[100001.0]}}}}
#
execute if score #rng3 Azr_system matches 1 if score #rng4 Azr_system matches 4 if score #rng9 Azr_system matches 1..8 if score #rng13 Azr_system matches 4..6 run summon item ~ ~ ~ {Item:{id:"minecraft:ghast_tear",count:1b,components:{custom_name:'{"text":"光明精华","italic":false,"color":"blue"}',custom_data:{light_essence:1b},custom_model_data:{floats:[100001.0]}}}}
execute if score #rng3 Azr_system matches 2 if score #rng4 Azr_system matches 4 if score #rng9 Azr_system matches 1..8 if score #rng13 Azr_system matches 4..6 run summon item ~ ~ ~ {Item:{id:"shield",count:1b,components:{custom_name:'{"text":"刺盾·遂望","italic":false,"color":"dark_red"}',attribute_modifiers:[{type:"attack_damage",amount:7.0d,operation:"add_value",id:"i_84300_135_20991_27",slot:"mainhand"},{type:"attack_speed",amount:-2.8d,operation:"add_value",id:"i_84300_135_20991_28",slot:"mainhand"},{type:"movement_speed",amount:0.015d,operation:"add_value",id:"i_84300_135_20991_2802",slot:"mainhand"}],unbreakable:{}}}}
execute if score #rng3 Azr_system matches 3 if score #rng4 Azr_system matches 4 if score #rng9 Azr_system matches 1..8 if score #rng13 Azr_system matches 4..6 run summon item ~ ~ ~ {Item:{id:"crossbow",count:1b,components:{custom_name:'{"text":"刃弩·迅穿","italic":false,"color":"dark_red"}',enchantments:{quick_charge:1,piercing:1},attribute_modifiers:[{type:"attack_damage",amount:3.5d,operation:"add_value",id:"i_84300_135_20992_27",slot:"mainhand"},{type:"attack_speed",amount:-2.3d,operation:"add_value",id:"i_84300_135_20992_28",slot:"mainhand"}],unbreakable:{}}}}
