...
execute as @s[scores={sea_4temp1=49,rng2=2}] run tellraw @a[tag=SEAPT,distance=0.1..8] {"text":"不朽之声：“为了沙利叶大人。”","color":"red"}
...
execute as @s[scores={sea_4temp1=49,rng2=6}] run tellraw @a[tag=SEAPT,distance=0.1..8] {"text":"不朽之声：“领悟真理吧。”","color":"red"}
...
execute as @s[scores={sea_4temp1=49,rng2=9}] run tellraw @a[tag=SEAPT,distance=0.1..8] {"text":"不朽之声：“雷米尔已重生。”","color":"red"}
