...
setblock -21 23 32 minecraft:air
setblock -79956 39 -29 air
stopsound @a[tag=SeGa_StandLastA]
...
setblock -79932 39 4 birch_button[facing=east,face=wall]
setblock -79937 39 -12 birch_button[facing=north,face=wall]
setblock -79935 39 22 birch_button[facing=north,face=wall]
fill -79931 38 6 -79931 40 6 purple_stained_glass
fill -79931 38 22 -79931 40 22 purple_stained_glass
setblock -79924 39 25 birch_button[face=floor,facing=west]
fill -79928 38 34 -79928 39 35 white_concrete
setblock -79928 40 34 minecraft:white_concrete
setblock -79928 38 33 minecraft:white_concrete
fill -79931 38 40 -79931 40 40 purple_stained_glass
setblock -79934 39 34 birch_button[face=wall,facing=east]
fill -79930 38 52 -79932 42 52 purple_stained_glass
setblock -79932 39 42 birch_button[face=wall,facing=east]
setblock -79936 39 42 birch_button[facing=south,face=wall]
setblock -79936 39 41 minecraft:gold_block
fill -79935 43 34 -79935 45 34 minecraft:purple_stained_glass
setblock -79924 38 33 air
fill -79906 40 27 -79906 38 29 minecraft:purple_stained_glass
setblock -79919 39 24 birch_button[facing=south]
...
#execute if entity @e[tag=sc,limit=1,scores={SeGa_StandLastP=8..}] run
setblock -79938 38 49 minecraft:quartz_block
setblock -79938 39 49 minecraft:quartz_bricks
setblock -79946 39 50 minecraft:birch_button[face=floor,facing=north]
...
setblock -79931 39 88 polished_blackstone_button[face=floor,facing=south]
...
execute if block -79949 41 54 air run fill -79949 41 54 -79949 38 57 minecraft:purple_stained_glass
execute if block -79950 38 58 air run fill -79950 38 59 -79951 38 59 chest[facing=north]
execute if block -79950 38 58 air run item replace block -79950 38 59 container.11 with minecraft:emerald 10
execute if block -79950 38 58 air run item replace block -79950 38 59 container.13 with minecraft:emerald 10
execute if block -79950 38 58 air run item replace block -79950 38 59 container.15 with minecraft:emerald 10
execute if block -79950 38 58 air run item replace block -79951 38 59 container.11 with minecraft:emerald 10
execute if block -79950 38 58 air run item replace block -79951 38 59 container.13 with minecraft:emerald 10
execute if block -79950 38 58 air run item replace block -79951 38 59 container.15 with minecraft:emerald 10
setblock -79946 37 -8 minecraft:white_stained_glass
setblock -79915 39 34 minecraft:quartz_bricks
setblock -79915 38 34 minecraft:quartz_block
setblock -79915 40 34 minecraft:quartz_block
setblock -79912 38 34 chest[facing=west]
item replace block -79912 38 34 container.12 with skull_banner_pattern[custom_name='{"text":"“我的东南水路正门钥匙被迅蛛偷走六回了”","italic":true,"color":"dark_purple"}',lore=['{"text":"我敢肯定那群蜘蛛最近经常失控。","color":"white","italic":false}','{"text":"能天使大人难不成是患上疾病了？","color":"white","italic":false}','{"text":"这总不可能是怹刻意为之吧。","color":"white","italic":false}']]
item replace block -79912 38 34 container.14 with tripwire_hook[custom_name='{"text":"木船图案的钥匙","italic":false,"color":"blue"}'] 1
setblock -79939 38 20 chest[facing=west]{Lock:"木船图案的钥匙"}
item replace block -79939 38 20 container.11 with minecraft:paper[custom_name='{"text":"圣殿信条","italic":false,"color":"blue"}'] 3
item replace block -79939 38 20 container.13 with skull_banner_pattern[custom_name='{"text":"“仍旧在调查魔物失控的真相”","italic":true,"color":"dark_purple"}',lore=['{"text":"拉斐尔大人告知我丢失钥匙并无大碍，","color":"white","italic":false}','{"text":"地下水路东区不存在任何有用的事物。","color":"white","italic":false}','{"text":"可那里明明封印着源自各处的亡灵……","color":"white","italic":false}']]
item replace block -79939 38 20 container.15 with iron_ingot[custom_name='{"text":"碳钢","italic":false,"color":"white"}'] 1
setblock -79939 39 58 chest[facing=north]
item replace block -79939 39 58 container.13 with tripwire_hook[custom_name='{"text":"白方岩钥匙","italic":false,"color":"blue"}'] 1
setblock -79949 34 15 chest[facing=north]
item replace block -79949 34 15 container.13 with tripwire_hook[custom_name='{"text":"铸铁钥匙","italic":false,"color":"blue"}'] 1
...
execute if block -79950 38 58 air run fill -79950 38 58 -79951 39 58 quartz_block
...
fill -79934 40 -1 -79934 38 1 purple_stained_glass
setblock -79956 39 1 minecraft:birch_button[facing=south]
...
fill -79957 42 13 -79955 38 13 minecraft:purple_stained_glass
setblock -79959 39 20 minecraft:birch_button[face=floor,facing=west]
fill -79942 40 3 -79944 38 3 minecraft:purple_stained_glass
...
item replace block -79929 47 -110 container.13 with tripwire_hook[custom_name='{"text":"纸张图案的钥匙","italic":false,"color":"blue"}'] 1
setblock -79897 40 -115 chest[facing=west]{Lock:"纸张图案的钥匙"}
item replace block -79897 40 -115 container.12 with minecraft:paper[custom_name='{"text":"被污染的信条","italic":false,"color":"dark_purple"}'] 1
item replace block -79897 40 -115 container.14 with minecraft:paper[custom_name='{"text":"被污染的信条","italic":false,"color":"dark_purple"}'] 1
...
fill -79928 40 1 -79928 38 -1 minecraft:purple_stained_glass
...
item replace block -79939 35 -76 container.11 with minecraft:paper[custom_name='{"text":"被污染的信条","italic":false,"color":"dark_purple"}'] 1
item replace block -79939 35 -76 container.13 with minecraft:dried_kelp 8
item replace block -79939 35 -76 container.15 with tripwire_hook[custom_name='{"text":"蓝宝石钥匙","italic":false,"color":"blue"}'] 1
...
item replace block -79917 40 -62 container.11 with minecraft:paper[custom_name='{"text":"被污染的信条","italic":false,"color":"dark_purple"}'] 2
item replace block -79917 40 -62 container.13 with minecraft:chain 5
item replace block -79917 40 -62 container.15 with skull_banner_pattern[custom_name='{"text":"“拉斐尔大人与能天使大人吵了一架”","italic":true,"color":"dark_purple"}',lore=['{"text":"希望神庭近些日子不要遭遇困难。","color":"white","italic":false}','{"text":"这两天拉斐尔大人的脾气特别不稳定，","color":"white","italic":false}','{"text":"还时不时地跟我们说，","color":"white","italic":false}','{"text":"“百千年的重头戏终于要到来了”。","color":"white","italic":false}']]
tag @e[tag=sc,limit=1] remove StageDiffid
setblock -79875 38 64 chest[facing=north]
item replace block -79875 38 64 container.13 with tripwire_hook[custom_name='{"text":"粗石英钥匙","italic":false,"color":"blue"}'] 1
...
item replace block -79922 38 35 container.15 with skull_banner_pattern[custom_name='{"text":"“招待厅事务记录6”","italic":true,"color":"dark_purple"}',lore=['{"text":"权之残影大人曾言","color":"white","italic":false}','{"text":"下一回便会有真正的强者光临神庭。","color":"white","italic":false}','{"text":"并非由魔界之污秽魔力所造就，","color":"white","italic":false}','{"text":"而是命定将拯救三界之人。","color":"white","italic":false}']]
setblock -79895 48 136 chest[facing=east]{Lock:"椅子形状的钥匙"}
item replace block -79895 48 136 container.11 with minecraft:paper[custom_name='{"text":"圣殿信条","italic":false,"color":"blue"}'] 2
item replace block -79895 48 136 container.13 with minecraft:carrot 5
item replace block -79895 48 136 container.15 with skull_banner_pattern[custom_name='{"text":"“招待厅事务记录4”","italic":true,"color":"dark_purple"}',lore=['{"text":"魔界最近好像在刻意引导那些死去的亡灵","color":"white","italic":false}','{"text":"前来挑战生命树试炼，","color":"white","italic":false}','{"text":"他们到底在打什么算盘？","color":"white","italic":false}','{"text":"如果真的哪天有不怀好意的亡灵到来……","color":"white","italic":false}']]
setblock -79902 43 109 chest[facing=east]
item replace block -79902 43 109 container.12 with minecraft:arrow 6
item replace block -79902 43 109 container.12 with tripwire_hook[custom_name='{"text":"椅子形状的钥匙","italic":false,"color":"blue"}'] 1
setblock -79764 30 218 chest[facing=north,waterlogged=true]
item replace block -79764 30 218 container.13 with skull_banner_pattern[custom_name='{"text":"“招待厅事务记录2”","italic":true,"color":"dark_purple"}',lore=['{"text":"有更多的巡逻士兵说，","color":"white","italic":false}','{"text":"自己在执行任务时遭遇了轻微的幻听。","color":"white","italic":false}','{"text":"他们说，","color":"white","italic":false}','{"text":"那温柔话语声的来源像是艾奥洛斯之女：","color":"white","italic":false}','{"text":"雅尔希奥妮。","color":"white","italic":false}']]
setblock -79850 48 205 chest[facing=south]
item replace block -79850 48 205 container.12 with lapis_lazuli 2
item replace block -79850 48 205 container.14 with skull_banner_pattern[custom_name='{"text":"“招待厅事务记录3”","italic":true,"color":"dark_purple"}',lore=['{"text":"力天使大人说过，","color":"white","italic":false}','{"text":"挑战者没有办法来到图书馆区域。","color":"white","italic":false}','{"text":"试炼的过程是被精心安排的，","color":"white","italic":false}','{"text":"不知挑战者本人能否看穿这件事实。","color":"white","italic":false}']]
setblock -79889 46 115 chest[facing=east]
item replace block -79889 46 115 container.12 with tripwire_hook[custom_name='{"text":"月色石钥匙","italic":false,"color":"blue"}'] 1
...
#
setblock -79931 37 -9 minecraft:quartz_pillar
setblock -79931 37 3 minecraft:quartz_pillar
...
item replace block -79936 49 -158 container.13 with skull_banner_pattern[custom_name='{"text":"“期限将至 此乃针对神庭之审判”","italic":true,"color":"dark_purple"}',lore=['{"text":"这里的魔物保受摧残，","color":"white","italic":false}','{"text":"终日身于苦痛之中。","color":"white","italic":false}','{"text":"沙利叶大人既是对此心知肚明，","color":"white","italic":false}','{"text":"又为何让这暴行再续？","color":"white","italic":false}']]
item replace block -79936 49 -158 container.15 with shulker_shell[enchantments={"minecraft:blast_protection":1},custom_name='{"text":"弹簧箭盒","italic":false,"color":"white"}',custom_data={Lore:["{\"text\":\"敲击 - 散射36支箭矢（射程较高）\",\"color\":\"yellow\",\"italic\":false}"]}] 3
...
item replace block -79867 40 -103 container.12 with shulker_shell[enchantments={"minecraft:blast_protection":1},custom_name='{"text":"弹簧箭盒","italic":false,"color":"white"}',custom_data={Lore:["{\"text\":\"敲击 - 散射36支箭矢（射程较高）\",\"color\":\"yellow\",\"italic\":false}"]}] 2
item replace block -79867 40 -103 container.14 with tripwire_hook[custom_name='{"text":"紫翡翠钥匙","italic":false,"color":"blue"}'] 1
setblock -79863 40 -76 chest[facing=west]{Lock:"杜鹃花钥匙"}
item replace block -79863 40 -76 container.12 with stone_axe[enchantments={unbreaking:2},custom_name='{"text":"苔石斧·笼怨","italic":false,"color":"white"}',attribute_modifiers=[{type:"generic.knockback_resistance",slot:"mainhand",id:"i84300_1_18_2077",amount:0.13,operation:"add_value"},{type:"generic.attack_damage",slot:"mainhand",id:"i84300_1_18_2177",amount:10.5,operation:"add_value"},{type:"generic.attack_speed",slot:"mainhand",id:"i84300_1_18_2277",amount:-3.2,operation:"add_value"}]]
item replace block -79863 40 -76 container.14 with skull_banner_pattern[custom_name='{"text":"“招待厅事务记录5”","italic":true,"color":"dark_purple"}',lore=['{"text":"第一关口北面的建筑物出现了大量裂缝，","color":"white","italic":false}','{"text":"这样的现象一直延伸至牢房区域。","color":"white","italic":false}','{"text":"虽说大家有不祥的预感，","color":"white","italic":false}','{"text":"权之殊能大人却言仅为年久失修。","color":"white","italic":false}']]
setblock -79929 49 -123 chest[facing=south]
item replace block -79929 49 -123 container.12 with raw_iron[custom_name='{"text":"钝铁","italic":false,"color":"white"}'] 1
item replace block -79929 49 -123 container.14 with tripwire_hook[custom_name='{"text":"杜鹃花钥匙","italic":false,"color":"blue"}'] 1
...
item replace block -79782 27 -286 container.13 with nether_star 1
...
item replace block -79713 22 -461 container.13 with paper[custom_name='{"text":"圣殿信条","italic":false,"color":"blue"}'] 3
...
item replace block -79626 21 -415 container.11 with minecraft:paper[custom_name='{"text":"圣殿信条","italic":false,"color":"blue"}'] 3
item replace block -79626 21 -415 container.13 with skull_banner_pattern[custom_name='{"text":"“神罚 这一切都是神罚 全部都是”","italic":true,"color":"dark_purple"}',lore=['{"text":"我们触怒了神庭 我们触怒了神庭","color":"white","italic":false}','{"text":"我们触怒了神庭 我们触怒了神庭","color":"white","italic":false}','{"text":"现在轮到我们自取灭亡了","color":"white","italic":false}','{"text":"现在轮到我们自取灭亡了","color":"white","italic":false}']]
...
item replace block 79588 8 -427 container.11 with firework_star[custom_name='{"text":"机械箭","italic":false,"color":"white"}'] 5
item replace block 79588 8 -427 container.13 with firework_star[custom_name='{"text":"机械箭","italic":false,"color":"white"}'] 5
item replace block 79588 8 -427 container.15 with firework_star[custom_name='{"text":"机械箭","italic":false,"color":"white"}'] 5
setblock -79571 11 -412 chest[facing=north]{Lock:"金镐图案的钥匙"}
item replace block -79571 11 -412 container.12 with minecraft:splash_potion[custom_name='[{"italic":false,"color":"light_purple","text":"「抗火瓶」"},{"italic":false,"color":"blue","text":"lv1"}]',potion_contents="minecraft:water",custom_data={CustomPotionEffects:[{Id:12,Duration:200}]}] 1
...
#
scoreboard players set @e[tag=sc,limit=1] SeGa_StandLast 0
scoreboard players set @e[tag=sc,limit=1] SeGa_StandLastP 0
kill @e[type=!player,type=!armor_stand,x=-80000,y=100,z=0,distance=0..1000]
kill @e[type=!player,type=!armor_stand,x=-80000,y=100,z=0,distance=0..1000]
kill @e[type=!player,type=!armor_stand,x=-80000,y=100,z=0,distance=0..1000]
kill @e[tag=AzrielMob]
kill @e[tag=AzrielDecMob]
scoreboard objectives setdisplay sidebar SeGa_StandLastBH
scoreboard objectives remove Temp_PersonAZS
scoreboard objectives remove Temp_PersonAZSt
scoreboard objectives remove AzrielShop
tellraw @a[tag=!Gaming] [{"text":"『亚兹列尔的中庭花园』","color":"light_purple"},{"text":" 已允许新的挑战者光临","color":"green"}]
scoreboard players reset @a SeGa_StandLastDD
setblock -21 23 32 minecraft:air
execute as @a[tag=SeGa_StandLastA] at @s run function skyblock:azr/ingame_azrielsmidgarden_dead
tag @a remove SeGa_StandLastD
