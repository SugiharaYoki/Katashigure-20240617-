...
execute if score stageSeconds Azr_system matches 133..141 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 142
execute if score stageSeconds Azr_system matches 132 positioned -79927 38 16 run function skyblock:azr/m/pillager_t1
execute if score stageSeconds Azr_system matches 132 positioned -79935 38 12 run function skyblock:azr/m/pillager_t1
#回秒
...
execute if score stageSeconds Azr_system matches 143 run advancement grant @a[tag=azrPlayer] only skyblock:azr/azr_stage2
execute if score stageSeconds Azr_system matches 143 run title @a[tag=azrPlayer] actionbar {"text":"Stage Clear","color":"green"}
execute if score stageSeconds Azr_system matches 143 run tellraw @a[tag=azrPlayer,scores={AZR_chainKillUpg_pts=..0},tag=hasSkills] [{"text":"索命连击","color":"gold"},{"text":"可用点数已增加，目前为：1","color":"green"}]
execute if score stageSeconds Azr_system matches 143 run scoreboard players set @a[scores={AZR_chainKillUpg_pts=..0}] AZR_chainKillUpg_pts 1