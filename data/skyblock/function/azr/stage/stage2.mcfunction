...
execute if score stageSeconds Azr_system matches 134 if score playerCount Azr_system matches 2.. positioned -79922 38 14 run function skyblock:azr/m/zombie_t2_shield
