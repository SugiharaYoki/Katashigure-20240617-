...
execute if score stage_main_thread AzrTimerStack matches 35 if score playerCount Azr_system matches 1 run tellraw @a[tag=azrPlayer] {"text":"“这坐标是……你是怎么跑到这么偏离路线的地方去的？”","color":"white"}
execute if score stage_main_thread AzrTimerStack matches 35 if score playerCount Azr_system matches 2.. run tellraw @a[tag=azrPlayer] {"text":"“这坐标是……你们是怎么跑到这么偏离路线的地方去的？”","color":"white"}
execute if score stage_main_thread AzrTimerStack matches 35 as @a[tag=azrPlayer] at @s run playsound minecraft:entity.pillager.ambient master @a[tag=azrPlayer] ~ ~ ~ 0.5 0.8
...
execute if score stage_main_thread AzrTimerStack matches 60 run tellraw @a[tag=azrPlayer] {"text":"默尔森：","color":"aqua"}
execute if score stage_main_thread AzrTimerStack matches 60 if score playerCount Azr_system matches 1 run tellraw @a[tag=azrPlayer] {"text":"“矿洞深层……真亏你能活着跑到这个信号台来。”","color":"white"}
execute if score stage_main_thread AzrTimerStack matches 60 if score playerCount Azr_system matches 2.. run tellraw @a[tag=azrPlayer] {"text":"“矿洞深层……真亏你们能活着跑到这个信号台来。”","color":"white"}
execute if score stage_main_thread AzrTimerStack matches 60 as @e[tag=AzrielBossFA] at @s run playsound minecraft:entity.pillager.ambient master @a[tag=azrPlayer] ~ ~ ~ 0.5 0.8
...
execute if score stage_main_thread AzrTimerStack matches 95 if score playerCount Azr_system matches 1 run tellraw @a[tag=azrPlayer] {"text":"“你在前进时也要谨慎行事。记得试试看金质装备可不可以抵御这些菌丝的侵蚀。”","color":"white"}
execute if score stage_main_thread AzrTimerStack matches 95 if score playerCount Azr_system matches 2 run tellraw @a[tag=azrPlayer] {"text":"“你俩在前进时也要谨慎行事。记得试试看金质装备可不可以抵御这些菌丝的侵蚀。”","color":"white"}
execute if score stage_main_thread AzrTimerStack matches 95 if score playerCount Azr_system matches 3.. run tellraw @a[tag=azrPlayer] {"text":"“你们在前进时也要谨慎行事。记得试试看金质装备可不可以抵御这些菌丝的侵蚀。”","color":"white"}
execute if score stage_main_thread AzrTimerStack matches 95 as @e[tag=AzrielBossFA] at @s run playsound minecraft:entity.pillager.ambient master @a[tag=azrPlayer] ~ ~ ~ 0.5 0.8
...
execute if score stage_main_thread AzrTimerStack matches 117 as @e[tag=AzrielBossFA] at @s run playsound minecraft:entity.ender_dragon.hurt master @a[tag=azrPlayer] -79533 26 -405.0 0.5 1.4
execute if score stage_main_thread AzrTimerStack matches 117 as @e[tag=AzrielBossFA] at @s run playsound minecraft:entity.witch.drink master @a[tag=azrPlayer] -79533 26 -405.0 0.5 1.5
execute if score stage_main_thread AzrTimerStack matches 117 run fill -79533 27 -406 -79533 26 -405 minecraft:air destroy

execute if score stage_main_thread AzrTimerStack matches 121 run tellraw @a[tag=azrPlayer] {"text":"默尔森：","color":"aqua"}
execute if score stage_main_thread AzrTimerStack matches 121 if score playerCount Azr_system matches 1 run tellraw @a[tag=azrPlayer] {"text":"“改日传授你破坏地形的方法。”","color":"white"}
execute if score stage_main_thread AzrTimerStack matches 121 if score playerCount Azr_system matches 2.. run tellraw @a[tag=azrPlayer] {"text":"“改日传授你们破坏地形的方法”","color":"white"}
