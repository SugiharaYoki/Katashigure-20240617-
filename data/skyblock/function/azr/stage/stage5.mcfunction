...
execute if score stageSeconds Azr_system matches 106..111 if score stage Azr_system matches 12 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 112
