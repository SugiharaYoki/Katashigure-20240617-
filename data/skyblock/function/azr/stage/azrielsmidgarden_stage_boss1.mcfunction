...
execute if entity @e[tag=sc,limit=1,scores={SeGa_StandLastQ=80,SeGa_NumPartic=3..4}] run summon illusioner -79931 47 88 {PersistenceRequired:1,Tags:["AzrielMob","AzrielBossA"],DeathLootTable:"skyblock:azriel_shadow_tier1",Attributes:[{Name:generic.max_health,Base:250.0},{Name:generic.movement_speed,Base:0.2},{Name:generic.knockback_resistance,Base:0.9},{Name:generic.armor,Base:1.5}],Health:250.0f,CustomName:"\"权之残影\""}
...
execute if entity @e[tag=sc,limit=1,scores={SeGa_StandLastQ=1849}] run summon skeleton -79939 44 96 {PersistenceRequired:1,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_skeleton_tier1",Attributes:[{Name:generic.max_health,Base:18.0},{Name:generic.attack_damage,Base:1.0}],Health:6.0f,CustomName:"\"骷髅射手\"",CanPickUpLoot:0,HandItems:[{Count:1,id:bow,tag:{display:{Name:"{\"text\":\"弓·传统\",\"italic\":false,\"color\":\"white\"}"}}}],HandDropChances:[0.003f],ArmorItems:[{},{},{},{}]}
execute if entity @e[tag=sc,limit=1,scores={SeGa_StandLastQ=1849}] run summon skeleton -79923 44 80 {PersistenceRequired:1,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_skeleton_tier1",Attributes:[{Name:generic.max_health,Base:18.0},{Name:generic.attack_damage,Base:1.0}],Health:6.0f,CustomName:"\"骷髅射手\"",CanPickUpLoot:0,HandItems:[{Count:1,id:bow,tag:{display:{Name:"{\"text\":\"弓·传统\",\"italic\":false,\"color\":\"white\"}"}}}],HandDropChances:[0.003f],ArmorItems:[{},{},{},{}]}

execute if entity @e[tag=sc,limit=1,scores={SeGa_StandLastQ=1829,SeGa_NumPartic=4..}] run summon skeleton -79939 44 96 {PersistenceRequired:1,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_skeleton_tier1",Attributes:[{Name:generic.max_health,Base:18.0},{Name:generic.attack_damage,Base:1.0}],Health:6.0f,CustomName:"\"骷髅护卫\"",CanPickUpLoot:0,HandItems:[{Count:1,id:wooden_sword}],HandDropChances:[0.00f],ArmorItems:[{},{},{},{}]}
execute if entity @e[tag=sc,limit=1,scores={SeGa_StandLastQ=1829,SeGa_NumPartic=4..}] run summon skeleton -79923 44 80 {PersistenceRequired:1,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_skeleton_tier1",Attributes:[{Name:generic.max_health,Base:18.0},{Name:generic.attack_damage,Base:1.0}],Health:6.0f,CustomName:"\"骷髅护卫\"",CanPickUpLoot:0,HandItems:[{Count:1,id:wooden_sword}],HandDropChances:[0.00f],ArmorItems:[{},{},{},{}]}
