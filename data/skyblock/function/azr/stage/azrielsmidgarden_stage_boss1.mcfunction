...
execute if entity @e[tag=sc,limit=1,scores={SeGa_StandLastQ=1849}] run summon skeleton -79939 44 96 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_skeleton_tier1",Attributes:[{Name:generic.max_health,Base:18.0},{Name:generic.attack_damage,Base:1.0}],Health:6.0f,CustomName:"\"骷髅射手\"",CanPickUpLoot:0b,HandItems:[{Count:1,id:bow,tag:{display:{Name:"{\"text\":\"弓·传统\",\"italic\":false,\"color\":\"white\"}"}}}],HandDropChances:[0.003f],ArmorItems:[{},{},{},{}]}
execute if entity @e[tag=sc,limit=1,scores={SeGa_StandLastQ=1849}] run summon skeleton -79923 44 80 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_skeleton_tier1",Attributes:[{Name:generic.max_health,Base:18.0},{Name:generic.attack_damage,Base:1.0}],Health:6.0f,CustomName:"\"骷髅射手\"",CanPickUpLoot:0b,HandItems:[{Count:1,id:bow,tag:{display:{Name:"{\"text\":\"弓·传统\",\"italic\":false,\"color\":\"white\"}"}}}],HandDropChances:[0.003f],ArmorItems:[{},{},{},{}]}

execute if entity @e[tag=sc,limit=1,scores={SeGa_StandLastQ=1829,SeGa_NumPartic=4..}] run summon skeleton -79939 44 96 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_skeleton_tier1",Attributes:[{Name:generic.max_health,Base:18.0},{Name:generic.attack_damage,Base:1.0}],Health:6.0f,CustomName:"\"骷髅护卫\"",CanPickUpLoot:0b,HandItems:[{Count:1,id:wooden_sword}],HandDropChances:[0.00f],ArmorItems:[{},{},{},{}]}
execute if entity @e[tag=sc,limit=1,scores={SeGa_StandLastQ=1829,SeGa_NumPartic=4..}] run summon skeleton -79923 44 80 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_skeleton_tier1",Attributes:[{Name:generic.max_health,Base:18.0},{Name:generic.attack_damage,Base:1.0}],Health:6.0f,CustomName:"\"骷髅护卫\"",CanPickUpLoot:0b,HandItems:[{Count:1,id:wooden_sword}],HandDropChances:[0.00f],ArmorItems:[{},{},{},{}]}
