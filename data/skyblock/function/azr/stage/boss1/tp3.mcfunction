...
execute at @s if score #rng8 Azr_system matches 1 run tp @s ~ ~ ~4
execute at @s if score #rng8 Azr_system matches 2 run tp @s ~ ~ ~-4
execute at @s if score #rng8 Azr_system matches 3 run tp @s ~4 ~ ~
execute at @s if score #rng8 Azr_system matches 4 run tp @s ~-4 ~ ~
execute at @s if score #rng8 Azr_system matches 5 run tp @s ~4 ~ ~4
execute at @s if score #rng8 Azr_system matches 6 run tp @s ~4 ~ ~-4
