...
execute as @e[tag=AzrielBossA,limit=1] at @s run execute at @s positioned ~ ~ ~ run function skyblock:azr/m/shadow_t1_skeleton
execute as @e[tag=AzrielBossA,limit=1] at @s run execute at @s if score rng4 Azr_system matches 1 run tp @s ~ ~ ~1
execute as @e[tag=AzrielBossA,limit=1] at @s run execute at @s if score rng4 Azr_system matches 2 run tp @s ~ ~ ~-1
execute as @e[tag=AzrielBossA,limit=1] at @s run execute at @s if score rng4 Azr_system matches 3 run tp @s ~1 ~ ~
execute as @e[tag=AzrielBossA,limit=1] at @s run execute at @s if score rng4 Azr_system matches 4 run tp @s ~-1 ~ ~
execute as @e[tag=AzrielBossA,limit=1] at @s run execute at @s run particle minecraft:reverse_portal ~ ~1 ~ 0.5 0.6 0.5 0.5 40
...
execute as @e[tag=AzrielBossA,limit=1] at @s run execute if score rng7 Azr_system matches 7 run summon marker ~ ~ ~ {Tags:["arroworb"],Invulnerable:1b,Invisible:1b,NoGravity:1b,Silent:1b}