...
#AI 
    ...
    execute if score tickTimer Azr_system matches 152..2800 if score temp_rng Azr_system matches 1 as @e[tag=AzrielBossA,limit=3] at @s run rotate @s facing entity @p[tag=azrPlayer]
...
#跳秒
    ...
    execute if score tickTimer Azr_system matches 1020..1100 if score #rng15 Azr_system matches 1 as @e[tag=AzrielBossA,limit=3] at @s if score zanei_flat_01_marker rng1 matches 22.. run scoreboard players set zanei_flat_01_marker rng1 0
    execute if score tickTimer Azr_system matches 1020..1100 if score #rng15 Azr_system matches 2 as @e[tag=AzrielBossA,limit=3] at @s if score zanei_flat_01_marker rng2 matches 22.. run scoreboard players set zanei_flat_02_marker rng1 0
    ...
    execute if score tickTimer Azr_system matches 1150..1250 if score #rng13 Azr_system matches 1 as @e[tag=AzrielBossA,limit=3] at @s if score zanei_flat_01_marker rng1 matches 22.. run scoreboard players set zanei_flat_01_marker rng1 0
    execute if score tickTimer Azr_system matches 1150..1250 if score #rng13 Azr_system matches 2 as @e[tag=AzrielBossA,limit=3] at @s if score zanei_flat_01_marker rng2 matches 22.. run scoreboard players set zanei_flat_02_marker rng1 0
    ...
    execute if score tickTimer Azr_system matches 1286 if score #rng4 Azr_system matches 1 as @e[tag=AzrielBossA,limit=3] at @s if score zanei_flat_01_marker rng1 matches 22.. run scoreboard players set zanei_flat_01_marker rng1 0
    execute if score tickTimer Azr_system matches 1286 if score #rng4 Azr_system matches 2 as @e[tag=AzrielBossA,limit=3] at @s if score zanei_flat_01_marker rng2 matches 22.. run scoreboard players set zanei_flat_02_marker rng1 0
    execute if score tickTimer Azr_system matches 1286..1316 if score #rng4 Azr_system matches 3 as @e[tag=AzrielBossA,limit=3] at @s run function skyblock:azr/stage/boss1/flat3_w
    execute if score tickTimer Azr_system matches 1286..1316 if score #rng4 Azr_system matches 4 as @e[tag=AzrielBossA,limit=3] at @s run function skyblock:azr/stage/boss1/flat3_w
    ...
    execute if score tickTimer Azr_system matches 1466 as @e[tag=AzrielBossA,limit=3] at @s run summon arrow ~ ~1 ~ {Motion:[-1.6,0.1,-3.4],pickup:0,damage:1.0,life:1100}
    execute if score tickTimer Azr_system matches 1468 as @e[tag=AzrielBossA,limit=3] at @s run summon arrow ~ ~1 ~ {Motion:[-1.8,0.2,-3.2],pickup:0,damage:1.0,life:1100}
    execute if score tickTimer Azr_system matches 1630 if score #rng2 Azr_system matches 2 if score #rng16 Azr_system matches 1 as @e[tag=AzrielBossA,limit=3] at @s if score zanei_flat_01_marker rng1 matches 22.. run scoreboard players set zanei_flat_01_marker rng1 0
    execute if score tickTimer Azr_system matches 1630 if score #rng2 Azr_system matches 2 if score #rng16 Azr_system matches 2 as @e[tag=AzrielBossA,limit=3] at @s if score zanei_flat_02_marker rng1 matches 22.. run scoreboard players set zanei_flat_02_marker rng1 0
    execute if score tickTimer Azr_system matches 1600..1630 if score #rng2 Azr_system matches 2 if score #rng16 Azr_system matches 3 as @e[tag=AzrielBossA,limit=3] at @s run function skyblock:azr/stage/boss1/flat3_w
    execute if score tickTimer Azr_system matches 1630 if score #rng2 Azr_system matches 2 if score #rng16 Azr_system matches 3 as @e[tag=AzrielBossA,limit=3] at @s run function skyblock:azr/stage/boss1/flat3
    execute if score tickTimer Azr_system matches 1600..1630 if score #rng2 Azr_system matches 2 if score #rng16 Azr_system matches 4 as @e[tag=AzrielBossA,limit=3] at @s run function skyblock:azr/stage/boss1/flat3_w
    execute if score tickTimer Azr_system matches 1630 if score #rng2 Azr_system matches 2 if score #rng16 Azr_system matches 4 as @e[tag=AzrielBossA,limit=3] at @s run function skyblock:azr/stage/boss1/flat3
    ...
    execute if score tickTimer Azr_system matches 1740 if score #rng3 Azr_system matches 1 as @e[tag=AzrielBossA,limit=3] at @s if score zanei_flat_01_marker rng1 matches 22.. run scoreboard players set zanei_flat_01_marker rng1 0
    ...
    execute if score tickTimer Azr_system matches 3170 run particle minecraft:end_rod -79931 39 76 0.6 0.6 0.6 0.0 131
    #finalize map
    ...
    execute if score tickTimer Azr_system matches 3140 run advancement grant @a[tag=azrPlayer] only skyblock:azr/azr_stage4_boss1
