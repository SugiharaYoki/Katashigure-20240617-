...
#跳秒
    ...
    execute if score tickTimer Azr_system matches 900..2800 if score playerCount Azr_system matches 1.. if score #rng19 Azr_system matches 1..11 if score #rng20 Azr_system matches 6..7 if entity @e[tag=AzrielBossA,scores={Azr_mobHealth=..50}] run scoreboard players set zanei_flat_01_marker rng1 0
    execute if score tickTimer Azr_system matches 900..2800 if score playerCount Azr_system matches 1.. if score #rng19 Azr_system matches 1..11 if score #rng20 Azr_system matches 8..9 if entity @e[tag=AzrielBossA,scores={Azr_mobHealth=..50}] run scoreboard players set zanei_flat_02_marker rng1 0
    execute if score tickTimer Azr_system matches 1020..1100 if score #rng15 Azr_system matches 1 as @e[tag=AzrielBossA,limit=3] at @s run scoreboard players set zanei_flat_01_marker rng1 0
    execute if score tickTimer Azr_system matches 1020..1100 if score #rng15 Azr_system matches 2 as @e[tag=AzrielBossA,limit=3] at @s run scoreboard players set zanei_flat_02_marker rng1 0
    ...
    execute if score tickTimer Azr_system matches 1150..1250 if score #rng13 Azr_system matches 1 as @e[tag=AzrielBossA,limit=3] at @s run scoreboard players set zanei_flat_01_marker rng1 0
    execute if score tickTimer Azr_system matches 1150..1250 if score #rng13 Azr_system matches 2 as @e[tag=AzrielBossA,limit=3] at @s run scoreboard players set zanei_flat_02_marker rng1 0
    ...
    execute if score tickTimer Azr_system matches 1286 if score #rng4 Azr_system matches 1 as @e[tag=AzrielBossA,limit=3] at @s run scoreboard players set zanei_flat_01_marker rng1 0
    execute if score tickTimer Azr_system matches 1286 if score #rng4 Azr_system matches 2 as @e[tag=AzrielBossA,limit=3] at @s run scoreboard players set zanei_flat_02_marker rng1 0
    ...
    execute if score tickTimer Azr_system matches 1466 as @e[tag=AzrielBossA,limit=3] at @s run summon arrow ~ ~1 ~ {Motion:[-1.6,0.1,-3.4],pickup:0,damage:1.0,life:1100}
    execute if score tickTimer Azr_system matches 1468 as @e[tag=AzrielBossA,limit=3] at @s run summon arrow ~ ~1 ~ {Motion:[-1.8,0.2,-3.2],pickup:0,damage:1.0,life:1100}
    execute if score tickTimer Azr_system matches 1530..1630 if score #rng2 Azr_system matches 2 if score #rng16 Azr_system matches 1 as @e[tag=AzrielBossA,limit=3] at @s run scoreboard players set zanei_flat_01_marker rng1 0
    execute if score tickTimer Azr_system matches 1530..1630 if score #rng2 Azr_system matches 2 if score #rng16 Azr_system matches 2 as @e[tag=AzrielBossA,limit=3] at @s run scoreboard players set zanei_flat_02_marker rng1 0
    ...
    execute if score tickTimer Azr_system matches 1740 if score #rng3 Azr_system matches 1 as @e[tag=AzrielBossA,limit=3] at @s run scoreboard players set zanei_flat_01_marker rng1 0
