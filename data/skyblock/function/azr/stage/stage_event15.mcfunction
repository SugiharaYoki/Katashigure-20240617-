execute positioned -79756.5 29.0 -464.5 if entity @a[distance=0..3,tag=azrPlayer,tag=!Trader4ATalkA] run playsound minecraft:entity.piglin.admiring_item master @a[tag=azrPlayer] ~ ~ ~ 2 0.8
