...
execute if score stageSeconds Azr_system matches 1 run tellraw @a[tag=DebugMode,tag=azrPlayer] [{"text":"[DEBUG MODE MESSAGE] You are playing \"Stage 3β\", with playerCount = "},{"score":{"objective":"Azr_system","name":"playerCount"}},{"text":" Maximum Seconds =204"}]
...
execute if score stageSeconds Azr_system matches 11 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 12
...
execute if score stageSeconds Azr_system matches 13 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 14
...
execute if score stageSeconds Azr_system matches 15 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 16
...
execute if score stageSeconds Azr_system matches 19 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 20
...
execute if score stageSeconds Azr_system matches 24 if score playerCount Azr_system matches 1.. positioned -79959 38 6 run function skyblock:azr/m/zombie_t2_shield
...
execute if score stageSeconds Azr_system matches 26 if score playerCount Azr_system matches 1.. positioned -79959 38 6 run function skyblock:azr/m/zombie_t2_shield
execute if score stageSeconds Azr_system matches 26 if score playerCount Azr_system matches 1.. positioned -79948 38 6 run function skyblock:azr/m/pillager_t1
execute if score stageSeconds Azr_system matches 27..29 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 30
execute if score stageSeconds Azr_system matches 30 if score playerCount Azr_system matches 4.. positioned -79948 38 6 run function skyblock:azr/m/pillager_t1
...
execute if score stageSeconds Azr_system matches 31 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 32
...
execute if score stageSeconds Azr_system matches 33..34 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 35
...
execute if score stageSeconds Azr_system matches 37..38 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 39
...
execute if score stageSeconds Azr_system matches 41 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 42
execute if score stageSeconds Azr_system matches 42 if score playerCount Azr_system matches 1.. positioned -79959 38 6 run function skyblock:azr/m/zombie_t2_shield
execute if score stageSeconds Azr_system matches 43 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 44
...
execute if score stageSeconds Azr_system matches 45 if score playerCount Azr_system matches 1.. positioned -79959 38 6 run function skyblock:azr/m/zombie_t2_shield
...
execute if score stageSeconds Azr_system matches 48 if score playerCount Azr_system matches 4.. positioned -79959 38 6 run function skyblock:azr/m/zombie_t2_shield
...
execute if score stageSeconds Azr_system matches 49..51 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 52
...
execute if score stageSeconds Azr_system matches 65..66 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 67
...
execute if score stageSeconds Azr_system matches 99 if score playerCount Azr_system matches 1.. positioned -79959 38 6 run function skyblock:azr/m/zombie_t2_shield
execute if score stageSeconds Azr_system matches 100..102 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 103
...
execute if score stageSeconds Azr_system matches 104 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 105
...
execute if score stageSeconds Azr_system matches 106 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 107
execute if score stageSeconds Azr_system matches 107 if score playerCount Azr_system matches 1.. positioned -79959 38 6 run function skyblock:azr/m/zombie_t2_shield
execute if score stageSeconds Azr_system matches 108 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 109
execute if score stageSeconds Azr_system matches 109 if score playerCount Azr_system matches 5.. positioned -79959 38 6 run function skyblock:azr/m/zombie_t2_shield
execute if score stageSeconds Azr_system matches 110..111 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 112
...
execute if score stageSeconds Azr_system matches 112 if score playerCount Azr_system matches 5.. positioned -79951 38 10 run function skyblock:azr/m/silverfish_t1
...
execute if score stageSeconds Azr_system matches 113 if score playerCount Azr_system matches 7.. positioned -79959 38 6 run function skyblock:azr/m/zombie_t1_5hp_full_armor
execute if score stageSeconds Azr_system matches 113 if score playerCount Azr_system matches 7.. positioned -79948 38 6 run function skyblock:azr/m/zombie_t1_5hp_full_armor
...
execute if score stageSeconds Azr_system matches 114 if score playerCount Azr_system matches 6.. positioned -79951 38 10 run function skyblock:azr/m/silverfish_t1
execute if score stageSeconds Azr_system matches 114 if score playerCount Azr_system matches 6.. positioned -79948 38 6 run function skyblock:azr/m/zombie_militia_t1
execute if score stageSeconds Azr_system matches 115 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 116
execute if score stageSeconds Azr_system matches 116 if score playerCount Azr_system matches 1.. positioned -79951 38 10 run function skyblock:azr/m/silverfish_t1
execute if score stageSeconds Azr_system matches 116 if score playerCount Azr_system matches 5.. positioned -79951 38 10 run function skyblock:azr/m/silverfish_t1
execute if score stageSeconds Azr_system matches 116 if score playerCount Azr_system matches 1.. positioned -79959 38 6 run function skyblock:azr/m/zombie_militia_t1
execute if score stageSeconds Azr_system matches 117..121 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 122
execute if score stageSeconds Azr_system matches 122 if score playerCount Azr_system matches 4.. positioned -79948 38 6 run function skyblock:azr/m/zombie_militia_t1
...
execute if score stageSeconds Azr_system matches 122 if score playerCount Azr_system matches 6.. positioned -79959 38 6 run function skyblock:azr/m/zombie_militia_t1
execute if score stageSeconds Azr_system matches 123 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 124
execute if score stageSeconds Azr_system matches 124 if score playerCount Azr_system matches 7.. positioned -79948 38 6 run function skyblock:azr/m/zombie_militia_t1
...
execute if score stageSeconds Azr_system matches 124 if score playerCount Azr_system matches 1.. positioned -79944 38 3 run function skyblock:azr/m/pillager_t1_enchant
execute if score stageSeconds Azr_system matches 124 if score playerCount Azr_system matches 1.. positioned -79942 38 3 run function skyblock:azr/m/pillager_t1_enchant
execute if score stageSeconds Azr_system matches 125..127 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 128
execute if score stageSeconds Azr_system matches 128 if score playerCount Azr_system matches 6.. positioned -79944 38 3 run function skyblock:azr/m/zombie_t1_5hp_full_armor
execute if score stageSeconds Azr_system matches 128 if score playerCount Azr_system matches 6.. positioned -79942 38 3 run function skyblock:azr/m/zombie_t1_5hp_full_armor
execute if score stageSeconds Azr_system matches 128 if score playerCount Azr_system matches 1.. positioned -79948 38 6 run function skyblock:azr/m/zombie_t2_shield
execute if score stageSeconds Azr_system matches 129..131 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 132
...
execute if score stageSeconds Azr_system matches 132 if score playerCount Azr_system matches 1.. positioned -79948 38 6 run function skyblock:azr/m/zombie_t1_5hp_full_armor
execute if score stageSeconds Azr_system matches 132 if score playerCount Azr_system matches 5.. positioned -79948 38 6 run function skyblock:azr/m/zombie_t2_shield
execute if score stageSeconds Azr_system matches 132 if score playerCount Azr_system matches 4.. positioned -79959 38 6 run function skyblock:azr/m/zombie_t2_shield
execute if score stageSeconds Azr_system matches 132 if score playerCount Azr_system matches 7.. positioned -79959 38 6 run function skyblock:azr/m/zombie_t1_5hp_full_armor
execute if score stageSeconds Azr_system matches 132 if score playerCount Azr_system matches 7.. positioned -79959 38 6 run function skyblock:azr/m/zombie_t1_5hp_full_armor
execute if score stageSeconds Azr_system matches 133 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 134
execute if score stageSeconds Azr_system matches 134 if score playerCount Azr_system matches 5.. positioned -79948 38 6 run function skyblock:azr/m/zombie_t1_5hp_full_armor
execute if score stageSeconds Azr_system matches 134 if score playerCount Azr_system matches 6.. positioned -79959 38 6 run function skyblock:azr/m/zombie_t1_5hp_full_armor
execute if score stageSeconds Azr_system matches 135..137 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 138
...
execute if score stageSeconds Azr_system matches 138 if score playerCount Azr_system matches 5.. positioned -79959 38 6 run function skyblock:azr/m/zombie_t2_shield
...
execute if score stageSeconds Azr_system matches 161 if score playerCount Azr_system matches 4.. positioned -79951 38 10 run function skyblock:azr/m/silverfish_t1
execute if score stageSeconds Azr_system matches 161 if score playerCount Azr_system matches 1.. positioned -79951 38 10 run function skyblock:azr/m/silverfish_t1
execute if score stageSeconds Azr_system matches 162 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 163
execute if score stageSeconds Azr_system matches 163 if score playerCount Azr_system matches 1.. positioned -79943 38 3 run function skyblock:azr/m/zombie_t1_5hp_full_armor
...
execute if score stageSeconds Azr_system matches 164 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 165
execute if score stageSeconds Azr_system matches 165 if score playerCount Azr_system matches 1.. positioned -79943 38 3 run function skyblock:azr/m/zombie_t1_5hp_full_armor
...
execute if score stageSeconds Azr_system matches 171 if score playerCount Azr_system matches 1.. positioned -79959 38 6 run function skyblock:azr/m/zombie_t2_shield
...
execute if score stageSeconds Azr_system matches 175 if score playerCount Azr_system matches 1.. positioned -79948 38 6 run function skyblock:azr/m/zombie_t2_shield
...
execute if score stageSeconds Azr_system matches 183 positioned -79943 38 10 run function skyblock:azr/m/spider_t1_swift
execute if score stageSeconds Azr_system matches 183 positioned -79943 38 10 run function skyblock:azr/m/spider_t1_swift
execute if score stageSeconds Azr_system matches 184 if score playerCount Azr_system matches 7.. positioned -79943 38 10 run function skyblock:azr/m/spider_t1_swift
execute if score stageSeconds Azr_system matches 184 if score playerCount Azr_system matches 7.. positioned -79943 38 10 run function skyblock:azr/m/spider_t1_swift
execute if score stageSeconds Azr_system matches 185 positioned -79943 38 10 run function skyblock:azr/m/spider_t1_ruin
execute if score stageSeconds Azr_system matches 185 positioned -79943 38 10 run function skyblock:azr/m/spider_t1_swift
execute if score stageSeconds Azr_system matches 186 positioned -79943 38 10 run function skyblock:azr/m/spider_t1_ruin
execute if score stageSeconds Azr_system matches 187 positioned -79943 38 10 run function skyblock:azr/m/spider_t1_swift
execute store result score temp_rng Azr_system run random value 1..4
execute if score stageSeconds Azr_system matches 187 if score temp_rng Azr_system matches 1 positioned -79943 38 10 run function skyblock:azr/m/spider_t1_dust
execute if score stageSeconds Azr_system matches 188 if score temp_rng Azr_system matches 2 positioned -79943 38 10 run function skyblock:azr/m/spider_t1_ruin
execute if score stageSeconds Azr_system matches 189 if score temp_rng Azr_system matches 3 positioned -79943 38 10 run function skyblock:azr/m/spider_t1_swift
execute if score stageSeconds Azr_system matches 190 if score temp_rng Azr_system matches 4 positioned -79943 38 10 run function skyblock:azr/m/spider_t1_swift
execute if score stageSeconds Azr_system matches 191..194 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 195
execute if score stageSeconds Azr_system matches 191 if score playerCount Azr_system matches 4.. if score temp_rng Azr_system matches 1 positioned -79943 38 10 run function skyblock:azr/m/spider_t1_dust
execute if score stageSeconds Azr_system matches 192 if score playerCount Azr_system matches 4.. if score temp_rng Azr_system matches 2 positioned -79943 38 10 run function skyblock:azr/m/spider_t1_ruin
execute if score stageSeconds Azr_system matches 193 if score playerCount Azr_system matches 4.. if score temp_rng Azr_system matches 3 positioned -79943 38 10 run function skyblock:azr/m/spider_t1_swift
execute if score stageSeconds Azr_system matches 194 if score playerCount Azr_system matches 4.. if score temp_rng Azr_system matches 4 positioned -79943 38 10 run function skyblock:azr/m/spider_t1_swift
execute if score stageSeconds Azr_system matches 195 if score temp_rng Azr_system matches 1 positioned -79943 38 10 run function skyblock:azr/m/spider_t1_dust
execute if score stageSeconds Azr_system matches 196 if score temp_rng Azr_system matches 2 positioned -79943 38 10 run function skyblock:azr/m/spider_t1_ruin
execute if score stageSeconds Azr_system matches 197 if score temp_rng Azr_system matches 3 positioned -79943 38 10 run function skyblock:azr/m/spider_t1_swift
execute if score stageSeconds Azr_system matches 196 if score temp_rng Azr_system matches 4 positioned -79943 38 10 run function skyblock:azr/m/spider_t1_swift
execute if score stageSeconds Azr_system matches 195 positioned -79943 38 10 run function skyblock:azr/m/spider_t1_swift
execute if score stageSeconds Azr_system matches 193 positioned -79943 38 10 run function skyblock:azr/m/spider_t1_swift
...
execute if score stageSeconds Azr_system matches 194 if score playerCount Azr_system matches 6.. positioned -79943 38 10 run function skyblock:azr/m/zombie_t2_shield
execute if score stageSeconds Azr_system matches 198 if score playerCount Azr_system matches 6.. positioned -79943 38 10 run function skyblock:azr/m/zombie_t2_shield
execute if score stageSeconds Azr_system matches 199 if score playerCount Azr_system matches 6.. positioned -79943 38 10 run function skyblock:azr/m/zombie_t2_shield
execute if score stageSeconds Azr_system matches 200..202 unless entity @n[tag=AzrielMob] run scoreboard players set stageSeconds Azr_system 203
#回秒
...
execute if score stageSeconds Azr_system matches 204 run advancement grant @a[tag=azrPlayer] only skyblock:azr/azr_stage3_alt
execute if score stageSeconds Azr_system matches 204 run summon minecraft:chest_boat -79942.75 37.52 17.70 {Invulnerable: 1b, Rotation: [120.60768f, 0.0f], Type: "birch", Items: [{count: 1, Slot: 11b, id: "minecraft:lapis_lazuli"}, {count: 5, Slot: 13b, id: "minecraft:emerald"}, {count: 1, Slot: 15b, id: "minecraft:lapis_lazuli"}]}
...
#【僵尸 lv1】execute if score stageSeconds Azr_system matches 1 positioned -79959 38 6 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_zombie_tier1",Attributes:[{Name:generic.max_health,Base:4.0},{Name:generic.attack_damage,Base:1.5}],Health:4.0f,CustomName:"\"僵尸\"",CanPickUpLoot:0b,IsBaby:0b,ArmorItems:[{},{},{},{}]}
#【僵尸+ lv2】execute if score stageSeconds Azr_system matches 1 positioned -79959 38 6 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_zombie_tier1",Attributes:[{Name:generic.max_health,Base:5.0},{Name:generic.attack_damage,Base:2.0}],Health:5.0f,CustomName:"\"僵尸\"",CanPickUpLoot:0b,IsBaby:0b,ArmorItems:[{count:1,id:"leather_boots",tag:{display:{Name:"{\"text\":\"皮革靴\",\"italic\":false,\"color\":\"white\"}"}}},{count:1,id:"leather_leggings",tag:{display:{Name:"{\"text\":\"皮革裤\",\"italic\":false,\"color\":\"white\"}"}}},{count:1,id:"leather_chestplate",tag:{display:{Name:"{\"text\":\"皮革甲\",\"italic\":false,\"color\":\"white\"}"}}},{count:1,id:"leather_helmet",tag:{display:{Name:"{\"text\":\"皮革帽\",\"italic\":false,\"color\":\"white\"}"}}}],ArmorDropChances:[0.02f,0.02f,0.02f,0.02f]}
#【僵尸++ lv6】execute if score stageSeconds Azr_system matches 1 positioned -79959 38 6 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_zombie_tier1",Attributes:[{Name:generic.max_health,Base:6.5},{Name:generic.attack_damage,Base:2.0}],Health:6.5f,CustomName:"\"僵尸\"",CanPickUpLoot:0b,IsBaby:0b,ArmorItems:[{count:1,id:"leather_boots",tag:{display:{Name:"{\"text\":\"皮革靴\",\"italic\":false,\"color\":\"white\"}"}}},{count:1,id:"leather_leggings",tag:{display:{Name:"{\"text\":\"皮革裤\",\"italic\":false,\"color\":\"white\"}"}}},{count:1,id:leather_chestplate,tag:{Enchantments:[{id:protection,lvl:1}]}},{count:1,id:leather_helmet,tag:{Enchantments:[{id:protection,lvl:1}]}}],ArmorDropChances:[0.02f,0.02f,0.02f,0.02f]}
#【小僵尸 lv6】execute if score stageSeconds Azr_system matches 1 positioned -79959 38 6 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_zombie_tier2_small",Attributes:[{Name:generic.max_health,Base:4.5},{Name:generic.attack_damage,Base:1.5},{Name:generic.movement_speed,Base:0.21}],Health:4.5f,CustomName:"\"小僵尸\"",CanPickUpLoot:0b,IsBaby:1b}
#【尸壳A lv6】execute if score stageSeconds Azr_system matches 1 positioned -79959 38 6 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_zombie_tier2",Attributes:[{Name:generic.max_health,Base:6.5},{Name:generic.attack_damage,Base:1.5},{Name:generic.movement_speed,Base:0.26},{Name:generic.attack_knockback,Base:0.15}],Health:6.5f,CustomName:"\"尸壳\"",CanPickUpLoot:0b,IsBaby:0b,ArmorItems:[{},{},{count:1,id:leather_chestplate,tag:{Enchantments:[{id:fire_protection,lvl:3}]}},{}],ArmorDropChances:[0.02f,0.02f,0.01f,0.02f]}
#【尸壳B lv6】execute if score stageSeconds Azr_system matches 1 positioned -79959 38 6 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_zombie_tier2",Attributes:[{Name:generic.max_health,Base:6.5},{Name:generic.attack_damage,Base:1.5},{Name:generic.movement_speed,Base:0.26},{Name:generic.attack_knockback,Base:0.15}],Health:6.5f,CustomName:"\"尸壳\"",CanPickUpLoot:0b,IsBaby:0b,ArmorItems:[{},{},{count:1,id:chainmail_chestplate,tag:{Enchantments:[{id:projectile_protection,lvl:2}]}},{}],ArmorDropChances:[0.02f,0.02f,0.01f,0.02f]}
#【弩手 lv1】execute if score stageSeconds Azr_system matches 19 positioned -79927 38 122 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_pillager_tier1",Attributes:[{Name:generic.max_health,Base:3.0},{Name:generic.attack_damage,Base:0.5}],Health:2.0f,CustomName:"\"弩手\"",HandItems:[{count:1,id:"crossbow",tag:{display:{Name:"{\"text\":\"弩·传统\",\"italic\":false,\"color\":\"white\"}"}}}],HandDropChances:[0.003f],ArmorItems:[{},{},{},{}]}
#【弩手+ lv2】execute if score stageSeconds Azr_system matches 19 positioned -79959 38 6 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_pillager_tier1",Attributes:[{Name:generic.max_health,Base:3.0},{Name:generic.attack_damage,Base:0.5}],Health:2.0f,CustomName:"\"弩手\"",CanPickUpLoot:0b,HandItems:[{count:1,id:crossbow,tag:{Enchantments:[{id:quick_charge,lvl:1},{id:piercing,lvl:1}]}}],HandDropChances:[0.003f],ArmorItems:[{},{},{},{}]}
#【迅弩手 lv4】execute if score stageSeconds Azr_system matches 124}] #rng4 matches 1 positioned -79959 38 6 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_pillager_tier2",Attributes:[{Name:generic.max_health,Base:7.0},{Name:generic.attack_damage,Base:1.0}],Health:5.0f,CustomName:"\"迅弩手\"",CanPickUpLoot:0b,HandItems:[{count:1,id:crossbow,tag:{Enchantments:[{id:quick_charge,lvl:2},{id:piercing,lvl:2}]}}],HandDropChances:[0.004f],ArmorItems:[{},{},{},{}]}
#【第一关口巡逻兵 lv4】execute if score stageSeconds Azr_system matches 19 positioned -79927 38 122 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_vindicator_tier1",Attributes:[{Name:generic.max_health,Base:6.0},{Name:generic.attack_damage,Base:0.0},{Name:generic.movement_speed,Base:0.14}],Health:6.0f,CustomName:"\"第一关口巡逻兵\"",CanPickUpLoot:0b,HandItems:[{count:1,id:"stone_sword",tag:{display:{Name:"{\"text\":\"石剑\",\"italic\":false,\"color\":\"white\"}"}}}],HandDropChances:[0.003f]}
#【圣殿巡逻兵 lv5】execute if score stageSeconds Azr_system matches 19 positioned -79927 38 122 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_vindicator_tier1",Attributes:[{Name:generic.max_health,Base:12.0},{Name:generic.attack_damage,Base:0.0},{Name:generic.movement_speed,Base:0.20}],Health:12.0f,CustomName:"\"圣殿巡逻兵\"",CanPickUpLoot:0b,HandItems:[{count:1,id:"stone_sword",tag:{display:{Name:"{\"text\":\"石剑\",\"italic\":false,\"color\":\"white\"}"}}}],HandDropChances:[0.003f]}
#【骷髅射手 lv5】execute if score stageSeconds Azr_system matches 19 positioned -79959 38 6 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_skeleton_tier1",Attributes:[{Name:generic.max_health,Base:18.0},{Name:generic.attack_damage,Base:1.0}],Health:6.0f,CustomName:"\"骷髅射手\"",CanPickUpLoot:0b,HandItems:[{count:1,id:bow,tag:{display:{Name:"{\"text\":\"弓·传统\",\"italic\":false,\"color\":\"white\"}"}}}],HandDropChances:[0.003f],ArmorItems:[{},{},{},{}]}
#【骷髅射手+ lv6】execute if score stageSeconds Azr_system matches 19 positioned -79959 38 6 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_skeleton_tier1",Attributes:[{Name:generic.max_health,Base:21.0},{Name:generic.attack_damage,Base:1.0}],Health:7.0f,CustomName:"\"骷髅射手\"",CanPickUpLoot:0b,HandItems:[{count:1,id:bow,tag:{Enchantments:[{id:unbreaking,lvl:1}]}}],HandDropChances:[0.003f],ArmorItems:[{},{},{count:1,id:"leather_chestplate",tag:{display:{Name:"{\"text\":\"皮革甲\",\"italic\":false,\"color\":\"white\"}"}}},{count:1,id:"leather_helmet",tag:{display:{Name:"{\"text\":\"皮革帽\",\"italic\":false,\"color\":\"white\"}"}}}],ArmorDropChances:[0.02f,0.02f,0.02f,0.02f]}
#【僵尸民兵 lv3】execute if score stageSeconds Azr_system matches 28 positioned -79959 38 6 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_zombie_militia_tier1",Attributes:[{Name:generic.max_health,Base:5.0},{Name:generic.attack_damage,Base:1.5},{Name:generic.movement_speed,Base:0.19}],Health:5.0f,CustomName:"\"僵尸民兵\"",CanPickUpLoot:0b,IsBaby:0b,HandItems:[{count:1,id:"wooden_sword",tag:{display:{Name:"{\"text\":\"木剑\",\"italic\":false,\"color\":\"white\"}"}}}],HandDropChances:[0.06f],ArmorItems:[{},{},{count:1,id:"chainmail_chestplate",tag:{display:{Name:"{\"text\":\"链甲\",\"italic\":false,\"color\":\"white\"}"}}},{}],ArmorDropChances:[0.02f,0.02f,0.02f,0.02f]}
#【僵尸民兵+ lv5】execute if score stageSeconds Azr_system matches 28 positioned -79959 38 6 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_zombie_militia_tier1",Attributes:[{Name:generic.max_health,Base:7.0},{Name:generic.attack_damage,Base:2.0},{Name:generic.movement_speed,Base:0.18}],Health:7.0f,CustomName:"\"僵尸民兵\"",CanPickUpLoot:0b,IsBaby:0b,HandItems:[{count:1,id:"wooden_sword",tag:{display:{Name:"{\"text\":\"木剑\",\"italic\":false,\"color\":\"white\"}"}}}],HandDropChances:[0.06f],ArmorItems:[{count:1,id:"leather_boots",tag:{display:{Name:"{\"text\":\"皮革靴\",\"italic\":false,\"color\":\"white\"}"}}},{count:1,id:"leather_leggings",tag:{display:{Name:"{\"text\":\"皮革裤\",\"italic\":false,\"color\":\"white\"}"}}},{count:1,id:"chainmail_chestplate",tag:{display:{Name:"{\"text\":\"链甲\",\"italic\":false,\"color\":\"white\"}"}}},{count:1,id:"leather_helmet",tag:{display:{Name:"{\"text\":\"皮革帽\",\"italic\":false,\"color\":\"white\"}"}}}],ArmorDropChances:[0.02f,0.02f,0.02f,0.02f]}
#【盾兵僵尸 lv2】execute if score stageSeconds Azr_system matches 32 positioned -79959 38 6 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_zombie_tier2_shield",Attributes:[{Name:generic.max_health,Base:10.0},{Name:generic.attack_damage,Base:1.5}],Health:10.0f,CustomName:"\"盾兵僵尸\"",CanPickUpLoot:0b,IsBaby:0b,HandItems:[{count:1,id:"shield",tag:{display:{Name:"{\"text\":\"盾\",\"italic\":false,\"color\":\"white\"}"}}}],HandDropChances:[0.003f],ArmorItems:[{},{},{},{count:1,id:"leather_helmet",tag:{display:{Name:"{\"text\":\"皮革帽\",\"italic\":false,\"color\":\"white\"}"}}}],ArmorDropChances:[0.02f,0.02f,0.02f,0.02f]}
#【盾兵僵尸+ lv5】execute if score stageSeconds Azr_system matches 32 positioned -79959 38 6 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_zombie_tier2_shield",Attributes:[{Name:generic.max_health,Base:14.0},{Name:generic.attack_damage,Base:1.5},{Name:generic.knockback_resistance,Base:0.25}],Health:14.0f,CustomName:"\"盾兵僵尸\"",CanPickUpLoot:0b,IsBaby:0b,HandItems:[{count:1,id:"shield",tag:{display:{Name:"{\"text\":\"盾\",\"italic\":false,\"color\":\"white\"}"}}}],HandDropChances:[0.003f],ArmorItems:[{},{},{count:1,id:"iron_chestplate",tag:{display:{Name:"{\"text\":\"铁胸甲\",\"italic\":false,\"color\":\"white\"}"}}},{count:1,id:"iron_helmet",tag:{display:{Name:"{\"text\":\"铁盔\",\"italic\":false,\"color\":\"white\"}"}}}],ArmorDropChances:[0.015f,0.015f,0.015f,0.015f]}
#【惰虫 lv3】execute if score stageSeconds Azr_system matches 39 positioned -79951 38 10 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_silverfish_tier1",Attributes:[{Name:generic.max_health,Base:3.5},{Name:generic.attack_damage,Base:1.0},{Name:generic.movement_speed,Base:0.15}],Health:3.5f,CustomName:"\"惰虫\""}
#【廊虫 lv4】execute if score stageSeconds Azr_system matches 39 positioned -79951 38 10 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_silverfish_tier1",Attributes:[{Name:generic.max_health,Base:5.5},{Name:generic.attack_damage,Base:2.0},{Name:generic.movement_speed,Base:0.25}],Health:5.5f,CustomName:"\"廊虫\""}
#【妒䖞 lv6】execute if score stageSeconds Azr_system matches 39 positioned -79951 38 10 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_silverfish_tier2",Attributes:[{Name:generic.max_health,Base:6.5},{Name:generic.attack_damage,Base:4.0},{Name:generic.movement_speed,Base:0.3}],Health:6.5f,CustomName:"\"妒䖞\""}
#【工兵僵尸 lv3】execute if score stageSeconds Azr_system matches 109 positioned -79959 38 6 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_zombie_militia_tier1",Attributes:[{Name:generic.max_health,Base:6.5},{Name:generic.attack_damage,Base:2.0}],Health:6.5f,CustomName:"\"工兵僵尸\"",CanPickUpLoot:0b,IsBaby:0b,HandItems:[{count:1,id:"stone_shovel",tag:{display:{Name:"{\"text\":\"工兵石铲\",\"italic\":false,\"color\":\"white\"}"}}}],HandDropChances:[0.003f],ArmorItems:[{count:1,id:"leather_boots",tag:{display:{Name:"{\"text\":\"皮革靴\",\"italic\":false,\"color\":\"white\"}"}}},{count:1,id:"leather_leggings",tag:{display:{Name:"{\"text\":\"皮革裤\",\"italic\":false,\"color\":\"white\"}"}}},{count:1,id:"leather_chestplate",tag:{display:{Name:"{\"text\":\"皮革甲\",\"italic\":false,\"color\":\"white\"}"}}},{count:1,id:"leather_helmet",tag:{display:{Name:"{\"text\":\"皮革帽\",\"italic\":false,\"color\":\"white\"}"}}}],ArmorDropChances:[0.02f,0.02f,0.02f,0.02f]}
#【工兵僵尸+ lv6】execute if score stageSeconds Azr_system matches 109 positioned -79959 38 6 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_zombie_militia_tier1",Attributes:[{Name:generic.max_health,Base:9.5},{Name:generic.attack_damage,Base:2.5}],Health:9.5f,CustomName:"\"工兵僵尸\"",CanPickUpLoot:0b,IsBaby:0b,HandItems:[{count:1,id:stone_shovel,tag:{Enchantments:[{id:sharpness,lvl:1}]}}],HandDropChances:[0.003f],ArmorItems:[{count:1,id:"iron_boots",tag:{display:{Name:"{\"text\":\"铁靴\",\"italic\":false,\"color\":\"white\"}"}}},{count:1,id:"iron_leggings",tag:{display:{Name:"{\"text\":\"铁护腿\",\"italic\":false,\"color\":\"white\"}"}}},{count:1,id:"leather_chestplate",tag:{display:{Name:"{\"text\":\"皮革甲\",\"italic\":false,\"color\":\"white\"}"}}},{count:1,id:"leather_helmet",tag:{display:{Name:"{\"text\":\"皮革帽\",\"italic\":false,\"color\":\"white\"}"}}}],ArmorDropChances:[0.02f,0.02f,0.02f,0.02f]}
#【遗迹蜘蛛 lv3】execute if score stageSeconds Azr_system matches 222 positioned -79959 38 6 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_spider_tier1",Attributes:[{Name:generic.max_health,Base:4.5},{Name:generic.attack_damage,Base:1.5},{Name:generic.movement_speed,Base:0.24}],Health:4.5f,CustomName:"\"遗迹蜘蛛\""}
#【迅蛛 lv3】execute if score stageSeconds Azr_system matches 222 positioned -79959 38 6 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_spider_tier1",Attributes:[{Name:generic.max_health,Base:2.5},{Name:generic.attack_damage,Base:1.0},{Name:generic.movement_speed,Base:0.4}],Health:2.5f,CustomName:"\"迅蛛\""}
#【禁尘蜘蛛 lv4】execute if score stageSeconds Azr_system matches 222 positioned -79959 38 6 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_spider_tier1",Attributes:[{Name:generic.max_health,Base:8.0},{Name:generic.attack_damage,Base:2.0},{Name:generic.knockback_resistance,Base:0.5},{Name:generic.movement_speed,Base:0.18}],Health:8.0f,CustomName:"\"禁尘蜘蛛\"",ActiveEffects:[{Id:11,Amplifier:0,Duration:10000,Ambient:0},{Id:10,Amplifier:0,Duration:10000,Ambient:0}]}
#【梦魇蜘蛛 lv20】execute if score stageSeconds Azr_system matches 222 positioned -79959 38 6 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_spider_tier3",Attributes:[{Name:generic.max_health,Base:28.0},{Name:generic.attack_damage,Base:12.0},{Name:generic.knockback_resistance,Base:0.7},{Name:generic.movement_speed,Base:0.38}],Health:28.0f,CustomName:"\"梦魇蜘蛛\"",ActiveEffects:[{Id:11,Amplifier:0,Duration:10000,Ambient:0},{Id:10,Amplifier:0,Duration:10000,Ambient:0}]}
