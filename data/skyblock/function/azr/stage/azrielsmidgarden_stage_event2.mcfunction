...
execute as @a[tag=!Azr_SKun,tag=azrPlayer,x=-79938,y=41,z=160,distance=..5,scores={If_Lectern=1..}] at @s run tag @s add Event2Suc
...
execute as @a[tag=Event2Suc] at @s run playsound minecraft:entity.evoker.cast_spell master @a[tag=azrPlayer] ~ ~ ~ 2 1
