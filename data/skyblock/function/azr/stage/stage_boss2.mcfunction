...
#AI-二阶段
    ...
    execute if score tickTimer Azr_system matches 6750 run summon pillager -79932 38 -32 {Rotation:[-28.6f,0.0f],Invulnerable:1b,CanPickUpLoot:0b,PersistenceRequired:1b,Tags:["AzrielFriendly"],Health:3.0f,CustomName:'"弩手"',attributes:[{id:"generic.max_health",base:3.0d},{id:"movement_speed",base:0.0d}],Team:"AzrPlayer"}
