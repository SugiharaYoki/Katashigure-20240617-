...
#start
    #boss2 prepare
    execute unless score tickTimer Azr_system matches -2147483648..2147483647 as @a[x=-79884,y=38,z=-15,distance=..2,tag=azrPlayer] run tp @a[tag=azrPlayer,distance=0.1..] @s
    execute unless score tickTimer Azr_system matches -2147483648..2147483647 as @a[x=-79884,y=38,z=-15,distance=..2,tag=azrPlayer] run scoreboard players set tickTimer Azr_system 0
