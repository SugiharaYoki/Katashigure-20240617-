...
#AI
    ...
    execute if score tickTimer Azr_system matches 152..5000 if score #rng8 Azr_system matches 1 as @e[tag=AzrielBossA,type=illusioner,limit=3,nbt={OnGround:1b}] at @s run rotate @s facing entity @p[tag=azrPlayer]
...
#AI - 一阶段
    ...
    execute if score tickTimer Azr_system matches 1335 if score #rng7 Azr_system matches 3..4 if score #rng8 Azr_system matches 3..4 if score #rng6 Azr_system matches 4..5 as @e[tag=AzrielBossA,type=illusioner,limit=3] at @s run function skyblock:azr/stage/boss2/move3
...
#AI-二阶段
    ...
    execute if score tickTimer Azr_system matches 3910 as @n[tag=AzrielBossA,type=illusioner] at @s run function skyblock:azr/stage/boss2/skill_select
    execute if score tickTimer Azr_system matches 4110 as @n[tag=AzrielBossA,type=illusioner] at @s run function skyblock:azr/stage/boss2/skill_select
    ...
    execute if score tickTimer Azr_system matches 3310..4110 store result score #azr_boss2_rng rng9 run random value 1..40
    ...
    execute if score tickTimer Azr_system matches 3150..4150 if score #azr_boss2_rng rng9 matches 2 as @e[tag=AzrielBossA,type=illusioner,limit=3] at @s if entity @a[tag=azrPlayer,distance=0..4.5] run function skyblock:azr/stage/boss1/tp1
    execute if score tickTimer Azr_system matches 3150..4150 if score #azr_boss2_rng rng9 matches 3 as @e[tag=AzrielBossA,type=illusioner,limit=3] at @s if entity @a[tag=azrPlayer,distance=0..6.5] run function skyblock:azr/stage/boss1/move1
    ...
    execute if score tickTimer Azr_system matches 3500..3760 if score #azr_boss2_rng rng9 matches 6 as @e[tag=AzrielBossA,type=illusioner,limit=3] at @s run function skyblock:azr/stage/boss2/move3
    ...
    execute if score tickTimer Azr_system matches 3310..4110 store result score #azr_boss2_rng rng8 run random value 1..80
    execute if score tickTimer Azr_system matches 3150..4150 if score #azr_boss2_rng rng8 matches 1 as @e[tag=AzrielBossA,type=illusioner,limit=3] at @s run item replace entity @s weapon.offhand with tipped_arrow[potion_contents={custom_color:16763161,custom_effects:[{id:"slowness",duration:100}]}]
    execute if score tickTimer Azr_system matches 3150..4150 if score #azr_boss2_rng rng8 matches 2 as @e[tag=AzrielBossA,type=illusioner,limit=3] at @s run item replace entity @s weapon.offhand with tipped_arrow[potion_contents={custom_color:16734631,custom_effects:[{id:"nausea",duration:100}]}]
    execute if score tickTimer Azr_system matches 3150..4150 if score #azr_boss2_rng rng8 matches 3 as @e[tag=AzrielBossA,type=illusioner,limit=3] at @s run item replace entity @s weapon.offhand with tipped_arrow[potion_contents={custom_color:7421439,custom_effects:[{id:"weakness",duration:100}]}]
    execute if score tickTimer Azr_system matches 3150..4150 if score #azr_boss2_rng rng8 matches 4 as @e[tag=AzrielBossA,type=illusioner,limit=3] at @s run item replace entity @s weapon.offhand with tipped_arrow[potion_contents={custom_color:980839,custom_effects:[{id:"poison",duration:100}]}]
