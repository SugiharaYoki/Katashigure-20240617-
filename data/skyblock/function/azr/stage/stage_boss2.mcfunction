...
#AI - 一阶段
    ...
    # Wave I 循环直到第一阶段死亡
    execute if score tickTimer Azr_system matches 1001 as @e[tag=AzrielBossA,type=illusioner,limit=3] at @s run function skyblock:azr/stage/boss1/flat1_w
    execute if score tickTimer Azr_system matches 1021 if score #rng3 Azr_system matches 1 as @e[tag=AzrielBossA,type=illusioner,limit=3] at @s run function skyblock:azr/stage/boss1/flat1
    execute if score tickTimer Azr_system matches 1026 if score #rng3 Azr_system matches 2 as @e[tag=AzrielBossA,type=illusioner,limit=3] at @s run function skyblock:azr/stage/boss1/flat1
    execute if score tickTimer Azr_system matches 1031 if score #rng3 Azr_system matches 3 as @e[tag=AzrielBossA,type=illusioner,limit=3] at @s run function skyblock:azr/stage/boss1/flat1
    ...
    execute if score tickTimer Azr_system matches 1040..1510 if score #rng7 Azr_system matches 1 as @e[tag=AzrielBossA,type=illusioner,limit=3] at @s run function skyblock:azr/stage/boss1/flat1_w
    execute if score tickTimer Azr_system matches 1040..1510 if score #rng7 Azr_system matches 1 if score #rng3 Azr_system matches 1 as @e[tag=AzrielBossA,type=illusioner,limit=3] at @s run function skyblock:azr/stage/boss1/flat1
    execute if score tickTimer Azr_system matches 1040..1510 if score #rng7 Azr_system matches 1 if score #rng3 Azr_system matches 2 as @e[tag=AzrielBossA,type=illusioner,limit=3] at @s run function skyblock:azr/stage/boss1/flat1
    execute if score tickTimer Azr_system matches 1040..1510 if score #rng7 Azr_system matches 1 if score #rng3 Azr_system matches 3 as @e[tag=AzrielBossA,type=illusioner,limit=3] at @s run function skyblock:azr/stage/boss1/flat1
...
#AI-二阶段
    ...
    execute if score tickTimer Azr_system matches 3150..4150 if score #rng2 Azr_system matches 1 if score #rng19 Azr_system matches 1..11 if score #rng20 Azr_system matches 13..14 run function skyblock:azr/stage/boss2/flat6_w
