...
execute if entity @e[tag=sc,limit=1,scores={SeGa_StandLastQ=6110}] run summon illusioner -79903 44 -14.0 {Silent:1b,PersistenceRequired:1,Tags:["AzrielMob","AzrielBossA"],DeathLootTable:"skyblock:azriel_shadow_tier1",Attributes:[{Name:generic.max_health,Base:150.0},{Name:generic.movement_speed,Base:0.15},{Name:generic.knockback_resistance,Base:1.0}],Health:150.0f,CustomName:"\"权之残影\"",Invulnerable:true}
...
execute if entity @e[tag=sc,limit=1,scores={SeGa_StandLastQ=6750}] run summon pillager -79932 38 -32 {Rotation:[-28.6f,0f],Invulnerable:1,CanPickUpLoot:0,PersistenceRequired:1,Tags:["AzrielFriendly"],Attributes:[{Name:generic.max_health,Base:3.0},{Name:generic.movement_speed,Base:0.10}],Health:3.0f,CustomName:"\"弩手\""}
execute if entity @e[tag=sc,limit=1,scores={SeGa_StandLastQ=6750}] run summon vindicator -79930 38 -34 {Rotation:[90f,0f],NoAI:1,Invulnerable:1,PersistenceRequired:1,Tags:["AzrielFriendly"],Attributes:[{Name:generic.max_health,Base:12.0},{Name:generic.movement_speed,Base:0.20}],Health:12.0f,CustomName:"\"圣殿巡逻兵\"",CanPickUpLoot:0,HandItems:[{Count:1,id:"stone_sword",tag:{display:{Name:"{\"text\":\"石剑\",\"italic\":false,\"color\":\"white\"}"}}}]}
execute if entity @e[tag=sc,limit=1,scores={SeGa_StandLastQ=6750}] run summon vindicator -79932 38 -34 {Invulnerable:1,PersistenceRequired:1,Tags:["AzrielFriendly"],Attributes:[{Name:generic.max_health,Base:12.0},{Name:generic.movement_speed,Base:0.10},{Name:generic.attack_damage,Base:0.10},{Name:generic.follow_range,Base:0.0}],Health:12.0f,CustomName:"\"圣殿巡逻兵\"",CanPickUpLoot:0}

execute if entity @e[tag=sc,limit=1,scores={SeGa_StandLastQ=6750}] run summon endermite -79939 38 -71 {PersistenceRequired:1,Tags:["AzrielMob","AzrielDecMob","Immune"],DeathLootTable:"skyblock:azriel_endermite_tier1",Attributes:[{Name:generic.max_health,Base:16.0},{Name:generic.movement_speed,Base:0.28},{Name:generic.knockback_resistance,Base:0.9},{Name:generic.follow_range,Base:1.5},{Name:generic.attack_damage,Base:8.0}],Health:16.0f,CustomName:"\"夜盲虫\"",CanPickUpLoot:0}
