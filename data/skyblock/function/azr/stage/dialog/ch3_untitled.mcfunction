...
execute if score internal_clock_003 Azr_system matches 4 positioned -79866 48 -117 run function skyblock:azr/m/silverfish_t2_brick
...
execute if score internal_clock_003 Azr_system matches 8 positioned -79866 48 -117 run function skyblock:azr/m/silverfish_t2_brick
...
execute if score internal_clock_003 Azr_system matches 12 positioned -79866 48 -117 run function skyblock:azr/m/silverfish_t2_brick
...
execute if score internal_clock_003 Azr_system matches 16 positioned -79866 48 -117 run function skyblock:azr/m/silverfish_t2_brick
