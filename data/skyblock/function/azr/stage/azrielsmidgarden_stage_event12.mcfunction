...
execute if entity @e[tag=sc,limit=1,scores={Azr_Timerx4=2}] run summon piglin -79768 42 -227 {Invulnerable:1,IsImmuneToZombification:1b,PersistenceRequired:1,Tags:["AzrielMob","AzrielDecMob","Immune","AzrielEvent3761"],DeathLootTable:"skyblock:azriel_piglin_resident_tier1",Attributes:[{Name:generic.max_health,Base:10.0},{Name:generic.attack_damage,Base:0.0},{Name:generic.follow_range,Base:0.0}],Health:10.0f,CustomName:"\"猪灵居民\"",CanPickUpLoot:0,IsBaby:0,HandItems:[{}],HandDropChances:[0.05f],ArmorItems:[{},{},{},{}]}
execute if entity @e[tag=sc,limit=1,scores={Azr_Timerx4=2}] run summon piglin -79763 41 -239 {Invulnerable:1,IsImmuneToZombification:1b,PersistenceRequired:1,Tags:["AzrielMob","AzrielDecMob","Immune","AzrielEvent3762"],DeathLootTable:"skyblock:azriel_piglin_resident_tier1",Attributes:[{Name:generic.max_health,Base:10.0},{Name:generic.attack_damage,Base:0.0},{Name:generic.follow_range,Base:0.0}],Health:10.0f,CustomName:"\"猪灵居民\"",CanPickUpLoot:0,IsBaby:0,HandItems:[{Count:1,id:"spruce_trapdoor"}],HandDropChances:[0.05f],ArmorItems:[{},{},{Count:1,id:"leather_chestplate",tag:{display:{Name:"{\"text\":\"皮革甲\",\"italic\":false,\"color\":\"white\"}"}}},{}],NoAI:1}
...
execute if entity @e[tag=sc,limit=1,scores={Azr_Timerx4=2}] run summon piglin -79769 43 -253 {Invulnerable:1,IsImmuneToZombification:1b,PersistenceRequired:1,Tags:["AzrielMob","AzrielDecMob","Immune","AzrielEvent3765"],DeathLootTable:"skyblock:azriel_piglin_tier1",Attributes:[{Name:generic.max_health,Base:10.0},{Name:generic.attack_damage,Base:0.0},{Name:generic.follow_range,Base:0.0}],Health:10.0f,CustomName:"\"猪灵剑士\"",CanPickUpLoot:0,IsBaby:0,HandItems:[{Count:1,id:"golden_sword",tag:{display:{Name:"{\"text\":\"金剑\",\"italic\":false,\"color\":\"white\"}"}}}],HandDropChances:[0.05f],ArmorItems:[{},{},{Count:1,id:"golden_chestplate",tag:{display:{Name:"{\"text\":\"金胸甲\",\"italic\":false,\"color\":\"white\"}"}}},{}]}
execute if entity @e[tag=sc,limit=1,scores={Azr_Timerx4=2}] run summon piglin -79776 43 -248 {Invulnerable:1,IsImmuneToZombification:1b,PersistenceRequired:1,Tags:["AzrielMob","AzrielDecMob","Immune","AzrielEvent3763"],DeathLootTable:"skyblock:azriel_piglin_resident_tier1",Attributes:[{Name:generic.max_health,Base:10.0},{Name:generic.attack_damage,Base:0.0},{Name:generic.follow_range,Base:0.0}],Health:10.0f,CustomName:"\"猪灵居民\"",CanPickUpLoot:0,IsBaby:0,HandItems:[{}],HandDropChances:[0.05f],ArmorItems:[{},{},{},{}]}
execute if entity @e[tag=sc,limit=1,scores={Azr_Timerx4=2}] run summon bat -79764 45 -227 {PersistenceRequired:1,Tags:["AzrielMob","AzrielDecMob"]}
execute if entity @e[tag=sc,limit=1,scores={Azr_Timerx4=2}] run summon bat -79764 45 -227 {PersistenceRequired:1,Tags:["AzrielMob","AzrielDecMob"]}
execute if entity @e[tag=sc,limit=1,scores={Azr_Timerx4=2}] run summon bat -79764 45 -227 {PersistenceRequired:1,Tags:["AzrielMob","AzrielDecMob"]}
execute if entity @e[tag=sc,limit=1,scores={Azr_Timerx4=2}] run summon bat -79764 45 -227 {PersistenceRequired:1,Tags:["AzrielMob","AzrielDecMob"]}
