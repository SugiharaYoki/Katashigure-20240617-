execute at @e[tag=ZaneiSpotCage] run playsound minecraft:entity.arrow.shoot master @a[tag=ZaneiSpotCage] ~ ~ ~ 10 1
execute at @e[tag=ZaneiSpotCage] run playsound minecraft:entity.arrow.shoot master @a[tag=ZaneiSpotCage] ~ ~ ~ 10 0.8
execute at @e[tag=ZaneiSpotCage] run playsound minecraft:entity.firework_rocket.blast master @a[tag=ZaneiSpotCage] ~ ~ ~ 10 0.7
execute at @e[tag=ZaneiSpotCage] run summon arrow ~1.4 ~4 ~1.4 {Motion:[0.0,0.00,0.0],pickup:0,damage:5.0,life:1100}
