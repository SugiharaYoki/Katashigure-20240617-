...
execute if score AZR_boss2_breakingout rng1 matches 96..98 run kill @e[tag=AZR_boss2_breakingout_origin]
...
execute if score AZR_boss2_breakingout rng1 matches 69..92 if score AZR_boss2_breakingout rng2 matches 1 run tag @n[tag=AZR_boss2_breakingout_1] add AZR_boss2_breakingout_attacker
execute if score AZR_boss2_breakingout rng1 matches 69..92 if score AZR_boss2_breakingout rng2 matches 2 run tag @n[tag=AZR_boss2_breakingout_2] add AZR_boss2_breakingout_attacker
execute if score AZR_boss2_breakingout rng1 matches 69..92 if score AZR_boss2_breakingout rng2 matches 3 run tag @n[tag=AZR_boss2_breakingout_3] add AZR_boss2_breakingout_attacker
execute if score AZR_boss2_breakingout rng1 matches 69..92 if score AZR_boss2_breakingout rng2 matches 4 run tag @n[tag=AZR_boss2_breakingout_4] add AZR_boss2_breakingout_attacker

execute if score AZR_boss2_breakingout rng1 matches 69..92 at @n[tag=AZR_boss2_breakingout_attacker] run particle white_smoke ^ ^2 ^1.2 0.3 0.3 0.3 0.03 30
execute if score AZR_boss2_breakingout rng1 matches 69..92 at @n[tag=AZR_boss2_breakingout_attacker] run playsound minecraft:entity.arrow.shoot hostile @a ~ ~ ~ 1 1.3
execute if score AZR_boss2_breakingout rng1 matches 69..92 if score AZR_boss2_breakingout rng3 matches 1 at @e[tag=AZR_boss2_breakingout_attacker] run summon arrow ^ ^0.1 ^1.2 {Motion:[0d,1.7d,0d],Rotation:[0f,90f],life:1100,damage:3.0,Fire:100s}
execute if score AZR_boss2_breakingout rng1 matches 69..92 if score AZR_boss2_breakingout rng3 matches 2 at @e[tag=AZR_boss2_breakingout_attacker] run summon arrow ^ ^0.1 ^1.2 {Motion:[0.2d,1.65d,0d],Rotation:[0f,90f],life:1100,damage:3.0,Fire:100s}
execute if score AZR_boss2_breakingout rng1 matches 69..92 if score AZR_boss2_breakingout rng3 matches 3 at @e[tag=AZR_boss2_breakingout_attacker] run summon arrow ^ ^0.1 ^1.2 {Motion:[-0.2d,1.65d,0d],Rotation:[0f,90f],life:1100,damage:3.0,Fire:100s}
execute if score AZR_boss2_breakingout rng1 matches 69..92 if score AZR_boss2_breakingout rng3 matches 4 at @e[tag=AZR_boss2_breakingout_attacker] run summon arrow ^ ^0.1 ^1.2 {Motion:[0d,1.65d,0.2d],Rotation:[0f,90f],life:1100,damage:3.0,Fire:100s}
execute if score AZR_boss2_breakingout rng1 matches 69..92 if score AZR_boss2_breakingout rng3 matches 5 at @e[tag=AZR_boss2_breakingout_attacker] run summon arrow ^ ^0.1 ^1.2 {Motion:[0d,1.65d,-0.2d],Rotation:[0f,90f],life:1100,damage:3.0,Fire:100s}
execute if score AZR_boss2_breakingout rng1 matches 69..92 if score AZR_boss2_breakingout rng3 matches 6 at @e[tag=AZR_boss2_breakingout_attacker] run summon arrow ^ ^0.1 ^1.2 {Motion:[0.2d,1.6d,0.2d],Rotation:[0f,90f],life:1100,damage:3.0,Fire:100s}
execute if score AZR_boss2_breakingout rng1 matches 69..92 if score AZR_boss2_breakingout rng3 matches 7 at @e[tag=AZR_boss2_breakingout_attacker] run summon arrow ^ ^0.1 ^1.2 {Motion:[0.2d,1.6d,-0.2d],Rotation:[0f,90f],life:1100,damage:3.0,Fire:100s}
execute if score AZR_boss2_breakingout rng1 matches 69..92 if score AZR_boss2_breakingout rng3 matches 8 at @e[tag=AZR_boss2_breakingout_attacker] run summon arrow ^ ^0.1 ^1.2 {Motion:[-0.2d,1.6d,0.2d],Rotation:[0f,90f],life:1100,damage:3.0,Fire:100s}
execute if score AZR_boss2_breakingout rng1 matches 69..92 if score AZR_boss2_breakingout rng3 matches 9 at @e[tag=AZR_boss2_breakingout_attacker] run summon arrow ^ ^0.1 ^1.2 {Motion:[-0.2d,1.6d,-0.2d],Rotation:[0f,90f],life:1100,damage:3.0,Fire:100s}

execute if score AZR_boss2_breakingout rng1 matches 69..86 run tag @e[tag=AZR_boss2_breakingout_marker] remove AZR_boss2_breakingout_attacker

execute if score AZR_boss2_breakingout rng1 matches 97.. run tag @s remove AZR_boss2_skill_breakingout
execute if score AZR_boss2_breakingout rng1 matches 97.. run scoreboard players set AZR_boss2_breakingout rng1 0
