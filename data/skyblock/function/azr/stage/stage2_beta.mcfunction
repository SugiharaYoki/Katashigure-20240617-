...
execute if score stageSeconds Azr_system matches 52 if score temp_rng Azr_system matches 1 positioned -79927 38 8 run function skyblock:azr/m/cow
...
execute store result score temp_rng Azr_system run random value 1..3
execute if score stageSeconds Azr_system matches 83 if score temp_rng Azr_system matches 1 positioned -79940 38 14 run function skyblock:azr/m/zombie_t1_5hp_full_armor
execute if score stageSeconds Azr_system matches 83 if score temp_rng Azr_system matches 2 positioned -79922 38 14 run function skyblock:azr/m/zombie_t2_shield
...
execute if score stageSeconds Azr_system matches 99 run advancement grant @a[tag=azrPlayer] only skyblock:azr/azr_stage2
