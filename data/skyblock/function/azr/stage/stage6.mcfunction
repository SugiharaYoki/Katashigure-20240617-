...
execute if score stageSeconds Azr_system matches 318 run advancement grant @a[tag=azrPlayer] only skyblock:azr/azr_stage6
...
execute if score stageSeconds Azr_system matches 318 run summon witch -79938 41 159 {PersistenceRequired:1b,Tags:["AzrielDecMob","AzrielMob"],DeathLootTable:"skyblock:azriel_witch_tier1",Health:6.0f,CustomName:'"见习女巫"',CanPickUpLoot:0b,attributes:[{id:"generic.max_health",base:6.0d},{id:"movement_speed",base:0.23d}]}
execute if score stageSeconds Azr_system matches 318 if score playerCount Azr_system matches 2.. run summon witch -79938 41 159 {PersistenceRequired:1b,Tags:["AzrielDecMob","AzrielMob"],DeathLootTable:"skyblock:azriel_witch_tier1",Health:6.0f,CustomName:'"见习女巫"',CanPickUpLoot:0b,attributes:[{id:"generic.max_health",base:6.0d},{id:"movement_speed",base:0.23d}]}
...
execute if score stageSeconds Azr_system matches 318 run tellraw @a[tag=azrPlayer,scores={AZR_chainKillUpg_pts=..2},tag=hasSkills] [{"text":"索命连击","color":"gold"},{"text":"可用点数已增加，目前为：3","color":"green"}]
execute if score stageSeconds Azr_system matches 318 run scoreboard players set @a[scores={AZR_chainKillUpg_pts=..2}] AZR_chainKillUpg_pts 3
...
#【弩手 lv1】execute if entity @e[tag=sc,limit=1,scores={stageSeconds=19}] run summon pillager -79927 38 8 {PersistenceRequired:1,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_pillager_tier1",Attributes:[{Name:generic.max_health,Base:3.0},{Name:attack_damage,Base:0.5}],Health:2.0f,CustomName:"\"弩手\"",HandItems:[{Count:1,id:"crossbow",tag:{display:{Name:"{\"text\":\"弩·传统\",\"italic\":false,\"color\":\"white\"}"}}}],HandDropChances:[0.003f],ArmorItems:[{},{},{},{}]}
#【弩手+ lv2】execute if entity @e[tag=sc,limit=1,scores={stageSeconds=19}] run summon pillager -79931 42 153 {PersistenceRequired:1,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_pillager_tier1",Attributes:[{Name:generic.max_health,Base:3.0},{Name:attack_damage,Base:0.5}],Health:2.0f,CustomName:"\"弩手\"",CanPickUpLoot:0,HandItems:[{Count:1,id:crossbow,tag:{Enchantments:[{id:quick_charge,lvl:1},{id:piercing,lvl:1}]}}],HandDropChances:[0.003f],ArmorItems:[{},{},{},{}]}
...
#【圣殿守卫 lv7】execute if entity @e[tag=sc,limit=1,scores={stageSeconds=19}] run summon vindicator -79927 38 8 {PersistenceRequired:1,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_vindicator_tier1",Attributes:[{Name:generic.max_health,Base:12.0},{Name:generic.attack_damage,Base:2.0},{Name:movement_speed,Base:0.22}],Health:12.0f,CustomName:"\"圣殿守卫\"",CanPickUpLoot:0,HandItems:[{Count:1,id:"stone_axe",tag:{display:{Name:"{\"text\":\"石斧\",\"italic\":false,\"color\":\"white\"}"}}}],HandDropChances:[0.003f]}
#【见习女巫 lv6】execute if entity @e[tag=sc,limit=1,scores={stageSeconds=19}] run summon witch -79927 38 8 {PersistenceRequired:1,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_witch_tier1",Attributes:[{Name:generic.max_health,Base:6.0},{Name:movement_speed,Base:0.23}],Health:6.0f,CustomName:"\"见习女巫\"",CanPickUpLoot:0}
