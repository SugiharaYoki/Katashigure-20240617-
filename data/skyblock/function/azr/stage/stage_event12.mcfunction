...
execute if score stage_main_thread AzrTimerStack matches 11.. as @a[tag=azrPlayer,tag=!AzrielEvent3761S] at @s at @n[tag=AzrielEvent3761,distance=0..3.5] run playsound entity.piglin.ambient master @a[tag=azrPlayer,distance=0..3.5] ~ ~ ~ 2 0.9
...
execute if score stage_main_thread AzrTimerStack matches 11.. as @a[tag=azrPlayer,tag=!AzrielEvent3762S] at @s at @n[tag=AzrielEvent3762,distance=0..3.5] run playsound entity.piglin.admiring_item master @a[tag=azrPlayer,distance=0..3.5] ~ ~ ~ 2 0.9
...
execute if score stage_main_thread AzrTimerStack matches 11.. as @a[tag=azrPlayer,tag=!AzrielEvent3763S] at @s at @n[tag=AzrielEvent3763,distance=0..3.5] run playsound entity.piglin.ambient master @a[tag=azrPlayer,distance=0..3.5] ~ ~ ~ 2 0.9
...
execute if score stage_main_thread AzrTimerStack matches 11.. as @a[tag=azrPlayer,tag=!AzrielEvent3764S] at @s at @n[tag=AzrielEvent3764,distance=0..3.5] run playsound entity.piglin.jealous master @a[tag=azrPlayer,distance=0..3.5] ~ ~ ~ 2 0.9
...
execute if score stage_main_thread AzrTimerStack matches 11.. as @a[tag=azrPlayer,tag=!AzrielEvent3765S] at @s at @n[tag=AzrielEvent3765,distance=0..3.5] run playsound entity.piglin.ambient master @a[tag=azrPlayer,distance=0..3.5] ~ ~ ~ 2 0.9
...
execute if score stage_main_thread AzrTimerStack matches 5550..6000 positioned -79776 44 -279 run playsound entity.piglin_brute.ambient master @a[tag=azrPlayer,distance=0..3.5] ~ ~ ~ 2 0.9
