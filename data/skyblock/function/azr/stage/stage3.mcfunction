...
execute if score stageSeconds Azr_system matches 127 if score playerCount Azr_system matches 3.. if score random Azr_system matches 4 positioned -79931 42.8 38 run function skyblock:azr/m/silverfish_t1
