...
execute if score stageSeconds Azr_system matches 3364 run summon vindicator -79904 40.5 -126 {Invulnerable:1b,PersistenceRequired:1b,Tags:["AzrielFriendly"],Health:12.0f,CustomName:'"圣殿巡逻兵"',CanPickUpLoot:0b,attributes:[{id:"generic.max_health",base:12.0d},{id:"generic.movement_speed",base:0.0d},{id:"generic.attack_damage",base:0.0d},{id:"follow_range",base:0.0d}]}
execute if score stageSeconds Azr_system matches 3364 run summon vindicator -79906 41 -126 {Invulnerable:1b,PersistenceRequired:1b,Tags:["AzrielFriendly"],Health:12.0f,CustomName:'"圣殿巡逻兵"',CanPickUpLoot:0b,attributes:[{id:"generic.max_health",base:12.0d},{id:"generic.movement_speed",base:0.0d},{id:"generic.attack_damage",base:0.0d},{id:"follow_range",base:0.0d}]}
execute if score stageSeconds Azr_system matches 3364 run summon wolf -79904 40 -124 {PersistenceRequired:1b,Tags:["AzrielFriendly","e8001"],CustomName:'"圣殿守卫犬"',CanPickUpLoot:0b,Health:40.0f,attributes:[{id:"max_health",base:40.0d}]}
execute if score stageSeconds Azr_system matches 3364 run summon wolf -79906 40 -124 {PersistenceRequired:1b,Tags:["AzrielFriendly","e8002"],CustomName:'"圣殿守卫犬"',CanPickUpLoot:0b,Health:40.0f,attributes:[{id:"max_health",base:40.0d}]}
