...
execute if score stageSeconds Azr_system matches 1 run bossbar set azr:progress_bar_normal max 27
...
execute if score stageSeconds Azr_system matches 10 run summon zombie -79931 38 -9 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_zombie_tier1",attributes:[{id:"generic.max_health",base:3.0},{id:"generic.attack_damage",base:1.5}],Health:3.0f,CustomName:'"僵尸"',CanPickUpLoot:0b,IsBaby:0b,ArmorItems:[{},{},{},{}]}
execute if score stageSeconds Azr_system matches 13 run summon zombie -79931 38 -9 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_zombie_tier1",attributes:[{id:"generic.max_health",base:4.0},{id:"generic.attack_damage",base:1.5}],Health:4.0f,CustomName:'"僵尸"',CanPickUpLoot:0b,IsBaby:0b,ArmorItems:[{},{},{},{}]}
execute if score stageSeconds Azr_system matches 16 run summon zombie -79931 38 -9 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_zombie_tier1",attributes:[{id:"generic.max_health",base:4.0},{id:"generic.attack_damage",base:1.5}],Health:4.0f,CustomName:'"僵尸"',CanPickUpLoot:0b,IsBaby:0b,ArmorItems:[{},{},{},{}]}
execute if score stageSeconds Azr_system matches 17 run summon zombie -79931 38 -9 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_zombie_tier1",attributes:[{id:"generic.max_health",base:4.0},{id:"generic.attack_damage",base:1.5}],Health:4.0f,CustomName:'"僵尸"',CanPickUpLoot:0b,IsBaby:0b,ArmorItems:[{},{},{},{}]}
execute if score stageSeconds Azr_system matches 19 if score playerCount Azr_system matches 4.. run summon zombie -79931 38 -9 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_zombie_tier1",attributes:[{id:"generic.max_health",base:4.0},{id:"generic.attack_damage",base:1.5}],Health:4.0f,CustomName:'"僵尸"',CanPickUpLoot:0b,IsBaby:0b,ArmorItems:[{},{},{},{}]}
execute if score stageSeconds Azr_system matches 12 if score playerCount Azr_system matches 5.. run summon pillager -79931 38 3 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_pillager_tier1",attributes:[{id:"generic.max_health",base:3.0},{id:"generic.attack_damage",base:0.5}],Health:1.0f,CustomName:'"弩手"',HandItems:[{count:1,id:"crossbow",components:{"custom_name":'{"text":"弩·传统","italic":false}'}}],HandDropChances:[0.1f,0.1f],ArmorItems:[{},{},{},{}]}
execute if score stageSeconds Azr_system matches 21 run summon pillager -79931 38 3 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_pillager_tier1",attributes:[{id:"generic.max_health",base:3.0},{id:"generic.attack_damage",base:0.5}],Health:1.0f,CustomName:'"弩手"',HandItems:[{count:1,id:"crossbow",components:{"custom_name":'{"text":"弩·传统","italic":false}'}}],HandDropChances:[0.1f,0.1f],ArmorItems:[{},{},{},{}]}
execute if score stageSeconds Azr_system matches 22 run summon pillager -79931 38 -9 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_pillager_tier1",attributes:[{id:"generic.max_health",base:3.0},{id:"generic.attack_damage",base:0.5}],Health:1.0f,CustomName:'"弩手"',HandItems:[{count:1,id:"crossbow",components:{"custom_name":'{"text":"弩·传统","italic":false}'}}],HandDropChances:[0.1f,0.1f],ArmorItems:[{},{},{},{}]}
execute if score stageSeconds Azr_system matches 25 run summon zombie -79931 38 3 {PersistenceRequired:1b,Tags:["AzrielMob"],DeathLootTable:"skyblock:azriel_zombie_tier1",attributes:[{id:"generic.max_health",base:5.0},{id:"generic.attack_damage",base:1.5}],Health:5.0f,CustomName:'"僵尸"',CanPickUpLoot:0b,IsBaby:0b,ArmorItems:[{},{},{},{count:1,id:"leather_helmet",components:{"custom_name":'{"text":"皮革帽","italic":false}'}}]}
#回秒
execute if score stageSeconds Azr_system matches 26..30 if entity @e[tag=AzrielMob,tag=!AzrielDecMob] run scoreboard players set stageSeconds Azr_system 26
#结束
execute if score stageSeconds Azr_system matches 27 run playsound ambient.crimson_forest.loop ambient @a[tag=azrPlayer] -78000 100 0 1000
execute if score stageSeconds Azr_system matches 27 run playsound ambient.crimson_forest.mood ambient @a[tag=azrPlayer] -78000 100 0 1000
execute if score stageSeconds Azr_system matches 27 run playsound ambient.crimson_forest.additions ambient @a[tag=azrPlayer] -78000 100 0 1000
