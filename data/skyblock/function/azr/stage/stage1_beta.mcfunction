...
execute if score stage_main_thread AzrTimerStack matches 10 positioned -79931 38 -9 run function skyblock:azr/m/zombie_t1
...
execute if score stage_main_thread AzrTimerStack matches 13 positioned -79931 38 -9 run function skyblock:azr/m/zombie_t1_4hp
...
execute if score stage_main_thread AzrTimerStack matches 16 positioned -79931 38 -9 run function skyblock:azr/m/zombie_t1_4hp
execute if score stage_main_thread AzrTimerStack matches 17 positioned -79931 38 -9 run function skyblock:azr/m/zombie_t1_4hp
execute if score stage_main_thread AzrTimerStack matches 12 if score playerCount Azr_system matches 5.. positioned -79931 38 3 run function skyblock:azr/m/pillager_t1
...
execute if score stage_main_thread AzrTimerStack matches 21 positioned -79931 38 3 run function skyblock:azr/m/pillager_t1
execute if score stage_main_thread AzrTimerStack matches 22 positioned -79931 38 -9 run function skyblock:azr/m/pillager_t1
...
execute if score stage_main_thread AzrTimerStack matches 25 positioned -79931 38 3 run function skyblock:azr/m/zombie_t1_5hp
#回秒
