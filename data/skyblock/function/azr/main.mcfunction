...
#精英怪共享指令
execute positioned -79900 100 0 if entity @n[tag=AzrielMob_elite_candle_angel,distance=..2000] run function skyblock:azr/assets/mobs_new/skill/candle/core_controller
