...
execute store result score @s AZS_SoulFrag run execute if entity @e[distance=..10000]
execute if score @s AZS_SoulFrag matches 2500.. run function skyblock:azr/fuse
