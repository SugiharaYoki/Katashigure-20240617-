...
execute if score stage Azr_system matches 8..43 if score playerCount Azr_system matches 1.. positioned -79931 28 -5 as @n[tag=AzrielMarker_encounter,distance=0..0.5] run function skyblock:azr/assets/mobs_new/skill/boss_diesel/core
