...
execute as @s at @s[scores={Perm_PersonFSB=200..,Perm_PersonSHD=100..}] run tellraw @s {"text":"解封了灵能「嗜血狂袭」！花费了： 200浮世币 100影之石","color":"green"}
...
execute as @s at @s[tag=purchasesuccess] run scoreboard players set @s Azr_SK2 1
