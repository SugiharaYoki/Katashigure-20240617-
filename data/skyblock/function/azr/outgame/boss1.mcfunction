...
#health check
    ...
    execute if score @s Azr_system matches 81 as @a[gamemode=!creative,gamemode=!spectator,distance=..100] at @s run playsound minecraft:vol2.lethaldose master @s ~ ~ ~ 0.65
