...
tellraw @s[x=-79956,y=38,z=-29] {"text":""}
tellraw @s[x=-79956,y=38,z=-29] {"text":"中途加入","underlined":true,"color":"green","click_event":{"action":"run_command","value":"/trigger MultiMenu set 112"},"hoverEvent":{"action":"show_text","contents":{"text":"中途进入已经开始的游戏","color":"white"}}}
tellraw @s[x=-79956,y=38,z=-29] {"text":""}