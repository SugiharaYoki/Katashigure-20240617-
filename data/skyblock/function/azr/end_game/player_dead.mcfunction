...
#真实死亡
execute unless entity @s[tag=!AZR_fakeDeath,nbt={Inventory:[{components:{"minecraft:custom_data":{revival_star:1b}}}]}] run scoreboard players set @s Azr_forceDeath 1
#使用下界命星复活
