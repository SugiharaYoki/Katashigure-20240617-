...
item replace block -79939 38 20 container.11 with minecraft:paper[custom_name='{"text":"圣殿信条","color":"blue","italic":false}',custom_data={sanct_credo:1b},custom_model_data=100001] 3
...
item replace block -79929 49 -123 container.12 with raw_iron[custom_name='{"text":"钝铁","italic":false,"color":"white"}',custom_data={raw_iron:1b},custom_model_data=100001] 1
