...
execute if entity @s[tag=azr_system_sub_weapons_shovel_on] run attribute @s generic.attack_speed modifier remove azr:system_sub_weapons_shovel_on_attackspeed
