...
attribute @s minecraft:entity_interaction_range modifier add azr_chainkill_01 5 add_value
attribute @s minecraft:attack_damage modifier add azr_chainkill_02 0.5 add_multiplied_total
