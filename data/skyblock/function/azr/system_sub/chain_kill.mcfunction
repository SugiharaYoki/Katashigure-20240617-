execute if entity @s[tag=!AZR_chainKill_activated] store result score random Azr_system run random value 1..6
...
execute if entity @s[tag=AZR_chainKill_activated] run title @s actionbar {"text": "- 索命连击 -","color":"gold","bold": true}
