...
execute if entity @s[scores={AZR_chainKillUpg_chargeboost=1..,AZR_chainKill_chargeup=..50}] unless items entity @s weapon.mainhand #shovels run scoreboard players add random Azr_system 1
execute if entity @s[scores={AZR_chainKillUpg_chargeboost=2..,AZR_chainKill_chargeup=..50}] unless items entity @s weapon.mainhand #shovels run scoreboard players add random Azr_system 1
execute if entity @s[scores={AZR_chainKillUpg_chargeboost=3..,AZR_chainKill_chargeup=..50}] unless items entity @s weapon.mainhand #shovels run scoreboard players add random Azr_system 1
execute if entity @s[scores={AZR_chainKillUpg_chargeboost=4..,AZR_chainKill_chargeup=..50}] unless items entity @s weapon.mainhand #shovels run scoreboard players add random Azr_system 1
