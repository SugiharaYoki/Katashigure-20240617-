...
execute if score @s AZR_chainKill_chargeup matches 100.. if entity @s[tag=!AZR_chainKill_activated,scores={AZR_chainKill=1..}] run function skyblock:azr/system_sub/chain_kill_execute
