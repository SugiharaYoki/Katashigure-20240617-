...
function skyblock:azr/system_sub/weapons/shovel

execute if entity @s[tag=AZR_chainKill_activated] if entity @n[type=!player,type=!marker,type=!painting,type=!item_frame,type=!armor_stand,type=!text_display,type=!block_display,distance=0..9] run title @s[tag=AZR_chainKillUpg_countvisible,scores={AZR_chainKill_count=10..}] actionbar {"text": "- 索命连击 ×Z -","color":"gold","bold": true}
execute if entity @s[tag=AZR_chainKill_activated] if entity @n[type=!player,type=!marker,type=!painting,type=!item_frame,type=!armor_stand,type=!text_display,type=!block_display,distance=0..9] run title @s[tag=AZR_chainKillUpg_countvisible,scores={AZR_chainKill_count=10}] actionbar {"text": "- 索命连击 ×T -","color":"gold","bold": true}
execute if entity @s[tag=AZR_chainKill_activated] if entity @n[type=!player,type=!marker,type=!painting,type=!item_frame,type=!armor_stand,type=!text_display,type=!block_display,distance=0..9] run title @s[tag=AZR_chainKillUpg_countvisible,scores={AZR_chainKill_count=9}] actionbar {"text": "- 索命连击 ×9 -","color":"gold","bold": true}
execute if entity @s[tag=AZR_chainKill_activated] if entity @n[type=!player,type=!marker,type=!painting,type=!item_frame,type=!armor_stand,type=!text_display,type=!block_display,distance=0..9] run title @s[tag=AZR_chainKillUpg_countvisible,scores={AZR_chainKill_count=8}] actionbar {"text": "- 索命连击 ×8 -","color":"gold","bold": true}
execute if entity @s[tag=AZR_chainKill_activated] if entity @n[type=!player,type=!marker,type=!painting,type=!item_frame,type=!armor_stand,type=!text_display,type=!block_display,distance=0..9] run title @s[tag=AZR_chainKillUpg_countvisible,scores={AZR_chainKill_count=7}] actionbar {"text": "- 索命连击 ×7 -","color":"gold","bold": true}
execute if entity @s[tag=AZR_chainKill_activated] if entity @n[type=!player,type=!marker,type=!painting,type=!item_frame,type=!armor_stand,type=!text_display,type=!block_display,distance=0..9] run title @s[tag=AZR_chainKillUpg_countvisible,scores={AZR_chainKill_count=6}] actionbar {"text": "- 索命连击 ×6 -","color":"gold","bold": true}
execute if entity @s[tag=AZR_chainKill_activated] if entity @n[type=!player,type=!marker,type=!painting,type=!item_frame,type=!armor_stand,type=!text_display,type=!block_display,distance=0..9] run title @s[tag=AZR_chainKillUpg_countvisible,scores={AZR_chainKill_count=5}] actionbar {"text": "- 索命连击 ×5 -","color":"gold","bold": true}
execute if entity @s[tag=AZR_chainKill_activated] if entity @n[type=!player,type=!marker,type=!painting,type=!item_frame,type=!armor_stand,type=!text_display,type=!block_display,distance=0..9] run title @s[tag=AZR_chainKillUpg_countvisible,scores={AZR_chainKill_count=4}] actionbar {"text": "- 索命连击 ×4 -","color":"gold","bold": true}
execute if entity @s[tag=AZR_chainKill_activated] if entity @n[type=!player,type=!marker,type=!painting,type=!item_frame,type=!armor_stand,type=!text_display,type=!block_display,distance=0..9] run title @s[tag=AZR_chainKillUpg_countvisible,scores={AZR_chainKill_count=3}] actionbar {"text": "- 索命连击 ×3 -","color":"gold","bold": true}
execute if entity @s[tag=AZR_chainKill_activated] if entity @n[type=!player,type=!marker,type=!painting,type=!item_frame,type=!armor_stand,type=!text_display,type=!block_display,distance=0..9] run title @s[tag=AZR_chainKillUpg_countvisible,scores={AZR_chainKill_count=2}] actionbar {"text": "- 索命连击 ×2 -","color":"gold","bold": true}
execute if entity @s[tag=AZR_chainKill_activated] if entity @n[type=!player,type=!marker,type=!painting,type=!item_frame,type=!armor_stand,type=!text_display,type=!block_display,distance=0..9] run title @s[tag=AZR_chainKillUpg_countvisible,scores={AZR_chainKill_count=1}] actionbar {"text": "- 索命连击 ×1 -","color":"gold","bold": true}
execute if entity @s[tag=AZR_chainKill_activated] if entity @n[type=!player,type=!marker,type=!painting,type=!item_frame,type=!armor_stand,type=!text_display,type=!block_display,distance=0..9] run title @s[tag=!AZR_chainKillUpg_countvisible] actionbar {"text": "- 索命连击 -","color":"gold","bold": true}
