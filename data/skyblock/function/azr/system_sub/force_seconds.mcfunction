...
execute if score stage Azr_system matches 9 run scoreboard players add stageSeconds Azr_system 1
execute if score stage Azr_system matches 16 run scoreboard players add stageSeconds Azr_system 1
...
execute if score stage Azr_system matches 301 run scoreboard players add stageSeconds Azr_system 1