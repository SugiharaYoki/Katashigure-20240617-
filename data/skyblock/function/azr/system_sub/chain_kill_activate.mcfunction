...
execute if score random Azr_system matches 1 run title @s actionbar {"text": "- 连击结束 -","color":"dark_gray","bold": true}
execute if score random Azr_system matches 1 run attribute @s minecraft:entity_interaction_range modifier remove azr_chainkill_01
execute if score random Azr_system matches 1 run attribute @s minecraft:attack_damage modifier remove azr_chainkill_02
