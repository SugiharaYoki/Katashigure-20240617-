...
execute store result score @s AZS_SoulFrag run execute if entity @e[distance=..10000,tag=AzrielMob]
tellraw @s [{text:" AzrielMob = ",color:"white",italic:0b},{"score":{"name":"entity_count","objective":"Azr_system"},color: "white",italic:1b}]
execute store result score @s AZS_SoulFrag run execute if entity @e[distance=..10000,tag=AzrielMarker_encounter]
...
execute store result score @s AZS_SoulFrag run execute if entity @e[distance=..10000,tag=AzrielMob_mob_marker]
...
execute store result score @s AZS_SoulFrag run execute if entity @e[distance=..10000,type=item]
...
execute if score @s AZS_SoulFrag matches 2500.. run function skyblock:azr/lifecycle/endgame