...
execute store result score entity_count Azr_system run execute if entity @e[distance=..10000,tag=AzrielMob]
tellraw @s [{text:" AzrielMob = ",color:"white",italic:0b},{"score":{"name":"entity_count","objective":"Azr_system"},color: "white",italic:1b}]
execute store result score entity_count Azr_system run execute if entity @e[distance=..10000,tag=AzrielMarker_encounter]
...
execute store result score entity_count Azr_system run execute if entity @e[distance=..10000,tag=AzrielMob_mob_marker]
...
execute store result score entity_count Azr_system run execute if entity @e[distance=..10000,type=item]
