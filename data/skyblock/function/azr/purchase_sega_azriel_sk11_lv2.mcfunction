...
execute as @s at @s[scores={Perm_PersonSHD=500..}] run tellraw @s {"text":"灵能「螺旋风压」升级！花费了： 500影之石","color":"green"}
...
execute as @s at @s[tag=purchasesuccess] run scoreboard players set @s Azr_SK11 2
