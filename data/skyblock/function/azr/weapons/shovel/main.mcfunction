...
execute if score @s[tag=!azr_system_sub_weapons_shovel_on] AZR_chainKill_chargeup matches 50.. if items entity @s weapon.mainhand #shovels run function skyblock:azr/weapons/shovel/on
...
execute unless items entity @s weapon.mainhand #shovels run function skyblock:azr/weapons/shovel/off
execute unless score @s AZR_chainKill_chargeup matches 50.. run function skyblock:azr/weapons/shovel/off
