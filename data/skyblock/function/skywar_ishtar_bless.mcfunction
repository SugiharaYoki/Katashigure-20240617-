...
execute if entity @s[scores={ishtar_bless_4=4}] run give @s tide_armor_trim_smithing_template[custom_name='{"text":"雷厄渡水","italic":false,"color":"red"}',custom_data={skywar_ishtar_24:1}] 1
