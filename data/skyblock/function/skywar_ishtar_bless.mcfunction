...
execute if entity @s[scores={ishtar_bless_1=4}] run give @s trident[custom_name='{"text":"湖灯之戟","italic":false,"color":"red"}',enchantments={loyalty:4,impaling:2,channeling:1},attribute_modifiers=[{type:"generic.movement_speed",slot:"hand",id:"ishtar_bless:001_01",amount:-0.12,operation:"add_value"}]]
execute if entity @s[scores={ishtar_bless_2=4}] run give @s trident[custom_name='{"text":"湖灯之戟","italic":false,"color":"red"}',enchantments={loyalty:4,impaling:2,channeling:1},attribute_modifiers=[{type:"generic.movement_speed",slot:"hand",id:"ishtar_bless:001_01",amount:-0.12,operation:"add_value"}]]
execute if entity @s[scores={ishtar_bless_3=4}] run give @s trident[custom_name='{"text":"湖灯之戟","italic":false,"color":"red"}',enchantments={loyalty:4,impaling:2,channeling:1},attribute_modifiers=[{type:"generic.movement_speed",slot:"hand",id:"ishtar_bless:001_01",amount:-0.12,operation:"add_value"}]]
execute if entity @s[scores={ishtar_bless_1=5}] run give @s leather_boots[custom_name='{"text":"彻锋戮影","italic":false,"color":"red"}',dyed_color={rgb:3081303},attribute_modifiers=[{type:"generic.movement_speed",slot:"feet",id:"ishtar_bless:002_01",amount:0.13,operation:"add_value"},{type:"player.sneaking_speed",slot:"feet",id:"ishtar_bless:002_02",amount:0.55,operation:"add_value"},{type:"generic.max_health",slot:"feet",id:"ishtar_bless:002_03",amount:-4,operation:"add_value"}]]
...
execute if entity @s[scores={ishtar_bless_1=6}] run give @s iron_sword[custom_name='{"text":"袖剑·轮月","italic":false,"color":"red"}',attribute_modifiers=[{type:"generic.movement_speed",slot:"hand",id:"ishtar_bless:003_01",amount:0.05,operation:"add_value"},{type:"generic.armor",slot:"hand",id:"ishtar_bless:003_02",amount:-2,operation:"add_value"},{type:"generic.attack_damage",slot:"hand",id:"ishtar_bless:003_03",amount:15,operation:"add_value"},{type:"generic.attack_speed",slot:"hand",id:"ishtar_bless:003_04",amount:-3.5,operation:"add_value"}],enchantments={fire_aspect:1}]
...
execute if entity @s[scores={ishtar_bless_1=13}] run give @s bow[custom_name='{"text":"绯华","italic":false,"color":"red"}',enchantments={multishot:4,power:3,piercing:2}]
execute if entity @s[scores={ishtar_bless_2=13}] run give @s bow[custom_name='{"text":"绯华","italic":false,"color":"red"}',enchantments={multishot:4,power:3,piercing:2}]
execute if entity @s[scores={ishtar_bless_3=13}] run give @s bow[custom_name='{"text":"绯华","italic":false,"color":"red"}',enchantments={multishot:4,power:3,piercing:2}]
