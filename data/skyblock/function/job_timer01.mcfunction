...
#魔法师书籍
execute as @a[tag=!NoSkyWar,nbt={Inventory:[{Slot:-106b,id:"minecraft:enchanted_book",tag:{display:{Name:"{\"italic\":false,\"text\":\"魔法师笔记·纷争\"}",Lore:["{\"italic\":false,\"text\":\"装备在副手时，五米内所有生物陷入虚弱状态。\"}"]}}}]}] at @s run effect give @a[tag=!NoSkyWar,gamemode=!spectator,distance=0..5] minecraft:weakness 2 0
execute as @a[tag=!NoSkyWar,nbt={Inventory:[{Slot:-106b,id:"minecraft:enchanted_book",tag:{display:{Name:"{\"italic\":false,\"text\":\"魔法师笔记·溟冷\"}",Lore:["{\"italic\":false,\"text\":\"装备在副手时，两米内所有生物获得抗火状态。\"}"]}}}]}] at @s run effect give @a[tag=!NoSkyWar,gamemode=!spectator,distance=0..2] minecraft:fire_resistance 2 0
execute as @a[tag=!NoSkyWar,nbt={Inventory:[{Slot:-106b,id:"minecraft:enchanted_book",tag:{display:{Name:"{\"italic\":false,\"text\":\"魔法师笔记·铁曜\"}",Lore:["{\"italic\":false,\"text\":\"装备在副手时，五米内所有生物陷入挖掘疲劳状态。\"}"]}}}]}] at @s run effect give @a[tag=!NoSkyWar,gamemode=!spectator,distance=0..5] minecraft:mining_fatigue 2 0
#
...
item replace entity @a[tag=!NoSkyWar,scores={Job=12}] container.16 with minecraft:bone_meal{display:{Name:"{\"italic\":false,\"color\":\"gold\",\"text\":\"便携式骨粉\"}",Lore:["{\"italic\":false,\"text\":\"可以从背包无限获取的骨粉。\"}"]}} 4
...
#刺客的尊荣
execute as @a[tag=!NoSkyWar,gamemode=!spectator,team=Team1_1,nbt={Inventory:[{Slot:7b,id:"minecraft:skull_banner_pattern",tag:{display:{Name:"{\"italic\":false,\"color\":\"green\",\"text\":\"刺客的尊荣\"}",Lore:["{\"italic\":false,\"text\":\"当放置在八号物品栏位时，自动照亮3米内所有的隐形单位并给予发光状态。\"}"]}}}]}] at @s run effect clear @a[tag=!NoSkyWar,team=!Team1_1,gamemode=!spectator,distance=0..3] minecraft:invisibility
execute as @a[tag=!NoSkyWar,team=Team1_1,nbt={Inventory:[{Slot:7b,id:"minecraft:skull_banner_pattern",tag:{display:{Name:"{\"italic\":false,\"color\":\"green\",\"text\":\"刺客的尊荣\"}",Lore:["{\"italic\":false,\"text\":\"当放置在八号物品栏位时，自动照亮3米内所有的隐形单位并给予发光状态。\"}"]}}}]}] at @s run execute if entity @a[tag=!NoSkyWar,team=!Team1_1,gamemode=!spectator,distance=0..3] run advancement grant @s only skyblock:job5_glowinginvis
...
execute as @a[tag=!NoSkyWar,gamemode=!spectator,team=Team1_2,nbt={Inventory:[{Slot:7b,id:"minecraft:skull_banner_pattern",tag:{display:{Name:"{\"italic\":false,\"color\":\"green\",\"text\":\"刺客的尊荣\"}",Lore:["{\"italic\":false,\"text\":\"当放置在八号物品栏位时，自动照亮3米内所有的隐形单位并给予发光状态。\"}"]}}}]}] at @s run effect clear @a[tag=!NoSkyWar,team=!Team1_2,gamemode=!spectator,distance=0..3] minecraft:invisibility
execute as @a[tag=!NoSkyWar,team=Team1_2,nbt={Inventory:[{Slot:7b,id:"minecraft:skull_banner_pattern",tag:{display:{Name:"{\"italic\":false,\"color\":\"green\",\"text\":\"刺客的尊荣\"}",Lore:["{\"italic\":false,\"text\":\"当放置在八号物品栏位时，自动照亮3米内所有的隐形单位并给予发光状态。\"}"]}}}]}] at @s run execute if entity @a[tag=!NoSkyWar,team=!Team1_2,gamemode=!spectator,distance=0..3] run advancement grant @s only skyblock:job5_glowinginvis
...
execute as @a[tag=!NoSkyWar,gamemode=!spectator,team=Team1_3,nbt={Inventory:[{Slot:7b,id:"minecraft:skull_banner_pattern",tag:{display:{Name:"{\"italic\":false,\"color\":\"green\",\"text\":\"刺客的尊荣\"}",Lore:["{\"italic\":false,\"text\":\"当放置在八号物品栏位时，自动照亮3米内所有的隐形单位并给予发光状态。\"}"]}}}]}] at @s run effect clear @a[tag=!NoSkyWar,team=!Team1_3,gamemode=!spectator,distance=0..3] minecraft:invisibility
execute as @a[tag=!NoSkyWar,team=Team1_3,nbt={Inventory:[{Slot:7b,id:"minecraft:skull_banner_pattern",tag:{display:{Name:"{\"italic\":false,\"color\":\"green\",\"text\":\"刺客的尊荣\"}",Lore:["{\"italic\":false,\"text\":\"当放置在八号物品栏位时，自动照亮3米内所有的隐形单位并给予发光状态。\"}"]}}}]}] at @s run execute if entity @a[tag=!NoSkyWar,team=!Team1_3,gamemode=!spectator,distance=0..3] run advancement grant @s only skyblock:job5_glowinginvis
...
execute as @a[tag=!NoSkyWar,gamemode=!spectator,team=Team1_4,nbt={Inventory:[{Slot:7b,id:"minecraft:skull_banner_pattern",tag:{display:{Name:"{\"italic\":false,\"color\":\"green\",\"text\":\"刺客的尊荣\"}",Lore:["{\"italic\":false,\"text\":\"当放置在八号物品栏位时，自动照亮3米内所有的隐形单位并给予发光状态。\"}"]}}}]}] at @s run effect clear @a[tag=!NoSkyWar,team=!Team1_4,gamemode=!spectator,distance=0..3] minecraft:invisibility
execute as @a[tag=!NoSkyWar,team=Team1_4,nbt={Inventory:[{Slot:7b,id:"minecraft:skull_banner_pattern",tag:{display:{Name:"{\"italic\":false,\"color\":\"green\",\"text\":\"刺客的尊荣\"}",Lore:["{\"italic\":false,\"text\":\"当放置在八号物品栏位时，自动照亮3米内所有的隐形单位并给予发光状态。\"}"]}}}]}] at @s run execute if entity @a[tag=!NoSkyWar,team=!Team1_4,gamemode=!spectator,distance=0..3] run advancement grant @s only skyblock:job5_glowinginvis
...
execute as @a[tag=!NoSkyWar,scores={Job_Rite=8,If_MD_Pigstep=1..}] at @s run summon area_effect_cloud ~ ~0.3 ~ {Particle:warped_spore,ReapplicationDelay:15,Radius:7.0f,RadiusPerTick:-0.01f,RadiusOnUse:-0.2f,Duration:120,DurationOnUse:-10f,Age:0,WaitTime:60,Color:948795,OwnerUUIDLeast:0,OwnerUUIDMost:1000000,Effects:[{Id:20,Amplifier:1,Duration:160}]}
