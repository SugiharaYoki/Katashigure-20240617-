...
#place
$execute unless data storage cmd:io data_space[{UUID:$(current_user)}].temp if data storage cmd:io data_space[{UUID:$(current_user)}].pickup unless data storage cmd:io data_space[{UUID:$(current_user)}].List3[-1] run data modify storage cmd:io data_space[{UUID:$(current_user)}].List3 append from storage cmd:io data_space[{UUID:$(current_user)}].pickup
...
#output
$execute unless data storage cmd:io data_space[{UUID:$(current_user)}].List3[-1] run data merge storage cmd:io {color1:"gray"}
