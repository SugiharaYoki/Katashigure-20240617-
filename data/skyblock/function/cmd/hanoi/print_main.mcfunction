...
$tellraw @s [{text:"第一个列表：",color:"aqua"},{"nbt":"data_space[{UUID:$(current_user)}].List1","storage": "cmd:io",color:"yellow"},{text:"<·>",color:"$(color1)",bold:1b,click_event: {"action": "command","value": "trigger CmdTrigger set 0"}}]
$tellraw @s [{text:"第二个列表：",color:"aqua"},{"nbt":"data_space[{UUID:$(current_user)}].List2","storage": "cmd:io",color:"yellow"},{text:"<·>",color:"$(color2)",bold:1b,click_event: {"action": "command","value": "trigger CmdTrigger set 1"}}]
$tellraw @s [{text:"第三个列表：",color:"aqua"},{"nbt":"data_space[{UUID:$(current_user)}].List3","storage": "cmd:io",color:"yellow"},{text:"<·>",color:"$(color3)",bold:1b,click_event: {"action": "command","value": "trigger CmdTrigger set 2"}}]
tellraw @s [{text:"<·>退出",color:"red",bold:1b,click_event: {"action": "command","value": "trigger CmdTrigger set 3"}}]
