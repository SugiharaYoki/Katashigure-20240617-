...
execute as @a[scores={rng1=13}] at @s positioned ^ ^ ^-26 run playsound item.goat_horn.sound.5 master @a ~ ~ ~ 3 1
execute as @a[scores={rng1=14}] at @s positioned ^-26 ^ ^-26 run playsound item.goat_horn.sound.5 master @a ~ ~ ~ 3 1
execute as @a[scores={rng1=15}] at @s positioned ^26 ^ ^-26 run playsound item.goat_horn.sound.5 master @a ~ ~ ~ 3 1
