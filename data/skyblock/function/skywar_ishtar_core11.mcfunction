execute as @s[tag=PVPing,gamemode=survival,scores={If_Bless11=59}] run attribute @s generic.jump_strength modifier add skywar_ishtar_bless11_01 -1.0 add_value
