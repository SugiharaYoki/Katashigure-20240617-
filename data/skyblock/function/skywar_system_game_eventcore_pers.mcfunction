...
execute if score @n[tag=sc] Map_Code matches 11 as @a[tag=PVPing] at @s if entity @s[y=118,dy=5] run tp ~ ~-1 ~
...
execute if block -131 58 -133 diamond_block as @e[type=egg,tag=Bless25,x=50062,y=226,z=50052,distance=..3000] at @s if entity @a[gamemode=survival,distance=0..25] run function skyblock:skywar_ishtar_core25e
execute if block -131 58 -133 diamond_block as @e[type=wind_charge,tag=Bless26,x=50062,y=226,z=50052,distance=..3000] at @s as @a[gamemode=survival,distance=0..64] unless items entity @s container.* *[custom_data={skywar_ishtar_26:1}] run function skyblock:skywar_ishtar_core26e
