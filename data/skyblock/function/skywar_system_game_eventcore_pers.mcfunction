execute if entity @n[tag=sc,scores={Temp5_LoopE=0}] unless entity @a[team=Team1_4,tag=!PVP_observer] run execute unless entity @a[team=Team1_2,tag=!PVP_observer] run execute unless entity @a[team=Team1_3,tag=!PVP_observer] run scoreboard players add @n[tag=sc] Temp5_LoopE 1
