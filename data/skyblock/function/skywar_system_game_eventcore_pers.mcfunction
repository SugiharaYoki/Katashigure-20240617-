execute if entity @n[tag=sc,scores={Temp5_LoopE=0}] if entity @a[team=Team1_1] unless entity @a[team=!Team1_1,tag=!PVP_observer] run scoreboard players add @n[tag=sc] Temp5_LoopE 1
execute if entity @n[tag=sc,scores={Temp5_LoopE=0}] if entity @a[team=Team1_2] unless entity @a[team=!Team1_2,tag=!PVP_observer] run scoreboard players add @n[tag=sc] Temp5_LoopE 1
execute if entity @n[tag=sc,scores={Temp5_LoopE=0}] if entity @a[team=Team1_3] unless entity @a[team=!Team1_3,tag=!PVP_observer] run scoreboard players add @n[tag=sc] Temp5_LoopE 1
execute if entity @n[tag=sc,scores={Temp5_LoopE=0}] if entity @a[team=Team1_4] unless entity @a[team=!Team1_4,tag=!PVP_observer] run scoreboard players add @n[tag=sc] Temp5_LoopE 1
execute if entity @n[tag=sc,scores={Temp5_LoopE=0}] if entity @a[team=Team1_5] unless entity @a[team=!Team1_5,tag=!PVP_observer] run scoreboard players add @n[tag=sc] Temp5_LoopE 1
execute if entity @n[tag=sc,scores={Temp5_LoopE=0}] if entity @a[team=Team1_6] unless entity @a[team=!Team1_6,tag=!PVP_observer] run scoreboard players add @n[tag=sc] Temp5_LoopE 1
execute if entity @n[tag=sc,scores={Temp5_LoopE=0}] if entity @a[team=Team1_7] unless entity @a[team=!Team1_7,tag=!PVP_observer] run scoreboard players add @n[tag=sc] Temp5_LoopE 1
execute if entity @n[tag=sc,scores={Temp5_LoopE=0}] if entity @a[team=Team1_8] unless entity @a[team=!Team1_8,tag=!PVP_observer] run scoreboard players add @n[tag=sc] Temp5_LoopE 1
