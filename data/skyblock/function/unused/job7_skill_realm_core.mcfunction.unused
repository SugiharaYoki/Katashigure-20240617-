...
execute as @a[tag=!NoSkyWar,scores={Job=7,If_MD_Blocks=1..}] at @s run summon area_effect_cloud ~ ~0.3 ~ {Particle:{type:"crit"},ReapplicationDelay:30,Radius:4.0f,RadiusPerTick:-0.02f,RadiusOnUse:-0.2f,Duration:120,DurationOnUse:-10f,Age:0,WaitTime:5,Color:16756224,OwnerUUIDLeast:0,OwnerUUIDMost:1000000,Effects:[{Id:11,Amplifier:1,Duration:300},{Id:12,Amplifier:0,Duration:300}]}
...
execute as @a[tag=!NoSkyWar,scores={Job=7,If_MD_Chirp=1..}] at @s run summon area_effect_cloud ~ ~0.3 ~ {Particle:{type:"soul_fire_flame"},ReapplicationDelay:15,Radius:7.0f,RadiusPerTick:-0.01f,RadiusOnUse:-0.2f,Duration:120,DurationOnUse:-10f,Age:0,WaitTime:60,Color:3541771,OwnerUUIDLeast:0,OwnerUUIDMost:1000000,Effects:[{Id:7,Amplifier:1,Duration:1},{Id:2,Amplifier:2,Duration:40}]}
...
execute as @a[tag=!NoSkyWar,scores={Job=7,If_MD_Mall=1..}] at @s run summon area_effect_cloud ~ ~0.3 ~ {Particle:{type:"end_rod"},ReapplicationDelay:30,Radius:4.0f,RadiusPerTick:-0.02f,RadiusOnUse:-0.2f,Duration:120,DurationOnUse:-10f,Age:0,WaitTime:5,Color:3612577,OwnerUUIDLeast:0,OwnerUUIDMost:1000000,Effects:[{Id:14,Amplifier:0,Duration:400},{Id:16,Amplifier:0,Duration:400}]}
