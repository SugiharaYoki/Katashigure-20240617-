...
execute as @a[tag=!NoSkyWar,scores={Job=6,If_Bread=1..,Job_SpiritProp=1..2}] at @s run scoreboard players set @s If_Bread 0
execute as @a[tag=!NoSkyWar,scores={Job=6,If_Bread=1..,Job_SpiritProp=1..2}] at @s run advancement grant @s only skyblock:job6_firstbred
