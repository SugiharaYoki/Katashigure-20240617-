...
#double invitation
execute if entity @a[tag=4ASCENDInvite] run tellraw @s [{"text":"4ASCEND·接待员：\n","color":"aqua"},{"text":"已经有人发送过邀请了，你想要直接加入吗？","color":"white","underlined": true,"click_event":{"action":"run_command","value":"/trigger PlayHouseTrigger set 101"},"hoverEvent":{"action":"show_text","contents":{"text":"接受这条邀请","color":"green"}}}]
...
tellraw @s {"text":"—— [取消邀请] ——","color":"green","click_event":{"action":"run_command","value":"/trigger PlayHouseTrigger set 100"},"hoverEvent":{"action":"show_text","contents":{"text":"将这条邀请作废","color":"green"}}}
...
tellraw @a[distance=0.001..,tag=!Gaming] {"text":"—— [参加游戏] ——","color":"green","click_event":{"action":"run_command","value":"/trigger PlayHouseTrigger set 101"},"hoverEvent":{"action":"show_text","contents":{"text":"接受这条邀请","color":"green"}}}
