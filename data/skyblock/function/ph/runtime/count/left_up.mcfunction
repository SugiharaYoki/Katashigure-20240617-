...
execute if score temp_index_col 4ASCEND_system matches 0..8 if score temp_index_row 4ASCEND_system matches 0..8 if entity @a[tag=current_turn,tag=4ASCENDHost] if score slot_type 4ASCEND_system matches 2 run scoreboard players set temp_index_col 4ASCEND_system -1
#GUEST
