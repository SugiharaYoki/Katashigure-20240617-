...
#clear data
    ...
    #enum template [$1=1..5]:
    #execute as @s[tag=table$1,tag=!4ASCENDHost]  if data storage ph {end_init:{table:$1}} run data remove storage ph table_manager[{table:$1}].player2
    execute as @s[tag=table0,tag=!4ASCENDHost] if data storage ph {end_init:{table:0}} run data remove storage ph table_manager[{table:0}].player2
    execute as @s[tag=table1,tag=!4ASCENDHost] if data storage ph {end_init:{table:1}} run data remove storage ph table_manager[{table:1}].player2
    execute as @s[tag=table2,tag=!4ASCENDHost] if data storage ph {end_init:{table:2}} run data remove storage ph table_manager[{table:2}].player2
    execute as @s[tag=table3,tag=!4ASCENDHost] if data storage ph {end_init:{table:3}} run data remove storage ph table_manager[{table:3}].player2
    execute as @s[tag=table4,tag=!4ASCENDHost] if data storage ph {end_init:{table:4}} run data remove storage ph table_manager[{table:4}].player2
