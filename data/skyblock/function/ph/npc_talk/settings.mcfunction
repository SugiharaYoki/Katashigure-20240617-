tellraw @s "\n\n"
    #HP
    tellraw @s [{"text":"设置自己的生命值：","color":"yellow"},{"score":{"name":"@s","objective":"4ASCEND_HP"},"color":"green","underlined":true,"clickEvent":{"action": "suggest_command","value": "/trigger 4ASCEND_HP_Trigger set 5"}}]
