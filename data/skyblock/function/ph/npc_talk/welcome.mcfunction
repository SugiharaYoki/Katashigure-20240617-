...
tellraw @s [{"text":"新手教程","color":"yellow","underlined":true,"click_event":{"action": "command","value": "trigger PlayHouseTrigger set 1"},"hoverEvent": {"action": "show_text","contents": {"text":"点此进入新手教程模拟对局","color":"green"}}}]
...
tellraw @s [{"text":"人机对战","color":"gray","underlined":true,"click_event":{"action": "command","value": "trigger PlayHouseTrigger set 5"},"hoverEvent": {"action": "show_text","contents": {"text":"此功能暂未开放！","color":"red"}}}]
