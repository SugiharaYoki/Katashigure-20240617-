#available
    ...
    execute if data storage ph {invitation:{table:0}} run data modify storage ph table_manager[{id:0}].available set value 0b
    ...
    execute if data storage ph {invitation:{table:1}} run data modify storage ph table_manager[{id:1}].available set value 0b
    ...
    execute if data storage ph {invitation:{table:2}} run data modify storage ph table_manager[{id:2}].available set value 0b
    ...
    execute if data storage ph {invitation:{table:3}} run data modify storage ph table_manager[{id:3}].available set value 0b
    ...
    execute if data storage ph {invitation:{table:4}} run data modify storage ph table_manager[{id:4}].available set value 0b
    #display
