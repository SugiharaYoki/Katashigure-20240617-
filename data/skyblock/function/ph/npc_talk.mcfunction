...
execute if score @s PlayHouseTrigger matches 3 run tellraw @s "\n\n\n"
    #HP
    execute if score @s PlayHouseTrigger matches 3 run tellraw @s [{"text":"设置自己的生命值：","color":"yellow"},{"score":{"name":"@s","objective":"4ASCEND_HP"},"underlined":true,"clickEvent":{"action": "suggest_command","value": "/trigger 4ASCEND_HP_Trigger set 5"}}]
