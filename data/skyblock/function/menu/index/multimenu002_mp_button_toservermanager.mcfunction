...
tellraw @s[tag=!En,gamemode=!adventure] {text:"   冒险模式",color:"green",click_event:{"action":"run_command","command":"trigger MultiMenu set 12"},hover_event:{"action":"show_text","value":{text:"切换至冒险模式",color:"white"}}}
tellraw @s[tag=En,gamemode=!adventure] {text:"   Adventure Mode",color:"green",click_event:{"action":"run_command","command":"trigger MultiMenu set 12"},hover_event:{"action":"show_text","value":{text:"Switch to Adventure Mode",color:"white"}}}
