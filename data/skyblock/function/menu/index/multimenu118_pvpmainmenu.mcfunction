...
tellraw @s {text:"「综合设定」",color:"yellow",bold:1b}
...
tellraw @s {text:""}
tellraw @s [{text:"「伊什塔尔的赐福」",color:"yellow",bold:1b,click_event:{"action":"run_command","command":"trigger MultiMenu set 131"},hover_event:{"action":"show_text","value":{text:"选择PVP战争开局时获取的道具",color:"white"}}}]
