...
tellraw @s {text:" "}
tellraw @s [{text:"   ",color:"white"},{text:"查看职业数据",underlined:true,color:"yellow",click_event:{"action":"run_command","command":"trigger MultiMenu set 29"},hover_event:{"action":"show_text","value":{text:"查看自己的PVP职业统计数据",color:"white"}}}]
tellraw @s {text:" "}
tellraw @s {text:"      [返回主菜单]",color:"yellow",click_event:{"action":"run_command","command":"trigger MultiMenu set 991"},hover_event:{"action":"show_text","value":{text:"返回主菜单",color:"green"}}}
