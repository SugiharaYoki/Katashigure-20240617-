...
tellraw @s {text:" "}
tellraw @s [{text:"   ",color:"white"},{text:"查看职业数据",underlined:1b,color:"yellow",click_event:{"action":"run_command","command":"trigger MultiMenu set 29"},hover_event:{"action":"show_text","value":{text:"查看自己的PVP职业统计数据",color:"white"}}}]
tellraw @s {text:" "}
