...
#二段跳
execute as @a[tag=!Gaming,score={City_DoubleJump=..0}] at @s if block ~ ~-0.1 ~ air unless entity @s[predicate=skyblock:jump] run tag @s add City_DoubleJumpPass
...
execute as @a[score={City_DoubleJump=1..}] at @s run function skyblock:city/double_jump
