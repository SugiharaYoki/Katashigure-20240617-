...
execute if score @n[tag=sc] Map_Code matches 10 run spawnpoint @a[tag=!NoSkyWar] 50000 100 50000
...
execute if score @n[tag=sc] Map_Code matches 13 if block 27 56 -105 jungle_log run spawnpoint @a[tag=!NoSkyWar] 50452 30 50452
execute if score @n[tag=sc] Map_Code matches 13 if block 27 56 -105 crimson_hyphae run spawnpoint @a[tag=!NoSkyWar] 50474 30 50474

gamemode survival @a[tag=PVPing,tag=PVPTeamed]
execute if score @n[tag=sc] Map_Code matches 7 run gamemode adventure @a[tag=PVPing,tag=PVPTeamed]
#[futuredevskywar]
...
execute if score @n[tag=sc] Map_Code matches 2 run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run worldborder center 50062 50052
...
execute if score @n[tag=sc] Map_Code matches 7 run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run worldborder set 142
execute if score @n[tag=sc] Map_Code matches 8 run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run worldborder center 50449 50049
...
execute if score @n[tag=sc] Map_Code matches 13 if block 27 56 -105 oak_planks run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run worldborder set 70
execute if score @n[tag=sc] Map_Code matches 13 if block 27 56 -105 jungle_log run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run worldborder center 50452 50452
execute if score @n[tag=sc] Map_Code matches 13 if block 27 56 -105 jungle_log run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run worldborder set 110
