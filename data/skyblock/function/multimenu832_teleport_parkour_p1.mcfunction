...
tellraw @s[scores={parkour_stage=11..}] [{"text":"  腐败污池 11","bold":false,"color":"blue","clickEvent":{"action":"run_command","value":"/trigger MultiMenu set 832011"}}]
tellraw @s[scores={parkour_stage=12..}] [{"text":"  腐败污池 12","bold":false,"color":"blue","clickEvent":{"action":"run_command","value":"/trigger MultiMenu set 832012"}}]
tellraw @s[scores={parkour_stage=13..}] [{"text":"  日光祭坛 13","bold":false,"color":"blue","clickEvent":{"action":"run_command","value":"/trigger MultiMenu set 832013"}}]
tellraw @s[scores={parkour_stage=14..}] [{"text":"  日光祭坛 14","bold":false,"color":"blue","clickEvent":{"action":"run_command","value":"/trigger MultiMenu set 832014"}}]
tellraw @s[scores={parkour_stage=15..}] [{"text":"  日光祭坛 15","bold":false,"color":"blue","clickEvent":{"action":"run_command","value":"/trigger MultiMenu set 832015"}}]
tellraw @s[scores={parkour_stage=16..}] [{"text":"  16","bold":false,"color":"blue","clickEvent":{"action":"run_command","value":"/trigger MultiMenu set 832016"}}]
tellraw @s[scores={parkour_stage=17..}] [{"text":"  17","bold":false,"color":"blue","clickEvent":{"action":"run_command","value":"/trigger MultiMenu set 832017"}}]
tellraw @s[scores={parkour_stage=18..}] [{"text":"  18","bold":false,"color":"blue","clickEvent":{"action":"run_command","value":"/trigger MultiMenu set 832018"}}]
