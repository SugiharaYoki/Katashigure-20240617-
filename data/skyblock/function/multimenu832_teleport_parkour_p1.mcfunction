...
tellraw @s[scores={parkour_stage=14..}] [{"text":"  14","bold":false,"color":"blue","clickEvent":{"action":"run_command","value":"/trigger MultiMenu set 832014"}}]
tellraw @s[scores={parkour_stage=15..}] [{"text":"  15","bold":false,"color":"blue","clickEvent":{"action":"run_command","value":"/trigger MultiMenu set 832015"}}]
