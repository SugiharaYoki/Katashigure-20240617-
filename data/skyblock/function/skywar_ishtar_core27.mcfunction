...
execute at @s[y_rotation=135..225] if block ~ ~-0.1 ~ air run fill ~ ~0 ~-2 ~ ~6 ~-2 polished_deepslate destroy
execute at @s[y_rotation=225..315] if block ~ ~-0.1 ~ air run fill ~2 ~0 ~ ~2 ~6 ~ polished_deepslate destroy
execute at @s[y_rotation=315..45] if block ~ ~-0.1 ~ air run fill ~ ~0 ~2 ~ ~6 ~2 polished_deepslate destroy
execute at @s[y_rotation=45..135] if block ~ ~-0.1 ~ air run fill ~-2 ~0 ~ ~-2 ~6 ~ polished_deepslate destroy
execute at @s[y_rotation=135..225] if block ~ ~-0.1 ~ air run fill ~ ~0 ~-1 ~ ~6 ~-1 ladder[facing=south] destroy
execute at @s[y_rotation=225..315] if block ~ ~-0.1 ~ air run fill ~1 ~0 ~ ~1 ~6 ~ ladder[facing=west] destroy
execute at @s[y_rotation=315..45] if block ~ ~-0.1 ~ air run fill ~ ~0 ~1 ~ ~6 ~1 ladder[facing=north] destroy
execute at @s[y_rotation=45..135] if block ~ ~-0.1 ~ air run fill ~-1 ~0 ~ ~-1 ~6 ~ ladder[facing=east] destroy
