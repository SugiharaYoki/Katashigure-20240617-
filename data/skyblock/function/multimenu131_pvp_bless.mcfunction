...
execute unless entity @s[scores={ishtar_bless_1=19}] run tellraw @s {"text":"    搬运「输载归初」","color":"gray","clickEvent":{"action":"run_command","value":"/trigger MultiMenu set 131019"},"hoverEvent":{"action":"show_text","contents":{"text":"点击装备该礼装","color":"green"}}}
...
execute if entity @s[scores={ishtar_bless_1=20}] run tellraw @s {"text":"    天威「跃空战技」","color":"gold","hoverEvent":{"action":"show_text","contents":{"text":"跃空战技核心×1 给予自己一把重锤 留在背包内时可以在粘液块上一跃而起","color":"white"}}}
execute unless entity @s[scores={ishtar_bless_1=20}] run tellraw @s {"text":"    天威「跃空战技」","color":"gray","clickEvent":{"action":"run_command","value":"/trigger MultiMenu set 131020"},"hoverEvent":{"action":"show_text","contents":{"text":"点击装备该礼装","color":"green"}}}
