...
execute as @e[tag=Bless24_Effective,scores={rng1=1..60}] at @s run particle trial_spawner_detection_ominous ~ ~ ~ 0.2 50 0.2 0 100
execute as @e[tag=Bless24_Effective,scores={rng1=21..60}] at @s run particle trial_spawner_detection_ominous ~ ~ ~ 0.2 60 0.2 0 200
execute as @e[tag=Bless24_Effective,scores={rng1=41..60}] at @s run particle trial_spawner_detection_ominous ~ ~ ~ 0.2 70 0.2 0 300
execute as @e[tag=Bless24_Effective,scores={rng1=61..}] at @s run summon marker ~ ~ ~ {Tags:["Bless24_Marker"]}
execute as @e[tag=Bless24_Effective,scores={rng1=61..}] at @s run kill @s
...
execute as @e[type=marker,tag=Bless24_Marker,x=50062,y=226,z=50052,distance=..3000] at @s run fill ~ ~ ~ ~ ~ ~ air destroy
