...
#开启涂色战争
execute if score start_seconds color_war_system matches 0 run tag @a[tag=!NoSkyWar,tag=!Gaming] add NoMultiMenu
execute if score start_seconds color_war_system matches 0 run tag @a[tag=!NoSkyWar,tag=!Gaming] add ColorWar
execute if score start_seconds color_war_system matches 0 run tag @a[tag=!NoSkyWar,tag=!Gaming] add Gaming
execute if score start_seconds color_war_system matches 0 run team leave @a[tag=ColorWar]
...
execute if score start_seconds color_war_system matches -2 run tag @a[tag=ColorWar] remove Gaming
execute if score start_seconds color_war_system matches -2 run tag @a[tag=ColorWar] remove NoMultiMenu
execute if score start_seconds color_war_system matches -2 run tag @a[tag=ColorWar] remove ColorWar
