...
execute if score start_seconds color_war_system matches 10 run title @a[tag=!Gaming,tag=!NoSkyWar] title {"text":"开启PVP竞技场","bold":true,"color":"gold"}
...
execute if score start_seconds color_war_system matches 10 run tellraw @a[tag=!Gaming,tag=!NoSkyWar] {"text":"   —— [暂停开局] ——","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger MultiMenu set 994"},"hoverEvent":{"action":"show_text","contents":{"text":"暂停PVP战场的开局","color":"green"}}}
execute if score start_seconds color_war_system matches 10 run tellraw @a[tag=!Gaming,tag=!NoSkyWar] {"text":"   —— [重置倒计时] ——","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger MultiMenu set 996"},"hoverEvent":{"action":"show_text","contents":{"text":"重置PVP战场的开局倒计时","color":"green"}}}
