...
#Set MultiM=1
execute as @s[tag=!NoMultiMenu,tag=!MultiMenuAlready,nbt={SelectedItem:{components:{"minecraft:custom_data":{multimenu:true}}}}] at @s run scoreboard players set @s MultiMenu 1
#MultiM giving
...
#Add MultiMAlready
execute as @s[tag=!MultiMenuAlready,nbt={SelectedItem:{components:{"minecraft:custom_data":{multimenu:true}}}}] at @s run tag @s add MultiMenuAlready
#Remove MultiMAlready
execute as @s[nbt=!{SelectedItem:{components:{"minecraft:custom_data":{multimenu:true}}}}] at @s run tag @s remove MultiMenuAlready
#Anti-Throw
