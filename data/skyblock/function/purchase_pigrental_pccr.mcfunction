...
execute if entity @n[tag=sc,scores={PigCarCount=..40}] as @s at @s[tag=purchasesuccess] run summon pig -9 54 -28 {Tags:[PigCar],Saddle:1,Rotation:[-90f,0f],attributes:[{id:"generic.max_health",base:80.0},{id:"generic.movement_speed",base:0.5}],Health:80.0f,CustomName:"\"豪车\""}
