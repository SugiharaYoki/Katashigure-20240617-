...
execute if block ~ ~-1 ~ emerald_block if block ~ ~-2 ~ red_concrete if block ~ ~-3 ~ white_concrete unless score @s parkour_stage matches ..9 run scoreboard players set @s parkour_stage 10
