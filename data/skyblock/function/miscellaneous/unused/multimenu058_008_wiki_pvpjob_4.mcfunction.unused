...
tellraw @s [{"text":"属性“星”： ","bold":false,"color":"gray"},{"text":"建筑师之铲×1、","bold":false,"color":"light_purple","hoverEvent":{"action":"show_text","contents":{"text":"效率与击退较高的精准采集铁铲 但攻击力较低","color":"white"}}},{"text":"雕刻罗盘·速×1、","bold":false,"color":"light_purple","hoverEvent":{"action":"show_text","contents":{"text":"主副手握住时发挥作用 生命上限（小）增加速度（中）","color":"white"}}},{"text":"梯子×15、","bold":false,"color":"green"},{"text":"岩浆怪刷怪蛋×1、","bold":false,"color":"green"},{"text":"高速堡垒核心×2 搭建落脚堡垒 留在背包内时增加挖掘速度（无法叠加）","bold":false,"color":"light_purple","hoverEvent":{"action":"show_text","contents":{"text":"包含两枚核心 投掷后自动建造小型堡垒","color":"white"}}}]
tellraw @s {"text":"","color":"white"}
