...
tellraw @s [{"text":"地图更换成功！已选择地图： ","color":"green"},{"text":"蛛网竞技场","color":"aqua"}]
trigger MultiMenu set 1
tellraw @a[tag=FallenSquareJoined] [{"text":"『塌方战争』 房主已更改地图： ","color":"green"},{"text":"蛛网竞技场","color":"aqua"}]
...
scoreboard players set @n[tag=sc] FallenSquareMap 2
