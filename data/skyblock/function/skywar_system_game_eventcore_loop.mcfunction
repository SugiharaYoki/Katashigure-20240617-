...
execute if entity @n[tag=sc,scores={Map_Code=4}] if block 50068 -6 50068 air run execute unless entity @n[tag=sc,tag=Skyblock_map004_event] run particle flame 50068 -6 50068 0 0 0 0.3 180
execute if entity @n[tag=sc,scores={Map_Code=4}] if block 50068 -6 50068 air run execute unless entity @n[tag=sc,tag=Skyblock_map004_event] run particle flame 50068 -6 50068 0 0 0 0.1 80
execute if entity @n[tag=sc,scores={Map_Code=4}] if block 50068 -6 50068 air run execute unless entity @n[tag=sc,tag=Skyblock_map004_event] run particle flame 50068 -6 50068 0 0 0 0.5 80
execute if entity @n[tag=sc,scores={Map_Code=4}] if block 50068 -6 50068 air run execute unless entity @n[tag=sc,tag=Skyblock_map004_event] run playsound item.trident.thunder hostile @a 50068 -6 50068 10 0.8
execute if entity @n[tag=sc,scores={Map_Code=4}] if block 50068 -6 50068 air run execute unless entity @n[tag=sc,tag=Skyblock_map004_event] run playsound entity.lightning_bolt.impact hostile @a 50068 -6 50068 10 0.8
execute if entity @n[tag=sc,scores={Map_Code=4}] if block 50068 -6 50068 air run execute unless entity @n[tag=sc,tag=Skyblock_map004_event] run summon blaze 50068 -6 50068
execute if entity @n[tag=sc,scores={Map_Code=4}] if block 50068 -6 50068 air run execute unless entity @n[tag=sc,tag=Skyblock_map004_event] run summon blaze 50068 -6 50068
execute if entity @n[tag=sc,scores={Map_Code=4}] if block 50068 -6 50068 air run execute unless entity @n[tag=sc,tag=Skyblock_map004_event] run summon blaze 50068 -6 50068
execute if entity @n[tag=sc,scores={Map_Code=4}] if block 50068 -6 50068 air run execute unless entity @n[tag=sc,tag=Skyblock_map004_event] run summon blaze 50068 -6 50068
execute if entity @n[tag=sc,scores={Map_Code=4}] if block 50068 -6 50068 air run execute unless entity @n[tag=sc,tag=Skyblock_map004_event] run summon blaze 50068 -6 50068
