...
execute if score sc TimeRemainUnsee matches 400 if entity @n[tag=sc,scores={Map_Code=2}] run title @a[tag=PVP_see] times 0 60 60
execute if score sc TimeRemainUnsee matches 400 if entity @n[tag=sc,scores={Map_Code=2}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] title {"text":"地图边界开始缩小","color":"yellow"}
execute if score sc TimeRemainUnsee matches 400 if entity @n[tag=sc,scores={Map_Code=2}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] subtitle {"text":"“逆向的道标已腐朽数年……”","color":"yellow"}
execute if score sc TimeRemainUnsee matches 400 if entity @n[tag=sc,scores={Map_Code=2}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run worldborder set 76 60

execute if score sc TimeRemainUnsee matches 200 if entity @n[tag=sc,scores={Map_Code=2}] run title @a[tag=PVP_see] times 0 60 60
execute if score sc TimeRemainUnsee matches 200 if entity @n[tag=sc,scores={Map_Code=2}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] title {"text":"地图边界再次缩小","color":"red"}
execute if score sc TimeRemainUnsee matches 200 if entity @n[tag=sc,scores={Map_Code=2}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] subtitle {"text":"“恍惚间 面前古老的祭坛近似摇摇欲坠……”","color":"red"}
execute if score sc TimeRemainUnsee matches 200 if entity @n[tag=sc,scores={Map_Code=2}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run worldborder set 42 60

execute if score sc TimeRemainUnsee matches 0 if entity @n[tag=sc,scores={Map_Code=2}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] times 0 50 30
execute if score sc TimeRemainUnsee matches 0 if entity @n[tag=sc,scores={Map_Code=2}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] title {"text":"地图边界缩小","color":"red"}
execute if score sc TimeRemainUnsee matches 0 if entity @n[tag=sc,scores={Map_Code=2}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] subtitle {"text":"“万物终将与众神一同溺亡于时光之忘川……”","color":"red"}
execute if score sc TimeRemainUnsee matches 0 if entity @n[tag=sc,scores={Map_Code=2}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run worldborder set 16 30

execute if score sc TimeRemainUnsee matches 600 if entity @n[tag=sc,scores={Map_Code=3}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] times 0 60 60
execute if score sc TimeRemainUnsee matches 600 if entity @n[tag=sc,scores={Map_Code=3}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] title {"text":"地图边界开始缩小","color":"yellow"}
execute if score sc TimeRemainUnsee matches 600 if entity @n[tag=sc,scores={Map_Code=3}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] subtitle {"text":"“潜入深海的探险者 至今未曾发现这是陷阱”","color":"yellow"}
execute if score sc TimeRemainUnsee matches 600 if entity @n[tag=sc,scores={Map_Code=3}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run worldborder set 12 600
execute if score sc TimeRemainUnsee matches 600 if entity @n[tag=sc,scores={Map_Code=3}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run advancement grant @a[gamemode=!spectator] only skyblock:story_map003option1
execute if score sc TimeRemainUnsee matches 0 if entity @n[tag=sc,scores={Map_Code=3}] run title @a[tag=PVP_see] times 0 50 30
execute if score sc TimeRemainUnsee matches 0 if entity @n[tag=sc,scores={Map_Code=3}] run title @a[tag=PVP_see] title {"text":"血腥决战已至","color":"red"}
execute if score sc TimeRemainUnsee matches 0 if entity @n[tag=sc,scores={Map_Code=3}] run title @a[tag=PVP_see] subtitle {"text":"“一切诱导皆为阴谋者的骗局……”","color":"red"}
execute if score sc TimeRemainUnsee matches 0 if entity @n[tag=sc,scores={Map_Code=3}] run playsound minecraft:music.dragon music @a[tag=PVP_see] ~ ~ ~ 10000
execute if score sc TimeRemainUnsee matches 0 if entity @n[tag=sc,scores={Map_Code=3}] run effect give @a[tag=PVPing] minecraft:glowing 600 0 true

execute if score sc TimeRemainUnsee matches 540 if entity @n[tag=sc,scores={Map_Code=5}] run title @a[tag=PVP_see] times 0 60 60
execute if score sc TimeRemainUnsee matches 540 if entity @n[tag=sc,scores={Map_Code=5}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] title {"text":"教堂外圈开始崩塌","color":"yellow"}
...
execute if score sc TimeRemainUnsee matches 300 if entity @n[tag=sc,scores={Map_Code=7}] run title @a[tag=PVP_see] subtitle {"text":"“勇士们 请踏入决斗平台”","color":"red"}
execute if score sc TimeRemainUnsee matches 300 if entity @n[tag=sc,scores={Map_Code=7}] run gamemode survival @a[tag=PVPing,gamemode=adventure]
execute if score sc TimeRemainUnsee matches 300 if entity @n[tag=sc,scores={Map_Code=7}] run stopsound @a[tag=PVP_see]
execute if score sc TimeRemainUnsee matches 300 if entity @n[tag=sc,scores={Map_Code=7}] run fill 50503 28 50469 50503 26 50473 air
execute if score sc TimeRemainUnsee matches 300 if entity @n[tag=sc,scores={Map_Code=7}] run fill 50439 28 50473 50439 26 50469 air
execute if score sc TimeRemainUnsee matches 300 if entity @n[tag=sc,scores={Map_Code=7}] run playsound minecraft:music_disc.pigstep music @a[tag=PVP_see] 50471 230 50471 1000

execute if score sc TimeRemainUnsee matches 300 if entity @n[tag=sc,scores={Map_Code=8}] run title @a[tag=PVP_see] times 0 60 60
execute if score sc TimeRemainUnsee matches 300 if entity @n[tag=sc,scores={Map_Code=8}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] title {"text":"地图边界开始缩小","color":"yellow"}
execute if score sc TimeRemainUnsee matches 300 if entity @n[tag=sc,scores={Map_Code=8}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] subtitle {"text":"“自荒地的正下方传来毛骨悚然的噪音……”","color":"red"}
execute if score sc TimeRemainUnsee matches 300 if entity @n[tag=sc,scores={Map_Code=8}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run worldborder set 56 60

execute if score sc TimeRemainUnsee matches 0 if entity @n[tag=sc,scores={Map_Code=8}] run title @a[tag=PVP_see] times 0 50 30
execute if score sc TimeRemainUnsee matches 0 if entity @n[tag=sc,scores={Map_Code=8}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] title {"text":"地图边界缩小","color":"red"}
execute if score sc TimeRemainUnsee matches 0 if entity @n[tag=sc,scores={Map_Code=8}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] subtitle {"text":"“这片沙漠 本就是无人禁区……”","color":"red"}
execute if score sc TimeRemainUnsee matches 0 if entity @n[tag=sc,scores={Map_Code=8}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run worldborder set 32 60
...
execute if score sc TimeRemainUnsee matches 500 if entity @n[tag=sc,scores={Map_Code=15}] run title @a[tag=PVP_see] times 0 30 30
execute if score sc TimeRemainUnsee matches 500 if entity @n[tag=sc,scores={Map_Code=15}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] title {"text":"天色骤变","color":"yellow"}
execute if score sc TimeRemainUnsee matches 500 if entity @n[tag=sc,scores={Map_Code=15}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] subtitle {"text":"“这座浮游要塞本身即在拒绝我等的光临”","color":"red"}
execute if score sc TimeRemainUnsee matches 500 if entity @n[tag=sc,scores={Map_Code=15}] unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run weather thunder 500

execute if score sc TimeRemainUnsee matches 300 if entity @n[tag=sc,scores={Map_Code=16}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run worldborder set 40 200
execute if score sc TimeRemainUnsee matches 300 if entity @n[tag=sc,scores={Map_Code=16}] run title @a[tag=PVP_see] times 0 30 30
execute if score sc TimeRemainUnsee matches 300 if entity @n[tag=sc,scores={Map_Code=16}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run effect give @a[tag=PVP_see] darkness 3 1 true
execute if score sc TimeRemainUnsee matches 300 if entity @n[tag=sc,scores={Map_Code=16}] run stopsound @a[tag=PVP_see] music
execute if score sc TimeRemainUnsee matches 298..300 if entity @n[tag=sc,scores={Map_Code=16}] run playsound minecraft:ambient.crimson_forest.mood master @a[tag=PVP_see] ~ ~ ~ 100 0.8
execute if score sc TimeRemainUnsee matches 298..300 if entity @n[tag=sc,scores={Map_Code=16}] run playsound minecraft:ambient.crimson_forest.additions master @a[tag=PVP_see] ~ ~ ~ 100 0.8
execute if score sc TimeRemainUnsee matches 298 if entity @n[tag=sc,scores={Map_Code=16}] as @a[tag=PVPing,gamemode=survival] at @s run fill ~-10 ~-10 ~-10 ~10 ~10 ~10 nether_wart_block replace cherry_leaves
execute if score sc TimeRemainUnsee matches 298 if entity @n[tag=sc,scores={Map_Code=16}] as @a[tag=PVPing,gamemode=survival] at @s run fill ~-10 ~-10 ~-10 ~10 ~10 ~10 crimson_stem replace cherry_log
execute if score sc TimeRemainUnsee matches 298 if entity @n[tag=sc,scores={Map_Code=16}] as @a[tag=PVPing,gamemode=survival] at @s run fill ~-10 ~-10 ~-10 ~10 ~10 ~10 crimson_planks replace cherry_planks
execute if score sc TimeRemainUnsee matches 298 if entity @n[tag=sc,scores={Map_Code=16}] as @a[tag=PVPing,gamemode=survival] at @s run fill ~-10 ~-10 ~-10 ~10 ~10 ~10 crimson_nylium replace grass_block
execute if score sc TimeRemainUnsee matches 298 if entity @n[tag=sc,scores={Map_Code=16}] as @a[tag=PVPing,gamemode=survival] at @s run fill ~-10 ~-10 ~-10 ~10 ~10 ~10 crimson_roots replace short_grass
execute if score sc TimeRemainUnsee matches 298 if entity @n[tag=sc,scores={Map_Code=16}] as @a[tag=PVPing,gamemode=survival] at @s run fill ~-10 ~-10 ~-10 ~10 ~10 ~10 netherrack replace stone
execute if score sc TimeRemainUnsee matches 298 if entity @n[tag=sc,scores={Map_Code=16}] as @a[tag=PVPing,gamemode=survival] at @s run fill ~-10 ~-10 ~-10 ~10 ~10 ~10 blackstone replace diorite
execute if score sc TimeRemainUnsee matches 298 if entity @n[tag=sc,scores={Map_Code=16}] as @a[tag=PVPing,gamemode=survival] at @s run fill ~-10 ~-10 ~-10 ~10 ~10 ~10 crimson_fungus replace pink_petals
execute if score sc TimeRemainUnsee matches 298 if entity @n[tag=sc,scores={Map_Code=16}] unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run time set midnight


execute if score sc TimeRemainUnsee matches 600 if entity @n[tag=sc,scores={Map_Code=17}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] times 0 60 60
execute if score sc TimeRemainUnsee matches 600 if entity @n[tag=sc,scores={Map_Code=17}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] title {"text":"地图边界开始缩小","color":"yellow"}
execute if score sc TimeRemainUnsee matches 600 if entity @n[tag=sc,scores={Map_Code=17}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] subtitle {"text":"“这艘军舰 早已不再是属于生者的造物”","color":"yellow"}
execute if score sc TimeRemainUnsee matches 600 if entity @n[tag=sc,scores={Map_Code=17}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run worldborder set 60 300
execute if score sc TimeRemainUnsee matches 0 if entity @n[tag=sc,scores={Map_Code=17}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] times 0 60 60
execute if score sc TimeRemainUnsee matches 0 if entity @n[tag=sc,scores={Map_Code=17}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] title {"text":"地图边界大幅缩小","color":"yellow"}
execute if score sc TimeRemainUnsee matches 0 if entity @n[tag=sc,scores={Map_Code=17}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] subtitle {"text":"“再不离开这头空中巨兽 我等皆会化作其腹中食物”","color":"yellow"}
execute if score sc TimeRemainUnsee matches 0 if entity @n[tag=sc,scores={Map_Code=17}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run worldborder set 20 300

execute if score sc TimeRemainUnsee matches 803 if entity @n[tag=sc,scores={Map_Code=4}] run summon piglin 50070 11 50068
execute if score sc TimeRemainUnsee matches 803 if entity @n[tag=sc,scores={Map_Code=4}] run summon piglin 50070 11 50068
execute if score sc TimeRemainUnsee matches 803 if entity @n[tag=sc,scores={Map_Code=4}] run summon piglin 50070 11 50068
execute if score sc TimeRemainUnsee matches 803 if entity @n[tag=sc,scores={Map_Code=4}] run summon piglin 50070 11 50068
execute if score sc TimeRemainUnsee matches 803 if entity @n[tag=sc,scores={Map_Code=4}] run summon blaze 50062 34 50068
execute if score sc TimeRemainUnsee matches 803 if entity @n[tag=sc,scores={Map_Code=4}] run summon blaze 50062 34 50068
execute if score sc TimeRemainUnsee matches 803 if entity @n[tag=sc,scores={Map_Code=4}] run summon blaze 50074 34 50068
execute if score sc TimeRemainUnsee matches 803 if entity @n[tag=sc,scores={Map_Code=4}] run summon blaze 50074 34 50068
execute if score sc TimeRemainUnsee matches 500 if entity @n[tag=sc,scores={Map_Code=4}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] times 0 60 60
execute if score sc TimeRemainUnsee matches 500 if entity @n[tag=sc,scores={Map_Code=4}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] title {"text":"地图边界开始缩小","color":"yellow"}
execute if score sc TimeRemainUnsee matches 500 if entity @n[tag=sc,scores={Map_Code=4}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] subtitle {"text":"“噩梦带来的 从来都会是 也只会是痛苦”","color":"yellow"}
execute if score sc TimeRemainUnsee matches 500 if entity @n[tag=sc,scores={Map_Code=4}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run worldborder set 60 300
execute if score sc TimeRemainUnsee matches 0 if entity @n[tag=sc,scores={Map_Code=4}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] times 0 60 60
execute if score sc TimeRemainUnsee matches 0 if entity @n[tag=sc,scores={Map_Code=4}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] title {"text":"梦醒时分已至","color":"red"}
execute if score sc TimeRemainUnsee matches 0 if entity @n[tag=sc,scores={Map_Code=4}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run title @a[tag=PVP_see] subtitle {"text":"“人类啊 切勿迷失于纯黑的噩梦”","color":"red"}
execute if score sc TimeRemainUnsee matches 0 if entity @n[tag=sc,scores={Map_Code=4}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run worldborder set 20 300
...
execute if score sc TimeRemainUnsee matches 603 if entity @n[tag=sc,scores={Map_Code=10}] run summon frog 50048 21 50076 {variant:warm}
execute if score sc TimeRemainUnsee matches 603 if entity @n[tag=sc,scores={Map_Code=10}] run summon frog 50076 21 50048 {variant:warm}
execute if score sc TimeRemainUnsee matches 603 if entity @n[tag=sc,scores={Map_Code=10}] run summon frog 50090 21 50076 {variant:warm}
execute if score sc TimeRemainUnsee matches 603 if entity @n[tag=sc,scores={Map_Code=10}] run summon frog 50076 21 50090 {variant:warm}
execute if score sc TimeRemainUnsee matches 603 if entity @n[tag=sc,scores={Map_Code=10}] run summon frog 50048 21 50076 {variant:warm}
execute if score sc TimeRemainUnsee matches 603 if entity @n[tag=sc,scores={Map_Code=10}] run summon frog 50076 21 50048 {variant:warm}
execute if score sc TimeRemainUnsee matches 603 if entity @n[tag=sc,scores={Map_Code=10}] run summon frog 50090 21 50076 {variant:warm}
execute if score sc TimeRemainUnsee matches 603 if entity @n[tag=sc,scores={Map_Code=10}] run summon frog 50076 21 50090 {variant:warm}
...
execute if score sc TimeRemainUnsee matches 600 if entity @n[tag=sc,scores={Map_Code=11}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run worldborder set 30 480