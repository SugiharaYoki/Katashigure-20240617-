...
execute if score sc TimeRemainUnsee matches 600 if entity @n[tag=sc,scores={Map_Code=11}] run execute unless entity @n[tag=sc,tag=Skyblock_NoWorldborder] run worldborder set 13 600