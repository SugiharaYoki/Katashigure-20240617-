...
execute if score MG_AZR0_rng rng1 matches 40 run summon silverfish ~ ~ ~ {CustomName:'[{"text":"噬砖虫王"}]',DeathLootTable:"skyblock:mg/azr0/tier4",Tags:["MG_AZR0MOB","MG_AZR0MOB_silverfishking"],attributes:[{id:"generic.attack_damage",base:9},{id:"generic.movement_speed",base:0.18},{id:"generic.max_health",base:60},{id:"generic.follow_range",base:186},{id:"generic.armor",base:6},{id:"generic.scale",base:2.5}],Health:60,PersistenceRequired:1b}
