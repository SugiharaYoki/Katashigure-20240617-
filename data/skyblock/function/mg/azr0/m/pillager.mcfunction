...
execute if score MG_AZR0_Timer rng7 matches 70.. store result score MG_AZR0_rng rng1 run random value 3..30
execute if score MG_AZR0_Timer rng7 matches 160.. store result score MG_AZR0_rng rng1 run random value 10..35
execute if score MG_AZR0_Timer rng7 matches 320.. store result score MG_AZR0_rng rng1 run random value 15..40
