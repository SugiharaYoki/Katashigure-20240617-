...
execute if score MG_AZR0_rng rng1 matches 30..35 run summon pillager ~ ~ ~ {CustomName:'[{"text":"剿弩手"}]',DeathLootTable:"skyblock:mg/azr0/tier2",Tags:["MG_AZR0MOB","MG_AZR0MOB_SlownessImmune"],attributes:[{id:"generic.movement_speed",base:0.3},{id:"generic.max_health",base:10},{id:"generic.follow_range",base:186},{id:"generic.armor",base:6}],HandItems:[{id:crossbow,count:1,components:{enchantments:{pierce:2b,quick_charge:2b}}},{}],HandDropChances:[0f,0f],ArmorItems:[{},{},{},{}],ArmorDropChances:[0f,0f,0f,0f],Health:10,PersistenceRequired:1b}

execute if score MG_AZR0_rng rng1 matches 36..39 run function skyblock:mg/azr0/particle/m_mob_tier3
execute if score MG_AZR0_rng rng1 matches 36..39 run summon pillager ~ ~ ~ {CustomName:'[{"text":"神庭先锋军·弩"}]',DeathLootTable:"skyblock:mg/azr0/tier3",Tags:["MG_AZR0MOB","MG_AZR0MOB_SlownessImmune"],attributes:[{id:"generic.movement_speed",base:0.3},{id:"generic.max_health",base:16},{id:"generic.follow_range",base:186},{id:"generic.armor",base:8}],HandItems:[{id:crossbow,count:1,components:{enchantments:{pierce:3b,quick_charge:3b}}},{}],HandDropChances:[0f,0f],ArmorItems:[{},{},{},{}],ArmorDropChances:[0f,0f,0f,0f],Health:16,PersistenceRequired:1b}
