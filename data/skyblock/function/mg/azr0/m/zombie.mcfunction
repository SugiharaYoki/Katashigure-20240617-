...
execute if score MG_AZR0_rng rng1 matches 27..29 run summon zombie ~ ~ ~ {CustomName:'[{"text":"盾兵僵尸"}]',DeathLootTable:"skyblock:mg/azr0/tier2",Tags:["MG_AZR0MOB"],attributes:[{id:"generic.attack_damage",base:1.0},{id:"generic.movement_speed",base:0.15},{id:"generic.max_health",base:6},{id:"generic.follow_range",base:86},{id:"generic.armor",base:10}],HandItems:[{id:shield,count:1},{}],HandDropChances:[0f,0f],ArmorItems:[{id:chainmail_boots,count:1},{id:chainmail_leggings,count:1},{id:chainmail_chestplate,count:1},{}],ArmorDropChances:[0f,0f,0f,0f],Health:6,PersistenceRequired:1b}
