...
execute as @a[tag=MG_AZR0PT] at @s if score MG_AZR0_Timer rng2 matches 80 if score @s Azr0_Wave_best matches ..79 run tellraw @s [{"text": "永久解锁了全新灵能！","color": "gold","bold":true},{"text": "\n - 庇灵圆环·熠烛","color": "green","bold":false}]
