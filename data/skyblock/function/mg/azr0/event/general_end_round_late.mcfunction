...
execute if score MG_AZR0_Timer rng2 matches 101 run function skyblock:mg/azr0/event/general_end_round_boss
execute if score MG_AZR0_Timer rng2 matches 121 run function skyblock:mg/azr0/event/general_end_round_boss
execute if score MG_AZR0_Timer rng2 matches 141 run function skyblock:mg/azr0/event/general_end_round_boss