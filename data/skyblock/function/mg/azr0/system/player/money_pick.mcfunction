...
execute if entity @s[scores={Azr0_UPG_OTSD_emerald_critical=1,rng1=1}] run scoreboard players add @a[tag=MG_AZR0PT] Azr_emerald 2
execute if entity @s[scores={Azr0_UPG_OTSD_emerald_critical=2,rng1=1..2}] run scoreboard players add @a[tag=MG_AZR0PT] Azr_emerald 2
execute if entity @s[scores={Azr0_UPG_OTSD_emerald_critical=3,rng1=1..3}] run scoreboard players add @a[tag=MG_AZR0PT] Azr_emerald 2
execute if entity @s[scores={Azr0_UPG_OTSD_emerald_critical=4,rng1=1..4}] run scoreboard players add @a[tag=MG_AZR0PT] Azr_emerald 2
execute if entity @s[scores={Azr0_UPG_OTSD_emerald_critical=5,rng1=1..5}] run scoreboard players add @a[tag=MG_AZR0PT] Azr_emerald 2
execute if entity @s[scores={Azr0_UPG_OTSD_emerald_critical=6,rng1=1..6}] run scoreboard players add @a[tag=MG_AZR0PT] Azr_emerald 2
