...
item replace entity @s[scores={Azr0_SkillEquip_1=2,Azr0_SkillEquip_1_timer=..0}] hotbar.3 with music_disc_blocks[custom_data={"azr0skill_core1":true},custom_name='{"text":"按下F使用 - 灵能风压","italic":false,"color":"aqua"}']
