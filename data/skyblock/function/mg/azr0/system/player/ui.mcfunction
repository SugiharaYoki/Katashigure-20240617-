...
execute if entity @s[scores={Azr_bread_recharge_level=..0}] run item replace entity @s inventory.6 with wheat
execute if entity @s[scores={Azr_bread_recharge_level=..1}] run item replace entity @s inventory.7 with wheat
execute if entity @s[scores={Azr_bread_recharge_level=..2}] run item replace entity @s inventory.8 with wheat
execute if entity @s[scores={Azr_bread_recharge_level=3..}] run item replace entity @s inventory.6 with bread
execute if entity @s[scores={Azr_bread_recharge_level=2..}] run item replace entity @s inventory.7 with bread
execute if entity @s[scores={Azr_bread_recharge_level=1..}] run item replace entity @s inventory.8 with bread
