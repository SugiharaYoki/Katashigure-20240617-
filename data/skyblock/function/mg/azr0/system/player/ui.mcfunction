...
title @s actionbar [{"text":"绿宝石 ","color":"green"},{"score":{"name":"@s","objective":"Azr_emerald"},"color":"green"},{"text":"   钻石 ","color":"aqua"},{"score":{"name":"@s","objective":"Azr_diamond"},"color":"aqua"}]
