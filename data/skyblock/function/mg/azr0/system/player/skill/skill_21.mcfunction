...
execute if score MG_AZR0_rng rng2 matches ..5 if entity @s[scores={Azr0_SKILL_21=1}] run summon wolf ~ ~ ~ {CollarColor:5,Tags:["MG_AZR0FRIENDLY"],attributes:[{id:"attack_damage",base:2},{id:"movement_speed",base:0.22},{id:"max_health",base:20},{id:"follow_range",base:186},{id:"armor",base:2},{id:"scale",base:1}],Health:20,PersistenceRequired:1b}
execute if score MG_AZR0_rng rng2 matches ..5 if entity @s[scores={Azr0_SKILL_21=2}] run summon wolf ~ ~ ~ {CollarColor:11,Tags:["MG_AZR0FRIENDLY"],attributes:[{id:"attack_damage",base:3},{id:"movement_speed",base:0.24},{id:"max_health",base:40},{id:"follow_range",base:186},{id:"armor",base:4},{id:"scale",base:1.1}],Health:40,PersistenceRequired:1b}
execute if score MG_AZR0_rng rng2 matches ..5 if entity @s[scores={Azr0_SKILL_21=3}] run summon wolf ~ ~ ~ {CollarColor:14,Tags:["MG_AZR0FRIENDLY"],attributes:[{id:"attack_damage",base:4},{id:"movement_speed",base:0.26},{id:"max_health",base:60},{id:"follow_range",base:186},{id:"armor",base:6},{id:"scale",base:1.2}],Health:60,PersistenceRequired:1b}
