execute store result score @s Azr0_SkillEquip_1rng run random value 1..18
execute store result score @s Azr0_SkillEquip_2rng run random value 1..18
execute store result score @s Azr0_SkillEquip_3rng run random value 1..18
