...
execute if score @s rng1 matches 1.. run playsound minecraft:entity.breeze.shoot master @a ~ ~ ~ 0.8 1.5
execute if score @s rng1 matches 1.. run particle gust ~ ~0.2 ~ 0 0 0 0 1
