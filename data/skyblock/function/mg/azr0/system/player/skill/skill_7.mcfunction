...
execute if entity @s[tag=Azr0_SKILL_7a] as @n[tag=Azr0_SKILL_7] at @s run function skyblock:mg/azr0/system/player/skill/skill_7_particle
execute if entity @s[tag=Azr0_SKILL_7a,scores={Azr0_SKILL_7=1}] at @s as @e[distance=..3.8,tag=MG_AZR0MOB] run effect give @s slowness 3 1 false
execute if entity @s[tag=Azr0_SKILL_7a,scores={Azr0_SKILL_7=2}] at @s as @e[distance=..4.0,tag=MG_AZR0MOB] run effect give @s slowness 3 1 false
execute if entity @s[tag=Azr0_SKILL_7a,scores={Azr0_SKILL_7=3}] at @s as @e[distance=..4.2,tag=MG_AZR0MOB] run effect give @s slowness 3 1 false
