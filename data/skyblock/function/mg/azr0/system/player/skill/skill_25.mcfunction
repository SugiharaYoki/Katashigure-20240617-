...
execute if entity @s[scores={rng2=1}] as @n[tag=MG_AZR0MOB,distance=..15] at @s as @n[tag=MG_AZR0MOB,distance=..5] at @s run summon fireball ~ ~50 ~-30 {ExplosionPower:2,Motion:[0.0,-0.05,0.00]}
