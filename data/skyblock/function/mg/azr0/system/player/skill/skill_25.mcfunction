...
execute if entity @s[scores={rng2=1,Azr0_emerald=..29,Azr0_SKILL_24=1}] run scoreboard players set @s rng2 2
execute if entity @s[scores={rng2=1,Azr0_emerald=..14,Azr0_SKILL_24=2}] run scoreboard players set @s rng2 2
execute if entity @s[scores={rng2=1,Azr0_emerald=..4,Azr0_SKILL_24=3..}] run scoreboard players set @s rng2 2
...
execute if entity @s[scores={rng2=1,Azr0_SKILL_24=1}] run scoreboard players remove @s Azr0_emerald 30
execute if entity @s[scores={rng2=1,Azr0_SKILL_24=2}] run scoreboard players remove @s Azr0_emerald 15
execute if entity @s[scores={rng2=1,Azr0_SKILL_24=3..}] run scoreboard players remove @s Azr0_emerald 5
