...
execute if entity @s[scores={rng2=1,Azr0_SKILL_25=..2}] as @n[tag=MG_AZR0MOB,distance=..15] at @s as @n[tag=MG_AZR0MOB,distance=..5] at @s run summon fireball ~ ~1 ~-0 {ExplosionPower:2,Motion:[0.0,-0.25,0.00]}
execute if entity @s[scores={rng2=1,Azr0_SKILL_25=3..}] as @n[tag=MG_AZR0MOB,distance=..15] at @s as @n[tag=MG_AZR0MOB,distance=..5] at @s run summon fireball ~ ~1 ~-0 {ExplosionPower:3,Motion:[0.0,-0.25,0.00]}
