...
execute if entity @s[scores={Azr0_SKILL_18=1}] run scoreboard players set @s Azr0_SkillEquip_1_timer 80
execute if entity @s[scores={Azr0_SKILL_18=2}] run scoreboard players set @s Azr0_SkillEquip_1_timer 72
execute if entity @s[scores={Azr0_SKILL_18=3..}] run scoreboard players set @s Azr0_SkillEquip_1_timer 60
