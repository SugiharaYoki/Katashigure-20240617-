...
execute if score @s rng1 matches 21.. positioned ^ ^ ^1.5 run particle sweep_attack ~ ~1 ~ 0 0 0 0 1
execute if score @s rng1 matches 21.. positioned ^ ^ ^1.5 as @e[tag=MG_AZR0MOB,distance=0..1.5,limit=2,sort=nearest] at @s run damage @s 6 player_attack by @p[tag=MG_AZR0PT]
