...
execute if entity @s[scores={Azr0_UPG_crossbow_multishot=4}] run function skyblock:mg/azr0/system/player/hotbar/crossbow2 {"multishot":4}
execute if entity @s[scores={Azr0_UPG_crossbow_multishot=5}] run function skyblock:mg/azr0/system/player/hotbar/crossbow2 {"multishot":5}
execute if entity @s[scores={Azr0_UPG_crossbow_multishot=6}] run function skyblock:mg/azr0/system/player/hotbar/crossbow2 {"multishot":6}
execute if entity @s[scores={Azr0_UPG_crossbow_multishot=7}] run function skyblock:mg/azr0/system/player/hotbar/crossbow2 {"multishot":7}
