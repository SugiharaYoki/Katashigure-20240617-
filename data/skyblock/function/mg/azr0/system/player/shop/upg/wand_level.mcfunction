execute if entity @s[scores={Azr0_UPG_wand_level=-1,Azr_emerald=30..}] run tag @s add AZR0SHOP_SUCCESS
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_wand_level=-1}] run scoreboard players remove @s Azr_emerald 30
