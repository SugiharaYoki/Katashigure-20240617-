...
execute as @a[tag=MG_AZR0PT,tag=MG_AZR0SPIRIT_wand_anchor] if entity @n[tag=MG_AZR0MOB,distance=2..10,tag=!MG_AZR0SPIRIT_wand_invalid] at @s facing entity @p[tag=MG_AZR0SPIRIT_wand_anchor] eyes rotated ~ 0 run tp @s ^ ^ ^0.3 facing entity @n[tag=MG_AZR0SPIRIT_wand_anchor]
