...
execute if entity @s[scores={Azr0_UPG_sword_damage=10..,Azr_emerald=1000..}] run tag @s add AZR0SHOP_SUCCESS
...
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_sword_damage=10..}] run scoreboard players remove @s Azr_emerald 1000
