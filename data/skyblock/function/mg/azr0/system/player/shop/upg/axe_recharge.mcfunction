...
execute if entity @s[scores={Azr0_UPG_axe_recharge=8,Azr_emerald=500..}] run tag @s add AZR0SHOP_SUCCESS
execute if entity @s[scores={Azr0_UPG_axe_recharge=9,Azr_emerald=600..}] run tag @s add AZR0SHOP_SUCCESS
...
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_axe_recharge=8}] run scoreboard players remove @s Azr_emerald 500
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_axe_recharge=9}] run scoreboard players remove @s Azr_emerald 600
