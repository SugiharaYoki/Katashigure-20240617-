...
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_axe_damage=-1}] run clear @s emerald 30
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_axe_damage=0}] run clear @s emerald 50
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_axe_damage=1}] run clear @s emerald 80
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_axe_damage=2}] run clear @s emerald 100
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_axe_damage=3}] run clear @s emerald 150
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_axe_damage=4}] run clear @s emerald 250
