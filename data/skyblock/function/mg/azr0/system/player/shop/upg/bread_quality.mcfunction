...
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_bread_quality=0}] run scoreboard players remove @s Azr_diamond 3
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_bread_quality=1}] run scoreboard players remove @s Azr_diamond 10
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_bread_quality=2}] run scoreboard players remove @s Azr_diamond 20
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_bread_quality=3}] run scoreboard players remove @s Azr_diamond 40
execute if entity @s[tag=AZR0SHOP_SUCCESS] run scoreboard players add @s Azr0_UPG_bread_quality 1
