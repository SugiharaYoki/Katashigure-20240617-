execute if entity @s[scores={Azr0_UPG_hp=0,Azr_emerald=20..}] run tag @s add AZR0SHOP_SUCCESS
execute if entity @s[scores={Azr0_UPG_hp=1,Azr_emerald=50..}] run tag @s add AZR0SHOP_SUCCESS
execute if entity @s[scores={Azr0_UPG_hp=2,Azr_emerald=100..}] run tag @s add AZR0SHOP_SUCCESS
execute if entity @s[scores={Azr0_UPG_hp=3,Azr_emerald=150..}] run tag @s add AZR0SHOP_SUCCESS
execute if entity @s[scores={Azr0_UPG_hp=4,Azr_emerald=200..}] run tag @s add AZR0SHOP_SUCCESS
execute if entity @s[scores={Azr0_UPG_hp=5,Azr_emerald=250..}] run tag @s add AZR0SHOP_SUCCESS
...
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_hp=0}] run scoreboard players remove @s Azr_emerald 20
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_hp=1}] run scoreboard players remove @s Azr_emerald 50
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_hp=2}] run scoreboard players remove @s Azr_emerald 100
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_hp=3}] run scoreboard players remove @s Azr_emerald 150
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_hp=4}] run scoreboard players remove @s Azr_emerald 200
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_hp=5}] run scoreboard players remove @s Azr_emerald 250
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_hp=6}] run scoreboard players remove @s Azr_emerald 300
...
execute if entity @s[tag=AZR0SHOP_SUCCESS] run effect give @s instant_health 3 9 true
