...
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_hp=0}] run scoreboard players remove @s Azr_emerald 10
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_hp=1}] run scoreboard players remove @s Azr_emerald 20
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_hp=2}] run scoreboard players remove @s Azr_emerald 50
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_hp=3}] run scoreboard players remove @s Azr_emerald 50
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_hp=4}] run scoreboard players remove @s Azr_emerald 100
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_hp=5}] run scoreboard players remove @s Azr_emerald 300
