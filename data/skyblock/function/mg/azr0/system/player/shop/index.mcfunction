...
execute if items entity @s player.cursor brick[custom_data={"azr0shop":true}] run function skyblock:mg/azr0/system/player/shop/wand_summon/list {"min":50,"max":100}
execute if items entity @s player.cursor copper_ingot[custom_data={"azr0shop":true}] run function skyblock:mg/azr0/system/player/shop/wand_summon/list {"min":30,"max":130}
execute if items entity @s player.cursor resin_brick[custom_data={"azr0shop":true}] run function skyblock:mg/azr0/system/player/shop/wand_summon/list {"min":0,"max":200}
