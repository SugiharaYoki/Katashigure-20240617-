...
execute if entity @n[tag=MG_AZR0MOB,distance=..0.9] at @s run tag @s add AZR0_success
execute if entity @s[tag=AZR0_success] as @e[distance=..3,tag=MG_AZR0MOB] at @s run damage @s 16 explosion by @n[tag=MG_AZR0SPIRIT_bombchicken]
execute if entity @s[tag=AZR0_success] at @s run damage @s 14 explosion



tag @s remove AZR0_success