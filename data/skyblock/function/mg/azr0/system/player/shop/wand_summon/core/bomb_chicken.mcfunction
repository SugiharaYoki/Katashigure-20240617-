...
execute if entity @n[tag=MG_AZR0MOB,distance=..0.9] at @s as @e[distance=..3,tag=MG_AZR0MOB] at @s run damage @s 16 explosion by @n[tag=MG_AZR0SPIRIT_bombchicken]
execute if entity @n[tag=MG_AZR0MOB,distance=..0.9] at @s run damage @s 14 explosion by @s
