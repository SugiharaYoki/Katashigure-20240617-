...
execute if score @s rng1 matches 3..5 at @n[tag=azr0_wand_summon_pos,type=marker,distance=0..10] run function skyblock:mg/azr0/system/player/shop/wand_summon/list/m/iron_golem
