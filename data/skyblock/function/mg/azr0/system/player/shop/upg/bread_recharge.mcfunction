...
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_bread_recharge=0}] run scoreboard players remove @s Azr_emerald 80
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_bread_recharge=1}] run scoreboard players remove @s Azr_emerald 300
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_bread_recharge=2}] run scoreboard players remove @s Azr_emerald 800
execute if entity @s[tag=AZR0SHOP_SUCCESS] run scoreboard players add @s Azr0_UPG_bread_recharge 1
