...
execute if entity @s[scores={Azr0_UPG_bread_recharge=3,Azr_emerald=3000..}] run tag @s add AZR0SHOP_SUCCESS
...
execute if entity @s[tag=AZR0SHOP_SUCCESS,tag=!azr0_load_game,scores={Azr0_UPG_bread_recharge=3}] run scoreboard players remove @s Azr_emerald 3000
