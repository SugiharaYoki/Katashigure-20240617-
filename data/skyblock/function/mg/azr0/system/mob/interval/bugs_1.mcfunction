...
execute if score MG_AZR0_Timer rng2 matches 80..200 store result score MG_AZR0_rng rng3 run random value 1..40
execute if score MG_AZR0_Timer rng2 matches 201.. store result score MG_AZR0_rng rng3 run random value 1..45
