...
execute if score MG_AZR0_Timer rng8 matches 250.. if score MG_AZR0_Timer rng2 matches 20..39 store result score MG_AZR0_rng rng3 run random value 3000..3010
execute if score MG_AZR0_Timer rng8 matches 250.. run scoreboard players set MG_AZR0_Timer rng8 0
