...
execute if score @s rng8 matches 20 store result score @s[scores={Health=300..}] rng1 run random value 20..50
execute if score @s rng8 matches 20 store result score @s[scores={Health=..299}] rng1 run random value 35..55
...
execute if score @s rng8 matches 80.. if score @s rng2 matches 7 at @s run function skyblock:mg/azr0/system/mob/boss/devil_goat/attack_fang
...
execute as @e[distance=..200,type=marker,tag=azr0_boss_devil_goat_summon_cross_marker] at @s run function skyblock:mg/azr0/system/mob/boss/devil_goat/summon_cross
...
execute as @e[tag=MG_AZR0MOB_devil_goat_cross,type=shulker] at @s as @e[distance=..8,type=drowned,tag=MG_AZR0MOB_devil_goat_protector] at @s run particle minecraft:trial_omen ~ ~1.3 ~ 0 0 0 0 1

execute as @n[tag=MG_AZR0MOB_devil_goat_cross,distance=..200] at @s unless entity @e[tag=azr0_boss_devil_goat_summon_cross_marker,distance=..1.5] run kill @s
