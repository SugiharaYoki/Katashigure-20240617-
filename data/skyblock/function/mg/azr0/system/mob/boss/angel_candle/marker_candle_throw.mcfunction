...
execute if score @s[scores={Health=..59}] rng1 matches 61 run summon marker ~-2 4.0 ~ {Tags:["azr0_candle_angel_candle_marker"]}
execute if score @s[scores={Health=..59}] rng1 matches 61 run summon marker ~ 4.0 ~2 {Tags:["azr0_candle_angel_candle_marker"]}
execute if score @s[scores={Health=..59}] rng1 matches 61 run summon marker ~ 4.0 ~-2 {Tags:["azr0_candle_angel_candle_marker"]}
execute if score @s[scores={Health=..59}] rng1 matches 64 run summon marker ~4 4.0 ~ {Tags:["azr0_candle_angel_candle_marker"]}
execute if score @s[scores={Health=..59}] rng1 matches 64 run summon marker ~-4 4.0 ~ {Tags:["azr0_candle_angel_candle_marker"]}
execute if score @s[scores={Health=..59}] rng1 matches 64 run summon marker ~ 4.0 ~4 {Tags:["azr0_candle_angel_candle_marker"]}
execute if score @s[scores={Health=..59}] rng1 matches 64 run summon marker ~ 4.0 ~-4 {Tags:["azr0_candle_angel_candle_marker"]}
