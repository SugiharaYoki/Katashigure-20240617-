...
execute if score @s[scores={Health=..59}] rng5 matches 46 run summon marker ~ 4.0 ~ {Tags:["azr0_candle_angel_candle_throw_marker","AzrTrace"]}
...
execute if score @s[scores={Health=..99}] rng5 matches 71 run summon marker ~ 4.0 ~ {Tags:["azr0_candle_angel_candle_throw_marker","AzrTrace"]}
