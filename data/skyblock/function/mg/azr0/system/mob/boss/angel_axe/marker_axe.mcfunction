...
execute if score @s rng1 matches 18.. at @s[tag=!azr0_axe_angel_attack_throw_high] positioned ^ ^ ^0.4 as @a[tag=MG_AZR0PT,distance=..1.1] at @s unless block ~ ~-0.2 ~ air run damage @s 5 mob_attack by @n[tag=MG_AZR0BOSS_axe_angel]
execute if score @s rng1 matches 18.. at @s[tag=!azr0_axe_angel_attack_throw_high] positioned ^ ^ ^0.4 as @e[tag=MG_AZR0SPIRIT,distance=..1.1] at @s run damage @s 8 mob_attack by @n[tag=MG_AZR0BOSS_axe_angel]
...
execute if score @s rng1 matches 18.. at @s[tag=azr0_axe_angel_attack_throw_high] positioned ^ ^ ^0.4 as @a[tag=MG_AZR0PT,distance=..1.1] at @s unless entity @s[predicate=skyblock:sneak] run damage @s 5 mob_attack by @n[tag=MG_AZR0BOSS_axe_angel]
execute if score @s rng1 matches 18.. at @s[tag=azr0_axe_angel_attack_throw_high] positioned ^ ^ ^0.4 as @e[tag=MG_AZR0SPIRIT,distance=..1.1] at @s run damage @s 8 mob_attack by @n[tag=MG_AZR0BOSS_axe_angel]
