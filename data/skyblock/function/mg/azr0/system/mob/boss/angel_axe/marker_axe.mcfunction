...
execute if score @s[tag=azr0_axe_angel_attack_throw_leftsmall] rng1 matches 1 at @n[tag=MG_AZR0BOSS_axe_angel,distance=..50] rotated as @n[tag=MG_AZR0BOSS_axe_angel,distance=..5] run tp @s ^0.2 ^ ^-0.8 facing entity @n[tag=MG_AZR0BOSS_axe_angel,distance=..5]
execute if score @s[tag=azr0_axe_angel_attack_throw_rightsmall] rng1 matches 1 at @n[tag=MG_AZR0BOSS_axe_angel,distance=..50] rotated as @n[tag=MG_AZR0BOSS_axe_angel,distance=..5] run tp @s ^-0.2 ^ ^-0.8 facing entity @n[tag=MG_AZR0BOSS_axe_angel,distance=..5]
