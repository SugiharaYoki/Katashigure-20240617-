...
execute if score @s rng1 matches 18.. at @s run particle sweep_attack ^ ^0.8 ^0.4 0 0 0 0 1
execute if score @s rng1 matches 18.. at @s positioned ^ ^ ^0.4 as @a[tag=MG_AZR0PT,distance=..1.1] at @s run damage @s 5 mob_attack by @n[tag=MG_AZR0BOSS_axe_angel]
