...
execute as @e[distance=..200,type=marker,tag=azr0_candle_angel_candle_throe_marker] at @s run function skyblock:mg/azr0/system/mob/boss/angel_candle/marker_candle_throw
