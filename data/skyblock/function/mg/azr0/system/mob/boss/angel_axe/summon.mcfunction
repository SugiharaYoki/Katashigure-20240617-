...
summon vindicator ~ ~ ~ {CustomName:'[{"text":"斧天使瑟拉斐尔"}]',DeathLootTable:"skyblock:mg/azr0/tier4",Tags:["MG_AZR0MOB","MG_AZR0MOB_SlownessImmune","MG_AZR0BOSS","MG_AZR0BOSS_axe_angel"],attributes:[{id:"attack_damage",base:0.0},{id:"armor",base:10.0},{id:"armor_toughness",base:4.0},{id:"movement_speed",base:0.16},{id:"max_health",base:240},{id:"scale",base:1.2},{id:"follow_range",base:186}],HandItems:[{id:iron_axe,count:1},{}],HandDropChances:[0f,0f],Health:240,PersistenceRequired:1b}
