...
execute if score @s[scores={rng2=1..5}] rng1 matches 3.. run rotate @s facing entity @p[tag=MG_AZR0PT]
...
execute if score @s[scores={rng2=3}] rng1 matches 8.. run tp @s ^-0.1 ^ ^
execute if score @s[scores={rng2=4}] rng1 matches 8.. run tp @s ^0.25 ^ ^
execute if score @s[scores={rng2=5}] rng1 matches 8.. run tp @s ^-0.25 ^ ^
