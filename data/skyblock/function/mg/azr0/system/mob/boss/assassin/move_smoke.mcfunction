...
execute if score @s[scores={rng1=1..2}] rng5 matches 62 as @r[tag=MG_AZR0PT,distance=..200] at @s rotated ~ 0 positioned ^ ^ ^3 run tp @s ~ ~ ~ facing entity @p[tag=MG_AZR0PT]
...
execute if score @s[scores={rng1=3..4}] rng5 matches 62 as @r[tag=MG_AZR0PT,distance=..200] at @s rotated ~ 0 positioned ^ ^ ^-2 run tp @s ~ ~ ~ facing entity @p[tag=MG_AZR0PT]
