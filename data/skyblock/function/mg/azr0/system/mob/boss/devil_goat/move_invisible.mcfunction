...
execute if score @s rng5 matches 2 run particle end_rod ~ ~1 ~ 0.3 1 0.3 0 15
...
execute if score @s rng5 matches 60 store result score @s rng1 run random value 1..4
