...
execute if score @s rng5 matches 41 as @n[tag=azr0_candle_angel_fireattack_marker1] at @s rotated as @s run rotate @s ~80 ~
execute if score @s rng5 matches 41 as @n[tag=azr0_candle_angel_fireattack_marker2] at @s rotated as @s run rotate @s ~-80 ~
...
execute if score @s rng5 matches 42..49 as @n[tag=azr0_candle_angel_fireattack_marker1] at @s rotated as @s run rotate @s ~-8 ~
execute if score @s rng5 matches 42..49 as @n[tag=azr0_candle_angel_fireattack_marker2] at @s rotated as @s run rotate @s ~8 ~
