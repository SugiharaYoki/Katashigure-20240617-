...
execute if score @s rng5 matches 41 run rotate @n[tag=azr0_candle_angel_fireattack_marker1] ~80 ~
execute if score @s rng5 matches 41 run rotate @n[tag=azr0_candle_angel_fireattack_marker2] ~-80 ~
...
execute if score @s rng5 matches 42..50 as @n[tag=azr0_candle_angel_fireattack_marker1] at @s positioned ^ ^ ^1.5 run particle flame ~ ~ ~ 0 0 0 0.00 3
execute if score @s rng5 matches 42..50 as @n[tag=azr0_candle_angel_fireattack_marker2] at @s positioned ^ ^ ^1.5 run particle flame ~ ~ ~ 0 0 0 0.00 3
...
execute if score @s rng5 matches 42..49 run rotate @n[tag=azr0_candle_angel_fireattack_marker1] ~-8 ~
execute if score @s rng5 matches 42..49 run rotate @n[tag=azr0_candle_angel_fireattack_marker2] ~8 ~
...
execute if score @s rng5 matches 53 as @n[tag=azr0_candle_angel_fireattack_marker1] at @s positioned ^ ^ ^1.9 run summon marker ~ 4.0 ~ {Tags:["azr0_candle_angel_candle_marker"]}
execute if score @s rng5 matches 55 as @n[tag=azr0_candle_angel_fireattack_marker1] at @s positioned ^ ^ ^2.9 run summon marker ~ 4.0 ~ {Tags:["azr0_candle_angel_candle_marker"]}
execute if score @s rng5 matches 57 as @n[tag=azr0_candle_angel_fireattack_marker1] at @s positioned ^ ^ ^3.9 run summon marker ~ 4.0 ~ {Tags:["azr0_candle_angel_candle_marker"]}
execute if score @s rng5 matches 59 as @n[tag=azr0_candle_angel_fireattack_marker1] at @s positioned ^ ^ ^4.9 run summon marker ~ 4.0 ~ {Tags:["azr0_candle_angel_candle_marker"]}
