...
execute if score MG_AZR5_rng rng1 matches 1..3 as @e[tag=MG_AZR0MOB,tag=MG_AZR0MOB_smoke_grenade,scores={health=..3},tag=!MG_AZR0MOB_smoke_grenade_done] at @s run particle large_smoke ~ ~1 ~ 0.8 0.8 0.8 0.08 80 force
execute if score MG_AZR5_rng rng1 matches 1..3 as @e[tag=MG_AZR0MOB,tag=MG_AZR0MOB_smoke_grenade,scores={health=..3},tag=!MG_AZR0MOB_smoke_grenade_done] at @s run effect give @a[distance=0..1.9,gamemode=adventure] blindness 3 0 false
execute if score MG_AZR5_rng rng1 matches 1..3 as @e[tag=MG_AZR0MOB,tag=MG_AZR0MOB_smoke_grenade,scores={health=..3},tag=!MG_AZR0MOB_smoke_grenade_done] at @s run effect give @a[distance=0..2.2,gamemode=adventure] blindness 2 0 false
