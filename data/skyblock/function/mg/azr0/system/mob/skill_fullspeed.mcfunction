...
execute as @s[tag=MG_AZR0BOSS_candle_angel,distance=..200] at @s run function skyblock:mg/azr0/system/mob/boss/angel_candle/core_controller
execute as @s[tag=MG_AZR0BOSS_axe_angel,distance=..200] at @s run function skyblock:mg/azr0/system/mob/boss/angel_axe/core
execute as @s[tag=MG_AZR0BOSS_axe_angel,distance=..200] at @s run function skyblock:mg/azr0/system/mob/boss/angel_axe/core_controller
execute as @s[tag=MG_AZR0BOSS_assassin,distance=..200] at @s run function skyblock:mg/azr0/system/mob/boss/assassin/core
execute as @s[tag=MG_AZR0BOSS_assassin,distance=..200] at @s run function skyblock:mg/azr0/system/mob/boss/assassin/core_controller
