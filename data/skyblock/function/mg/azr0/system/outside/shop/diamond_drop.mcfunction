...
execute if entity @s[scores={Azr0_UPG_OTSD_skill_point=2,Perm_PersonSHD=1000..}] run tag @s add AZR0SHOP_SUCCESS
execute if entity @s[scores={Azr0_UPG_OTSD_skill_point=3,Perm_PersonSHD=1500..}] run tag @s add AZR0SHOP_SUCCESS
execute if entity @s[scores={Azr0_UPG_OTSD_skill_point=4,Perm_PersonSHD=2000..}] run tag @s add AZR0SHOP_SUCCESS
...
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_OTSD_skill_point=2}] run scoreboard players remove @s Perm_PersonSHD 1000
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_OTSD_skill_point=3}] run scoreboard players remove @s Perm_PersonSHD 1500
execute if entity @s[tag=AZR0SHOP_SUCCESS,scores={Azr0_UPG_OTSD_skill_point=4}] run scoreboard players remove @s Perm_PersonSHD 2000
