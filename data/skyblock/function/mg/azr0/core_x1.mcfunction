...
execute if score MG_AZR0_Timer rng3 matches 8 if score MG_AZR0_Timer rng2 matches 21 run function skyblock:mg/azr0/event/general_end_round_boss
execute if score MG_AZR0_Timer rng3 matches 8 if score MG_AZR0_Timer rng2 matches 41 run function skyblock:mg/azr0/event/general_end_round_boss
