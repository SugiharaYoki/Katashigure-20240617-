...
tellraw @a[tag=!Gaming,tag=!OneShotInvite] {"text":"—— [参加游戏] ——","color":"green","click_event":{"action":"run_command","value":"/trigger MultiMenu set 7450101"},"hover_event":{"action":"show_text","contents":{"text":"接受这条邀请","color":"green"}}}
tellraw @a[tag=!Gaming,tag=OneShotInvite] {"text":"—— [取消邀请] ——","color":"green","click_event":{"action":"run_command","value":"/trigger MultiMenu set 7450102"},"hover_event":{"action":"show_text","contents":{"text":"将这条邀请作废","color":"green"}}}
