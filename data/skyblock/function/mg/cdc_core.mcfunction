...
execute as @n[tag=sc,scores={mg_cdc_timer=2200..5000,mg_cdc_loop=60..,mg_rng=1}] run summon skeleton 3 56 110 {Tags:["mg_cdc_mob"],DeathLootTable:"empty",attributes:[{id:max_health,base:14.0},{id:attack_damage,base:0.5},{id:movement_speed,base:0.28}],Health:14.0f,equipment:{mainhand:{id:"stone_sword",components:{"minecraft:enchantments":{"minecraft:knockback":6}}}},drop_chances:{mainhand:0.0f,offhand:0.0f}}
...
execute as @n[tag=sc,scores={mg_cdc_timer=1501..7000,mg_cdc_loop=60..,mg_rng2=1}] run summon zombie 3 56 110 {Tags:["mg_cdc_mob"],DeathLootTable:"empty",attributes:[{id:max_health,base:34.0},{id:attack_damage,base:0.5},{id:movement_speed,base:0.15}],Health:34.0f,equipment:{mainhand:{id:"stone_axe",components:{"minecraft:enchantments":{"minecraft:knockback":6}}}},drop_chances:{mainhand:0.0f,offhand:0.0f}}
...
execute as @n[tag=sc,scores={mg_cdc_timer=7001..,mg_cdc_loop=60..,mg_rng2=1}] run summon zombie 3 56 110 {Tags:["mg_cdc_mob"],DeathLootTable:"empty",attributes:[{id:max_health,base:37.0},{id:attack_damage,base:0.5},{id:movement_speed,base:0.25}],Health:37.0f,equipment:{mainhand:{id:"iron_axe",components:{"minecraft:enchantments":{"minecraft:knockback":6}}}},drop_chances:{mainhand:0.0f,offhand:0.0f}}
...
execute as @n[tag=sc,scores={mg_cdc_timer=4301..,mg_cdc_loop=60..,mg_rng3=1}] run summon husk 3 56 110 {Tags:["mg_cdc_mob"],DeathLootTable:"empty",attributes:[{id:max_health,base:1.0},{id:attack_damage,base:0.5},{id:movement_speed,base:0.5}],Health:1.0f,equipment:{mainhand:{id:"stone_axe",components:{"minecraft:enchantments":{"minecraft:knockback":6}}}},drop_chances:{mainhand:0.0f,offhand:0.0f}}
