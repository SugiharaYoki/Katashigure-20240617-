...
execute if score @s MG_qqd_step matches 64 run title @s title [{"text": "→ → ↓", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 237 run title @s title [{"text": "→ ↑ ← ↓ ↑ ↓", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 247 run title @s title [{"text": "← ↑ → ↓ ↑ ↓", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 257 run title @s title [{"text": "→ ↑ ← ↓ ↑ ↓", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 314 run title @s title [{"text": "→ ← →", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 464 run title @s title [{"text": "← ↑ →", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 474 run title @s title [{"text": "→ ↑ ←", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 484 run title @s title [{"text": "← → ↓", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 494 run title @s title [{"text": "→ ← ↓", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 504 run title @s title [{"text": "→ ↓ ←", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 543 run title @s title [{"text": "→ ↑", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 595 run title @s title [{"text": "→ ← → ←", "color": "green", "bold": true}]
