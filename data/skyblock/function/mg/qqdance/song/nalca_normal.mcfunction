...
execute if score @s MG_qqd_step matches 95 run title @s title [{"text": "3", "color": "blue", "bold": true}]
execute if score @s MG_qqd_step matches 115 run title @s title [{"text": "2", "color": "blue", "bold": true}]
execute if score @s MG_qqd_step matches 135 run title @s title [{"text": "Ready", "color": "blue", "bold": true}]
...
execute if entity @s[tag=MG_qqd_stepped,tag=!MG_qqd_stepped_x,predicate=skyblock:left] run tag @s add MG_qqd_stepped_a
execute if entity @s[tag=MG_qqd_stepped,tag=!MG_qqd_stepped_x,predicate=skyblock:right] run tag @s add MG_qqd_stepped_d
execute if entity @s[tag=MG_qqd_stepped,tag=!MG_qqd_stepped_x,predicate=skyblock:forward] run tag @s add MG_qqd_stepped_w
execute if entity @s[tag=MG_qqd_stepped,tag=!MG_qqd_stepped_x,predicate=skyblock:backward] run tag @s add MG_qqd_stepped_s
execute if entity @s[tag=MG_qqd_stepped,tag=!MG_qqd_stepped_x] run tag @s add MG_qqd_stepped_x
execute if entity @s[tag=MG_qqd_stepped] if entity @s[tag=MG_qqd_stepped_a,predicate=!skyblock:left] run tag @s remove MG_qqd_stepped_x
execute if entity @s[tag=MG_qqd_stepped] if entity @s[tag=MG_qqd_stepped_a,predicate=!skyblock:left] run tag @s remove MG_qqd_stepped_a
execute if entity @s[tag=MG_qqd_stepped] if entity @s[tag=MG_qqd_stepped_a,predicate=!skyblock:left] run tag @s remove MG_qqd_stepped
execute if entity @s[tag=MG_qqd_stepped] if entity @s[tag=MG_qqd_stepped_d,predicate=!skyblock:backward] run tag @s remove MG_qqd_stepped_x
execute if entity @s[tag=MG_qqd_stepped] if entity @s[tag=MG_qqd_stepped_d,predicate=!skyblock:backward] run tag @s remove MG_qqd_stepped_d
execute if entity @s[tag=MG_qqd_stepped] if entity @s[tag=MG_qqd_stepped_d,predicate=!skyblock:backward] run tag @s remove MG_qqd_stepped
execute if entity @s[tag=MG_qqd_stepped] if entity @s[tag=MG_qqd_stepped_w,predicate=!skyblock:forward] run tag @s remove MG_qqd_stepped_x
execute if entity @s[tag=MG_qqd_stepped] if entity @s[tag=MG_qqd_stepped_w,predicate=!skyblock:forward] run tag @s remove MG_qqd_stepped_w
execute if entity @s[tag=MG_qqd_stepped] if entity @s[tag=MG_qqd_stepped_w,predicate=!skyblock:forward] run tag @s remove MG_qqd_stepped
execute if entity @s[tag=MG_qqd_stepped] if entity @s[tag=MG_qqd_stepped_s,predicate=!skyblock:right] run tag @s remove MG_qqd_stepped_x
execute if entity @s[tag=MG_qqd_stepped] if entity @s[tag=MG_qqd_stepped_s,predicate=!skyblock:right] run tag @s remove MG_qqd_stepped_s
execute if entity @s[tag=MG_qqd_stepped] if entity @s[tag=MG_qqd_stepped_s,predicate=!skyblock:right] run tag @s remove MG_qqd_stepped
