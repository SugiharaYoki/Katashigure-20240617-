...
execute if score @s MG_qqd_step matches 6 run title @s title [{text:"↑ → ↓ ↑ →", "color": "green", bold:1b}]
...
execute if score @s MG_qqd_step matches 16 run title @s title [{text:"↑ ← ↓ ↑ ←", "color": "green", bold:1b}]
...
execute if score @s MG_qqd_step matches 66 run title @s title [{text:"↓ ← ↑ ← →", "color": "green", bold:1b}]
...
execute if score @s MG_qqd_step matches 88 run title @s title [{text:"↑ ↓ ↑ ← → ← ↑", "color": "green", bold:1b}]
...
execute if score @s MG_qqd_step matches 98 run title @s title [{text:"↑ → ↓ ← → ↑ ↓", "color": "green", bold:1b}]
...
execute if score @s MG_qqd_step matches 147 run title @s title [{text:"↑ ← ← → ← ↓", "color": "green", bold:1b}, {text:" ↑", "color": "blue", bold:1b}]
execute if score @s MG_qqd_step matches 148 run title @s title [{text:"↑ ← ← → ← ↓ ↑", "color": "green", bold:1b}]
...
execute if score @s MG_qqd_step matches 178 run title @s title [{text:"→ ↓ ← → ↓ ← ↑", "color": "green", bold:1b}]
...
execute if score @s MG_qqd_step matches 218 run title @s title [{text:"↑ ↓ ↑ ↓ ↑ → ←", "color": "green", bold:1b}]
...
execute if score @s MG_qqd_step matches 228 run title @s title [{text:"→ ↓ → ↓ ← → ←", "color": "green", bold:1b}]
...
execute if score @s MG_qqd_step matches 238 run title @s title [{text:"↑ ↓ ↑ ↓ ↑ ← →", "color": "green", bold:1b}]
