...
execute if score @s MG_qqd_step matches 23 run title @s title [{"text": "→ ↑", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 33 run title @s title [{"text": "← ↑", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 144 run title @s title [{"text": "← ↑ ↓", "color": "green", "bold": true}]
