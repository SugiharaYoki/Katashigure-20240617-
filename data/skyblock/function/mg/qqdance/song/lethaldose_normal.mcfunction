...
execute if score @s MG_qqd_t_abs matches 1304 run scoreboard players set @s[scores={MG_qqd_step=..115}] MG_qqd_t_rel -50
...
execute if score @s MG_qqd_t_abs matches 1862 run scoreboard players set @s[scores={MG_qqd_step=..176}] MG_qqd_t_rel -50
...
execute if score @s MG_qqd_step matches 181 if entity @s[predicate=skyblock:forward,tag=!MG_qqd_stepped] run tag @s add MG_qqd_stepped
...
execute if score @s MG_qqd_step matches 196 if entity @s[predicate=skyblock:right,tag=!MG_qqd_stepped] run tag @s add MG_qqd_stepped
...
execute if score @s MG_qqd_step matches 206 if entity @s[predicate=skyblock:forward,tag=!MG_qqd_stepped] run tag @s add MG_qqd_stepped
