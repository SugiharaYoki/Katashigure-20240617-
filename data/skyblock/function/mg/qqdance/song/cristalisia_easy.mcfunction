...
execute if score @s MG_qqd_step matches 298 run title @s title [{"text": "← ↓ → ↑ → ↓ ←", "color": "green", bold: true}]
...
execute if score @s MG_qqd_step matches 318 run title @s title [{"text": "→ ↑ ← ↓ → ↑ ←", "color": "green", bold: true}]
