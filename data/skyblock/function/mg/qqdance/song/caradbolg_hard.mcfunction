...
execute if score @s MG_qqd_step matches 73 run title @s title [{"text": "↑ ↓", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 334 run title @s title [{"text": "← ↓ ←", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 383 run title @s title [{"text": "→ ←", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 392 run title @s title [{"text": "↑", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 406 run title @s title [{"text": "← ↑ → ↓ ←", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 436 run title @s title [{"text": "← ↓ → ↑ ↓", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 486 run title @s title [{"text": "← ↑ ← ↑ ←", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 495 run title @s title [{"text": "→ ↑ → ↑", "color": "green", "bold": true}, {"text": " →", "color": "blue", "bold": true}]
execute if score @s MG_qqd_step matches 496 run title @s title [{"text": "→ ↑ → ↑ →", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 505 run title @s title [{"text": "← ↓ ← ↓", "color": "green", "bold": true}, {"text": " ←", "color": "blue", "bold": true}]
execute if score @s MG_qqd_step matches 506 run title @s title [{"text": "← ↓ ← ↓ ←", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 516 run title @s title [{"text": "→ ↓ → ↓ →", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 563 run title @s title [{"text": "← →", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 574 run title @s title [{"text": "↓ ↑ ↓", "color": "green", "bold": true}]
