...
execute if score @s MG_qqd_step matches 12 run title @s title [{"text": "←", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 22 run title @s title [{"text": "→", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 42 run title @s title [{"text": "→", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 52 run title @s title [{"text": "↑", "color": "green", "bold": true}]
...
execute if score @s MG_qqd_step matches 63 run title @s title [{"text": "← ↓", "color": "green", "bold": true}]
