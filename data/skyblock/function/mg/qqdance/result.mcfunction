tellraw @s[tag=MG_qqd_st_gamemode_1] [{text:"舞蹈结束！",color:"green",bold:1b},{text:"\n完成了一场出色的舞蹈！",color:"white",bold:0b}]
tellraw @s[tag=MG_qqd_st_gamemode_2] [{text:"舞蹈排练结束！",color:"green",bold:1b},{text:"\n辛苦了！",color:"white",bold:0b}]
...
execute if score @s[tag=MG_qqd_st_gamemode_1] MG_qqd_song_id matches 12 at @n[tag=id_data_reading,type=marker] if items block ~ ~ ~ container.4 white_wool run item replace block ~ ~ ~ container.4 with yellow_wool
execute if score @s[tag=MG_qqd_st_gamemode_1] MG_qqd_song_id matches 14 at @n[tag=id_data_reading,type=marker] if items block ~ ~ ~ container.5 white_wool run item replace block ~ ~ ~ container.5 with yellow_wool
...
execute if score @s[tag=MG_qqd_st_gamemode_1] MG_qqd_song_id matches 16 at @n[tag=id_data_reading,type=marker] unless items block ~ ~ ~ container.4 red_wool run function skyblock:mg/qqdance/result_new
...
execute if score @s[tag=MG_qqd_st_gamemode_1] MG_qqd_song_id matches 16 at @n[tag=id_data_reading,type=marker] unless items block ~ ~ ~ container.4 red_wool run item replace block ~ ~ ~ container.4 with red_wool
execute if score @s[tag=MG_qqd_st_gamemode_1] MG_qqd_song_id matches 15 at @n[tag=id_data_reading,type=marker] unless items block ~ ~ ~ container.5 red_wool run item replace block ~ ~ ~ container.5 with red_wool
