...
#title @s title {text:"测试文本 ↑ ↓ ← →",color:"blue",bold:1b}
execute as @s[scores={MG_qqd_t_rel=1..4}] run title @s subtitle [{text:"★",color:"dark_red",bold:0b},{text:"☆☆☆☆ ☆☆☆☆☆ ☆☆☆☆☆ ☆☆☆☆☆",color:"gray",bold:0b}]
execute as @s[scores={MG_qqd_t_rel=5..8}] run title @s subtitle [{text:"★★",color:"dark_red",bold:0b},{text:"☆☆☆ ☆☆☆☆☆ ☆☆☆☆☆ ☆☆☆☆☆",color:"gray",bold:0b}]
execute as @s[scores={MG_qqd_t_rel=9..12}] run title @s subtitle [{text:"★★★",color:"dark_red",bold:0b},{text:"☆☆ ☆☆☆☆☆ ☆☆☆☆☆ ☆☆☆☆☆",color:"gray",bold:0b}]
execute as @s[scores={MG_qqd_t_rel=13..16}] run title @s subtitle [{text:"★★★★",color:"dark_red",bold:0b},{text:"☆ ☆☆☆☆☆ ☆☆☆☆☆ ☆☆☆☆☆",color:"gray",bold:0b}]
execute as @s[scores={MG_qqd_t_rel=17..20}] run title @s subtitle [{text:"★★★★★",color:"dark_red",bold:0b},{text:" ☆☆☆☆☆ ☆☆☆☆☆ ☆☆☆☆☆",color:"gray",bold:0b}]
execute as @s[scores={MG_qqd_t_rel=21..24}] run title @s subtitle [{text:"★★★★★ ★",color:"yellow",bold:0b},{text:"☆☆☆☆ ☆☆☆☆☆ ☆☆☆☆☆",color:"gray",bold:0b}]
execute as @s[scores={MG_qqd_t_rel=25..28}] run title @s subtitle [{text:"★★★★★ ★★",color:"yellow",bold:0b},{text:"☆☆☆ ☆☆☆☆☆ ☆☆☆☆☆",color:"gray",bold:0b}]
execute as @s[scores={MG_qqd_t_rel=29..32}] run title @s subtitle [{text:"★★★★★ ★★★",color:"yellow",bold:0b},{text:"☆☆ ☆☆☆☆☆ ☆☆☆☆☆",color:"gray",bold:0b}]
execute as @s[scores={MG_qqd_t_rel=33..36}] run title @s subtitle [{text:"★★★★★ ★★★★",color:"yellow",bold:0b},{text:"☆ ☆☆☆☆☆ ☆☆☆☆☆",color:"gray",bold:0b}]
execute as @s[scores={MG_qqd_t_rel=37..40}] run title @s subtitle [{text:"★★★★★ ★★★★★",color:"yellow",bold:0b},{text:" ☆☆☆☆☆ ☆☆☆☆☆",color:"gray",bold:0b}]
execute as @s[scores={MG_qqd_t_rel=41..44}] run title @s subtitle [{text:"★★★★★ ★★★★★ ★",color:"white",bold:0b},{text:"☆☆☆☆ ☆☆☆☆☆",color:"gray",bold:0b}]
execute as @s[scores={MG_qqd_t_rel=45..48}] run title @s subtitle [{text:"★★★★★ ★★★★★ ★★",color:"white",bold:0b},{text:"☆☆☆ ☆☆☆☆☆",color:"gray",bold:0b}]
execute as @s[scores={MG_qqd_t_rel=49..52}] run title @s subtitle [{text:"★★★★★ ★★★★★ ★★★",color:"white",bold:0b},{text:"☆☆ ☆☆☆☆☆",color:"gray",bold:0b}]
execute as @s[scores={MG_qqd_t_rel=53..56}] run title @s subtitle [{text:"★★★★★ ★★★★★ ★★★★",color:"white",bold:0b},{text:"☆ ☆☆☆☆☆",color:"gray",bold:0b}]
execute as @s[scores={MG_qqd_t_rel=57..60}] run title @s subtitle [{text:"★★★★★ ★★★★★ ★★★★★",color:"white",bold:0b},{text:" ☆☆☆☆☆",color:"gray",bold:0b}]
execute as @s[scores={MG_qqd_t_rel=61..64}] run title @s subtitle [{text:"★★★★★ ★★★★★ ★★★★★ ★",color:"white",bold:0b},{text:"☆☆☆☆",color:"gray",bold:0b}]
execute as @s[scores={MG_qqd_t_rel=65..68}] run title @s subtitle [{text:"★★★★★ ★★★★★ ★★★★★ ★★",color:"white",bold:0b},{text:"☆☆☆",color:"gray",bold:0b}]
execute as @s[scores={MG_qqd_t_rel=69..72}] run title @s subtitle [{text:"★★★★★ ★★★★★ ★★★★★ ★★★",color:"white",bold:0b},{text:"☆☆",color:"gray",bold:0b}]
execute as @s[scores={MG_qqd_t_rel=73..76}] run title @s subtitle [{text:"★★★★★ ★★★★★ ★★★★★ ★★★★",color:"white",bold:0b},{text:"☆",color:"gray",bold:0b}]
execute as @s[scores={MG_qqd_t_rel=78..}] run title @s subtitle [{text:"★★★★★ ★★★★★ ★★★★★ ★★★★★",color:"white",bold:0b},{text:"",color:"gray",bold:0b}]
...
execute if score @s MG_qqd_song_id matches 11 run title @s actionbar [{text:"Cristalisia - Easy",color:"green"},{text:" | ",color:"gray"},{"score":{"name":"@s","objective":"MG_qqd_hit"},color:"white"},{text:"",color:"white"}]
execute if score @s MG_qqd_song_id matches 12 run title @s actionbar [{text:"Cristalisia - Normal",color:"yellow"},{text:" | ",color:"gray"},{"score":{"name":"@s","objective":"MG_qqd_hit"},color:"white"},{text:"",color:"white"}]
...
execute if score @s MG_qqd_song_id matches 16 run title @s actionbar [{text:"Cristalisia - Hard",color:"red"},{text:" | ",color:"gray"},{"score":{"name":"@s","objective":"MG_qqd_hit"},color:"white"},{text:"",color:"white"}]
