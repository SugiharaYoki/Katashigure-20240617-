...
execute if score @s MG_qqd_song_id matches 1 run tellraw @a [{"text":"难度：","color":"gray","bold":true},{"text":"Easy 1","color":"green","bold":false}]
...
execute if score @s MG_qqd_song_id matches 2 run tellraw @a [{"text":"难度：","color":"gray","bold":true},{"text":"Normal 3","color":"yellow","bold":false}]
...
execute if score @s MG_qqd_song_id matches 3 run tellraw @a [{"text":"难度：","color":"gray","bold":true},{"text":"Hard 5","color":"red","bold":false}]
execute if score @s MG_qqd_song_id matches 4 run tellraw @a [{"text":"歌曲：","color":"gray","bold":true},{"text":"Nalca","color":"gray","bold":false}]
execute if score @s MG_qqd_song_id matches 4 run tellraw @a [{"text":"难度：","color":"gray","bold":true},{"text":"Normal 3","color":"yellow","bold":false}]
execute if score @s MG_qqd_song_id matches 5 run tellraw @a [{"text":"歌曲：","color":"gray","bold":true},{"text":"Nalca","color":"gray","bold":false}]
execute if score @s MG_qqd_song_id matches 5 run tellraw @a [{"text":"难度：","color":"gray","bold":true},{"text":"Hard 6","color":"red","bold":false}]
...
execute if score @s MG_qqd_song_id matches 6 run tellraw @a [{"text":"难度：","color":"gray","bold":true},{"text":"Normal 4","color":"yellow","bold":false}]
...
execute if score @s MG_qqd_song_id matches 7 run tellraw @a [{"text":"难度：","color":"gray","bold":true},{"text":"Hard 7","color":"red","bold":false}]
...
execute if score @s MG_qqd_song_id matches 8 run tellraw @a [{"text":"难度：","color":"gray","bold":true},{"text":"Easy 1","color":"green","bold":false}]
...
execute if score @s MG_qqd_song_id matches 9 run tellraw @a [{"text":"难度：","color":"gray","bold":true},{"text":"Normal 3","color":"yellow","bold":false}]
...
execute if score @s MG_qqd_song_id matches 11 run tellraw @a [{"text":"难度：","color":"gray","bold":true},{"text":"Easy 3","color":"green","bold":false}]
