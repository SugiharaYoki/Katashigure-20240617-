...
execute if score @s MG_qqd_song_id matches 7 run tellraw @a [{"text":"难度：","color":"gray","bold":true},{"text":"Hard 10","color":"red","bold":false}]
...
execute if score @s MG_qqd_song_id matches 12 run tellraw @a [{"text":"难度：","color":"gray","bold":true},{"text":"Hard 8","color":"red","bold":false}]
...
execute if score @s MG_qqd_song_id matches 14 run tellraw @a [{"text":"难度：","color":"gray","bold":true},{"text":"Normal 6","color":"yellow","bold":false}]
...
execute if score @s MG_qqd_song_id matches 15 run tellraw @a [{"text":"难度：","color":"gray","bold":true},{"text":"Hard 10","color":"red","bold":false}]
