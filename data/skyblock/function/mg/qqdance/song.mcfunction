...
execute if score @s MG_qqd_song_id matches 8 run function skyblock:mg/qqdance/song/caradbolg_normal
execute if score @s MG_qqd_song_id matches 9 run function skyblock:mg/qqdance/song/caradbolg_hard
