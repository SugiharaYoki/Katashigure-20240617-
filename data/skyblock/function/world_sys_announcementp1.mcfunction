...
execute as @n[x=102,y=5,z=-242,dx=58,dy=300,dz=58,type=item,scores={rng2=3}] at @s if entity @s[nbt={Item:{id:"minecraft:blaze_powder"}}] run particle white_smoke ~ ~ ~ 0.2 0.3 0.2 0.08 20
