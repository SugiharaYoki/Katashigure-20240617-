...
execute as @s at @s[scores={Azr_Mt_0020=5..}] run tellraw @s {"text":"解封了灵能「残城箭影」！","color":"green"}
...
execute as @s at @s[tag=purchasesuccess] run scoreboard players set @s Azr_SK9 1
