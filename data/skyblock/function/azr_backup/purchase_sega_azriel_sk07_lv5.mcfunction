execute as @s at @s[scores={Perm_PersonSHD=..799}] run tellraw @s {"text":"升级失败！所持不足800影之石！","color":"red"}
execute as @s at @s[scores={Perm_PersonSHD=800..}] run playsound minecraft:item.armor.equip_iron neutral @s ~ ~ ~ 100
execute as @s at @s[scores={Perm_PersonSHD=800..}] run tellraw @s {"text":"灵能「花卉领域」升级！花费了： 800影之石","color":"green"}
...
execute as @s at @s[tag=purchasesuccess] run scoreboard players set @s Azr_SK7 5
