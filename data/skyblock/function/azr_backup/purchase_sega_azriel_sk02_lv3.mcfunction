...
execute as @s at @s[scores={Perm_PersonFSB=800..,Perm_PersonSHD=300..}] run tellraw @s {"text":"灵能「嗜血狂袭」升级！花费了： 800浮世币 300影之石","color":"green"}
...
execute as @s at @s[tag=purchasesuccess] run scoreboard players set @s Azr_SK2 3
