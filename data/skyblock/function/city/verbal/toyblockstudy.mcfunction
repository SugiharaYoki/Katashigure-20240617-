...
tellraw @s {text:"选择主城音乐",bold:false,underlined:true,color:"yellow",click_event:{"action":"run_command","command":"trigger MultiMenu set 51"}}
tellraw @s {text:"购买 抹茶拿铁 20FSB",bold:false,underlined:true,color:"gold",click_event:{"action":"run_command","command":"trigger MultiMenu set 16210003"}}
tellraw @s {text:"购买 草莓牛奶冰沙 20FSB",bold:false,underlined:true,color:"gold",click_event:{"action":"run_command","command":"trigger MultiMenu set 16210004"}}
