...
tellraw @s {"text":"浮世币归零","bold":false,"underlined":true,"color":"yellow","click_event":{"action":"run_command","value":"/trigger MultiMenu set 16210012"},"hoverEvent":{"action":"show_text","contents":{"text":"将降至-500以下的浮世币余额归零","color":"white"}}}
