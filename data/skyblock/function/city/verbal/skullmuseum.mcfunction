...
tellraw @s {text:"购买 方颅券（铜） 10FSB",bold:false,underlined:true,color:"gold",click_event:{"action":"run_command","command":"trigger MultiMenu set 16210005"}}
tellraw @s {text:"购买 方颅券（银） 20FSB",bold:false,underlined:true,color:"gold",click_event:{"action":"run_command","command":"trigger MultiMenu set 16210006"}}
tellraw @s {text:"购买 方颅券（金） 50FSB",bold:false,underlined:true,color:"gold",click_event:{"action":"run_command","command":"trigger MultiMenu set 16210007"}}
