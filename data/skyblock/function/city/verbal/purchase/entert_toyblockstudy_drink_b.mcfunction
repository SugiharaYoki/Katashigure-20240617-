...
execute as @s at @s[tag=purchasesuccess] run give @s potion[potion_contents={custom_color:16755406,custom_effects:[{id:"regeneration",amplifier:7,duration:36000},{id:"resistance",amplifier:7,duration:36000}]},custom_name={text:"草莓牛奶冰沙",color:"white",italic:1b},lore=[{text:"冰凉酸甜的积木书房特色饮品。"}]] 1
