...
tellraw @s {text:"『云亭攻防战』开始游戏",bold:false,underlined:true,color:"green",click_event:{"action":"run_command","command":"trigger MultiMenu set 116"}}
tellraw @s {text:"『云亭攻防战』查看排行榜",bold:false,underlined:true,color:"yellow",click_event:{"action":"run_command","command":"trigger MultiMenu set 117"}}
tellraw @s {text:"返回 地牢主题游戏大楼",bold:false,underlined:true,color:"red",click_event:{"action":"run_command","command":"trigger MultiMenu set 821"}}
tellraw @s {text:"返回 匿名都 - 以太座",bold:false,underlined:true,color:"red",click_event:{"action":"run_command","command":"trigger MultiMenu set 819"}}
