...
tellraw @s[tag=CasBSG1,tag=!CasBSGGS,scores={CasinoBigSmallE=50}] {"text":"当前赌注为 50 浮世币","color":"gray"}
...
execute if entity @s[tag=CasBSGGS] if score @s CasBSGTemp1 = @s CasBSGTemp2 run tellraw @s [{"text":"猜测正确！B的数值为： ","color":"green"},{"score":{"name":"@s","objective":"CasBSGTemp2"}},{"text":"，您额外获得3倍奖励！","color":"green"}]
