...
tellraw @s[tag=!city_broadcast_off] {"text":"   主城广播公告 开启","color":"green","clickEvent":{"action":"run_command","value":"/trigger MultiMenu set 49"},"hoverEvent":{"action":"show_text","contents":{"text":"点击关闭广播公告","color":"red"}}}
tellraw @s[tag=city_broadcast_off] {"text":"   主城广播公告 关闭","color":"dark_red","clickEvent":{"action":"run_command","value":"/trigger MultiMenu set 49"},"hoverEvent":{"action":"show_text","contents":{"text":"点击开启广播公告","color":"green"}}}
