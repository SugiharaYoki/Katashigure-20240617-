...
execute if score breakpoint fp_system matches 0 run return 1
...
execute if score breakpoint fp_system matches 2 run return 1
...
execute if score breakpoint fp_system matches 3 run return 1
...
execute if score breakpoint fp_system matches 4 run return 1
